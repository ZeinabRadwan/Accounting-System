"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9826],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-38f36945]{gap:10px}.header-buttons[data-v-38f36945]{margin-bottom:15px}.footer-buttons[data-v-38f36945]{display:flex;gap:10px}.footer-buttons .btn[data-v-38f36945]{margin-right:10px}.footer-buttons .btn[data-v-38f36945]:last-child{margin-right:0}.card[data-v-38f36945]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-38f36945]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-38f36945]{background:#fff!important}.btn-primary[data-v-38f36945]{background:#2ab930!important}.btn-primary[data-v-38f36945],.btn-secondary[data-v-38f36945]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-38f36945]{background:#33a0d9!important}.btn-secondary[data-v-38f36945]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/edit.vue?vue&type=template&id=38f36945&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/edit.vue?vue&type=script&lang=js
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              if (_this6.form.subCategory && _typeof(_this6.form.subCategory) === 'object') {
                if (_this6.form.subCategory.code !== undefined && typeof _this6.form.subCategory.code !== 'string') {
                  // Create a new object with code as string
                  _this6.form.subCategory = _objectSpread(_objectSpread({}, _this6.form.subCategory), {}, {
                    code: String(_this6.form.subCategory.code)
                  });
                }
              }
              _context4.next = 3;
              return _this6.form.patch(window.location.origin + '/api/expenses/' + _this6.$route.params.slug).then(function () {
                ...
                _this6.$toast.success(_this6.$t('Expense updated successfully'));
                _this6.$router.push({
                  name: 'expenses.index'
                });
                ...
                if ((error === null || error === void 0 || (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 422 && error !== null && error !== void 0 && (_error$response2 = error.response) !== null && _error$response2 !== void 0 && (_error$response2 = _error$response2.data) !== null && _error$response2 !== void 0 && _error$response2.errors) {
                  ...
                  if (errorMessages.length > 0) {
                    ...
                    var firstError = errorMessages[0];
                    // Try to translate if possible, otherwise use as-is
                    var translatedError = _this6.$t(firstError);
                    _this6.$toast.error(translatedError !== firstError ? translatedError : firstError);
                  } else {
                    _this6.$toast.error(_this6.$t('Please check your input and try again.'));
                  }
                } else {
                  var _error$response3, _error$response4;
                  // Handle other errors
                  var errorMessage = (error === null || error === void 0 || (_error$response3 = error.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || (error === null || error === void 0 || (_error$response4 = error.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.error) || _this6.$t('Please check your input and try again.');
                  var _translatedError = _this6.$t(errorMessage);
                  _this6.$toast.error(_translatedError !== errorMessage ? _translatedError : errorMessage);
                }
              });
            case 3:
            case "end":
...
;// CONCATENATED MODULE: ./resources/js/pages/expenses/edit.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_38f36945_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_editvue_type_style_index_0_id_38f36945_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_38f36945_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/expenses/edit.vue?vue&type=style&index=0&id=38f36945&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/expenses/edit.vue
