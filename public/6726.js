...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-30578c9b]{gap:10px}.header-buttons[data-v-30578c9b]{margin-bottom:15px}.footer-buttons[data-v-30578c9b]{display:flex;gap:10px}.footer-buttons .btn[data-v-30578c9b]{margin-right:10px}.footer-buttons .btn[data-v-30578c9b]:last-child{margin-right:0}.card[data-v-30578c9b]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-30578c9b]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-30578c9b]{padding:1.25rem}.card-footer[data-v-30578c9b]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.btn-primary[data-v-30578c9b]{background:#2ab930!important}.btn-primary[data-v-30578c9b],.btn-secondary[data-v-30578c9b]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-30578c9b]{background:#33a0d9!important}.btn-secondary[data-v-30578c9b]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/create.vue?vue&type=template&id=30578c9b&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_30578c9b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_createvue_type_style_index_0_id_30578c9b_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_30578c9b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/expenses/create.vue?vue&type=style&index=0&id=30578c9b&prod&scoped=true&lang=css
