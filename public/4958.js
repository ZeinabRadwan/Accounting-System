...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-2817715e]{gap:10px}.header-buttons[data-v-2817715e]{margin-bottom:15px}.footer-buttons[data-v-2817715e]{display:flex;gap:10px}.footer-buttons .btn[data-v-2817715e]{margin-right:10px}.footer-buttons .btn[data-v-2817715e]:last-child{margin-right:0}.card[data-v-2817715e]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-2817715e]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-2817715e]{background:#fff!important}.btn-primary[data-v-2817715e]{background:#2ab930!important}.btn-primary[data-v-2817715e],.btn-secondary[data-v-2817715e]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-2817715e]{background:#33a0d9!important}.btn-secondary[data-v-2817715e]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.table th[data-v-2817715e]{background-color:#f8f9fa;font-weight:600}.invalid-feedback[data-v-2817715e]{display:block}.je-lines-table thead th[data-v-2817715e]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;font-weight:600}.je-lines-table td[data-v-2817715e]{vertical-align:middle}.je-summary-row td[data-v-2817715e]{background:#fafbfc;border-top:2px solid #e5e7eb}.add-line-btn[data-v-2817715e]{border-radius:8px!important;padding:8px 14px!important}.je-lines-actions[data-v-2817715e]{padding:12px 16px}.table-responsive[data-v-2817715e]{overflow:visible}.v-select .vs__dropdown-menu[data-v-2817715e]{z-index:1050!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/journal-entries/edit.vue?vue&type=template&id=2817715e&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_2817715e_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const journal_entries_editvue_type_style_index_0_id_2817715e_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_2817715e_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/journal-entries/edit.vue?vue&type=style&index=0&id=2817715e&prod&scoped=true&lang=css
