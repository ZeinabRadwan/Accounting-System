"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3089],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-pills .nav-item[data-v-2b726186]{background:#ddd;border-radius:.25rem;margin:2px}.invoices-table[data-v-2b726186]{border-collapse:separate;border-spacing:0}.invoices-table thead th[data-v-2b726186]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-table thead tr[data-v-2b726186]{border:none!important}.invoices-table thead th[data-v-2b726186]:first-child{border-top-left-radius:10px}.invoices-table thead th[data-v-2b726186]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-table thead th[data-v-2b726186]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-table thead th[data-v-2b726186]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-table .badge.bg-success[data-v-2b726186]{background-color:#28a745!important}.invoices-table .badge.bg-danger[data-v-2b726186],.invoices-table .badge.bg-success[data-v-2b726186]{border-radius:4px;color:#fff!important;font-size:.75rem;padding:4px 8px}.invoices-table .badge.bg-danger[data-v-2b726186]{background-color:#dc3545!important}.invoices-table td[data-v-2b726186]{overflow:visible;position:relative}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/show.vue?vue&type=template&id=2b726186&scoped=true
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_2b726186_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const employees_showvue_type_style_index_0_id_2b726186_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_2b726186_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/employees/show.vue?vue&type=style&index=0&id=2b726186&prod&scoped=true&lang=css
