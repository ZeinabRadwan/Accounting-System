"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9581],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-52e4346e]{border:none!important}.inventory-history-table[data-v-52e4346e]{border-collapse:separate;border-spacing:0}.inventory-history-table thead th[data-v-52e4346e]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.inventory-history-table thead tr[data-v-52e4346e]{border:none!important}.inventory-history-table thead th[data-v-52e4346e]:first-child{border-top-left-radius:10px}.inventory-history-table thead th[data-v-52e4346e]:last-child{border-top-right-radius:10px}[dir=rtl] .inventory-history-table thead th[data-v-52e4346e]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .inventory-history-table thead th[data-v-52e4346e]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-52e4346e]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-52e4346e],.export-pdf-btn[data-v-52e4346e]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-52e4346e],.export-pdf-btn[data-v-52e4346e],.print-btn[data-v-52e4346e]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-52e4346e]{background:#33a0d91a!important;color:#33a0d9!important}.card[data-v-52e4346e]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-52e4346e]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.inventory-history-table .badge[data-v-52e4346e]{font-size:12px!important;font-weight:500!important;padding:8px 12px}.inventory-history-table .badge.bg-success[data-v-52e4346e]{background:#f6fef4!important;color:#2ab930!important}.inventory-history-table .badge.bg-primary[data-v-52e4346e]{background:#e3f2fd!important;color:#1976d2!important}.inventory-history-table .badge.bg-warning[data-v-52e4346e]{background:#fff8e1!important;color:#f57c00!important}.inventory-history-table .badge.bg-danger[data-v-52e4346e]{background:#fef4f4!important;color:#dc3545!important}.inventory-history-table .badge.bg-info[data-v-52e4346e]{background:#e0f2f1!important;color:#00695c!important}.inventory-history-table .badge.bg-secondary[data-v-52e4346e]{background:#f5f5f5!important;color:#6c757d!important}.form-control[data-v-52e4346e]{background:#fff!important}.btn-group.c-w-100[data-v-52e4346e]{gap:10px}.text-success[data-v-52e4346e]{color:#2ab930!important;font-weight:600}.text-danger[data-v-52e4346e]{color:#dc3545!important;font-weight:600}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history-general.vue?vue&type=template&id=52e4346e&scoped=true
...
/* harmony default export */ const history_generalvue_type_script_lang_js = ({
  ...
  data: function data() {
    return {
      ...
      loading: false,
      items: [],
      // Store current page items from server
      pagination: null,
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var hasSearchOrFilter, endpoint, page, queryParams, queryString, fullUrl, response, responseData, data, serverPage, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ...
              hasSearchOrFilter = _this2.query && _this2.query.trim() !== '' || _this2.filterType !== 'default';
              endpoint = hasSearchOrFilter ? '/api/inventory-history/search' : '/api/inventory-history'; // Ensure currentPage is a valid number
              page = parseInt(_this2.currentPage) || 1; // Build query string manually to ensure all params are included
              // Always include page parameter
              queryParams = new URLSearchParams();
              queryParams.append('page', page.toString());
              queryParams.append('perPage', _this2.perPage.toString());
              queryParams.append('term', _this2.query || '');
              queryParams.append('filterType', _this2.filterType || 'default');
              queryParams.append('startDate', _this2.startDate || '');
              queryParams.append('endDate', _this2.endDate || '');
              queryString = queryParams.toString();
              fullUrl = "".concat(window.location.origin).concat(endpoint, "?").concat(queryString);
              console.log('Loading page:', page, 'Full URL:', fullUrl);
              _context2.n = 2;
              return axios_default().get(fullUrl);
            case 2:
              ...
              _this2.items = Array.isArray(responseData) ? responseData : [];
              console.log('Items loaded:', _this2.items.length);

              // Parse pagination info (convert strings to numbers if needed)
              data = response.data || {};
              serverPage = parseInt(data.current_page) || parseInt(_this2.currentPage) || 1;
              _this2.pagination = {
                current_page: serverPage,
                per_page: parseInt(data.per_page) || parseInt(_this2.perPage) || 10,
              ...
              _this2.currentPage = serverPage;
              _context2.n = 4;
              break;
            case 3:
              _context2.p = 3;
              _t = _context2.v;
              console.error('Error loading inventory history:', _t);
              _this2.items = [];
              _this2.pagination = {
                current_page: 1,
...
var update = injectStylesIntoStyleTag_default()(history_generalvue_type_style_index_0_id_52e4346e_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const inventory_history_generalvue_type_style_index_0_id_52e4346e_prod_scoped_true_lang_css = (history_generalvue_type_style_index_0_id_52e4346e_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/inventory/history-general.vue?vue&type=style&index=0&id=52e4346e&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history-general.vue?vue&type=style&index=1&id=52e4346e&prod&lang=css
var history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css = __webpack_require__(23238);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history-general.vue?vue&type=style&index=1&id=52e4346e&prod&lang=css

            

var history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css_options = {};

history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css_options.insert = "head";
history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css_options.singleton = false;

var history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css_update = injectStylesIntoStyleTag_default()(history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css/* default */.A, history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css_options);



/* harmony default export */ const inventory_history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css = (history_generalvue_type_style_index_1_id_52e4346e_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/inventory/history-general.vue?vue&type=style&index=1&id=52e4346e&prod&lang=css
