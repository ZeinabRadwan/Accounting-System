"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5448,8717],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=3c7a14de&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    attrs: {
      "for": "analytical_account_id"
    }
  }, [_vm._v(_vm._s(_vm.$t("Analytical Account")))]), _vm._v(" "), _c('v-select', {
    attrs: {
    ...
    model: {
      value: _vm.filters.analyticalAccountId,
      callback: function callback($$v) {
        _vm.$set(_vm.filters, "analyticalAccountId", $$v);
      },
      expression: "filters.analyticalAccountId"
    }
  })], 1)]), _vm._v(" "), _c('div', {
    staticClass: "col-md-3"
  }, [_c('div', {
  ...
  }, [_vm.reportData && _vm.reportData.trial_balance && _vm.reportData.trial_balance.length > 0 ? _c('button', {
...
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=3c7a14de&scoped=true
  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all([_this.loadChartOfAccounts(), _this.loadCostCenters(), _this.loadAnalyticalAccounts()]);
            case 2:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 8:
              ...
              console.error('Error loading cost centers:', _context4.t0);
              _this4.$toast.error('', ((_error$response3 = _context4.t0.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || _this4.$t("Failed to load cost centers"));
              _this4.costCenters = [];
            case 13:
              _context4.prev = 13;
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 9:
              ...
              _this5.$toast.error('', ((_error$response4 = _context5.t0.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || _this5.$t("Failed to search chart of accounts"));
            case 12:
              _context5.prev = 12;
              loading(false);
    ...
    searchSubChartOfAccounts: function searchSubChartOfAccounts(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var _yield$axios$get4, data, _error$response5;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 11:
              ...
              _this6.$toast.error('', ((_error$response5 = _context6.t0.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || _this6.$t("Failed to search sub accounts"));
            case 14:
              _context6.prev = 14;
              loading(false);
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 8:
              ...
              console.error('Error searching cost centers:', _context7.t0);
              _this7.$toast.error('', ((_error$response6 = _context7.t0.response) === null || _error$response6 === void 0 || (_error$response6 = _error$response6.data) === null || _error$response6 === void 0 ? void 0 : _error$response6.message) || _this7.$t("Failed to search cost centers"));
              _this7.costCenters = [];
            case 13:
              _context7.prev = 13;
              if (loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _this8.loadingAnalyticalAccounts = true;
              _context8.prev = 1;
              _context8.next = 4;
              return axios_default().get("/api/analytical-accounts/all", {
                params: {
                  limit: 100
                }
              });
            case 4:
              ...
              if (response.data && Array.isArray(response.data)) {
                _this8.analyticalAccounts = response.data.map(function (account) {
                  return _objectSpread(_objectSpread({}, account), {}, {
                    display_name: "[".concat(account.code, "] ").concat(account.name)
                  });
                });
              } else if (response.data && response.data.data && Array.isArray(response.data.data)) {
                _this8.analyticalAccounts = response.data.data.map(function (account) {
                  return _objectSpread(_objectSpread({}, account), {}, {
                    display_name: "[".concat(account.code, "] ").concat(account.name)
                  });
                });
              } else {
                _this8.analyticalAccounts = [];
              }
              _context8.next = 13;
              break;
            case 8:
              ...
              console.error('Error loading analytical accounts:', _context8.t0);
              _this8.$toast.error('', ((_error$response7 = _context8.t0.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || _this8.$t("Failed to load analytical accounts"));
              _this8.analyticalAccounts = [];
            case 13:
              _context8.prev = 13;
              _this8.loadingAnalyticalAccounts = false;
              return _context8.finish(13);
            case 16:
            case "end":
              return _context8.stop();
          }
        }, _callee8, null, [[1, 8, 13, 16]]);
      }))();
    },
    searchAnalyticalAccounts: function searchAnalyticalAccounts(search, loading) {
      var _this9 = this;
          ...
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              if (loading) {
                ...
                _this9.loadingAnalyticalAccounts = true;
              }
              _context9.prev = 1;
              _context9.next = 4;
              return axios_default().get("/api/analytical-accounts/all", {
            ...
            case 4:
              ...
              if (response.data && Array.isArray(response.data)) {
                _this9.analyticalAccounts = response.data.map(function (account) {
                  return _objectSpread(_objectSpread({}, account), {}, {
                    display_name: "[".concat(account.code, "] ").concat(account.name)
                  });
                });
              } else if (response.data && response.data.data && Array.isArray(response.data.data)) {
                _this9.analyticalAccounts = response.data.data.map(function (account) {
                  return _objectSpread(_objectSpread({}, account), {}, {
                    display_name: "[".concat(account.code, "] ").concat(account.name)
                  });
                });
              } else {
                _this9.analyticalAccounts = [];
              }
              _context9.next = 13;
              break;
            case 8:
              ...
              console.error('Error searching analytical accounts:', _context9.t0);
              _this9.$toast.error('', ((_error$response8 = _context9.t0.response) === null || _error$response8 === void 0 || (_error$response8 = _error$response8.data) === null || _error$response8 === void 0 ? void 0 : _error$response8.message) || _this9.$t("Failed to search analytical accounts"));
              _this9.analyticalAccounts = [];
            case 13:
              _context9.prev = 13;
              if (loading) {
                ...
                _this9.loadingAnalyticalAccounts = false;
              }
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0() {
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              if (!(!_this0.filters.fromDate || !_this0.filters.toDate)) {
                _context0.next = 3;
                break;
              }
              _this0.$toast.error('', _this0.$t('Please select date range'));
              return _context0.abrupt("return");
            case 3:
              _this0.loading = true;
              _this0.allAccounts = [];
              _this0.calculatingAccounts.clear();
              _context0.prev = 6;
              params = new URLSearchParams();
              if (_this0.filters.chartOfAccountId) {
                params.append('chart_of_account_id', _this0.filters.chartOfAccountId);
              }
              if (_this0.filters.subChartOfAccountId) {
                params.append('sub_chart_of_account_id', _this0.filters.subChartOfAccountId);
              }
              if (_this0.filters.costCenterId) {
                params.append('cost_center_id', _this0.filters.costCenterId);
              }
              if (_this0.filters.analyticalAccountId) {
                params.append('analytical_account_id', _this0.filters.analyticalAccountId);
              }
              if (_this0.filters.accountLevel) {
                params.append('account_level', _this0.filters.accountLevel);
              }
              params.append('from_date', _this0.filters.fromDate);
              params.append('to_date', _this0.filters.toDate);
              _context0.next = 17;
            ...
            case 17:
              ...
              if (response.data && response.data.success === true) {
                ...
                _this0.reportData = response.data.data;
                _this0.allAccounts = _toConsumableArray(((_response$data$data = response.data.data) === null || _response$data$data === void 0 ? void 0 : _response$data$data.trial_balance) || []);
                ...
                _this0.expandAll();
                _this0.$toast.success('', _this0.$t("Trial balance loaded successfully"));
              } else {
                errorMsg = ((_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.message) || _this0.$t("Failed to generate trial balance report");
                console.error('API Error:', errorMsg);
                _this0.$toast.error('', errorMsg);
              }
              _context0.next = 27;
              break;
            case 21:
              ...
              console.error('Trial Balance Error:', _context0.t0);
              errorMessage = _this0.$t("Failed to generate trial balance report");
              if (_context0.t0 && _typeof(_context0.t0) === 'object') {
              ...
              _this0.$toast.error('', errorMessage);
            case 27:
              _context0.prev = 27;
              _this0.loading = false;
              return _context0.finish(27);
            case 30:
            case "end":
              return _context0.stop();
          }
        }, _callee0, null, [[6, 21, 27, 30]]);
      }))();
    },
    ...
    buildHierarchicalList: function buildHierarchicalList(accounts) {
      ...
      accounts.forEach(function (account) {
        var accountWithLevel = _objectSpread(_objectSpread({}, account), {}, {
          level: level,
          expanded: _this1.expandedNodes.includes(account.id),
        ...
        if (accountWithLevel.expanded && account.children && account.children.length > 0) {
          var children = _this1.buildHierarchicalList(account.children, level + 1);
          ...
          if (children.length > 0) {
            ...
            var childrenTotals = _this1.calculateChildrenTotals(account.children);
            var totalRow = {
    ...
    calculateChildrenTotals: function calculateChildrenTotals(childrenAccounts) {
      ...
      var calculateFromAccount = function calculateFromAccount(account) {
    ...
    applyAccountFilters: function applyAccountFilters(accounts) {
      ...
      var shouldShowAccount = function shouldShowAccount(account) {
        switch (_this10.filters.accountDisplayFilter) {
          case 'transactions_only':
            // Show only accounts with transactions
            return _this10.accountHasTransactions(account);
          case 'hide_zero_balance':
            // Hide accounts with zero closing balance
            return !_this10.accountHasZeroBalance(account);
          case 'hide_zero_opening':
            // Hide accounts with zero opening balance
            return !_this10.accountHasZeroOpeningBalance(account);
          default:
            return true;
        }
      };
    ...
    filterAccountHierarchy: function filterAccountHierarchy(accounts, filterFn) {
      ...
      accounts.forEach(function (account) {
        ...
        if (account.children && account.children.length > 0) {
          var filteredChildren = _this11.filterAccountHierarchy(account.children, filterFn);
    ...
    addAllAccountIds: function addAllAccountIds(accounts) {
      ...
      accounts.forEach(function (account) {
        if (account.children && account.children.length > 0) {
          if (!_this12.expandedNodes.includes(account.id)) {
            _this12.expandedNodes.push(account.id);
          }
          _this12.addAllAccountIds(account.children);
        }
      });
    },
...
var update = injectStylesIntoStyleTag_default()(trial_balancevue_type_style_index_0_id_3c7a14de_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_trial_balancevue_type_style_index_0_id_3c7a14de_prod_scoped_true_lang_css = (trial_balancevue_type_style_index_0_id_3c7a14de_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=style&index=0&id=3c7a14de&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-3c7a14de]{border:none!important}.account-statement-table[data-v-3c7a14de]{border-collapse:separate;border-spacing:0}.account-statement-table thead th[data-v-3c7a14de]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.account-statement-table thead tr[data-v-3c7a14de]{border:none!important}.account-statement-table thead th[data-v-3c7a14de]:first-child{border-top-left-radius:10px}.account-statement-table thead th[data-v-3c7a14de]:last-child{border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-3c7a14de]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-3c7a14de]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-3c7a14de]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.export-excel-btn[data-v-3c7a14de],.export-pdf-btn[data-v-3c7a14de],.preview-btn[data-v-3c7a14de]{background:#f6fef4!important;border:none;border-radius:10px;color:#2ab930!important}.print-btn[data-v-3c7a14de]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.btn-group.c-w-100[data-v-3c7a14de]{gap:10px}.card[data-v-3c7a14de]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-3c7a14de]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-3c7a14de]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.table-responsive[data-v-3c7a14de]{border:1px solid #dee2e6;border-radius:.375rem;overflow-y:auto}.table-sm td[data-v-3c7a14de],.table-sm th[data-v-3c7a14de]{font-size:.875rem;padding:.5rem .75rem}.table th[data-v-3c7a14de]{border-bottom:2px solid #dee2e6;color:#495057;font-weight:600}.table tbody tr[data-v-3c7a14de]:hover,.table th[data-v-3c7a14de]{background-color:#f8f9fa}.table tbody tr.table-info[data-v-3c7a14de]{background-color:#e3f2fd;font-weight:600}.table tbody tr.table-info[data-v-3c7a14de]:hover{background-color:#bbdefb}.info-box[data-v-3c7a14de]{background:#f8f9fa;border-radius:.375rem;margin-bottom:1rem;padding:1rem}.info-box[data-v-3c7a14de],.info-box-icon[data-v-3c7a14de]{align-items:center;display:flex}.info-box-icon[data-v-3c7a14de]{border-radius:50%;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-3c7a14de]{flex:1}.info-box-text[data-v-3c7a14de]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-3c7a14de]{color:#495057;display:block;font-size:1.5rem;font-weight:700}.badge[data-v-3c7a14de]{font-size:.75rem;padding:.25rem .5rem}.font-weight-bold[data-v-3c7a14de]{color:#212529}.text-muted[data-v-3c7a14de]{color:#6c757d!important}.btn-link[data-v-3c7a14de]{background:none;border:none;color:#007bff;padding:0;text-decoration:none}.btn-link[data-v-3c7a14de]:hover{color:#0056b3;text-decoration:none}.btn-link[data-v-3c7a14de]:focus{box-shadow:none;outline:none}.tree-toggle-icon[data-v-3c7a14de]{transition:transform .2s ease}.tree-toggle-icon.expanded[data-v-3c7a14de]{transform:rotate(90deg)}.tree-item-icon[data-v-3c7a14de]{text-align:center;width:16px}.gap-2>*+*[data-v-3c7a14de]{margin-left:.5rem}@media (max-width:768px){.gap-2[data-v-3c7a14de]{align-items:stretch;flex-direction:column}.gap-2>*+*[data-v-3c7a14de]{margin-left:0;margin-top:.5rem}}.trial-balance-table[data-v-3c7a14de]{background:#fff;border:1px solid #dee2e6;font-size:16px}.table-header[data-v-3c7a14de],.table-header th[data-v-3c7a14de]{background:#f8f9fa}.table-header th[data-v-3c7a14de]{border:1px solid #dee2e6;color:#495057;font-size:16px;font-weight:600;padding:12px 8px}.header-code[data-v-3c7a14de]{width:10%}.header-account[data-v-3c7a14de]{width:30%}.header-amount[data-v-3c7a14de]{font-size:16px;width:12%}.trial-balance-table tbody tr[data-v-3c7a14de]{border-bottom:1px solid #dee2e6}.trial-balance-table tbody tr[data-v-3c7a14de]:hover{background:#f8f9fa}.trial-balance-table tbody tr.table-info[data-v-3c7a14de]{background:#e9ecef;border-left:3px solid #6c757d;font-weight:600}.trial-balance-table tbody tr.table-info[data-v-3c7a14de]:hover{background:#dee2e6}.trial-balance-table tbody tr.table-warning[data-v-3c7a14de]{background:#fff3cd;border-left:3px solid #ffc107;font-weight:600}.trial-balance-table tbody tr.table-warning[data-v-3c7a14de]:hover{background:#ffeaa7}.cell-code[data-v-3c7a14de]{background:#f8f9fa}.cell-account[data-v-3c7a14de],.cell-amount[data-v-3c7a14de]{background:#fff}.cell-amount[data-v-3c7a14de]{font-weight:600}.account-code-badge[data-v-3c7a14de]{background:#6c757d;border-radius:4px;color:#fff;display:inline-block;font-size:16px;font-weight:600;padding:4px 8px}.account-name-container[data-v-3c7a14de]{align-items:center;display:flex;padding:8px 0}.expand-btn[data-v-3c7a14de]{align-items:center;background:none;border:none;border-radius:2px;color:#6c757d;display:flex;font-size:16px;height:20px;justify-content:center;margin-right:8px;min-width:20px;padding:2px;transition:color .2s ease}.expand-btn[data-v-3c7a14de]:hover{background:#f8f9fa;color:#495057}.expand-spacer[data-v-3c7a14de]{margin-right:8px;width:24px}.account-icon[data-v-3c7a14de]{font-size:16px;margin-right:8px;text-align:center;width:16px}.account-icon.fa-folder[data-v-3c7a14de]{color:#6c757d}.account-icon.fa-folder-open[data-v-3c7a14de]{color:#495057}.account-icon.fa-file[data-v-3c7a14de]{color:#adb5bd}.account-name[data-v-3c7a14de]{color:#2c3e50;font-size:16px;font-weight:600}.total-row-name[data-v-3c7a14de]{color:#d63384;font-style:italic;font-weight:700}.amount-value[data-v-3c7a14de]{background:none;color:#495057;display:inline-block;font-size:16px;font-weight:600;min-width:80px;padding:0;text-align:right}.credit-amount[data-v-3c7a14de],.debit-amount[data-v-3c7a14de]{background:none;border:none;color:#495057}.closing-amount[data-v-3c7a14de]{background:none;font-size:16px;font-weight:800}.amount-empty[data-v-3c7a14de]{color:#adb5bd;font-size:16px;font-style:italic}.table-footer[data-v-3c7a14de]{background:#f8f9fa;color:#495057}.grand-total-row[data-v-3c7a14de]{background:#e9ecef;border-top:2px solid #6c757d}.grand-total-label[data-v-3c7a14de]{font-weight:700;padding:12px 8px}.grand-total-amount[data-v-3c7a14de],.grand-total-label[data-v-3c7a14de]{background:none;color:#495057;font-size:16px}.grand-total-amount[data-v-3c7a14de]{border:none;font-weight:600;margin:0;padding:0}.grand-total-amount.credit-amount[data-v-3c7a14de],.grand-total-amount.debit-amount[data-v-3c7a14de]{background:none;border:none}@media print{.no-print[data-v-3c7a14de]{display:none!important}.card[data-v-3c7a14de]{border:none!important;box-shadow:none!important}.table[data-v-3c7a14de]{font-size:16px}.table-responsive[data-v-3c7a14de]{overflow:visible}}@media (max-width:1300px){.info-box[data-v-3c7a14de]{padding:0}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
