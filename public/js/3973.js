...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/roles/index.vue?vue&type=template&id=59e2f1b8
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('breadcrumbs', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var row = _ref.row;
        return [_vm.developer || row.slug != 'developer' && row.slug != 'super-admin' ? _c('div', {
          staticClass: "btn-group"
        }, [row && row.slug ? _c('router-link', {
          directives: [{
            name: "tooltip",
            rawName: "v-tooltip",
            value: _vm.$t('Edit'),
...
/* harmony default export */ const rolesvue_type_script_lang_js = ({
  ...
  // Map Getters
  computed: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "loading", "pagination"])), (0,vuex_esm/* mapGetters */.L8)("auth", ["user"])), {}, {
    roleColumns: function roleColumns() {
      return [{
        key: "index",
        label: this.$t("#"),
        sortable: false
    ...
    rolesWithIndex: function rolesWithIndex() {
      var _this = this;
...
var update = injectStylesIntoStyleTag_default()(rolesvue_type_style_index_0_id_59e2f1b8_prod_lang_css/* default */.A, options);



/* harmony default export */ const setup_rolesvue_type_style_index_0_id_59e2f1b8_prod_lang_css = (rolesvue_type_style_index_0_id_59e2f1b8_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/setup/roles/index.vue?vue&type=style&index=0&id=59e2f1b8&prod&lang=css
