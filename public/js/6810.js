"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[150,6810],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=b4eaccdc&scoped=true
var render = function render() {
  ...
  })], 2), _vm._v(" "), _vm.reportData.grand_totals ? _c('tfoot', {
...
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=b4eaccdc&scoped=true
...
var CurrencyDisplay = __webpack_require__(90150);
  ...
  methods: {
    ...
    loadFiscalYears: function loadFiscalYears() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var _yield$axios$get3, data, _error$response3, _t3;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 3:
              _context4.p = 3;
              _t3 = _context4.v;
              _this4.$toast.error('', ((_error$response3 = _t3.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || _this4.$t("Failed to load fiscal years"));
            case 4:
              _context4.p = 4;
    ...
    loadAccountingPeriods: function loadAccountingPeriods(fiscalYearId) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var _yield$axios$get4, data, _error$response4, _t4;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            ...
            case 4:
              _context5.p = 4;
              _t4 = _context5.v;
              _this5.$toast.error('', ((_error$response4 = _t4.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || _this5.$t("Failed to load accounting periods"));
            case 5:
              _context5.p = 5;
    ...
    searchChartOfAccounts: function searchChartOfAccounts(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var _yield$axios$get5, data, _error$response5, _t5;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 3:
              _context6.p = 3;
              _t5 = _context6.v;
              _this6.$toast.error('', ((_error$response5 = _t5.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || _this6.$t("Failed to search chart of accounts"));
            case 4:
              _context6.p = 4;
              loading(false);
    ...
    searchSubChartOfAccounts: function searchSubChartOfAccounts(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var _yield$axios$get6, data, _error$response6, _t6;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 4:
              _context7.p = 4;
              _t6 = _context7.v;
              _this7.$toast.error('', ((_error$response6 = _t6.response) === null || _error$response6 === void 0 || (_error$response6 = _error$response6.data) === null || _error$response6 === void 0 ? void 0 : _error$response6.message) || _this7.$t("Failed to search sub accounts"));
            case 5:
              _context7.p = 5;
              loading(false);
    ...
    searchFiscalYears: function searchFiscalYears(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var _yield$axios$get7, data, _error$response7, _t7;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 3:
              _context8.p = 3;
              _t7 = _context8.v;
              _this8.$toast.error('', ((_error$response7 = _t7.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || _this8.$t("Failed to search fiscal years"));
            case 4:
              _context8.p = 4;
              loading(false);
    ...
    searchAccountingPeriods: function searchAccountingPeriods(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var _yield$axios$get8, data, _error$response8, _t8;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            ...
            case 4:
              _context9.p = 4;
              _t8 = _context9.v;
              _this9.$toast.error('', ((_error$response8 = _t8.response) === null || _error$response8 === void 0 || (_error$response8 = _error$response8.data) === null || _error$response8 === void 0 ? void 0 : _error$response8.message) || _this9.$t("Failed to search accounting periods"));
            case 5:
              _context9.p = 5;
              loading(false);
    ...
    generateReport: function generateReport() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var params, response, _response$data$data, _response$data, errorMsg, errorMessage, _t9;
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            case 0:
              ...
              if (_this0.filters.fiscalYearId) {
                params.append('fiscal_year_id', _this0.filters.fiscalYearId);
              }
              if (_this0.filters.accountingPeriodId) {
                params.append('accounting_period_id', _this0.filters.accountingPeriodId);
              }
              if (_this0.filters.fromDate) {
                params.append('from_date', _this0.filters.fromDate);
              }
              if (_this0.filters.toDate) {
            ...
            case 2:
              ...
              if (response.data && response.data.success === true) {
                ...
                _this0.$toast.success('', _this0.$t("Trial balance structure loaded. Calculating balances..."));
                console.log('✅ All accounts loaded:', _this0.allAccounts.length);

                // Start calculating balances in chunks
                if (_this0.allAccounts.length > 0) {
                  _this0.startBalanceCalculations();
                }
              } else {
            ...
            case 3:
              _context0.p = 3;
              _t9 = _context0.v;
              console.error('Trial Balance Error:', _t9);
              errorMessage = _this0.$t("Failed to generate trial balance report");
              if (_t9 && _typeof(_t9) === 'object') {
    ...
    startBalanceCalculations: function startBalanceCalculations() {
      ...
      allAccountIds.forEach(function (accountId) {
        _this1.calculatingAccounts.add(accountId);
      });
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 1:
              ...
              _context1.p = 2;
              _context1.n = 3;
              return _this10.calculateSingleAccountBalance(accountId);
            case 3:
            ...
            case 5:
              _context1.p = 5;
              _t0 = _context1.v;
              console.error("\u274C Error processing account ".concat(accountId, ":"), _t0);
            case 6:
              i++;
              _context1.n = 1;
              break;
    ...
    calculateSingleAccountBalance: function calculateSingleAccountBalance(accountId) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        var requestData, response, _response$data2, _t1;
          ...
          while (1) switch (_context10.p = _context10.n) {
            case 0:
              ...
              requestData = {
                ...
                fiscal_year_id: _this11.filters.fiscalYearId,
                accounting_period_id: _this11.filters.accountingPeriodId,
                from_date: _this11.filters.fromDate,
                to_date: _this11.filters.toDate
              };
            ...
            case 1:
              ...
              if (response.data && response.data.success === true) {
                ...
                _this11.updateSingleAccountBalance(response.data.data.account);
              } else {
            ...
            case 2:
              _context10.p = 2;
              _t1 = _context10.v;
              console.error('❌ Error calculating balance for account', accountId, ':', _t1);
            case 3:
    ...
    buildHierarchicalList: function buildHierarchicalList(accounts) {
      ...
      accounts.forEach(function (account) {
        var accountWithLevel = _objectSpread(_objectSpread({}, account), {}, {
          level: level,
          expanded: _this12.expandedNodes.includes(account.id),
        ...
        if (accountWithLevel.expanded && account.children && account.children.length > 0) {
          var children = _this12.buildHierarchicalList(account.children, level + 1);
...
var update = injectStylesIntoStyleTag_default()(trial_balancevue_type_style_index_0_id_b4eaccdc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_trial_balancevue_type_style_index_0_id_b4eaccdc_prod_scoped_true_lang_css = (trial_balancevue_type_style_index_0_id_b4eaccdc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=style&index=0&id=b4eaccdc&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-b4eaccdc]{border:none!important}.account-statement-table[data-v-b4eaccdc]{border-collapse:separate;border-spacing:0}.account-statement-table thead th[data-v-b4eaccdc]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.account-statement-table thead tr[data-v-b4eaccdc]{border:none!important}.account-statement-table thead th[data-v-b4eaccdc]:first-child{border-top-left-radius:10px}.account-statement-table thead th[data-v-b4eaccdc]:last-child{border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-b4eaccdc]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-b4eaccdc]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-b4eaccdc]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.export-excel-btn[data-v-b4eaccdc],.export-pdf-btn[data-v-b4eaccdc]{background:#f6fef4!important;border:none;border-radius:10px;color:#2ab930!important}.print-btn[data-v-b4eaccdc]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.btn-group.c-w-100[data-v-b4eaccdc]{gap:10px}.card[data-v-b4eaccdc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-b4eaccdc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-b4eaccdc]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.table-responsive[data-v-b4eaccdc]{border:1px solid #dee2e6;border-radius:.375rem;overflow-y:auto}.table-sm td[data-v-b4eaccdc],.table-sm th[data-v-b4eaccdc]{font-size:.875rem;padding:.5rem .75rem}.table th[data-v-b4eaccdc]{border-bottom:2px solid #dee2e6;color:#495057;font-weight:600}.table tbody tr[data-v-b4eaccdc]:hover,.table th[data-v-b4eaccdc]{background-color:#f8f9fa}.table tbody tr.table-info[data-v-b4eaccdc]{background-color:#e3f2fd;font-weight:600}.table tbody tr.table-info[data-v-b4eaccdc]:hover{background-color:#bbdefb}.info-box[data-v-b4eaccdc]{background:#f8f9fa;border-radius:.375rem;margin-bottom:1rem;padding:1rem}.info-box[data-v-b4eaccdc],.info-box-icon[data-v-b4eaccdc]{align-items:center;display:flex}.info-box-icon[data-v-b4eaccdc]{border-radius:50%;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-b4eaccdc]{flex:1}.info-box-text[data-v-b4eaccdc]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-b4eaccdc]{color:#495057;display:block;font-size:1.5rem;font-weight:700}.badge[data-v-b4eaccdc]{font-size:.75rem;padding:.25rem .5rem}.font-weight-bold[data-v-b4eaccdc]{color:#212529}.text-muted[data-v-b4eaccdc]{color:#6c757d!important}.btn-link[data-v-b4eaccdc]{background:none;border:none;color:#007bff;padding:0;text-decoration:none}.btn-link[data-v-b4eaccdc]:hover{color:#0056b3;text-decoration:none}.btn-link[data-v-b4eaccdc]:focus{box-shadow:none;outline:none}.tree-toggle-icon[data-v-b4eaccdc]{transition:transform .2s ease}.tree-toggle-icon.expanded[data-v-b4eaccdc]{transform:rotate(90deg)}.tree-item-icon[data-v-b4eaccdc]{text-align:center;width:16px}.gap-2>*+*[data-v-b4eaccdc]{margin-left:.5rem}@media (max-width:768px){.gap-2[data-v-b4eaccdc]{align-items:stretch;flex-direction:column}.gap-2>*+*[data-v-b4eaccdc]{margin-left:0;margin-top:.5rem}}.trial-balance-table[data-v-b4eaccdc]{background:#fff;border:1px solid #dee2e6;font-size:16px}.table-header[data-v-b4eaccdc],.table-header th[data-v-b4eaccdc]{background:#f8f9fa}.table-header th[data-v-b4eaccdc]{border:1px solid #dee2e6;color:#495057;font-size:16px;font-weight:600;padding:12px 8px}.header-code[data-v-b4eaccdc]{width:10%}.header-account[data-v-b4eaccdc]{width:30%}.header-amount[data-v-b4eaccdc]{font-size:16px;width:12%}.trial-balance-table tbody tr[data-v-b4eaccdc]{border-bottom:1px solid #dee2e6}.trial-balance-table tbody tr[data-v-b4eaccdc]:hover{background:#f8f9fa}.trial-balance-table tbody tr.table-info[data-v-b4eaccdc]{background:#e9ecef;border-left:3px solid #6c757d;font-weight:600}.trial-balance-table tbody tr.table-info[data-v-b4eaccdc]:hover{background:#dee2e6}.trial-balance-table tbody tr.table-warning[data-v-b4eaccdc]{background:#fff3cd;border-left:3px solid #ffc107;font-weight:600}.trial-balance-table tbody tr.table-warning[data-v-b4eaccdc]:hover{background:#ffeaa7}.cell-code[data-v-b4eaccdc]{background:#f8f9fa}.cell-account[data-v-b4eaccdc],.cell-amount[data-v-b4eaccdc]{background:#fff}.cell-amount[data-v-b4eaccdc]{font-weight:600}.account-code-badge[data-v-b4eaccdc]{background:#6c757d;border-radius:4px;color:#fff;display:inline-block;font-size:16px;font-weight:600;padding:4px 8px}.account-name-container[data-v-b4eaccdc]{align-items:center;display:flex;padding:8px 0}.expand-btn[data-v-b4eaccdc]{align-items:center;background:none;border:none;border-radius:2px;color:#6c757d;display:flex;font-size:16px;height:20px;justify-content:center;margin-right:8px;min-width:20px;padding:2px;transition:color .2s ease}.expand-btn[data-v-b4eaccdc]:hover{background:#f8f9fa;color:#495057}.expand-spacer[data-v-b4eaccdc]{margin-right:8px;width:24px}.account-icon[data-v-b4eaccdc]{font-size:16px;margin-right:8px;text-align:center;width:16px}.account-icon.fa-folder[data-v-b4eaccdc]{color:#6c757d}.account-icon.fa-folder-open[data-v-b4eaccdc]{color:#495057}.account-icon.fa-file[data-v-b4eaccdc]{color:#adb5bd}.account-name[data-v-b4eaccdc]{color:#2c3e50;font-size:16px;font-weight:600}.total-row-name[data-v-b4eaccdc]{color:#d63384;font-style:italic;font-weight:700}.amount-value[data-v-b4eaccdc]{background:none;color:#495057;display:inline-block;font-size:16px;font-weight:600;min-width:80px;padding:0;text-align:right}.credit-amount[data-v-b4eaccdc],.debit-amount[data-v-b4eaccdc]{background:none;border:none;color:#495057}.closing-amount[data-v-b4eaccdc]{background:none;font-size:16px;font-weight:800}.amount-empty[data-v-b4eaccdc]{color:#adb5bd;font-size:16px;font-style:italic}.table-footer[data-v-b4eaccdc]{background:#f8f9fa;color:#495057}.grand-total-row[data-v-b4eaccdc]{background:#e9ecef;border-top:2px solid #6c757d}.grand-total-label[data-v-b4eaccdc]{font-weight:700;padding:12px 8px}.grand-total-amount[data-v-b4eaccdc],.grand-total-label[data-v-b4eaccdc]{background:none;color:#495057;font-size:16px}.grand-total-amount[data-v-b4eaccdc]{border:none;font-weight:600;margin:0;padding:0}.grand-total-amount.credit-amount[data-v-b4eaccdc],.grand-total-amount.debit-amount[data-v-b4eaccdc]{background:none;border:none}@media print{.no-print[data-v-b4eaccdc]{display:none!important}.card[data-v-b4eaccdc]{border:none!important;box-shadow:none!important}.table[data-v-b4eaccdc]{font-size:16px}.table-responsive[data-v-b4eaccdc]{overflow:visible}}", ""]);
// Exports
