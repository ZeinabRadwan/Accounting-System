  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 30:
              _this4.form.selectedProducts = _context4.sent;
            case 31:
            case "end":
    ...
    assignProducts: function assignProducts(products) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var key, _this5$taxes, _productData2, purchaseReturnItem, purchaseReturnProduct, productData, _productData, response, selectedVatRate, totalBeforeDiscount, discountAmount, totalAfterDiscount, productTax, totalTax, totalPrice, finalPurchaseAccountId;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _this5.form.selectedProducts = [];
              _context5.t0 = _regeneratorRuntime().keys(products);
            case 2:
            ...
            case 32:
              _this5.calculateSum();
              return _context5.abrupt("return", _this5.form.selectedProducts);
            case 34:
            case "end":
