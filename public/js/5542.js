(self["webpackChunk"] = self["webpackChunk"] || []).push([[5542],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-f83e8a8e]{border:none!important}.adjustments-table[data-v-f83e8a8e]{border-collapse:separate;border-spacing:0}.adjustments-table thead th[data-v-f83e8a8e]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.adjustments-table thead tr[data-v-f83e8a8e]{border:none!important}.adjustments-table thead th[data-v-f83e8a8e]:first-child{border-top-left-radius:10px}.adjustments-table thead th[data-v-f83e8a8e]:last-child{border-top-right-radius:10px}[dir=rtl] .adjustments-table thead th[data-v-f83e8a8e]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .adjustments-table thead th[data-v-f83e8a8e]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-f83e8a8e]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-f83e8a8e],.export-pdf-btn[data-v-f83e8a8e]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-f83e8a8e],.export-pdf-btn[data-v-f83e8a8e],.print-btn[data-v-f83e8a8e]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-f83e8a8e]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-f83e8a8e]{display:inline-block;position:relative}.action-icon-btn[data-v-f83e8a8e]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-f83e8a8e]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-f83e8a8e]{animation:slideInRight-f83e8a8e .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 20px 25px -5px rgba(0,0,0,.1),0 10px 10px -5px rgba(0,0,0,.04);max-width:250px;min-width:200px;position:fixed;right:50%;top:50%;transform:translate(50%,-50%);z-index:1000}.action-menu-header[data-v-f83e8a8e]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-f83e8a8e]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-f83e8a8e]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-f83e8a8e]:hover{background-color:#e5e7eb}.action-menu ul[data-v-f83e8a8e]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-f83e8a8e]{margin:0}.action-menu li a[data-v-f83e8a8e]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-f83e8a8e]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-f83e8a8e]{flex-shrink:0;height:16px;width:16px}.action-menu-backdrop[data-v-f83e8a8e]{animation:fadeIn-f83e8a8e .3s ease-out;background:rgba(0,0,0,.5);bottom:0;left:0;position:fixed;right:0;top:0;z-index:999}@keyframes slideInRight-f83e8a8e{0%{opacity:0;transform:translate(50%,-50%) translateX(20px)}to{opacity:1;transform:translate(50%,-50%) translateX(0)}}@keyframes fadeIn-f83e8a8e{0%{opacity:0}to{opacity:1}}.btn-group.c-w-100[data-v-f83e8a8e]{gap:10px}.btn-group.c-w-100>.btn[data-v-f83e8a8e]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-f83e8a8e]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-f83e8a8e]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-f83e8a8e]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-f83e8a8e]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.adjustments-table .badge.bg-success[data-v-f83e8a8e]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.adjustments-table .badge.bg-danger[data-v-f83e8a8e]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-f83e8a8e]{background:#f1f5fb!important}.btn-primary[data-v-f83e8a8e]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/adjustments/index.vue?vue&type=template&id=f83e8a8e&scoped=true
...
var update = injectStylesIntoStyleTag_default()(adjustmentsvue_type_style_index_0_id_f83e8a8e_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const inventory_adjustmentsvue_type_style_index_0_id_f83e8a8e_prod_scoped_true_lang_css = (adjustmentsvue_type_style_index_0_id_f83e8a8e_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/inventory/adjustments/index.vue?vue&type=style&index=0&id=f83e8a8e&prod&scoped=true&lang=css
