...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ payroll)
});

;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=template&id=0b70dbbd&scoped=true
var render = function render() {
  ...
  return _c('div', {
  ...
  })])]), _vm._v(" "), _vm.$can('payroll-create') ? _c('router-link', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var row = _ref.row;
        return [_vm.$can('employee-view') && row.employee ? _c('router-link', {
          attrs: {
            "to": {
              name: 'employees.show',
              params: {
        ...
        }, [_vm._v("\n                " + _vm._s(row.employee.name) + "\n              ")]) : _c('span', [_vm._v(_vm._s(row.employee && row.employee.name))])];
      }
    }, {
      key: "cell-empID",
      fn: function fn(_ref2) {
        var row = _ref2.row;
        return [row.employee ? _c('span', [_vm._v(_vm._s(_vm._f("withPrefix")(row.employee.empID, _vm.employeePrefix)))]) : _vm._e()];
      }
    }, {
      key: "cell-designation",
      fn: function fn(_ref3) {
        var row = _ref3.row;
        return [row.employee ? _c('span', [_vm._v(_vm._s(row.employee.designation))]) : _vm._e()];
      }
    }, {
      key: "cell-totalPaid",
      ...
      fn: function fn(_ref5) {
        var row = _ref5.row;
        return [row.transaction && row.transaction.cashbook_account ? _c('span', [_vm._v("\n                " + _vm._s(row.transaction.cashbook_account.account_number) + "\n              ")]) : _vm._e()];
      }
    }, {
      key: "cell-salaryDate",
      fn: function fn(_ref6) {
        var row = _ref6.row;
        return [row.salaryDate ? _c('span', [_vm._v(_vm._s(_vm._f("moment")(row.salaryDate, "Do MMM, YYYY")))]) : _vm._e()];
      }
    }, {
      key: "cell-status",
      ...
      fn: function fn(_ref8) {
        ...
        })])])]), _vm._v(" "), _c('ul', [_vm.$can('payroll-view') ? _c('li', [_c('router-link', {
          attrs: {
            "to": {
              name: 'payroll.show',
              params: {
        ...
        })]), _vm._v("\n                        " + _vm._s(_vm.$t('View')) + "\n                      ")])], 1) : _vm._e(), _vm._v(" "), _vm.$can('payroll-edit') ? _c('li', [_c('router-link', {
          attrs: {
            "to": {
              name: 'payroll.edit',
              params: {
        ...
        })]), _vm._v("\n                        " + _vm._s(_vm.$t('Edit')) + "\n                      ")])], 1) : _vm._e(), _vm._v(" "), _vm.$can('payroll-delete') ? _c('li', [_c('a', {
          attrs: {
            "href": "#"
          },
          on: {
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=script&lang=js
...
/* harmony default export */ const payrollvue_type_script_lang_js = ({
  middleware: ["auth", "check-permissions"],
  metaInfo: function metaInfo() {
    return {
      title: this.$t("Employee Payroll")
    };
  },
  components: {
  ...
  data: function data() {
    return {
      breadcrumbsCurrent: "Employee Payroll",
      breadcrumbs: [{
        name: "Dashboard",
        url: "home"
      }, {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "loading", "pagination", "appInfo"])), {}, {
    showActions: function showActions() {
      return this.$can('payroll-edit') || this.$can('payroll-view') || this.$can('payroll-delete');
    },
    ...
    payrollsWithIndex: function payrollsWithIndex() {
      var _this = this;
    ...
    exportUrl: function exportUrl() {
      ...
      return "/payroll/export/excel?start_date=".concat(this.dateRange.startDate, "&end_date=").concat(this.dateRange.endDate, "&term=").concat(this.query, "&locale=").concat(locale);
    }
  }),
  watch: {
    // watch search data
...
;// ./resources/js/pages/payroll/index.vue?vue&type=script&lang=js
 /* harmony default export */ const pages_payrollvue_type_script_lang_js = (payrollvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=style&index=0&id=0b70dbbd&prod&scoped=true&lang=css
var payrollvue_type_style_index_0_id_0b70dbbd_prod_scoped_true_lang_css = __webpack_require__(58489);
...
var update = injectStylesIntoStyleTag_default()(payrollvue_type_style_index_0_id_0b70dbbd_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_payrollvue_type_style_index_0_id_0b70dbbd_prod_scoped_true_lang_css = (payrollvue_type_style_index_0_id_0b70dbbd_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payroll/index.vue?vue&type=style&index=0&id=0b70dbbd&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=style&index=1&id=0b70dbbd&prod&lang=css
var payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css = __webpack_require__(21113);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=style&index=1&id=0b70dbbd&prod&lang=css

            

var payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css_options = {};

payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css_options.insert = "head";
payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css_options.singleton = false;

var payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css_update = injectStylesIntoStyleTag_default()(payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css/* default */.A, payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css_options);



/* harmony default export */ const pages_payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css = (payrollvue_type_style_index_1_id_0b70dbbd_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payroll/index.vue?vue&type=style&index=1&id=0b70dbbd&prod&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  pages_payrollvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ const payroll = (component.exports);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-0b70dbbd]{border:none!important}.payroll-table[data-v-0b70dbbd]{border-collapse:separate;border-spacing:0}.payroll-table thead th[data-v-0b70dbbd]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.payroll-table thead tr[data-v-0b70dbbd]{border:none!important}.payroll-table thead th[data-v-0b70dbbd]:first-child{border-top-left-radius:10px}.payroll-table thead th[data-v-0b70dbbd]:last-child{border-top-right-radius:10px}[dir=rtl] .payroll-table thead th[data-v-0b70dbbd]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .payroll-table thead th[data-v-0b70dbbd]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-0b70dbbd]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-0b70dbbd],.export-pdf-btn[data-v-0b70dbbd]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-0b70dbbd],.export-pdf-btn[data-v-0b70dbbd],.print-btn[data-v-0b70dbbd]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-0b70dbbd]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-0b70dbbd]{display:inline-block;position:relative}.action-icon-btn[data-v-0b70dbbd]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-0b70dbbd]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-0b70dbbd]{animation:slideInDown-0b70dbbd .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-0b70dbbd]{left:45px!important;right:auto!important}.action-menu-header[data-v-0b70dbbd]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-0b70dbbd]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-0b70dbbd]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-0b70dbbd]:hover{background-color:#e5e7eb}.action-menu ul[data-v-0b70dbbd]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-0b70dbbd]{margin:0}.action-menu li a[data-v-0b70dbbd]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-0b70dbbd]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-0b70dbbd]{flex-shrink:0;height:16px;width:16px}@keyframes slideInDown-0b70dbbd{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.btn-group.c-w-100[data-v-0b70dbbd]{gap:10px}.card[data-v-0b70dbbd]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-0b70dbbd]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.payroll-table .badge.bg-success[data-v-0b70dbbd]{background:#f6fef4!important;color:#2ab930!important}.payroll-table .badge.bg-danger[data-v-0b70dbbd],.payroll-table .badge.bg-success[data-v-0b70dbbd]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.payroll-table .badge.bg-danger[data-v-0b70dbbd]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-0b70dbbd]{background:#fff!important}.btn-primary[data-v-0b70dbbd]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
