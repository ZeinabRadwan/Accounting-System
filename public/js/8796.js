"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8796],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/suppliers/non-purchase/create.vue?vue&type=template&id=f18f072a
var render = function render() {
  ...
  }, [_vm._v("\n            " + _vm._s(_vm.$t('Create non purchase payment')) + "\n          ")]), _vm._v(" "), _c('router-link', {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _context3.n = 1;
              return _this3.form.post(window.location.origin + '/api/payments/non-purchase').then(function () {
                toast.fire({
                  type: 'success',
