...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/create.vue?vue&type=template&id=5ce23b77&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_5ce23b77_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const categories_createvue_type_style_index_0_id_5ce23b77_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_5ce23b77_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/categories/create.vue?vue&type=style&index=0&id=5ce23b77&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-5ce23b77]{gap:10px}.btn-group.c-w-100>.btn[data-v-5ce23b77]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-5ce23b77]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-5ce23b77]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-5ce23b77]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-5ce23b77]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-5ce23b77]{padding:1.25rem}.card-footer[data-v-5ce23b77]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-5ce23b77]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-5ce23b77]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-5ce23b77]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-5ce23b77]{color:#dc3545;font-weight:700}.btn-primary[data-v-5ce23b77]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-5ce23b77]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-5ce23b77]{background:#33a0d9!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-5ce23b77]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-5ce23b77]{border-color:#dc3545!important}#editor[data-v-5ce23b77]{border:1px solid #e5e7eb;min-height:200px}#editor[data-v-5ce23b77],#editor .ql-editor[data-v-5ce23b77]{background:#f1f5fb!important;border-radius:10px}#editor .ql-editor[data-v-5ce23b77]{font-size:14px;padding:12px 16px}#editor .ql-toolbar[data-v-5ce23b77]{background:#f8f9fa!important;border:1px solid #e5e7eb;border-bottom:none;border-radius:10px 10px 0 0}#editor .ql-container[data-v-5ce23b77]{border:1px solid #e5e7eb;border-radius:0 0 10px 10px;border-top:none}#editor[data-v-5ce23b77]:focus-within{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.row[data-v-5ce23b77]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-5ce23b77]{flex-direction:column;gap:10px}.card-footer .btn[data-v-5ce23b77]{margin-right:0!important;width:100%}.card-footer div[data-v-5ce23b77]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
