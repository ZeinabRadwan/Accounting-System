"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5789],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-cff2ad00]{gap:10px}.header-buttons[data-v-cff2ad00]{margin-bottom:15px}.footer-buttons[data-v-cff2ad00]{display:flex;gap:10px}.footer-buttons .btn[data-v-cff2ad00]{margin-right:10px}.footer-buttons .btn[data-v-cff2ad00]:last-child{margin-right:0}.btn-group.c-w-100>.btn[data-v-cff2ad00]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-cff2ad00]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-cff2ad00]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-cff2ad00]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-cff2ad00]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-cff2ad00]{background:#f1f5fb!important}.btn-primary[data-v-cff2ad00]{background:#2ab930!important}.btn-primary[data-v-cff2ad00],.btn-secondary[data-v-cff2ad00]{border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-cff2ad00]{background:#33a0d9!important}.btn-secondary[data-v-cff2ad00]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/edit.vue?vue&type=template&id=cff2ad00&scoped=true
  ...
  methods: {
    ...
    onFileChange: function onFileChange(e) {
      ...
      if (file.size < 2111775 && (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/gif')) {
        ...
        sweetalert2_all_default().fire('error!', this.$t('Please select a valid thumbnail with size less than 2 MB'), 'error');
      }
    },
    // update expense
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_cff2ad00_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_editvue_type_style_index_0_id_cff2ad00_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_cff2ad00_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/edit.vue?vue&type=style&index=0&id=cff2ad00&prod&scoped=true&lang=css
