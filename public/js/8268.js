"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8268],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-75893bab]{gap:10px}.header-buttons[data-v-75893bab]{margin-bottom:15px}.footer-buttons[data-v-75893bab]{display:flex;gap:10px}.footer-buttons .btn[data-v-75893bab]{margin-right:10px}.footer-buttons .btn[data-v-75893bab]:last-child{margin-right:0}.btn-group.c-w-100>.btn[data-v-75893bab]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-75893bab]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-75893bab]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-75893bab]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-75893bab]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-75893bab]{padding:1.25rem}.card-footer[data-v-75893bab]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-75893bab]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-75893bab]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-75893bab]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-75893bab]{color:#dc3545;font-weight:700}.btn-primary[data-v-75893bab]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-75893bab]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-75893bab]{background:#33a0d9!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-75893bab]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-75893bab]{border-color:#dc3545!important}textarea.form-control[data-v-75893bab]{min-height:100px;resize:vertical}.v-select[data-v-75893bab]{background:#f1f5fb!important}.v-select .vs__dropdown-toggle[data-v-75893bab]{background:#f1f5fb!important;border:1px solid #e5e7eb!important;border-radius:10px!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-75893bab]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-75893bab]{border-color:#dc3545!important}.custom-file-input[data-v-75893bab],.custom-file-label[data-v-75893bab]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px}.custom-file-label[data-v-75893bab]{color:#6b7280;font-size:14px}.custom-file-input:focus~.custom-file-label[data-v-75893bab]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.bg-light[data-v-75893bab]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px}.vue-tel-input[data-v-75893bab]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;padding:3px}.vue-tel-input[data-v-75893bab]:focus-within{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.vue-tel-input.is-invalid[data-v-75893bab]{border-color:#dc3545!important}.form-check-input[data-v-75893bab]{margin-top:.3rem}.form-check-label[data-v-75893bab]{color:#374151;font-weight:500;margin-left:.5rem}.row[data-v-75893bab]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-75893bab]{flex-direction:column;gap:10px}.card-footer .btn[data-v-75893bab]{margin-right:0!important;width:100%}.card-footer div[data-v-75893bab]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/create.vue?vue&type=template&id=75893bab&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    staticClass: "required"
  }, [_vm._v("*")])]), _vm._v(" "), _c('vue-tel-input', {
    "class": {
...
var vue_tel_input_umd_min = __webpack_require__(60940);
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  components: {
    VueTelInput: vue_tel_input_umd_min.VueTelInput
  },
  data: function data() {
    return {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _context3.n = 1;
              return _this4.form.post(window.location.origin + "/api/employees").then(function () {
                // Clear temporary data after successful save
                _this4.clearTemporaryData();
                toast.fire({
                  type: "success",
                  title: _this4.$t("Employee added successfully")
                });
                _this4.$router.push({
                  name: "employees.index"
                });
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/create.vue?vue&type=style&index=1&id=75893bab&prod&scoped=true&lang=css
var createvue_type_style_index_1_id_75893bab_prod_scoped_true_lang_css = __webpack_require__(24812);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/create.vue?vue&type=style&index=1&id=75893bab&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_1_id_75893bab_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const employees_createvue_type_style_index_1_id_75893bab_prod_scoped_true_lang_css = (createvue_type_style_index_1_id_75893bab_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/employees/create.vue?vue&type=style&index=1&id=75893bab&prod&scoped=true&lang=css
