"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5039],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/journal-entries/edit.vue?vue&type=template&id=ef35e9ca&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_ef35e9ca_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const journal_entries_editvue_type_style_index_0_id_ef35e9ca_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_ef35e9ca_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/journal-entries/edit.vue?vue&type=style&index=0&id=ef35e9ca&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-ef35e9ca]{gap:10px}.header-buttons[data-v-ef35e9ca]{margin-bottom:15px}.footer-buttons[data-v-ef35e9ca]{display:flex;gap:10px}.footer-buttons .btn[data-v-ef35e9ca]{margin-right:10px}.footer-buttons .btn[data-v-ef35e9ca]:last-child{margin-right:0}.card[data-v-ef35e9ca]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-ef35e9ca]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-ef35e9ca]{background:#fff!important}.btn-primary[data-v-ef35e9ca]{background:#2ab930!important}.btn-primary[data-v-ef35e9ca],.btn-secondary[data-v-ef35e9ca]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-ef35e9ca]{background:#33a0d9!important}.btn-secondary[data-v-ef35e9ca]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.table th[data-v-ef35e9ca]{background-color:#f8f9fa;font-weight:600}.invalid-feedback[data-v-ef35e9ca]{display:block}", ""]);
// Exports
