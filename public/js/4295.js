...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-6a17f0db]{margin-bottom:15px}.footer-buttons[data-v-6a17f0db]{display:flex;gap:10px}.footer-buttons .btn[data-v-6a17f0db]{margin-right:10px}.footer-buttons .btn[data-v-6a17f0db]:last-child{margin-right:0}.badge[data-v-6a17f0db]{border-radius:.25rem;display:inline-block;font-size:75%;font-weight:700;line-height:1;padding:.25em .4em;text-align:center;vertical-align:baseline;white-space:nowrap}.badge-info[data-v-6a17f0db]{background-color:#33a0d9;color:#fff}.text-muted[data-v-6a17f0db]{color:#6c757d!important}.account-status[data-v-6a17f0db]{font-size:.875rem;.account-warning[data-v-6a17f0db]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404}.account-success[data-v-6a17f0db],.account-warning[data-v-6a17f0db]{align-items:center;display:flex;padding:.5rem}.account-success[data-v-6a17f0db]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724}}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-6a17f0db]{border:none!important}.invoices-create-table[data-v-6a17f0db]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-6a17f0db]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-6a17f0db]{border:none!important}.invoices-create-table thead th[data-v-6a17f0db]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-6a17f0db]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-6a17f0db]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-6a17f0db]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-6a17f0db]{gap:10px}.card[data-v-6a17f0db]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-6a17f0db]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-info[data-v-6a17f0db]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-6a17f0db]{background:#fff!important}.btn-primary[data-v-6a17f0db]{background:#2ab930!important}.btn-info[data-v-6a17f0db],.btn-secondary[data-v-6a17f0db]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.quantity-field[data-v-6a17f0db]{border-radius:0!important;margin:0!important;min-height:50px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=template&id=6a17f0db&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/create.vue?vue&type=template&id=6a17f0db&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_6a17f0db_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_6a17f0db_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_6a17f0db_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=0&id=6a17f0db&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=6a17f0db&prod&scoped=true&lang=css
var createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css = __webpack_require__(39427);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=6a17f0db&prod&scoped=true&lang=css

            

var createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css_options = {};

createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css_options.insert = "head";
createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css_options.singleton = false;

var createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css/* default */.A, createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css_options);



/* harmony default export */ const returns_createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css = (createvue_type_style_index_1_id_6a17f0db_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=6a17f0db&prod&scoped=true&lang=css
