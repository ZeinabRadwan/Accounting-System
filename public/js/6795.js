(self["webpackChunk"] = self["webpackChunk"] || []).push([[6795],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/index.vue?vue&type=template&id=1d927612&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(_vm.$t('View')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('invoice-edit') && !(_vm.isSaudiArabia && data.status === 1) ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'invoices.edit',
          params: {
...
var update = injectStylesIntoStyleTag_default()(invoicesvue_type_style_index_0_id_1d927612_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const sales_invoicesvue_type_style_index_0_id_1d927612_prod_scoped_true_lang_css = (invoicesvue_type_style_index_0_id_1d927612_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/index.vue?vue&type=style&index=0&id=1d927612&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-1d927612]{border:none!important}.invoices-table[data-v-1d927612]{border-collapse:separate;border-spacing:0}.invoices-table thead th[data-v-1d927612]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-table thead tr[data-v-1d927612]{border:none!important}.invoices-table thead th[data-v-1d927612]:first-child{border-top-left-radius:10px}.invoices-table thead th[data-v-1d927612]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-table thead th[data-v-1d927612]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-table thead th[data-v-1d927612]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-1d927612]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-1d927612],.export-pdf-btn[data-v-1d927612]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-1d927612],.export-pdf-btn[data-v-1d927612],.print-btn[data-v-1d927612]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-1d927612]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-1d927612]{display:inline-block;position:relative}.action-icon-btn[data-v-1d927612]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-1d927612]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-1d927612]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-1d927612]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-1d927612]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-1d927612]{gap:10px}.btn-group.c-w-100>.btn[data-v-1d927612]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-1d927612]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-1d927612]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-1d927612]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-1d927612]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-table .badge.bg-success[data-v-1d927612]{background:#f6fef4!important;color:#2ab930!important}.invoices-table .badge.bg-danger[data-v-1d927612],.invoices-table .badge.bg-success[data-v-1d927612]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.invoices-table .badge.bg-danger[data-v-1d927612]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-1d927612]{background:#f1f5fb!important}.btn-primary[data-v-1d927612]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
