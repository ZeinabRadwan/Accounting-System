...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-5c044067]{margin-bottom:15px}.footer-buttons[data-v-5c044067]{display:flex;gap:10px}.footer-buttons .btn[data-v-5c044067]{margin-right:10px}.footer-buttons .btn[data-v-5c044067]:last-child{margin-right:0}.badge[data-v-5c044067]{border-radius:.25rem;display:inline-block;font-size:75%;font-weight:700;line-height:1;padding:.25em .4em;text-align:center;vertical-align:baseline;white-space:nowrap}.badge-info[data-v-5c044067]{background-color:#33a0d9;color:#fff}.text-muted[data-v-5c044067]{color:#6c757d!important}.account-status[data-v-5c044067]{font-size:.875rem;.account-warning[data-v-5c044067]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404}.account-success[data-v-5c044067],.account-warning[data-v-5c044067]{align-items:center;display:flex;padding:.5rem}.account-success[data-v-5c044067]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724}}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-5c044067]{border:none!important}.returns-create-table[data-v-5c044067]{border-collapse:separate;border-spacing:0}.returns-create-table thead th[data-v-5c044067]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.returns-create-table thead tr[data-v-5c044067]{border:none!important}.returns-create-table thead th[data-v-5c044067]:first-child{border-top-left-radius:10px}.returns-create-table thead th[data-v-5c044067]:last-child{border-top-right-radius:10px}[dir=rtl] .returns-create-table thead th[data-v-5c044067]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .returns-create-table thead th[data-v-5c044067]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-5c044067]{gap:10px}.card[data-v-5c044067]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-5c044067]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.returns-create-table .badge.badge-info[data-v-5c044067]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-5c044067]{background:#fff!important}.btn-primary[data-v-5c044067]{background:#2ab930!important}.btn-info[data-v-5c044067],.btn-secondary[data-v-5c044067]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=template&id=5c044067&scoped=true
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    calculateSum: function calculateSum() {
      ...
      this.form.invoiceTotal = Number((this.form.newSubTotal + this.form.newTax + this.form.invoiceTransport).toFixed(2));
    ...
    validateReturns: function validateReturns() {
      ...
      this.form.selectedProducts.forEach(function (product) {
        if (product.returnQty > product.qty) {
          errors.push("Return quantity for ".concat(product.name, " cannot exceed available quantity"));
          isValid = false;
        }
        if (product.returnQty < 0) {
          errors.push("Return quantity for ".concat(product.name, " cannot be negative"));
          isValid = false;
        }
      });
    ...
    saveInvoiceReturn: function saveInvoiceReturn() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var _this6$form$invoice;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              if (_this6.validateReturns()) {
                _context5.next = 2;
                break;
              }
              return _context5.abrupt("return");
            case 2:
              if (!(!_this6.isSaudiArabia && _this6.form.returnAmount > 0 && !_this6.hasBankAccountChartOfAccount)) {
                _context5.next = 5;
                break;
              }
              toast.fire({
                type: "warning",
                title: _this6.$t("Bank Account Chart of Account Required"),
                text: _this6.$t("Bank Account must have a Chart of Account assigned for journal entries."),
                timer: 8000,
                timerProgressBar: true,
                showConfirmButton: true,
                confirmButtonText: _this6.$t("Go to Bank Accounts"),
                showCancelButton: true,
                cancelButtonText: _this6.$t("Close")
              }).then(function (result) {
                if (result.isConfirmed) {
                  _this6.goToBankAccounts();
                }
              });
              return _context5.abrupt("return");
            case 5:
              // Sync form fields with Calculation Summary just before save
              _this6.form.totalPaid = ((_this6$form$invoice = _this6.form.invoice) === null || _this6$form$invoice === void 0 ? void 0 : _this6$form$invoice.totalPaid) || 0;
              _this6.form.invoiceTax = _this6.form.newTax;
              _this6.form.newDue = _this6.form.invoiceDue;
              // invoiceTotal, invoiceDiscount and invoiceTransport are already current
              _context5.next = 10;
              return _this6.form.post(window.location.origin + '/api/invoice-returns').then(function (_ref) {
                var data = _ref.data;
                if (_this6.isSaudiArabia) {
                  toast.fire({
                    type: 'success',
                    title: _this6.$t('Credit Note created successfully'),
                    text: _this6.$t('Credit Note has been created as inactive. You can send it to ZATCA from the invoice returns list.'),
                    timer: 8000,
                    timerProgressBar: true
                  });
                } else {
                  toast.fire({
                    type: 'success',
                    title: _this6.$t('Invoice return added successfully')
                  });
                }
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_5c044067_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_5c044067_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_5c044067_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=0&id=5c044067&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=5c044067&prod&scoped=true&lang=css
var createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css = __webpack_require__(49841);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=5c044067&prod&scoped=true&lang=css

            

var createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css_options = {};

createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css_options.insert = "head";
createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css_options.singleton = false;

var createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css/* default */.A, createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css_options);



/* harmony default export */ const returns_createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css = (createvue_type_style_index_1_id_5c044067_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=5c044067&prod&scoped=true&lang=css
