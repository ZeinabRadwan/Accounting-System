"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9679],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/sales-by-user-report.vue?vue&type=template&id=265121e1
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  })]), _vm._v(" "), _vm.items && _vm.items.length > 0 && _vm.form.user ? _c('a', {
    directives: [{
      name: "tooltip",
      rawName: "v-tooltip",
    ...
    }, [_vm._v("\n                    " + _vm._s(data.invoiceLabel) + "\n                  ")]) : _vm._e()], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.client))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.invoiceTotal)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("moment")(data.invoiceDate, "Do MMM, YYYY")))])]);
