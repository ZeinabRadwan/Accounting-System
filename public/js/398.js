(self["webpackChunk"] = self["webpackChunk"] || []).push([[398],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/transactions/index.vue?vue&type=template&id=45acb7bc&scoped=true
...
var update = injectStylesIntoStyleTag_default()(transactionsvue_type_style_index_0_id_45acb7bc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const cashbook_transactionsvue_type_style_index_0_id_45acb7bc_prod_scoped_true_lang_css = (transactionsvue_type_style_index_0_id_45acb7bc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/transactions/index.vue?vue&type=style&index=0&id=45acb7bc&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-45acb7bc]{border:none!important}.transactions-table[data-v-45acb7bc]{border-collapse:separate;border-spacing:0}.transactions-table thead th[data-v-45acb7bc]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.transactions-table thead tr[data-v-45acb7bc]{border:none!important}.transactions-table thead th[data-v-45acb7bc]:first-child{border-top-left-radius:10px}.transactions-table thead th[data-v-45acb7bc]:last-child{border-top-right-radius:10px}[dir=rtl] .transactions-table thead th[data-v-45acb7bc]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .transactions-table thead th[data-v-45acb7bc]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-45acb7bc]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-45acb7bc],.export-pdf-btn[data-v-45acb7bc]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-45acb7bc],.export-pdf-btn[data-v-45acb7bc],.print-btn[data-v-45acb7bc]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-45acb7bc]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-45acb7bc]{gap:10px}.card[data-v-45acb7bc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-45acb7bc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.transactions-table .badge.bg-success[data-v-45acb7bc]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.transactions-table .badge.bg-danger[data-v-45acb7bc]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-45acb7bc]{background:#fff!important}", ""]);
// Exports
