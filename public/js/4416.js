"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4416],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=b1fd267c&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  data: function data() {
    return {
      ...
      paymentMethods: [{
        ...
        id: 'amex',
        name: 'أمريكان إكسبريس (American Express)'
      }],
      // Communication configuration status
      communicationConfig: {
        email_configured: false,
  ...
  methods: {
    ...
    storeProduct: function storeProduct(product) {
      ...
      if (index === -1) {
        ...
        this.form.selectedProducts.unshift({
          ...
          totalBeforeDiscount: product.regularPrice * quantity,
          // For ItemsTable component
          totalAfterDiscount: product.regularPrice * quantity,
          // For ItemsTable component
    ...
    onSupplierChange: function onSupplierChange() {
      ...
      if (this.form.supplier && this.form.supplier.id) {
        ...
        var updatedSupplier = this.suppliers.find(function (s) {
        ...
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            ...
            case 8:
              ...
              console.error('Error getting cost centers:', _context1.t0);
              _this10.costCenters = [];
            case 12:
            case "end":
              return _context1.stop();
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 6:
              _yield$axios$get6 = _context10.sent;
            ...
            case 26:
              _this11.branches = branchesData;
              _context10.next = 33;
              break;
            case 29:
              _context10.prev = 29;
              _context10.t1 = _context10["catch"](0);
              console.error('Error getting branches:', _context10.t1);
              _this11.branches = [];
            case 33:
            case "end":
              return _context10.stop();
          }
        }, _callee10, null, [[0, 29], [11, 19]]);
      }))();
    },
    ...
    onAttachmentChange: function onAttachmentChange(event) {
      ...
      var validFiles = files.filter(function (file) {
        ...
        if (file.size > 10 * 1024 * 1024) {
          toast.fire({
            type: "error",
            title: _this12.$t("File too large"),
            text: "".concat(file.name, " ").concat(_this12.$t("exceeds 10MB limit"))
          });
          return false;
        }
        return true;
    ...
    resetForm: function resetForm() {
      ...
      sweetalert2_all_default().fire({
        ...
        if (result.value) {
          // Reset form fields
          _this13.form.reset();
          _this13.form.errors.clear();
          _this13.form.selectedProducts = [];
          _this13.form.subTotal = 0;
          _this13.form.netTotal = 0;
          _this13.form.totalProductTax = 0;
          _this13.form.totalTax = 0;
          _this13.form.totalDiscount = 0;
          _this13.form.discount = "";
          _this13.form.discount_type = "percentage";
          _this13.form.discount_value = 0;
          _this13.form.transportCost = "";
          _this13.form.transportTaxableCost = "";
          _this13.form.transportVatAmount = 0;
          _this13.form.orderTax = "";
          _this13.form.account = "";
          _this13.form.availableBalance = "";
          _this13.form.totalPaid = "";
          _this13.form.poReference = "";
          _this13.form.reference = "";
          _this13.form.paymentTerms = "";
          _this13.form.addPayment = "";
          _this13.form.chequeNo = "";
          _this13.form.receiptNo = "";
          _this13.form.poDate = new Date().toISOString().slice(0, 10);
          _this13.form.purchaseDate = new Date().toISOString().slice(0, 10);
          _this13.form.purchase_status = "";
          _this13.form.note = "";
          _this13.form.status = 0;
          _this13.form.isSendEmail = false;
          _this13.form.isSendSMS = false;
          _this13.form.costCenter = null;
          _this13.form.cost_center_id = null;
          _this13.form.branch = null;
          _this13.form.branch_id = null;
          _this13.form.isPaid = false;
          _this13.form.payment_method_id = null;
          _this13.form.attachments = [];
          _this13.form.supplier = "";

          // Reset supplier selection - set to first supplier if available
          if (_this13.suppliers && _this13.suppliers.length > 0) {
            _this13.form.supplier = _this13.suppliers[0];
          }

          // Reset account selection - set to default account if available
          if (_this13.accounts && _this13.accounts.length > 0) {
            var defaultAccountSlug = _this13.appInfo.defaultAccountSlug;
            _this13.form.account = _this13.accounts.find(function (account) {
              return account.slug == defaultAccountSlug;
            }) || _this13.accounts[0];
            _this13.updateBalance();
          }

          // Reset orderTax - set to default VAT rate if available
          if (_this13.taxes && _this13.taxes.length > 0) {
            var defaultVatRateSlug = _this13.appInfo.defaultVatRateSlug;
            _this13.form.orderTax = _this13.taxes.find(function (tax) {
              return tax.slug === defaultVatRateSlug;
            }) || _this13.taxes[0];
            _this13.updateTax();
          }
          ...
          toast.fire({
            type: "success",
            title: _this13.$t("Form Reset"),
            text: _this13.$t("Form has been reset successfully"),
            timer: 2000
          });
        }
      });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              _context12.prev = 0;
              _this14.$store.state.operations.loading = true;
            ...
            case 4:
              ...
              if (purchaseOrder.supplier && _this14.suppliers && _this14.suppliers.length > 0) {
                supplier = _this14.suppliers.find(function (s) {
                  return s.id === purchaseOrder.supplier.id || s.id === purchaseOrder.supplier_id;
                });
                if (supplier) {
                  _this14.form.supplier = supplier;
                  _this14.onSupplierChange();
                }
              }

              // Set purchase order reference fields
              if (purchaseOrder.po_reference) {
                _this14.form.poReference = purchaseOrder.po_reference;
              }
              if (purchaseOrder.payment_terms) {
                _this14.form.paymentTerms = purchaseOrder.payment_terms;
              }
              if (purchaseOrder.po_date) {
                _this14.form.poDate = purchaseOrder.po_date;
              }
              if (purchaseOrder.purchase_date) {
                _this14.form.purchaseDate = purchaseOrder.purchase_date;
              } else {
                _this14.form.purchaseDate = new Date().toISOString().slice(0, 10);
              }
              if (purchaseOrder.note) {
                _this14.form.note = purchaseOrder.note;
              }
              if (purchaseOrder.transport) {
                _this14.form.transportCost = purchaseOrder.transport;
              }
                ...
                return _regeneratorRuntime().wrap(function _loop$(_context11) {
                  while (1) switch (_context11.prev = _context11.next) {
                    case 0:
                      ...
                      product = _this14.products.find(function (p) {
                        return p.id === poProduct.product_id || poProduct.product && p.id === poProduct.product.id;
                      });
                      if (product) {
                        // Find matching VAT rate
                        selectedVatRate = null;
                        if (poProduct.tax_amount && poProduct.tax_amount > 0 && _this14.taxes && _this14.taxes.length > 0) {
                          ...
                          selectedVatRate = _this14.taxes.find(function (tax) {
                            return Math.abs(tax.rate - calculatedVatRate) < 0.01 || poProduct.product && poProduct.product.productTax && _this14.findMatchingVatRate(poProduct.product.productTax);
                          });
                          if (!selectedVatRate && poProduct.product && poProduct.product.productTax) {
                            selectedVatRate = _this14.findMatchingVatRate(poProduct.product.productTax);
                          }
                        }
                        ...
                        formProduct = {
                          ...
                          selectedVatRate: selectedVatRate || (_this14.taxes && _this14.taxes.length > 0 ? _this14.taxes[0] : null),
            ...
            case 20:
              ...
              return _context12.delegateYield(_loop(), "t0", 22);
            case 22:
              _context12.next = 20;
              break;
            case 24:
            ...
            case 32:
              ...
              _this14.form.selectedProducts = selectedProducts;

              // Recalculate totals for all products (calculateProductVat already calls generateItemTotalPrice)
              selectedProducts.forEach(function (product, index) {
                _this14.calculateProductDiscount(index);
                _this14.calculateProductVat(index);
              });
            ...
            case 35:
              ...
              toast.fire({
                type: "success",
                title: _this14.$t("Purchase order data loaded successfully")
              });
              _this14.$store.state.operations.loading = false;
              _context12.next = 44;
              break;
            case 39:
              _context12.prev = 39;
              _context12.t2 = _context12["catch"](0);
              console.error('Error loading purchase order data:', _context12.t2);
              _this14.$store.state.operations.loading = false;
              toast.fire({
                type: "error",
                title: _this14.$t("Failed to load purchase order data"),
                text: ((_error$response = _context12.t2.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this14.$t("Please try again")
              });
            case 44:
            case "end":
              return _context12.stop();
          }
        }, _callee11, null, [[0, 39], [17, 26, 29, 32]]);
      }))();
    }
  },
  mounted: function mounted() {
...
var createvue_type_style_index_0_id_b1fd267c_prod_scoped_true_lang_css = __webpack_require__(54434);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=b1fd267c&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_b1fd267c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_b1fd267c_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_b1fd267c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=b1fd267c&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-b1fd267c]{margin-bottom:15px}.footer-buttons[data-v-b1fd267c]{display:flex;gap:10px}.footer-buttons .btn[data-v-b1fd267c]{margin-right:10px}.footer-buttons .btn[data-v-b1fd267c]:last-child{margin-right:0}.create-btn[data-v-b1fd267c]{padding:11px}.chart-account-success[data-v-b1fd267c],.chart-account-warning[data-v-b1fd267c]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-b1fd267c]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-b1fd267c]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-b1fd267c],.warning-content[data-v-b1fd267c]{align-items:center;display:flex;gap:16px}.success-icon[data-v-b1fd267c],.warning-icon[data-v-b1fd267c]{flex-shrink:0;font-size:24px}.warning-icon[data-v-b1fd267c]{color:#856404}.success-icon[data-v-b1fd267c]{color:#155724}.success-text[data-v-b1fd267c],.warning-text[data-v-b1fd267c]{flex-grow:1}.success-title[data-v-b1fd267c],.warning-title[data-v-b1fd267c]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-b1fd267c]{color:#856404}.success-title[data-v-b1fd267c]{color:#155724}.success-description[data-v-b1fd267c],.warning-description[data-v-b1fd267c]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-b1fd267c]{color:#856404}.success-description[data-v-b1fd267c]{color:#155724}.warning-action[data-v-b1fd267c]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-b1fd267c]{padding:0}.card[data-v-b1fd267c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-b1fd267c]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-b1fd267c]{padding:1.25rem}.card-footer[data-v-b1fd267c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-b1fd267c]{border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-b1fd267c]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-b1fd267c]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-b1fd267c]{color:#dc3545;font-weight:700}.btn-primary[data-v-b1fd267c]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-b1fd267c]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-b1fd267c]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-b1fd267c]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-b1fd267c]{border-color:#dc3545!important}textarea.form-control[data-v-b1fd267c]{min-height:100px;resize:vertical}.v-select[data-v-b1fd267c],.v-select .vs__dropdown-toggle[data-v-b1fd267c]{background:#fff!important;border:1px solid #e5e7eb}.v-select .vs__dropdown-toggle[data-v-b1fd267c]{padding:10px 16px}.v-select .vs__search[data-v-b1fd267c]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-b1fd267c]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-b1fd267c]{color:#374151}.v-select .vs__dropdown-menu[data-v-b1fd267c]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-b1fd267c]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-b1fd267c]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-b1fd267c]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-b1fd267c]:hover{background-color:#f8f9fa}.toggle-button[data-v-b1fd267c]{margin-right:10px}.product-status[data-v-b1fd267c],.supplier-status[data-v-b1fd267c]{font-size:13px}.product-warning[data-v-b1fd267c],.supplier-warning[data-v-b1fd267c]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-b1fd267c]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-b1fd267c]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-b1fd267c]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-b1fd267c]{margin-bottom:1rem}.form-text[data-v-b1fd267c]{color:#6b7280;font-size:.875rem}.text-muted[data-v-b1fd267c]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-b1fd267c]{flex-direction:column;gap:10px}.card-footer .btn[data-v-b1fd267c]{margin-right:0!important;width:100%}.card-footer div[data-v-b1fd267c]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-b1fd267c]{font-size:12px}.table-custom tbody td[data-v-b1fd267c],.table-custom thead th[data-v-b1fd267c]{padding:8px 4px}}.btn-group.c-w-100[data-v-b1fd267c]{gap:10px}.quantity-field[data-v-b1fd267c]{border-radius:0!important;margin:0!important;min-height:50px!important}.table-custom[data-v-b1fd267c]{border:none!important}.invoices-create-table[data-v-b1fd267c]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-b1fd267c]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-b1fd267c]{border:none!important}.invoices-create-table thead th[data-v-b1fd267c]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-b1fd267c]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-b1fd267c]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-b1fd267c]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-create-table .badge.badge-danger[data-v-b1fd267c]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-b1fd267c]{background:#fff!important}.summary-footer-wrapper[data-v-b1fd267c]{margin-top:10px}.summary-footer-row[data-v-b1fd267c]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-b1fd267c]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-b1fd267c]{color:#495057}.summary-label[data-v-b1fd267c],.summary-value[data-v-b1fd267c]{font-size:14px;padding:12px 16px}.summary-value[data-v-b1fd267c]{color:#212529;text-align:left}.grand-total-row[data-v-b1fd267c]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-b1fd267c]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-b1fd267c]{text-align:left}[dir=rtl] .summary-value[data-v-b1fd267c]{text-align:right}@media (max-width:768px){.summary-label[data-v-b1fd267c],.summary-value[data-v-b1fd267c]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-b1fd267c]{font-size:14px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
