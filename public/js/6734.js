(self["webpackChunk"] = self["webpackChunk"] || []).push([[6734],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-6b6f8f22]{border:none!important}.payroll-table[data-v-6b6f8f22]{border-collapse:separate;border-spacing:0}.payroll-table thead th[data-v-6b6f8f22]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.payroll-table thead tr[data-v-6b6f8f22]{border:none!important}.payroll-table thead th[data-v-6b6f8f22]:first-child{border-top-left-radius:10px}.payroll-table thead th[data-v-6b6f8f22]:last-child{border-top-right-radius:10px}[dir=rtl] .payroll-table thead th[data-v-6b6f8f22]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .payroll-table thead th[data-v-6b6f8f22]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-6b6f8f22]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-6b6f8f22],.export-pdf-btn[data-v-6b6f8f22]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-6b6f8f22],.export-pdf-btn[data-v-6b6f8f22],.print-btn[data-v-6b6f8f22]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-6b6f8f22]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-6b6f8f22]{display:inline-block;position:relative}.action-icon-btn[data-v-6b6f8f22]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-6b6f8f22]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-6b6f8f22]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-6b6f8f22]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-6b6f8f22]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-6b6f8f22]{gap:10px}.btn-group.c-w-100>.btn[data-v-6b6f8f22]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-6b6f8f22]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-6b6f8f22]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-6b6f8f22]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-6b6f8f22]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.payroll-table .badge.bg-success[data-v-6b6f8f22]{background:#f6fef4!important;color:#2ab930!important}.payroll-table .badge.bg-danger[data-v-6b6f8f22],.payroll-table .badge.bg-success[data-v-6b6f8f22]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.payroll-table .badge.bg-danger[data-v-6b6f8f22]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-6b6f8f22]{background:#f1f5fb!important}.btn-primary[data-v-6b6f8f22]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=template&id=6b6f8f22&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_c('ul', [_vm.$can('payroll-view') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'payroll.show',
          params: {
    ...
    }, [_vm._v(_vm._s(_vm.$t('View')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('payroll-edit') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'payroll.edit',
          params: {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Edit')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('payroll-delete') ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
...
var update = injectStylesIntoStyleTag_default()(payrollvue_type_style_index_0_id_6b6f8f22_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_payrollvue_type_style_index_0_id_6b6f8f22_prod_scoped_true_lang_css = (payrollvue_type_style_index_0_id_6b6f8f22_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payroll/index.vue?vue&type=style&index=0&id=6b6f8f22&prod&scoped=true&lang=css
