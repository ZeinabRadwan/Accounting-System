...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".account-status .account-warning[data-v-46029747],.account-status .client-warning[data-v-46029747],.account-status .product-warning[data-v-46029747],.client-status .account-warning[data-v-46029747],.client-status .client-warning[data-v-46029747],.client-status .product-warning[data-v-46029747],.product-status .account-warning[data-v-46029747],.product-status .client-warning[data-v-46029747],.product-status .product-warning[data-v-46029747]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;color:#856404;font-size:.875rem;padding:8px 12px}.account-status .account-success[data-v-46029747],.account-status .client-success[data-v-46029747],.account-status .product-success[data-v-46029747],.client-status .account-success[data-v-46029747],.client-status .client-success[data-v-46029747],.client-status .product-success[data-v-46029747],.product-status .account-success[data-v-46029747],.product-status .client-success[data-v-46029747],.product-status .product-success[data-v-46029747]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:4px;color:#155724;font-size:.875rem;padding:8px 12px}.create-btn[data-v-46029747]{background-color:#007bff;border-left:none;border-color:#007bff;color:#fff;cursor:pointer}.create-btn[data-v-46029747]:hover{background-color:#0056b3;border-color:#0056b3}.radio-group-horizontal[data-v-46029747]{display:flex;gap:20px}.radio-group-horizontal .form-check[data-v-46029747]{align-items:center;display:flex;gap:8px}.custom-qty-input .button-minus[data-v-46029747],.custom-qty-input .button-plus[data-v-46029747]{border:none;border-radius:0;height:30px;width:30px}.custom-qty-input .quantity-field[data-v-46029747]{border-left:none;border-right:none;text-align:center;width:60px}.table-custom td[data-v-46029747],.table-custom th[data-v-46029747]{vertical-align:middle}.invalid-feedback[data-v-46029747]{display:block;margin-top:5px}.btn-primary[data-v-46029747]{background:#2ab930!important}.btn-primary[data-v-46029747]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=46029747&scoped=true
...
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=46029747&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_46029747_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const invoices_editvue_type_style_index_0_id_46029747_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_46029747_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=46029747&prod&lang=scss&scoped=true
