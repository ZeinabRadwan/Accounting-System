...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".page-header[data-v-5db0ddd3]{margin-bottom:20px}.breadcrumb[data-v-5db0ddd3]{background:none;margin:0;padding:0}.breadcrumb-item+.breadcrumb-item[data-v-5db0ddd3]:before{content:\">\"}.form-control-plaintext[data-v-5db0ddd3]{background:transparent;border:none;margin:0;padding:0}.table th[data-v-5db0ddd3]{background-color:#f8f9fa;font-weight:600}.badge[data-v-5db0ddd3]{font-size:.875em}.table-active[data-v-5db0ddd3]{background-color:#e9ecef!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/journal-entries/show.vue?vue&type=template&id=5db0ddd3&scoped=true
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_5db0ddd3_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const journal_entries_showvue_type_style_index_0_id_5db0ddd3_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_5db0ddd3_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/journal-entries/show.vue?vue&type=style&index=0&id=5db0ddd3&prod&scoped=true&lang=css
