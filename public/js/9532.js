...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".inner-card[data-v-b6ba10dc]{box-shadow:0 0 1px rgba(0,0,0,.125),0 1px 3px rgba(0,0,0,.2)}.inner-card .card-header[data-v-b6ba10dc]{background-color:rgba(0,0,0,.03)}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/general.vue?vue&type=template&id=b6ba10dc&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
var update = injectStylesIntoStyleTag_default()(generalvue_type_style_index_0_id_b6ba10dc_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const setup_generalvue_type_style_index_0_id_b6ba10dc_prod_lang_scss_scoped_true = (generalvue_type_style_index_0_id_b6ba10dc_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/central/setup/general.vue?vue&type=style&index=0&id=b6ba10dc&prod&lang=scss&scoped=true
