...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-group[data-v-1d2bd1bb]{margin-bottom:1rem}.custom-control.custom-switch[data-v-1d2bd1bb]{align-items:center;display:flex;height:44px}.custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]{align-items:center;cursor:pointer;display:inline-flex;min-height:1.5rem;padding-left:3.25rem}.custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]:before{background-color:#e5e7eb;border:1px solid #d1d5db;border-radius:1rem;box-shadow:none;height:1.6rem;left:.25rem;top:50%;transform:translateY(-50%);width:3rem}.custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]:after{background-color:#fff;border-radius:50%;box-shadow:0 1px 2px rgba(0,0,0,.12);height:1.2rem;left:.4rem;top:50%;transform:translateY(-50%);width:1.2rem}.custom-control-input:checked~.custom-control-label[data-v-1d2bd1bb]:before{background-color:#2ab930;border-color:#2ab930}.custom-control-input:checked~.custom-control-label[data-v-1d2bd1bb]:after{left:2.05rem}.custom-control-input:focus~.custom-control-label[data-v-1d2bd1bb]:before{box-shadow:0 0 0 .2rem rgba(42,185,48,.15)}.custom-control-input:disabled~.custom-control-label[data-v-1d2bd1bb]{color:#9ca3af;cursor:not-allowed}.custom-control-input:disabled~.custom-control-label[data-v-1d2bd1bb]:before{background-color:#f3f4f6;border-color:#e5e7eb}@media (max-width:576px){.custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]{padding-left:3rem}}[dir=rtl] .custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]{padding-left:0;padding-right:3.25rem}[dir=rtl] .custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]:before{left:auto;right:.25rem}[dir=rtl] .custom-control.custom-switch .custom-control-label[data-v-1d2bd1bb]:after{left:auto;right:.4rem}[dir=rtl] .custom-control-input:checked~.custom-control-label[data-v-1d2bd1bb]:after{left:auto;right:2.05rem}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/branches/edit.vue?vue&type=template&id=1d2bd1bb&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/branches/edit.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./resources/js/pages/branches/edit.vue?vue&type=script&lang=js
...
var editvue_type_style_index_0_id_1d2bd1bb_prod_scoped_true_lang_css = __webpack_require__(75859);
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_1d2bd1bb_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const branches_editvue_type_style_index_0_id_1d2bd1bb_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_1d2bd1bb_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/branches/edit.vue?vue&type=style&index=0&id=1d2bd1bb&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/branches/edit.vue
