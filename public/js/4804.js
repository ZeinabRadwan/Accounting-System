"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4804],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=template&id=2e0ab823&scoped=true
...
;// ./resources/js/pages/sales/returns/create.vue?vue&type=template&id=2e0ab823&scoped=true
  ...
  methods: {
    ...
    handlePreSelection: function handlePreSelection() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var clientSlug, invoiceSlug, invoiceData, response, attempts, maxAttempts, selectedClient, fallbackClient, selectedInvoice, fallbackInvoice, _selectedInvoice, _fallbackInvoice, _t2;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              clientSlug = _this5.$route.query.client;
              invoiceSlug = _this5.$route.query.invoice;
              invoiceData = null;
              if (!invoiceSlug) {
                _context5.n = 20;
                break;
            ...
            case 4:
              ...
              selectedClient = _this5.items.find(function (client) {
              ...
              fallbackClient = _this5.items.find(function (client) {
              ...
              _this5.form.client = fallbackClient;

              // Trigger invoice loading for this client
              _context5.n = 5;
              return _this5.assignInvoices();
            case 5:
              _context5.n = 6;
            ...
            case 7:
              if (!(_this5.clientInvoices && _this5.clientInvoices.length > 0)) {
                _context5.n = 10;
                break;
              }
              selectedInvoice = _this5.clientInvoices.find(function (invoice) {
              ...
              _this5.form.invoice = selectedInvoice;
              // Trigger product loading for this invoice
              _this5.storeProducts();
              return _context5.a(2);
            case 8:
              // Try multiple fallback methods
              fallbackInvoice = null; // Method 1: Try by ID
              if (invoiceData && invoiceData.id) {
                fallbackInvoice = _this5.clientInvoices.find(function (invoice) {
              ...
              _this5.form.invoice = fallbackInvoice;
              _this5.storeProducts();
              return _context5.a(2);
            case 9:
              ...
              _this5.form.invoice = invoiceData;
              _this5.storeProducts();
              return _context5.a(2);
            case 10:
              if (!selectedClient) {
              ...
              _this5.form.client = selectedClient;
            ...
            case 13:
              ...
              _selectedInvoice = _this5.clientInvoices.find(function (invoice) {
                return invoice.slug === invoiceSlug;
              });
              if (!_selectedInvoice) {
                _context5.n = 14;
              ...
              _this5.form.invoice = _selectedInvoice;
              // Trigger product loading for this invoice
              _this5.storeProducts();
              return _context5.a(2);
            case 14:
              ...
              if (invoiceData && invoiceData.id) {
                _fallbackInvoice = _this5.clientInvoices.find(function (invoice) {
                  return invoice.id === invoiceData.id;
                });
              }
              ...
              _this5.form.invoice = _fallbackInvoice;
              _this5.storeProducts();
              return _context5.a(2);
            case 15:
              if (!(invoiceData && invoiceData.slug === invoiceSlug)) {
            ...
            case 19:
              _context5.p = 19;
              _t2 = _context5.v;
              console.error('Error fetching invoice details:', _t2);
            case 20:
              return _context5.a(2);
          }
        }, _callee5, null, [[1, 19]]);
    ...
    validateReturns: function validateReturns() {
      ...
      this.form.selectedProducts.forEach(function (product) {
        if (product.returnQty > product.qty) {
          errors.push(_this8.$t('Return quantity for {name} cannot exceed available quantity', {
            name: product.name
          }));
          isValid = false;
        }
        if (product.returnQty < 0) {
          errors.push(_this8.$t('Return quantity for {name} cannot be negative', {
            name: product.name
          }));
          isValid = false;
        }
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.n) {
            ...
            case 2:
              ...
              _context7.n = 3;
              return _this9.form.post(window.location.origin + '/api/invoice-returns').then(function (_ref) {
                var data = _ref.data;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_2e0ab823_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_2e0ab823_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_2e0ab823_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=0&id=2e0ab823&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=2e0ab823&prod&scoped=true&lang=css
var createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css = __webpack_require__(48653);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=2e0ab823&prod&scoped=true&lang=css

            

var createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css_options = {};

createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css_options.insert = "head";
createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css_options.singleton = false;

var createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css/* default */.A, createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css_options);



/* harmony default export */ const returns_createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css = (createvue_type_style_index_1_id_2e0ab823_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=2e0ab823&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-2e0ab823]{border:none!important}.invoices-create-table[data-v-2e0ab823]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-2e0ab823]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-2e0ab823]{border:none!important}.invoices-create-table thead th[data-v-2e0ab823]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-2e0ab823]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-2e0ab823]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-2e0ab823]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-2e0ab823]{gap:10px}.card[data-v-2e0ab823]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-2e0ab823]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-info[data-v-2e0ab823]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-2e0ab823]{background:#fff!important}.btn-primary[data-v-2e0ab823]{background:#2ab930!important}.btn-info[data-v-2e0ab823],.btn-secondary[data-v-2e0ab823]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.quantity-field[data-v-2e0ab823]{border-radius:0!important;margin:0!important;min-height:50px!important}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-2e0ab823]{margin-bottom:15px}.footer-buttons[data-v-2e0ab823]{display:flex;gap:10px}.footer-buttons .btn[data-v-2e0ab823]{margin-right:10px}.footer-buttons .btn[data-v-2e0ab823]:last-child{margin-right:0}.badge[data-v-2e0ab823]{border-radius:.25rem;display:inline-block;font-size:75%;font-weight:700;line-height:1;padding:.25em .4em;text-align:center;vertical-align:baseline;white-space:nowrap}.badge-info[data-v-2e0ab823]{background-color:#33a0d9;color:#fff}.text-muted[data-v-2e0ab823]{color:#6c757d!important}.account-status[data-v-2e0ab823]{font-size:.875rem;.account-warning[data-v-2e0ab823]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404}.account-success[data-v-2e0ab823],.account-warning[data-v-2e0ab823]{align-items:center;display:flex;padding:.5rem}.account-success[data-v-2e0ab823]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
