(self["webpackChunk"] = self["webpackChunk"] || []).push([[6511],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-cec83160]{border:none!important}.invoice-returns-table[data-v-cec83160]{border-collapse:separate;border-spacing:0}.invoice-returns-table thead th[data-v-cec83160]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoice-returns-table thead tr[data-v-cec83160]{border:none!important}.invoice-returns-table thead th[data-v-cec83160]:first-child{border-top-left-radius:10px}.invoice-returns-table thead th[data-v-cec83160]:last-child{border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-cec83160]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-cec83160]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-cec83160]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-cec83160],.export-pdf-btn[data-v-cec83160]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-cec83160],.export-pdf-btn[data-v-cec83160],.print-btn[data-v-cec83160]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-cec83160]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-cec83160]{display:inline-block;position:relative}.action-icon-btn[data-v-cec83160]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-cec83160]{animation:slideInRight-cec83160 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;right:20px;top:50%;transform:translateY(-50%);z-index:9999}@keyframes slideInRight-cec83160{0%{opacity:0;transform:translateY(-50%) translateX(20px)}to{opacity:1;transform:translateY(-50%) translateX(0)}}.action-menu-backdrop[data-v-cec83160]{animation:fadeIn-cec83160 .3s ease-out;background:rgba(0,0,0,.1);bottom:0;left:0;position:fixed;right:0;top:0;z-index:9998}@keyframes fadeIn-cec83160{0%{opacity:0}to{opacity:1}}.action-menu-header[data-v-cec83160]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-cec83160]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-cec83160]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-cec83160]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-cec83160]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-cec83160]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-cec83160]:last-child{border-bottom:none}.action-menu li a[data-v-cec83160]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-cec83160]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-cec83160]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-cec83160]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-cec83160]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-cec83160]{gap:10px}.btn-group.c-w-100>.btn[data-v-cec83160]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-cec83160]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-cec83160]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-cec83160]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-cec83160]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoice-returns-table .badge.bg-success[data-v-cec83160]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.invoice-returns-table .badge.bg-danger[data-v-cec83160]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-cec83160]{background:#f1f5fb!important}.btn-primary[data-v-cec83160]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/index.vue?vue&type=template&id=cec83160&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm._v("\n                      " + _vm._s(_vm._f("withPrefix")(data.returnNo, _vm.invoiceReturnPrefix)) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(_vm._f("withPrefix")(data.returnNo, _vm.invoiceReturnPrefix)))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withPrefix")(data.invoiceNo, _vm.invoicePrefix)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.clientName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.reason))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.totalReturn)))]), _vm._v(" "), _c('td', [data.returnDate ? _c('span', [_vm._v(_vm._s(_vm._f("moment")(data.returnDate, "Do MMM, YYYY")))]) : _vm._e()]), _vm._v(" "), _c('td', [data.status === 1 ? _c('span', {
    ...
    }), _vm._v("\n                              " + _vm._s(_vm.$t('View')) + "\n                            ")])], 1) : _vm._e(), _vm._v(" "), _vm.$can('invoice-return-edit') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
...
/* harmony default export */ const returnsvue_type_script_lang_js = ({
  ...
  metaInfo: function metaInfo() {
    return {
      title: this.isSaudiArabia ? this.$t("Invoice Returns KSA") : this.$t("Invoice Returns")
    };
  },
  components: {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              console.log('isSaudiArabia:', _this8.isSaudiArabia);
              console.log('data.status:', data.status);
              sweetalert2_all_default().fire({
                title: _this8.$t("Send Credit Note to ZATCA"),
                text: _this8.$t("Do you want to send this credit note to ZATCA?"),
                type: "question",
                showCancelButton: true,
                confirmButtonText: _this8.$t("Yes"),
                cancelButtonText: _this8.$t("No"),
                  ...
                  return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                    while (1) switch (_context8.prev = _context8.next) {
                      case 0:
                        ...
                        // Show loading
                        sweetalert2_all_default().fire({
                          title: _this8.$t("Sending..."),
                          text: _this8.$t("Please wait while we send the credit note to ZATCA"),
                      ...
                      case 5:
                        ...
                        if (response.data.success) {
                          sweetalert2_all_default().fire(_this8.$t("Sent Successfully!"), _this8.$t("Credit note has been sent to ZATCA and journal entries have been created."), "success");
                          // Refresh the table to update the status
                          _this8.getData();
                        } else {
                          sweetalert2_all_default().fire(_this8.$t("Failed!"), response.data.message || _this8.$t("Failed to send credit note to ZATCA"), "error");
                        }
                        _context8.next = 13;
                        break;
                      case 9:
                        ...
                        sweetalert2_all_default().fire(_this8.$t("Error!"), ((_error$response = _context8.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this8.$t("An error occurred while sending the credit note"), "error");
                      case 13:
                      case "end":
                ...
                if (result.value) {
                  _this9.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      sweetalert2_all_default().fire(_this9.$t("Failed!"), _this9.$t("There was something wrong."), "warning");
                    }
                  });
                }
              });
...
var update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_0_id_cec83160_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const sales_returnsvue_type_style_index_0_id_cec83160_prod_scoped_true_lang_css = (returnsvue_type_style_index_0_id_cec83160_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/index.vue?vue&type=style&index=0&id=cec83160&prod&scoped=true&lang=css
