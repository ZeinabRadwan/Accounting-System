"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1088],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/index.vue?vue&type=template&id=945480b4&scoped=true
...
var update = injectStylesIntoStyleTag_default()(categoriesvue_type_style_index_0_id_945480b4_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_categoriesvue_type_style_index_0_id_945480b4_prod_scoped_true_lang_css = (categoriesvue_type_style_index_0_id_945480b4_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=0&id=945480b4&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=1&id=945480b4&prod&lang=css
var categoriesvue_type_style_index_1_id_945480b4_prod_lang_css = __webpack_require__(36915);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=1&id=945480b4&prod&lang=css

            

var categoriesvue_type_style_index_1_id_945480b4_prod_lang_css_options = {};

categoriesvue_type_style_index_1_id_945480b4_prod_lang_css_options.insert = "head";
categoriesvue_type_style_index_1_id_945480b4_prod_lang_css_options.singleton = false;

var categoriesvue_type_style_index_1_id_945480b4_prod_lang_css_update = injectStylesIntoStyleTag_default()(categoriesvue_type_style_index_1_id_945480b4_prod_lang_css/* default */.A, categoriesvue_type_style_index_1_id_945480b4_prod_lang_css_options);



/* harmony default export */ const expenses_categoriesvue_type_style_index_1_id_945480b4_prod_lang_css = (categoriesvue_type_style_index_1_id_945480b4_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=1&id=945480b4&prod&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-945480b4]{border:none!important;overflow:visible!important}.expense-categories-table[data-v-945480b4]{border-collapse:separate;border-spacing:0}.expense-categories-table thead th[data-v-945480b4]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.expense-categories-table thead tr[data-v-945480b4]{border:none!important}.expense-categories-table thead th[data-v-945480b4]:first-child{border-top-left-radius:10px}.expense-categories-table thead th[data-v-945480b4]:last-child{border-top-right-radius:10px}[dir=rtl] .expense-categories-table thead th[data-v-945480b4]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .expense-categories-table thead th[data-v-945480b4]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-945480b4]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-945480b4],.export-pdf-btn[data-v-945480b4]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-945480b4],.export-pdf-btn[data-v-945480b4],.print-btn[data-v-945480b4]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-945480b4]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-945480b4]{gap:10px}.card[data-v-945480b4]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-945480b4]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.action-dropdown[data-v-945480b4]{display:inline-block;position:relative}.action-icon-btn[data-v-945480b4]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-945480b4]{animation:slideInDown-945480b4 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-945480b4]{left:45px!important;right:auto!important}@keyframes slideInDown-945480b4{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-945480b4]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-945480b4]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-945480b4]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-945480b4]:hover{background-color:#e5e7eb}.action-menu ul[data-v-945480b4]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-945480b4]{margin:0}.action-menu li a[data-v-945480b4]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-945480b4]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-945480b4]{flex-shrink:0;height:16px;width:16px}.expense-categories-table .badge.bg-success[data-v-945480b4]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.expense-categories-table .badge.bg-danger[data-v-945480b4]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-945480b4]{background:#fff!important}.btn-primary[data-v-945480b4]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
