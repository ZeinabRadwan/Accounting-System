"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4466],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/QuotationForm.vue?vue&type=template&id=8b1f23ac&scoped=true
var QuotationFormvue_type_template_id_8b1f23ac_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
    staticClass: "row"
    ...
    return _c('tr', {
    ...
    }, [_vm._v(_vm._s(_vm.formatToTwoDecimals(item.totalAfterDiscount !== undefined ? item.totalAfterDiscount : item.unitPrice * item.qty - (item.discountAmount || 0))) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]), _vm._v(" "), _c('td', {
      staticStyle: {
        "min-width": "150px"
    ...
    })], 2), _vm._v(" "), item.vat_rate_code ? _c('div', {
      staticClass: "mt-1",
      staticStyle: {
        "display": "none"
      }
      ...
      staticClass: "text-muted"
    }, [_c('strong', [_vm._v(_vm._s(_vm.$t("VAT Code")) + ":")]), _vm._v(" " + _vm._s(item.vat_rate_code) + "\n                          ")])]) : _vm._e(), _vm._v(" "), _vm.form.errors.has("selectedProducts.".concat(i, ".selectedVatRate")) ? _c('div', {
      staticClass: "invalid-feedback d-block"
    ...
    }, [_vm._v(_vm._s(_vm.formatToTwoDecimals(item.taxType === 'Inclusive' ? item.totalTax || 0 : item.productTax || 0)) + "\n                        "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])])]), _vm._v(" "), _c('td', {
      staticClass: "no-currency",
      staticStyle: {
    ...
    staticClass: "no-currency"
  }, [_c('strong', [_vm._v(_vm._s(_vm.formatToTwoDecimals(_vm.totalAfterTax)))]), _vm._v(" "), _c('span', {
    staticClass: "saudi-riyal"
...
var QuotationFormvue_type_template_id_8b1f23ac_scoped_true_staticRenderFns = [function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c('td', [_c('strong')]);
}];

;// ./resources/js/components/QuotationForm.vue?vue&type=template&id=8b1f23ac&scoped=true
...
var update = injectStylesIntoStyleTag_default()(QuotationFormvue_type_style_index_0_id_8b1f23ac_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_QuotationFormvue_type_style_index_0_id_8b1f23ac_prod_scoped_true_lang_css = (QuotationFormvue_type_style_index_0_id_8b1f23ac_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/QuotationForm.vue?vue&type=style&index=0&id=8b1f23ac&prod&scoped=true&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  ...
  QuotationFormvue_type_template_id_8b1f23ac_scoped_true_render,
  QuotationFormvue_type_template_id_8b1f23ac_scoped_true_staticRenderFns,
  false,
  null,
  "8b1f23ac",
  null
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-8b1f23ac]{margin-bottom:15px}.footer-buttons[data-v-8b1f23ac]{display:flex;gap:10px}.footer-buttons .btn[data-v-8b1f23ac]{margin-right:10px}.footer-buttons .btn[data-v-8b1f23ac]:last-child{margin-right:0}.create-btn[data-v-8b1f23ac]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-8b1f23ac]:hover{background-color:#e9ecef}.edit-btn[data-v-8b1f23ac]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-8b1f23ac]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-8b1f23ac]{border:none!important}.quotations-create-table[data-v-8b1f23ac]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-8b1f23ac]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-8b1f23ac]{border:none!important}.quotations-create-table thead th[data-v-8b1f23ac]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-8b1f23ac]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-8b1f23ac]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-8b1f23ac]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-8b1f23ac]{gap:10px}.card[data-v-8b1f23ac]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-8b1f23ac]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-8b1f23ac]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-8b1f23ac]{background:#fff!important}.btn-primary[data-v-8b1f23ac]{background:#2ab930!important}.btn-secondary[data-v-8b1f23ac]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-8b1f23ac]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-8b1f23ac],.button-plus[data-v-8b1f23ac]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-8b1f23ac]{background-color:#dc3545;color:#fff}.button-plus[data-v-8b1f23ac]{background-color:#007bff;color:#fff}.button-minus[data-v-8b1f23ac]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-8b1f23ac]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-8b1f23ac]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-8b1f23ac]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-8b1f23ac]{direction:rtl}[dir=rtl] .create-btn[data-v-8b1f23ac]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-8b1f23ac]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-8b1f23ac]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-8b1f23ac]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-8b1f23ac]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-8b1f23ac]{border-right:1px solid #ced4da}.clickable-badge[data-v-8b1f23ac]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-8b1f23ac]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-8b1f23ac]:active{transform:scale(.95)}.insufficient-stock-input[data-v-8b1f23ac]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-8b1f23ac]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
