...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/show.vue?vue&type=template&id=080d5157&scoped=true
...
/* harmony default export */ const showvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    downloadPDF: function downloadPDF() {
      window.location.href = "/print/purchase-return/".concat(this.$route.params.slug, "/pdf");
    },
    // preview PDF
    previewPDF: function previewPDF() {
      window.location.href = "/print/purchase-return/".concat(this.$route.params.slug, "/preview");
    },
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_080d5157_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_showvue_type_style_index_0_id_080d5157_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_080d5157_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/show.vue?vue&type=style&index=0&id=080d5157&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-pills .nav-item[data-v-080d5157]{background:#ddd;border-radius:.25rem;margin:2px}.equal-sign[data-v-080d5157]{color:#007bff;font-weight:700;margin-right:5px}.bg-indigo-light[data-v-080d5157]{background-color:#e3f2fd!important}.bg-red-light[data-v-080d5157]{background-color:#ffebee!important}.bg-green-light[data-v-080d5157]{background-color:#e8f5e8!important}.bg-sub-light[data-v-080d5157]{background-color:#f8f9fa!important}.purchases-create-table[data-v-080d5157]{border-collapse:collapse;width:100%}.purchases-create-table td[data-v-080d5157],.purchases-create-table th[data-v-080d5157]{border:1px solid #dee2e6;padding:8px;text-align:center;vertical-align:middle}.purchases-create-table th[data-v-080d5157]{background-color:#f8f9fa;font-size:.875rem;font-weight:700}.purchases-create-table tbody tr[data-v-080d5157]:hover{background-color:#f8f9fa}.purchases-create-table .quantity-field[data-v-080d5157]{text-align:center;width:80px}.purchases-create-table .btn[data-v-080d5157]{font-size:.75rem;padding:.25rem .5rem}", ""]);
// Exports
