"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8022],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".tenant-details h3[data-v-1cba4168]{margin:15px 0 0}.card-body.tenant-details a[data-v-1cba4168]{display:block;font-size:16px;margin-top:0;text-align:center}.tenant-details table[data-v-1cba4168]{margin-top:20px;width:100%}.tenant-details table tr td[data-v-1cba4168]{border:1px solid #ddd;padding:8px 15px}.tenant-details table tr td[data-v-1cba4168]:first-child{width:30%}.domain-twrapper .card-header h3[data-v-1cba4168]{font-size:16px;margin:0;padding:0}.box-profile .list-group-item[data-v-1cba4168]{padding-left:20px;padding-right:20px}.box-profile .list-group[data-v-1cba4168]{border-left:1px solid #ddd;border-radius:0;border-right:1px solid #ddd}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/show.vue?vue&type=template&id=1cba4168&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }, [_vm.data && _vm.data.tenant_invoices && _vm.data.tenant_invoices.length > 0 ? _c('GeneralTable', {
    attrs: {
      "columns": _vm.tenantInvoiceColumns,
      "rows": _vm.tenantInvoiceRows,
      "loading": _vm.loading,
    ...
    }], null, false, 1804799535)
  }) : _c('div', {
    staticClass: "text-center"
  }, [_c('EmptyTable')], 1)], 1)], 1)])])])])])]) : _vm._e()], 1);
};
var staticRenderFns = [];
...
/* harmony default export */ const showvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["appInfo"])), {}, {
    tenantInvoiceColumns: function tenantInvoiceColumns() {
      return [{
        key: "id",
        label: this.$t("ID")
      }, {
    ...
    tenantInvoiceRows: function tenantInvoiceRows() {
      if (!this.data || !this.data.tenant_invoices) {
        return [];
      }
      return this.data.tenant_invoices.map(function (invoice) {
        var _invoice$plan;
        return _objectSpread(_objectSpread({}, invoice), {}, {
          plan: ((_invoice$plan = invoice.plan) === null || _invoice$plan === void 0 ? void 0 : _invoice$plan.name) || ""
        });
      });
    }
  }),
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_1cba4168_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const tenants_showvue_type_style_index_0_id_1cba4168_prod_lang_scss_scoped_true = (showvue_type_style_index_0_id_1cba4168_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/central/tenants/show.vue?vue&type=style&index=0&id=1cba4168&prod&lang=scss&scoped=true
