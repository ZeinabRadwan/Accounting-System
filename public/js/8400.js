"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8400],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/create.vue?vue&type=template&id=439589e3&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_439589e3_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_createvue_type_style_index_0_id_439589e3_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_439589e3_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/create.vue?vue&type=style&index=0&id=439589e3&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-439589e3]{gap:10px}.header-buttons[data-v-439589e3]{margin-bottom:15px}.footer-buttons[data-v-439589e3]{display:flex;gap:10px}.footer-buttons .btn[data-v-439589e3]{margin-right:10px}.footer-buttons .btn[data-v-439589e3]:last-child{margin-right:0}.card[data-v-439589e3]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-439589e3]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-439589e3]{padding:1.25rem}.card-footer[data-v-439589e3]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.btn-primary[data-v-439589e3]{background:#2ab930!important}.btn-primary[data-v-439589e3],.btn-secondary[data-v-439589e3]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-439589e3]{background:#33a0d9!important}.btn-secondary[data-v-439589e3]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
