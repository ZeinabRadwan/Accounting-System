"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9576],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".inner-card[data-v-4c9dddf8]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:20px}.inner-card .card-header[data-v-4c9dddf8]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:22px 16px}.form-control[data-v-4c9dddf8]{background:#fff!important}input[readonly][data-v-4c9dddf8]{background-color:#f8f9fa!important;border-color:#ced4da;color:#6c757d;cursor:not-allowed}.form-control[data-v-4c9dddf8]:focus,select.form-control[data-v-4c9dddf8]:focus,textarea.form-control[data-v-4c9dddf8]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-toggle[data-v-4c9dddf8]{border-color:#ced4da;border-radius:6px}.v-select .vs__dropdown-toggle.vs__open[data-v-4c9dddf8],.v-select .vs__dropdown-toggle[data-v-4c9dddf8]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-menu[data-v-4c9dddf8],.v-select .vs__search[data-v-4c9dddf8],.v-select .vs__selected[data-v-4c9dddf8]{font-size:.95rem}.custom-file-input:focus~.custom-file-label[data-v-4c9dddf8]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.custom-file-label[data-v-4c9dddf8]{border-radius:6px}.custom-file-label[data-v-4c9dddf8],[dir=rtl] .custom-file-label[data-v-4c9dddf8]{text-align:left!important}.btn-primary[data-v-4c9dddf8]{background:#2ab930!important;border:none!important;color:#fff!important}.card[data-v-4c9dddf8]{border-radius:20px;margin-top:30px;overflow:visible}.card[data-v-4c9dddf8],.settings-sidebar-wrapper[data-v-4c9dddf8]{border:1px solid #ced4da;box-shadow:0 8px 20px 0 #00000014}.settings-sidebar-wrapper[data-v-4c9dddf8]{background:#fff;border-radius:20px;padding:10px}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/general.vue?vue&type=template&id=4c9dddf8&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/general.vue?vue&type=script&lang=js
...
/* harmony default export */ const generalvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    onLogoChange: function onLogoChange(e) {
      ...
      if (file.size < 2111775 && (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/gif' || file.type === "image/svg" || file.type === "image/svg+xml")) {
        reader.onloadend = function () {
          _this10.form.logo = reader.result;
        };
    ...
    onBlackLogoChange: function onBlackLogoChange(e) {
      ...
      if (file.size < 2111775 && (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/gif' || file.type === "image/svg" || file.type === "image/svg+xml")) {
        reader.onloadend = function () {
          _this11.form.blackLogo = reader.result;
        };
        reader.readAsDataURL(file);
    ...
    onSmallLogoChange: function onSmallLogoChange(e) {
      ...
      if (file.size < 2111775 && (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/gif' || file.type === "image/svg" || file.type === "image/svg+xml")) {
        reader.onloadend = function () {
          _this12.form.smallLogo = reader.result;
        };
        reader.readAsDataURL(file);
    ...
    onFaviconChange: function onFaviconChange(e) {
      ...
      if (file.size < 2111775 && (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/gif' || file.type === "image/svg" || file.type === "image/svg+xml")) {
        reader.onloadend = function () {
          _this13.form.favicon = reader.result;
        };
        reader.readAsDataURL(file);
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              if (!_this14.isDemoMode) {
                _context7.next = 2;
                break;
              }
              return _context7.abrupt("return", toast.fire({
                type: 'warning',
                title: _this14.$t('You are not allowed to do this in demo version.')
              }));
            case 2:
              // update locale
              locale = _this14.form.language;
              if (_this14.$i18n.locale !== locale) {
                (0,i18n.loadMessages)(locale);
                _this14.$store.dispatch('lang/setLocale', {
                  locale: locale
                });
              }
              ...
              // for production
              _context7.next = 6;
              return _this14.form.post(window.location.origin + '/api/update-settings').then(function () {
                toast.fire({
                  type: 'success',
                  title: _this14.$t('Settings updated successfully')
                });
...
;// CONCATENATED MODULE: ./resources/js/pages/setup/general.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(generalvue_type_style_index_0_id_4c9dddf8_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const setup_generalvue_type_style_index_0_id_4c9dddf8_prod_lang_scss_scoped_true = (generalvue_type_style_index_0_id_4c9dddf8_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/setup/general.vue?vue&type=style&index=0&id=4c9dddf8&prod&lang=scss&scoped=true

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/setup/general.vue
