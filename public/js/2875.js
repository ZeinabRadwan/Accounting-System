...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-pills .nav-item[data-v-6deb6c7f]{background:#ddd;border-radius:.25rem;margin:2px}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/show.vue?vue&type=template&id=6deb6c7f&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Code")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Item Name")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Quantity")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Unit Price")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Discount")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Total After Discount")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Unit Tax")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Unit Cost")))]), _vm._v(" "), _c('th', {
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.$t("Subtotal")))])])]), _vm._v(" "), _vm.allData.products ? _c('tbody', [_vm._l(_vm.allData.products, function (data, i) {
    return _c('tr', {
      key: i
    }, [_c('td', [_vm._v(_vm._s(++i))]), _vm._v(" "), _c('td', [_vm._v("\n                        " + _vm._s(_vm._f("withPrefix")(data.productCode, _vm.productPrefix)) + "\n                      ")]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.productName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.quantity) + " " + _vm._s(data.productUnit))]), _vm._v(" "), _c('td', {
      staticClass: "no-currency"
    }, [_vm._v(_vm._s(data.salePrice))]), _vm._v(" "), _c('td', {
      staticClass: "no-currency"
    }, [_vm._v(_vm._s(data.discountAmount || 0))]), _vm._v(" "), _c('td', {
      staticClass: "no-currency"
    }, [_vm._v(_vm._s(_vm.calculateTotalAfterDiscount(data)))]), _vm._v(" "), _c('td', {
      staticClass: "no-currency"
    }, [_vm._v(_vm._s(_vm.calculateUnitTax(data)))]), _vm._v(" "), _c('td', {
      staticClass: "no-currency"
    }, [_vm._v(_vm._s(_vm.calculateUnitCost(data)))]), _vm._v(" "), _c('td', {
      staticClass: "text-right no-currency"
    }, [_vm._v("\n                        " + _vm._s(_vm.calculateSubtotal(data)) + "\n                      ")])]);
  }), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "9"
    ...
    staticClass: "text-right no-currency"
  }, [_c('strong', [_vm._v(_vm._s(_vm.calculatedSubTotal))])])])], 2) : _vm._e()])])])]), _vm._v(" "), _c('div', {
    staticClass: "row mt-3"
  }, [_c('div', {
  ...
  }, [_c('th', [_vm._v(_vm._s(_vm.$t("Total before vat")) + ":")]), _vm._v(" "), _c('td', {
    staticClass: "no-currency"
  }, [_vm._v(_vm._s(_vm.calculatedTotalAfterDiscount))])]), _vm._v(" "), _c('tr', [_c('th', [_vm._v("\n                        " + _vm._s(_vm.$t("Discount")) + "\n                        "), _vm.allData.discountPercentage > 0 ? _c('span', [_vm._v("(" + _vm._s(_vm.allData.discountPercentage) + "%)")]) : _vm._e(), _vm._v(":\n                      ")]), _vm._v(" "), _c('td', {
    staticClass: "no-currency"
  }, [_vm._v("\n                        " + _vm._s(_vm.calculatedTotalDiscount) + "\n                      ")])]), _vm._v(" "), _c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Total After Discount")) + ":")]), _vm._v(" "), _c('td', {
    staticClass: "no-currency"
  }, [_vm._v("\n                        " + _vm._s(_vm.calculatedTotalAfterDiscount) + "\n                      ")])]), _vm._v(" "), _c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Transport")) + ":")]), _vm._v(" "), _c('td', {
    staticClass: "no-currency"
  }, [_vm._v("\n                        " + _vm._s(_vm.allData.transport || 0) + "\n                      ")])]), _vm._v(" "), _c('tr', [_c('th', [_vm._v("\n                        " + _vm._s(_vm.$t("Tax")) + "\n                        "), _vm.allData.quotationTax ? _c('span', [_vm._v("(" + _vm._s(_vm.allData.quotationTax.rate) + "%)")]) : _vm._e(), _vm._v(": "), _c('br'), _vm._v(" "), _vm.allData.quotationTax && _vm.allData.quotationTax.group_tax_details && _vm.allData.quotationTax.group_tax_details.length ? _c('span', [_vm._v("\n                          ("), _vm._l(_vm.allData.quotationTax.group_tax_details, function (tax, index) {
    return _c('span', {
      key: tax.id
    }, [_vm._v("\n                            " + _vm._s(tax.rate) + "%"), index < _vm.allData.quotationTax.group_tax_details.length - 1 ? _c('span', [_vm._v("\n                              +")]) : _vm._e()]);
  }), _vm._v(")\n                        ")], 2) : _vm._e()]), _vm._v(" "), _c('td', {
    staticClass: "no-currency"
  }, [_vm._v("\n                        " + _vm._s(_vm.allData.totalTax) + "\n                      ")])]), _vm._v(" "), _c('tr', {
    staticClass: "bg-indigo-light"
  }, [_c('th', [_vm._v(_vm._s(_vm.$t("Total")) + ":")]), _vm._v(" "), _c('td', {
    staticClass: "no-currency"
  }, [_c('span', {
    staticClass: "equal-sign"
  }, [_vm._v("=")]), _vm._v("\n                        " + _vm._s(_vm.calculatedTotal) + "\n                      ")])])])])])])])], 1)])]), _vm._v(" "), _c('div', {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["appInfo", "items", "loading", "pagination"])), {}, {
    ...
    calculatedSubTotal: function calculatedSubTotal() {
      ...
      this.allData.products.forEach(function (product) {
        total += parseFloat(_this.calculateSubtotal(product));
      });
      return total.toFixed(2);
    },
    // calculate total discount from all products
    calculatedTotalDiscount: function calculatedTotalDiscount() {
      if (!this.allData.products) return 0;
      var totalDiscount = 0;
      this.allData.products.forEach(function (product) {
    ...
    calculatedTotalAfterDiscount: function calculatedTotalAfterDiscount() {
      if (!this.allData.products) return 0;
      var totalAfterDiscount = 0;
      this.allData.products.forEach(function (product) {
        var unitPrice = parseFloat(product.salePrice) || 0;
        var quantity = parseFloat(product.quantity) || 0;
        var discount = parseFloat(product.discountAmount) || 0;

        // Total After Discount = unit price * quantity - discount
        var productTotalAfterDiscount = unitPrice * quantity - discount;
    ...
    calculatedTotal: function calculatedTotal() {
      ...
      var transport = parseFloat(this.allData.transport) || 0;
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_6deb6c7f_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_showvue_type_style_index_0_id_6deb6c7f_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_6deb6c7f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/quotations/show.vue?vue&type=style&index=0&id=6deb6c7f&prod&scoped=true&lang=css
