"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4293],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/tenant-initialization.vue?vue&type=template&id=eb1159a6&scoped=true
...
;// ./resources/js/pages/tenant-initialization.vue?vue&type=template&id=eb1159a6&scoped=true
...
var update = injectStylesIntoStyleTag_default()(tenant_initializationvue_type_style_index_0_id_eb1159a6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_tenant_initializationvue_type_style_index_0_id_eb1159a6_prod_scoped_true_lang_css = (tenant_initializationvue_type_style_index_0_id_eb1159a6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/tenant-initialization.vue?vue&type=style&index=0&id=eb1159a6&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".tenant-initialization[data-v-eb1159a6]{background:#fff;min-height:100vh;padding:20px}.tenant-initialization .form-label[data-v-eb1159a6]{font-family:Almarai,sans-serif;font-size:19px;font-weight:500}.tenant-initialization .document-prefix-label[data-v-eb1159a6]{color:#707685;font-size:12px;font-weight:400}.tenant-initialization input.form-control[data-v-eb1159a6],.tenant-initialization select.form-control[data-v-eb1159a6],.tenant-initialization textarea.form-control[data-v-eb1159a6]{border:1px solid #cbd0dd!important;border-radius:10px!important;box-shadow:none!important;font-size:14px!important;padding:3px 16px 10px!important}.tenant-initialization input.form-control[data-v-eb1159a6]::-moz-placeholder,.tenant-initialization textarea.form-control[data-v-eb1159a6]::-moz-placeholder{color:#707685!important;font-size:14px!important;font-weight:400!important}.tenant-initialization input.form-control[data-v-eb1159a6]::placeholder,.tenant-initialization textarea.form-control[data-v-eb1159a6]::placeholder{color:#707685!important;font-size:14px!important;font-weight:400!important}.tenant-initialization select.form-control[data-v-eb1159a6]{color:#707685!important;font-size:14px!important;font-weight:400!important}.tenant-initialization select.form-control option[data-v-eb1159a6]{color:#000}.tenant-initialization select.form-control option[data-v-eb1159a6]:first-child{color:#707685}.language-switcher-container[data-v-eb1159a6]{position:fixed;right:20px;top:20px;z-index:9999}.auth-wrapper[data-v-eb1159a6]{align-items:center;display:flex;min-height:100vh;padding:60px 20px}.wizard-progress[data-v-eb1159a6]{margin-bottom:30px}.progress-container[data-v-eb1159a6]{align-items:center;display:flex;justify-content:space-between;margin:0 auto;max-width:700px;position:relative}.progress-container[data-v-eb1159a6]:before{background:#e7f2f7;content:\"\";height:2px;position:absolute;top:12px;z-index:1}.progress-container.rtl[data-v-eb1159a6]:before,.progress-container[data-v-eb1159a6]:not(.rtl):before{left:calc(12.5px + 8%);right:calc(12.5px + 8%)}.progress-item[data-v-eb1159a6]{flex:1;flex-direction:column}.progress-item[data-v-eb1159a6],.step-indicator[data-v-eb1159a6]{align-items:center;display:flex;position:relative}.step-indicator[data-v-eb1159a6]{background:#e7f2f7;border:none;border-radius:50%;font-size:16px;font-weight:600;height:25px;justify-content:center;margin-bottom:10px;transition:all .3s ease;width:25px;z-index:2}.progress-item.active .step-indicator[data-v-eb1159a6]{background:#0775af;border:none;color:#fff}.progress-item.completed .step-indicator[data-v-eb1159a6]{background:#28a745;border:none;color:#fff}.step-number[data-v-eb1159a6]{font-size:16px;font-weight:600;transition:opacity .3s ease}.step-check[data-v-eb1159a6]{align-items:center;animation:scaleIn-eb1159a6 .3s ease;color:#fff;display:flex;font-size:14px;justify-content:center}@keyframes scaleIn-eb1159a6{0%{opacity:0;transform:scale(0)}to{opacity:1;transform:scale(1)}}.step-title[data-v-eb1159a6]{color:#6c757d;font-size:12px;font-weight:500;text-align:center}.progress-item.active .step-title[data-v-eb1159a6]{color:#0775af;font-weight:600}.system-type-card[data-v-eb1159a6]{background:#fff;border:2px solid #e9ecef;border-radius:15px;box-shadow:0 2px 4px rgba(0,0,0,.05);cursor:pointer;height:100%;padding:25px 15px;position:relative;text-align:center;transition:all .3s}.system-badge[data-v-eb1159a6]{align-items:center;background:#f3fff5;border:.5px solid #2f8a3a;border-radius:8px;color:#2f8a3a;display:flex;font-size:12px;font-weight:500;gap:4px;padding:4px 8px;position:absolute;right:10px;top:10px;z-index:1}.system-badge i[data-v-eb1159a6]{font-size:10px}.system-type-card[data-v-eb1159a6]:hover{border-color:#0775af;box-shadow:0 8px 20px rgba(51,160,217,.1);transform:translateY(-5px)}.system-type-card.active[data-v-eb1159a6]{background:#f8fbff;border-color:#0775af;box-shadow:0 8px 20px rgba(51,160,217,.15);transform:translateY(-5px)}.card-icon[data-v-eb1159a6]{color:#0775af;font-size:48px;margin-bottom:15px}.system-type-card h6[data-v-eb1159a6]{color:#333;font-weight:600;margin-bottom:8px}.system-type-card p[data-v-eb1159a6]{color:#6c757d;font-size:13px;margin:0}.wizard-step[data-v-eb1159a6]{animation:fadeIn-eb1159a6 .3s}@keyframes fadeIn-eb1159a6{0%{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}.lg-logo[data-v-eb1159a6]{transition:all .3s ease}.lg-logo[data-v-eb1159a6]:hover{opacity:.9}.text-primary[data-v-eb1159a6]{color:#0775af!important}.btn-primary[data-v-eb1159a6]{background-color:#0775af;border-color:#0775af}.btn-primary[data-v-eb1159a6]:hover{background-color:#2b8bc4;border-color:#2b8bc4}@media (max-width:768px){.language-switcher-container[data-v-eb1159a6]{right:10px;top:10px}.auth-wrapper[data-v-eb1159a6]{padding:40px 15px}.step-indicator[data-v-eb1159a6]{height:25px;width:25px}.step-check[data-v-eb1159a6],.step-number[data-v-eb1159a6]{font-size:12px}.step-title[data-v-eb1159a6]{font-size:10px}.progress-container[data-v-eb1159a6]{gap:5px;max-width:100%}.card-icon[data-v-eb1159a6]{font-size:36px}.system-type-card[data-v-eb1159a6]{padding:20px 12px}}.tenant-initialization .language-switcher-container[data-v-eb1159a6]{left:auto;right:20px}@media (max-width:768px){.tenant-initialization .language-switcher-container[data-v-eb1159a6]{left:auto;right:10px}}.logo-upload-container[data-v-eb1159a6]{align-items:center;display:flex;flex-direction:column}.logo-preview[data-v-eb1159a6]{text-align:center}.logo-preview-image[data-v-eb1159a6]{box-shadow:0 2px 8px rgba(0,0,0,.1);max-height:200px;max-width:200px}.file-upload-area[data-v-eb1159a6]{background:#f8f9fa;border:2px dashed #dee2e6;border-radius:15px;overflow:hidden;padding:40px 20px;position:relative;text-align:center;transition:all .3s ease;width:100%}.file-upload-area *[data-v-eb1159a6]{text-align:center}.file-upload-area[data-v-eb1159a6]:hover{background:#f0f7ff;border-color:#0775af}.file-upload-area.has-logo[data-v-eb1159a6]{background:#f0fff4;border-color:#28a745;padding:20px}.file-upload-label[data-v-eb1159a6]{align-items:center;cursor:pointer;display:flex;flex-direction:column;gap:15px;justify-content:center;padding:10px;transition:all .3s ease}.file-upload-label[data-v-eb1159a6]:hover{transform:translateY(-2px)}.upload-icon-wrapper[data-v-eb1159a6]{align-items:center;background:linear-gradient(135deg,#0775af,#2b8bc4);border-radius:50%;box-shadow:0 4px 15px rgba(51,160,217,.3);color:#fff;display:flex;font-size:24px;height:60px;justify-content:center;transition:all .3s ease;width:60px}.file-upload-label:hover .upload-icon-wrapper[data-v-eb1159a6]{box-shadow:0 6px 20px rgba(51,160,217,.4);transform:scale(1.1)}.upload-text[data-v-eb1159a6]{display:flex;flex-direction:column;gap:5px}.upload-title[data-v-eb1159a6]{color:#333;font-size:16px;font-weight:600}.upload-subtitle[data-v-eb1159a6]{color:#6c757d;font-size:13px}.file-upload-area.has-logo .upload-icon-wrapper[data-v-eb1159a6]{background:linear-gradient(135deg,#28a745,#218838);box-shadow:0 4px 15px rgba(40,167,69,.3)}.file-upload-area.has-logo .upload-title[data-v-eb1159a6]{color:#28a745}@media (max-width:768px){.file-upload-area[data-v-eb1159a6]{padding:30px 15px}.upload-icon-wrapper[data-v-eb1159a6]{font-size:20px;height:50px;width:50px}.upload-title[data-v-eb1159a6]{font-size:14px}.upload-subtitle[data-v-eb1159a6]{font-size:12px}}.logo-preview-wrapper[data-v-eb1159a6]{border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,.1);display:inline-block;overflow:hidden;position:relative}.logo-preview-wrapper:hover .logo-preview-overlay[data-v-eb1159a6]{opacity:1}.logo-preview-overlay[data-v-eb1159a6]{align-items:center;background:rgba(0,0,0,.5);bottom:0;display:flex;justify-content:center;left:0;opacity:0;position:absolute;right:0;top:0;transition:opacity .3s ease}.logo-preview-image[data-v-eb1159a6]{background:#f8f9fa;border-radius:10px;display:block;height:300px;-o-object-fit:contain;object-fit:contain;width:300px}.logo-crop-wrapper[data-v-eb1159a6]{background:#f8f9fa;border:2px dashed #dee2e6;border-radius:15px;padding:20px}.crop-container-inline[data-v-eb1159a6]{background:#fff;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,.1);margin:0 auto;max-height:400px;max-width:600px;overflow:hidden;width:100%}.crop-image-inline[data-v-eb1159a6]{display:block;max-width:100%}.crop-actions[data-v-eb1159a6]{display:flex;gap:10px;justify-content:center}.crop-actions .btn[data-v-eb1159a6]{min-width:120px}.crop-container-inline .cropper-container[data-v-eb1159a6]{max-height:400px}.crop-container-inline .cropper-view-box[data-v-eb1159a6]{outline:2px solid #0775af;outline-offset:-2px}@media (max-width:768px){.logo-crop-wrapper[data-v-eb1159a6]{padding:15px}.crop-container-inline[data-v-eb1159a6]{max-height:300px}.crop-actions[data-v-eb1159a6]{flex-direction:column}.crop-actions .btn[data-v-eb1159a6]{width:100%}.logo-preview-image[data-v-eb1159a6]{height:200px;width:200px}}.country-select[data-v-eb1159a6]{width:100%}.country-select+.select2-container[data-v-eb1159a6]{width:100%!important}.country-select+.select2-container .select2-selection--single[data-v-eb1159a6],.country-select+.select2-container--default .select2-selection--single[data-v-eb1159a6]{background-color:#fff;border:1px solid #cbd0dd;border-radius:50px;box-shadow:0 .125rem .25rem rgba(0,0,0,.075);height:auto!important;min-height:3rem;padding:.5rem 1rem}.country-select+.select2-container .select2-selection[data-v-eb1159a6]{height:auto!important}.country-select+.select2-container .select2-selection--single .select2-selection__rendered[data-v-eb1159a6]{align-items:center;color:#333;display:flex;line-height:2rem;padding:0}.country-select+.select2-container .select2-selection--single .select2-selection__arrow[data-v-eb1159a6]{height:auto!important;right:1rem;top:50%;transform:translateY(-50%)}.country-select.is-invalid+.select2-container .select2-selection--single[data-v-eb1159a6]{border-color:#dc3545;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)}.country-select+.select2-container .select2-dropdown[data-v-eb1159a6]{border:1px solid #e9ecef;border-radius:15px;box-shadow:0 .5rem 1rem rgba(0,0,0,.15);margin-top:.5rem}.country-select+.select2-container .select2-results__option[data-v-eb1159a6]{align-items:center;cursor:pointer;display:flex;padding:.75rem 1rem;transition:background-color .2s ease}.country-select+.select2-container .select2-results__option[data-v-eb1159a6]:hover{background-color:#f8f9fa}.country-select+.select2-container .select2-results__option--highlighted[data-v-eb1159a6]{background-color:#0775af;color:#fff}.country-select+.select2-container .select2-results__option img[data-v-eb1159a6]{margin-right:8px;vertical-align:middle}.tenant-submit-btn[data-v-eb1159a6]{align-items:center;background:#0775af!important;border:1px solid #0775af!important;border-radius:9px;color:#fff;display:flex;font-weight:500;justify-content:center;margin-top:1rem;padding:12px;text-align:center;transition:all .3s ease;width:87%}.tenant-submit-btn-full[data-v-eb1159a6]{width:100%!important}.tenant-submit-btn[data-v-eb1159a6]:hover{background:#06608a!important;color:#fff}.tenant-submit-btn[data-v-eb1159a6]:focus{box-shadow:0 0 0 3px rgba(7,117,175,.25);outline:none}.tenant-submit-btn[data-v-eb1159a6]:disabled{cursor:not-allowed;opacity:.6}.tenant-prev-btn[data-v-eb1159a6]{align-items:center;background:transparent!important;border:1px solid #191e29!important;border-radius:10px!important;color:#191e29;display:flex;font-size:1rem;font-weight:500;height:auto;justify-content:center;margin-top:1rem;padding:0!important;text-align:center;width:12%}.tenant-prev-btn[data-v-eb1159a6]:hover{background:#f8f9fa!important;color:#191e29}.tenant-prev-btn[data-v-eb1159a6]:focus{box-shadow:0 0 0 3px rgba(25,30,41,.25);outline:none}.tenant-prev-btn[data-v-eb1159a6]:disabled{cursor:not-allowed;opacity:.6}", ""]);
// Exports
