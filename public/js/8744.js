"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8744],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/fiscal-years.vue?vue&type=template&id=4bcaa5a8
var render = function render() {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('ID')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Name')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Start Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('End Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Status')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Accounting Periods')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Actions')))])])]), _vm._v(" "), _c('tbody', _vm._l(_vm.fiscalYears, function (fiscalYear) {
    return _c('tr', {
      key: fiscalYear.id
      ...
      attrs: {
        ...
        "disabled": fiscalYear.id === _vm.currentFiscalYearId
      },
      on: {
        "click": function click($event) {
...
;// ./resources/js/pages/setup/fiscal-years.vue?vue&type=template&id=4bcaa5a8
          ...
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              if (response.data.data) {
                _this2.currentFiscalYearId = response.data.data.id;
              }
              _context2.n = 3;
              break;
            case 2:
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              ...
              console.log('Editing fiscal year with ID:', _this3.form.id);
              _context3.n = 1;
              return _this3.form.put("/api/fiscal-years/".concat(_this3.form.id));
            case 1:
              _context3.n = 3;
              break;
            case 2:
              _context3.n = 3;
              return _this3.form.post('/api/fiscal-years');
            case 3:
              toast.fire({
                type: 'success',
                title: _this3.$t('Fiscal year saved successfully')
              });
            ...
            case 4:
              ...
              if (_t3.response && _t3.response.data && _t3.response.data.message) {
                ...
                toast.fire({
                  type: 'error',
                  title: _this3.$t('Error saving fiscal year')
                });
              }
            case 5:
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 1:
              ...
              _this4.currentFiscalYearId = fiscalYear.id;
              toast.fire({
                type: 'success',
                title: _this4.$t('Current fiscal year set successfully')
              });
            ...
            case 2:
              ...
              if (_t4.response && _t4.response.data && _t4.response.data.message) {
                ...
                toast.fire({
                  type: 'error',
                  title: _this4.$t('Error setting current fiscal year')
                });
              }
            case 3:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              if (!confirm(_this5.$t('Are you sure you want to delete this fiscal year?'))) {
                _context5.n = 4;
                break;
              }
              _context5.p = 1;
            ...
            case 2:
              toast.fire({
                type: 'success',
                title: _this5.$t('Fiscal year deleted successfully')
              });
            ...
            case 3:
              ...
              if (_t5.response && _t5.response.data && _t5.response.data.message) {
                ...
                toast.fire({
                  type: 'error',
                  title: _this5.$t('Cannot delete fiscal year with existing accounting periods')
                });
              }
            case 4:
