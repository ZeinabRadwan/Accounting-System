...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card[data-v-46645254]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-46645254]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-46645254]{padding:1.25rem}.card-footer[data-v-46645254]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-46645254]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-46645254]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-46645254]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.text-danger[data-v-46645254]{color:#dc3545!important;font-weight:700}.btn-primary[data-v-46645254]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-46645254]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-46645254]:disabled{background:#6c757d!important;box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}.btn-secondary[data-v-46645254]{background:#6c757d!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-46645254]:hover{background:#5a6268!important;box-shadow:0 4px 8px hsla(208,7%,46%,.3);transform:translateY(-1px)}.btn-danger[data-v-46645254]{background:#dc3545!important;border:none!important;border-radius:8px!important;color:#fff!important;font-weight:500;padding:8px 12px!important}.btn-danger[data-v-46645254]:hover{background:#c82333!important;box-shadow:0 4px 8px rgba(220,53,69,.3);transform:translateY(-1px)}.is-invalid[data-v-46645254]{border-color:#dc3545!important}textarea.form-control[data-v-46645254]{min-height:100px;resize:vertical}.v-select[data-v-46645254]{background:#f1f5fb!important}.v-select .vs__dropdown-toggle[data-v-46645254]{background:#f1f5fb!important;border:1px solid #e5e7eb!important;border-radius:10px!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-46645254]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-46645254]{border-color:#dc3545!important}.alert[data-v-46645254]{border:1px solid transparent;border-radius:10px;margin-bottom:16px;padding:12px 16px}.alert-success[data-v-46645254]{background-color:#d4edda;border-color:#c3e6cb;color:#155724}.alert-warning[data-v-46645254]{background-color:#fff3cd;border-color:#ffeaa7;color:#856404}.table th[data-v-46645254]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 16px}.table td[data-v-46645254]{border-bottom:1px solid #e5e7eb;padding:12px 16px;vertical-align:middle}.table tbody tr[data-v-46645254]:hover{background-color:#f8f9fa}.invalid-feedback[data-v-46645254]{color:#dc3545;display:block}.form-text[data-v-46645254],.invalid-feedback[data-v-46645254]{font-size:12px;margin-top:5px}.form-text[data-v-46645254]{color:#6c757d}.row[data-v-46645254]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-46645254]{flex-direction:column;gap:10px}.card-footer .btn[data-v-46645254]{margin-right:0!important;width:100%}.card-footer div[data-v-46645254]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/journal-entries/create.vue?vue&type=template&id=46645254&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_46645254_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const journal_entries_createvue_type_style_index_0_id_46645254_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_46645254_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/journal-entries/create.vue?vue&type=style&index=0&id=46645254&prod&scoped=true&lang=css
