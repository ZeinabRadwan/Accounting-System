(self["webpackChunk"] = self["webpackChunk"] || []).push([[5799],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/accounts/index.vue?vue&type=template&id=06fa08e9&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm._v("\n                      " + _vm._s(data.bankName) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(data.bankName))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.branchName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.accountNumber))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.availableBalance)))]), _vm._v(" "), _c('td', [data.status === 1 ? _c('span', {
    ...
    }, [_c('ul', [_vm.$can('account-view') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'accounts.show',
          params: {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Transactions')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('account-edit') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'accounts.edit',
          params: {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Edit')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('account-delete') && _vm.appInfo.defaultAccountSlug != data.slug ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
...
var update = injectStylesIntoStyleTag_default()(accountsvue_type_style_index_0_id_06fa08e9_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const cashbook_accountsvue_type_style_index_0_id_06fa08e9_prod_scoped_true_lang_css = (accountsvue_type_style_index_0_id_06fa08e9_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/accounts/index.vue?vue&type=style&index=0&id=06fa08e9&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-06fa08e9]{border:none!important}.accounts-table[data-v-06fa08e9]{border-collapse:separate;border-spacing:0}.accounts-table thead th[data-v-06fa08e9]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.accounts-table thead tr[data-v-06fa08e9]{border:none!important}.accounts-table thead th[data-v-06fa08e9]:first-child{border-top-left-radius:10px}.accounts-table thead th[data-v-06fa08e9]:last-child{border-top-right-radius:10px}[dir=rtl] .accounts-table thead th[data-v-06fa08e9]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .accounts-table thead th[data-v-06fa08e9]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-06fa08e9]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-06fa08e9],.export-pdf-btn[data-v-06fa08e9]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-06fa08e9],.export-pdf-btn[data-v-06fa08e9],.print-btn[data-v-06fa08e9]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-06fa08e9]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-06fa08e9]{display:inline-block;position:relative}.action-icon-btn[data-v-06fa08e9]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-06fa08e9]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-06fa08e9]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-06fa08e9]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-06fa08e9]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-06fa08e9]{gap:10px}.btn-group.c-w-100>.btn[data-v-06fa08e9]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-06fa08e9]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-06fa08e9]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-06fa08e9]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-06fa08e9]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.accounts-table .badge.bg-success[data-v-06fa08e9]{background:#f6fef4!important;color:#2ab930!important}.accounts-table .badge.bg-danger[data-v-06fa08e9],.accounts-table .badge.bg-success[data-v-06fa08e9]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.accounts-table .badge.bg-danger[data-v-06fa08e9]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-06fa08e9]{background:#f1f5fb!important}.btn-primary[data-v-06fa08e9]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-06fa08e9]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-06fa08e9]{align-items:center;color:#6c757d;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
