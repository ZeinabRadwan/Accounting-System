"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7114],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/today-report.vue?vue&type=template&id=00355d0d&scoped=true
...
;// ./resources/js/pages/reports/today-report.vue?vue&type=template&id=00355d0d&scoped=true
...
var update = injectStylesIntoStyleTag_default()(today_reportvue_type_style_index_0_id_00355d0d_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_today_reportvue_type_style_index_0_id_00355d0d_prod_scoped_true_lang_css = (today_reportvue_type_style_index_0_id_00355d0d_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/today-report.vue?vue&type=style&index=0&id=00355d0d&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-00355d0d]{border:none!important}.refresh-btn[data-v-00355d0d]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-00355d0d],.export-pdf-btn[data-v-00355d0d],.preview-btn[data-v-00355d0d]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-00355d0d],.export-pdf-btn[data-v-00355d0d],.preview-btn[data-v-00355d0d],.print-btn[data-v-00355d0d]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-00355d0d]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-00355d0d]{gap:10px}.card[data-v-00355d0d]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-00355d0d]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.table-striped td[data-v-00355d0d],.table-striped th[data-v-00355d0d]{vertical-align:middle}.form-control[data-v-00355d0d]{background:#fff!important}@media (max-width:1300px){.info-box[data-v-00355d0d]{padding:0}}", ""]);
// Exports
