...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".cancelled-row[data-v-3d098316]{background-color:#f8f9fa;opacity:.7;text-decoration:line-through}.cancelled-row td[data-v-3d098316]{color:#6c757d;text-decoration:line-through}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/clients/invoice/index.vue?vue&type=template&id=3d098316&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    staticClass: "table"
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Client")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Total")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Paid Amount")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Account")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Payment Date")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _vm.$can('invoice-payment-edit') || _vm.$can('invoice-payment-view') || _vm.$can('invoice-payment-delete') ? _c('th', {
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('invoice-payment-edit') && data.status !== 2 ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Edit'),
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('invoice-payment-delete') && data.status === 1 ? _c('a', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Cancel Payment'),
        expression: "$t('Cancel Payment')"
      }],
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('invoice-payment-delete') && data.status === 0 ? _c('a', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Delete'),
          ...
          while (1) switch (_context8.n) {
            case 0:
              sweetalert2_all_default().fire({
                title: _this8.$t("Cancel Payment"),
                text: _this8.$t("Are you sure you want to cancel this payment? This will delete the related journal entries."),
                type: "warning",
                showCancelButton: true,
                confirmButtonText: _this8.$t("Yes, Cancel"),
                cancelButtonText: _this8.$t("No"),
                confirmButtonColor: "#f39c12",
                cancelButtonColor: "#6c757d"
              }).then(function (result) {
                if (result.value) {
                  _this8.$axios.post("/api/payments/invoice/cancel/".concat(slug)).then(function (response) {
                    if (response.data.success) {
                      sweetalert2_all_default().fire(_this8.$t("Cancelled!"), _this8.$t("Payment has been cancelled successfully."), "success");
                      _this8.getData(); // Refresh the table
                    } else {
                      sweetalert2_all_default().fire(_this8.$t("Failed!"), _this8.$t("Sorry, couldn't cancel this payment!"), "error");
                    }
...
var update = injectStylesIntoStyleTag_default()(invoicevue_type_style_index_0_id_3d098316_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const clients_invoicevue_type_style_index_0_id_3d098316_prod_scoped_true_lang_css = (invoicevue_type_style_index_0_id_3d098316_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payments/clients/invoice/index.vue?vue&type=style&index=0&id=3d098316&prod&scoped=true&lang=css
