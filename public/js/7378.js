"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7378],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".client-status[data-v-648a1996],.supplier-status[data-v-648a1996]{font-size:13px}.client-success[data-v-648a1996],.client-warning[data-v-648a1996],.supplier-warning[data-v-648a1996]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-648a1996],.supplier-warning[data-v-648a1996]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-648a1996]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.create-btn[data-v-648a1996]{align-items:center;background-color:#33a0d9;border:1px solid #33a0d9;border-left:none;border-radius:0 10px 10px 0;color:#fff;cursor:pointer;display:flex;justify-content:center;padding:10px 16px;transition:all .3s ease}.create-btn[data-v-648a1996]:hover{background-color:#2a8bc4;border-color:#2a8bc4}.create-btn i[data-v-648a1996]{font-size:18px}.account-select[data-v-648a1996],[dir=rtl] .create-btn[data-v-648a1996]{border-radius:10px 0 0 10px}[dir=rtl] .create-btn[data-v-648a1996]{border-left:1px solid #33a0d9;border-right:none}[dir=rtl] .account-select[data-v-648a1996]{border-radius:0 10px 10px 0}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/vouchers/receive/create.vue?vue&type=template&id=648a1996&scoped=true
...
var render = function render() {
  ...
  return _c('div', {
    ...
    staticClass: "form-text text-muted"
  }, [_vm._v("\n                  " + _vm._s(_vm.$t("Automatically set based on payment method")) + "\n                ")])]) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.form && _vm.form.entityType === 'client' && _vm.invoices ? _c('div', {
    staticClass: "row"
  }, [_c('div', {
    staticClass: "form-group col-md-12"
  }, [_c('label', {
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/vouchers/receive/create.vue?vue&type=script&lang=js
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  methods: _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              query = _this2.$route.query; // If invoice and client are provided, auto-fill the form
              if (!(query.invoice && query.client)) {
                _context.next = 12;
                break;
              }
              // Set entity type to client
              _this2.form.entityType = 'client';
            ...
            case 5:
              ...
              client = _this2.clients.find(function (c) {
              ...
              _this2.form.client = client;
              // Set payment method to invoice (for backward compatibility)
              _this2.form.paymentMethod = 'invoice';
            ...
            case 11:
              ...
              if (_this2.invoices && _this2.invoices.length > 0) {
                invoice = _this2.invoices.find(function (inv) {
                  return inv.slug === query.invoice;
                });
                if (invoice) {
                  _this2.form.invoice = invoice;
                }
              }
            case 12:
            case "end":
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _this3.clients = _this3.$store.getters['operations/items'] || [];
            case 3:
            case "end":
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              _this4.suppliers = _this4.$store.getters['operations/items'] || [];
            case 3:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              _this5.chartOfAccounts = (data.data || data || []).map(function (account) {
                return {
                  id: account.id,
                  name: account.name,
                  code: account.code
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              if (!(_this6.form.client && _this6.form.client.slug)) {
                _context5.next = 12;
                break;
              }
              _context5.prev = 1;
              _context5.next = 4;
              return axios_default().get(window.location.origin + '/api/client/' + _this6.form.client.slug + '/invoices');
            case 4:
              _yield$axios$get2 = _context5.sent;
              data = _yield$axios$get2.data;
              _this6.invoices = (data.invoices || []).map(function (invoice) {
                return {
                  id: invoice.id,
                  slug: invoice.slug,
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              if (!(_this7.form.supplier && _this7.form.supplier.slug)) {
                _context6.next = 12;
                break;
              }
              _context6.prev = 1;
              _context6.next = 4;
              return axios_default().get(window.location.origin + '/api/supplier/' + _this7.form.supplier.slug + '/purchases');
            case 4:
              _yield$axios$get3 = _context6.sent;
              data = _yield$axios$get3.data;
              _this7.purchases = (data.purchases || data || []).map(function (purchase) {
                return {
                  id: purchase.id,
                  slug: purchase.slug,
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              _this8.accounts = (data.data || data || []).map(function (account) {
                return {
                  id: account.id,
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _this9.loadingPaymentMethods = true;
              _context8.prev = 1;
              _context8.next = 4;
            ...
            case 4:
              ...
              if (response.data) {
                if (Array.isArray(response.data)) {
                  _this9.paymentMethods = response.data;
                } else if (response.data.data && Array.isArray(response.data.data)) {
                  _this9.paymentMethods = response.data.data;
                } else {
                  _this9.paymentMethods = [];
                }
              } else {
                _this9.paymentMethods = [];
              }
            ...
            case 8:
              ...
              console.error('Error loading payment methods:', _context8.t0);
              _this9.paymentMethods = [];
              toast.fire({
                type: 'error',
                title: _this9.$t('Error'),
                text: _this9.$t('Failed to load payment methods')
              });
            case 13:
              _context8.prev = 13;
              _this9.loadingPaymentMethods = false;
          ...
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 2:
              ...
              if (!account && newAccount) {
                ...
                _this0.accounts.push(account);
              }
              if (account) {
                // Use $nextTick to ensure Vue updates the form
                _this0.$nextTick(function () {
                  _this0.form.account = account;
                  _this0.updateBalance();
                });
              }
            case 6:
            case "end":
    ...
    onClientChange: function onClientChange() {
      // Show invoices when client is selected (for invoice payment type)
      if (this.form.entityType === 'client') {
        this.getInvoices();
      }
    },
    ...
    onPaymentMethodChange: function onPaymentMethodChange() {
      ...
      // If client is selected, show invoices (for invoice payment type)
      if (this.form.entityType === 'client' && this.form.client) {
        this.getInvoices();
      }
    }
  }, "getPaymentMethods", function getPaymentMethods() {
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0() {
      ...
      return _regeneratorRuntime().wrap(function _callee0$(_context0) {
        while (1) switch (_context0.prev = _context0.next) {
          case 0:
            _this1.loadingPaymentMethods = true;
            _context0.prev = 1;
            _context0.next = 4;
            return axios_default().get(window.location.origin + '/api/payment-methods', {
              params: {
          ...
          case 4:
            ...
            if (response.data) {
              if (Array.isArray(response.data)) {
                _this1.paymentMethods = response.data;
              } else if (response.data.data && Array.isArray(response.data.data)) {
                _this1.paymentMethods = response.data.data;
              } else {
                _this1.paymentMethods = [];
              }
            } else {
              _this1.paymentMethods = [];
            }
          ...
          case 8:
            ...
            console.error('Error loading payment methods:', _context0.t0);
            _this1.paymentMethods = [];
            toast.fire({
              type: 'error',
              title: _this1.$t('Error'),
              text: _this1.$t('Failed to load payment methods')
            });
          case 13:
            _context0.prev = 13;
            _this1.loadingPaymentMethods = false;
            return _context0.finish(13);
          case 16:
          case "end":
            return _context0.stop();
        }
      }, _callee0, null, [[1, 8, 13, 16]]);
    }))();
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee1() {
      ...
      return _regeneratorRuntime().wrap(function _callee1$(_context1) {
        while (1) switch (_context1.prev = _context1.next) {
          case 0:
            if (!(!_this10.form.client || !_this10.form.client.slug || _this10.isAutoAssigningClient)) {
              _context1.next = 2;
              break;
            }
          ...
          case 2:
            ...
            _context1.next = 7;
            return axios_default().post("/api/clients/".concat(_this10.form.client.slug, "/auto-assign-chart-of-account"));
          case 7:
            ...
            if (response.data.success) {
              ...
              if (newAccountId) {
                ...
                idx = (_this10.clients || []).findIndex(function (i) {
                  return i.slug === currentClientSlug;
                });
                if (idx !== -1) {
                  _this10.$set(_this10.clients[idx], 'chart_of_account_id', newAccountId);
                }
              }
          ...
          case 11:
            ...
            if (((_error$response = _context1.t0.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 400) {
              toast.fire({
                type: 'error',
                title: _this10.$t('Invalid Request'),
                text: ((_error$response2 = _context1.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this10.$t('Please check the client data and try again')
              });
            } else if (((_error$response3 = _context1.t0.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 403 || ((_error$response4 = _context1.t0.response) === null || _error$response4 === void 0 ? void 0 : _error$response4.status) === 401) {
              toast.fire({
                type: 'error',
              ...
              toast.fire({
                type: 'error',
                title: _this10.$t('Failed to assign Chart of Account'),
                text: ((_error$response5 = _context1.t0.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || _context1.t0.message || _this10.$t('An error occurred. Please try again.')
              });
            }
          case 15:
            _context1.prev = 15;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
      var currentSupplierSlug, response, newAccountId, idx, _error$response6, _error$response8, _error$response9, _error$response7, _error$response0;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            if (!(!_this11.form.supplier || !_this11.form.supplier.slug || _this11.isAutoAssigningSupplier)) {
              _context10.next = 2;
              break;
            }
          ...
          case 2:
            ...
            _context10.prev = 3;
            currentSupplierSlug = _this11.form.supplier.slug;
            _context10.next = 7;
          ...
          case 7:
            ...
            if (response.data.success) {
              newAccountId = response.data.chart_of_account_id || response.data.data && response.data.data.chart_of_account_id || null;
              if (newAccountId) {
                _this11.form.supplier.chart_of_account_id = newAccountId;
                idx = (_this11.suppliers || []).findIndex(function (i) {
                  return i.slug === currentSupplierSlug;
                });
                if (idx !== -1) {
                  _this11.$set(_this11.suppliers[idx], 'chart_of_account_id', newAccountId);
                }
              }
          ...
          case 11:
            ...
            if (((_error$response6 = _context10.t0.response) === null || _error$response6 === void 0 ? void 0 : _error$response6.status) === 400) {
              toast.fire({
                type: 'error',
                title: _this11.$t('Invalid Request'),
                text: ((_error$response7 = _context10.t0.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || _this11.$t('Please check the supplier data and try again')
              });
              ...
              toast.fire({
                type: 'error',
                title: _this11.$t('Failed to assign Chart of Account'),
                text: ((_error$response0 = _context10.t0.response) === null || _error$response0 === void 0 || (_error$response0 = _error$response0.data) === null || _error$response0 === void 0 ? void 0 : _error$response0.message) || _context10.t0.message || _this11.$t('An error occurred. Please try again.')
              });
            }
          case 15:
            _context10.prev = 15;
    ...
    if (message && message.includes('entity type') && message.includes('client') && message.includes('حقل العميل')) {
      ...
      var localized = this.$t('The client field is required when the entity type is client.');
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            _context11.next = 2;
            return _this12.form.post(window.location.origin + '/api/vouchers').then(function () {
              toast.fire({
                type: 'success',
                title: _this12.$t('Voucher created successfully')
              });
              _this12.$router.push({
                name: 'receiveVouchers.index'
              });
              ...
              if ((error === null || error === void 0 || (_error$response1 = error.response) === null || _error$response1 === void 0 ? void 0 : _error$response1.status) === 422 && error !== null && error !== void 0 && (_error$response10 = error.response) !== null && _error$response10 !== void 0 && (_error$response10 = _error$response10.data) !== null && _error$response10 !== void 0 && _error$response10.errors) {
                ...
                Object.keys(error.response.data.errors).forEach(function (field) {
                  translatedErrors[field] = error.response.data.errors[field].map(function (message) {
                    ...
                    return _this12.translateValidationMessage(message, field);
                  });
                });

                // Set the translated errors back to the form
                _this12.form.errors.set(translatedErrors);
                ...
                var translatedMessage = backendMessage ? _this12.translateValidationMessage(backendMessage, '') : null;
                toast.fire({
                  type: 'error',
                  title: translatedMessage || _this12.$t('Please check your input and try again.'),
...
;// ./resources/js/pages/vouchers/receive/create.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_648a1996_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const receive_createvue_type_style_index_0_id_648a1996_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_648a1996_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/vouchers/receive/create.vue?vue&type=style&index=0&id=648a1996&prod&scoped=true&lang=css
