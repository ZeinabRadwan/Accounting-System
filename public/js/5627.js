...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-d87facda]{margin-bottom:15px}.footer-buttons[data-v-d87facda]{display:flex;gap:10px}.footer-buttons .btn[data-v-d87facda]{margin-right:10px}.footer-buttons .btn[data-v-d87facda]:last-child{margin-right:0}.btn-group.c-w-100[data-v-d87facda]{gap:10px}.card[data-v-d87facda]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-d87facda]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-d87facda]{padding:1.25rem}.card-footer[data-v-d87facda]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-d87facda]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-d87facda]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-d87facda]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-d87facda]{color:#dc3545;font-weight:700}.btn-primary[data-v-d87facda]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-d87facda]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-d87facda]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-d87facda]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-d87facda]{border-color:#dc3545!important}textarea.form-control[data-v-d87facda]{min-height:100px;resize:vertical}.v-select[data-v-d87facda],.v-select .vs__dropdown-toggle[data-v-d87facda]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-d87facda]{padding:10px 16px}.v-select .vs__search[data-v-d87facda]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-d87facda]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-d87facda]{color:#374151}.v-select .vs__dropdown-menu[data-v-d87facda]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-d87facda]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-d87facda]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-d87facda]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-d87facda]:hover{background-color:#f8f9fa}.custom-qty-input[data-v-d87facda]{align-items:center;background:#fff;border:1px solid #e5e7eb;border-radius:10px;display:flex;overflow:hidden}.custom-qty-input .button-minus[data-v-d87facda],.custom-qty-input .button-plus[data-v-d87facda]{background:#6c757d;border:none;color:#fff;cursor:pointer;font-weight:700;padding:8px 12px;transition:background-color .3s}.custom-qty-input .button-minus[data-v-d87facda]:hover{background:#dc3545}.custom-qty-input .button-plus[data-v-d87facda]:hover{background:#2ab930}.custom-qty-input .quantity-field[data-v-d87facda]{background:transparent;border:none;font-weight:500;padding:8px 4px;text-align:center;width:60px}.custom-qty-input .quantity-field[data-v-d87facda]:focus{box-shadow:none;outline:none}.callout[data-v-d87facda]{border-left:4px solid;border-radius:8px;margin-bottom:16px;padding:12px 16px}.callout-danger[data-v-d87facda]{background-color:#f8d7da;border-left-color:#dc3545;color:#721c24}.callout i[data-v-d87facda]{margin-right:8px}.row[data-v-d87facda]{margin-bottom:1rem}.form-text[data-v-d87facda]{color:#6b7280;font-size:.875rem}.text-muted[data-v-d87facda]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-d87facda]{flex-direction:column;gap:10px}.card-footer .btn[data-v-d87facda]{margin-right:0!important;width:100%}.card-footer div[data-v-d87facda]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-d87facda]{font-size:12px}.table-custom tbody td[data-v-d87facda],.table-custom thead th[data-v-d87facda]{padding:8px 4px}}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/create.vue?vue&type=template&id=d87facda&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(item.purchaseQty) + " " + _vm._s(item.unit))]), _vm._v(" "), _c('td', {
      staticStyle: {
        "min-width": "120px"
      }
    ...
    }, [_vm._v(_vm._s(item.purchasePrice) + " "), _c('span', {
    ...
    }, [_vm._v(_vm._s(item.returnTotal) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])])]);
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t('Subtotal')) + ":")])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.form.purchase.subTotal)))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm.form.totalReturn) + " "), _c('span', {
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])])])]) : _vm._e()], 2)])])]) : _vm._e(), _vm._v(" "), _vm.form.purchase ? _c('div', {
    staticClass: "row"
  }, [_c('div', {
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return _this5.form.post(window.location.origin + '/api/purchase-returns').then(function (_ref) {
                ...
                toast.fire({
                  type: 'success',
                  title: _this5.isSaudiArabia ? _this5.$t('Debit note added successfully') : _this5.$t('Purchase return added successfully')
                });
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_d87facda_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_d87facda_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_d87facda_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/purchases/returns/create.vue?vue&type=style&index=0&id=d87facda&prod&scoped=true&lang=css
