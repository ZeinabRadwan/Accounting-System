"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5048],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-primary[data-v-6c3b9755]{background:#2ab930!important;color:#fff!important;padding:10px 20px!important}.btn-primary[data-v-6c3b9755],.table-custom[data-v-6c3b9755]{border:none!important}.vat-report-table[data-v-6c3b9755]{border-collapse:separate;border-spacing:0}.vat-report-table thead th[data-v-6c3b9755]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.vat-report-table thead tr[data-v-6c3b9755]{border:none!important}.vat-report-table thead th[data-v-6c3b9755]:first-child{border-top-left-radius:10px}.vat-report-table thead th[data-v-6c3b9755]:last-child{border-top-right-radius:10px}[dir=rtl] .vat-report-table thead th[data-v-6c3b9755]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .vat-report-table thead th[data-v-6c3b9755]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-6c3b9755]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-6c3b9755],.export-pdf-btn[data-v-6c3b9755],.preview-btn[data-v-6c3b9755]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-6c3b9755],.export-pdf-btn[data-v-6c3b9755],.preview-btn[data-v-6c3b9755],.print-btn[data-v-6c3b9755]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-6c3b9755]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-6c3b9755]{gap:10px}.card[data-v-6c3b9755]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-6c3b9755]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.vat-report-table .badge.bg-success[data-v-6c3b9755]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.vat-report-table .badge.bg-info[data-v-6c3b9755]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.vat-report-table .badge.bg-secondary[data-v-6c3b9755]{background:#f5f5f5!important;color:#616161!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-6c3b9755]{background:#fff!important}.text-success[data-v-6c3b9755]{color:#28a745!important}.text-danger[data-v-6c3b9755]{color:#dc3545!important}@media print{.btn[data-v-6c3b9755],.card-tools[data-v-6c3b9755]{display:none!important}}@media (max-width:1300px){.info-box[data-v-6c3b9755]{padding:0}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/vat-report.vue?vue&type=template&id=6c3b9755&scoped=true
...
var update = injectStylesIntoStyleTag_default()(vat_reportvue_type_style_index_0_id_6c3b9755_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_vat_reportvue_type_style_index_0_id_6c3b9755_prod_scoped_true_lang_css = (vat_reportvue_type_style_index_0_id_6c3b9755_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/vat-report.vue?vue&type=style&index=0&id=6c3b9755&prod&scoped=true&lang=css
