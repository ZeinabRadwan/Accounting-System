...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/general.vue?vue&type=template&id=761533ea&scoped=true
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t("System Type")) + "\n                                            "), _c('span', {
    staticClass: "required"
  }, [_vm._v("*")])]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
  ...
  }, [_vm._v(_vm._s(_vm.$t('Select a system type')))]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "accounting"
    }
...
var update = injectStylesIntoStyleTag_default()(generalvue_type_style_index_0_id_761533ea_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const setup_generalvue_type_style_index_0_id_761533ea_prod_lang_scss_scoped_true = (generalvue_type_style_index_0_id_761533ea_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/setup/general.vue?vue&type=style&index=0&id=761533ea&prod&lang=scss&scoped=true
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".inner-card[data-v-761533ea]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:20px}.inner-card .card-header[data-v-761533ea]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:22px 16px}.form-control[data-v-761533ea]{background:#fff!important}input[readonly][data-v-761533ea]{background-color:#f8f9fa!important;border-color:#ced4da;color:#6c757d;cursor:not-allowed}.form-control[data-v-761533ea]:focus,select.form-control[data-v-761533ea]:focus,textarea.form-control[data-v-761533ea]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-toggle[data-v-761533ea]{border-color:#ced4da}.v-select .vs__dropdown-toggle.vs__open[data-v-761533ea],.v-select .vs__dropdown-toggle[data-v-761533ea]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-menu[data-v-761533ea],.v-select .vs__search[data-v-761533ea],.v-select .vs__selected[data-v-761533ea]{font-size:.95rem}.custom-file-input:focus~.custom-file-label[data-v-761533ea]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.custom-file-label[data-v-761533ea]{border-radius:6px}.custom-file-label[data-v-761533ea],[dir=rtl] .custom-file-label[data-v-761533ea]{text-align:left!important}.btn-primary[data-v-761533ea]{background:#2ab930!important;border:none!important;color:#fff!important}.card[data-v-761533ea]{border-radius:20px;margin-top:30px;overflow:visible}.card[data-v-761533ea],.settings-sidebar-wrapper[data-v-761533ea]{border:1px solid #ced4da;box-shadow:0 8px 20px 0 #00000014}.settings-sidebar-wrapper[data-v-761533ea]{background:#fff;border-radius:20px;padding:10px}", ""]);
// Exports
