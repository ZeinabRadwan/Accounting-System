"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7099],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/journal-entries/create.vue?vue&type=template&id=016b674f&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_016b674f_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const journal_entries_createvue_type_style_index_0_id_016b674f_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_016b674f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/journal-entries/create.vue?vue&type=style&index=0&id=016b674f&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-016b674f]{gap:10px}.header-buttons[data-v-016b674f]{margin-bottom:15px}.footer-buttons[data-v-016b674f]{display:flex;gap:10px}.footer-buttons .btn[data-v-016b674f]{margin-right:10px}.footer-buttons .btn[data-v-016b674f]:last-child{margin-right:0}.card[data-v-016b674f]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-016b674f]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-016b674f]{padding:1.25rem}.card-footer[data-v-016b674f]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-016b674f]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-016b674f]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-016b674f]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.text-danger[data-v-016b674f]{color:#dc3545!important;font-weight:700}.btn-primary[data-v-016b674f]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-016b674f]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-016b674f]:disabled{background:#6c757d!important;box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}.btn-secondary[data-v-016b674f]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-016b674f]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.btn-danger[data-v-016b674f]{background:#dc3545!important;border:none!important;border-radius:8px!important;color:#fff!important;font-weight:500;padding:8px 12px!important}.btn-danger[data-v-016b674f]:hover{background:#c82333!important;box-shadow:0 4px 8px rgba(220,53,69,.3);transform:translateY(-1px)}.is-invalid[data-v-016b674f]{border-color:#dc3545!important}textarea.form-control[data-v-016b674f]{min-height:100px;resize:vertical}.v-select[data-v-016b674f]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-016b674f]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-016b674f]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-016b674f]{border-color:#dc3545!important}.alert[data-v-016b674f]{border:1px solid transparent;border-radius:10px;margin-bottom:16px;padding:12px 16px}.alert-success[data-v-016b674f]{background-color:#d4edda;border-color:#c3e6cb;color:#155724}.alert-warning[data-v-016b674f]{background-color:#fff3cd;border-color:#ffeaa7;color:#856404}.table th[data-v-016b674f]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 16px}.table td[data-v-016b674f]{border-bottom:1px solid #e5e7eb;padding:12px 16px;vertical-align:middle}.table tbody tr[data-v-016b674f]:hover{background-color:#f8f9fa}.invalid-feedback[data-v-016b674f]{color:#dc3545;display:block}.form-text[data-v-016b674f],.invalid-feedback[data-v-016b674f]{font-size:12px;margin-top:5px}.form-text[data-v-016b674f]{color:#6c757d}.row[data-v-016b674f]{margin-bottom:1rem}.je-lines-table thead th[data-v-016b674f]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;font-weight:600}.je-lines-table td[data-v-016b674f]{vertical-align:middle}.je-summary-row td[data-v-016b674f]{background:#fafbfc;border-top:2px solid #e5e7eb}.add-line-btn[data-v-016b674f]{border-radius:8px!important;padding:8px 14px!important}.je-lines-actions[data-v-016b674f]{padding:12px 16px}.table-responsive[data-v-016b674f]{overflow:visible}.v-select .vs__dropdown-menu[data-v-016b674f]{z-index:1050!important}@media (max-width:768px){.card-footer[data-v-016b674f]{flex-direction:column;gap:10px}.card-footer .btn[data-v-016b674f]{margin-right:0!important;width:100%}.card-footer div[data-v-016b674f]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
