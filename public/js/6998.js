...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/index.vue?vue&type=template&id=f1d3ae00
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm.$can('quotation-to-invoice') ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Create Invoice'),
        expression: "$t('Create Invoice')\n                        "
      }],
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('quotation-view') ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('View'),
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('quotation-delete') ? _c('a', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Delete'),
                ...
                if (result.value) {
                  _this8.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      Swal.fire(_this8.$t("Failed!"), _this8.$t("Sorry you can't delete this quotation!"), "warning");
                    }
                  });
                }
              });
