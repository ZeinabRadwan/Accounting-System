  ...
  methods: {
    handleCrossDomainLogin: function handleCrossDomainLogin() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var urlParams, encryptedEmail, encryptedPassword, response, user;
        ...
        }, _callee2, null, [[0, 36, 41, 44]]);
      }))();
    },
    applyLocale: function applyLocale(locale) {
      var _this3 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var rtlLanguages, isRTL, _yield$import, loadMessages;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 19:
              ...
              console.error('Error applying locale:', _context3.t0);
            case 22:
            case "end":
    ...
    redirectAfterAuth: function redirectAfterAuth() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var initResponse, isInitialized;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 8:
              ...
              console.error('Error checking tenant initialization:', _context4.t0);
              window.location.href = '/tenant-initialization';
            case 12:
            case "end":
