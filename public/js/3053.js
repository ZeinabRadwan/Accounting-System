"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3053],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=6d66df98&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    return _c('tr', {
      ...
      staticClass: "invalid-feedback d-block"
    }, [_vm._v("\n                          " + _vm._s(_vm.form.errors.get("selectedProducts.".concat(i - 1, ".unitPrice"))) + "\n                        ")]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.unitPrice * item.qty) + " "), _c('span', {
      ...
      staticClass: "d-block"
    }, [_vm._v(_vm._s(_vm.form.errors.get("selectedProducts.".concat(i - 1, ".discountType"))))]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.unitPrice * item.qty - (item.discountAmount || 0)) + " "), _c('span', {
      staticClass: "saudi-riyal"
...
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=6d66df98&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_6d66df98_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const invoices_editvue_type_style_index_0_id_6d66df98_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_6d66df98_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=6d66df98&prod&lang=scss&scoped=true
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-6d66df98]{margin-bottom:15px}.footer-buttons[data-v-6d66df98]{display:flex;gap:10px}.footer-buttons .btn[data-v-6d66df98]{margin-right:10px}.footer-buttons .btn[data-v-6d66df98]:last-child{margin-right:0}.account-status .account-warning[data-v-6d66df98],.account-status .client-warning[data-v-6d66df98],.account-status .product-warning[data-v-6d66df98],.client-status .account-warning[data-v-6d66df98],.client-status .client-warning[data-v-6d66df98],.client-status .product-warning[data-v-6d66df98],.product-status .account-warning[data-v-6d66df98],.product-status .client-warning[data-v-6d66df98],.product-status .product-warning[data-v-6d66df98]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;color:#856404;font-size:.875rem;padding:8px 12px}.account-status .account-success[data-v-6d66df98],.account-status .client-success[data-v-6d66df98],.account-status .product-success[data-v-6d66df98],.client-status .account-success[data-v-6d66df98],.client-status .client-success[data-v-6d66df98],.client-status .product-success[data-v-6d66df98],.product-status .account-success[data-v-6d66df98],.product-status .client-success[data-v-6d66df98],.product-status .product-success[data-v-6d66df98]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:4px;color:#155724;font-size:.875rem;padding:8px 12px}.create-btn[data-v-6d66df98]{background-color:#007bff;border-left:none;border-color:#007bff;color:#fff;cursor:pointer}.create-btn[data-v-6d66df98]:hover{background-color:#0056b3;border-color:#0056b3}.radio-group-horizontal[data-v-6d66df98]{display:flex;gap:20px}.radio-group-horizontal .form-check[data-v-6d66df98]{align-items:center;display:flex;gap:8px}.custom-qty-input .button-minus[data-v-6d66df98],.custom-qty-input .button-plus[data-v-6d66df98]{border:none;border-radius:0;height:30px;width:30px}.custom-qty-input .quantity-field[data-v-6d66df98]{border-left:none;border-right:none;text-align:center;width:60px}.table-custom td[data-v-6d66df98],.table-custom th[data-v-6d66df98]{vertical-align:middle}.invalid-feedback[data-v-6d66df98]{display:block;margin-top:5px}.btn-primary[data-v-6d66df98]{background:#2ab930!important}.btn-primary[data-v-6d66df98]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
