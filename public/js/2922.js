"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2922],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-10a1ca3c]{border:none!important}.loan-authorities-table[data-v-10a1ca3c]{border-collapse:separate;border-spacing:0}.loan-authorities-table thead th[data-v-10a1ca3c]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.loan-authorities-table thead tr[data-v-10a1ca3c]{border:none!important}.loan-authorities-table thead th[data-v-10a1ca3c]:first-child{border-top-left-radius:10px}.loan-authorities-table thead th[data-v-10a1ca3c]:last-child{border-top-right-radius:10px}[dir=rtl] .loan-authorities-table thead th[data-v-10a1ca3c]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .loan-authorities-table thead th[data-v-10a1ca3c]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-10a1ca3c]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-10a1ca3c],.export-pdf-btn[data-v-10a1ca3c]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-10a1ca3c],.export-pdf-btn[data-v-10a1ca3c],.print-btn[data-v-10a1ca3c]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-10a1ca3c]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-10a1ca3c]{display:inline-block;position:relative}.action-icon-btn[data-v-10a1ca3c]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-10a1ca3c]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-10a1ca3c]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-10a1ca3c]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-10a1ca3c]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-10a1ca3c]{gap:10px}.btn-group.c-w-100>.btn[data-v-10a1ca3c]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-10a1ca3c]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-10a1ca3c]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-10a1ca3c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-10a1ca3c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.loan-authorities-table .badge.bg-success[data-v-10a1ca3c]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.loan-authorities-table .badge.bg-danger[data-v-10a1ca3c]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-10a1ca3c]{background:#f1f5fb!important}.btn-primary[data-v-10a1ca3c]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/loans/authorities/index.vue?vue&type=template&id=10a1ca3c&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_c('ul', [_vm.$can('loan-authority-view') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'authorities.show',
          params: {
    ...
    }, [_vm._v(_vm._s(_vm.$t('View')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('loan-authority-edit') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Edit')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('loan-authority-delete') ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
...
var update = injectStylesIntoStyleTag_default()(authoritiesvue_type_style_index_0_id_10a1ca3c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const loans_authoritiesvue_type_style_index_0_id_10a1ca3c_prod_scoped_true_lang_css = (authoritiesvue_type_style_index_0_id_10a1ca3c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/loans/authorities/index.vue?vue&type=style&index=0&id=10a1ca3c&prod&scoped=true&lang=css
