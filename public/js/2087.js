"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2087],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/edit.vue?vue&type=template&id=fb38e6e8&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_fb38e6e8_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const quotations_editvue_type_style_index_0_id_fb38e6e8_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_fb38e6e8_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/edit.vue?vue&type=style&index=0&id=fb38e6e8&prod&lang=scss&scoped=true
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-fb38e6e8]{margin-bottom:15px}.footer-buttons[data-v-fb38e6e8]{display:flex;gap:10px}.footer-buttons .btn[data-v-fb38e6e8]{margin-right:10px}.footer-buttons .btn[data-v-fb38e6e8]:last-child{margin-right:0}.custom-qty-input[data-v-fb38e6e8]{display:flex;flex-wrap:nowrap}.btn-primary[data-v-fb38e6e8]{background:#2ab930!important}.btn-primary[data-v-fb38e6e8]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
