...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/brands/edit.vue?vue&type=template&id=38b6475b
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Brand Name")) + "\n                "), _c('span', {
    ...
    attrs: {
      ...
      "type": "text",
      "name": "name",
      "placeholder": _vm.$t('Enter brand name')
    },
    domProps: {
      "value": _vm.form.name
    },
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/brands/edit.vue?vue&type=script&lang=js
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this3.form.patch(window.location.origin + "/api/brands/" + _this3.$route.params.slug).then(function () {
                toast.fire({
                  type: "success",
                  title: _this3.$t("Brand updated successfully")
                });
                _this3.$router.push({
                  name: "brands.index"
                });
...
;// ./resources/js/pages/setup/brands/edit.vue?vue&type=script&lang=js
 /* harmony default export */ const brands_editvue_type_script_lang_js = (editvue_type_script_lang_js); 
...
var component = (0,componentNormalizer/* default */.A)(
  brands_editvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
