"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5581],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchase-order/edit.vue?vue&type=template&id=138cabc2&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_138cabc2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchase_order_editvue_type_style_index_0_id_138cabc2_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_138cabc2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchase-order/edit.vue?vue&type=style&index=0&id=138cabc2&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-138cabc2]{margin-bottom:15px}.footer-buttons[data-v-138cabc2]{display:flex;gap:10px}.footer-buttons .btn[data-v-138cabc2]{margin-right:10px}.footer-buttons .btn[data-v-138cabc2]:last-child{margin-right:0}.create-btn[data-v-138cabc2]{padding:11px}.button-plus.icon-shape.icon-sm.btn-primary[data-v-138cabc2]{padding:0}.btn-primary[data-v-138cabc2]{background:#2ab930!important}.btn-primary[data-v-138cabc2]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-138cabc2]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}.table-custom[data-v-138cabc2]{border:none!important}.invoices-create-table[data-v-138cabc2]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-138cabc2]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.btn-group.c-w-100[data-v-138cabc2]{gap:10px}.card[data-v-138cabc2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-138cabc2]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-138cabc2]{background:#fff!important}", ""]);
// Exports
