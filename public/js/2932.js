"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2932],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-0225fb1a]{border:none!important;overflow:visible!important}.balances-table[data-v-0225fb1a]{border-collapse:separate;border-spacing:0}.balances-table thead th[data-v-0225fb1a]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.balances-table thead tr[data-v-0225fb1a]{border:none!important}.balances-table thead th[data-v-0225fb1a]:first-child{border-top-left-radius:10px}.balances-table thead th[data-v-0225fb1a]:last-child{border-top-right-radius:10px}[dir=rtl] .balances-table thead th[data-v-0225fb1a]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .balances-table thead th[data-v-0225fb1a]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-0225fb1a]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-0225fb1a],.export-pdf-btn[data-v-0225fb1a]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-0225fb1a],.export-pdf-btn[data-v-0225fb1a],.print-btn[data-v-0225fb1a]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-0225fb1a]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-0225fb1a]{display:inline-block;position:relative}.action-icon-btn[data-v-0225fb1a]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-0225fb1a]{animation:slideInDown-0225fb1a .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-0225fb1a]{left:45px!important;right:auto!important}@keyframes slideInDown-0225fb1a{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-0225fb1a]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-0225fb1a]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-0225fb1a]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-0225fb1a]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-0225fb1a]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-0225fb1a]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-0225fb1a]:last-child{border-bottom:none}.action-menu li a[data-v-0225fb1a]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-0225fb1a]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-0225fb1a]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-0225fb1a]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-0225fb1a]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-0225fb1a]{gap:10px}.card[data-v-0225fb1a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-0225fb1a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.balances-table .badge.bg-success[data-v-0225fb1a]{background:#f6fef4!important;color:#2ab930!important}.balances-table .badge.bg-danger[data-v-0225fb1a],.balances-table .badge.bg-success[data-v-0225fb1a]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.balances-table .badge.bg-danger[data-v-0225fb1a]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-0225fb1a]{background:#fff!important}.btn-primary[data-v-0225fb1a]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/balances/index.vue?vue&type=template&id=0225fb1a&scoped=true
...
var update = injectStylesIntoStyleTag_default()(balancesvue_type_style_index_0_id_0225fb1a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const cashbook_balancesvue_type_style_index_0_id_0225fb1a_prod_scoped_true_lang_css = (balancesvue_type_style_index_0_id_0225fb1a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/balances/index.vue?vue&type=style&index=0&id=0225fb1a&prod&scoped=true&lang=css
