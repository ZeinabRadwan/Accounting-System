"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6210],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-59adf55a]{margin-bottom:15px}.footer-buttons[data-v-59adf55a]{display:flex;gap:10px}.footer-buttons .btn[data-v-59adf55a]{margin-right:10px}.footer-buttons .btn[data-v-59adf55a]:last-child{margin-right:0}.create-btn[data-v-59adf55a]{padding:11px}.button-plus.icon-shape.icon-sm.btn-primary[data-v-59adf55a]{padding:0}.btn-primary[data-v-59adf55a]{background:#2ab930!important}.btn-primary[data-v-59adf55a]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-59adf55a]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}.table-custom[data-v-59adf55a]{border:none!important}.invoices-create-table[data-v-59adf55a]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-59adf55a]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.btn-group.c-w-100[data-v-59adf55a]{gap:10px}.card[data-v-59adf55a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-59adf55a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-59adf55a]{background:#fff!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchase-order/edit.vue?vue&type=template&id=59adf55a&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_59adf55a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchase_order_editvue_type_style_index_0_id_59adf55a_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_59adf55a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/purchase-order/edit.vue?vue&type=style&index=0&id=59adf55a&prod&scoped=true&lang=css
