(self["webpackChunk"] = self["webpackChunk"] || []).push([[9586],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-91e374ac]{border:none!important}.expenses-table[data-v-91e374ac]{border-collapse:separate;border-spacing:0}.expenses-table thead th[data-v-91e374ac]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.expenses-table thead tr[data-v-91e374ac]{border:none!important}.expenses-table thead th[data-v-91e374ac]:first-child{border-top-left-radius:10px}.expenses-table thead th[data-v-91e374ac]:last-child{border-top-right-radius:10px}[dir=rtl] .expenses-table thead th[data-v-91e374ac]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .expenses-table thead th[data-v-91e374ac]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-91e374ac]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-91e374ac],.export-pdf-btn[data-v-91e374ac]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-91e374ac],.export-pdf-btn[data-v-91e374ac],.print-btn[data-v-91e374ac]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-91e374ac]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-91e374ac]{gap:10px}.btn-group.c-w-100>.btn[data-v-91e374ac]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-91e374ac]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-91e374ac]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-91e374ac]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-91e374ac]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.action-dropdown[data-v-91e374ac]{display:inline-block;position:relative}.action-menu[data-v-91e374ac]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-icon-btn[data-v-91e374ac]{align-items:center;background:#f8f9fa;border:1px solid #e5e7eb;border-radius:8px;cursor:pointer;display:flex;height:32px;justify-content:center;padding:8px;width:32px}.action-icon-btn[data-v-91e374ac]:hover{background:#e9ecef}.action-menu-item[data-v-91e374ac]{align-items:center;border-bottom:1px solid #f3f4f6;color:#374151;display:flex;font-size:14px;padding:10px 16px;text-decoration:none}.action-menu-item[data-v-91e374ac]:last-child{border-bottom:none}.action-menu-item[data-v-91e374ac]:hover{background:#f9fafb;color:#111827}.action-menu-item i[data-v-91e374ac]{margin-right:8px;text-align:center;width:16px}.expenses-table .badge.bg-success[data-v-91e374ac]{background:#f6fef4!important;color:#2ab930!important}.expenses-table .badge.bg-danger[data-v-91e374ac],.expenses-table .badge.bg-success[data-v-91e374ac]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.expenses-table .badge.bg-danger[data-v-91e374ac]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-91e374ac]{background:#f1f5fb!important}.btn-primary[data-v-91e374ac]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-91e374ac]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-91e374ac]{align-items:center;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/index.vue?vue&type=template&id=91e374ac&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_vm.$can('expense-view') ? _c('router-link', {
    ...
    }), _vm._v(" " + _vm._s(_vm.$t('View')) + "\n                        ")]) : _vm._e(), _vm._v(" "), _vm.$can('expense-edit') ? _c('router-link', {
      staticClass: "action-menu-item",
      attrs: {
        "to": {
          name: 'expenses.edit',
    ...
    }), _vm._v(" " + _vm._s(_vm.$t('Edit')) + "\n                        ")]) : _vm._e(), _vm._v(" "), _vm.$can('expense-delete') ? _c('a', {
...
var update = injectStylesIntoStyleTag_default()(expensesvue_type_style_index_0_id_91e374ac_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_expensesvue_type_style_index_0_id_91e374ac_prod_scoped_true_lang_css = (expensesvue_type_style_index_0_id_91e374ac_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/index.vue?vue&type=style&index=0&id=91e374ac&prod&scoped=true&lang=css
