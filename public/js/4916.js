(self["webpackChunk"] = self["webpackChunk"] || []).push([[4916],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/show.vue?vue&type=template&id=0a1f2833&scoped=true
    ...
    return _c('div', {
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(_ref1) {
          var _row$chart_of_account, _row$chart_of_account2;
          var row = _ref1.row;
          return [_c('strong', [_vm._v(_vm._s((_row$chart_of_account = row.chart_of_account) === null || _row$chart_of_account === void 0 ? void 0 : _row$chart_of_account.name))]), _vm._v(" "), _c('br'), _vm._v(" "), _c('small', {
            staticClass: "text-muted"
          }, [_vm._v(_vm._s((_row$chart_of_account2 = row.chart_of_account) === null || _row$chart_of_account2 === void 0 || (_row$chart_of_account2 = _row$chart_of_account2.type) === null || _row$chart_of_account2 === void 0 ? void 0 : _row$chart_of_account2.name))])];
        }
      }, {
        key: "debit_amount",
        fn: function fn(_ref10) {
          var row = _ref10.row;
          return [row.debit_amount > 0 ? _c('span', [_vm._v("\n                      " + _vm._s(row.debit_amount)), _c('span', {
            staticClass: "saudi-riyal"
          }, [_vm._v("ê")])]) : _c('span', {
            staticClass: "text-muted"
          }, [_vm._v("-")])];
        ...
        fn: function fn(_ref11) {
          var row = _ref11.row;
          return [row.credit_amount > 0 ? _c('span', [_vm._v("\n                      " + _vm._s(row.credit_amount) + " "), _c('span', {
            staticClass: "saudi-riyal"
          }, [_vm._v("ê")])]) : _c('span', {
            staticClass: "text-muted"
          }, [_vm._v("-")])];
...
/* harmony default export */ const showvue_type_script_lang_js = ({
    ...
    returnProductsRows: function returnProductsRows() {
      ...
      return this.returnProducts.map(function (product, index) {
        ...
        return {
          ...
          vatType: _this2.getVatRate(product),
          vat: product,
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _this3.returnProducts = _this3.allData.returnProducts;
              _this3.returnProducts.sort(_this3.sortProducts);
    ...
    calculateTotalReturnDiscount: function calculateTotalReturnDiscount() {
      ...
      return this.productsWithReturns.reduce(function (total, product) {
        return total + _this4.calculateUnitDiscount(product);
      }, 0);
    },
    ...
    calculateTotalReturnTax: function calculateTotalReturnTax() {
      ...
      return this.productsWithReturns.reduce(function (total, product) {
        return total + _this5.calculateUnitVat(product);
      }, 0);
    },
          ...
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              sweetalert2_default().fire({
                title: _this11.$t("Send Purchase Return to ZATCA"),
                text: _this11.$t("Do you want to send this purchase return to ZATCA?"),
                type: "question",
                    ...
                    while (1) switch (_context9.prev = _context9.next) {
                      case 0:
                        ...
                        sweetalert2_default().fire({
                          ...
                          text: _this11.$t("Please wait while we send the purchase return to ZATCA"),
                      ...
                      case 5:
                        ...
                        if (response.data.success) {
                          _this11.$toast.success(_this11.$t("Sent Successfully!"), _this11.$t("Purchase return has been sent to ZATCA and journal entries have been created."));
                          // Refresh the purchase return data to update the status
                          _this11.getInvoiceReturn();
                        } else {
                          _this11.$toast.error(_this11.$t("Failed!"), response.data.message || _this11.$t("Failed to send purchase return to ZATCA"));
                        }
                        _context9.next = 15;
                        break;
                      case 10:
                        ...
                        // Close the loading dialog
                        sweetalert2_default().close();
                        _this11.$toast.error(_this11.$t("Error!"), _this11.$t("An error occurred while sending the purchase return to ZATCA"));
                      case 15:
                      case "end":
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_0a1f2833_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_showvue_type_style_index_0_id_0a1f2833_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_0a1f2833_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/show.vue?vue&type=style&index=0&id=0a1f2833&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-pills .nav-item[data-v-0a1f2833]{background:#ddd;border-radius:.25rem;margin:2px}.equal-sign[data-v-0a1f2833]{color:#007bff;font-weight:700;margin-right:5px}.bg-indigo-light[data-v-0a1f2833]{background-color:#e3f2fd!important}.bg-red-light[data-v-0a1f2833]{background-color:#ffebee!important}.bg-green-light[data-v-0a1f2833]{background-color:#e8f5e8!important}.bg-sub-light[data-v-0a1f2833]{background-color:#f8f9fa!important}.purchases-create-table[data-v-0a1f2833]{border-collapse:collapse;width:100%}.purchases-create-table td[data-v-0a1f2833],.purchases-create-table th[data-v-0a1f2833]{border:1px solid #dee2e6;padding:8px;text-align:center;vertical-align:middle}.purchases-create-table th[data-v-0a1f2833]{background-color:#f8f9fa;font-size:.875rem;font-weight:700}.purchases-create-table tbody tr[data-v-0a1f2833]:hover{background-color:#f8f9fa}.purchases-create-table .quantity-field[data-v-0a1f2833]{text-align:center;width:80px}.purchases-create-table .btn[data-v-0a1f2833]{font-size:.75rem;padding:.25rem .5rem}", ""]);
// Exports
