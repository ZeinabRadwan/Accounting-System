"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7580],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".inner-card[data-v-56eee82b]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:20px}.inner-card .card-header[data-v-56eee82b]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:22px 16px}.form-control[data-v-56eee82b]{background:#fff!important}input[readonly][data-v-56eee82b]{background-color:#f8f9fa!important;border-color:#ced4da;color:#6c757d;cursor:not-allowed}.form-control[data-v-56eee82b]:focus,select.form-control[data-v-56eee82b]:focus,textarea.form-control[data-v-56eee82b]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-toggle[data-v-56eee82b]{border-color:#ced4da}.v-select .vs__dropdown-toggle.vs__open[data-v-56eee82b],.v-select .vs__dropdown-toggle[data-v-56eee82b]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-menu[data-v-56eee82b],.v-select .vs__search[data-v-56eee82b],.v-select .vs__selected[data-v-56eee82b]{font-size:.95rem}.custom-file-input:focus~.custom-file-label[data-v-56eee82b]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.custom-file-label[data-v-56eee82b]{border-radius:6px}.custom-file-label[data-v-56eee82b],[dir=rtl] .custom-file-label[data-v-56eee82b]{text-align:left!important}.btn-primary[data-v-56eee82b]{background:#2ab930!important;border:none!important;color:#fff!important}.card[data-v-56eee82b]{border-radius:20px;margin-top:30px;overflow:visible}.card[data-v-56eee82b],.settings-sidebar-wrapper[data-v-56eee82b]{border:1px solid #ced4da;box-shadow:0 8px 20px 0 #00000014}.settings-sidebar-wrapper[data-v-56eee82b]{background:#fff;border-radius:20px;padding:10px}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/general.vue?vue&type=template&id=56eee82b&scoped=true
...
var update = injectStylesIntoStyleTag_default()(generalvue_type_style_index_0_id_56eee82b_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const setup_generalvue_type_style_index_0_id_56eee82b_prod_lang_scss_scoped_true = (generalvue_type_style_index_0_id_56eee82b_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/setup/general.vue?vue&type=style&index=0&id=56eee82b&prod&lang=scss&scoped=true
