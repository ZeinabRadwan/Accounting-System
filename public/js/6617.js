...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-75c09d3c]{border:none!important}.inventory-history-table[data-v-75c09d3c]{border-collapse:separate;border-spacing:0}.inventory-history-table thead th[data-v-75c09d3c]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.inventory-history-table thead tr[data-v-75c09d3c]{border:none!important}.inventory-history-table thead th[data-v-75c09d3c]:first-child{border-top-left-radius:10px}.inventory-history-table thead th[data-v-75c09d3c]:last-child{border-top-right-radius:10px}[dir=rtl] .inventory-history-table thead th[data-v-75c09d3c]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .inventory-history-table thead th[data-v-75c09d3c]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-75c09d3c]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-75c09d3c],.export-pdf-btn[data-v-75c09d3c]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-75c09d3c],.export-pdf-btn[data-v-75c09d3c],.print-btn[data-v-75c09d3c]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-75c09d3c]{background:#33a0d91a!important;color:#33a0d9!important}.card[data-v-75c09d3c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-75c09d3c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.inventory-history-table .badge[data-v-75c09d3c]{font-size:12px!important;font-weight:500!important;padding:8px 12px}.inventory-history-table .badge.bg-success[data-v-75c09d3c]{background:#f6fef4!important;color:#2ab930!important}.inventory-history-table .badge.bg-primary[data-v-75c09d3c]{background:#e3f2fd!important;color:#1976d2!important}.inventory-history-table .badge.bg-warning[data-v-75c09d3c]{background:#fff8e1!important;color:#f57c00!important}.inventory-history-table .badge.bg-danger[data-v-75c09d3c]{background:#fef4f4!important;color:#dc3545!important}.inventory-history-table .badge.bg-info[data-v-75c09d3c]{background:#e0f2f1!important;color:#00695c!important}.inventory-history-table .badge.bg-secondary[data-v-75c09d3c]{background:#f5f5f5!important;color:#6c757d!important}.form-control[data-v-75c09d3c]{background:#fff!important}.btn-group.c-w-100[data-v-75c09d3c]{gap:10px}.text-success[data-v-75c09d3c]{color:#2ab930!important;font-weight:600}.text-danger[data-v-75c09d3c]{color:#dc3545!important;font-weight:600}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history-general.vue?vue&type=template&id=75c09d3c&scoped=true
...
/* harmony default export */ const history_generalvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["appInfo"])), {}, {
    ...
    filteredItems: function filteredItems() {
      var _this = this;
      var filtered = _toConsumableArray(this.allData);

      // Apply search term filter
      if (this.query && this.query.trim() !== "") {
        var term = this.query.toLowerCase().trim();
        filtered = filtered.filter(function (item) {
          var productName = (item.product_name || '').toLowerCase();
          var productCode = (item.product_code || '').toLowerCase();
          var referenceCode = (item.reference_code || '').toLowerCase();
          var notes = (item.notes || '').toLowerCase();
          return productName.includes(term) || productCode.includes(term) || referenceCode.includes(term) || notes.includes(term);
        });
      }
      ...
      if (this.filterType !== 'default') {
        filtered = filtered.filter(function (item) {
          var operationType = item.operation_type || '';
          switch (_this.filterType) {
            ...
            case 'stock_in':
              return operationType === 'Purchase' || operationType === 'Invoice Return' || operationType === 'Stock In';
            case 'stock_out':
              return operationType === 'Invoice' || operationType === 'Purchase Return' || operationType === 'Stock Out';
            default:
              return true;
          }
        });
      ...
      if (this.startDate) {
        filtered = filtered.filter(function (item) {
          ...
          return item.operation_date >= _this.startDate;
        });
      }
      if (this.endDate) {
        filtered = filtered.filter(function (item) {
          if (!item.operation_date) return false;
          return item.operation_date <= _this.endDate;
        });
      }

      // Sort by operation date descending
      filtered.sort(function (a, b) {
        var dateA = new Date(a.operation_date || 0);
        var dateB = new Date(b.operation_date || 0);
        return dateB - dateA;
      });
      return filtered;
    },
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            _this2.prefix = _this2.appInfo.productPrefix;
            _this2.currency = _this2.appInfo.currency;
          case 4:
          case "end":
  ...
  methods: {
    ...
    loadAllData: function loadAllData() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var allItems, currentPage, hasMore, response, data, totalPages;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              _context2.next = 8;
              return axios_default().get("".concat(window.location.origin, "/api/inventory-history?page=").concat(currentPage, "&perPage=100"));
            case 8:
              ...
              break;
            case 13:
              _this3.allData = allItems;
              _context2.next = 21;
              break;
            case 16:
              _context2.prev = 16;
              _context2.t0 = _context2["catch"](1);
              console.error('Error loading inventory history:', _context2.t0);
              _this3.allData = [];
              // Show error message
              _this3.$toastr.e(_this3.$t('Failed to load inventory history data'));
            case 21:
              _context2.prev = 21;
...
var update = injectStylesIntoStyleTag_default()(history_generalvue_type_style_index_0_id_75c09d3c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const inventory_history_generalvue_type_style_index_0_id_75c09d3c_prod_scoped_true_lang_css = (history_generalvue_type_style_index_0_id_75c09d3c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/inventory/history-general.vue?vue&type=style&index=0&id=75c09d3c&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history-general.vue?vue&type=style&index=1&id=75c09d3c&prod&lang=css
var history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css = __webpack_require__(72770);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history-general.vue?vue&type=style&index=1&id=75c09d3c&prod&lang=css

            

var history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css_options = {};

history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css_options.insert = "head";
history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css_options.singleton = false;

var history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css_update = injectStylesIntoStyleTag_default()(history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css/* default */.A, history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css_options);



/* harmony default export */ const inventory_history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css = (history_generalvue_type_style_index_1_id_75c09d3c_prod_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/inventory/history-general.vue?vue&type=style&index=1&id=75c09d3c&prod&lang=css
