"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9491],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/supplier-payable-report.vue?vue&type=template&id=2221be9d
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._v("\n                            " + _vm._s(_vm.$t("Supplier Payable Report")) + "\n                        ")])]), _vm._v(" "), _c('div', {
    ...
    }, [_vm._v("\n                                            " + _vm._s(data.name) + "\n                                        ")]) : _c('span', [_vm._v(_vm._s(data.name))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.phoneNumber))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.email))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.companyName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.purchaseTotalDue)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.nonPurchaseCurrentDue)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.purchaseTotalDue + data.nonPurchaseCurrentDue)))]), _vm._v(" "), _c('td', [data.status === 1 ? _c('span', {
