"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1184],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/edit.vue?vue&type=template&id=2e55cebe&scoped=true
...
;// ./resources/js/pages/products/edit.vue?vue&type=template&id=2e55cebe&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_2e55cebe_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const products_editvue_type_style_index_0_id_2e55cebe_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_2e55cebe_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/products/edit.vue?vue&type=style&index=0&id=2e55cebe&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-2e55cebe]{gap:10px}.header-buttons[data-v-2e55cebe]{margin-bottom:15px}.footer-buttons[data-v-2e55cebe]{display:flex;gap:10px}.footer-buttons .btn[data-v-2e55cebe]{margin-right:10px}.footer-buttons .btn[data-v-2e55cebe]:last-child{margin-right:0}.btn-group.c-w-100>.btn[data-v-2e55cebe]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-2e55cebe]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-2e55cebe]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-2e55cebe]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-2e55cebe]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-2e55cebe]{background:#f1f5fb!important}.btn-primary[data-v-2e55cebe]{background:#2ab930!important}.btn-primary[data-v-2e55cebe],.btn-secondary[data-v-2e55cebe]{border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-2e55cebe]{background:#33a0d9!important}.btn-secondary[data-v-2e55cebe]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.btn-outline-custom[data-v-2e55cebe]{border-color:#1b3c71;border-radius:10px;color:#1b3c71;font-weight:500;padding:8px 16px;transition:background-color .3s,color .3s,border-color .3s}.btn-custom-active[data-v-2e55cebe],.btn-outline-custom[data-v-2e55cebe]:hover{background-color:#1b3c71;border-color:#1b3c71;color:#fff}h1[data-v-2e55cebe],h2[data-v-2e55cebe]{font-weight:400}ul[data-v-2e55cebe]{list-style-type:none;padding:0}li[data-v-2e55cebe]{display:inline-block;margin:0 10px}a[data-v-2e55cebe]{color:#42b983}", ""]);
// Exports
