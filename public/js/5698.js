...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=template&id=66e2d5b4&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    ...
    staticClass: "form-label"
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Tax Status")) + "\n                "), _vm.form.type === 'Company' ? _c('span', {
    staticClass: "required"
  }, [_vm._v("*")]) : _vm._e()]), _vm._v(" "), _vm.form.type === 'Individual' ? _c('div', {
    staticClass: "tax-status-individual-locked"
  }, [_c('div', {
    staticClass: "tax-status-card-compact border-success active locked"
  }, [_c('div', {
    staticClass: "tax-status-header-compact"
  }, [_c('i', {
    staticClass: "fas fa-lock mr-2 text-muted"
  }), _vm._v(" "), _c('span', {
    staticClass: "tax-status-title-compact"
  }, [_vm._v(_vm._s(_vm.$t("Non-Taxable")))])])]), _vm._v(" "), _c('small', {
    staticClass: "form-text form-helper-text text-muted d-block mt-1"
  }, [_vm._v("\n                  " + _vm._s(_vm.$t("Individual suppliers are always Non-Taxable.")) + "\n                ")])]) : _c('div', {
  ...
  }, [_vm._v("\n                " + _vm._s(_vm.$t("Additional Number")) + " "), _vm.form.taxStatus === 'taxable' ? _c('span', {
    staticClass: "required"
  }, [_vm._v("*")]) : _c('span', {
    staticClass: "text-muted"
  }, [_vm._v("(" + _vm._s(_vm.$t("Optional")) + ")")])]), _vm._v(" "), _c('input', {
...
;// ./resources/js/components/SupplierForm.vue?vue&type=template&id=66e2d5b4&scoped=true
...
var PhoneNumberInput = __webpack_require__(77949);
// EXTERNAL MODULE: ./node_modules/axios/index.js
var axios = __webpack_require__(72505);
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);
  ...
  methods: {
    ...
    validateForm: function validateForm() {
      ...
      if (this.form.type === 'Company') {
        var taxStatus = this.form.taxStatus;
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=66e2d5b4&prod&scoped=true&lang=css
var SupplierFormvue_type_style_index_0_id_66e2d5b4_prod_scoped_true_lang_css = __webpack_require__(59366);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=66e2d5b4&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(SupplierFormvue_type_style_index_0_id_66e2d5b4_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_SupplierFormvue_type_style_index_0_id_66e2d5b4_prod_scoped_true_lang_css = (SupplierFormvue_type_style_index_0_id_66e2d5b4_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=66e2d5b4&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=1d66a410&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_1d66a410_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_1d66a410_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_1d66a410_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=1d66a410&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-card[data-v-66e2d5b4]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:20px}.form-card .card-header[data-v-66e2d5b4]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:22px 16px}.form-card .section-title[data-v-66e2d5b4]{color:#fff;font-size:14px;font-weight:600;margin:0}.form-card .card-body[data-v-66e2d5b4]{padding:16px}.form-control[data-v-66e2d5b4]{background:#fff!important}input[readonly][data-v-66e2d5b4]{background-color:#f8f9fa!important;border-color:#ced4da;color:#6c757d;cursor:not-allowed}.form-control[data-v-66e2d5b4]:focus,select.form-control[data-v-66e2d5b4]:focus,textarea.form-control[data-v-66e2d5b4]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.radio-group[data-v-66e2d5b4]{align-items:center;display:flex;gap:16px}.radio-group .radio-inline[data-v-66e2d5b4]{align-items:center;display:inline-flex;gap:6px;margin:0}.v-select .vs__dropdown-toggle[data-v-66e2d5b4]{border-color:#ced4da;border-radius:6px}.v-select .vs__dropdown-toggle.vs__open[data-v-66e2d5b4],.v-select .vs__dropdown-toggle[data-v-66e2d5b4]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-menu[data-v-66e2d5b4],.v-select .vs__search[data-v-66e2d5b4],.v-select .vs__selected[data-v-66e2d5b4]{font-size:.95rem}.custom-file-input:focus~.custom-file-label[data-v-66e2d5b4]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.custom-file-label[data-v-66e2d5b4]{border-radius:6px}.file-upload-area[data-v-66e2d5b4]{background:#f8fdfe;border:2px dashed #33a0d9;border-radius:12px;padding:20px;position:relative;text-align:center}.file-upload-area .file-input[data-v-66e2d5b4]{cursor:pointer;height:100%;inset:0;opacity:0;position:absolute;width:100%}.file-upload-area .file-upload-content[data-v-66e2d5b4]{color:#33a0d9}.selected-files .selected-file-item[data-v-66e2d5b4]{align-items:center;background:#f5faff;border:1px solid #e3f3f7;border-radius:6px;display:inline-flex;margin-bottom:8px;margin-right:8px;padding:6px 10px}.d-flex.align-items-center span.ml-3[data-v-66e2d5b4]{font-weight:500}.required[data-v-66e2d5b4]{color:#dc3545}.tax-status-options[data-v-66e2d5b4]{margin-top:.5rem}.tax-status-card-compact[data-v-66e2d5b4]{background-color:#fff;border:2px solid #e0e0e0;box-shadow:0 1px 4px rgba(0,0,0,.06);display:block;padding:.75rem 1rem;position:relative}.tax-status-card-compact[data-v-66e2d5b4]:hover{border-color:#007bff;box-shadow:0 2px 8px rgba(0,123,255,.12);transform:translateY(-1px)}.tax-status-card-compact.active[data-v-66e2d5b4]{background:linear-gradient(135deg,#f8f9ff,#fff);border-color:#007bff;box-shadow:0 2px 10px rgba(0,123,255,.15)}.tax-status-card-compact.border-success.active[data-v-66e2d5b4]{background:linear-gradient(135deg,#f0fff4,#fff);border-color:#28a745;box-shadow:0 2px 10px rgba(40,167,69,.15)}.tax-status-card-compact.border-primary.active[data-v-66e2d5b4]{background:linear-gradient(135deg,#f8f9ff,#fff);border-color:#007bff;box-shadow:0 2px 10px rgba(0,123,255,.15)}.tax-status-header-compact[data-v-66e2d5b4]{position:relative}.tax-status-radio[data-v-66e2d5b4]{opacity:0;pointer-events:none;position:absolute}.tax-status-icon-compact[data-v-66e2d5b4]{align-items:center;border-radius:8px;display:flex;flex-shrink:0;font-size:1rem;height:32px;justify-content:center;margin-right:.75rem;transition:all .2s ease;width:32px}.tax-status-icon-compact.taxable-icon[data-v-66e2d5b4]{background:linear-gradient(135deg,#007bff,#0056b3);box-shadow:0 2px 6px rgba(0,123,255,.25);color:#fff}.tax-status-icon-compact.non-taxable-icon[data-v-66e2d5b4]{background:linear-gradient(135deg,#28a745,#1e7e34);box-shadow:0 2px 6px rgba(40,167,69,.25);color:#fff}.tax-status-card-compact.active .tax-status-icon-compact.taxable-icon[data-v-66e2d5b4]{box-shadow:0 3px 10px rgba(0,123,255,.35);transform:scale(1.05)}.tax-status-card-compact.active .tax-status-icon-compact.non-taxable-icon[data-v-66e2d5b4]{box-shadow:0 3px 10px rgba(40,167,69,.35);transform:scale(1.05)}.tax-status-title-compact[data-v-66e2d5b4]{color:#2c3e50;flex:1;font-size:.95rem;font-weight:600}.tax-status-card-compact.active .tax-status-title-compact[data-v-66e2d5b4]{color:#007bff}.tax-status-card-compact.border-success.active .tax-status-title-compact[data-v-66e2d5b4]{color:#28a745}[dir=rtl] .tax-status-icon-compact[data-v-66e2d5b4]{margin-left:.75rem;margin-right:0}[dir=rtl] .form-card .card-header[data-v-66e2d5b4]{border-radius:20px 20px 0 0}.custom-file-label[data-v-66e2d5b4],[dir=rtl] .custom-file-label[data-v-66e2d5b4]{text-align:left!important}.btn-primary[data-v-66e2d5b4]{background:#33a0d9!important;border-color:#33a0d9!important}.btn-primary[data-v-66e2d5b4]:hover{filter:brightness(.95)}.equal-height>[class*=\" col-\"][data-v-66e2d5b4],.equal-height>[class^=col-][data-v-66e2d5b4]{display:flex}.equal-height .form-card[data-v-66e2d5b4]{display:flex;flex-direction:column;width:100%}.equal-height .form-card .card-body[data-v-66e2d5b4]{flex:1 1 auto}.country-select[data-v-66e2d5b4]{width:100%}.country-select .vs__dropdown-toggle[data-v-66e2d5b4]{border:1px solid #ced4da;border-radius:6px;max-width:100%;min-height:2.5rem;overflow:hidden;padding:.5rem 1rem}.country-select .vs__search[data-v-66e2d5b4]{font-size:.95rem;margin:0;padding:0}.country-select .vs__selected[data-v-66e2d5b4]{align-items:center;display:flex;gap:.5rem;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.country-option[data-v-66e2d5b4],.country-selected[data-v-66e2d5b4]{align-items:center;display:flex;gap:.5rem;min-width:0}.country-flag[data-v-66e2d5b4]{flex-shrink:0;font-size:1.25rem;line-height:1}.country-name[data-v-66e2d5b4]{flex:1;font-size:.95rem;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.country-select.is-invalid .vs__dropdown-toggle[data-v-66e2d5b4]{border-color:#dc3545}.country-select .vs__dropdown-menu[data-v-66e2d5b4]{border-radius:6px;box-shadow:0 .5rem 1rem rgba(0,0,0,.15);margin-top:.5rem}.country-select .vs__dropdown-option[data-v-66e2d5b4]{padding:.75rem 1rem}.country-select .vs__dropdown-option--highlight[data-v-66e2d5b4]{background-color:#33a0d9;color:#fff}.saudi-location-select[data-v-66e2d5b4]{width:100%}.saudi-location-select .vs__dropdown-toggle[data-v-66e2d5b4]{background-color:#fff;border:1px solid #ced4da;border-radius:6px;min-height:2.5rem;padding:.375rem .75rem}.saudi-location-select .vs__dropdown-toggle.vs__open[data-v-66e2d5b4],.saudi-location-select .vs__dropdown-toggle[data-v-66e2d5b4]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15);outline:none}.saudi-location-select.is-invalid .vs__dropdown-toggle[data-v-66e2d5b4]{border-color:#dc3545}.saudi-location-select .vs__search[data-v-66e2d5b4]{font-size:.95rem;margin:0;padding:0}.saudi-location-select .vs__dropdown-menu[data-v-66e2d5b4]{border-radius:6px;box-shadow:0 .5rem 1rem rgba(0,0,0,.15);margin-top:.5rem}.saudi-location-select .vs__dropdown-option[data-v-66e2d5b4]{padding:.75rem 1rem}.saudi-location-select .vs__dropdown-option--highlight[data-v-66e2d5b4]{background-color:#33a0d9;color:#fff}.client-form-tabs[data-v-66e2d5b4]{background:#f8f9fa;border-radius:12px;margin-bottom:2rem;padding:.5rem}.client-form-tabs .nav-tabs[data-v-66e2d5b4]{border:none;display:flex;gap:.5rem;margin:0;padding:0}.client-form-tabs .nav-item[data-v-66e2d5b4]{flex:1}.client-form-tabs .nav-link[data-v-66e2d5b4]{align-items:center;background:transparent;border:none;border-radius:8px;color:#6b7280;cursor:pointer;display:flex;font-size:15px;font-weight:500;justify-content:center;padding:14px 24px;transition:all .3s ease}.client-form-tabs .nav-link[data-v-66e2d5b4]:hover{background:#e5e7eb;color:#374151}.client-form-tabs .nav-link.active[data-v-66e2d5b4]{background:#0775af;box-shadow:0 2px 8px rgba(7,117,175,.2);color:#fff}.client-form-tabs .nav-link i[data-v-66e2d5b4]{font-size:16px;margin-right:8px}[dir=rtl] .client-form-tabs .nav-link i[data-v-66e2d5b4]{margin-left:8px;margin-right:0}.tab-content[data-v-66e2d5b4]{margin-top:0}.tab-pane[data-v-66e2d5b4]{display:none}.tab-pane.show.active[data-v-66e2d5b4]{animation:fadeIn-66e2d5b4 .3s ease;display:block}@keyframes fadeIn-66e2d5b4{0%{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}.form-card-enhanced[data-v-66e2d5b4]{background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 1px 3px rgba(0,0,0,.05);margin-bottom:2rem;overflow:hidden;transition:all .3s ease}.form-card-enhanced[data-v-66e2d5b4]:hover{border-color:#d1d5db;box-shadow:0 4px 12px rgba(0,0,0,.08)}.form-card-enhanced .card-header[data-v-66e2d5b4]{background:#eceff3;border-bottom:1px solid #e5e7eb;padding:20px 24px}.form-card-enhanced .section-title[data-v-66e2d5b4]{align-items:center;color:#111827;display:flex;flex-wrap:wrap;font-size:18px;font-weight:600;gap:8px;margin:0}.form-card-enhanced .section-title i[data-v-66e2d5b4]{color:#0775af;font-size:20px}.form-card-enhanced .card-header-subtitle[data-v-66e2d5b4]{color:#6b7280;font-size:13px;font-weight:400;line-height:1.5;margin-bottom:0;margin-top:6px}.form-card-enhanced .card-body[data-v-66e2d5b4]{padding:24px}.form-control[data-v-66e2d5b4],.form-control-modern[data-v-66e2d5b4]{background-color:#fff;border:1.5px solid #d1d5db;border-radius:8px;color:#111827;font-size:14px;height:44px;line-height:1.5;padding:12px 16px;transition:all .2s ease;width:100%}.form-control-modern[data-v-66e2d5b4]:focus,.form-control[data-v-66e2d5b4]:focus{background-color:#fff;border-color:#0775af;box-shadow:0 0 0 3px rgba(7,117,175,.1);outline:none}.form-control-modern[readonly][data-v-66e2d5b4]{background-color:#f9fafb;color:#6b7280;cursor:not-allowed}.form-row-modern[data-v-66e2d5b4]{display:grid;gap:20px;grid-template-columns:repeat(2,1fr);margin-bottom:0}.form-row-three[data-v-66e2d5b4]{grid-template-columns:repeat(3,1fr)}.form-col-third[data-v-66e2d5b4]{width:100%}@media (max-width:1200px){.form-row-three[data-v-66e2d5b4]{grid-template-columns:repeat(2,1fr)}.form-row-three .form-col-third[data-v-66e2d5b4]:last-child{grid-column:1/-1}}@media (max-width:768px){.form-row-modern[data-v-66e2d5b4],.form-row-three[data-v-66e2d5b4]{gap:0;grid-template-columns:1fr}.form-row-three .form-col-third[data-v-66e2d5b4]:last-child{grid-column:1}}.radio-group-modern[data-v-66e2d5b4]{display:flex;gap:12px}.radio-option-modern[data-v-66e2d5b4]{align-items:center;background:#fff;border:1.5px solid #d1d5db;border-radius:8px;cursor:pointer;display:flex;flex:1;height:44px;justify-content:center;padding:0 16px;position:relative;transition:all .2s ease}.radio-option-modern[data-v-66e2d5b4]:hover{background:#f0f9ff;border-color:#0775af}.radio-option-modern.active[data-v-66e2d5b4]{background:#e6f4ff;border-color:#0775af;box-shadow:0 0 0 3px rgba(7,117,175,.1)}.radio-option-modern input[type=radio][data-v-66e2d5b4]{opacity:0;pointer-events:none;position:absolute}.radio-label-text[data-v-66e2d5b4]{color:#374151;font-size:14px;font-weight:500}.radio-option-modern.active .radio-label-text[data-v-66e2d5b4]{color:#0775af;font-weight:600}.tax-status-row[data-v-66e2d5b4]{display:flex;gap:8px}.tax-status-row .tax-status-card-compact[data-v-66e2d5b4]{flex:1;min-width:0}.tax-status-card-compact[data-v-66e2d5b4]{align-items:center;background:#fff;border:1.5px solid #d1d5db;border-radius:8px;cursor:pointer;display:flex;height:44px;padding:0;transition:all .2s ease}.tax-status-card-compact[data-v-66e2d5b4]:hover{border-color:#0775af;box-shadow:0 2px 8px rgba(7,117,175,.15)}.tax-status-card-compact.active[data-v-66e2d5b4]{background:#f0f9ff;border-color:#0775af;box-shadow:0 0 0 3px rgba(7,117,175,.1)}.tax-status-card-compact.border-success.active[data-v-66e2d5b4]{background:#f0fdf4;border-color:#10b981}.tax-status-header-compact[data-v-66e2d5b4]{align-items:center;display:flex;height:100%;justify-content:center;padding:0 12px;width:100%}.tax-status-title-compact[data-v-66e2d5b4]{color:#374151;font-size:14px;font-weight:500;text-align:center}.tax-status-card-compact.active .tax-status-title-compact[data-v-66e2d5b4]{color:#0775af}.tax-status-card-compact.border-success.active .tax-status-title-compact[data-v-66e2d5b4]{color:#10b981;font-weight:600}.tax-status-individual-locked .tax-status-card-compact.locked[data-v-66e2d5b4]{background:#f0fdf4;border-color:#10b981;cursor:default}.tax-status-individual-locked .tax-status-card-compact.locked[data-v-66e2d5b4]:hover{border-color:#10b981;box-shadow:none}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-1d66a410]{margin-bottom:15px}.footer-buttons[data-v-1d66a410]{display:flex;gap:10px}.footer-buttons .btn[data-v-1d66a410]{margin-right:10px}.footer-buttons .btn[data-v-1d66a410]:last-child{margin-right:0}.create-btn[data-v-1d66a410]{padding:11px}.chart-account-success[data-v-1d66a410],.chart-account-warning[data-v-1d66a410]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-1d66a410]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-1d66a410]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-1d66a410],.warning-content[data-v-1d66a410]{align-items:center;display:flex;gap:16px}.success-icon[data-v-1d66a410],.warning-icon[data-v-1d66a410]{flex-shrink:0;font-size:24px}.warning-icon[data-v-1d66a410]{color:#856404}.success-icon[data-v-1d66a410]{color:#155724}.success-text[data-v-1d66a410],.warning-text[data-v-1d66a410]{flex-grow:1}.success-title[data-v-1d66a410],.warning-title[data-v-1d66a410]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-1d66a410]{color:#856404}.success-title[data-v-1d66a410]{color:#155724}.success-description[data-v-1d66a410],.warning-description[data-v-1d66a410]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-1d66a410]{color:#856404}.success-description[data-v-1d66a410]{color:#155724}.warning-action[data-v-1d66a410]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-1d66a410]{padding:0}.card[data-v-1d66a410]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-1d66a410]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-1d66a410]{padding:1.25rem}.card-footer[data-v-1d66a410]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-1d66a410]{border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-1d66a410]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-1d66a410]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-1d66a410]{color:#dc3545;font-weight:700}.btn-primary[data-v-1d66a410]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-1d66a410]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-1d66a410]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-1d66a410]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-1d66a410]{border-color:#dc3545!important}textarea.form-control[data-v-1d66a410]{min-height:100px;resize:vertical}.v-select[data-v-1d66a410],.v-select .vs__dropdown-toggle[data-v-1d66a410]{background:#fff!important;border:1px solid #e5e7eb}.v-select .vs__dropdown-toggle[data-v-1d66a410]{padding:10px 16px}.v-select .vs__search[data-v-1d66a410]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-1d66a410]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-1d66a410]{color:#374151}.v-select .vs__dropdown-menu[data-v-1d66a410]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-1d66a410]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-1d66a410]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-1d66a410]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-1d66a410]:hover{background-color:#f8f9fa}.toggle-button[data-v-1d66a410]{margin-right:10px}.product-status[data-v-1d66a410],.supplier-status[data-v-1d66a410]{font-size:13px}.product-warning[data-v-1d66a410],.supplier-warning[data-v-1d66a410]{border-radius:6px;color:#856404;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-1d66a410]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-1d66a410]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-1d66a410]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-1d66a410]{margin-bottom:1rem}.form-text[data-v-1d66a410]{color:#6b7280;font-size:.875rem}.text-muted[data-v-1d66a410]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-1d66a410]{flex-direction:column;gap:10px}.card-footer .btn[data-v-1d66a410]{margin-right:0!important;width:100%}.card-footer div[data-v-1d66a410]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-1d66a410]{font-size:12px}.table-custom tbody td[data-v-1d66a410],.table-custom thead th[data-v-1d66a410]{padding:8px 4px}}.btn-group.c-w-100[data-v-1d66a410]{gap:10px}.quantity-field[data-v-1d66a410]{border-radius:0!important;margin:0!important;min-height:50px!important}.table-custom[data-v-1d66a410]{border:none!important}.invoices-create-table[data-v-1d66a410]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-1d66a410]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-1d66a410]{border:none!important}.invoices-create-table thead th[data-v-1d66a410]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-1d66a410]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-1d66a410]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-1d66a410]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-create-table .badge.badge-danger[data-v-1d66a410]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-1d66a410]{background:#fff!important}.summary-footer-wrapper[data-v-1d66a410]{margin-bottom:20px;margin-top:20px}.summary-card[data-v-1d66a410]{background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.05);overflow:hidden}.summary-header[data-v-1d66a410]{background:linear-gradient(135deg,#33a0d9,#2a8bc7);border-bottom:2px solid #2a8bc7;padding:16px 20px}.summary-title[data-v-1d66a410]{align-items:center;color:#fff;display:flex;font-size:16px;font-weight:600;margin:0}.summary-title i[data-v-1d66a410]{font-size:18px}.summary-body[data-v-1d66a410]{padding:16px 20px}.summary-row[data-v-1d66a410]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;justify-content:space-between;padding:12px 0;transition:background-color .2s ease}.summary-row[data-v-1d66a410]:last-child{border-bottom:none}.summary-row[data-v-1d66a410]:hover{background-color:#f9fafb;border-radius:4px;margin:0 -20px;padding-left:20px;padding-right:20px}.summary-row-net[data-v-1d66a410]{font-weight:500}.summary-row-discount[data-v-1d66a410]{background-color:#fef2f2}.summary-row-discount[data-v-1d66a410]:hover{background-color:#fee2e2}.summary-row-total[data-v-1d66a410]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-bottom:none;border-radius:8px;font-size:18px;margin-top:12px;padding:16px 20px}.summary-row-total[data-v-1d66a410]:hover{background:linear-gradient(135deg,#e0f2fe,#dbeafe);margin:12px -20px 0;padding:16px 20px}.summary-label[data-v-1d66a410]{align-items:center;color:#374151;display:flex;flex:1;font-size:14px;font-weight:500}.summary-label i[data-v-1d66a410]{color:#6b7280;font-size:14px;text-align:center;width:20px}.summary-value[data-v-1d66a410]{color:#111827;font-size:14px;font-weight:600;min-width:120px;text-align:right}.summary-total[data-v-1d66a410]{color:#33a0d9;font-size:20px;font-weight:700}[dir=rtl] .summary-label i[data-v-1d66a410]{margin-left:8px;margin-right:0}[dir=rtl] .summary-value[data-v-1d66a410]{text-align:left}@media (max-width:768px){.summary-header[data-v-1d66a410]{padding:12px 16px}.summary-title[data-v-1d66a410]{font-size:14px}.summary-body[data-v-1d66a410]{padding:12px 16px}.summary-row[data-v-1d66a410]{flex-wrap:wrap;padding:10px 0}.summary-row[data-v-1d66a410]:hover{margin:0 -16px;padding-left:16px;padding-right:16px}.summary-label[data-v-1d66a410]{font-size:13px;margin-bottom:4px;width:100%}.summary-value[data-v-1d66a410]{font-size:13px;min-width:auto;text-align:left;width:100%}.summary-row-total[data-v-1d66a410]{font-size:16px;padding:12px 16px}.summary-row-total[data-v-1d66a410]:hover{margin:12px -16px 0;padding:12px 16px}.summary-total[data-v-1d66a410]{font-size:18px}[dir=rtl] .summary-value[data-v-1d66a410]{text-align:right}}@media (max-width:576px){.summary-card[data-v-1d66a410]{border-radius:8px}.summary-body[data-v-1d66a410],.summary-header[data-v-1d66a410],.summary-row-total[data-v-1d66a410]{padding:10px 12px}.summary-row-total[data-v-1d66a410]:hover{margin:12px -12px 0;padding:10px 12px}}.product-option[data-v-1d66a410]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-1d66a410]:last-child{border-bottom:none}.product-option-header[data-v-1d66a410]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-1d66a410]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-1d66a410]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-1d66a410]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-1d66a410]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-1d66a410]{color:#33a0d9;font-size:11px}.badge-sm[data-v-1d66a410]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-1d66a410]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-1d66a410]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-1d66a410]{background-color:#e3f2fd}.form-section[data-v-1d66a410]{border-bottom:1px solid #e9ecef;padding:1.5rem 0}.form-section[data-v-1d66a410]:last-of-type{border-bottom:none}.form-group[data-v-1d66a410]{margin-bottom:1rem}.input-group[data-v-1d66a410]{display:flex;flex-wrap:wrap}.input-group .form-control[data-v-1d66a410]{flex:1 1 auto;min-width:0}@media (max-width:576px){.footer-buttons .btn[data-v-1d66a410]{margin-bottom:.5rem;width:100%}.footer-buttons .btn[data-v-1d66a410]:last-child{margin-bottom:0}.form-section[data-v-1d66a410]{padding:1rem 0}}@media (min-width:577px) and (max-width:768px){.form-section[data-v-1d66a410]{padding:1.25rem 0}}@media (max-width:768px){.form-group label[data-v-1d66a410]{display:block;margin-bottom:.5rem}.input-group[data-v-1d66a410]{flex-direction:column}.input-group .form-control[data-v-1d66a410],.input-group select[data-v-1d66a410]{margin-bottom:.5rem;width:100%}.btn[data-v-1d66a410]{min-height:44px;padding:.75rem 1rem}.btn-sm[data-v-1d66a410]{min-height:36px;padding:.5rem .75rem}}.transport-taxability-card[data-v-1d66a410]{background:#fff;border:2px solid #e5e7eb;border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.05);margin-top:1rem;padding:16px;transition:all .3s ease}.transport-taxability-card[data-v-1d66a410]:hover{border-color:#33a0d9;box-shadow:0 4px 8px rgba(51,160,217,.1)}.transport-taxability-header[data-v-1d66a410]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;margin-bottom:12px;padding-bottom:10px}.transport-taxability-header i[data-v-1d66a410]{font-size:20px;margin-right:8px}.transport-taxability-title[data-v-1d66a410]{color:#374151;font-size:14px;font-weight:600}.transport-taxability-body[data-v-1d66a410]{padding-top:8px}.custom-checkbox-wrapper[data-v-1d66a410]{margin-bottom:12px;position:relative}.custom-checkbox-input[data-v-1d66a410]{cursor:pointer;height:0;opacity:0;position:absolute;width:0}.custom-checkbox-label[data-v-1d66a410]{align-items:center;cursor:pointer;display:flex;padding:8px 0;transition:all .2s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.custom-checkbox-label[data-v-1d66a410]:hover{color:#33a0d9}.checkbox-indicator[data-v-1d66a410]{background-color:#fff;border:2px solid #d1d5db;border-radius:6px;display:inline-block;flex-shrink:0;height:24px;margin-right:12px;position:relative;transition:all .2s ease;width:24px}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-1d66a410]{background-color:#33a0d9;border-color:#33a0d9}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-1d66a410]:after{border:solid #fff;border-width:0 2px 2px 0;content:\"\";height:12px;left:7px;position:absolute;top:3px;transform:rotate(45deg);width:6px}.custom-checkbox-input:focus~.custom-checkbox-label .checkbox-indicator[data-v-1d66a410]{box-shadow:0 0 0 3px rgba(51,160,217,.1)}.checkbox-text[data-v-1d66a410]{color:#374151;font-size:14px;font-weight:500;line-height:1.5}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-text[data-v-1d66a410]{color:#33a0d9;font-weight:600}.transport-taxability-description[data-v-1d66a410]{align-items:flex-start;border-radius:6px;display:flex;font-size:13px;line-height:1.5;margin-top:8px;padding:10px 12px;transition:all .2s ease}.transport-taxability-description i[data-v-1d66a410]{flex-shrink:0;margin-top:2px}.description-taxable[data-v-1d66a410]{background-color:#ecfdf5;border:1px solid #a7f3d0;color:#065f46}.description-taxable i[data-v-1d66a410]{color:#10b981}.description-non-taxable[data-v-1d66a410]{background-color:#fef3c7;border:1px solid #fde68a;color:#92400e}.description-non-taxable i[data-v-1d66a410]{color:#f59e0b}[dir=rtl] .transport-taxability-header i[data-v-1d66a410]{margin-left:8px;margin-right:0}[dir=rtl] .checkbox-indicator[data-v-1d66a410]{margin-left:12px;margin-right:0}[dir=rtl] .transport-taxability-description i[data-v-1d66a410]{margin-left:8px;margin-right:0}@media (max-width:768px){.transport-taxability-card[data-v-1d66a410]{margin-top:.5rem;padding:12px}.transport-taxability-header[data-v-1d66a410]{margin-bottom:10px;padding-bottom:8px}.transport-taxability-title[data-v-1d66a410]{font-size:13px}.checkbox-indicator[data-v-1d66a410]{height:22px;width:22px}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-1d66a410]:after{height:10px;left:6px;top:2px;width:5px}.checkbox-text[data-v-1d66a410]{font-size:13px}.transport-taxability-description[data-v-1d66a410]{font-size:12px;padding:8px 10px}}.product-warning[data-v-1d66a410],.supplier-warning[data-v-1d66a410]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;display:flex;flex-wrap:wrap;gap:.5rem;margin-top:.5rem;padding:.75rem}.product-warning button[data-v-1d66a410],.supplier-warning button[data-v-1d66a410]{white-space:nowrap}@media (max-width:576px){.product-warning[data-v-1d66a410],.supplier-warning[data-v-1d66a410]{align-items:flex-start;flex-direction:column}.product-warning button[data-v-1d66a410],.supplier-warning button[data-v-1d66a410]{margin-left:0!important;width:100%}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var SupplierForm = __webpack_require__(27140);
