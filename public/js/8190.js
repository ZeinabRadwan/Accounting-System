...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/index.vue?vue&type=template&id=7f727ff9&scoped=true
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/index.vue?vue&type=script&lang=js
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            case 0:
              _context0.n = 1;
              return _this1.form.post(window.location.origin + "/api/invoices-pay").then(function () {
                toast.fire({
                  type: "success",
                  title: _this1.$t("Invoice payment added successfully")
                });
                _this1.$router.push({
                  name: "invoices.show",
                  params: {
                    slug: _this1.form.selectedInvoice.slug
                  }
                });
              })["catch"](function () {
                toast.fire({
          ...
          while (1) switch (_context1.n) {
            case 0:
              sweetalert2_all_default().fire({
                ...
                text: _this10.$t("You will not be able to return to this! This will delete the invoice permanently."),
                type: "warning",
                ...
                if (result.value) {
                  _this10.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true || response && response.success === true) {
                      ...
                      var errorMessage = _this10.$t("Sorry you can't delete this invoice!");
                      if (response && _typeof(response) === 'object' && response.message) {
                        errorMessage = response.message;
                      } else if (typeof response === 'string') {
                        errorMessage = response;
                      }
                      _this10.$toast.warning(_this10.$t("Failed!"), errorMessage);
                    }
                  });
                }
              });
          ...
          while (1) switch (_context11.n) {
            case 0:
              sweetalert2_default().fire({
                title: _this11.$t("Send Invoice to ZATCA"),
                text: _this11.$t("Do you want to send this invoice to ZATCA?"),
                type: "question",
                showCancelButton: true,
                confirmButtonText: _this11.$t("Yes"),
                cancelButtonText: _this11.$t("No"),
                confirmButtonColor: "#28a745",
                cancelButtonColor: "#dc3545"
              }).then(/*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(result) {
                  var response, _t2;
                  return _regenerator().w(function (_context10) {
                    while (1) switch (_context10.p = _context10.n) {
                      case 0:
                        ...
                        // Show loading
                        sweetalert2_default().fire({
                          title: _this11.$t("Sending..."),
                          text: _this11.$t("Please wait while we send the invoice to ZATCA"),
                      ...
                      case 2:
                        ...
                        if (response.data.success) {
                          _this11.$toast.success(_this11.$t("Sent Successfully!"), _this11.$t("Invoice has been sent to ZATCA and journal entries have been created."));
                          // Refresh the table to update the status
                          _this11.getData();
                        } else {
                          _this11.$toast.error(_this11.$t("Failed!"), response.data.message || _this11.$t("Failed to send invoice to ZATCA"));
                        }
                        _context10.n = 4;
                        break;
                      case 3:
                        _context10.p = 3;
                        _t2 = _context10.v;
                        console.error('Error sending invoice to ZATCA:', _t2);
                        // Close the loading dialog
                        sweetalert2_default().close();
                        _this11.$toast.error(_this11.$t("Error!"), _this11.$t("An error occurred while sending the invoice to ZATCA"));
                      case 4:
...
;// ./resources/js/pages/sales/invoices/index.vue?vue&type=script&lang=js
...
;// ./resources/js/pages/sales/invoices/index.vue?vue&type=style&index=0&id=7f727ff9&prod&scoped=true&lang=css
...
;// ./resources/js/pages/sales/invoices/index.vue?vue&type=style&index=1&id=7f727ff9&prod&lang=css
