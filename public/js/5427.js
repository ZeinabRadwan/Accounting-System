...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".overlay[data-v-64f44546]{background-color:rgba(0,0,0,.5);height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.info-box[data-v-64f44546],.overlay[data-v-64f44546]{align-items:center;display:flex}.info-box[data-v-64f44546]{background:#fff;border:1px solid #dee2e6;border-radius:.25rem;margin-bottom:1rem;padding:1rem}.info-box-icon[data-v-64f44546]{align-items:center;border-radius:50%;display:flex;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-64f44546]{flex:1}.info-box-text[data-v-64f44546]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-64f44546]{color:#495057;display:block;font-size:1.25rem;font-weight:700}.table th[data-v-64f44546]{background-color:#f8f9fa;border-top:1px solid #dee2e6}.pagination[data-v-64f44546]{margin-bottom:0}.dataTables_info[data-v-64f44546]{color:#6c757d;padding-bottom:.75rem;padding-top:.75rem}.dataTables_paginate[data-v-64f44546]{text-align:right}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/account-statement.vue?vue&type=template&id=64f44546&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }), _vm._v("\n                  " + _vm._s(_vm.$t('Reset')) + "\n                ")]), _vm._v(" "), _vm.reportData && _vm.entriesCount > 0 ? _c('button', {
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.summary ? _vm.summary.opening_balance : '0.00') + " " + _vm._s(_vm.summary ? _vm.summary.opening_balance_type : '') + "\n                  ")])])])]), _vm._v(" "), _c('div', {
    staticClass: "col-md-3"
  }, [_c('div', {
    staticClass: "info-box"
    ...
    staticClass: "info-box-number"
  }, [_vm._v(_vm._s(_vm.summary ? _vm.summary.period_debits : '0.00'))])])])]), _vm._v(" "), _c('div', {
    staticClass: "col-md-3"
  }, [_c('div', {
    staticClass: "info-box"
    ...
    staticClass: "info-box-number"
  }, [_vm._v(_vm._s(_vm.summary ? _vm.summary.period_credits : '0.00'))])])])]), _vm._v(" "), _c('div', {
    staticClass: "col-md-3"
  }, [_c('div', {
    staticClass: "info-box"
    ...
    staticClass: "info-box-number"
  }, [_vm._v("\n                    " + _vm._s(_vm.summary ? _vm.summary.closing_balance : '0.00') + " " + _vm._s(_vm.summary ? _vm.summary.closing_balance_type : '') + "\n                  ")])])])])]), _vm._v(" "), _c('div', {
    ...
    return _c('tr', {
      ...
      "class": entry.net_amount.startsWith('-') ? 'text-danger' : 'text-success'
...
;// ./resources/js/pages/reports/account-statement.vue?vue&type=template&id=64f44546&scoped=true
...
/* harmony default export */ const account_statementvue_type_script_lang_js = (_defineProperty({
  ...
  methods: {
    ...
    exportToPDF: function exportToPDF() {
      ...
      this.$toast.info('', this.$t('PDF export feature will be implemented soon'));
    }
  }
}, "watch", {
...
var update = injectStylesIntoStyleTag_default()(account_statementvue_type_style_index_0_id_64f44546_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_account_statementvue_type_style_index_0_id_64f44546_prod_scoped_true_lang_css = (account_statementvue_type_style_index_0_id_64f44546_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/account-statement.vue?vue&type=style&index=0&id=64f44546&prod&scoped=true&lang=css
