"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4728],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-38fdd5cc]{margin-bottom:15px}.footer-buttons[data-v-38fdd5cc]{display:flex;gap:10px}.footer-buttons .btn[data-v-38fdd5cc]{margin-right:10px}.footer-buttons .btn[data-v-38fdd5cc]:last-child{margin-right:0}.create-btn[data-v-38fdd5cc]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-38fdd5cc]:hover{background-color:#e9ecef}.edit-btn[data-v-38fdd5cc]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-38fdd5cc]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-38fdd5cc]{border:none!important}.quotations-create-table[data-v-38fdd5cc]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-38fdd5cc]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-38fdd5cc]{border:none!important}.quotations-create-table thead th[data-v-38fdd5cc]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-38fdd5cc]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-38fdd5cc]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-38fdd5cc]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-38fdd5cc]{gap:10px}.card[data-v-38fdd5cc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-38fdd5cc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-38fdd5cc]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-38fdd5cc]{background:#fff!important}.btn-primary[data-v-38fdd5cc]{background:#2ab930!important}.btn-secondary[data-v-38fdd5cc]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-38fdd5cc]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-38fdd5cc],.button-plus[data-v-38fdd5cc]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:12px;font-weight:700;height:24px;justify-content:center;transition:all .2s ease;width:24px}.button-minus[data-v-38fdd5cc]{background-color:#dc3545;color:#fff}.button-plus[data-v-38fdd5cc]{background-color:#007bff;color:#fff}.button-minus[data-v-38fdd5cc]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-38fdd5cc]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-38fdd5cc]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-38fdd5cc]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-38fdd5cc]{direction:rtl}[dir=rtl] .create-btn[data-v-38fdd5cc]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-38fdd5cc]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-38fdd5cc]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-38fdd5cc]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-38fdd5cc]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-38fdd5cc]{border-right:1px solid #ced4da}.clickable-badge[data-v-38fdd5cc]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-38fdd5cc]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-38fdd5cc]:active{transform:scale(.95)}.insufficient-stock-input[data-v-38fdd5cc]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-38fdd5cc]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-38fdd5cc]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-38fdd5cc]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-38fdd5cc]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-38fdd5cc]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-38fdd5cc]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-38fdd5cc]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-38fdd5cc]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-38fdd5cc]:last-child{border-bottom:none}.debug-display[data-v-38fdd5cc]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-38fdd5cc]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-38fdd5cc]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-38fdd5cc]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-38fdd5cc]:last-child{border-bottom:none}.debug-panel .table th[data-v-38fdd5cc]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-38fdd5cc]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-38fdd5cc]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-38fdd5cc]{padding:15px}.debug-item .row[data-v-38fdd5cc]{margin:0}.debug-item .col-md-6[data-v-38fdd5cc]{padding:0 5px}.debug-step[data-v-38fdd5cc]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-38fdd5cc]{font-size:.75em}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=template&id=38fdd5cc&scoped=true
...
;// ./resources/js/pages/sales/returns/create.vue?vue&type=template&id=38fdd5cc&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_38fdd5cc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_38fdd5cc_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_38fdd5cc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=0&id=38fdd5cc&prod&scoped=true&lang=css
