...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-f53c041c]{gap:10px}.header-buttons[data-v-f53c041c]{margin-bottom:15px}.footer-buttons[data-v-f53c041c]{display:flex;gap:10px}.footer-buttons .btn[data-v-f53c041c]{margin-right:10px}.footer-buttons .btn[data-v-f53c041c]:last-child{margin-right:0}.card[data-v-f53c041c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-f53c041c]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-f53c041c]{padding:1.25rem}.card-footer[data-v-f53c041c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-f53c041c]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-f53c041c]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-f53c041c]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-f53c041c]{color:#dc3545;font-weight:700}.btn-primary[data-v-f53c041c]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-f53c041c]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-f53c041c]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-f53c041c]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-f53c041c]{border-color:#dc3545!important}textarea.form-control[data-v-f53c041c]{min-height:100px;resize:vertical}.custom-file-input[data-v-f53c041c],.custom-file-label[data-v-f53c041c]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px}.custom-file-label[data-v-f53c041c]{color:#374151;font-weight:500}.custom-file-label[data-v-f53c041c]:after{background:#33a0d9;border-radius:0 10px 10px 0;color:#fff;font-weight:500}.bg-light[data-v-f53c041c]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px}.v-select[data-v-f53c041c]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-f53c041c]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-f53c041c]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-f53c041c]{border-color:#dc3545!important}.text-muted[data-v-f53c041c]{color:#6c757d!important}.small[data-v-f53c041c],.text-muted[data-v-f53c041c]{font-size:12px}.row[data-v-f53c041c]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-f53c041c]{flex-direction:column;gap:10px}.card-footer .btn[data-v-f53c041c]{margin-right:0!important;width:100%}.card-footer div[data-v-f53c041c]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/accounts/create.vue?vue&type=template&id=f53c041c&scoped=true
...
;// ./resources/js/pages/cashbook/accounts/create.vue?vue&type=template&id=f53c041c&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_f53c041c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const accounts_createvue_type_style_index_0_id_f53c041c_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_f53c041c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/accounts/create.vue?vue&type=style&index=0&id=f53c041c&prod&scoped=true&lang=css
