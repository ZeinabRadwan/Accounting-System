"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4398],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-e5e884e0]{margin-bottom:15px}.footer-buttons[data-v-e5e884e0]{display:flex;gap:10px}.footer-buttons .btn[data-v-e5e884e0]{margin-right:10px}.footer-buttons .btn[data-v-e5e884e0]:last-child{margin-right:0}.table-custom[data-v-e5e884e0]{border:none!important}.invoices-create-table[data-v-e5e884e0]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-e5e884e0]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-e5e884e0]{border:none!important}.invoices-create-table thead th[data-v-e5e884e0]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-e5e884e0]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-e5e884e0]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-e5e884e0]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-e5e884e0]{gap:10px}.card[data-v-e5e884e0]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-e5e884e0]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-info[data-v-e5e884e0]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-e5e884e0]{background:#fff!important}.btn-primary[data-v-e5e884e0]{background:#2ab930!important}.btn-secondary[data-v-e5e884e0]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.quantity-field[data-v-e5e884e0]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-e5e884e0]{font-size:.875rem}.account-status .account-warning[data-v-e5e884e0]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-e5e884e0]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/form.vue?vue&type=template&id=e5e884e0&scoped=true
...
;// ./resources/js/pages/sales/returns/form.vue?vue&type=template&id=e5e884e0&scoped=true
  ...
  methods: {
    ...
    storeProducts: function storeProducts() {
      ...
      try {
        var _loop = function _loop() {
          ...
          var matchedReturn = _this6.isEdit && _this6.loadedReturn ? _this6.loadedReturn.invoiceReturnProducts.find(function (p) {
          ...
          var selectedVatRate = _this6.findMatchingVatRate(invoiceItem.productTax) || _this6.form.orderTax || ((_this6$taxes = _this6.taxes) === null || _this6$taxes === void 0 ? void 0 : _this6$taxes[0]);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              _context6.n = 1;
              return axios_default().get("/api/invoice-returns/".concat(_this8.$route.params.slug));
            case 1:
              _yield$axios$get4 = _context6.v;
              data = _yield$axios$get4.data;
              _this8.loadedReturn = data.data;
              // set top-level fields
              _this8.form.returnReason = data.data.reason;
              _this8.form.availableBalance = data.data.account ? data.data.account.availableBalance : 0;
              _this8.form.account = data.data.account;
              _this8.form.receiptNo = data.data.accountPayable ? data.data.accountPayable.receipt_no : '';
              _this8.form.client = data.data.client;
              _this8.form.date = data.data.returnDate;
            ...
            case 2:
              invoiceResp = _context6.v;
              invoiceData = invoiceResp.data.data;
              _this8.form.invoice = invoiceData;
    ...
    onSubmit: function onSubmit() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var _this9$form$invoice;
        var _yield$_this9$form$po, data, _t2;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              if (_this9.validateReturns()) {
                _context7.n = 1;
                break;
              }
              return _context7.a(2);
            case 1:
              if (!(!_this9.isSaudiArabia && _this9.form.returnAmount > 0 && !_this9.hasBankAccountChartOfAccount)) {
                _context7.n = 2;
                break;
              }
              toast.fire({
                type: 'warning',
                title: _this9.$t('Bank Account Chart of Account Required'),
                text: _this9.$t('Bank Account must have a Chart of Account assigned for journal entries.'),
                timer: 8000,
                timerProgressBar: true,
                showConfirmButton: true,
                confirmButtonText: _this9.$t('Go to Bank Accounts'),
                showCancelButton: true,
                cancelButtonText: _this9.$t('Close')
              }).then(function (result) {
                if (result.isConfirmed) _this9.goToBankAccounts();
              });
              return _context7.a(2);
            case 2:
              _this9.form.totalPaid = ((_this9$form$invoice = _this9.form.invoice) === null || _this9$form$invoice === void 0 ? void 0 : _this9$form$invoice.totalPaid) || 0;
              _this9.form.invoiceTax = _this9.form.newTax;
              _this9.form.newDue = _this9.form.invoiceDue;
              _context7.p = 3;
              if (!_this9.isEdit) {
                _context7.n = 5;
                break;
              ...
              _context7.n = 4;
              return _this9.form.patch("/api/invoice-returns/".concat(_this9.$route.params.slug));
            case 4:
              toast.fire({
                type: 'success',
                title: _this9.$t('Invoice return updated successfully')
              });
              _this9.$router.push({
                name: 'invoiceReturns.index'
              });
            ...
            case 5:
              _context7.n = 6;
              return _this9.form.post('/api/invoice-returns');
            case 6:
              _yield$_this9$form$po = _context7.v;
              data = _yield$_this9$form$po.data;
              if (_this9.isSaudiArabia) {
                toast.fire({
                  type: 'success',
                  title: _this9.$t('Credit Note created successfully'),
                  text: _this9.$t('Credit Note has been created as inactive. You can send it to ZATCA from the invoice returns list.'),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else {
                toast.fire({
                  type: 'success',
                  title: _this9.$t('Invoice return added successfully')
                });
              }
              _this9.$router.push({
...
var update = injectStylesIntoStyleTag_default()(formvue_type_style_index_0_id_e5e884e0_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_formvue_type_style_index_0_id_e5e884e0_prod_scoped_true_lang_css = (formvue_type_style_index_0_id_e5e884e0_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/form.vue?vue&type=style&index=0&id=e5e884e0&prod&scoped=true&lang=css
