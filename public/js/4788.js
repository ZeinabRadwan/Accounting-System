...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/index.vue?vue&type=template&id=3911a25b&scoped=true
                  ...
                  return _regenerator().w(function (_context8) {
                    while (1) switch (_context8.p = _context8.n) {
                      ...
                      case 3:
                        ...
                        sweetalert2_all_default().fire(_this8.$t("Error!"), ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this8.$t("An error occurred while sending the credit note"), "error");
                      case 4:
...
var update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_0_id_3911a25b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const sales_returnsvue_type_style_index_0_id_3911a25b_prod_scoped_true_lang_css = (returnsvue_type_style_index_0_id_3911a25b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/index.vue?vue&type=style&index=0&id=3911a25b&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-3911a25b]{border:none!important}.invoice-returns-table[data-v-3911a25b]{border-collapse:separate;border-spacing:0}.invoice-returns-table thead th[data-v-3911a25b]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoice-returns-table thead tr[data-v-3911a25b]{border:none!important}.invoice-returns-table thead th[data-v-3911a25b]:first-child{border-top-left-radius:10px}.invoice-returns-table thead th[data-v-3911a25b]:last-child{border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-3911a25b]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-3911a25b]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-3911a25b]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-3911a25b],.export-pdf-btn[data-v-3911a25b]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-3911a25b],.export-pdf-btn[data-v-3911a25b],.print-btn[data-v-3911a25b]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-3911a25b]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-3911a25b]{display:inline-block;position:relative}.action-icon-btn[data-v-3911a25b]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-3911a25b]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-3911a25b]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-3911a25b]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-3911a25b]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-3911a25b]{gap:10px}.btn-group.c-w-100>.btn[data-v-3911a25b]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-3911a25b]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-3911a25b]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-3911a25b]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-3911a25b]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoice-returns-table .badge.bg-success[data-v-3911a25b]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.invoice-returns-table .badge.bg-danger[data-v-3911a25b]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-3911a25b]{background:#f1f5fb!important}.btn-primary[data-v-3911a25b]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
