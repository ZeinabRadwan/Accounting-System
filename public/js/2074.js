(self["webpackChunk"] = self["webpackChunk"] || []).push([[2074],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-6cd60dfa]{margin-bottom:15px}.table-price-counter-nowrap[data-v-6cd60dfa]{display:flex;flex-wrap:nowrap}.table-product-title[data-v-6cd60dfa]{max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pos-r-head[data-v-6cd60dfa]{border-bottom:1px solid #f3f3f3;border-radius:5px;box-shadow:0 0 3px #0003;box-sizing:border-box;padding:20px}.pos-logo[data-v-6cd60dfa]{text-align:center}.pos-item-grid[data-v-6cd60dfa]{grid-gap:10px;display:grid;grid-template-columns:1fr 1fr 1fr 1fr 1fr 1fr}.pos-item-grid>div[data-v-6cd60dfa]{border:1px solid #fff;border-radius:10px;box-shadow:0 4px 20px 1px rgba(0,0,0,.06),0 1px 4px rgba(0,0,0,.08);cursor:pointer;overflow:hidden;position:relative}.pos-item-grid>div[data-v-6cd60dfa]:hover{border-color:#33a0d9}.pos-item-grid>div .box-qty[data-v-6cd60dfa]{background:#33a0d9;border-bottom-right-radius:10px;color:#fff;display:block;font-size:12px;font-weight:700;height:30px;left:0;line-height:30px;position:absolute;text-align:center;top:0;width:50px}.qty-red[data-v-6cd60dfa]{background:red!important}.pos-body[data-v-6cd60dfa]{border-radius:5px;min-height:240px}.pos-box-img[data-v-6cd60dfa]{background:#ebebeb;border-bottom:1px solid #f1f1f1;font-size:13px;font-weight:700;height:100px;line-height:100px;text-align:center;width:100%}.pos-box-img img[data-v-6cd60dfa]{height:100px;-o-object-fit:cover;object-fit:cover;width:100%}.pos-box-content p[data-v-6cd60dfa]{font-size:14px;font-weight:700;margin-bottom:0}.pos-box-content span[data-v-6cd60dfa]{font-size:12px;margin-bottom:2px}.pos-box-content[data-v-6cd60dfa]{padding:5px 10px}.pos-item-grid-red[data-v-6cd60dfa]{border-color:red!important}.card-client-search[data-v-6cd60dfa]{border-bottom:1px solid #ddd;padding:20px}.table-wrap[data-v-6cd60dfa]{padding:15px}.table-responsive.table-wrap>table[data-v-6cd60dfa]{border:1px solid #ddd}.table-wrap .table thead tr[data-v-6cd60dfa]{background:#33a0d91f!important;border-bottom:0}.table-wrap .incrementor[data-v-6cd60dfa]{width:80px}.table-wrap .custom-qty-input[data-v-6cd60dfa]{border:1px solid #ececfdb8;border-radius:18px;display:inline-flex!important;justify-content:center;padding:0}.table-wrap .btn-danger[data-v-6cd60dfa]{font-size:10px;height:25px;padding:0;width:25px}.table-wrap .icon-sm[data-v-6cd60dfa]{height:25px;line-height:23px;width:25px}.pos-card-footer[data-v-6cd60dfa]{background:#fff;border:1px solid #ddd;border-radius:4px;margin-bottom:15px}.pos-net-total[data-v-6cd60dfa]{background:#33a0d933;font-size:22px;font-weight:700;padding:10px;text-align:center;width:100%}.product[data-v-6cd60dfa]{cursor:pointer}.product .info-box[data-v-6cd60dfa]:hover{background:#e0e0e0}.dark-mode .pos-body[data-v-6cd60dfa],.dark-mode .pos-r-head[data-v-6cd60dfa]{background:#111827!important;border-color:#000}.dark-mode .pos-item-grid>div[data-v-6cd60dfa]{border-color:#6c757d!important}.dark-mode .pos-box-content[data-v-6cd60dfa]{color:#fff;padding:5px 10px}.dark-mode .pos-item-grid>div.pos-item-grid-red[data-v-6cd60dfa]{border-color:red!important}.dark-mode .card-client-search[data-v-6cd60dfa]{border-color:#6c757d}.dark-mode .table-striped tbody tr[data-v-6cd60dfa]:nth-of-type(odd){background-color:#1f2937}.dark-mode .table-responsive.table-wrap>table[data-v-6cd60dfa]{border:1px solid #6c757d}.dark-mode .table-wrap .incrementor[data-v-6cd60dfa]{border:none!important}.dark-mode .pos-card-footer.bg-white[data-v-6cd60dfa]{background:#111827!important;border-color:#6c757d}.dark-mode .pos-card-footer label[data-v-6cd60dfa]{color:#fff}.dark-mode .pos-net-total[data-v-6cd60dfa]{background:#63a9f1;color:#fff}#invoice-POS table[data-v-6cd60dfa],#invoice-POS td[data-v-6cd60dfa],#invoice-POS th[data-v-6cd60dfa],#invoice-POS tr[data-v-6cd60dfa]{border-collapse:collapse}#invoice-POS tr[data-v-6cd60dfa]{border-bottom:2px dotted #05070b}#invoice-POS table[data-v-6cd60dfa]{width:100%}#invoice-POS tfoot tr th[data-v-6cd60dfa]:first-child{text-align:left}#invoice-POS .info[data-v-6cd60dfa]{margin-bottom:20px}#invoice-POS .info>p[data-v-6cd60dfa]{margin-top:20px}#legalcopy[data-v-6cd60dfa]{margin-top:5mm}#bar[data-v-6cd60dfa],#legalcopy p[data-v-6cd60dfa]{text-align:center}.total[data-v-6cd60dfa]{font-size:12px;font-weight:700}span.pqty[data-v-6cd60dfa]{display:block;font-size:12px;font-weight:500;line-height:15px;margin-bottom:5px}@media only screen and (max-width:1250px){.pos-item-grid[data-v-6cd60dfa]{grid-template-columns:1fr 1fr 1fr 1fr}}@media only screen and (max-width:991px){.pos-item-grid[data-v-6cd60dfa]{grid-template-columns:1fr 1fr 1fr}}@media only screen and (max-width:767px){.sm-col-reverse[data-v-6cd60dfa]{flex-direction:column-reverse}.pos-item-grid[data-v-6cd60dfa]{grid-template-columns:1fr 1fr 1fr 1fr}}.create-btn[data-v-6cd60dfa]{padding:11px}.create-btn-2[data-v-6cd60dfa]{padding:10px}.btn-primary[data-v-6cd60dfa]{background:#2ab930!important}.btn-primary[data-v-6cd60dfa]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/pos/create.vue?vue&type=template&id=6cd60dfa&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_6cd60dfa_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const pos_createvue_type_style_index_0_id_6cd60dfa_prod_lang_scss_scoped_true = (createvue_type_style_index_0_id_6cd60dfa_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/pos/create.vue?vue&type=style&index=0&id=6cd60dfa&prod&lang=scss&scoped=true
