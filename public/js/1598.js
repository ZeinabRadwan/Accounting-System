"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1598],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/QuotationForm.vue?vue&type=template&id=0ef0caee&scoped=true
var QuotationFormvue_type_template_id_0ef0caee_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
    ...
    attrs: {
      ...
      "subtotal": _vm.totalAfterTax,
      "amount-in-words": _vm.toWord(),
      "show-edit-button": _vm.mode === 'create'
    },
    on: {
    ...
    staticClass: "ml-2 text-muted small"
  }, [_vm._v("(" + _vm._s(_vm.$t("SMS not configured")) + ")")]) : _vm._e()], 1)])], 1), _vm._v(" "), _c('div', {
...
var QuotationFormvue_type_template_id_0ef0caee_scoped_true_staticRenderFns = [];
...
/* harmony default export */ const QuotationFormvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "appInfo"])), {}, {
    ...
    totalProductTax: function totalProductTax() {
      return this.roundToTwoDecimals(this.form.selectedProducts.reduce(function (t, i) {
        return t + (i.taxType === 'Inclusive' ? i.totalTax || 0 : i.productTax || 0);
      }, 0));
    },
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              if (_this4.taxes && _this4.form.selectedProducts && _this4.form.selectedProducts.length > 0) {
                _this4.form.selectedProducts.forEach(function (item, index) {
                  if (item.vat_rate_id) {
                    var vatRate = _this4.findVatRateById(item.vat_rate_id);
                    if (vatRate) {
                      _this4.$set(item, 'vat_rate_code', vatRate.code);
                      // Also update selectedVatRate if it's not set or doesn't match
                      if (!item.selectedVatRate || item.selectedVatRate.id !== vatRate.id) {
                        _this4.$set(item, 'selectedVatRate', vatRate);
                      }
                    }
                    ...
                    _this4.$set(item, 'vat_rate_code', item.selectedVatRate.code);
                    _this4.$set(item, 'vat_rate_id', item.selectedVatRate.id);
                  } else if (!item.selectedVatRate && item.taxRate) {
                    // If no selectedVatRate but taxRate exists, try to find matching VAT rate
                    var matchingVatRate = _this4.findMatchingVatRate(item.taxRate) || _this4.form.orderTax || _this4.taxes && _this4.taxes[0];
                    if (matchingVatRate) {
                      _this4.$set(item, 'selectedVatRate', matchingVatRate);
                      _this4.$set(item, 'vat_rate_code', matchingVatRate.code);
                      _this4.$set(item, 'vat_rate_id', matchingVatRate.id);
                    }
                  }
    ...
    findVatRateById: function findVatRateById(vatRateId) {
      if (!this.taxes || !vatRateId) return null;
      return this.taxes.find(function (tax) {
        return tax.id === vatRateId;
      });
    },
    ...
    generateItemTotalPrice: function generateItemTotalPrice(index) {
      ...
      if (item.taxType == "Exclusive") {
        ...
        var productTax = this.roundToTwoDecimals(priceAfterDiscount * (vatRate / 100));
        var totalTax = this.roundToTwoDecimals(productTax);
        var totalPrice = this.roundToTwoDecimals(priceAfterDiscount + totalTax);
        ...
        var _productTax = this.roundToTwoDecimals(discountedUnitPrice - discountedUnitPrice / (1 + vatRate / 100));
        var _totalTax = this.roundToTwoDecimals(_productTax * item.qty);
        var _totalPrice = this.roundToTwoDecimals(priceAfterDiscount);
        this.$set(item, 'productTax', _productTax);
        this.$set(item, 'totalTax', _totalTax);
        this.$set(item, 'totalPrice', _totalPrice);
      }
    },
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return _this7.form.patch(window.location.origin + "/api/quotations/" + _this7.$route.params.slug).then(function (_ref2) {
                var data = _ref2.data;
                toast.fire({
                  type: "success",
            ...
            case 5:
              _context6.next = 7;
              return _this7.form.post(window.location.origin + "/api/quotations").then(function (_ref3) {
                var data = _ref3.data;
                toast.fire({
                  type: "success",
    ...
    assignProducts: function assignProducts(quotationProducts) {
      ...
      for (var key in quotationProducts) {
        var _ref4, _qp$salePrice, _qp$taxRate, _qp$taxAmount, _qp$unitCostTotal, _qp$unitCost, _qp$productID, _qp$productSlug, _qp$productName, _qp$productCode, _qp$inventoryCount, _qp$discount, _qp$discountType, _qp$discountAmount;
        var qp = quotationProducts[key];
        var qty = Number(qp.quantity || qp.qty || 1);
        var unitPrice = Number((_ref4 = (_qp$salePrice = qp.salePrice) !== null && _qp$salePrice !== void 0 ? _qp$salePrice : qp.unitPrice) !== null && _ref4 !== void 0 ? _ref4 : 0);
...
var update = injectStylesIntoStyleTag_default()(QuotationFormvue_type_style_index_0_id_0ef0caee_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_QuotationFormvue_type_style_index_0_id_0ef0caee_prod_scoped_true_lang_css = (QuotationFormvue_type_style_index_0_id_0ef0caee_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/QuotationForm.vue?vue&type=style&index=0&id=0ef0caee&prod&scoped=true&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  ...
  QuotationFormvue_type_template_id_0ef0caee_scoped_true_render,
  QuotationFormvue_type_template_id_0ef0caee_scoped_true_staticRenderFns,
  false,
  null,
  "0ef0caee",
  null
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-0ef0caee]{margin-bottom:15px}.footer-buttons[data-v-0ef0caee]{display:flex;gap:10px}.footer-buttons .btn[data-v-0ef0caee]{margin-right:10px}.footer-buttons .btn[data-v-0ef0caee]:last-child{margin-right:0}.create-btn[data-v-0ef0caee]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-0ef0caee]:hover{background-color:#e9ecef}.edit-btn[data-v-0ef0caee]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-0ef0caee]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-0ef0caee]{border:none!important}.quotations-create-table[data-v-0ef0caee]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-0ef0caee]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-0ef0caee]{border:none!important}.quotations-create-table thead th[data-v-0ef0caee]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-0ef0caee]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-0ef0caee]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-0ef0caee]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-0ef0caee]{gap:10px}.card[data-v-0ef0caee]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-0ef0caee]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-0ef0caee]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-0ef0caee]{background:#fff!important}.btn-primary[data-v-0ef0caee]{background:#2ab930!important}.btn-secondary[data-v-0ef0caee]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-0ef0caee]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-0ef0caee],.button-plus[data-v-0ef0caee]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-0ef0caee]{background-color:#dc3545;color:#fff}.button-plus[data-v-0ef0caee]{background-color:#007bff;color:#fff}.button-minus[data-v-0ef0caee]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-0ef0caee]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-0ef0caee]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-0ef0caee]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-0ef0caee]{direction:rtl}[dir=rtl] .create-btn[data-v-0ef0caee]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-0ef0caee]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-0ef0caee]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-0ef0caee]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-0ef0caee]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-0ef0caee]{border-right:1px solid #ced4da}.clickable-badge[data-v-0ef0caee]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-0ef0caee]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-0ef0caee]:active{transform:scale(.95)}.insufficient-stock-input[data-v-0ef0caee]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-0ef0caee]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
