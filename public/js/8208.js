"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8208],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-80c4d352]{margin-bottom:15px}.footer-buttons[data-v-80c4d352]{display:flex;gap:10px}.footer-buttons .btn[data-v-80c4d352]{margin-right:10px}.footer-buttons .btn[data-v-80c4d352]:last-child{margin-right:0}.btn-group.c-w-100[data-v-80c4d352]{gap:10px}.card[data-v-80c4d352]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-80c4d352]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-80c4d352]{padding:1.25rem}.card-footer[data-v-80c4d352]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-80c4d352]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-80c4d352]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-80c4d352]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-80c4d352]{color:#dc3545;font-weight:700}.btn-primary[data-v-80c4d352]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-80c4d352]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-80c4d352]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-80c4d352]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-80c4d352]{border-color:#dc3545!important}textarea.form-control[data-v-80c4d352]{min-height:100px;resize:vertical}.v-select[data-v-80c4d352],.v-select .vs__dropdown-toggle[data-v-80c4d352]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-80c4d352]{padding:10px 16px}.v-select .vs__search[data-v-80c4d352]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-80c4d352]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-80c4d352]{color:#374151}.v-select .vs__dropdown-menu[data-v-80c4d352]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-80c4d352]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-80c4d352]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-80c4d352]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-80c4d352]:hover{background-color:#f8f9fa}.custom-qty-input[data-v-80c4d352]{align-items:center;background:#fff;border:1px solid #e5e7eb;border-radius:10px;display:flex;overflow:hidden}.custom-qty-input .button-minus[data-v-80c4d352],.custom-qty-input .button-plus[data-v-80c4d352]{background:#6c757d;border:none;color:#fff;cursor:pointer;font-weight:700;padding:8px 12px;transition:background-color .3s}.custom-qty-input .button-minus[data-v-80c4d352]:hover{background:#dc3545}.custom-qty-input .button-plus[data-v-80c4d352]:hover{background:#2ab930}.custom-qty-input .quantity-field[data-v-80c4d352]{background:transparent;border:none;font-weight:500;padding:8px 4px;text-align:center;width:60px}.custom-qty-input .quantity-field[data-v-80c4d352]:focus{box-shadow:none;outline:none}.callout[data-v-80c4d352]{border-left:4px solid;border-radius:8px;margin-bottom:16px;padding:12px 16px}.callout-danger[data-v-80c4d352]{background-color:#f8d7da;border-left-color:#dc3545;color:#721c24}.callout i[data-v-80c4d352]{margin-right:8px}.row[data-v-80c4d352]{margin-bottom:1rem}.form-text[data-v-80c4d352]{color:#6b7280;font-size:.875rem}.text-muted[data-v-80c4d352]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-80c4d352]{flex-direction:column;gap:10px}.card-footer .btn[data-v-80c4d352]{margin-right:0!important;width:100%}.card-footer div[data-v-80c4d352]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-80c4d352]{font-size:12px}.table-custom tbody td[data-v-80c4d352],.table-custom thead th[data-v-80c4d352]{padding:8px 4px}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/create.vue?vue&type=template&id=80c4d352&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    })])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.purchasePrice) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.totalPrice) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.returnTotal) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])])]);
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_80c4d352_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_80c4d352_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_80c4d352_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/create.vue?vue&type=style&index=0&id=80c4d352&prod&scoped=true&lang=css
