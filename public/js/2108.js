"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2108],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-99ffee4a]{margin-bottom:15px}.footer-buttons[data-v-99ffee4a]{display:flex;gap:10px}.footer-buttons .btn[data-v-99ffee4a]{margin-right:10px}.footer-buttons .btn[data-v-99ffee4a]:last-child{margin-right:0}.create-btn[data-v-99ffee4a]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-99ffee4a]:hover{background-color:#e9ecef}.edit-btn[data-v-99ffee4a]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-99ffee4a]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-99ffee4a]{border:none!important}.quotations-create-table[data-v-99ffee4a]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-99ffee4a]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-99ffee4a]{border:none!important}.quotations-create-table thead th[data-v-99ffee4a]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-99ffee4a]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-99ffee4a]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-99ffee4a]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-99ffee4a]{gap:10px}.card[data-v-99ffee4a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-99ffee4a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-99ffee4a]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-99ffee4a]{background:#fff!important}.btn-primary[data-v-99ffee4a]{background:#2ab930!important}.btn-secondary[data-v-99ffee4a]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-99ffee4a]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-99ffee4a],.button-plus[data-v-99ffee4a]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-99ffee4a]{background-color:#dc3545;color:#fff}.button-plus[data-v-99ffee4a]{background-color:#007bff;color:#fff}.button-minus[data-v-99ffee4a]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-99ffee4a]:hover{background-color:#0056b3;transform:scale(1.05)}.price-field[data-v-99ffee4a]{width:100%}.quantity-field[data-v-99ffee4a]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-99ffee4a]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-99ffee4a]{direction:rtl}[dir=rtl] .create-btn[data-v-99ffee4a]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-99ffee4a]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-99ffee4a]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-99ffee4a]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-99ffee4a]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-99ffee4a]{border-right:1px solid #ced4da}.clickable-badge[data-v-99ffee4a]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-99ffee4a]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-99ffee4a]:active{transform:scale(.95)}.insufficient-stock-input[data-v-99ffee4a]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-99ffee4a]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-99ffee4a]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-99ffee4a]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-99ffee4a]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-99ffee4a]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-99ffee4a]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-99ffee4a]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-99ffee4a]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-99ffee4a]:last-child{border-bottom:none}.debug-display[data-v-99ffee4a]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-99ffee4a]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-99ffee4a]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-99ffee4a]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-99ffee4a]:last-child{border-bottom:none}.debug-panel .table th[data-v-99ffee4a]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-99ffee4a]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-99ffee4a]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-99ffee4a]{padding:15px}.debug-item .row[data-v-99ffee4a]{margin:0}.debug-item .col-md-6[data-v-99ffee4a]{padding:0 5px}.debug-step[data-v-99ffee4a]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-99ffee4a]{font-size:.75em}}.summary-footer-wrapper[data-v-99ffee4a]{margin-top:10px}.summary-card[data-v-99ffee4a]{background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.05);overflow:hidden}.summary-header[data-v-99ffee4a]{background:linear-gradient(135deg,#33a0d9,#2a8bc7);border-bottom:2px solid #2a8bc7;padding:16px 20px}.summary-title[data-v-99ffee4a]{align-items:center;color:#fff;display:flex;font-size:16px;font-weight:600;margin:0}.summary-title i[data-v-99ffee4a]{font-size:18px}.summary-body[data-v-99ffee4a]{padding:16px 20px}.summary-row[data-v-99ffee4a]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;justify-content:space-between;padding:12px 0;transition:background-color .2s ease}.summary-row[data-v-99ffee4a]:last-child{border-bottom:none}.summary-row[data-v-99ffee4a]:hover{background-color:#f9fafb;border-radius:4px;margin:0 -20px;padding-left:20px;padding-right:20px}.summary-row-net[data-v-99ffee4a]{font-weight:500}.summary-row-discount[data-v-99ffee4a]{background-color:#fef2f2}.summary-row-discount[data-v-99ffee4a]:hover{background-color:#fee2e2}.summary-row-total[data-v-99ffee4a]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-bottom:none;border-radius:8px;font-size:18px;margin-top:12px;padding:16px 20px}.summary-row-total[data-v-99ffee4a]:hover{background:linear-gradient(135deg,#e0f2fe,#dbeafe);margin:12px -20px 0;padding:16px 20px}.summary-label[data-v-99ffee4a]{align-items:center;color:#374151;display:flex;flex:1;font-size:14px;font-weight:500}.summary-label i[data-v-99ffee4a]{color:#6b7280;font-size:14px;text-align:center;width:20px}.summary-value[data-v-99ffee4a]{color:#111827;font-size:14px;font-weight:600;min-width:120px;text-align:right}.summary-total[data-v-99ffee4a]{color:#33a0d9;font-size:20px;font-weight:700}[dir=rtl] .summary-label i[data-v-99ffee4a]{margin-left:8px;margin-right:0}[dir=rtl] .summary-value[data-v-99ffee4a]{text-align:left}@media (max-width:768px){.summary-header[data-v-99ffee4a]{padding:12px 16px}.summary-title[data-v-99ffee4a]{font-size:14px}.summary-body[data-v-99ffee4a]{padding:12px 16px}.summary-row[data-v-99ffee4a]{flex-wrap:wrap;padding:10px 0}.summary-row[data-v-99ffee4a]:hover{margin:0 -16px;padding-left:16px;padding-right:16px}.summary-label[data-v-99ffee4a]{font-size:13px;margin-bottom:4px;width:100%}.summary-value[data-v-99ffee4a]{font-size:13px;min-width:auto;text-align:left;width:100%}.summary-row-total[data-v-99ffee4a]{font-size:16px;padding:12px 16px}.summary-row-total[data-v-99ffee4a]:hover{margin:12px -16px 0;padding:12px 16px}.summary-total[data-v-99ffee4a]{font-size:18px}[dir=rtl] .summary-value[data-v-99ffee4a]{text-align:right}}@media (max-width:576px){.summary-card[data-v-99ffee4a]{border-radius:8px}.summary-body[data-v-99ffee4a],.summary-header[data-v-99ffee4a],.summary-row-total[data-v-99ffee4a]{padding:10px 12px}.summary-row-total[data-v-99ffee4a]:hover{margin:12px -12px 0;padding:10px 12px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/edit.vue?vue&type=template&id=99ffee4a&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
...
;// ./resources/js/pages/sales/quotations/edit.vue?vue&type=template&id=99ffee4a&scoped=true
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _this.getProducts();
            _this.getTaxes();
            _this.loadCommunicationConfigStatus();
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_99ffee4a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_editvue_type_style_index_0_id_99ffee4a_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_99ffee4a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/edit.vue?vue&type=style&index=0&id=99ffee4a&prod&scoped=true&lang=css
