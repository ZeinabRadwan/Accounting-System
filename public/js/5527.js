...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    savePurchase: function savePurchase() {
      var _this10 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var validationErrors, errorList, formData, _formDataObj$supplier, formDataObj, appendIfDefined, _formDataObj$account, response, _response, errorMessages, _errorList, ErrorHandler, _t2;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
    ...
    getCostCenters: function getCostCenters() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        var _yield$axios$get5, data, _t5;
        ...
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.p = _context11.n) {
            ...
            case 3:
              _context11.p = 3;
              _t6 = _context11.v;
              console.error('Error loading payment methods:', _t6);
              _this15.paymentMethods = [];
              toast.fire({
                type: 'error',
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        ...
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.p = _context12.n) {
            ...
            case 1:
              _yield$axios$get6 = _context12.v;
            ...
            case 3:
              _yield$axios$get7 = _context12.v;
            ...
            case 4:
              ...
              return axios_default().get('/api/branches');
            case 5:
              _yield$axios$get8 = _context12.v;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        ...
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.p = _context14.n) {
            ...
            case 1:
              _yield$axios$get9 = _context14.v;
            ...
            case 10:
              _context14.p = 10;
              _t0 = _context14.v;
              console.error('Error loading purchase order data:', _t0);
              _this19.$store.state.operations.loading = false;
              toast.fire({
                type: "error",
                title: _this19.$t("Failed to load purchase order data"),
                text: ((_error$response = _t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this19.$t("Please try again")
              });
            case 11:
              return _context14.a(2);
          }
        }, _callee13, null, [[2, 6, 7, 8], [0, 10]]);
      }))();
    }
  },
  mounted: function mounted() {
