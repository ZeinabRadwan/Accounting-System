"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3764],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card[data-v-5430675a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-5430675a]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-5430675a]{padding:1.25rem}.card-footer[data-v-5430675a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.refresh-btn[data-v-5430675a]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-5430675a],.export-pdf-btn[data-v-5430675a]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-5430675a],.export-pdf-btn[data-v-5430675a],.print-btn[data-v-5430675a]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-5430675a]{background:#33a0d91a!important;color:#33a0d9!important}.btn-primary[data-v-5430675a]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.pricing-wrap h2[data-v-5430675a]{color:#4c4e51;font-size:15px}.subscribe-plan[data-v-5430675a]{align-items:center;display:flex;justify-content:space-between}.subscribe-plan img[data-v-5430675a]{max-width:100px}.subscribe-plan>div p[data-v-5430675a]{font-size:18px;font-weight:400;margin-bottom:0}.switch-plan[data-v-5430675a]{justify-content:space-between;margin-top:30px}.resume-alert[data-v-5430675a]{background:#dc3545;border-radius:8px;color:#fff;font-size:18px;padding:20px}.resume-subs-block p[data-v-5430675a]{margin-bottom:0;margin-right:9px}.resume-subs-block[data-v-5430675a]{display:flex;justify-content:flex-end;margin-top:11px}.small-text[data-v-5430675a]{font-size:10px}.card-icon.bg-brand-primary[data-v-5430675a]{background:linear-gradient(135deg,#33a0d9,#2a8bc7)!important;border:1px solid rgba(51,160,217,.3);border-radius:20px}.card-icon.bg-brand-light-blue[data-v-5430675a]{background:linear-gradient(135deg,#ebf6fc,#d6edf7)!important;border:1px solid rgba(235,246,252,.5);border-radius:20px;color:#33a0d9!important}.card-icon.bg-brand-light-green[data-v-5430675a]{background:linear-gradient(135deg,#f6fef4,#e8f5e8)!important;border:1px solid rgba(246,254,244,.5);border-radius:20px;color:#33a0d9!important}.card-icon.bg-brand-green[data-v-5430675a]{background:linear-gradient(135deg,#2ab930,#239a26)!important;border:1px solid rgba(42,185,48,.3);border-radius:20px}.card-icon.bg-brand-dark-blue[data-v-5430675a]{background:linear-gradient(135deg,#33a0d9,#152a4a)!important;border:1px solid rgba(27,60,113,.3);border-radius:20px}.card-icon.bg-brand-teal[data-v-5430675a]{background:linear-gradient(135deg,#449eae,#3a8a98)!important;border:1px solid rgba(68,158,174,.3);border-radius:20px}.card-icon.bg-brand-dark-teal[data-v-5430675a]{background:linear-gradient(135deg,#377578,#2d5f61)!important;border:1px solid rgba(55,117,120,.3);border-radius:20px}.card-icon.bg-brand-light-blue i[data-v-5430675a],.card-icon.bg-brand-light-green i[data-v-5430675a]{color:#33a0d9!important}.card-icon.bg-brand-dark-blue i[data-v-5430675a],.card-icon.bg-brand-dark-teal i[data-v-5430675a],.card-icon.bg-brand-green i[data-v-5430675a],.card-icon.bg-brand-primary i[data-v-5430675a],.card-icon.bg-brand-teal i[data-v-5430675a]{color:#fff!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/billing.vue?vue&type=template&id=5430675a&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/billing/Plans.vue?vue&type=template&id=09a94366&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/components/billing/Plans.vue?vue&type=style&index=0&id=09a94366&prod&lang=scss&scoped=true
...
var billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css = __webpack_require__(68668);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/billing.vue?vue&type=style&index=0&id=5430675a&prod&scoped=true&lang=css

            

var billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css_options = {};

billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css_options.insert = "head";
billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css_options.singleton = false;

var billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css/* default */.A, billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css_options);



/* harmony default export */ const settings_billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css = (billingvue_type_style_index_0_id_5430675a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/settings/billing.vue?vue&type=style&index=0&id=5430675a&prod&scoped=true&lang=css
