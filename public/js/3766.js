"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3766],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductFormTemplate.vue?vue&type=template&id=2d2eee46&scoped=true
...
var update = injectStylesIntoStyleTag_default()(ProductFormTemplatevue_type_style_index_0_id_2d2eee46_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_ProductFormTemplatevue_type_style_index_0_id_2d2eee46_prod_scoped_true_lang_css = (ProductFormTemplatevue_type_style_index_0_id_2d2eee46_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/ProductFormTemplate.vue?vue&type=style&index=0&id=2d2eee46&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-card[data-v-2d2eee46]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-bottom:1.25rem;margin-top:20px;transition:all .2s ease}.form-card[data-v-2d2eee46]:hover{box-shadow:0 .1rem .5rem 0 rgba(58,59,69,.15)}.form-card .card-header[data-v-2d2eee46]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:12px 16px}.form-card .card-header .section-title[data-v-2d2eee46]{border:none;color:#fff;font-size:14px;font-weight:600;margin:0;padding:0}.form-card .card-header .section-title[data-v-2d2eee46]:after{display:none}.form-card .card-header .section-title i[data-v-2d2eee46]{color:hsla(0,0%,100%,.8)}.form-card .card-body[data-v-2d2eee46]{padding:16px}.section-title[data-v-2d2eee46]{border-bottom:1px solid #e9ecef;color:#495057;font-weight:600;margin-bottom:15px;padding-bottom:8px}.form-group[data-v-2d2eee46]{margin-bottom:1rem}.form-group label[data-v-2d2eee46]{color:#495057;font-size:.95rem;font-weight:500;margin-bottom:.5rem}.required[data-v-2d2eee46]{color:#dc3545;font-weight:700}.row[data-v-2d2eee46]{margin-bottom:1rem}.row[data-v-2d2eee46]:last-child{margin-bottom:0}.image-preview[data-v-2d2eee46]{text-align:center}.image-preview img[data-v-2d2eee46]{border:1px solid #dee2e6;border-radius:4px;box-shadow:0 1px 3px rgba(0,0,0,.1)}.custom-file-label[data-v-2d2eee46]{background-color:#f8f9fa;border:1px dashed #dee2e6;cursor:pointer;font-size:.85rem;transition:all .2s ease}.custom-file-label[data-v-2d2eee46]:hover{background-color:#e3f2fd;border-color:#007bff}.custom-file-label i[data-v-2d2eee46]{color:#6c757d}.item-type-selector[data-v-2d2eee46]{display:flex;gap:.75rem;margin-top:.5rem}.item-type-option[data-v-2d2eee46]{cursor:pointer;flex:1;position:relative;transition:all .2s ease}.item-type-option input[type=radio][data-v-2d2eee46]{opacity:0;pointer-events:none;position:absolute}.option-content[data-v-2d2eee46]{align-items:center;background:#fff;border:2px solid #e3e6f0;border-radius:8px;display:flex;flex-direction:column;justify-content:center;min-height:70px;padding:1rem .75rem;text-align:center;transition:all .2s ease}.item-type-option:hover .option-content[data-v-2d2eee46]{border-color:#33a0d9;box-shadow:0 2px 6px rgba(51,160,217,.15);transform:translateY(-1px)}.item-type-option.active .option-content[data-v-2d2eee46]{background:#33a0d9;border-color:#33a0d9;box-shadow:0 3px 10px rgba(51,160,217,.25);color:#fff;transform:translateY(-1px)}.option-content i[data-v-2d2eee46]{color:#6c757d;font-size:1.4rem;margin-bottom:.5rem;transition:all .2s ease}.item-type-option.active .option-content i[data-v-2d2eee46]{color:hsla(0,0%,100%,.9)}.option-content span[data-v-2d2eee46]{color:#495057;font-size:.9rem;font-weight:600;transition:all .2s ease}.item-type-option.active .option-content span[data-v-2d2eee46]{color:#fff}.form-check-input[data-v-2d2eee46]{appearance:none;-webkit-appearance:none;-moz-appearance:none;background-color:#fff;border:2px solid #ced4da;border-radius:4px;cursor:pointer;height:18px;margin-right:.75rem;margin-top:.1rem;position:relative;transition:all .2s ease;width:18px}.form-check-input[data-v-2d2eee46]:checked{background-color:#33a0d9;background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3E%3Cpath fill='none' stroke='%23fff' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='m6 10 3 3 6-6'/%3E%3C/svg%3E\");background-position:50%;background-repeat:no-repeat;background-size:12px;border-color:#33a0d9}.form-check-input[data-v-2d2eee46]:focus,.form-check-input[data-v-2d2eee46]:hover{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-check-input[data-v-2d2eee46]:focus{outline:none}.form-check-label[data-v-2d2eee46]{align-items:center;background-color:#f8f9fa;border:1px solid #e9ecef;border-radius:6px;color:#495057;cursor:pointer;display:flex;font-weight:600;margin-bottom:0;padding:.5rem .75rem;transition:all .2s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.form-check-label[data-v-2d2eee46]:hover{background-color:#e3f2fd;border-color:#33a0d9;box-shadow:0 2px 4px rgba(51,160,217,.1);color:#33a0d9;transform:translateY(-1px)}.form-check-label[data-v-2d2eee46]:active{box-shadow:0 1px 2px rgba(51,160,217,.1);transform:translateY(0)}.override-checkbox-container[data-v-2d2eee46]{align-items:center;display:flex}.checkbox-text[data-v-2d2eee46]{color:#495057;font-size:.95rem;font-weight:600;margin-left:.5rem;padding:0 26px}.override-checkbox-container .form-check-label[data-v-2d2eee46]{background:linear-gradient(135deg,#f8f9fa,#fff);border:2px solid #e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.05);min-height:48px;padding:.75rem 1rem}.override-checkbox-container .form-check-label[data-v-2d2eee46]:hover{background:linear-gradient(135deg,#e3f2fd,#f0f8ff);border-color:#33a0d9;box-shadow:0 4px 8px rgba(51,160,217,.15)}.override-checkbox-container .form-check-label[data-v-2d2eee46]:has(.form-check-input:checked){background:linear-gradient(135deg,#e8f5e8,#f0fff0);border-color:#28a745;color:#155724}.override-checkbox-container .form-check-label:has(.form-check-input:checked) .checkbox-text[data-v-2d2eee46]{color:#155724;font-weight:700}.account-label-row[data-v-2d2eee46]{align-items:flex-start;display:flex;flex-direction:column;gap:1rem;justify-content:space-between;margin-bottom:.5rem}.account-label[data-v-2d2eee46]{color:#495057;flex:1;font-size:.95rem;font-weight:500;margin-bottom:0}.toggle-switch-container[data-v-2d2eee46]{align-items:center;display:flex;flex-shrink:0}.toggle-switch-label[data-v-2d2eee46]{align-items:center;cursor:pointer;display:inline-flex;gap:.75rem;-webkit-user-select:none;-moz-user-select:none;user-select:none}.toggle-switch-wrapper[data-v-2d2eee46]{display:inline-block;flex-shrink:0;height:26px;position:relative;width:50px}.toggle-switch-input[data-v-2d2eee46]{appearance:none;-webkit-appearance:none;-moz-appearance:none;background-color:#ced4da;border-radius:26px;cursor:pointer;height:26px;left:0;margin:0;outline:none;padding:0;position:absolute;top:0;transition:background-color .3s ease;width:50px}.toggle-switch-input[data-v-2d2eee46]:checked{background-color:#33a0d9}.toggle-switch-input[data-v-2d2eee46]:focus{box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.toggle-switch-slider[data-v-2d2eee46]{background-color:#fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2);height:20px;left:3px;pointer-events:none;position:absolute;top:50%;transform:translateY(-50%);transition:transform .3s ease;width:20px}.toggle-switch-label[data-v-2d2eee46],.toggle-switch-label .toggle-switch-input[data-v-2d2eee46]{position:relative}.toggle-switch-label .toggle-switch-input:checked+.toggle-switch-slider[data-v-2d2eee46]{transform:translate(24px,-50%)}.toggle-switch-text[data-v-2d2eee46]{color:#495057;font-size:.9rem;font-weight:500;transition:color .2s ease;white-space:nowrap}.toggle-switch-input:checked~.toggle-switch-text[data-v-2d2eee46],.toggle-switch-wrapper:has(.toggle-switch-input:checked)~.toggle-switch-text[data-v-2d2eee46]{color:#33a0d9;font-weight:600}.toggle-switch-label:has(.toggle-switch-input:checked) .toggle-switch-text[data-v-2d2eee46]{color:#33a0d9;font-weight:600}.alert-info[data-v-2d2eee46]{background-color:#d1ecf1;border-color:#bee5eb;border-radius:.375rem;font-size:.9rem;padding:.75rem 1rem}.alert-info[data-v-2d2eee46],.alert-info i[data-v-2d2eee46]{color:#0c5460}@media (max-width:768px){.item-type-selector[data-v-2d2eee46]{flex-direction:column;gap:.5rem}.option-content[data-v-2d2eee46]{min-height:60px;padding:.75rem .5rem}.option-content i[data-v-2d2eee46]{font-size:1.25rem;margin-bottom:.4rem}.option-content span[data-v-2d2eee46]{font-size:.85rem}.override-checkbox-container .form-check-label[data-v-2d2eee46]{min-height:44px;padding:.6rem .8rem}.checkbox-text[data-v-2d2eee46]{font-size:.9rem}.form-check-input[data-v-2d2eee46]{height:16px;width:16px}}", ""]);
// Exports
