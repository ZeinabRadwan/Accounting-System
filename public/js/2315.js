"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2315],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-a29bd946]{border:none!important}.account-statement-table[data-v-a29bd946]{border-collapse:separate;border-spacing:0}.account-statement-table thead th[data-v-a29bd946]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.print-template-btn[data-v-a29bd946]{align-items:center;display:inline-flex}.print-template-label[data-v-a29bd946]{display:inline-block;min-width:140px;text-align:left}.account-statement-table thead tr[data-v-a29bd946]{border:none!important}.account-statement-table thead th[data-v-a29bd946]:first-child{border-top-left-radius:10px}.account-statement-table thead th[data-v-a29bd946]:last-child{border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-a29bd946]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-a29bd946]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-a29bd946]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-a29bd946],.export-pdf-btn[data-v-a29bd946],.preview-btn[data-v-a29bd946]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-a29bd946],.export-pdf-btn[data-v-a29bd946],.preview-btn[data-v-a29bd946],.print-btn[data-v-a29bd946]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-a29bd946]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-a29bd946]{gap:10px}.card[data-v-a29bd946]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-a29bd946]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-a29bd946]{background-color:rgba(0,0,0,.5);height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.info-box[data-v-a29bd946],.overlay[data-v-a29bd946]{align-items:center;display:flex}.info-box[data-v-a29bd946]{background:#fff;border:1px solid #dee2e6;border-radius:.25rem;margin-bottom:1rem;padding:1rem}.info-box-icon[data-v-a29bd946]{align-items:center;border-radius:50%;display:flex;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-a29bd946]{flex:1}.info-box-text[data-v-a29bd946]{color:#6c757d;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-a29bd946]{color:#495057;font-size:1.25rem;font-weight:700}.table th[data-v-a29bd946]{border-top:1px solid #dee2e6}.pagination[data-v-a29bd946]{margin-bottom:0}.dataTables_info[data-v-a29bd946]{color:#6c757d;padding-bottom:.75rem;padding-top:.75rem}.dataTables_paginate[data-v-a29bd946]{text-align:right}.btn-primary[data-v-a29bd946]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.red[data-v-a29bd946]{color:#dc3545}.font-weight-bold[data-v-a29bd946]{font-weight:700}@media (max-width:1300px){.info-box[data-v-a29bd946]{padding:0}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/balance-sheet.vue?vue&type=template&id=a29bd946&scoped=true
...
;// ./resources/js/pages/reports/balance-sheet.vue?vue&type=template&id=a29bd946&scoped=true
...
var update = injectStylesIntoStyleTag_default()(balance_sheetvue_type_style_index_0_id_a29bd946_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_balance_sheetvue_type_style_index_0_id_a29bd946_prod_scoped_true_lang_css = (balance_sheetvue_type_style_index_0_id_a29bd946_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/balance-sheet.vue?vue&type=style&index=0&id=a29bd946&prod&scoped=true&lang=css
