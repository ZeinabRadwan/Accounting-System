...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-card[data-v-35208f05]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-bottom:1.25rem;margin-top:20px;transition:all .2s ease}.form-card[data-v-35208f05]:hover{box-shadow:0 .1rem .5rem 0 rgba(58,59,69,.15)}.form-card .card-header[data-v-35208f05]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:12px 16px}.form-card .card-header .section-title[data-v-35208f05]{border:none;color:#fff;font-size:14px;font-weight:600;margin:0;padding:0}.form-card .card-header .section-title[data-v-35208f05]:after{display:none}.form-card .card-header .section-title i[data-v-35208f05]{color:hsla(0,0%,100%,.8)}.form-card .card-body[data-v-35208f05]{padding:16px}.section-title[data-v-35208f05]{border-bottom:1px solid #e9ecef;color:#495057;font-weight:600;margin-bottom:15px;padding-bottom:8px}.form-group[data-v-35208f05]{margin-bottom:1rem}.form-group label[data-v-35208f05]{color:#495057;font-size:.95rem;font-weight:500;margin-bottom:.5rem}.required[data-v-35208f05]{color:#dc3545;font-weight:700}.row[data-v-35208f05]{margin-bottom:1rem}.row[data-v-35208f05]:last-child{margin-bottom:0}.auto-assign-btn[data-v-35208f05]{min-width:40px;padding:.375rem .5rem;white-space:nowrap}.auto-assign-btn[data-v-35208f05]:disabled{cursor:not-allowed;opacity:.6}.form-text[data-v-35208f05]{color:#6c757d;font-size:.8rem;margin-top:3px}.image-preview[data-v-35208f05]{text-align:center}.image-preview img[data-v-35208f05]{border:1px solid #dee2e6;border-radius:4px;box-shadow:0 1px 3px rgba(0,0,0,.1)}.custom-file-label[data-v-35208f05]{background-color:#f8f9fa;border:1px dashed #dee2e6;cursor:pointer;font-size:.85rem;transition:all .2s ease}.custom-file-label[data-v-35208f05]:hover{background-color:#e3f2fd;border-color:#007bff}.custom-file-label i[data-v-35208f05]{color:#6c757d}.create-button[data-v-35208f05]{cursor:pointer;text-decoration:none}@media (max-width:768px){.section-title[data-v-35208f05]{font-size:.95rem;margin-bottom:12px}.form-card .card-body[data-v-35208f05]{padding:.75rem}.auto-assign-btn[data-v-35208f05]{font-size:.75rem;min-width:35px}}.input-group-prepend .input-group-text[data-v-35208f05]{background-color:#f8f9fa;border-color:#ced4da;color:#495057;font-size:.85rem}.v-select[data-v-35208f05]{margin-bottom:0}.is-invalid[data-v-35208f05]{border-color:#dc3545!important}.invalid-feedback[data-v-35208f05]{color:#dc3545;display:block;font-size:75%;margin-top:.2rem;width:100%}.item-type-selector[data-v-35208f05]{display:flex;gap:.75rem;margin-top:.5rem}.item-type-option[data-v-35208f05]{cursor:pointer;flex:1;position:relative;transition:all .2s ease}.item-type-option input[type=radio][data-v-35208f05]{opacity:0;pointer-events:none;position:absolute}.option-content[data-v-35208f05]{align-items:center;background:#fff;border:2px solid #e3e6f0;border-radius:8px;display:flex;flex-direction:column;justify-content:center;min-height:70px;padding:1rem .75rem;text-align:center;transition:all .2s ease}.item-type-option:hover .option-content[data-v-35208f05]{border-color:#33a0d9;box-shadow:0 2px 6px rgba(51,160,217,.15);transform:translateY(-1px)}.item-type-option.active .option-content[data-v-35208f05]{background:#33a0d9;border-color:#33a0d9;box-shadow:0 3px 10px rgba(51,160,217,.25);color:#fff;transform:translateY(-1px)}.option-content i[data-v-35208f05]{color:#6c757d;font-size:1.4rem;margin-bottom:.5rem;transition:all .2s ease}.item-type-option.active .option-content i[data-v-35208f05]{color:hsla(0,0%,100%,.9)}.option-content span[data-v-35208f05]{color:#495057;font-size:.9rem;font-weight:600;transition:all .2s ease}.item-type-option.active .option-content span[data-v-35208f05]{color:#fff}@media (max-width:768px){.item-type-selector[data-v-35208f05]{flex-direction:column;gap:.5rem}.option-content[data-v-35208f05]{min-height:60px;padding:.75rem .5rem}.option-content i[data-v-35208f05]{font-size:1.25rem;margin-bottom:.4rem}.option-content span[data-v-35208f05]{font-size:.85rem}.override-checkbox-container .form-check-label[data-v-35208f05]{min-height:44px;padding:.6rem .8rem}.checkbox-text[data-v-35208f05]{font-size:.9rem}.form-check-input[data-v-35208f05]{height:16px;width:16px}}.account-label-row[data-v-35208f05]{align-items:flex-start;display:flex;flex-direction:column;gap:1rem;justify-content:space-between;margin-bottom:.5rem}.account-label[data-v-35208f05]{color:#495057;flex:1;font-size:.95rem;font-weight:500;margin-bottom:0}.toggle-switch-container[data-v-35208f05]{align-items:center;display:flex;flex-shrink:0}.toggle-switch-label[data-v-35208f05]{align-items:center;cursor:pointer;display:inline-flex;gap:.75rem;-webkit-user-select:none;-moz-user-select:none;user-select:none}.toggle-switch-wrapper[data-v-35208f05]{display:inline-block;flex-shrink:0;height:26px;position:relative;width:50px}.toggle-switch-input[data-v-35208f05]{appearance:none;-webkit-appearance:none;-moz-appearance:none;background-color:#ced4da;border-radius:26px;cursor:pointer;height:26px;left:0;margin:0;outline:none;padding:0;position:absolute;top:0;transition:background-color .3s ease;width:50px}.toggle-switch-input[data-v-35208f05]:checked{background-color:#33a0d9}.toggle-switch-input[data-v-35208f05]:focus{box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.toggle-switch-slider[data-v-35208f05]{background-color:#fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2);height:20px;left:3px;pointer-events:none;position:absolute;top:50%;transform:translateY(-50%);transition:transform .3s ease;width:20px}.toggle-switch-input:checked+.toggle-switch-slider[data-v-35208f05]{transform:translate(24px,-50%)}.toggle-switch-text[data-v-35208f05]{color:#495057;font-size:.9rem;font-weight:500;transition:color .2s ease;white-space:nowrap}.toggle-switch-label:has(.toggle-switch-input:checked) .toggle-switch-text[data-v-35208f05]{color:#33a0d9;font-weight:600}.alert-info[data-v-35208f05]{background-color:#d1ecf1;border-color:#bee5eb;border-radius:.375rem;font-size:.9rem;padding:.75rem 1rem}.alert-info[data-v-35208f05],.alert-info i[data-v-35208f05]{color:#0c5460}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductCreateModal.vue?vue&type=template&id=35208f05&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('VModal', {
...
var update = injectStylesIntoStyleTag_default()(ProductCreateModalvue_type_style_index_0_id_35208f05_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_ProductCreateModalvue_type_style_index_0_id_35208f05_prod_scoped_true_lang_css = (ProductCreateModalvue_type_style_index_0_id_35208f05_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/ProductCreateModal.vue?vue&type=style&index=0&id=35208f05&prod&scoped=true&lang=css
...
var ProductCreateModal = __webpack_require__(62837);
