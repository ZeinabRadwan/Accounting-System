...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductCreateModal.vue?vue&type=template&id=868b4adc&scoped=true
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CategorySubcategoryCreateModal.vue?vue&type=template&id=4e083048&scoped=true
...
;// ./resources/js/components/CategorySubcategoryCreateModal.vue?vue&type=style&index=0&id=4e083048&prod&scoped=true&lang=css
...
/* harmony default export */ const ProductCreateModalvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    saveProduct: function saveProduct() {
      var _this13 = this;
      return ProductCreateModalvue_type_script_lang_js_asyncToGenerator(/*#__PURE__*/ProductCreateModalvue_type_script_lang_js_regenerator().m(function _callee1() {
        ...
        return ProductCreateModalvue_type_script_lang_js_regenerator().w(function (_context1) {
          while (1) switch (_context1.n) {
            ...
            case 3:
              ...
              console.log("=============================");
              _context1.n = 4;
              return _this13.form.post(window.location.origin + "/api/products").then(function (response) {
                ProductCreateModalvue_type_script_lang_js_toast.fire({
                  type: "success",
                ...
                var autoAssignedSalesAccountId = _this13.isSalesAccountAutomatic ? _this13.form.salesAccountId : null;
                var autoAssignedPurchaseAccountId = _this13.isPurchaseAccountAutomatic ? _this13.form.purchaseAccountId : null;
                _this13.form.reset();
      ...
      return ProductCreateModalvue_type_script_lang_js_asyncToGenerator(/*#__PURE__*/ProductCreateModalvue_type_script_lang_js_regenerator().m(function _callee10() {
        ...
        return ProductCreateModalvue_type_script_lang_js_regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            case 0:
              if (!_this14.isAutoAssigningSales) {
                _context10.n = 1;
                break;
              }
              return _context10.a(2);
            case 1:
              _this14.isAutoAssigningSales = true;
              try {
                ...
                if (defaultAccount) {
                  _this14.form.salesAccountId = defaultAccount.id;
                  ProductCreateModalvue_type_script_lang_js_toast.fire({
                    type: "success",
                    title: _this14.$t("Sales Account auto-assigned successfully")
                  });
                } else {
                  ProductCreateModalvue_type_script_lang_js_toast.fire({
                    type: "error",
                    title: _this14.$t("No suitable Sales Account found for automatic assignment")
                  });
                }
              } catch (error) {
                ...
                ProductCreateModalvue_type_script_lang_js_toast.fire({
                  type: "error",
                  title: _this14.$t("Failed to auto-assign Sales Account")
                });
              } finally {
                _this14.isAutoAssigningSales = false;
              }
            case 2:
              return _context10.a(2);
          }
      ...
      return ProductCreateModalvue_type_script_lang_js_asyncToGenerator(/*#__PURE__*/ProductCreateModalvue_type_script_lang_js_regenerator().m(function _callee11() {
        ...
        return ProductCreateModalvue_type_script_lang_js_regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            case 0:
              if (!_this15.isAutoAssigningPurchase) {
                _context11.n = 1;
                break;
              }
              return _context11.a(2);
            case 1:
              _this15.isAutoAssigningPurchase = true;
              try {
                // For new products, we need to simulate the auto-assignment logic
                // since the product doesn't exist in the database yet
                defaultAccount = null;
                ...
                if (defaultAccount) {
                  _this15.form.purchaseAccountId = defaultAccount.id;
                  ProductCreateModalvue_type_script_lang_js_toast.fire({
                    type: "success",
                    title: _this15.$t("Purchase Account auto-assigned successfully")
                  });
                } else {
                  ProductCreateModalvue_type_script_lang_js_toast.fire({
                    type: "error",
                    title: _this15.$t("No suitable Purchase Account found for automatic assignment")
                  });
                }
              } catch (error) {
                ...
                ProductCreateModalvue_type_script_lang_js_toast.fire({
                  type: "error",
                  title: _this15.$t("Failed to auto-assign Purchase Account")
                });
              } finally {
                _this15.isAutoAssigningPurchase = false;
              }
            case 2:
              return _context11.a(2);
          }
...
;// ./resources/js/components/ProductCreateModal.vue?vue&type=style&index=0&id=868b4adc&prod&scoped=true&lang=css
