"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[31],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/edit.vue?vue&type=template&id=61a9ab50&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_61a9ab50_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_editvue_type_style_index_0_id_61a9ab50_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_61a9ab50_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/edit.vue?vue&type=style&index=0&id=61a9ab50&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-61a9ab50]{gap:10px}.header-buttons[data-v-61a9ab50]{margin-bottom:15px}.footer-buttons[data-v-61a9ab50]{display:flex;gap:10px}.footer-buttons .btn[data-v-61a9ab50]{margin-right:10px}.footer-buttons .btn[data-v-61a9ab50]:last-child{margin-right:0}.card[data-v-61a9ab50]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-61a9ab50]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-61a9ab50]{background:#fff!important}.btn-primary[data-v-61a9ab50]{background:#2ab930!important}.btn-primary[data-v-61a9ab50],.btn-secondary[data-v-61a9ab50]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-61a9ab50]{background:#33a0d9!important}.btn-secondary[data-v-61a9ab50]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
