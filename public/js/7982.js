...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-33a4fd0e]{margin-bottom:15px}.footer-buttons[data-v-33a4fd0e]{display:flex;gap:10px}.footer-buttons .btn[data-v-33a4fd0e]{margin-right:10px}.footer-buttons .btn[data-v-33a4fd0e]:last-child{margin-right:0}.table-custom[data-v-33a4fd0e]{border:none!important}.quotations-create-table[data-v-33a4fd0e]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-33a4fd0e]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-33a4fd0e]{border:none!important}.quotations-create-table thead th[data-v-33a4fd0e]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-33a4fd0e]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-33a4fd0e]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-33a4fd0e]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-33a4fd0e]{gap:10px}.card[data-v-33a4fd0e]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-33a4fd0e]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-33a4fd0e]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-33a4fd0e]{background:#fff!important}.btn-primary[data-v-33a4fd0e]{background:#2ab930!important}.btn-secondary[data-v-33a4fd0e]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.quantity-field[data-v-33a4fd0e]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-33a4fd0e]{font-size:.875rem}.account-status .account-warning[data-v-33a4fd0e]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-33a4fd0e]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/form.vue?vue&type=template&id=33a4fd0e&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/form.vue?vue&type=template&id=33a4fd0e&scoped=true
...
var update = injectStylesIntoStyleTag_default()(formvue_type_style_index_0_id_33a4fd0e_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_formvue_type_style_index_0_id_33a4fd0e_prod_scoped_true_lang_css = (formvue_type_style_index_0_id_33a4fd0e_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/form.vue?vue&type=style&index=0&id=33a4fd0e&prod&scoped=true&lang=css
