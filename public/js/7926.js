"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5307,7926],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cost-centers/create.vue?vue&type=template&id=f4a700ae
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    ...
    attrs: {
      ...
      "type": "text",
      "name": "name",
      "placeholder": _vm.$t('Enter cost center name in Arabic'),
      "required": ""
    },
    domProps: {
      "value": _vm.form.name
          ...
          while (1) switch (_context.n) {
            case 0:
              ...
              return _this.form.post('/api/cost-centers').then(function (_ref) {
                var data = _ref.data;
                var message = _this.$t('Cost center created successfully');
                if (_this.$toastr && _this.$toastr.s) {
                  _this.$toastr.s(message);
                } else if (window.toastr && window.toastr.s) {
                  window.toastr.s(message);
                } else if (_this.$toast && _this.$toast.success) {
                ...
                var message = _this.$t('Failed to create cost center');
                if (_this.$toastr && _this.$toastr.e) {
                  _this.$toastr.e(message);
                } else if (window.toastr && window.toastr.e) {
                  window.toastr.e(message);
                } else if (_this.$toast && _this.$toast.error) {
