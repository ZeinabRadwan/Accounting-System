(self["webpackChunk"] = self["webpackChunk"] || []).push([[3623],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom .table td[data-v-5d3b8654]{vertical-align:middle}.profile-area[data-v-5d3b8654]{align-items:center;display:flex}.profile-area img[data-v-5d3b8654]{border-radius:100%;height:50px;width:50px}.profile-area a[data-v-5d3b8654]{display:block}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=template&id=5d3b8654&scoped=true
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              ...
              sweetalert2_all_default().fire({
                title: _this8.$t("Delete Tenant"),
                text: _this8.$t("Are you sure you want to delete this tenant?"),
                type: "warning",
                showCancelButton: true,
                confirmButtonText: _this8.$t("Yes, delete it!")
                ...
                if (result.value) {
                  ...
                  _this8.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      sweetalert2_all_default().fire(_this8.$t("Deleted"), _this8.$t("Tenant deleted successfully"), "success");
                      _this8.getData();
                    } else {
                      console.error('Delete failed with response:', response);
                      sweetalert2_all_default().fire(_this8.$t("Failed"), _this8.$t("Delete failed"), "warning");
                    }
                  })["catch"](function (error) {
            ...
            case 0:
              axios_default().post(window.location.origin + "/api/tenants/" + id + "/ban").then(function (response) {
                if (response.data.success === true) {
                  sweetalert2_all_default().fire(_this9.$t(response.data.message), _this9.$t(response.data.message + "_success"), "success");
                  _this9.getData();
                } else {
                  sweetalert2_all_default().fire(_this9.$t("Failed"), _this9.$t("Ban failed"), "warning");
                }
              });
            case 1:
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=5d3b8654&prod&scoped=true&lang=css
var tenantsvue_type_style_index_0_id_5d3b8654_prod_scoped_true_lang_css = __webpack_require__(75049);
...
var update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_0_id_5d3b8654_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const central_tenantsvue_type_style_index_0_id_5d3b8654_prod_scoped_true_lang_css = (tenantsvue_type_style_index_0_id_5d3b8654_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=5d3b8654&prod&scoped=true&lang=css
