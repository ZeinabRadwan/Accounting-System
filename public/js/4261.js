...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/increments/index.vue?vue&type=template&id=8d194444&scoped=true
...
var incrementsvue_type_style_index_0_id_8d194444_prod_scoped_true_lang_css = __webpack_require__(43569);
...
var update = injectStylesIntoStyleTag_default()(incrementsvue_type_style_index_0_id_8d194444_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const employees_incrementsvue_type_style_index_0_id_8d194444_prod_scoped_true_lang_css = (incrementsvue_type_style_index_0_id_8d194444_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/employees/increments/index.vue?vue&type=style&index=0&id=8d194444&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-8d194444]{border:none!important;overflow:visible!important}.increments-table[data-v-8d194444]{border-collapse:separate;border-spacing:0}.increments-table thead th[data-v-8d194444]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.increments-table thead tr[data-v-8d194444]{border:none!important}.increments-table thead th[data-v-8d194444]:first-child{border-top-left-radius:10px}.increments-table thead th[data-v-8d194444]:last-child{border-top-right-radius:10px}[dir=rtl] .increments-table thead th[data-v-8d194444]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .increments-table thead th[data-v-8d194444]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-8d194444]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-8d194444],.export-pdf-btn[data-v-8d194444]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-8d194444],.export-pdf-btn[data-v-8d194444],.print-btn[data-v-8d194444]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-8d194444]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-8d194444]{display:inline-block;position:relative}.action-icon-btn[data-v-8d194444]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-8d194444]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-8d194444]{animation:slideInDown-8d194444 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-8d194444]{left:45px!important;right:auto!important}.action-menu-header[data-v-8d194444]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-8d194444]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-8d194444]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-8d194444]:hover{background-color:#e5e7eb}.action-menu ul[data-v-8d194444]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-8d194444]{margin:0}.action-menu li a[data-v-8d194444]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-8d194444]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-8d194444]{flex-shrink:0;height:16px;width:16px}@keyframes slideInDown-8d194444{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.btn-group.c-w-100[data-v-8d194444]{gap:10px}.card[data-v-8d194444]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-8d194444]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.increments-table .badge.bg-success[data-v-8d194444]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.increments-table .badge.bg-danger[data-v-8d194444]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-8d194444]{background:#fff!important}.btn-primary[data-v-8d194444]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-8d194444]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-8d194444]{align-items:center;color:#6c757d;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
