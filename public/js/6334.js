"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6334],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-1c0b68be]{margin-bottom:15px}.footer-buttons[data-v-1c0b68be]{display:flex;gap:10px}.footer-buttons .btn[data-v-1c0b68be]{margin-right:10px}.footer-buttons .btn[data-v-1c0b68be]:last-child{margin-right:0}.create-btn[data-v-1c0b68be]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-1c0b68be]:hover{background-color:#e9ecef}.edit-btn[data-v-1c0b68be]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-1c0b68be]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-1c0b68be]{border:none!important}.quotations-create-table[data-v-1c0b68be]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-1c0b68be]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-1c0b68be]{border:none!important}.quotations-create-table thead th[data-v-1c0b68be]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-1c0b68be]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-1c0b68be]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-1c0b68be]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-1c0b68be]{gap:10px}.card[data-v-1c0b68be]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-1c0b68be]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-1c0b68be]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-1c0b68be]{background:#fff!important}.btn-primary[data-v-1c0b68be]{background:#2ab930!important}.btn-secondary[data-v-1c0b68be]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-1c0b68be]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-1c0b68be],.button-plus[data-v-1c0b68be]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-1c0b68be]{background-color:#dc3545;color:#fff}.button-plus[data-v-1c0b68be]{background-color:#007bff;color:#fff}.button-minus[data-v-1c0b68be]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-1c0b68be]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-1c0b68be]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-1c0b68be]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-1c0b68be]{direction:rtl}[dir=rtl] .create-btn[data-v-1c0b68be]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-1c0b68be]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-1c0b68be]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-1c0b68be]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-1c0b68be]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-1c0b68be]{border-right:1px solid #ced4da}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=1c0b68be&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=1c0b68be&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_1c0b68be_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_createvue_type_style_index_0_id_1c0b68be_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_1c0b68be_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=style&index=0&id=1c0b68be&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ClientEditModal.vue?vue&type=template&id=527b419e&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('VModal', {
...
;// ./resources/js/components/ClientEditModal.vue?vue&type=style&index=0&id=527b419e&prod&scoped=true&lang=css
