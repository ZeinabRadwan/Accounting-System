"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6694,8651],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ClientCreateModal.vue?vue&type=template&id=56f6a1e0&scoped=true
...
var update = injectStylesIntoStyleTag_default()(ClientCreateModalvue_type_style_index_0_id_56f6a1e0_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_ClientCreateModalvue_type_style_index_0_id_56f6a1e0_prod_scoped_true_lang_css = (ClientCreateModalvue_type_style_index_0_id_56f6a1e0_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/ClientCreateModal.vue?vue&type=style&index=0&id=56f6a1e0&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-5061c40b]{margin-bottom:15px}.footer-buttons[data-v-5061c40b]{display:flex;gap:10px}.footer-buttons .btn[data-v-5061c40b]{margin-right:10px}.footer-buttons .btn[data-v-5061c40b]:last-child{margin-right:0}.create-btn[data-v-5061c40b]{padding:11px}.chart-account-success[data-v-5061c40b],.chart-account-warning[data-v-5061c40b]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-5061c40b]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-5061c40b]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-5061c40b],.warning-content[data-v-5061c40b]{align-items:center;display:flex;gap:16px}.success-icon[data-v-5061c40b],.warning-icon[data-v-5061c40b]{flex-shrink:0;font-size:24px}.warning-icon[data-v-5061c40b]{color:#856404}.success-icon[data-v-5061c40b]{color:#155724}.success-text[data-v-5061c40b],.warning-text[data-v-5061c40b]{flex-grow:1}.success-title[data-v-5061c40b],.warning-title[data-v-5061c40b]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-5061c40b]{color:#856404}.success-title[data-v-5061c40b]{color:#155724}.success-description[data-v-5061c40b],.warning-description[data-v-5061c40b]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-5061c40b]{color:#856404}.success-description[data-v-5061c40b]{color:#155724}.warning-action[data-v-5061c40b]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-5061c40b]{padding:0}.btn-primary[data-v-5061c40b]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-5061c40b]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-5061c40b],.warning-content[data-v-5061c40b]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-5061c40b],.warning-action[data-v-5061c40b]{width:100%}}.client-status[data-v-5061c40b]{font-size:13px}.client-success[data-v-5061c40b],.client-warning[data-v-5061c40b]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-5061c40b]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-5061c40b]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-5061c40b]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.debug-panel[data-v-5061c40b]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-5061c40b]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-5061c40b]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-5061c40b]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-5061c40b]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-5061c40b]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-5061c40b]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-5061c40b]:last-child{border-bottom:none}.debug-display[data-v-5061c40b]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-5061c40b]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-5061c40b]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-5061c40b]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-5061c40b]:last-child{border-bottom:none}.debug-panel .table th[data-v-5061c40b]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-5061c40b]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-5061c40b]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-5061c40b]{padding:15px}.debug-item .row[data-v-5061c40b]{margin:0}.debug-item .col-md-6[data-v-5061c40b]{padding:0 5px}.debug-step[data-v-5061c40b]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-5061c40b]{font-size:.75em}}.btn-outline-warning[data-v-5061c40b]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-5061c40b]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-5061c40b]{font-size:13px}.product-success[data-v-5061c40b],.product-warning[data-v-5061c40b]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-5061c40b]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-5061c40b]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-5061c40b]{font-size:13px}.account-success[data-v-5061c40b],.account-warning[data-v-5061c40b]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-5061c40b]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-5061c40b]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-5061c40b]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-5061c40b]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-5061c40b]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-5061c40b]{cursor:pointer;margin-bottom:0}.text-warning[data-v-5061c40b]{color:#856404!important}.text-warning small[data-v-5061c40b]{font-size:12px;font-weight:500}.text-warning i[data-v-5061c40b]{margin-right:4px}.table-custom[data-v-5061c40b]{border:none!important}.invoices-create-table[data-v-5061c40b]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-5061c40b]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-5061c40b]{border:none!important}.invoices-create-table thead th[data-v-5061c40b]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-5061c40b]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-5061c40b]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-5061c40b]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.summary-footer-wrapper[data-v-5061c40b]{margin-top:10px}.summary-card-horizontal[data-v-5061c40b]{padding:12px 15px}.summary-row-horizontal[data-v-5061c40b]{align-items:center;display:flex;flex-wrap:wrap;gap:8px;justify-content:space-between}.summary-item[data-v-5061c40b]{align-items:center;display:flex;flex:1;flex-direction:column;min-width:100px;padding:0 12px}.summary-item-label[data-v-5061c40b]{color:#6b7280;font-size:11px;font-weight:500;letter-spacing:.5px;margin-bottom:4px;text-transform:uppercase}.summary-item-value[data-v-5061c40b]{color:#111827;font-size:14px;font-weight:600;text-align:center}.summary-item-discount .summary-item-value[data-v-5061c40b]{color:#dc2626}.summary-item-total[data-v-5061c40b]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-radius:6px;margin:0 -5px;padding:8px 15px}.summary-item-total .summary-item-label[data-v-5061c40b]{color:#1e40af;font-size:12px;font-weight:600}.summary-item-total .summary-item-value[data-v-5061c40b]{color:#33a0d9;font-size:16px;font-weight:700}.summary-divider[data-v-5061c40b]{background-color:#e5e7eb;flex-shrink:0;height:40px;width:1px}.summary-divider-bold[data-v-5061c40b]{background-color:#33a0d9;height:50px;width:2px}[dir=rtl] .summary-item[data-v-5061c40b]{direction:rtl}@media (max-width:992px){.summary-row-horizontal[data-v-5061c40b]{flex-wrap:wrap;justify-content:center}.summary-item[data-v-5061c40b]{min-width:80px;padding:0 8px}.summary-divider[data-v-5061c40b]{display:none}}@media (max-width:768px){.summary-card-horizontal[data-v-5061c40b]{padding:10px 12px}.summary-item[data-v-5061c40b]{min-width:70px;padding:0 6px}.summary-item-label[data-v-5061c40b]{font-size:10px}.summary-item-value[data-v-5061c40b]{font-size:13px}.summary-item-total[data-v-5061c40b]{margin:8px 0 0;padding:10px;width:100%}.summary-item-total .summary-item-value[data-v-5061c40b]{font-size:18px}}@media (max-width:576px){.summary-card-horizontal[data-v-5061c40b]{border-radius:6px}.summary-item[data-v-5061c40b]{min-width:60px;padding:0 4px}.summary-item-label[data-v-5061c40b]{font-size:9px}.summary-item-value[data-v-5061c40b]{font-size:12px}}.summary-footer-row[data-v-5061c40b]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-5061c40b]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-5061c40b]{color:#495057;padding:12px 16px}.summary-value[data-v-5061c40b]{color:#212529;padding:12px 16px;text-align:left}.grand-total-row[data-v-5061c40b]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-5061c40b]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-5061c40b]{text-align:left}[dir=rtl] .summary-value[data-v-5061c40b]{text-align:right}@media (max-width:768px){.summary-label[data-v-5061c40b],.summary-value[data-v-5061c40b]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-5061c40b]{font-size:14px}}.btn-group.c-w-100[data-v-5061c40b]{gap:10px}.card[data-v-5061c40b]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-5061c40b]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-5061c40b]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-5061c40b]{background:#fff!important}.quantity-field[data-v-5061c40b]{border-radius:0!important;margin:0!important;min-height:50px!important;text-align:center}.btn-primary[data-v-5061c40b]{background:#2ab930!important}.btn-secondary[data-v-5061c40b]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-5061c40b]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-5061c40b]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-5061c40b]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-5061c40b]{flex-grow:1}.stock-warning-title[data-v-5061c40b]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-5061c40b]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-5061c40b]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-5061c40b]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-5061c40b]:last-child{margin-bottom:0}.product-name[data-v-5061c40b]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-5061c40b]{color:#856404;opacity:.8}.stock-details strong[data-v-5061c40b]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-5061c40b]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-5061c40b]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-5061c40b]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-5061c40b]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-5061c40b]{align-self:center}.stock-warning-list[data-v-5061c40b]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-5061c40b]{text-align:right}}.clickable-badge[data-v-5061c40b]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-5061c40b]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-5061c40b]:active{transform:scale(.95)}.insufficient-stock-input[data-v-5061c40b]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important;margin:0 5px}.insufficient-stock-input[data-v-5061c40b]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.custom-qty-input[data-v-5061c40b]{align-items:center;display:flex;justify-content:center}.custom-qty-input input.button-minus[data-v-5061c40b],.custom-qty-input input.button-plus[data-v-5061c40b]{margin:0 5px}.fixed-qty-column[data-v-5061c40b]{text-align:center}.product-option[data-v-5061c40b]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-5061c40b]:last-child{border-bottom:none}.product-option-header[data-v-5061c40b]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-5061c40b]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-5061c40b]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-5061c40b]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-5061c40b]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-5061c40b]{color:#33a0d9;font-size:11px}.badge-sm[data-v-5061c40b]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-5061c40b]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-5061c40b]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-5061c40b]{background-color:#e3f2fd}.summary-card[data-v-5061c40b]{background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.05);overflow:hidden}.summary-header[data-v-5061c40b]{background:linear-gradient(135deg,#33a0d9,#2a8bc7);border-bottom:2px solid #2a8bc7;padding:16px 20px}.summary-title[data-v-5061c40b]{align-items:center;color:#fff;display:flex;font-size:16px;font-weight:600;margin:0}.summary-title i[data-v-5061c40b]{font-size:18px}.summary-body[data-v-5061c40b]{padding:16px 20px}.summary-row[data-v-5061c40b]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;justify-content:space-between;padding:12px 0;transition:background-color .2s ease}.summary-row[data-v-5061c40b]:last-child{border-bottom:none}.summary-row[data-v-5061c40b]:hover{background-color:#f9fafb;border-radius:4px;margin:0 -20px;padding-left:20px;padding-right:20px}.summary-row-net[data-v-5061c40b]{font-weight:500}.summary-row-discount[data-v-5061c40b]{background-color:#fef2f2}.summary-row-discount[data-v-5061c40b]:hover{background-color:#fee2e2}.summary-row-total[data-v-5061c40b]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-bottom:none;border-radius:8px;font-size:18px;margin-top:12px;padding:16px 20px}.summary-row-total[data-v-5061c40b]:hover{background:linear-gradient(135deg,#e0f2fe,#dbeafe);margin:12px -20px 0;padding:16px 20px}.summary-label[data-v-5061c40b]{align-items:center;color:#374151;display:flex;flex:1;font-size:14px;font-weight:500}.summary-label i[data-v-5061c40b]{color:#6b7280;font-size:14px;text-align:center;width:20px}.summary-value[data-v-5061c40b]{color:#111827;font-size:14px;font-weight:600;min-width:120px;text-align:right}.summary-total[data-v-5061c40b]{color:#33a0d9;font-size:20px;font-weight:700}[dir=rtl] .summary-label i[data-v-5061c40b]{margin-left:8px;margin-right:0}[dir=rtl] .summary-value[data-v-5061c40b]{text-align:left}@media (max-width:768px){.summary-header[data-v-5061c40b]{padding:12px 16px}.summary-title[data-v-5061c40b]{font-size:14px}.summary-body[data-v-5061c40b]{padding:12px 16px}.summary-row[data-v-5061c40b]{flex-wrap:wrap;padding:10px 0}.summary-row[data-v-5061c40b]:hover{margin:0 -16px;padding-left:16px;padding-right:16px}.summary-label[data-v-5061c40b]{font-size:13px;margin-bottom:4px;width:100%}.summary-value[data-v-5061c40b]{font-size:13px;min-width:auto;text-align:left;width:100%}.summary-row-total[data-v-5061c40b]{font-size:16px;padding:12px 16px}.summary-row-total[data-v-5061c40b]:hover{margin:12px -16px 0;padding:12px 16px}.summary-total[data-v-5061c40b]{font-size:18px}[dir=rtl] .summary-value[data-v-5061c40b]{text-align:right}}@media (max-width:576px){.summary-card[data-v-5061c40b]{border-radius:8px}.summary-body[data-v-5061c40b],.summary-header[data-v-5061c40b],.summary-row-total[data-v-5061c40b]{padding:10px 12px}.summary-row-total[data-v-5061c40b]:hover{margin:12px -12px 0;padding:10px 12px}}.transport-taxability-card[data-v-5061c40b]{background:#fff;border:2px solid #e5e7eb;border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.05);margin-top:1rem;padding:16px;transition:all .3s ease}.transport-taxability-card[data-v-5061c40b]:hover{border-color:#33a0d9;box-shadow:0 4px 8px rgba(51,160,217,.1)}.transport-taxability-header[data-v-5061c40b]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;margin-bottom:12px;padding-bottom:10px}.transport-taxability-header i[data-v-5061c40b]{font-size:20px;margin-right:8px}.transport-taxability-title[data-v-5061c40b]{color:#374151;font-size:14px;font-weight:600}.transport-taxability-body[data-v-5061c40b]{padding-top:8px}.custom-checkbox-wrapper[data-v-5061c40b]{margin-bottom:12px;position:relative}.custom-checkbox-input[data-v-5061c40b]{cursor:pointer;height:0;opacity:0;position:absolute;width:0}.custom-checkbox-label[data-v-5061c40b]{align-items:center;cursor:pointer;display:flex;padding:8px 0;transition:all .2s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.custom-checkbox-label[data-v-5061c40b]:hover{color:#33a0d9}.checkbox-indicator[data-v-5061c40b]{background-color:#fff;border:2px solid #d1d5db;border-radius:6px;display:inline-block;flex-shrink:0;height:24px;margin-right:12px;position:relative;transition:all .2s ease;width:24px}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-5061c40b]{background-color:#33a0d9;border-color:#33a0d9}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-5061c40b]:after{border:solid #fff;border-width:0 2px 2px 0;content:\"\";height:12px;left:7px;position:absolute;top:3px;transform:rotate(45deg);width:6px}.custom-checkbox-input:focus~.custom-checkbox-label .checkbox-indicator[data-v-5061c40b]{box-shadow:0 0 0 3px rgba(51,160,217,.1)}.checkbox-text[data-v-5061c40b]{color:#374151;font-size:14px;font-weight:500;line-height:1.5}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-text[data-v-5061c40b]{color:#33a0d9;font-weight:600}.transport-taxability-description[data-v-5061c40b]{align-items:flex-start;border-radius:6px;display:flex;font-size:13px;line-height:1.5;margin-top:8px;padding:10px 12px;transition:all .2s ease}.transport-taxability-description i[data-v-5061c40b]{flex-shrink:0;margin-top:2px}.description-taxable[data-v-5061c40b]{background-color:#ecfdf5;border:1px solid #a7f3d0;color:#065f46}.description-taxable i[data-v-5061c40b]{color:#10b981}.description-non-taxable[data-v-5061c40b]{background-color:#fef3c7;border:1px solid #fde68a;color:#92400e}.description-non-taxable i[data-v-5061c40b]{color:#f59e0b}[dir=rtl] .transport-taxability-header i[data-v-5061c40b]{margin-left:8px;margin-right:0}[dir=rtl] .checkbox-indicator[data-v-5061c40b]{margin-left:12px;margin-right:0}[dir=rtl] .transport-taxability-description i[data-v-5061c40b]{margin-left:8px;margin-right:0}@media (max-width:768px){.transport-taxability-card[data-v-5061c40b]{margin-top:.5rem;padding:12px}.transport-taxability-header[data-v-5061c40b]{margin-bottom:10px;padding-bottom:8px}.transport-taxability-title[data-v-5061c40b]{font-size:13px}.checkbox-indicator[data-v-5061c40b]{height:22px;width:22px}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-5061c40b]:after{height:10px;left:6px;top:2px;width:5px}.checkbox-text[data-v-5061c40b]{font-size:13px}.transport-taxability-description[data-v-5061c40b]{font-size:12px;padding:8px 10px}}.readonly-field[data-v-5061c40b]{color:#6c757d!important;cursor:not-allowed!important;font-weight:500}.readonly-field[data-v-5061c40b],.readonly-field[data-v-5061c40b]:focus{background-color:#f8f9fa!important;border-color:#dee2e6!important}.readonly-field[data-v-5061c40b]:focus{box-shadow:none!important;outline:none!important}#total_amount[data-v-5061c40b]{max-width:200px}@media (max-width:768px){#total_amount[data-v-5061c40b]{max-width:100%}}.form-group.col-md-4[data-v-5061c40b]{margin-bottom:1rem}@media (min-width:768px){.form-group.col-md-4[data-v-5061c40b]{margin-bottom:0}.form-group.col-md-4[data-v-5061c40b]:first-child{padding-right:15px}.form-group.col-md-4[data-v-5061c40b]:nth-child(2){padding-left:7.5px;padding-right:7.5px}.form-group.col-md-4[data-v-5061c40b]:last-child{padding-left:15px}}@media (max-width:991px){.form-group.col-md-4[data-v-5061c40b]{margin-bottom:1rem}.form-group.col-md-4[data-v-5061c40b]:first-child,.form-group.col-md-4[data-v-5061c40b]:last-child,.form-group.col-md-4[data-v-5061c40b]:nth-child(2){padding-left:15px;padding-right:15px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".create-button[data-v-56f6a1e0]{cursor:pointer;text-decoration:none}.modal-content[data-v-56f6a1e0]{margin:1.75rem auto;max-width:1000px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=5061c40b&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
    ...
    attrs: {
      ...
      "invoice-id": _vm.createdInvoiceData.id,
      "invoice-no": _vm.createdInvoiceData.invoiceNo,
      "invoice-prefix": _vm.prefix,
      "invoice-total": _vm.createdInvoiceData.subTotal || _vm.createdInvoiceData.netTotal || _vm.form.netTotal,
      "due-amount": _vm.createdInvoiceData.subTotal || _vm.createdInvoiceData.netTotal || _vm.form.netTotal,
      "invoice-status": _vm.createdInvoiceData.status || 1
    },
    on: {
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=5061c40b&scoped=true
...
var ClientCreateModal = __webpack_require__(4832);
  ...
  methods: {
    ...
    getClients: function getClients() {
      var _arguments = arguments,
        _this5 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var selectedClient, currentItems, areClients, finalItems, walkingCustomerExists, retryCount, maxRetries, defaultClientSlug, defaultClient, walkingCustomer, _error$response, _error$response2, _error$config, _error$response3, _error$response4, _error$response5;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 48:
              ...
              console.error('[Invoice] ❌ Error getting clients:', _context2.t0);
              console.error('[Invoice] Error details:', {
                ...
                status: (_error$response2 = _context2.t0.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status,
                url: (_error$config = _context2.t0.config) === null || _error$config === void 0 ? void 0 : _error$config.url
              });
              ...
              } else if (((_error$response4 = _context2.t0.response) === null || _error$response4 === void 0 ? void 0 : _error$response4.status) === 403) {
                toast.fire({
                  type: "error",
    ...
    getProducts: function getProducts() {
      var _this6 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _yield$axios$get, data, _error$response6, _error$response7, _error$response8;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
            ...
            case 10:
              ...
              if (((_error$response6 = _context3.t0.response) === null || _error$response6 === void 0 ? void 0 : _error$response6.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response7 = _context3.t0.response) === null || _error$response7 === void 0 ? void 0 : _error$response7.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response8 = _context3.t0.response) === null || _error$response8 === void 0 ? void 0 : _error$response8.status) >= 500) {
                toast.fire({
                  type: "error",
    ...
    getAccounts: function getAccounts() {
      var _this7 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _yield$axios$get2, data, defaultAccountSlug, _error$response9, _error$response0, _error$response1;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
            ...
            case 9:
              ...
              if (((_error$response9 = _context4.t0.response) === null || _error$response9 === void 0 ? void 0 : _error$response9.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response0 = _context4.t0.response) === null || _error$response0 === void 0 ? void 0 : _error$response0.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response1 = _context4.t0.response) === null || _error$response1 === void 0 ? void 0 : _error$response1.status) >= 500) {
                toast.fire({
                  type: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 8:
              ...
              console.error('Error getting cost centers:', _context5.t0);
              _this8.costCenters = [];
            case 12:
            case "end":
              return _context5.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 11:
              ...
              console.error('Error getting employees:', _context6.t0);
              _this9.employees = [];
    ...
    getBranches: function getBranches() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var user, isSuperAdmin, branchesData, _yield$axios$get5, data, _yield$axios$get6, _data, _yield$axios$get7, _data2;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 31:
              ...
              console.error('Error getting branches:', _context7.t1);
              _this0.branches = [];
            case 35:
            case "end":
              return _context7.stop();
          }
        }, _callee7, null, [[0, 31], [13, 21]]);
      }))();
    },
    ...
    getTaxes: function getTaxes() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        var _yield$axios$get8, data, defaultVatRateSlug, _error$response10, _error$response11, _error$response12;
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 10:
              ...
              console.error('Error getting taxes:', _context8.t0);

              // Show error toast for tax loading failures
              if (((_error$response10 = _context8.t0.response) === null || _error$response10 === void 0 ? void 0 : _error$response10.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response11 = _context8.t0.response) === null || _error$response11 === void 0 ? void 0 : _error$response11.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response12 = _context8.t0.response) === null || _error$response12 === void 0 ? void 0 : _error$response12.status) >= 500) {
                toast.fire({
                  type: "error",
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 52:
              _context9.prev = 52;
              _context9.t0 = _context9["catch"](43);
              _this16.loading = false;
              throw _context9.t0;
            case 56:
              _context9.next = 64;
            ...
            case 60:
              _yield$_this16$form$p = _context9.sent;
            ...
            case 66:
              ...
              _this16.loading = false;
              console.error('Invoice creation error:', _context9.t1);

              // Handle validation errors specifically
              if (!(((_error$response13 = _context9.t1.response) === null || _error$response13 === void 0 ? void 0 : _error$response13.status) === 422 && (_error$response14 = _context9.t1.response) !== null && _error$response14 !== void 0 && (_error$response14 = _error$response14.data) !== null && _error$response14 !== void 0 && _error$response14.errors)) {
                _context9.next = 76;
                break;
              }
              _validationErrors = _context9.t1.response.data.errors; // Show validation errors in toast
              ...
              break;
            case 76:
              if (!(((_error$response15 = _context9.t1.response) === null || _error$response15 === void 0 ? void 0 : _error$response15.status) === 400)) {
                _context9.next = 86;
                break;
              }
              // Handle bad request errors (business logic errors)
              errorMessage = _context9.t1.response.data.message || _context9.t1.response.data.error || _this16.$t("Bad Request Error");
              _validationErrors2 = _context9.t1.response.data.validation_errors;
              errorCount = _context9.t1.response.data.error_count; // If we have multiple validation errors from the backend, show them all
            ...
            case 83:
              ...
              if (!_this16.handleBusinessLogicError(_context9.t1.response.data)) {
              ...
              break;
            case 86:
              if (((_error$response16 = _context9.t1.response) === null || _error$response16 === void 0 ? void 0 : _error$response16.status) === 401) {
              ...
              } else if (((_error$response17 = _context9.t1.response) === null || _error$response17 === void 0 ? void 0 : _error$response17.status) === 403) {
              ...
              } else if (((_error$response18 = _context9.t1.response) === null || _error$response18 === void 0 ? void 0 : _error$response18.status) === 404) {
              ...
              } else if (((_error$response19 = _context9.t1.response) === null || _error$response19 === void 0 ? void 0 : _error$response19.status) === 409) {
                // Handle conflict errors
                _errorMessage = _context9.t1.response.data.message || _this16.$t("Data Conflict Error");
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response20 = _context9.t1.response) === null || _error$response20 === void 0 ? void 0 : _error$response20.status) === 422) {
                // Handle other unprocessable entity errors
                _errorMessage2 = _context9.t1.response.data.message || _this16.$t("Please check your input and try again.");
                toast.fire({
                  type: "error",
                  title: _this16.$t("Validation Error"),
                  text: _errorMessage2,
              ...
              } else if (((_error$response21 = _context9.t1.response) === null || _error$response21 === void 0 ? void 0 : _error$response21.status) >= 500) {
                // Handle server errors
                _errorMessage3 = _context9.t1.response.data.message || _this16.$t("Server Error");
                toast.fire({
                  type: "error",
              ...
              } else if ((_error$response22 = _context9.t1.response) !== null && _error$response22 !== void 0 && (_error$response22 = _error$response22.data) !== null && _error$response22 !== void 0 && _error$response22.message) {
                // Handle other API error messages
                toast.fire({
                  type: "error",
                  title: _this16.$t("API Error"),
                  text: _context9.t1.response.data.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_context9.t1.message) {
                // Handle JavaScript errors
                toast.fire({
                  type: "error",
                  title: _this16.$t("JavaScript Error"),
                  text: _context9.t1.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_context9.t1.code === 'NETWORK_ERROR' || _context9.t1.code === 'ECONNABORTED') {
                ...
                ErrorHandler.handleApiError(_context9.t1, {
            ...
            case 87:
              ...
              console.error('Error object:', _context9.t1);
              console.error('Error response:', _context9.t1.response);
              console.error('Error message:', _context9.t1.message);
              console.error('Error stack:', _context9.t1.stack);
              console.groupEnd();
            case 93:
            case "end":
              return _context9.stop();
          }
        }, _callee9, null, [[0, 66], [43, 52]]);
      }))();
    },
        ...
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            ...
            case 11:
              ...
              if (((_error$response23 = _context1.t0.response) === null || _error$response23 === void 0 ? void 0 : _error$response23.status) === 400) {
                errorMessage = _context1.t0.response.data.message || _this19.$t("Bad request error");
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response24 = _context1.t0.response) === null || _error$response24 === void 0 ? void 0 : _error$response24.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response25 = _context1.t0.response) === null || _error$response25 === void 0 ? void 0 : _error$response25.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response26 = _context1.t0.response) === null || _error$response26 === void 0 ? void 0 : _error$response26.status) === 404) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response27 = _context1.t0.response) === null || _error$response27 === void 0 ? void 0 : _error$response27.status) >= 500) {
                _errorMessage4 = _context1.t0.response.data.message || _this19.$t("Server error");
                toast.fire({
                  type: "error",
              ...
              } else if ((_error$response28 = _context1.t0.response) !== null && _error$response28 !== void 0 && (_error$response28 = _error$response28.data) !== null && _error$response28 !== void 0 && _error$response28.message) {
                toast.fire({
                  type: "error",
                  title: _this19.$t("Assignment Failed"),
                  text: _context1.t0.response.data.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_context1.t0.message) {
                toast.fire({
                  type: "error",
                  title: _this19.$t("Assignment Failed"),
                  text: _context1.t0.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 11:
              ...
              console.error('Error auto-assigning chart of account for product:', _context10.t0);

              // Handle different types of errors
              if (((_error$response29 = _context10.t0.response) === null || _error$response29 === void 0 ? void 0 : _error$response29.status) === 400) {
                errorMessage = _context10.t0.response.data.message || _this23.$t("Bad request error");
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response30 = _context10.t0.response) === null || _error$response30 === void 0 ? void 0 : _error$response30.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response31 = _context10.t0.response) === null || _error$response31 === void 0 ? void 0 : _error$response31.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response32 = _context10.t0.response) === null || _error$response32 === void 0 ? void 0 : _error$response32.status) === 404) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response33 = _context10.t0.response) === null || _error$response33 === void 0 ? void 0 : _error$response33.status) >= 500) {
                _errorMessage5 = _context10.t0.response.data.message || _this23.$t("Server error");
                toast.fire({
                  type: "error",
              ...
              } else if ((_error$response34 = _context10.t0.response) !== null && _error$response34 !== void 0 && (_error$response34 = _error$response34.data) !== null && _error$response34 !== void 0 && _error$response34.message) {
                toast.fire({
                  type: "error",
                  title: _this23.$t("Please try again or assign manually"),
                  text: _context10.t0.response.data.message,
                  timer: 6000,
                  timerProgressBar: true
                });
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_5061c40b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_5061c40b_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_5061c40b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=5061c40b&prod&scoped=true&lang=css
