"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6916],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/auth/register.vue?vue&type=template&id=e11fae24
  ...
  methods: {
    tenantRegister: function tenantRegister() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var _yield$_this$form$pos, data, errorData, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 3:
              ...
              errorData = _t.response.data;
              if (!(errorData.message && errorData.message.includes('SMTP configuration'))) {
                _context.n = 4;
                break;
              }
              // Show error message in the form area for SMTP issues
              _this.message = _this.$t('System is unable to send email. Please contact the administrator.');
              _this.type = 'danger';
              return _context.a(2);
            case 4:
              // Handle other errors normally
              if (_t.response && _t.response.data && _t.response.data.message) {
                _this.message = _t.response.data.message;
                _this.type = 'danger';
              } else {
                _this.message = 'An error occurred during registration. Please try again.';
                _this.type = 'danger';
              }
            case 5:
              return _context.a(2);
