...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=9d6c2960&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_9d6c2960_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_9d6c2960_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_9d6c2960_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=9d6c2960&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-9d6c2960]{margin-bottom:15px}.footer-buttons[data-v-9d6c2960]{display:flex;gap:10px}.footer-buttons .btn[data-v-9d6c2960]{margin-right:10px}.footer-buttons .btn[data-v-9d6c2960]:last-child{margin-right:0}.create-btn[data-v-9d6c2960]{padding:11px}.chart-account-success[data-v-9d6c2960],.chart-account-warning[data-v-9d6c2960]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-9d6c2960]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-9d6c2960]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-9d6c2960],.warning-content[data-v-9d6c2960]{align-items:center;display:flex;gap:16px}.success-icon[data-v-9d6c2960],.warning-icon[data-v-9d6c2960]{flex-shrink:0;font-size:24px}.warning-icon[data-v-9d6c2960]{color:#856404}.success-icon[data-v-9d6c2960]{color:#155724}.success-text[data-v-9d6c2960],.warning-text[data-v-9d6c2960]{flex-grow:1}.success-title[data-v-9d6c2960],.warning-title[data-v-9d6c2960]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-9d6c2960]{color:#856404}.success-title[data-v-9d6c2960]{color:#155724}.success-description[data-v-9d6c2960],.warning-description[data-v-9d6c2960]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-9d6c2960]{color:#856404}.success-description[data-v-9d6c2960]{color:#155724}.warning-action[data-v-9d6c2960]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-9d6c2960]{padding:0}.card[data-v-9d6c2960]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-9d6c2960]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-9d6c2960]{padding:1.25rem}.card-footer[data-v-9d6c2960]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-9d6c2960]{border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-9d6c2960]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-9d6c2960]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-9d6c2960]{color:#dc3545;font-weight:700}.btn-primary[data-v-9d6c2960]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-9d6c2960]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-9d6c2960]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-9d6c2960]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-9d6c2960]{border-color:#dc3545!important}textarea.form-control[data-v-9d6c2960]{min-height:100px;resize:vertical}.v-select[data-v-9d6c2960],.v-select .vs__dropdown-toggle[data-v-9d6c2960]{background:#fff!important;border:1px solid #e5e7eb}.v-select .vs__dropdown-toggle[data-v-9d6c2960]{padding:10px 16px}.v-select .vs__search[data-v-9d6c2960]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-9d6c2960]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-9d6c2960]{color:#374151}.v-select .vs__dropdown-menu[data-v-9d6c2960]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-9d6c2960]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-9d6c2960]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-9d6c2960]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-9d6c2960]:hover{background-color:#f8f9fa}.toggle-button[data-v-9d6c2960]{margin-right:10px}.product-status[data-v-9d6c2960],.supplier-status[data-v-9d6c2960]{font-size:13px}.product-warning[data-v-9d6c2960],.supplier-warning[data-v-9d6c2960]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-9d6c2960]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-9d6c2960]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-9d6c2960]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-9d6c2960]{margin-bottom:1rem}.form-text[data-v-9d6c2960]{color:#6b7280;font-size:.875rem}.text-muted[data-v-9d6c2960]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-9d6c2960]{flex-direction:column;gap:10px}.card-footer .btn[data-v-9d6c2960]{margin-right:0!important;width:100%}.card-footer div[data-v-9d6c2960]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-9d6c2960]{font-size:12px}.table-custom tbody td[data-v-9d6c2960],.table-custom thead th[data-v-9d6c2960]{padding:8px 4px}}.btn-group.c-w-100[data-v-9d6c2960]{gap:10px}.quantity-field[data-v-9d6c2960]{border-radius:0!important;margin:0!important;min-height:50px!important}.table-custom[data-v-9d6c2960]{border:none!important}.invoices-create-table[data-v-9d6c2960]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-9d6c2960]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-9d6c2960]{border:none!important}.invoices-create-table thead th[data-v-9d6c2960]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-9d6c2960]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-9d6c2960]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-9d6c2960]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-create-table .badge.badge-danger[data-v-9d6c2960]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-9d6c2960]{background:#fff!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
