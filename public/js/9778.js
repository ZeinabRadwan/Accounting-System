"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9778],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-7ac24970]{margin-bottom:15px}.footer-buttons[data-v-7ac24970]{display:flex;gap:10px}.footer-buttons .btn[data-v-7ac24970]{margin-right:10px}.footer-buttons .btn[data-v-7ac24970]:last-child{margin-right:0}.btn-group.c-w-100[data-v-7ac24970]{gap:10px}.form-control[data-v-7ac24970]{background:#fff!important}.card[data-v-7ac24970]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-7ac24970]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-footer[data-v-7ac24970]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.section-title[data-v-7ac24970]{border-bottom:2px solid #e9ecef;color:#495057;font-weight:600;margin-bottom:1.5rem;padding-bottom:.5rem}.radio-group[data-v-7ac24970]{display:flex;gap:1rem;margin-top:.5rem}.radio-inline[data-v-7ac24970]{align-items:center;cursor:pointer;display:flex;margin-right:1rem}.radio-inline input[type=radio][data-v-7ac24970]{margin-right:.5rem}.required[data-v-7ac24970]{color:#dc3545}.form-group[data-v-7ac24970]{margin-bottom:1.5rem}.form-group label[data-v-7ac24970]{color:#495057;font-weight:500;margin-bottom:.5rem}.is-invalid[data-v-7ac24970]{border-color:#dc3545}.text-muted[data-v-7ac24970]{color:#6c757d!important}.btn[data-v-7ac24970]{border-radius:.375rem;font-weight:500}.btn-primary[data-v-7ac24970]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-7ac24970]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-7ac24970]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-7ac24970]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}@media (max-width:768px){.radio-group[data-v-7ac24970]{flex-direction:column;gap:.5rem}.col-md-3[data-v-7ac24970]{margin-bottom:1rem}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/suppliers/edit.vue?vue&type=template&id=7ac24970&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('breadcrumbs', {
  ...
  })])], 1)])]), _vm._v(" "), !_vm.loading && _vm.supplierData && _vm.supplierData.slug ? _c('SupplierForm', {
    ref: "supplierForm",
    attrs: {
      "showCardBody": true,
    ...
    staticClass: "mt-2"
  }, [_vm._v(_vm._s(_vm.$t('Loading supplier data...')))])]) : _c('div', {
    staticClass: "card-body text-center"
  }, [_c('div', {
    staticClass: "alert alert-danger"
  }, [_c('i', {
    staticClass: "fas fa-exclamation-triangle"
  }), _vm._v("\n            " + _vm._s(_vm.$t('Failed to load supplier data')) + "\n          ")])]), _vm._v(" "), _c('div', {
...
/* harmony default export */ const editvue_type_script_lang_js = ({
  ...
  computed: {
    ...
    isFormReady: function isFormReady() {
      var ready = !this.loading && this.supplierData && this.supplierData.slug && Object.keys(this.supplierData).length > 0;
      return ready;
    }
  },
  watch: {
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              supplierData = response.data.data || response.data;
              ...
              _this3.supplierData = {
                ...
                slug: supplierData.slug || _this3.$route.params.slug,
                // Account Details
              ...
              console.log("Supplier data slug:", supplierData.slug);
              console.log("Route params slug:", _this3.$route.params.slug);
              console.log("Final slug used:", supplierData.slug || _this3.$route.params.slug);
              console.log("Mapped supplier data:", _this3.supplierData);
              _context2.next = 28;
              break;
            case 22:
              _context2.prev = 22;
              _context2.t0 = _context2["catch"](0);
              console.error("Error fetching supplier:", _context2.t0);

              // Show error message if toast is available
              if (window.toast && typeof window.toast.fire === 'function') {
                window.toast.fire({
                  type: "error",
                  title: _this3.$t("Failed to load supplier data"),
                  text: _context2.t0.message || "Please check the supplier slug and try again."
                });
              } else {
                // Fallback to console and alert if toast is not available
                console.error("Toast not available, showing alert");
                alert(_this3.$t("Failed to load supplier data: ") + (_context2.t0.message || "Unknown error"));
              }
    ...
    saveSupplier: function saveSupplier(formData) {
      var _this4 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var hasFiles, requestData, config, fd, appendIfDefined, phoneNumberValue, phoneNumberToSend, _iterator, _step, pair, response;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 7:
              ...
              if (hasFiles) {
                ...
                if (phoneNumberValue === undefined || phoneNumberValue === null) {
                  ...
                  if (_this4.$refs.supplierForm && _this4.$refs.supplierForm.form) {
                    phoneNumberValue = _this4.$refs.supplierForm.form.phoneNumber;
                  }
                }
              ...
              _context3.next = 19;
              return _this4.$http.put("/api/suppliers/".concat(_this4.supplierData.slug), requestData, config);
            case 19:
              ...
              if (window.toast && typeof window.toast.fire === 'function') {
                ...
                alert(_this4.$t("Supplier updated successfully"));
              }
              _this4.$router.push({
                name: "suppliers.index"
              });
            ...
            case 31:
              ...
              console.error("Error saving supplier:", _context3.t0);
              if (window.toast && typeof window.toast.fire === 'function') {
                window.toast.fire({
                  type: "error",
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_7ac24970_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const suppliers_editvue_type_style_index_0_id_7ac24970_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_7ac24970_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/suppliers/edit.vue?vue&type=style&index=0&id=7ac24970&prod&scoped=true&lang=css
