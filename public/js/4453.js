(self["webpackChunk"] = self["webpackChunk"] || []).push([[4453],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/loans/payments/index.vue?vue&type=template&id=5847ac85
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }, [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Payment Ref.")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Loan Ref.")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Authority")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Payable")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Amount Paid")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Interest")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Account")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Date")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _vm.$can('loan-payment-edit') || _vm.$can('loan-payment-view') || _vm.$can('loan-payment-delete') ? _c('th', {
    ...
    }, [_vm._v("\n                      " + _vm._s(data.reference) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(data.reference))])], 1), _vm._v(" "), data.loan ? _c('td', [_vm._v(_vm._s(data.loan.reference))]) : _vm._e(), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.authority.name))]), _vm._v(" "), _c('td', [data.loan ? _c('span', [_vm._v(_vm._s(_vm._f("withCurrency")(data.loan.payable)) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.amount)))]), _vm._v(" "), _c('td', [data.interest ? _c('span', [_vm._v(_vm._s(_vm._f("withCurrency")(data.interest)) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c('td', [data.account ? _c('span', [_vm._v(_vm._s(data.account.accountNumber) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.date))]), _vm._v(" "), _c('td', [data.status === 1 ? _c('span', {
    ...
    }, [_vm.$can('loan-payment-view') ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('View'),
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('loan-payment-edit') ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Edit'),
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('loan-payment-delete') ? _c('a', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Delete'),
