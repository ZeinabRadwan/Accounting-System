"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5025],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-002d9746]{margin-bottom:15px}.footer-buttons[data-v-002d9746]{display:flex;gap:10px}.footer-buttons .btn[data-v-002d9746]{margin-right:10px}.footer-buttons .btn[data-v-002d9746]:last-child{margin-right:0}.table-custom[data-v-002d9746]{border:none!important}.quotations-create-table[data-v-002d9746]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-002d9746]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-002d9746]{border:none!important}.quotations-create-table thead th[data-v-002d9746]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-002d9746]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-002d9746]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-002d9746]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-002d9746]{gap:10px}.card[data-v-002d9746]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-002d9746]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-002d9746]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-002d9746]{background:#fff!important}.btn-primary[data-v-002d9746]{background:#2ab930!important}.btn-secondary[data-v-002d9746]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.quantity-field[data-v-002d9746]{border-radius:0!important;margin:0!important;min-height:50px!important}.custom-qty-input[data-v-002d9746]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-002d9746],.button-plus[data-v-002d9746]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:12px;font-weight:700;height:24px;justify-content:center;transition:all .2s ease;width:24px}.button-minus[data-v-002d9746]{background-color:#dc3545;color:#fff}.button-plus[data-v-002d9746]{background-color:#007bff;color:#fff}.button-minus[data-v-002d9746]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-002d9746]:hover{background-color:#0056b3;transform:scale(1.05)}.account-status[data-v-002d9746]{font-size:.875rem}.account-status .account-warning[data-v-002d9746]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-002d9746]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/form.vue?vue&type=template&id=002d9746&scoped=true
...
;// ./resources/js/pages/sales/returns/form.vue?vue&type=template&id=002d9746&scoped=true
...
var update = injectStylesIntoStyleTag_default()(formvue_type_style_index_0_id_002d9746_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_formvue_type_style_index_0_id_002d9746_prod_scoped_true_lang_css = (formvue_type_style_index_0_id_002d9746_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/form.vue?vue&type=style&index=0&id=002d9746&prod&scoped=true&lang=css
