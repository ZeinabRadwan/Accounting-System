...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-28f36922]{border:none!important}.purchase-payments-table[data-v-28f36922]{border-collapse:separate;border-spacing:0}.purchase-payments-table thead th[data-v-28f36922]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchase-payments-table thead tr[data-v-28f36922]{border:none!important}.purchase-payments-table thead th[data-v-28f36922]:first-child{border-top-left-radius:10px}.purchase-payments-table thead th[data-v-28f36922]:last-child{border-top-right-radius:10px}[dir=rtl] .purchase-payments-table thead th[data-v-28f36922]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchase-payments-table thead th[data-v-28f36922]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-28f36922]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-28f36922],.export-pdf-btn[data-v-28f36922]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-28f36922],.export-pdf-btn[data-v-28f36922],.print-btn[data-v-28f36922]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-28f36922]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-28f36922]{display:inline-block;position:relative}.action-icon-btn[data-v-28f36922]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-28f36922]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-28f36922]{animation:slideInRight-28f36922 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 20px 25px -5px rgba(0,0,0,.1),0 10px 10px -5px rgba(0,0,0,.04);max-width:250px;min-width:200px;position:fixed;right:50%;top:50%;transform:translate(50%,-50%);z-index:1000}.action-menu-header[data-v-28f36922]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-28f36922]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-28f36922]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-28f36922]:hover{background-color:#e5e7eb}.action-menu ul[data-v-28f36922]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-28f36922]{margin:0}.action-menu li a[data-v-28f36922]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-28f36922]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-28f36922]{flex-shrink:0;height:16px;width:16px}.action-menu-backdrop[data-v-28f36922]{animation:fadeIn-28f36922 .3s ease-out;background:rgba(0,0,0,.5);bottom:0;left:0;position:fixed;right:0;top:0;z-index:999}@keyframes slideInRight-28f36922{0%{opacity:0;transform:translate(50%,-50%) translateX(20px)}to{opacity:1;transform:translate(50%,-50%) translateX(0)}}@keyframes fadeIn-28f36922{0%{opacity:0}to{opacity:1}}.btn-group.c-w-100[data-v-28f36922]{gap:10px}.btn-group.c-w-100>.btn[data-v-28f36922]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-28f36922]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-28f36922]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-28f36922]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-28f36922]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.purchase-payments-table .badge.bg-success[data-v-28f36922]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.purchase-payments-table .badge.bg-danger[data-v-28f36922]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-28f36922]{background:#f1f5fb!important}.btn-primary[data-v-28f36922]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
var purchasevue_type_style_index_0_id_28f36922_prod_scoped_true_lang_css = __webpack_require__(64626);
...
var update = injectStylesIntoStyleTag_default()(purchasevue_type_style_index_0_id_28f36922_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const suppliers_purchasevue_type_style_index_0_id_28f36922_prod_scoped_true_lang_css = (purchasevue_type_style_index_0_id_28f36922_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/payments/suppliers/purchase/index.vue?vue&type=style&index=0&id=28f36922&prod&scoped=true&lang=css
