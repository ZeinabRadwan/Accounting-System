...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/user/Edit.vue?vue&type=template&id=55d45e28&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// CONCATENATED MODULE: ./resources/js/pages/central/setup/user/Edit.vue?vue&type=template&id=55d45e28&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/user/Edit.vue?vue&type=script&lang=js
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.form.patch(window.location.origin + '/api/user/' + _this.$route.params.slug).then(function () {
                toast.fire({
                  type: 'success',
                  title: _this.$t('Successfully updated')
                });
                _this.$router.push({
                  name: 'user.index'
                });
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios_default().get("/api/user/" + _this2.$route.params.slug).then(function (data) {
                _this2.form.fill(data.data);
                _this2.form.role = data.data.roles[0].slug;
              });
            case 2:
            case "end":
...
;// CONCATENATED MODULE: ./resources/js/pages/central/setup/user/Edit.vue?vue&type=script&lang=js
 /* harmony default export */ const user_Editvue_type_script_lang_js = (Editvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/central/setup/user/Edit.vue
...
;
var component = (0,componentNormalizer/* default */.A)(
  user_Editvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
