...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=25897254&scoped=true
...
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=25897254&scoped=true
  ...
  methods: {
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var _yield$axios$post, data, newAccountId, _error$response4, errorMessage, _t8;
          ...
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 3:
              ...
              if (data.success) {
                ...
                if (newAccountId) {
                  _this1.form.client.chart_of_account_id = newAccountId;
                }
                toast.fire({
                  type: "success",
    ...
    autoAssignProductChartOfAccount: function autoAssignProductChartOfAccount(product) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var _yield$axios$post2, data, exists, _error$response5, errorMessage, _t9;
          ...
          while (1) switch (_context9.p = _context9.n) {
            ...
            case 3:
              ...
              if (data.success) {
                ...
                exists = _this10.form.selectedProducts && _this10.form.selectedProducts.some(function (p) {
                  return p.id === product.id;
                });
                if (!exists) {
                  _this10.storeProduct(product);
                }
                toast.fire({
                  type: "success",
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_25897254_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const invoices_editvue_type_style_index_0_id_25897254_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_25897254_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=25897254&prod&lang=scss&scoped=true
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-25897254]{margin-bottom:15px}.footer-buttons[data-v-25897254]{display:flex;gap:10px}.footer-buttons .btn[data-v-25897254]{margin-right:10px}.footer-buttons .btn[data-v-25897254]:last-child{margin-right:0}.account-status .account-warning[data-v-25897254],.account-status .client-warning[data-v-25897254],.account-status .product-warning[data-v-25897254],.client-status .account-warning[data-v-25897254],.client-status .client-warning[data-v-25897254],.client-status .product-warning[data-v-25897254],.product-status .account-warning[data-v-25897254],.product-status .client-warning[data-v-25897254],.product-status .product-warning[data-v-25897254]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;color:#856404;font-size:.875rem;padding:8px 12px}.account-status .account-success[data-v-25897254],.account-status .client-success[data-v-25897254],.account-status .product-success[data-v-25897254],.client-status .account-success[data-v-25897254],.client-status .client-success[data-v-25897254],.client-status .product-success[data-v-25897254],.product-status .account-success[data-v-25897254],.product-status .client-success[data-v-25897254],.product-status .product-success[data-v-25897254]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:4px;color:#155724;font-size:.875rem;padding:8px 12px}.create-btn[data-v-25897254]{background-color:#007bff;border-left:none;border-color:#007bff;color:#fff;cursor:pointer}.create-btn[data-v-25897254]:hover{background-color:#0056b3;border-color:#0056b3}.radio-group-horizontal[data-v-25897254]{display:flex;gap:20px}.radio-group-horizontal .form-check[data-v-25897254]{align-items:center;display:flex;gap:8px}.custom-qty-input .button-minus[data-v-25897254],.custom-qty-input .button-plus[data-v-25897254]{border:none;border-radius:0;height:30px;width:30px}.custom-qty-input .quantity-field[data-v-25897254]{border-left:none;border-right:none;text-align:center;width:60px}.table-custom td[data-v-25897254],.table-custom th[data-v-25897254]{vertical-align:middle}.invalid-feedback[data-v-25897254]{display:block;margin-top:5px}.btn-primary[data-v-25897254]{background:#2ab930!important}.btn-primary[data-v-25897254]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
