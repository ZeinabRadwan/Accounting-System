...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".price-single[data-v-c2b1f37c]{align-items:flex-start;border:2px solid #c9cafa5c;border-radius:5px;cursor:pointer;display:flex;margin:0 0 10px!important;padding:15px 14px!important;position:relative;width:100%}.price-single img[data-v-c2b1f37c]{max-width:80px}.price-single ul[data-v-c2b1f37c]{display:grid;grid-template-columns:1fr 1fr;list-style:none;margin:8px 0 0;padding:0}.price-single ul li[data-v-c2b1f37c]{color:#8b8f95;font-size:12px;margin-right:12px}.price-single ul li span[data-v-c2b1f37c]{color:#33a0d9}.price-single .price-badge[data-v-c2b1f37c]{background:#33a0d9;border-top-left-radius:12px;bottom:0;position:absolute}.activePlanText[data-v-c2b1f37c],.price-single .price-badge[data-v-c2b1f37c]{color:#fff;font-size:13px;margin:0;padding:3px 8px;right:0}.activePlanText[data-v-c2b1f37c]{background:green;border-radius:3px;top:12px}label.price-single.selected[data-v-c2b1f37c]{border-color:#33a0d9}.current-plan[data-v-c2b1f37c]{background:#ddd;border:2px solid green;cursor:no-drop!important;opacity:1}.line-through[data-v-c2b1f37c]{text-decoration:line-through}.small-text[data-v-c2b1f37c]{font-size:11px}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/billing/Plans.vue?vue&type=template&id=c2b1f37c&scoped=true
var Plansvue_type_template_id_c2b1f37c_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
var Plansvue_type_template_id_c2b1f37c_scoped_true_staticRenderFns = [];
...
var update = injectStylesIntoStyleTag_default()(Plansvue_type_style_index_0_id_c2b1f37c_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const billing_Plansvue_type_style_index_0_id_c2b1f37c_prod_lang_scss_scoped_true = (Plansvue_type_style_index_0_id_c2b1f37c_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/components/billing/Plans.vue?vue&type=style&index=0&id=c2b1f37c&prod&lang=scss&scoped=true
...
var component = (0,componentNormalizer/* default */.A)(
  ...
  Plansvue_type_template_id_c2b1f37c_scoped_true_render,
  Plansvue_type_template_id_c2b1f37c_scoped_true_staticRenderFns,
  false,
  null,
  "c2b1f37c",
  null
