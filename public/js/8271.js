"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8271,6887],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".currency-display[data-v-d25f7b5c]{align-items:center;display:inline-flex}.currency-svg[data-v-d25f7b5c]{display:inline-block;filter:brightness(.2) contrast(2) saturate(1.5);opacity:1;vertical-align:middle}.small-box .currency-svg[data-v-d25f7b5c]{filter:brightness(0) invert(1) contrast(1)}.currency-text[data-v-d25f7b5c]{margin:0 2px}[dir=rtl] .currency-display[data-v-d25f7b5c]{direction:rtl}[dir=rtl] .currency-display .currency-text[data-v-d25f7b5c]{text-align:right}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-responsive[data-v-9e905160]{border:1px solid #dee2e6;border-radius:.375rem;overflow-y:auto}.table-sm td[data-v-9e905160],.table-sm th[data-v-9e905160]{font-size:.875rem;padding:.5rem .75rem}.table th[data-v-9e905160]{border-bottom:2px solid #dee2e6;color:#495057;font-weight:600}.table tbody tr[data-v-9e905160]:hover,.table th[data-v-9e905160]{background-color:#f8f9fa}.table tbody tr.table-info[data-v-9e905160]{background-color:#e3f2fd;font-weight:600}.table tbody tr.table-info[data-v-9e905160]:hover{background-color:#bbdefb}.info-box[data-v-9e905160]{background:#f8f9fa;border-radius:.375rem;margin-bottom:1rem;padding:1rem}.info-box[data-v-9e905160],.info-box-icon[data-v-9e905160]{align-items:center;display:flex}.info-box-icon[data-v-9e905160]{border-radius:50%;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-9e905160]{flex:1}.info-box-text[data-v-9e905160]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-9e905160]{color:#495057;display:block;font-size:1.5rem;font-weight:700}.badge[data-v-9e905160]{font-size:.75rem;padding:.25rem .5rem}.font-weight-bold[data-v-9e905160]{color:#212529}.text-muted[data-v-9e905160]{color:#6c757d!important}.btn-link[data-v-9e905160]{background:none;border:none;color:#007bff;padding:0;text-decoration:none}.btn-link[data-v-9e905160]:hover{color:#0056b3;text-decoration:none}.btn-link[data-v-9e905160]:focus{box-shadow:none;outline:none}.tree-toggle-icon[data-v-9e905160]{transition:transform .2s ease}.tree-toggle-icon.expanded[data-v-9e905160]{transform:rotate(90deg)}.tree-item-icon[data-v-9e905160]{text-align:center;width:16px}.gap-2>*+*[data-v-9e905160]{margin-left:.5rem}@media (max-width:768px){.gap-2[data-v-9e905160]{align-items:stretch;flex-direction:column}.gap-2>*+*[data-v-9e905160]{margin-left:0;margin-top:.5rem}}.trial-balance-table[data-v-9e905160]{background:#fff;border:1px solid #dee2e6;font-size:16px}.table-header[data-v-9e905160],.table-header th[data-v-9e905160]{background:#f8f9fa}.table-header th[data-v-9e905160]{border:1px solid #dee2e6;color:#495057;font-size:16px;font-weight:600;padding:12px 8px}.header-code[data-v-9e905160]{width:10%}.header-account[data-v-9e905160]{width:30%}.header-amount[data-v-9e905160]{font-size:16px;width:12%}.trial-balance-table tbody tr[data-v-9e905160]{border-bottom:1px solid #dee2e6}.trial-balance-table tbody tr[data-v-9e905160]:hover{background:#f8f9fa}.trial-balance-table tbody tr.table-info[data-v-9e905160]{background:#e9ecef;border-left:3px solid #6c757d;font-weight:600}.trial-balance-table tbody tr.table-info[data-v-9e905160]:hover{background:#dee2e6}.trial-balance-table tbody tr.table-warning[data-v-9e905160]{background:#fff3cd;border-left:3px solid #ffc107;font-weight:600}.trial-balance-table tbody tr.table-warning[data-v-9e905160]:hover{background:#ffeaa7}.cell-code[data-v-9e905160]{background:#f8f9fa}.cell-account[data-v-9e905160],.cell-amount[data-v-9e905160]{background:#fff}.cell-amount[data-v-9e905160]{font-weight:600}.account-code-badge[data-v-9e905160]{background:#6c757d;border-radius:4px;color:#fff;display:inline-block;font-size:16px;font-weight:600;padding:4px 8px}.account-name-container[data-v-9e905160]{align-items:center;display:flex;padding:8px 0}.expand-btn[data-v-9e905160]{align-items:center;background:none;border:none;border-radius:2px;color:#6c757d;display:flex;font-size:16px;height:20px;justify-content:center;margin-right:8px;min-width:20px;padding:2px;transition:color .2s ease}.expand-btn[data-v-9e905160]:hover{background:#f8f9fa;color:#495057}.expand-spacer[data-v-9e905160]{margin-right:8px;width:24px}.account-icon[data-v-9e905160]{font-size:16px;margin-right:8px;text-align:center;width:16px}.account-icon.fa-folder[data-v-9e905160]{color:#6c757d}.account-icon.fa-folder-open[data-v-9e905160]{color:#495057}.account-icon.fa-file[data-v-9e905160]{color:#adb5bd}.account-name[data-v-9e905160]{color:#2c3e50;font-size:16px;font-weight:600}.total-row-name[data-v-9e905160]{color:#d63384;font-style:italic;font-weight:700}.amount-value[data-v-9e905160]{background:none;color:#495057;display:inline-block;font-size:16px;font-weight:600;min-width:80px;padding:0;text-align:right}.credit-amount[data-v-9e905160],.debit-amount[data-v-9e905160]{background:none;border:none;color:#495057}.closing-amount[data-v-9e905160]{background:none;font-size:16px;font-weight:800}.amount-empty[data-v-9e905160]{color:#adb5bd;font-size:16px;font-style:italic}.table-footer[data-v-9e905160]{background:#f8f9fa;color:#495057}.grand-total-row[data-v-9e905160]{background:#e9ecef;border-top:2px solid #6c757d}.grand-total-label[data-v-9e905160]{font-weight:700;padding:12px 8px}.grand-total-amount[data-v-9e905160],.grand-total-label[data-v-9e905160]{background:none;color:#495057;font-size:16px}.grand-total-amount[data-v-9e905160]{border:none;font-weight:600;margin:0;padding:0}.grand-total-amount.credit-amount[data-v-9e905160],.grand-total-amount.debit-amount[data-v-9e905160]{background:none;border:none}@media print{.no-print[data-v-9e905160]{display:none!important}.card[data-v-9e905160]{border:none!important;box-shadow:none!important}.table[data-v-9e905160]{font-size:16px}.table-responsive[data-v-9e905160]{overflow:visible}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CurrencyDisplay.vue?vue&type=template&id=d25f7b5c&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/mixins/RTLMixin.js
...
var update = injectStylesIntoStyleTag_default()(CurrencyDisplayvue_type_style_index_0_id_d25f7b5c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_CurrencyDisplayvue_type_style_index_0_id_d25f7b5c_prod_scoped_true_lang_css = (CurrencyDisplayvue_type_style_index_0_id_d25f7b5c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/components/CurrencyDisplay.vue?vue&type=style&index=0&id=d25f7b5c&prod&scoped=true&lang=css
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=9e905160&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }, [_vm._v(_vm._s(_vm.$t("Please select filters and generate the trial balance report.")))])])])])]) : _vm._e()], 1);
};
...
;// CONCATENATED MODULE: ./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=9e905160&scoped=true
...
// EXTERNAL MODULE: ./resources/js/components/CurrencyDisplay.vue + 6 modules
var CurrencyDisplay = __webpack_require__(96887);
...
var update = injectStylesIntoStyleTag_default()(trial_balancevue_type_style_index_0_id_9e905160_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_trial_balancevue_type_style_index_0_id_9e905160_prod_scoped_true_lang_css = (trial_balancevue_type_style_index_0_id_9e905160_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/reports/trial-balance.vue?vue&type=style&index=0&id=9e905160&prod&scoped=true&lang=css
