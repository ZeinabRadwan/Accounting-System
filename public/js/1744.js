...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/domains/index.vue?vue&type=template&id=438d49a1
              ...
              Swal.fire({
                ...
                if (result.value) {
                  _this6.$store.dispatch('operations/deleteData', {
                    ...
                    if (response === true) {
                      Swal.fire(_this6.$t('Deleted!'), _this6.$t('Deleted successfully.'), 'success');
                      _this6.getData();
                    } else {
                      Swal.fire(_this6.$t('Failed!'), _this6.$t('Delete failed'), 'warning');
                    }
                  });
                }
              });
