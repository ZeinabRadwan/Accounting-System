...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".refresh-btn[data-v-f493357e]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-f493357e],.export-pdf-btn[data-v-f493357e]{background:#f6fef4!important;border:none;border-radius:10px;color:#2ab930!important;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-f493357e],.save-btn[data-v-f493357e]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.btn-group.c-w-100[data-v-f493357e]{gap:10px}.card[data-v-f493357e]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-f493357e]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-f493357e]{padding:1.25rem}.form-control[data-v-f493357e]{background:#fff!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/inventory.vue?vue&type=template&id=f493357e&scoped=true
var render = function render() {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Code")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Name")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Stock In")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Stock Out")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Stock in Hand")))])])]), _vm._v(" "), _c('tbody', [_vm._l(_vm.inventoryData, function (data, i) {
    return _c('tr', {
      key: i
...
var update = injectStylesIntoStyleTag_default()(inventoryvue_type_style_index_0_id_f493357e_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_inventoryvue_type_style_index_0_id_f493357e_prod_scoped_true_lang_css = (inventoryvue_type_style_index_0_id_f493357e_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/reports/inventory.vue?vue&type=style&index=0&id=f493357e&prod&scoped=true&lang=css
