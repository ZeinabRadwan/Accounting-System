"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2736],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-00743680]{margin-bottom:15px}.footer-buttons[data-v-00743680]{display:flex;gap:10px}.footer-buttons .btn[data-v-00743680]{margin-right:10px}.footer-buttons .btn[data-v-00743680]:last-child{margin-right:0}.create-btn[data-v-00743680]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-00743680]:hover{background-color:#e9ecef}.edit-btn[data-v-00743680]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-00743680]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-00743680]{border:none!important}.quotations-create-table[data-v-00743680]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-00743680]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-00743680]{border:none!important}.quotations-create-table thead th[data-v-00743680]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-00743680]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-00743680]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-00743680]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-00743680]{gap:10px}.card[data-v-00743680]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-00743680]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-00743680]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-00743680]{background:#fff!important}.btn-primary[data-v-00743680]{background:#2ab930!important}.btn-secondary[data-v-00743680]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-00743680]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-00743680],.button-plus[data-v-00743680]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-00743680]{background-color:#dc3545;color:#fff}.button-plus[data-v-00743680]{background-color:#007bff;color:#fff}.button-minus[data-v-00743680]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-00743680]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-00743680]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-00743680]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-00743680]{direction:rtl}[dir=rtl] .create-btn[data-v-00743680]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-00743680]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-00743680]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-00743680]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-00743680]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-00743680]{border-right:1px solid #ced4da}.clickable-badge[data-v-00743680]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-00743680]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-00743680]:active{transform:scale(.95)}.insufficient-stock-input[data-v-00743680]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-00743680]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-00743680]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none!important}.debug-panel .card-header[data-v-00743680]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-00743680]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-00743680]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-00743680]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-00743680]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-00743680]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-00743680]:last-child{border-bottom:none}.debug-display[data-v-00743680]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-00743680]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-00743680]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-00743680]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-00743680]:last-child{border-bottom:none}.debug-panel .table th[data-v-00743680]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-00743680]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-00743680]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-00743680]{padding:15px}.debug-item .row[data-v-00743680]{margin:0}.debug-item .col-md-6[data-v-00743680]{padding:0 5px}.debug-step[data-v-00743680]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-00743680]{font-size:.75em}}.saudi-riyal[data-v-00743680]{color:#28a745;font-weight:700}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=00743680&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=00743680&scoped=true
...
/* harmony default export */ const invoicevue_type_script_lang_js = ({
  ...
  methods: {
    ...
    openStockAdjustmentModal: function openStockAdjustmentModal(item) {
      var _this11 = this;
      // This would open a stock adjustment modal
      // For now, we'll show an alert with instructions
      sweetalert2_all_default().fire({
        title: this.$t('Insufficient Stock'),
        text: "Product \"".concat(item.name, "\" has insufficient stock. Current: ").concat(item.inventoryCount, ", Required: ").concat(item.qty),
        icon: 'warning',
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=00743680&prod&lang=scss&scoped=true
var invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true = __webpack_require__(69408);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=00743680&prod&lang=scss&scoped=true

            

var invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true_options = {};

invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true_options.insert = "head";
invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true_options.singleton = false;

var invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true_update = injectStylesIntoStyleTag_default()(invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true/* default */.A, invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true_options);



/* harmony default export */ const quotations_invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true = (invoicevue_type_style_index_0_id_00743680_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=00743680&prod&lang=scss&scoped=true
