"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[476],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".error-content[data-v-139adab0],.loading-content[data-v-139adab0]{align-items:center;display:flex;flex-direction:column;justify-content:center;min-height:200px;padding:1rem;text-align:center}.spinner-border[data-v-139adab0]{height:3rem;width:3rem}@media (max-width:768px){.error-content[data-v-139adab0],.loading-content[data-v-139adab0]{min-height:150px;padding:.75rem}.error-content p[data-v-139adab0],.loading-content p[data-v-139adab0]{font-size:14px;margin-top:1rem}.spinner-border[data-v-139adab0]{height:2.5rem;width:2.5rem}}@media (max-width:480px){.error-content[data-v-139adab0],.loading-content[data-v-139adab0]{min-height:120px;padding:.5rem}.error-content p[data-v-139adab0],.loading-content p[data-v-139adab0]{font-size:13px;margin-top:.75rem}.spinner-border[data-v-139adab0]{height:2rem;width:2rem}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/auth/cross-domain-login.vue?vue&type=template&id=139adab0&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('auth-wrapper', {
    attrs: {
      "title": _vm.$t('Logging in')
    },
    scopedSlots: _vm._u([{
      key: "form",
      fn: function fn() {
        return [_vm.loading && !_vm.error ? _c('div', {
          ...
          staticClass: "mt-3"
        }, [_vm._v(_vm._s(_vm.$t('Processing your login')) + "...")])]) : _vm.error ? _c('div', {
...
var cross_domain_loginvue_type_style_index_0_id_139adab0_prod_scoped_true_lang_css = __webpack_require__(75993);
...
var update = injectStylesIntoStyleTag_default()(cross_domain_loginvue_type_style_index_0_id_139adab0_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const auth_cross_domain_loginvue_type_style_index_0_id_139adab0_prod_scoped_true_lang_css = (cross_domain_loginvue_type_style_index_0_id_139adab0_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/auth/cross-domain-login.vue?vue&type=style&index=0&id=139adab0&prod&scoped=true&lang=css
