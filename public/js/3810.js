"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3810],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-2fca6be2]{border:none!important}.expense-categories-table[data-v-2fca6be2]{border-collapse:separate;border-spacing:0}.expense-categories-table thead th[data-v-2fca6be2]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.expense-categories-table thead tr[data-v-2fca6be2]{border:none!important}.expense-categories-table thead th[data-v-2fca6be2]:first-child{border-top-left-radius:10px}.expense-categories-table thead th[data-v-2fca6be2]:last-child{border-top-right-radius:10px}[dir=rtl] .expense-categories-table thead th[data-v-2fca6be2]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .expense-categories-table thead th[data-v-2fca6be2]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-2fca6be2]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-2fca6be2],.export-pdf-btn[data-v-2fca6be2]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-2fca6be2],.export-pdf-btn[data-v-2fca6be2],.print-btn[data-v-2fca6be2]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-2fca6be2]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-2fca6be2]{gap:10px}.btn-group.c-w-100>.btn[data-v-2fca6be2]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-2fca6be2]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-2fca6be2]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-2fca6be2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-2fca6be2]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.action-dropdown[data-v-2fca6be2]{display:inline-block;position:relative}.action-menu[data-v-2fca6be2]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-icon-btn[data-v-2fca6be2]{align-items:center;background:#f8f9fa;border:1px solid #e5e7eb;border-radius:8px;cursor:pointer;display:flex;height:32px;justify-content:center;padding:8px;width:32px}.action-icon-btn[data-v-2fca6be2]:hover{background:#e9ecef}.action-menu-item[data-v-2fca6be2]{align-items:center;border-bottom:1px solid #f3f4f6;color:#374151;display:flex;font-size:14px;padding:10px 16px;text-decoration:none}.action-menu-item[data-v-2fca6be2]:last-child{border-bottom:none}.action-menu-item[data-v-2fca6be2]:hover{background:#f9fafb;color:#111827}.action-menu-item i[data-v-2fca6be2]{margin-right:8px;text-align:center;width:16px}.expense-categories-table .badge.bg-success[data-v-2fca6be2]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.expense-categories-table .badge.bg-danger[data-v-2fca6be2]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-2fca6be2]{background:#f1f5fb!important}.btn-primary[data-v-2fca6be2]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/index.vue?vue&type=template&id=2fca6be2&scoped=true
...
var update = injectStylesIntoStyleTag_default()(categoriesvue_type_style_index_0_id_2fca6be2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_categoriesvue_type_style_index_0_id_2fca6be2_prod_scoped_true_lang_css = (categoriesvue_type_style_index_0_id_2fca6be2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=0&id=2fca6be2&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=1&id=2fca6be2&prod&lang=css
var categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css = __webpack_require__(92992);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=1&id=2fca6be2&prod&lang=css

            

var categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css_options = {};

categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css_options.insert = "head";
categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css_options.singleton = false;

var categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css_update = injectStylesIntoStyleTag_default()(categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css/* default */.A, categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css_options);



/* harmony default export */ const expenses_categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css = (categoriesvue_type_style_index_1_id_2fca6be2_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/categories/index.vue?vue&type=style&index=1&id=2fca6be2&prod&lang=css
