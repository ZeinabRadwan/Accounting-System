(self["webpackChunk"] = self["webpackChunk"] || []).push([[3216],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-1662194b]{border:none!important}.increments-table[data-v-1662194b]{border-collapse:separate;border-spacing:0}.increments-table thead th[data-v-1662194b]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.increments-table thead tr[data-v-1662194b]{border:none!important}.increments-table thead th[data-v-1662194b]:first-child{border-top-left-radius:10px}.increments-table thead th[data-v-1662194b]:last-child{border-top-right-radius:10px}[dir=rtl] .increments-table thead th[data-v-1662194b]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .increments-table thead th[data-v-1662194b]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-1662194b]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-1662194b],.export-pdf-btn[data-v-1662194b]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-1662194b],.export-pdf-btn[data-v-1662194b],.print-btn[data-v-1662194b]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-1662194b]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-1662194b]{display:inline-block;position:relative}.action-icon-btn[data-v-1662194b]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-1662194b]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-1662194b]{animation:slideInRight-1662194b .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 20px 25px -5px rgba(0,0,0,.1),0 10px 10px -5px rgba(0,0,0,.04);max-width:250px;min-width:200px;position:fixed;right:50%;top:50%;transform:translate(50%,-50%);z-index:1000}.action-menu-header[data-v-1662194b]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-1662194b]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-1662194b]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-1662194b]:hover{background-color:#e5e7eb}.action-menu ul[data-v-1662194b]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-1662194b]{margin:0}.action-menu li a[data-v-1662194b]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-1662194b]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-1662194b]{flex-shrink:0;height:16px;width:16px}.action-menu-backdrop[data-v-1662194b]{animation:fadeIn-1662194b .3s ease-out;background:rgba(0,0,0,.5);bottom:0;left:0;position:fixed;right:0;top:0;z-index:999}@keyframes slideInRight-1662194b{0%{opacity:0;transform:translate(50%,-50%) translateX(20px)}to{opacity:1;transform:translate(50%,-50%) translateX(0)}}@keyframes fadeIn-1662194b{0%{opacity:0}to{opacity:1}}.btn-group.c-w-100[data-v-1662194b]{gap:10px}.btn-group.c-w-100>.btn[data-v-1662194b]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-1662194b]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-1662194b]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-1662194b]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-1662194b]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.increments-table .badge.bg-success[data-v-1662194b]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.increments-table .badge.bg-danger[data-v-1662194b]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-1662194b]{background:#f1f5fb!important}.btn-primary[data-v-1662194b]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-1662194b]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-1662194b]{align-items:center;color:#6c757d;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/increments/index.vue?vue&type=template&id=1662194b&scoped=true
...
var update = injectStylesIntoStyleTag_default()(incrementsvue_type_style_index_0_id_1662194b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const employees_incrementsvue_type_style_index_0_id_1662194b_prod_scoped_true_lang_css = (incrementsvue_type_style_index_0_id_1662194b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/employees/increments/index.vue?vue&type=style&index=0&id=1662194b&prod&scoped=true&lang=css
