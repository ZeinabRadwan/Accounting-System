"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8650],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-b4c71a62]{gap:10px}.header-buttons[data-v-b4c71a62]{margin-bottom:15px}.footer-buttons[data-v-b4c71a62]{display:flex;gap:10px}.footer-buttons .btn[data-v-b4c71a62]{margin-right:10px}.footer-buttons .btn[data-v-b4c71a62]:last-child{margin-right:0}.card[data-v-b4c71a62]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-body[data-v-b4c71a62]{padding:1.25rem}.card-footer[data-v-b4c71a62]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-b4c71a62]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-b4c71a62]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-b4c71a62]{color:#374151;display:block;font-weight:500;margin:0 20px}.required[data-v-b4c71a62]{color:#dc3545;font-weight:700}.btn-primary[data-v-b4c71a62]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-b4c71a62]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-b4c71a62]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-b4c71a62]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-b4c71a62]{border-color:#dc3545!important}textarea.form-control[data-v-b4c71a62]{min-height:100px;resize:vertical}.v-select[data-v-b4c71a62]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-b4c71a62]{background:#fff!important;border:1px solid #e5e7eb;padding:10px 16px}.v-select .vs__search[data-v-b4c71a62]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-b4c71a62]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-b4c71a62]{color:#374151}.v-select .vs__dropdown-menu[data-v-b4c71a62]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.custom-file-input[data-v-b4c71a62],.custom-file-label[data-v-b4c71a62]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px}.custom-file-label[data-v-b4c71a62]{color:#374151}.custom-file-input:focus~.custom-file-label[data-v-b4c71a62]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.bg-light[data-v-b4c71a62]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px}.img-fluid[data-v-b4c71a62]{border-radius:8px;height:auto;max-width:100%}.form-check-input[data-v-b4c71a62]{background:#fff!important;border:1px solid #e5e7eb;border-radius:4px}.form-check-input[data-v-b4c71a62]:checked{background-color:#2ab930!important;border-color:#2ab930!important}.form-check-label[data-v-b4c71a62],.input-group-text[data-v-b4c71a62]{color:#374151;font-weight:500}.input-group-text[data-v-b4c71a62]{background:#fff!important;border:1px solid #e5e7eb}.btn-outline-custom[data-v-b4c71a62]{border-color:#33a0d9;border-radius:10px;color:#33a0d9;font-weight:500;padding:8px 16px;transition:background-color .3s,color .3s,border-color .3s}.btn-custom-active[data-v-b4c71a62],.btn-outline-custom[data-v-b4c71a62]:hover{background-color:#33a0d9;border-color:#33a0d9;color:#fff}.form-group .btn-outline-custom[data-v-b4c71a62]{border-color:#33a0d9;color:#33a0d9}.form-group .btn-custom-active[data-v-b4c71a62]{background-color:#33a0d9;border-color:#33a0d9;color:#fff}.row[data-v-b4c71a62]{margin-bottom:1rem}.form-text[data-v-b4c71a62]{color:#6b7280;font-size:.875rem}.text-muted[data-v-b4c71a62]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-b4c71a62]{flex-direction:column;gap:10px}.card-footer .btn[data-v-b4c71a62]{margin-right:0!important;width:100%}.card-footer div[data-v-b4c71a62]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/create.vue?vue&type=template&id=b4c71a62&scoped=true
...
;// ./resources/js/pages/products/create.vue?vue&type=template&id=b4c71a62&scoped=true
                ...
                if (((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 422 && (_error$response2 = error.response) !== null && _error$response2 !== void 0 && (_error$response2 = _error$response2.data) !== null && _error$response2 !== void 0 && _error$response2.errors) {
                  ...
                  Object.keys(error.response.data.errors).forEach(function (field) {
                    translatedErrors[field] = error.response.data.errors[field].map(function (message) {
                      ...
                      return _this0.$t(translationKey) !== translationKey ? _this0.$t(translationKey) : message;
                    });
                  });

                  // Set the translated errors back to the form
                  _this0.form.errors.set(translatedErrors);
                  ...
                  // Handle other errors
                  var errorMessage = ((_error$response3 = error.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || _this0.$t("Please check your input and try again.");
                  toast.fire({
                    type: "error",
                    title: errorMessage
                  });
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_b4c71a62_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const products_createvue_type_style_index_0_id_b4c71a62_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_b4c71a62_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/products/create.vue?vue&type=style&index=0&id=b4c71a62&prod&scoped=true&lang=css
