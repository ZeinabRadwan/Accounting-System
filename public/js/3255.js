"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3255],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/suppliers/non-purchase/create.vue?vue&type=template&id=1cccf605&scoped=true
...
var createvue_type_style_index_0_id_1cccf605_prod_scoped_true_lang_css = __webpack_require__(91975);
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_1cccf605_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const non_purchase_createvue_type_style_index_0_id_1cccf605_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_1cccf605_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payments/suppliers/non-purchase/create.vue?vue&type=style&index=0&id=1cccf605&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-1cccf605]{gap:10px}.header-buttons[data-v-1cccf605]{margin-bottom:15px}.card[data-v-1cccf605]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-1cccf605]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-1cccf605]{padding:1.25rem}.card-footer[data-v-1cccf605]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.footer-buttons[data-v-1cccf605]{display:flex;gap:10px}.footer-buttons .btn[data-v-1cccf605]{margin-right:10px}.footer-buttons .btn[data-v-1cccf605]:last-child{margin-right:0}.form-control[data-v-1cccf605]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-1cccf605]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-1cccf605]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-1cccf605]{color:#dc3545;font-weight:700}.btn-primary[data-v-1cccf605]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-1cccf605]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-1cccf605]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-1cccf605]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-1cccf605]{border-color:#dc3545!important}textarea.form-control[data-v-1cccf605]{min-height:100px;resize:vertical}.v-select[data-v-1cccf605]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-1cccf605]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-1cccf605]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-1cccf605]{border-color:#dc3545!important}.row[data-v-1cccf605]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-1cccf605]{flex-direction:column;gap:10px}.card-footer .btn[data-v-1cccf605]{margin-right:0!important;width:100%}.card-footer div[data-v-1cccf605]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
