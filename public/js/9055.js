...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/form.vue?vue&type=template&id=0d51845f&scoped=true
...
;// ./resources/js/pages/sales/returns/form.vue?vue&type=template&id=0d51845f&scoped=true
...
var update = injectStylesIntoStyleTag_default()(formvue_type_style_index_0_id_0d51845f_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_formvue_type_style_index_0_id_0d51845f_prod_scoped_true_lang_css = (formvue_type_style_index_0_id_0d51845f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/form.vue?vue&type=style&index=0&id=0d51845f&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-0d51845f]{margin-bottom:15px}.footer-buttons[data-v-0d51845f]{display:flex;gap:10px}.footer-buttons .btn[data-v-0d51845f]{margin-right:10px}.footer-buttons .btn[data-v-0d51845f]:last-child{margin-right:0}.table-custom[data-v-0d51845f]{border:none!important}.invoices-create-table[data-v-0d51845f]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-0d51845f]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-0d51845f]{border:none!important}.invoices-create-table thead th[data-v-0d51845f]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-0d51845f]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-0d51845f]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-0d51845f]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-0d51845f]{gap:10px}.card[data-v-0d51845f]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-0d51845f]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-info[data-v-0d51845f]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-0d51845f]{background:#fff!important}.btn-primary[data-v-0d51845f]{background:#2ab930!important}.btn-secondary[data-v-0d51845f]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.quantity-field[data-v-0d51845f]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-0d51845f]{font-size:.875rem}.account-status .account-warning[data-v-0d51845f]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-0d51845f]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}", ""]);
// Exports
