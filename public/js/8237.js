"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8237],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card[data-v-f4f01f76]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-f4f01f76]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-f4f01f76]{padding:1.25rem}.card-footer[data-v-f4f01f76]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.refresh-btn[data-v-f4f01f76]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-f4f01f76],.export-pdf-btn[data-v-f4f01f76]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-f4f01f76],.export-pdf-btn[data-v-f4f01f76],.print-btn[data-v-f4f01f76]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-f4f01f76]{background:#33a0d91a!important;color:#33a0d9!important}.btn-primary[data-v-f4f01f76]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.pricing-wrap h2[data-v-f4f01f76]{color:#4c4e51;font-size:15px}.subscribe-plan[data-v-f4f01f76]{align-items:center;display:flex;justify-content:space-between}.subscribe-plan img[data-v-f4f01f76]{max-width:100px}.subscribe-plan>div p[data-v-f4f01f76]{font-size:18px;font-weight:400;margin-bottom:0}.switch-plan[data-v-f4f01f76]{justify-content:space-between;margin-top:30px}.resume-alert[data-v-f4f01f76]{background:#dc3545;border-radius:8px;color:#fff;font-size:18px;padding:20px}.resume-subs-block p[data-v-f4f01f76]{margin-bottom:0;margin-right:9px}.resume-subs-block[data-v-f4f01f76]{display:flex;justify-content:flex-end;margin-top:11px}.small-text[data-v-f4f01f76]{font-size:10px}.card-icon.bg-brand-primary[data-v-f4f01f76]{background:linear-gradient(135deg,#33a0d9,#2a8bc7)!important;border:1px solid rgba(51,160,217,.3);border-radius:20px}.card-icon.bg-brand-light-blue[data-v-f4f01f76]{background:linear-gradient(135deg,#ebf6fc,#d6edf7)!important;border:1px solid rgba(235,246,252,.5);border-radius:20px;color:#33a0d9!important}.card-icon.bg-brand-light-green[data-v-f4f01f76]{background:linear-gradient(135deg,#f6fef4,#e8f5e8)!important;border:1px solid rgba(246,254,244,.5);border-radius:20px;color:#33a0d9!important}.card-icon.bg-brand-green[data-v-f4f01f76]{background:linear-gradient(135deg,#2ab930,#239a26)!important;border:1px solid rgba(42,185,48,.3);border-radius:20px}.card-icon.bg-brand-dark-blue[data-v-f4f01f76]{background:linear-gradient(135deg,#33a0d9,#152a4a)!important;border:1px solid rgba(27,60,113,.3);border-radius:20px}.card-icon.bg-brand-teal[data-v-f4f01f76]{background:linear-gradient(135deg,#449eae,#3a8a98)!important;border:1px solid rgba(68,158,174,.3);border-radius:20px}.card-icon.bg-brand-dark-teal[data-v-f4f01f76]{background:linear-gradient(135deg,#377578,#2d5f61)!important;border:1px solid rgba(55,117,120,.3);border-radius:20px}.card-icon.bg-brand-light-blue i[data-v-f4f01f76],.card-icon.bg-brand-light-green i[data-v-f4f01f76]{color:#33a0d9!important}.card-icon.bg-brand-dark-blue i[data-v-f4f01f76],.card-icon.bg-brand-dark-teal i[data-v-f4f01f76],.card-icon.bg-brand-green i[data-v-f4f01f76],.card-icon.bg-brand-primary i[data-v-f4f01f76],.card-icon.bg-brand-teal i[data-v-f4f01f76]{color:#fff!important}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".price-single[data-v-60d3a5a0]{align-items:flex-start;border:2px solid #c9cafa5c;border-radius:5px;cursor:pointer;display:flex;margin:0 0 10px!important;padding:15px 14px!important;position:relative;width:100%}.price-single img[data-v-60d3a5a0]{max-width:80px}.price-single ul[data-v-60d3a5a0]{display:grid;grid-template-columns:1fr 1fr;list-style:none;margin:8px 0 0;padding:0}.price-single ul li[data-v-60d3a5a0]{color:#8b8f95;font-size:12px;margin-right:12px}.price-single ul li span[data-v-60d3a5a0]{color:#33a0d9}.price-single .price-badge[data-v-60d3a5a0]{background:#33a0d9;border-top-left-radius:12px;bottom:0;position:absolute}.activePlanText[data-v-60d3a5a0],.price-single .price-badge[data-v-60d3a5a0]{color:#fff;font-size:13px;margin:0;padding:3px 8px;right:0}.activePlanText[data-v-60d3a5a0]{background:green;border-radius:3px;top:12px}label.price-single.selected[data-v-60d3a5a0]{border-color:#33a0d9}.current-plan[data-v-60d3a5a0]{background:#ddd;border:2px solid green;cursor:no-drop!important;opacity:1}.line-through[data-v-60d3a5a0]{text-decoration:line-through}.small-text[data-v-60d3a5a0]{font-size:11px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/billing.vue?vue&type=template&id=f4f01f76&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/billing/Plans.vue?vue&type=template&id=60d3a5a0&scoped=true
var Plansvue_type_template_id_60d3a5a0_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
var Plansvue_type_template_id_60d3a5a0_scoped_true_staticRenderFns = [];

;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/billing/Plans.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./resources/js/components/billing/Plans.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(Plansvue_type_style_index_0_id_60d3a5a0_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const billing_Plansvue_type_style_index_0_id_60d3a5a0_prod_lang_scss_scoped_true = (Plansvue_type_style_index_0_id_60d3a5a0_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/components/billing/Plans.vue?vue&type=style&index=0&id=60d3a5a0&prod&lang=scss&scoped=true

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/components/billing/Plans.vue
...
var component = (0,componentNormalizer/* default */.A)(
  ...
  Plansvue_type_template_id_60d3a5a0_scoped_true_render,
  Plansvue_type_template_id_60d3a5a0_scoped_true_staticRenderFns,
  false,
  null,
  "60d3a5a0",
  null
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/billing.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./resources/js/pages/settings/billing.vue?vue&type=script&lang=js
 /* harmony default export */ const settings_billingvue_type_script_lang_js = (billingvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/billing.vue?vue&type=style&index=0&id=f4f01f76&prod&scoped=true&lang=css
var billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css = __webpack_require__(60291);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/billing.vue?vue&type=style&index=0&id=f4f01f76&prod&scoped=true&lang=css

            

var billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css_options = {};

billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css_options.insert = "head";
billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css_options.singleton = false;

var billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css/* default */.A, billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css_options);



/* harmony default export */ const settings_billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css = (billingvue_type_style_index_0_id_f4f01f76_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/settings/billing.vue?vue&type=style&index=0&id=f4f01f76&prod&scoped=true&lang=css

;// CONCATENATED MODULE: ./resources/js/pages/settings/billing.vue
