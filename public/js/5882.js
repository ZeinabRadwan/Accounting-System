(self["webpackChunk"] = self["webpackChunk"] || []).push([[5882],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-e04da8c6]{border:none!important}.purchase-returns-table[data-v-e04da8c6]{border-collapse:separate;border-spacing:0}.purchase-returns-table thead th[data-v-e04da8c6]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchase-returns-table thead tr[data-v-e04da8c6]{border:none!important}.purchase-returns-table thead th[data-v-e04da8c6]:first-child{border-top-left-radius:10px}.purchase-returns-table thead th[data-v-e04da8c6]:last-child{border-top-right-radius:10px}[dir=rtl] .purchase-returns-table thead th[data-v-e04da8c6]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchase-returns-table thead th[data-v-e04da8c6]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-e04da8c6]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-e04da8c6],.export-pdf-btn[data-v-e04da8c6]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-e04da8c6],.export-pdf-btn[data-v-e04da8c6],.print-btn[data-v-e04da8c6]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-e04da8c6]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-e04da8c6]{display:inline-block;position:relative}.action-icon-btn[data-v-e04da8c6]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-e04da8c6]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-e04da8c6]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-e04da8c6]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-e04da8c6]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-e04da8c6]{gap:10px}.btn-group.c-w-100>.btn[data-v-e04da8c6]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-e04da8c6]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-e04da8c6]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-e04da8c6]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-e04da8c6]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.purchase-returns-table .badge.bg-success[data-v-e04da8c6]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.purchase-returns-table .badge.bg-danger[data-v-e04da8c6]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-e04da8c6]{background:#f1f5fb!important}.btn-primary[data-v-e04da8c6]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/index.vue?vue&type=template&id=e04da8c6&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_c('ul', [_vm.$can('invoice-return-view') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'purchaseReturns.show',
          params: {
...
var update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_0_id_e04da8c6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_returnsvue_type_style_index_0_id_e04da8c6_prod_scoped_true_lang_css = (returnsvue_type_style_index_0_id_e04da8c6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/index.vue?vue&type=style&index=0&id=e04da8c6&prod&scoped=true&lang=css
