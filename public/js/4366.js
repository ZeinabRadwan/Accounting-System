"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4366],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-4f84d4ae]{margin-bottom:15px}.footer-buttons[data-v-4f84d4ae]{display:flex;gap:10px}.footer-buttons .btn[data-v-4f84d4ae]{margin-right:10px}.footer-buttons .btn[data-v-4f84d4ae]:last-child{margin-right:0}.create-btn[data-v-4f84d4ae]{padding:11px}.button-plus.icon-shape.icon-sm.btn-primary[data-v-4f84d4ae]{padding:0}.btn-primary[data-v-4f84d4ae]{background:#2ab930!important}.btn-primary[data-v-4f84d4ae]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-4f84d4ae]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}.table-custom[data-v-4f84d4ae]{border:none!important}.invoices-create-table[data-v-4f84d4ae]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-4f84d4ae]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.btn-group.c-w-100[data-v-4f84d4ae]{gap:10px}.card[data-v-4f84d4ae]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-4f84d4ae]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-4f84d4ae]{background:#fff!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchase-order/edit.vue?vue&type=template&id=4f84d4ae&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_4f84d4ae_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchase_order_editvue_type_style_index_0_id_4f84d4ae_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_4f84d4ae_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/purchase-order/edit.vue?vue&type=style&index=0&id=4f84d4ae&prod&scoped=true&lang=css
