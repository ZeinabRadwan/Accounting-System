...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".account-status .account-warning[data-v-96df93d6],.account-status .client-warning[data-v-96df93d6],.account-status .product-warning[data-v-96df93d6],.client-status .account-warning[data-v-96df93d6],.client-status .client-warning[data-v-96df93d6],.client-status .product-warning[data-v-96df93d6],.product-status .account-warning[data-v-96df93d6],.product-status .client-warning[data-v-96df93d6],.product-status .product-warning[data-v-96df93d6]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;color:#856404;font-size:.875rem;padding:8px 12px}.account-status .account-success[data-v-96df93d6],.account-status .client-success[data-v-96df93d6],.account-status .product-success[data-v-96df93d6],.client-status .account-success[data-v-96df93d6],.client-status .client-success[data-v-96df93d6],.client-status .product-success[data-v-96df93d6],.product-status .account-success[data-v-96df93d6],.product-status .client-success[data-v-96df93d6],.product-status .product-success[data-v-96df93d6]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:4px;color:#155724;font-size:.875rem;padding:8px 12px}.create-btn[data-v-96df93d6]{background-color:#007bff;border-left:none;border-color:#007bff;color:#fff;cursor:pointer}.create-btn[data-v-96df93d6]:hover{background-color:#0056b3;border-color:#0056b3}.radio-group-horizontal[data-v-96df93d6]{display:flex;gap:20px}.radio-group-horizontal .form-check[data-v-96df93d6]{align-items:center;display:flex;gap:8px}.custom-qty-input .button-minus[data-v-96df93d6],.custom-qty-input .button-plus[data-v-96df93d6]{border:none;border-radius:0;height:30px;width:30px}.custom-qty-input .quantity-field[data-v-96df93d6]{border-left:none;border-right:none;text-align:center;width:60px}.table-custom td[data-v-96df93d6],.table-custom th[data-v-96df93d6]{vertical-align:middle}.invalid-feedback[data-v-96df93d6]{display:block;margin-top:5px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=96df93d6&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// CONCATENATED MODULE: ./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=96df93d6&scoped=true
...
/* harmony default export */ const editvue_type_script_lang_js = ({
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return axios_default().get(window.location.origin + '/api/invoices/' + _this7.$route.params.slug);
            case 3:
              _yield$axios$get4 = _context5.sent;
              data = _yield$axios$get4.data;
              _this7.form.invoiceNo = data.data.invoiceNo;
              _this7.form.client = data.data.client;
              _this7.form.reference = data.data.reference;
              _this7.form.poReference = data.data.poReference;
              _this7.form.paymentTerms = data.data.paymentTerms;
              _this7.form.deliveryPlace = data.data.deliveryPlace;
              _this7.form.date = data.data.invoiceDate;
              _this7.form.note = data.data.note;
              _this7.form.status = data.data.status;
              _this7.form.transportCost = data.data.transport;
              _this7.form.totalTax = data.data.tax;
              _this7.form.orderTax = data.data.taxRate;
              _this7.form.netTotal = Number(data.data.invoiceTotal);
              _this7.form.subTotal = Number(data.data.subTotal);
              _this7.form.totalPaid = Number(data.data.totalPaid);
              _this7.form.dueAmount = Number(data.data.due);
              _this7.form.selectedProducts = _this7.assignProducts(data.data.invoiceProducts);
              if (data.data.payment) {
                _this7.form.addPayment = 1;
                _this7.form.account = data.data.payment.account;
                _this7.form.paidAmount = data.data.payment.amount;
                _this7.form.chequeNo = data.data.payment.chequeNo;
                _this7.form.receiptNo = data.data.payment.receiptNo;
              }
              _this7.form.isSendEmail = data.data.isSendEmail || false;
              _this7.form.isSendSMS = data.data.isSendSMS || false;
              _this7.form.discountType = data.data.discountType || 0;
              _this7.form.discount = data.data.discount || 0;
              _this7.form.totalDiscount = data.data.totalDiscount || 0;
              _context5.next = 33;
              break;
            case 30:
              _context5.prev = 30;
              _context5.t0 = _context5["catch"](0);
              console.error('Error getting invoice:', _context5.t0);
            case 33:
            case "end":
              return _context5.stop();
          }
    ...
    assignProducts: function assignProducts(products) {
      ...
      var _loop = function _loop() {
        ...
        _this8.form.selectedProducts.unshift({
          ...
          selectedVatRate: invoiceItem.vat_rate_id ? _this8.taxes.find(function (tax) {
            return tax.id === invoiceItem.vat_rate_id;
          }) : _this8.form.orderTax,
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 8:
              ...
              console.error('Form submission error:', _context6.t0);
            case 11:
              _context6.prev = 11;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 16:
              _yield$_this10$form$p = _context7.sent;
            ...
            case 22:
              ...
              _this10.loading = false;
              if (((_error$response = _context7.t0.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 422) {
              ...
              } else if (((_error$response2 = _context7.t0.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 404) {
                toast.fire({
                  type: "error",
                  title: _this10.$t("Not Found"),
                  text: _this10.$t("Invoice not found.")
                });
              } else if (((_error$response3 = _context7.t0.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 403) {
                toast.fire({
                  type: "error",
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      var _this11 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        var _yield$axios$post, data, _error$response4, errorMessage;
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
            ...
            case 7:
              ...
              if (data.success) {
                _this11.form.client.chart_of_account_id = data.data.chart_of_account_id;
                toast.fire({
                  type: "success",
            ...
            case 12:
              ...
              if ((_error$response4 = _context8.t0.response) !== null && _error$response4 !== void 0 && (_error$response4 = _error$response4.data) !== null && _error$response4 !== void 0 && _error$response4.message) {
        ...
        }, _callee8, null, [[4, 12, 18, 21]]);
      }))();
    },
    autoAssignProductChartOfAccount: function autoAssignProductChartOfAccount(product) {
      var _this12 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        var _yield$axios$post2, data, _error$response5, errorMessage;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              if (product) {
            ...
            case 7:
              _yield$axios$post2 = _context9.sent;
            ...
            case 12:
              ...
              console.error('Error auto-assigning sales account:', _context9.t0);
              errorMessage = _this12.$t("An error occurred while assigning Sales Account.");
              if ((_error$response5 = _context9.t0.response) !== null && _error$response5 !== void 0 && (_error$response5 = _error$response5.data) !== null && _error$response5 !== void 0 && _error$response5.message) {
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=96df93d6&prod&lang=scss&scoped=true
var editvue_type_style_index_0_id_96df93d6_prod_lang_scss_scoped_true = __webpack_require__(77167);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=96df93d6&prod&lang=scss&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_96df93d6_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const invoices_editvue_type_style_index_0_id_96df93d6_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_96df93d6_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=96df93d6&prod&lang=scss&scoped=true
