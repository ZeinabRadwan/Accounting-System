...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=96df93d6&scoped=true
...
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=96df93d6&scoped=true
  ...
  methods: {
    ...
    getClients: function getClients() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var selectedClient, defaultClientSlug, _t;
    ...
    getAccounts: function getAccounts() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _yield$axios$get2, data, defaultAccountSlug, _t3;
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            ...
            case 2:
              _context5.p = 2;
              _t5 = _context5.v;
              console.error('Error getting invoice:', _t5);
            case 3:
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 4:
              _context6.p = 4;
              _t6 = _context6.v;
              console.error('Form submission error:', _t6);
            case 5:
              _context6.p = 5;
    ...
    updateInvoice: function updateInvoice() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var validationErrors, productsWithoutSalesAccount, productNames, paymentValidation, _yield$_this0$form$pa, data, _error$response, _error$response2, _error$response3, errors, _t7;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              ...
              if (!_this0.form.client || !_this0.form.client.chart_of_account_id) {
                validationErrors.push({
                  ...
                  message: _this0.$t("Client must have a Chart of Account assigned before updating an invoice."),
                  field: "client"
                });
              }
              if (!_this0.form.selectedProducts || _this0.form.selectedProducts.length === 0) {
                validationErrors.push({
                  ...
                  message: _this0.$t("Please select at least one product to update an invoice."),
                  field: "selectedProducts"
                });
              }
            ...
            case 1:
              _this0.loading = true;
              _context7.n = 2;
              return _this0.form.patch(window.location.origin + "/api/invoices/" + _this0.$route.params.slug);
            case 2:
              _yield$_this0$form$pa = _context7.v;
              data = _yield$_this0$form$pa.data;
              _this0.loading = false;
              if (data.success) {
                toast.fire({
                  type: "success",
                  title: _this0.$t("Success"),
                  text: _this0.$t("Invoice updated successfully")
                });
                _this0.$router.push({
                  name: "invoices.show",
                  params: {
            ...
            case 3:
              ...
              if (((_error$response = _t7.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 422) {
                ...
                Object.keys(errors).forEach(function (field) {
                  _this0.form.errors.set(field, errors[field][0]);
                });
                toast.fire({
                  type: "error",
                  title: _this0.$t("Validation Error"),
                  text: _this0.$t("Please check the form for errors.")
                });
              } else if (((_error$response2 = _t7.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 404) {
                toast.fire({
                  type: "error",
                  title: _this0.$t("Not Found"),
                  text: _this0.$t("Invoice not found.")
                });
              } else if (((_error$response3 = _t7.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this0.$t("Permission Denied"),
                  text: _this0.$t("You don't have permission to update this invoice.")
                });
              } else {
                toast.fire({
                  type: "error",
                  title: _this0.$t("Error"),
                  text: _this0.$t("An error occurred while updating the invoice. Please try again.")
                });
              }
            case 4:
              return _context7.a(2);
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var _yield$axios$post, data, _error$response4, errorMessage, _t8;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              if (_this1.form.client) {
                _context8.n = 1;
                break;
              }
              toast.fire({
                type: "error",
                title: _this1.$t("No Client Selected"),
                text: _this1.$t("Please select a client first.")
              });
              return _context8.a(2);
            case 1:
              _this1.isAutoAssigningClient = true;
              _context8.p = 2;
              _context8.n = 3;
              return axios_default().post(window.location.origin + "/api/clients/" + _this1.form.client.slug + "/auto-assign-chart-of-account");
            case 3:
              _yield$axios$post = _context8.v;
              data = _yield$axios$post.data;
              if (data.success) {
                _this1.form.client.chart_of_account_id = data.data.chart_of_account_id;
                toast.fire({
                  type: "success",
                  title: _this1.$t("Success"),
                  text: _this1.$t("Chart of Account assigned successfully to client.")
                });
              } else {
                toast.fire({
                  type: "error",
                  title: _this1.$t("Error"),
                  text: data.message || _this1.$t("Failed to assign Chart of Account.")
                });
              }
              _context8.n = 5;
              break;
            case 4:
              _context8.p = 4;
              _t8 = _context8.v;
              console.error('Error auto-assigning chart of account:', _t8);
              errorMessage = _this1.$t("An error occurred while assigning Chart of Account.");
              if ((_error$response4 = _t8.response) !== null && _error$response4 !== void 0 && (_error$response4 = _error$response4.data) !== null && _error$response4 !== void 0 && _error$response4.message) {
            ...
            case 5:
              _context8.p = 5;
              _this1.isAutoAssigningClient = false;
    ...
    autoAssignProductChartOfAccount: function autoAssignProductChartOfAccount(product) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var _yield$axios$post2, data, _error$response5, errorMessage, _t9;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              ...
              toast.fire({
                type: "error",
                title: _this10.$t("No Product Selected"),
                text: _this10.$t("Please select a product first.")
              });
            ...
            case 3:
              _yield$axios$post2 = _context9.v;
              ...
              if (data.success) {
                ...
                toast.fire({
                  ...
                  text: _this10.$t("Sales Account assigned successfully to product.")
                });
              } else {
                toast.fire({
                  type: "error",
                  title: _this10.$t("Error"),
                  text: data.message || _this10.$t("Failed to assign Sales Account.")
                });
              }
              _context9.n = 5;
              break;
            case 4:
              _context9.p = 4;
              _t9 = _context9.v;
              console.error('Error auto-assigning sales account:', _t9);
              errorMessage = _this10.$t("An error occurred while assigning Sales Account.");
              if ((_error$response5 = _t9.response) !== null && _error$response5 !== void 0 && (_error$response5 = _error$response5.data) !== null && _error$response5 !== void 0 && _error$response5.message) {
            ...
            case 5:
              _context9.p = 5;
              _this10.isAutoAssigningProduct = null;
...
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=96df93d6&prod&lang=scss&scoped=true
