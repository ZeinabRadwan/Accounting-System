(self["webpackChunk"] = self["webpackChunk"] || []).push([[8046],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/pos/create.vue?vue&type=template&id=bb9d0ccc&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_bb9d0ccc_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const pos_createvue_type_style_index_0_id_bb9d0ccc_prod_lang_scss_scoped_true = (createvue_type_style_index_0_id_bb9d0ccc_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/pos/create.vue?vue&type=style&index=0&id=bb9d0ccc&prod&lang=scss&scoped=true
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-bb9d0ccc]{margin-bottom:15px}.table-price-counter-nowrap[data-v-bb9d0ccc]{display:flex;flex-wrap:nowrap}.table-product-title[data-v-bb9d0ccc]{max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pos-r-head[data-v-bb9d0ccc]{border-bottom:1px solid #f3f3f3;border-radius:5px;box-shadow:0 0 3px #0003;box-sizing:border-box;padding:20px}.pos-logo[data-v-bb9d0ccc]{text-align:center}.pos-item-grid[data-v-bb9d0ccc]{grid-gap:10px;display:grid;grid-template-columns:1fr 1fr 1fr 1fr 1fr 1fr}.pos-item-grid>div[data-v-bb9d0ccc]{border:1px solid #fff;border-radius:10px;box-shadow:0 4px 20px 1px rgba(0,0,0,.06),0 1px 4px rgba(0,0,0,.08);cursor:pointer;overflow:hidden;position:relative}.pos-item-grid>div[data-v-bb9d0ccc]:hover{border-color:#33a0d9}.pos-item-grid>div .box-qty[data-v-bb9d0ccc]{background:#33a0d9;border-bottom-right-radius:10px;color:#fff;display:block;font-size:12px;font-weight:700;height:30px;left:0;line-height:30px;position:absolute;text-align:center;top:0;width:50px}.qty-red[data-v-bb9d0ccc]{background:red!important}.pos-body[data-v-bb9d0ccc]{border-radius:5px;min-height:240px}.pos-box-img[data-v-bb9d0ccc]{background:#ebebeb;border-bottom:1px solid #f1f1f1;font-size:13px;font-weight:700;height:100px;line-height:100px;text-align:center;width:100%}.pos-box-img img[data-v-bb9d0ccc]{height:100px;-o-object-fit:cover;object-fit:cover;width:100%}.pos-box-content p[data-v-bb9d0ccc]{font-size:14px;font-weight:700;margin-bottom:0}.pos-box-content span[data-v-bb9d0ccc]{font-size:12px;margin-bottom:2px}.pos-box-content[data-v-bb9d0ccc]{padding:5px 10px}.pos-item-grid-red[data-v-bb9d0ccc]{border-color:red!important}.card-client-search[data-v-bb9d0ccc]{border-bottom:1px solid #ddd;padding:20px}.table-wrap[data-v-bb9d0ccc]{padding:15px}.table-responsive.table-wrap>table[data-v-bb9d0ccc]{border:1px solid #ddd}.table-wrap .table thead tr[data-v-bb9d0ccc]{background:#33a0d91f!important;border-bottom:0}.table-wrap .incrementor[data-v-bb9d0ccc]{width:80px}.table-wrap .custom-qty-input[data-v-bb9d0ccc]{border:1px solid #ececfdb8;border-radius:18px;display:inline-flex!important;justify-content:center;padding:0}.table-wrap .btn-danger[data-v-bb9d0ccc]{font-size:10px;height:25px;padding:0;width:25px}.table-wrap .icon-sm[data-v-bb9d0ccc]{height:25px;line-height:23px;width:25px}.pos-card-footer[data-v-bb9d0ccc]{background:#fff;border:1px solid #ddd;border-radius:4px;margin-bottom:15px}.pos-net-total[data-v-bb9d0ccc]{background:#33a0d933;font-size:22px;font-weight:700;padding:10px;text-align:center;width:100%}.product[data-v-bb9d0ccc]{cursor:pointer}.product .info-box[data-v-bb9d0ccc]:hover{background:#e0e0e0}.dark-mode .pos-body[data-v-bb9d0ccc],.dark-mode .pos-r-head[data-v-bb9d0ccc]{background:#111827!important;border-color:#000}.dark-mode .pos-item-grid>div[data-v-bb9d0ccc]{border-color:#6c757d!important}.dark-mode .pos-box-content[data-v-bb9d0ccc]{color:#fff;padding:5px 10px}.dark-mode .pos-item-grid>div.pos-item-grid-red[data-v-bb9d0ccc]{border-color:red!important}.dark-mode .card-client-search[data-v-bb9d0ccc]{border-color:#6c757d}.dark-mode .table-striped tbody tr[data-v-bb9d0ccc]:nth-of-type(odd){background-color:#1f2937}.dark-mode .table-responsive.table-wrap>table[data-v-bb9d0ccc]{border:1px solid #6c757d}.dark-mode .table-wrap .incrementor[data-v-bb9d0ccc]{border:none!important}.dark-mode .pos-card-footer.bg-white[data-v-bb9d0ccc]{background:#111827!important;border-color:#6c757d}.dark-mode .pos-card-footer label[data-v-bb9d0ccc]{color:#fff}.dark-mode .pos-net-total[data-v-bb9d0ccc]{background:#63a9f1;color:#fff}#invoice-POS table[data-v-bb9d0ccc],#invoice-POS td[data-v-bb9d0ccc],#invoice-POS th[data-v-bb9d0ccc],#invoice-POS tr[data-v-bb9d0ccc]{border-collapse:collapse}#invoice-POS tr[data-v-bb9d0ccc]{border-bottom:2px dotted #05070b}#invoice-POS table[data-v-bb9d0ccc]{width:100%}#invoice-POS tfoot tr th[data-v-bb9d0ccc]:first-child{text-align:left}#invoice-POS .info[data-v-bb9d0ccc]{margin-bottom:20px}#invoice-POS .info>p[data-v-bb9d0ccc]{margin-top:20px}#legalcopy[data-v-bb9d0ccc]{margin-top:5mm}#bar[data-v-bb9d0ccc],#legalcopy p[data-v-bb9d0ccc]{text-align:center}.total[data-v-bb9d0ccc]{font-size:12px;font-weight:700}span.pqty[data-v-bb9d0ccc]{display:block;font-size:12px;font-weight:500;line-height:15px;margin-bottom:5px}@media only screen and (max-width:1250px){.pos-item-grid[data-v-bb9d0ccc]{grid-template-columns:1fr 1fr 1fr 1fr}}@media only screen and (max-width:991px){.pos-item-grid[data-v-bb9d0ccc]{grid-template-columns:1fr 1fr 1fr}}@media only screen and (max-width:767px){.sm-col-reverse[data-v-bb9d0ccc]{flex-direction:column-reverse}.pos-item-grid[data-v-bb9d0ccc]{grid-template-columns:1fr 1fr 1fr 1fr}}.create-btn[data-v-bb9d0ccc]{padding:11px}.create-btn-2[data-v-bb9d0ccc]{padding:10px}.btn-primary[data-v-bb9d0ccc]{background:#2ab930!important}.btn-primary[data-v-bb9d0ccc]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.stock-warning-icon-pos[data-v-bb9d0ccc]{align-items:center;background:#dc3545;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2);color:#fff;cursor:pointer;display:flex;font-size:12px;height:28px;justify-content:center;position:absolute;right:5px;top:35px;transition:all .3s ease;width:28px;z-index:10}.stock-warning-icon-pos[data-v-bb9d0ccc]:hover{background:#c82333;box-shadow:0 4px 8px rgba(220,53,69,.4);transform:scale(1.15)}.relative[data-v-bb9d0ccc]{position:relative}.box-qty.qty-red[data-v-bb9d0ccc]{animation:pulse-bb9d0ccc 2s infinite;font-size:13px;font-weight:700}@keyframes pulse-bb9d0ccc{0%,to{opacity:1}50%{opacity:.7}}.client-warning[data-v-bb9d0ccc],.product-warning[data-v-bb9d0ccc]{align-items:center;background-color:#fff3cd;border:1px solid #ffc107;border-radius:4px;display:flex;font-size:13px;padding:8px 12px}.client-warning i[data-v-bb9d0ccc],.product-warning i[data-v-bb9d0ccc]{margin-right:8px}.client-status[data-v-bb9d0ccc],.product-status[data-v-bb9d0ccc]{margin-top:8px}.badge.badge-warning[data-v-bb9d0ccc]{align-items:center;background-color:#ffc107;color:#212529;display:inline-flex;font-size:11px;gap:4px;padding:4px 8px}.badge.badge-warning .btn-link[data-v-bb9d0ccc]{color:#212529;line-height:1;margin:0;padding:0;text-decoration:none}.badge.badge-warning .btn-link[data-v-bb9d0ccc]:hover{color:#000;text-decoration:none}.badge.badge-warning .btn-link[data-v-bb9d0ccc]:disabled{cursor:not-allowed;opacity:.6}.product-warning-pos[data-v-bb9d0ccc]{align-items:center;background-color:#fff3cd;border:1px solid #ffc107;border-radius:3px;box-sizing:border-box;display:inline-flex;flex-wrap:nowrap;font-size:9px;height:auto;line-height:1.1;margin-top:3px;padding:3px 5px;width:100%}.product-warning-pos i.fa-exclamation-triangle[data-v-bb9d0ccc]{flex-shrink:0;font-size:9px;line-height:1;margin-right:3px}.product-warning-pos span[data-v-bb9d0ccc]{display:inline-block;flex:1;line-height:1.1;margin-right:3px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.product-warning-pos .btn[data-v-bb9d0ccc]{flex-shrink:0;font-size:8px;height:auto;line-height:1.1;margin-left:3px;min-height:auto;padding:1px 3px;white-space:nowrap}.pos-box[data-v-bb9d0ccc]{display:flex;flex-direction:column;min-height:0}.pos-box-content[data-v-bb9d0ccc]{flex-shrink:0}[dir=rtl] #pos[data-v-bb9d0ccc]{direction:rtl}[dir=rtl] #pos .float-right[data-v-bb9d0ccc]{float:left!important}[dir=rtl] #pos .float-left[data-v-bb9d0ccc]{float:right!important}[dir=rtl] #pos .text-right[data-v-bb9d0ccc]{text-align:left!important}[dir=rtl] #pos .text-left[data-v-bb9d0ccc]{text-align:right!important}[dir=rtl] #pos .ml-2[data-v-bb9d0ccc]{margin-left:0!important;margin-right:.5rem!important}[dir=rtl] #pos .mr-2[data-v-bb9d0ccc]{margin-left:.5rem!important;margin-right:0!important}[dir=rtl] #pos .pl-3[data-v-bb9d0ccc]{padding-left:0!important;padding-right:1rem!important}[dir=rtl] #pos .pr-3[data-v-bb9d0ccc]{padding-left:1rem!important;padding-right:0!important}[dir=rtl] #pos .pos-item-grid>div .box-qty[data-v-bb9d0ccc]{border-bottom-left-radius:10px;border-bottom-right-radius:0;left:auto;right:0}[dir=rtl] #pos .stock-warning-icon-pos[data-v-bb9d0ccc]{left:5px;right:auto}[dir=rtl] #pos .table td[data-v-bb9d0ccc],[dir=rtl] #pos .table th[data-v-bb9d0ccc]{text-align:right}[dir=rtl] #pos .table .text-center[data-v-bb9d0ccc]{text-align:center}[dir=rtl] #pos .input-group-text[data-v-bb9d0ccc]{border-left:1px solid #ced4da;border-right:none}[dir=rtl] #pos .input-group>.form-control[data-v-bb9d0ccc]:not(:last-child){border-left:none;border-right:1px solid #ced4da}[dir=rtl] #pos .btn-block[data-v-bb9d0ccc]{text-align:center}[dir=rtl] #pos .header-buttons[data-v-bb9d0ccc]{float:left!important}[dir=rtl] #pos .form-group[data-v-bb9d0ccc]{direction:rtl}[dir=rtl] #pos .create-btn[data-v-bb9d0ccc],[dir=rtl] #pos .create-btn-2[data-v-bb9d0ccc]{border-left:1px solid #ced4da;border-right:none}[dir=rtl] #pos .pos-item-grid[data-v-bb9d0ccc],[dir=rtl] #pos .pos-modal-footer[data-v-bb9d0ccc]{direction:rtl}[dir=rtl] #invoice-POS[data-v-bb9d0ccc]{direction:rtl;text-align:right}[dir=rtl] #invoice-POS .table_data td[style*=\"text-align: right\"][data-v-bb9d0ccc]{text-align:left!important}[dir=rtl] #invoice-POS .table_data td[style*=\"text-align: left\"][data-v-bb9d0ccc]{text-align:right!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
