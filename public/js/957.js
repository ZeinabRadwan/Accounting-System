...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/suppliers/index.vue?vue&type=template&id=5cc6b54f&scoped=true
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/suppliers/index.vue?vue&type=style&index=0&id=5cc6b54f&prod&scoped=true&lang=css
var suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css = __webpack_require__(63496);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/suppliers/index.vue?vue&type=style&index=0&id=5cc6b54f&prod&scoped=true&lang=css

            

var suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css_options = {};

suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css_options.insert = "head";
suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css_options.singleton = false;

var suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css/* default */.A, suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css_options);



/* harmony default export */ const pages_suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css = (suppliersvue_type_style_index_0_id_5cc6b54f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/suppliers/index.vue?vue&type=style&index=0&id=5cc6b54f&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-5cc6b54f]{border:none!important;overflow:visible!important}.suppliers-table[data-v-5cc6b54f]{border-collapse:separate;border-spacing:0}.suppliers-table thead th[data-v-5cc6b54f]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.suppliers-table thead tr[data-v-5cc6b54f]{border:none!important}.suppliers-table thead th[data-v-5cc6b54f]:first-child{border-top-left-radius:10px}.suppliers-table thead th[data-v-5cc6b54f]:last-child{border-top-right-radius:10px}[dir=rtl] .suppliers-table thead th[data-v-5cc6b54f]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .suppliers-table thead th[data-v-5cc6b54f]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-5cc6b54f]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-5cc6b54f],.export-pdf-btn[data-v-5cc6b54f],.import-btn[data-v-5cc6b54f]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-5cc6b54f],.export-pdf-btn[data-v-5cc6b54f],.import-btn[data-v-5cc6b54f],.print-btn[data-v-5cc6b54f]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-5cc6b54f]{background:#33a0d91a!important;color:#33a0d9!important}.clear-btn[data-v-5cc6b54f]{background:#f6fef4!important;border:none;border-radius:10px;color:#2ab930!important;height:44px;padding:10px 16px;width:56px}.action-dropdown[data-v-5cc6b54f]{display:inline-block;position:relative}.action-icon-btn[data-v-5cc6b54f]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-5cc6b54f]{animation:slideInDown-5cc6b54f .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-5cc6b54f]{left:45px!important;right:auto!important}@keyframes slideInDown-5cc6b54f{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-5cc6b54f]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-5cc6b54f]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-5cc6b54f]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-5cc6b54f]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-5cc6b54f]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-5cc6b54f]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-5cc6b54f]:last-child{border-bottom:none}.action-menu li a[data-v-5cc6b54f]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-5cc6b54f]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-5cc6b54f]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-5cc6b54f]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-5cc6b54f]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-5cc6b54f]{gap:10px}.card[data-v-5cc6b54f]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-5cc6b54f]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.suppliers-table .badge.bg-success[data-v-5cc6b54f]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.suppliers-table .badge.bg-danger[data-v-5cc6b54f]{background:#fef4f4!important;color:#dc3545!important}.suppliers-table .badge.bg-danger[data-v-5cc6b54f],.suppliers-table .badge.bg-info[data-v-5cc6b54f]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.suppliers-table .badge.bg-info[data-v-5cc6b54f]{background:#fff!important;color:#33a0d9!important}.form-control[data-v-5cc6b54f]{background:#fff!important}.btn-primary[data-v-5cc6b54f]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-5cc6b54f]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-5cc6b54f]{align-items:center;color:#6c757d;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
