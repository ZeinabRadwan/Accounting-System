(self["webpackChunk"] = self["webpackChunk"] || []).push([[4263],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-f1723a94]{margin-bottom:15px}.table-price-counter-nowrap[data-v-f1723a94]{display:flex;flex-wrap:nowrap}.table-product-title[data-v-f1723a94]{max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pos-r-head[data-v-f1723a94]{border-bottom:1px solid #f3f3f3;border-radius:5px;box-shadow:0 0 3px #0003;box-sizing:border-box;padding:20px}.pos-logo[data-v-f1723a94]{text-align:center}.pos-item-grid[data-v-f1723a94]{grid-gap:10px;display:grid;grid-template-columns:1fr 1fr 1fr 1fr 1fr 1fr}.pos-item-grid>div[data-v-f1723a94]{border:1px solid #fff;border-radius:10px;box-shadow:0 4px 20px 1px rgba(0,0,0,.06),0 1px 4px rgba(0,0,0,.08);cursor:pointer;overflow:hidden;position:relative}.pos-item-grid>div[data-v-f1723a94]:hover{border-color:#33a0d9}.pos-item-grid>div .box-qty[data-v-f1723a94]{background:#33a0d9;border-bottom-right-radius:10px;color:#fff;display:block;font-size:12px;font-weight:700;height:30px;left:0;line-height:30px;position:absolute;text-align:center;top:0;width:50px}.qty-red[data-v-f1723a94]{background:red!important}.pos-body[data-v-f1723a94]{border-radius:5px;min-height:240px}.pos-box-img[data-v-f1723a94]{background:#ebebeb;border-bottom:1px solid #f1f1f1;font-size:13px;font-weight:700;height:100px;line-height:100px;text-align:center;width:100%}.pos-box-img img[data-v-f1723a94]{height:100px;-o-object-fit:cover;object-fit:cover;width:100%}.pos-box-content p[data-v-f1723a94]{font-size:14px;font-weight:700;margin-bottom:0}.pos-box-content span[data-v-f1723a94]{font-size:12px;margin-bottom:2px}.pos-box-content[data-v-f1723a94]{padding:5px 10px}.pos-item-grid-red[data-v-f1723a94]{border-color:red!important}.card-client-search[data-v-f1723a94]{border-bottom:1px solid #ddd;padding:20px}.table-wrap[data-v-f1723a94]{padding:15px}.table-responsive.table-wrap>table[data-v-f1723a94]{border:1px solid #ddd}.table-wrap .table thead tr[data-v-f1723a94]{background:#33a0d91f!important;border-bottom:0}.table-wrap .incrementor[data-v-f1723a94]{width:80px}.table-wrap .custom-qty-input[data-v-f1723a94]{border:1px solid #ececfdb8;border-radius:18px;display:inline-flex!important;justify-content:center;padding:0}.table-wrap .btn-danger[data-v-f1723a94]{font-size:10px;height:25px;padding:0;width:25px}.table-wrap .icon-sm[data-v-f1723a94]{height:25px;line-height:23px;width:25px}.pos-card-footer[data-v-f1723a94]{background:#fff;border:1px solid #ddd;border-radius:4px;margin-bottom:15px}.pos-net-total[data-v-f1723a94]{background:#33a0d933;font-size:22px;font-weight:700;padding:10px;text-align:center;width:100%}.product[data-v-f1723a94]{cursor:pointer}.product .info-box[data-v-f1723a94]:hover{background:#e0e0e0}.dark-mode .pos-body[data-v-f1723a94],.dark-mode .pos-r-head[data-v-f1723a94]{background:#111827!important;border-color:#000}.dark-mode .pos-item-grid>div[data-v-f1723a94]{border-color:#6c757d!important}.dark-mode .pos-box-content[data-v-f1723a94]{color:#fff;padding:5px 10px}.dark-mode .pos-item-grid>div.pos-item-grid-red[data-v-f1723a94]{border-color:red!important}.dark-mode .card-client-search[data-v-f1723a94]{border-color:#6c757d}.dark-mode .table-striped tbody tr[data-v-f1723a94]:nth-of-type(odd){background-color:#1f2937}.dark-mode .table-responsive.table-wrap>table[data-v-f1723a94]{border:1px solid #6c757d}.dark-mode .table-wrap .incrementor[data-v-f1723a94]{border:none!important}.dark-mode .pos-card-footer.bg-white[data-v-f1723a94]{background:#111827!important;border-color:#6c757d}.dark-mode .pos-card-footer label[data-v-f1723a94]{color:#fff}.dark-mode .pos-net-total[data-v-f1723a94]{background:#63a9f1;color:#fff}#invoice-POS table[data-v-f1723a94],#invoice-POS td[data-v-f1723a94],#invoice-POS th[data-v-f1723a94],#invoice-POS tr[data-v-f1723a94]{border-collapse:collapse}#invoice-POS tr[data-v-f1723a94]{border-bottom:2px dotted #05070b}#invoice-POS table[data-v-f1723a94]{width:100%}#invoice-POS tfoot tr th[data-v-f1723a94]:first-child{text-align:left}#invoice-POS .info[data-v-f1723a94]{margin-bottom:20px}#invoice-POS .info>p[data-v-f1723a94]{margin-top:20px}#legalcopy[data-v-f1723a94]{margin-top:5mm}#bar[data-v-f1723a94],#legalcopy p[data-v-f1723a94]{text-align:center}.total[data-v-f1723a94]{font-size:12px;font-weight:700}span.pqty[data-v-f1723a94]{display:block;font-size:12px;font-weight:500;line-height:15px;margin-bottom:5px}@media only screen and (max-width:1250px){.pos-item-grid[data-v-f1723a94]{grid-template-columns:1fr 1fr 1fr 1fr}}@media only screen and (max-width:991px){.pos-item-grid[data-v-f1723a94]{grid-template-columns:1fr 1fr 1fr}}@media only screen and (max-width:767px){.sm-col-reverse[data-v-f1723a94]{flex-direction:column-reverse}.pos-item-grid[data-v-f1723a94]{grid-template-columns:1fr 1fr 1fr 1fr}}.create-btn[data-v-f1723a94]{padding:11px}.create-btn-2[data-v-f1723a94]{padding:10px}.btn-primary[data-v-f1723a94]{background:#2ab930!important}.btn-primary[data-v-f1723a94]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.stock-warning-icon-pos[data-v-f1723a94]{align-items:center;background:#dc3545;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2);color:#fff;cursor:pointer;display:flex;font-size:12px;height:28px;justify-content:center;position:absolute;right:5px;top:35px;transition:all .3s ease;width:28px;z-index:10}.stock-warning-icon-pos[data-v-f1723a94]:hover{background:#c82333;box-shadow:0 4px 8px rgba(220,53,69,.4);transform:scale(1.15)}.relative[data-v-f1723a94]{position:relative}.box-qty.qty-red[data-v-f1723a94]{animation:pulse-f1723a94 2s infinite;font-size:13px;font-weight:700}@keyframes pulse-f1723a94{0%,to{opacity:1}50%{opacity:.7}}.client-warning[data-v-f1723a94],.product-warning[data-v-f1723a94]{align-items:center;background-color:#fff3cd;border:1px solid #ffc107;border-radius:4px;display:flex;font-size:13px;padding:8px 12px}.client-warning i[data-v-f1723a94],.product-warning i[data-v-f1723a94]{margin-right:8px}.client-status[data-v-f1723a94],.product-status[data-v-f1723a94]{margin-top:8px}.badge.badge-warning[data-v-f1723a94]{align-items:center;background-color:#ffc107;color:#212529;display:inline-flex;font-size:11px;gap:4px;padding:4px 8px}.badge.badge-warning .btn-link[data-v-f1723a94]{color:#212529;line-height:1;margin:0;padding:0;text-decoration:none}.badge.badge-warning .btn-link[data-v-f1723a94]:hover{color:#000;text-decoration:none}.badge.badge-warning .btn-link[data-v-f1723a94]:disabled{cursor:not-allowed;opacity:.6}.product-warning-pos[data-v-f1723a94]{align-items:center;background-color:#fff3cd;border:1px solid #ffc107;border-radius:3px;box-sizing:border-box;display:inline-flex;flex-wrap:nowrap;font-size:9px;height:auto;line-height:1.1;margin-top:3px;padding:3px 5px;width:100%}.product-warning-pos i.fa-exclamation-triangle[data-v-f1723a94]{flex-shrink:0;font-size:9px;line-height:1;margin-right:3px}.product-warning-pos span[data-v-f1723a94]{display:inline-block;flex:1;line-height:1.1;margin-right:3px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.product-warning-pos .btn[data-v-f1723a94]{flex-shrink:0;font-size:8px;height:auto;line-height:1.1;margin-left:3px;min-height:auto;padding:1px 3px;white-space:nowrap}.pos-box[data-v-f1723a94]{display:flex;flex-direction:column;min-height:0}.pos-box-content[data-v-f1723a94]{flex-shrink:0}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/pos/create.vue?vue&type=template&id=f1723a94&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_f1723a94_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const pos_createvue_type_style_index_0_id_f1723a94_prod_lang_scss_scoped_true = (createvue_type_style_index_0_id_f1723a94_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/pos/create.vue?vue&type=style&index=0&id=f1723a94&prod&lang=scss&scoped=true
