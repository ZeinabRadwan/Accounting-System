...
var InvoiceSummaryTablevue_type_style_index_0_id_a6df283c_prod_scoped_true_lang_css = __webpack_require__(83217);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/sales/InvoiceSummaryTable.vue?vue&type=style&index=0&id=a6df283c&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/show.vue?vue&type=template&id=7fab17ec
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('breadcrumbs', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        ...
        }, [_vm.totalProductDiscount > _vm.totalPrice ? _c('div', {
        ...
        }), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t("Validation Error")) + ":")]), _vm._v(" \n                " + _vm._s(_vm.$t("Total discount cannot exceed total price. Discount has been capped at total price.")) + "\n              ")]) : _vm._e(), _vm._v(" "), _c('InvoiceSummaryTable', {
          attrs: {
            "subtotal": _vm.totalPrice,
            "after-discount": Math.max(0, _vm.totalPrice - _vm.totalProductDiscount),
            "total-tax": _vm.totalProductVat,
            "transport": 0,
            "grand-total": Math.max(0, _vm.totalPrice - _vm.totalProductDiscount + _vm.totalProductVat),
            "paid-amount": 0,
            "due-amount": 0
          }
        })], 1)])], 1)])];
...
var InvoiceSummaryTable = __webpack_require__(87968);
...
/* harmony default export */ const showvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["appInfo", "items", "loading", "pagination"])), {}, {
    ...
    totalProductDiscount: function totalProductDiscount() {
      ...
      var total = this.allData.products.reduce(function (sum, product) {
        var discount = parseFloat(_this.calculateProductDiscountAmount(product)) || 0;
        return sum + discount;
      }, 0);
    ...
    quotationProductsRows: function quotationProductsRows() {
      ...
      return this.allData.products.map(function (product, index) {
        var totalPrice = (parseFloat(product.salePrice) || 0) * (parseFloat(product.quantity) || 1);
        var discountAmount = parseFloat(_this2.calculateProductDiscountAmount(product)) || 0;
        // Ensure discount doesn't exceed item total
        var validDiscount = discountAmount > totalPrice ? totalPrice : discountAmount;
        var totalAfterDiscount = totalPrice - validDiscount;
        var taxAmount = parseFloat(product.taxAmount) || 0;
        var totalWithVat = totalAfterDiscount + taxAmount;
        return {
          index: index + 1,
  ...
  methods: {
    ...
    calculateProductDiscountAmount: function calculateProductDiscountAmount(data) {
      ...
      if (data.discountAmount !== undefined && data.discountAmount !== null) {
        ...
        var totalPrice = (parseFloat(data.salePrice) || 0) * (parseFloat(data.quantity) || 1);
      ...
      if (data.discountType === 'percentage' && data.discount) {
        var _totalPrice = (parseFloat(data.salePrice) || 0) * (parseFloat(data.quantity) || 1);
        var calculatedDiscount = _totalPrice * parseFloat(data.discount) / 100;
        // Ensure discount doesn't exceed total price
        return calculatedDiscount > _totalPrice ? _totalPrice.toFixed(2) : calculatedDiscount.toFixed(2);
      } else if (data.discount && data.discount > 0) {
        var _totalPrice2 = (parseFloat(data.salePrice) || 0) * (parseFloat(data.quantity) || 1);
        var _discountAmount = Number(data.discount) || 0;
        // Ensure discount doesn't exceed total price
        return _discountAmount > _totalPrice2 ? _totalPrice2.toFixed(2) : _discountAmount.toFixed(2);
      }
      return '0.00';
    },
    // Format number to 2 decimal places
