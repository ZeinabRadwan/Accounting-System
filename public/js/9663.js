"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9663],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-4221a7e4]{margin-bottom:15px}.footer-buttons[data-v-4221a7e4]{display:flex;gap:10px}.footer-buttons .btn[data-v-4221a7e4]{margin-right:10px}.footer-buttons .btn[data-v-4221a7e4]:last-child{margin-right:0}.create-btn[data-v-4221a7e4]{padding:11px}.chart-account-success[data-v-4221a7e4],.chart-account-warning[data-v-4221a7e4]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-4221a7e4]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-4221a7e4]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-4221a7e4],.warning-content[data-v-4221a7e4]{align-items:center;display:flex;gap:16px}.success-icon[data-v-4221a7e4],.warning-icon[data-v-4221a7e4]{flex-shrink:0;font-size:24px}.warning-icon[data-v-4221a7e4]{color:#856404}.success-icon[data-v-4221a7e4]{color:#155724}.success-text[data-v-4221a7e4],.warning-text[data-v-4221a7e4]{flex-grow:1}.success-title[data-v-4221a7e4],.warning-title[data-v-4221a7e4]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-4221a7e4]{color:#856404}.success-title[data-v-4221a7e4]{color:#155724}.success-description[data-v-4221a7e4],.warning-description[data-v-4221a7e4]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-4221a7e4]{color:#856404}.success-description[data-v-4221a7e4]{color:#155724}.warning-action[data-v-4221a7e4]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-4221a7e4]{padding:0}.btn-primary[data-v-4221a7e4]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-4221a7e4]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-4221a7e4],.warning-content[data-v-4221a7e4]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-4221a7e4],.warning-action[data-v-4221a7e4]{width:100%}}.client-status[data-v-4221a7e4]{font-size:13px}.client-success[data-v-4221a7e4],.client-warning[data-v-4221a7e4]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-4221a7e4]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-4221a7e4]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-4221a7e4]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.debug-panel[data-v-4221a7e4]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-4221a7e4]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-4221a7e4]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-4221a7e4]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-4221a7e4]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-4221a7e4]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-4221a7e4]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-4221a7e4]:last-child{border-bottom:none}.debug-display[data-v-4221a7e4]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-4221a7e4]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-4221a7e4]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-4221a7e4]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-4221a7e4]:last-child{border-bottom:none}.debug-panel .table th[data-v-4221a7e4]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-4221a7e4]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-4221a7e4]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-4221a7e4]{padding:15px}.debug-item .row[data-v-4221a7e4]{margin:0}.debug-item .col-md-6[data-v-4221a7e4]{padding:0 5px}.debug-step[data-v-4221a7e4]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-4221a7e4]{font-size:.75em}}.btn-outline-warning[data-v-4221a7e4]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-4221a7e4]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-4221a7e4]{font-size:13px}.product-success[data-v-4221a7e4],.product-warning[data-v-4221a7e4]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-4221a7e4]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-4221a7e4]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-4221a7e4]{font-size:13px}.account-success[data-v-4221a7e4],.account-warning[data-v-4221a7e4]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-4221a7e4]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-4221a7e4]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-4221a7e4]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-4221a7e4]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-4221a7e4]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-4221a7e4]{cursor:pointer;margin-bottom:0}.text-warning[data-v-4221a7e4]{color:#856404!important}.text-warning small[data-v-4221a7e4]{font-size:12px;font-weight:500}.text-warning i[data-v-4221a7e4]{margin-right:4px}.table-custom[data-v-4221a7e4]{border:none!important}.invoices-create-table[data-v-4221a7e4]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-4221a7e4]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-4221a7e4]{border:none!important}.invoices-create-table thead th[data-v-4221a7e4]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-4221a7e4]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-4221a7e4]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-4221a7e4]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.summary-footer-wrapper[data-v-4221a7e4]{margin-top:10px}.summary-footer-row[data-v-4221a7e4]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-4221a7e4]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-4221a7e4]{color:#495057}.summary-label[data-v-4221a7e4],.summary-value[data-v-4221a7e4]{font-size:14px;padding:12px 16px}.summary-value[data-v-4221a7e4]{color:#212529;text-align:left}.grand-total-row[data-v-4221a7e4]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-4221a7e4]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-4221a7e4]{text-align:left}[dir=rtl] .summary-value[data-v-4221a7e4]{text-align:right}@media (max-width:768px){.summary-label[data-v-4221a7e4],.summary-value[data-v-4221a7e4]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-4221a7e4]{font-size:14px}}.btn-group.c-w-100[data-v-4221a7e4]{gap:10px}.card[data-v-4221a7e4]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-4221a7e4]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-4221a7e4]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-4221a7e4]{background:#fff!important}.quantity-field[data-v-4221a7e4]{border-radius:0!important;margin:0!important;min-height:50px!important}.btn-primary[data-v-4221a7e4]{background:#2ab930!important}.btn-secondary[data-v-4221a7e4]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-4221a7e4]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-4221a7e4]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-4221a7e4]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-4221a7e4]{flex-grow:1}.stock-warning-title[data-v-4221a7e4]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-4221a7e4]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-4221a7e4]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-4221a7e4]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-4221a7e4]:last-child{margin-bottom:0}.product-name[data-v-4221a7e4]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-4221a7e4]{color:#856404;opacity:.8}.stock-details strong[data-v-4221a7e4]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-4221a7e4]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-4221a7e4]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-4221a7e4]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-4221a7e4]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-4221a7e4]{align-self:center}.stock-warning-list[data-v-4221a7e4]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-4221a7e4]{text-align:right}}.clickable-badge[data-v-4221a7e4]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-4221a7e4]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-4221a7e4]:active{transform:scale(.95)}.insufficient-stock-input[data-v-4221a7e4]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important;margin:0 5px}.insufficient-stock-input[data-v-4221a7e4]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.custom-qty-input input.button-minus[data-v-4221a7e4],.custom-qty-input input.button-plus[data-v-4221a7e4]{margin:0 5px}.product-option[data-v-4221a7e4]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-4221a7e4]:last-child{border-bottom:none}.product-option-header[data-v-4221a7e4]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-4221a7e4]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-4221a7e4]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-4221a7e4]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-4221a7e4]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-4221a7e4]{color:#33a0d9;font-size:11px}.badge-sm[data-v-4221a7e4]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-4221a7e4]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-4221a7e4]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-4221a7e4]{background-color:#e3f2fd}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=4221a7e4&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=4221a7e4&scoped=true
  ...
  methods: {
    ...
    calculateItemAmounts: function calculateItemAmounts(index) {
      ...
      if (item.taxType == "Exclusive") {
        ...
        var vatBase = this.roundToTwoDecimals(netTotal + proportionalTransport);
    ...
    calculateSum: function calculateSum() {
      ...
      if (this.form.discount > 0) {
        ...
        var invoiceSubtotal = this.totalUnitPrice || 0;
        if (this.form.discountType == 1) {
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_4221a7e4_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_4221a7e4_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_4221a7e4_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=4221a7e4&prod&scoped=true&lang=css
