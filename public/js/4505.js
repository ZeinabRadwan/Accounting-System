"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4505],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".refresh-btn[data-v-06d6d6e0]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-06d6d6e0],.export-pdf-btn[data-v-06d6d6e0]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-06d6d6e0],.export-pdf-btn[data-v-06d6d6e0],.print-btn[data-v-06d6d6e0]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-06d6d6e0]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-06d6d6e0]{gap:10px}.card[data-v-06d6d6e0]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-06d6d6e0]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-06d6d6e0]{padding:1.25rem}.form-control[data-v-06d6d6e0]{background:#fff!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/profit-loss.vue?vue&type=template&id=06d6d6e0&scoped=true
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Code")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Name")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Avg. Purchase Price")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Avg. Selling Price")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Sold Qty")))]), _vm._v(" "), _c('th', {
    ...
    return _c('tr', {
      key: i
    }, [_c('td', [_vm._v(_vm._s(++i))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withPrefix")(data.itemCode, _vm.productPrefix)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.itemName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(data.avgPurchasePrice)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(data.avgSalePrice)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.currentQty))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    ...
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.totalProfitOrLoss)))])])])], 2)])]) : _vm._e(), _vm._v(" "), _vm.loading == false ? _c('div', {
    staticClass: "table-responsive table-custom"
  }, [_c('table', {
    staticClass: "table"
  }, [_c('tbody', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Total Sales (Average)")))]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.totalSold)))])])]), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Total Purchase (Average)")))]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('u', [_c('strong', [_vm._v("(" + _vm._s(_vm._f("withAbsoluteCurrency")(_vm.totalPurchased)) + ")")])])])]), _vm._v(" "), _c('tr', {
    ...
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.totalProfitOrLoss)))])])])])])]) : _vm._e()], 1) : _c('div', {
    staticClass: "row mt-5 position-relative"
  }, [_c('table-loading', {
    directives: [{
      name: "show",
    ...
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].totalSales)))])])]), _vm._v(" "), _vm._m(1), _vm._v(" "), _c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Cost of Goods Sold")))]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('u', [_c('strong', [_vm._v("(" + _vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].costOfGoodsSold)) + ")")])])])]), _vm._v(" "), _c('tr', [_c('th', {
    attrs: {
      "colspan": "3"
    }
    ...
    staticClass: "text-right"
  }, [_c('u', [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].posAdjustment)))])])]), _vm._v(" "), _c('td')]), _vm._v(" "), _c('tr', {
    staticClass: "text-danger"
  }, [_c('td', [_vm._v(_vm._s(_vm.$t("Negative Adjusted")))]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('u', [_c('strong', [_vm._v("(" + _vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].negAdjustment)) + ")")])])]), _vm._v(" "), _c('td')]), _vm._v(" "), _c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Total Adjusted")))]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right",
    "class": _vm.allData[0].totalAdjustment >= 0 ? 'text-success' : 'text-danger'
  }, [_vm.allData[0].totalAdjustment >= 0 ? _c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].totalAdjustment)))]) : _c('strong', [_vm._v("(" + _vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].totalAdjustment)) + ")")])])]), _vm._v(" "), _c('tr', [_c('th', [_vm._v("\n                  " + _vm._s(_vm.$t("Total Sell Return")) + "\n                ")]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].totalSalesReturn)))])])]), _vm._v(" "), _c('tr', [_c('th', [_vm.allData[0].grossProfitOrLoss > 0 ? _c('span', [_vm._v(_vm._s(_vm.$t("Gross Profit")))]) : _c('span', [_vm._v(_vm._s(_vm.$t("Gross Loss")))])]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].grossProfitOrLoss)))])])]), _vm._v(" "), _vm._m(2), _vm._v(" "), _c('tr', [_c('th', {
    attrs: {
      "colspan": "3"
    }
  }, [_vm._v(_vm._s(_vm.$t("Operating Expenses")))])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v(_vm._s(_vm.$t("Salaries")))]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].payrollAmount)))])]), _vm._v(" "), _c('td')]), _vm._v(" "), _c('tr', [_c('td', [_vm._v(_vm._s(_vm.$t("General Expenses")))]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].expenseAmount)))])]), _vm._v(" "), _c('td')]), _vm._v(" "), _c('tr', [_c('td', [_vm._v(_vm._s(_vm.$t("Loan Interest")))]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].loanInterest)))])]), _vm._v(" "), _c('td')]), _vm._v(" "), _c('tr', [_c('td', [_vm._v(_vm._s(_vm.$t("Asset Depreciation")))]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].assetDepriciation)))])]), _vm._v(" "), _c('td')]), _vm._v(" "), _c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("Total Expense")))]), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v("(" + _vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].totalExpense)) + ")")])])]), _vm._v(" "), _c('tr', {
    ...
    staticClass: "text-right"
  }, [_c('strong', [_vm._v("\n                      " + _vm._s(_vm._f("withAbsoluteCurrency")(_vm.allData[0].netProfitOrLoss)) + "\n                    ")])])])])])])], 1)])])])])]) : _vm.allData && _vm.allData.length <= 0 ? _c('div', {
    staticClass: "row"
  }, [_c('div', {
...
;// CONCATENATED MODULE: ./resources/js/pages/reports/profit-loss.vue?vue&type=template&id=06d6d6e0&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/profit-loss.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./resources/js/pages/reports/profit-loss.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(profit_lossvue_type_style_index_0_id_06d6d6e0_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_profit_lossvue_type_style_index_0_id_06d6d6e0_prod_scoped_true_lang_css = (profit_lossvue_type_style_index_0_id_06d6d6e0_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/reports/profit-loss.vue?vue&type=style&index=0&id=06d6d6e0&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/reports/profit-loss.vue
