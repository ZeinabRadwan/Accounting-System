...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".settings-card .card-header{border-bottom:1px solid#ddd;box-shadow:none}.settings-card .card-body{padding:10px}.settings-card .nav-pills .nav-link,.settings-card .nav-tabs .nav-link{justify-content:flex-start}.settings-card .nav-pills .nav-link.active,.settings-card .nav-pills .show>.nav-link{background-color:#1b3c7159;color:#1b3c71}.settings-card{position:sticky;top:30px}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/settings/index.vue?vue&type=template&id=3f716483
...
var update = injectStylesIntoStyleTag_default()(settingsvue_type_style_index_0_id_3f716483_prod_lang_css/* default */.A, options);



/* harmony default export */ const central_settingsvue_type_style_index_0_id_3f716483_prod_lang_css = (settingsvue_type_style_index_0_id_3f716483_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/settings/index.vue?vue&type=style&index=0&id=3f716483&prod&lang=css
