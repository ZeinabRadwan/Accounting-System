"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1386],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=template&id=5ea291f1&scoped=true
  ...
  methods: {
    ...
    handlePreSelection: function handlePreSelection() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var clientSlug, invoiceSlug, invoiceData, response, attempts, maxAttempts, selectedClient, fallbackClient, selectedInvoice, fallbackInvoice, _selectedInvoice, _fallbackInvoice, _t3, _t4;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 18:
              _context7.p = 18;
              _t3 = _context7.v;
              console.error('Error in handlePreSelection:', _t3);
            case 19:
              attempts++;
              if (!(attempts < maxAttempts)) {
                _context7.n = 20;
            ...
            case 22:
              _context7.p = 22;
              _t4 = _context7.v;
              console.error('Error fetching invoice details:', _t4);
            case 23:
              return _context7.a(2);
          }
        }, _callee7, null, [[5, 18], [1, 22]]);
      }))();
    },
    ...
    storeProducts: function storeProducts() {
      ...
      var _loop = function _loop() {
        ...
        var lastProduct = _this0.form.selectedProducts[lastIndex];
    ...
    validateReturns: function validateReturns() {
      ...
      this.form.selectedProducts.forEach(function (product) {
        if (product.returnQty > product.qty) {
          errors.push(_this1.$t('Return quantity for {name} cannot exceed available quantity', {
            name: product.name
          }));
          isValid = false;
        }
        if (product.returnQty < 0) {
          errors.push(_this1.$t('Return quantity for {name} cannot be negative', {
            name: product.name
          }));
          isValid = false;
        }
    ...
    saveInvoiceReturn: function saveInvoiceReturn() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var _this10$form$invoice;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              if (_this10.validateReturns()) {
                _context9.n = 1;
                break;
              }
              return _context9.a(2);
            case 1:
              if (!(!_this10.isSaudiArabia && _this10.form.returnAmount > 0 && !_this10.hasBankAccountChartOfAccount)) {
                _context9.n = 2;
                break;
              }
              toast.fire({
                type: "warning",
                title: _this10.$t("Bank Account Chart of Account Required"),
                text: _this10.$t("Bank Account must have a Chart of Account assigned for journal entries."),
                timer: 8000,
                timerProgressBar: true,
                showConfirmButton: true,
                confirmButtonText: _this10.$t("Go to Bank Accounts"),
                showCancelButton: true,
                cancelButtonText: _this10.$t("Close")
              }).then(function (result) {
                if (result.isConfirmed) {
                  _this10.goToBankAccounts();
                }
              });
              return _context9.a(2);
            case 2:
              // Sync form fields with Calculation Summary just before save
              _this10.form.totalPaid = ((_this10$form$invoice = _this10.form.invoice) === null || _this10$form$invoice === void 0 ? void 0 : _this10$form$invoice.totalPaid) || 0;
              _this10.form.invoiceTax = _this10.form.newTax;
              _this10.form.newDue = _this10.form.invoiceDue;
              // invoiceTotal, invoiceDiscount and invoiceTransport are already current
              _context9.n = 3;
              return _this10.form.post(window.location.origin + '/api/invoice-returns').then(function (_ref) {
                var data = _ref.data;
                if (_this10.isSaudiArabia) {
                  toast.fire({
                    type: 'success',
                    title: _this10.$t('Credit Note created successfully'),
                    text: _this10.$t('Credit Note has been created as inactive. You can send it to ZATCA from the invoice returns list.'),
                    timer: 8000,
                    timerProgressBar: true
                  });
                } else {
                  toast.fire({
                    type: 'success',
                    title: _this10.$t('Invoice return added successfully')
                  });
                }
    ...
    calculateItemAmounts: function calculateItemAmounts(index) {
      ...
      var originalLineTotal = parseFloat(product.totalPrice) || 0;
      ...
      // Calculate return total proportionally from original invoice line total
      var totalQty = parseFloat(product.qty) || 1;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_5ea291f1_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_5ea291f1_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_5ea291f1_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=0&id=5ea291f1&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-5ea291f1]{margin-bottom:15px}.footer-buttons[data-v-5ea291f1]{display:flex;gap:10px}.footer-buttons .btn[data-v-5ea291f1]{margin-right:10px}.footer-buttons .btn[data-v-5ea291f1]:last-child{margin-right:0}.create-btn[data-v-5ea291f1]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-5ea291f1]:hover{background-color:#e9ecef}.edit-btn[data-v-5ea291f1]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-5ea291f1]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-5ea291f1]{border:none!important}.quotations-create-table[data-v-5ea291f1]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-5ea291f1]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-5ea291f1]{border:none!important}.quotations-create-table thead th[data-v-5ea291f1]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-5ea291f1]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-5ea291f1]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-5ea291f1]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-5ea291f1]{gap:10px}.card[data-v-5ea291f1]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-5ea291f1]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-5ea291f1]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-5ea291f1]{background:#fff!important}.btn-primary[data-v-5ea291f1]{background:#2ab930!important}.btn-secondary[data-v-5ea291f1]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-5ea291f1]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-5ea291f1],.button-plus[data-v-5ea291f1]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:12px;font-weight:700;height:24px;justify-content:center;transition:all .2s ease;width:24px}.button-minus[data-v-5ea291f1]{background-color:#dc3545;color:#fff}.button-plus[data-v-5ea291f1]{background-color:#007bff;color:#fff}.button-minus[data-v-5ea291f1]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-5ea291f1]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-5ea291f1]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-5ea291f1]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-5ea291f1]{direction:rtl}[dir=rtl] .create-btn[data-v-5ea291f1]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-5ea291f1]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-5ea291f1]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-5ea291f1]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-5ea291f1]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-5ea291f1]{border-right:1px solid #ced4da}.clickable-badge[data-v-5ea291f1]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-5ea291f1]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-5ea291f1]:active{transform:scale(.95)}.insufficient-stock-input[data-v-5ea291f1]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-5ea291f1]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-5ea291f1]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-5ea291f1]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-5ea291f1]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-5ea291f1]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-5ea291f1]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-5ea291f1]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-5ea291f1]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-5ea291f1]:last-child{border-bottom:none}.debug-display[data-v-5ea291f1]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-5ea291f1]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-5ea291f1]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-5ea291f1]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-5ea291f1]:last-child{border-bottom:none}.debug-panel .table th[data-v-5ea291f1]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-5ea291f1]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-5ea291f1]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-5ea291f1]{padding:15px}.debug-item .row[data-v-5ea291f1]{margin:0}.debug-item .col-md-6[data-v-5ea291f1]{padding:0 5px}.debug-step[data-v-5ea291f1]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-5ea291f1]{font-size:.75em}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
