(self["webpackChunk"] = self["webpackChunk"] || []).push([[4318],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-bd957214]{border:none!important;overflow:visible!important}.invoices-table[data-v-bd957214]{border-collapse:separate;border-spacing:0}.invoices-table thead th[data-v-bd957214]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-table thead tr[data-v-bd957214]{border:none!important}.invoices-table thead th[data-v-bd957214]:first-child{border-top-left-radius:10px}.invoices-table thead th[data-v-bd957214]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-table thead th[data-v-bd957214]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-table thead th[data-v-bd957214]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-bd957214]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-bd957214],.export-pdf-btn[data-v-bd957214]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-bd957214],.export-pdf-btn[data-v-bd957214],.print-btn[data-v-bd957214]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-bd957214]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-bd957214]{display:inline-block;position:relative}.action-icon-btn[data-v-bd957214]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-bd957214]{animation:slideInDown-bd957214 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-bd957214]{left:45px!important;right:auto!important}@keyframes slideInDown-bd957214{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-bd957214]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-bd957214]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-bd957214]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-bd957214]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-bd957214]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-bd957214]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-bd957214]:last-child{border-bottom:none}.action-menu li a[data-v-bd957214]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-bd957214]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-bd957214]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-bd957214]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-bd957214]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-bd957214]{gap:10px}.card[data-v-bd957214]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-bd957214]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-table .badge.bg-success[data-v-bd957214]{background:#f6fef4!important;color:#2ab930!important}.invoices-table .badge.bg-danger[data-v-bd957214],.invoices-table .badge.bg-success[data-v-bd957214]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.invoices-table .badge.bg-danger[data-v-bd957214]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-bd957214]{background:#fff!important}.btn-primary[data-v-bd957214]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/index.vue?vue&type=template&id=bd957214&scoped=true
          ...
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return _this11.form.post(window.location.origin + "/api/invoices-pay").then(function () {
                ...
                toast.fire({
                  type: "error",
                  title: _this11.$t("Opps...something went wrong")
                });
              });
            case 2:
            case "end":
              ...
              sweetalert2_all_default().fire({
                ...
                if (result.value) {
                  _this12.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      sweetalert2_all_default().fire(_this12.$t("Deleted!"), _this12.$t("Deleted successfully."), "success");
                    } else {
                      sweetalert2_all_default().fire(_this12.$t("Failed!"), _this12.$t("Sorry you can't delete this invoice!"), "warning");
                    }
                  });
                }
              });
                    ...
                    while (1) switch (_context12.prev = _context12.next) {
                      ...
                      case 5:
                        ...
                        if (response.data.success) {
                          sweetalert2_all_default().fire(_this13.$t("Sent Successfully!"), _this13.$t("Invoice has been sent to ZATCA and journal entries have been created."), "success");
                          // Refresh the table to update the status
                          _this13.getData();
                        } else {
                          sweetalert2_all_default().fire(_this13.$t("Failed!"), response.data.message || _this13.$t("Failed to send invoice to ZATCA"), "error");
                        }
                        _context12.next = 13;
                        break;
                      case 9:
                        ...
                        sweetalert2_all_default().fire(_this13.$t("Error!"), _this13.$t("An error occurred while sending the invoice to ZATCA"), "error");
                      case 13:
                      case "end":
...
var invoicesvue_type_style_index_0_id_bd957214_prod_scoped_true_lang_css = __webpack_require__(66250);
...
var update = injectStylesIntoStyleTag_default()(invoicesvue_type_style_index_0_id_bd957214_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const sales_invoicesvue_type_style_index_0_id_bd957214_prod_scoped_true_lang_css = (invoicesvue_type_style_index_0_id_bd957214_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/invoices/index.vue?vue&type=style&index=0&id=bd957214&prod&scoped=true&lang=css
