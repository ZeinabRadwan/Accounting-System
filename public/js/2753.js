"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2753],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_laravel_mix_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-0549e8f2]{margin-bottom:15px}.footer-buttons[data-v-0549e8f2]{display:flex;gap:10px}.footer-buttons .btn[data-v-0549e8f2]{margin-right:10px}.footer-buttons .btn[data-v-0549e8f2]:last-child{margin-right:0}.create-btn[data-v-0549e8f2]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-0549e8f2]:hover{background-color:#e9ecef}.edit-btn[data-v-0549e8f2]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-0549e8f2]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-0549e8f2]{border:none!important}.quotations-create-table[data-v-0549e8f2]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-0549e8f2]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-0549e8f2]{border:none!important}.quotations-create-table thead th[data-v-0549e8f2]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-0549e8f2]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-0549e8f2]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-0549e8f2]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-0549e8f2]{gap:10px}.card[data-v-0549e8f2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-0549e8f2]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-0549e8f2]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-0549e8f2]{background:#fff!important}.btn-primary[data-v-0549e8f2]{background:#2ab930!important}.btn-secondary[data-v-0549e8f2]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-0549e8f2]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-0549e8f2],.button-plus[data-v-0549e8f2]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:12px;font-weight:700;height:24px;justify-content:center;transition:all .2s ease;width:24px}.button-minus[data-v-0549e8f2]{background-color:#dc3545;color:#fff}.button-plus[data-v-0549e8f2]{background-color:#007bff;color:#fff}.button-minus[data-v-0549e8f2]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-0549e8f2]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-0549e8f2]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-0549e8f2]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-0549e8f2]{direction:rtl}[dir=rtl] .create-btn[data-v-0549e8f2]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-0549e8f2]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-0549e8f2]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-0549e8f2]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-0549e8f2]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-0549e8f2]{border-right:1px solid #ced4da}.clickable-badge[data-v-0549e8f2]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-0549e8f2]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-0549e8f2]:active{transform:scale(.95)}.insufficient-stock-input[data-v-0549e8f2]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-0549e8f2]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-0549e8f2]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-0549e8f2]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-0549e8f2]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-0549e8f2]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-0549e8f2]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-0549e8f2]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-0549e8f2]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-0549e8f2]:last-child{border-bottom:none}.debug-display[data-v-0549e8f2]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-0549e8f2]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-0549e8f2]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-0549e8f2]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-0549e8f2]:last-child{border-bottom:none}.debug-panel .table th[data-v-0549e8f2]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-0549e8f2]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-0549e8f2]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-0549e8f2]{padding:15px}.debug-item .row[data-v-0549e8f2]{margin:0}.debug-item .col-md-6[data-v-0549e8f2]{padding:0 5px}.debug-step[data-v-0549e8f2]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-0549e8f2]{font-size:.75em}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/form.vue?vue&type=template&id=0549e8f2&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  methods: {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 3:
              ...
              // Step 2: Get client from invoice if not provided in query
              targetClientSlug = clientSlug;
              if (!targetClientSlug && invoiceData.client) {
            ...
            case 15:
              ...
              if (_this6.clientInvoices && _this6.clientInvoices.length > 0) {
                ...
                selectedInvoice = _this6.clientInvoices.find(function (invoice) {
                  return invoice.slug === invoiceSlug || invoice.id === invoiceSlug;
                });

                // If not found, try by ID from invoiceData
                if (!selectedInvoice && invoiceData.id) {
                  selectedInvoice = _this6.clientInvoices.find(function (invoice) {
                    return invoice.id === invoiceData.id;
                  });
                }

                // If still not found, try by invoice number
                if (!selectedInvoice && invoiceData.invoiceNo) {
                  selectedInvoice = _this6.clientInvoices.find(function (invoice) {
                    return invoice.invoiceNo === invoiceData.invoiceNo || invoice.invoiceNo === invoiceData.invoice_no;
                  });
                }
              }

              // Step 7: Set the invoice and load products
              if (selectedInvoice) {
                console.log('Found invoice in client invoices, selecting:', selectedInvoice.id);
                _this6.form.invoice = selectedInvoice;
                _this6.storeProducts();
              } else {
                // Use the fetched invoice data directly (it has all the products)
                console.log('Using fetched invoice data directly');
                _this6.form.invoice = invoiceData;
                _this6.storeProducts();
              }
    ...
    storeProducts: function storeProducts() {
      ...
      var _loop = function _loop() {
        var _this9$taxes;
        var invoiceItem = _this9.form.invoice.invoiceProducts[key];

        // Skip products that have already been fully returned
        var remainingQuantity = invoiceItem.quantity - invoiceItem.returnQty;
        if (remainingQuantity <= 0) return 1; // continue
        _this9.form.selectedProducts.unshift({
          ...
          selectedVatRate: _this9.findMatchingVatRate(invoiceItem.productTax) || _this9.form.orderTax || ((_this9$taxes = _this9.taxes) === null || _this9$taxes === void 0 ? void 0 : _this9$taxes[0]),
      ...
      this.form.selectedProducts.forEach(function (_, index) {
        _this9.calculateItemAmounts(index);
      });
    ...
    calculateSum: function calculateSum() {
      ...
      for (var i = 0; i < length; i++) {
        ...
        if (looProduct.returnQty > 0) {
          ...
          var originalLineTotal = parseFloat(looProduct.originalLineTotal) || 0;
          var totalQty = parseFloat(looProduct.originalQty) || 1;
          var returnQty = parseFloat(looProduct.returnQty) || 0;
          var originalDiscount = parseFloat(looProduct.originalDiscountAmount) || 0;
          var originalTax = parseFloat(looProduct.originalTaxTotal) || 0;
      ...
      var totalToReturnValue = Number(this.form.totalReturn.toFixed(2));
      var originalTotalValue = Number(this.form.originalInvoiceTotal.toFixed(2));
      var totalPaidValue = Number(this.form.invoice.totalPaid.toFixed(2));
      var remainingInvoiceTotal = Number((originalTotalValue - totalToReturnValue).toFixed(2));
      var balanceValue = Number((remainingInvoiceTotal - totalPaidValue).toFixed(2));
      if (balanceValue >= 0) {
        // Still has due
        this.form.newDue = balanceValue;
        this.form.invoiceDue = balanceValue;
        this.form.newDueText = "".concat(remainingInvoiceTotal, " - ").concat(totalPaidValue, " = ").concat(balanceValue.toFixed(2));
        ...
        this.form.returnAmountText = "".concat(totalPaidValue, " - ").concat(remainingInvoiceTotal, " = ").concat(this.form.returnAmount.toFixed(2));
      }
      return;
    },
    ...
    validateReturns: function validateReturns() {
      ...
      this.form.selectedProducts.forEach(function (product) {
        if (product.returnQty > product.qty) {
          errors.push(_this0.$t('Return quantity for {name} cannot exceed available quantity', {
            name: product.name
          }));
          isValid = false;
        }
        if (product.returnQty < 0) {
          errors.push(_this0.$t('Return quantity for {name} cannot be negative', {
            name: product.name
          }));
          isValid = false;
        }
    ...
    calculateItemAmounts: function calculateItemAmounts(index) {
      ...
      var returnQtyNumber = Number(product.returnQty) || 0;
      var unitCostNumber = Number(product.unitCost) || 0;

      // Calculate total before discount (unit cost × return quantity)
      var totalBeforeDiscount = Number((returnQtyNumber * unitCostNumber).toFixed(2));

      // Calculate discount amount based on type
      var discountAmount = 0;
      var discountValue = Number(product.discount) || 0;
      if (product.discountType === 'percentage') {
      ...
      // Calculate return total proportionally from original invoice line total
      var totalQty = parseFloat(product.originalQty) || 1;
      var returnQty = parseFloat(product.returnQty) || 0;
      var originalLineTotal = parseFloat(product.originalLineTotal) || 0;

      // Calculate proportional return amount: (original_line_total / total_qty) * return_qty
      var unitPrice = totalQty > 0 ? originalLineTotal / totalQty : 0;
      var returnTotal = Number((unitPrice * returnQty).toFixed(2));
      ...
      if (product.selectedVatRate && product.selectedVatRate.rate) {
        var vatAmount = Number((totalAfterDiscount * (product.selectedVatRate.rate / 100)).toFixed(2));
...
var update = injectStylesIntoStyleTag_default()(formvue_type_style_index_0_id_0549e8f2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_formvue_type_style_index_0_id_0549e8f2_prod_scoped_true_lang_css = (formvue_type_style_index_0_id_0549e8f2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/form.vue?vue&type=style&index=0&id=0549e8f2&prod&scoped=true&lang=css
