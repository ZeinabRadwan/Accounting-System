"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8410],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-5541f706]{gap:10px}.header-buttons[data-v-5541f706]{margin-bottom:15px}.footer-buttons[data-v-5541f706]{display:flex;gap:10px}.footer-buttons .btn[data-v-5541f706]{margin-right:10px}.footer-buttons .btn[data-v-5541f706]:last-child{margin-right:0}.card[data-v-5541f706]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-5541f706]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-5541f706]{background:#fff!important}.btn-primary[data-v-5541f706]{background:#2ab930!important}.btn-primary[data-v-5541f706],.btn-secondary[data-v-5541f706]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-5541f706]{background:#33a0d9!important}.btn-secondary[data-v-5541f706]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.btn-outline-custom[data-v-5541f706]{border-color:#33a0d9;border-radius:10px;color:#33a0d9;font-weight:500;padding:8px 16px;transition:background-color .3s,color .3s,border-color .3s}.btn-custom-active[data-v-5541f706],.btn-outline-custom[data-v-5541f706]:hover{background-color:#33a0d9;border-color:#33a0d9;color:#fff}h1[data-v-5541f706],h2[data-v-5541f706]{font-weight:400}ul[data-v-5541f706]{list-style-type:none;padding:0}li[data-v-5541f706]{display:inline-block;margin:0 10px}a[data-v-5541f706]{color:#42b983}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/edit.vue?vue&type=template&id=5541f706&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/products/edit.vue?vue&type=template&id=5541f706&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/edit.vue?vue&type=script&lang=js
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 14:
              ...
              console.error('Error loading account routing settings:', _context6.t0);
    ...
    onFileChange: function onFileChange(e) {
      ...
      if (file.size < 2111775 && (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/gif')) {
        ...
        this.$toast.error('error!', 'Please select a valid thumbnail with size less than 2 MB');
      }
    },
    // update product
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              if (!(!_this11.isSalesAccountAutomatic && !_this11.form.salesAccountId)) {
                _context8.next = 3;
                break;
              }
              toast.fire({
            ...
            case 3:
              if (!(!_this11.isPurchaseAccountAutomatic && !_this11.form.purchaseAccountId)) {
                _context8.next = 6;
                break;
              }
              toast.fire({
            ...
            case 6:
              _context8.next = 8;
              return _this11.form.patch(window.location.origin + '/api/products/' + _this11.$route.params.slug).then(function () {
...
;// CONCATENATED MODULE: ./resources/js/pages/products/edit.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_5541f706_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const products_editvue_type_style_index_0_id_5541f706_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_5541f706_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/products/edit.vue?vue&type=style&index=0&id=5541f706&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/products/edit.vue
