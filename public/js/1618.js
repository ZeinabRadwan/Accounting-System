...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-698bc9ea]{margin-bottom:15px}.footer-buttons[data-v-698bc9ea]{display:flex;gap:10px}.footer-buttons .btn[data-v-698bc9ea]{margin-right:10px}.footer-buttons .btn[data-v-698bc9ea]:last-child{margin-right:0}.code-generation-toggle[data-v-698bc9ea]{margin-bottom:.5rem!important}.code-generation-toggle .btn-group[data-v-698bc9ea]{background:#f1f5f9;border:none;border-radius:8px;box-shadow:inset 0 1px 3px rgba(0,0,0,.1);display:inline-flex;padding:3px;width:125%}.code-generation-toggle .btn[data-v-698bc9ea]{background:transparent!important;border-radius:5px;box-shadow:none!important;flex:1;font-size:12px;font-weight:500;line-height:1.3;padding:6px 12px;transition:all .2s ease}.code-generation-toggle .btn[data-v-698bc9ea],.code-generation-toggle .btn-outline-primary[data-v-698bc9ea]{border:none!important;color:#64748b}.code-generation-toggle .btn-outline-primary[data-v-698bc9ea]:hover{background-color:hsla(0,0%,100%,.5)!important;box-shadow:none!important;color:#475569;transform:none}.code-generation-toggle .btn.btn-primary[data-v-698bc9ea]{background:#fff!important;border:none!important;box-shadow:0 1px 3px rgba(0,0,0,.12)!important;color:#2ab930!important;transform:none!important}.code-generation-toggle .btn.btn-primary[data-v-698bc9ea]:hover{background:#fff!important;box-shadow:0 2px 4px rgba(0,0,0,.15)!important;color:#229a26!important;transform:none!important}.code-input-container[data-v-698bc9ea]{position:relative}.code-generate-btn[data-v-698bc9ea]{position:absolute;right:.5rem;top:50%;transform:translateY(-50%);z-index:10}.code-generate-btn .btn[data-v-698bc9ea]{font-size:.8rem;padding:.25rem .75rem}.code-preview[data-v-698bc9ea]{background:#e3f2fd;border:1px solid #bbdefb;border-radius:4px;font-size:.875rem;padding:.5rem}.code-preview strong[data-v-698bc9ea]{color:#1976d2;font-family:Monaco,Menlo,Ubuntu Mono,monospace}.code-warning[data-v-698bc9ea]{background:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;font-size:.875rem;padding:.5rem}.code-warning strong[data-v-698bc9ea]{color:#856404;font-family:Monaco,Menlo,Ubuntu Mono,monospace}.form-control[readonly][data-v-698bc9ea]{background-color:#f8f9fa!important;border-color:#e9ecef;cursor:not-allowed}@media (max-width:768px){.code-generate-btn[data-v-698bc9ea]{margin-top:.5rem;position:static;transform:none;width:100%}.code-generate-btn .btn[data-v-698bc9ea]{width:100%}.code-generation-toggle .btn[data-v-698bc9ea]{font-size:.8rem;padding:.4rem .8rem}}.btn-outline-primary[data-v-698bc9ea]:hover{background-color:#007bff;border-color:#007bff;color:#fff}.btn-outline-secondary[data-v-698bc9ea]:hover{background-color:#6c757d;border-color:#6c757d;color:#fff}.btn[data-v-698bc9ea]:disabled{cursor:not-allowed;opacity:.6}.btn-group.c-w-100[data-v-698bc9ea]{gap:10px}.card[data-v-698bc9ea]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-698bc9ea]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-698bc9ea]{background:#fff!important}.btn-primary[data-v-698bc9ea]{background:#2ab930!important}.btn-primary[data-v-698bc9ea],.btn-secondary[data-v-698bc9ea]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-698bc9ea]{background:#33a0d9!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/chart-of-accounts/edit.vue?vue&type=template&id=698bc9ea&scoped=true
...
var editvue_type_style_index_0_id_698bc9ea_prod_scoped_true_lang_css = __webpack_require__(41954);
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_698bc9ea_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const chart_of_accounts_editvue_type_style_index_0_id_698bc9ea_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_698bc9ea_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/chart-of-accounts/edit.vue?vue&type=style&index=0&id=698bc9ea&prod&scoped=true&lang=css
