(self["webpackChunk"] = self["webpackChunk"] || []).push([[2217],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-b65d2272]{border:none!important}.transfer-balances-table[data-v-b65d2272]{border-collapse:separate;border-spacing:0}.transfer-balances-table thead th[data-v-b65d2272]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.transfer-balances-table thead tr[data-v-b65d2272]{border:none!important}.transfer-balances-table thead th[data-v-b65d2272]:first-child{border-top-left-radius:10px}.transfer-balances-table thead th[data-v-b65d2272]:last-child{border-top-right-radius:10px}[dir=rtl] .transfer-balances-table thead th[data-v-b65d2272]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .transfer-balances-table thead th[data-v-b65d2272]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-b65d2272]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-b65d2272],.export-pdf-btn[data-v-b65d2272]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-b65d2272],.export-pdf-btn[data-v-b65d2272],.print-btn[data-v-b65d2272]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-b65d2272]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-b65d2272]{display:inline-block;position:relative}.action-icon-btn[data-v-b65d2272]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-b65d2272]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-b65d2272]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-b65d2272]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-b65d2272]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-b65d2272]{gap:10px}.btn-group.c-w-100>.btn[data-v-b65d2272]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-b65d2272]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-b65d2272]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-b65d2272]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-b65d2272]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.transfer-balances-table .badge.bg-success[data-v-b65d2272]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.transfer-balances-table .badge.bg-danger[data-v-b65d2272]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-b65d2272]{background:#f1f5fb!important}.btn-primary[data-v-b65d2272]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/transfer-balances/index.vue?vue&type=template&id=b65d2272&scoped=true
                ...
                if (result.value) {
                  _this8.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      sweetalert2_all_default().fire(_this8.$t("Failed!"), _this8.$t("Sorry you can't delete this transfer!"), "warning");
                    }
                  });
                }
              });
...
var update = injectStylesIntoStyleTag_default()(transfer_balancesvue_type_style_index_0_id_b65d2272_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const cashbook_transfer_balancesvue_type_style_index_0_id_b65d2272_prod_scoped_true_lang_css = (transfer_balancesvue_type_style_index_0_id_b65d2272_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/transfer-balances/index.vue?vue&type=style&index=0&id=b65d2272&prod&scoped=true&lang=css
