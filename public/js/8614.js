"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8614],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-0bda6fda]{margin-bottom:15px}.footer-buttons[data-v-0bda6fda]{display:flex;gap:10px}.footer-buttons .btn[data-v-0bda6fda]{margin-right:10px}.footer-buttons .btn[data-v-0bda6fda]:last-child{margin-right:0}.custom-qty-input[data-v-0bda6fda]{display:flex;flex-wrap:nowrap}.btn-primary[data-v-0bda6fda]{background:#2ab930!important}.btn-primary[data-v-0bda6fda]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/edit.vue?vue&type=template&id=0bda6fda&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    return _c('tr', {
      key: i
    }, [_c('td', [_vm._v(_vm._s(++i))]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
      ...
      staticClass: "text-center"
    }, [_vm._v("\n                        " + _vm._s(_vm._f("withCurrency")(item.unitCost)) + "\n                      ")]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v("\n                        " + _vm._s(_vm._f("withCurrency")(item.totalTax)) + "\n                      ")]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v("\n                        " + _vm._s(_vm._f("withCurrency")(item.totalPrice)) + "\n                      ")]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_c('button', {
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t("Total")))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.form.productTotalTax)))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.form.subTotal)))])]), _vm._v(" "), _c('td')])], 2)])])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_0bda6fda_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const quotations_editvue_type_style_index_0_id_0bda6fda_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_0bda6fda_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/edit.vue?vue&type=style&index=0&id=0bda6fda&prod&lang=scss&scoped=true
