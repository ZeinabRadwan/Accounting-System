"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2697,8127],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_laravel_mix_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-ebe5ff36]{border:none!important}.account-statement-table[data-v-ebe5ff36]{border-collapse:separate;border-spacing:0}.account-statement-table thead th[data-v-ebe5ff36]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.account-statement-table thead tr[data-v-ebe5ff36]{border:none!important}.account-statement-table thead th[data-v-ebe5ff36]:first-child{border-top-left-radius:10px}.account-statement-table thead th[data-v-ebe5ff36]:last-child{border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-ebe5ff36]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-ebe5ff36]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-ebe5ff36]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.export-excel-btn[data-v-ebe5ff36],.export-pdf-btn[data-v-ebe5ff36],.preview-btn[data-v-ebe5ff36]{background:#f6fef4!important;border:none;border-radius:10px;color:#2ab930!important}.print-btn[data-v-ebe5ff36]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.btn-group.c-w-100[data-v-ebe5ff36]{gap:10px}.card[data-v-ebe5ff36]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-ebe5ff36]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-ebe5ff36]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.table-responsive[data-v-ebe5ff36]{border:1px solid #dee2e6;border-radius:.375rem;overflow-y:auto}.table-sm td[data-v-ebe5ff36],.table-sm th[data-v-ebe5ff36]{font-size:.875rem;padding:.5rem .75rem}.table th[data-v-ebe5ff36]{border-bottom:2px solid #dee2e6;color:#495057;font-weight:600}.table tbody tr[data-v-ebe5ff36]:hover,.table th[data-v-ebe5ff36]{background-color:#f8f9fa}.table tbody tr.table-info[data-v-ebe5ff36]{background-color:#e3f2fd;font-weight:600}.table tbody tr.table-info[data-v-ebe5ff36]:hover{background-color:#bbdefb}.info-box[data-v-ebe5ff36]{background:#f8f9fa;border-radius:.375rem;margin-bottom:1rem;padding:1rem}.info-box[data-v-ebe5ff36],.info-box-icon[data-v-ebe5ff36]{align-items:center;display:flex}.info-box-icon[data-v-ebe5ff36]{border-radius:50%;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-ebe5ff36]{flex:1}.info-box-text[data-v-ebe5ff36]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-ebe5ff36]{color:#495057;display:block;font-size:1.5rem;font-weight:700}.badge[data-v-ebe5ff36]{font-size:.75rem;padding:.25rem .5rem}.font-weight-bold[data-v-ebe5ff36]{color:#212529}.text-muted[data-v-ebe5ff36]{color:#6c757d!important}.btn-link[data-v-ebe5ff36]{background:none;border:none;color:#007bff;padding:0;text-decoration:none}.btn-link[data-v-ebe5ff36]:hover{color:#0056b3;text-decoration:none}.btn-link[data-v-ebe5ff36]:focus{box-shadow:none;outline:none}.tree-toggle-icon[data-v-ebe5ff36]{transition:transform .2s ease}.tree-toggle-icon.expanded[data-v-ebe5ff36]{transform:rotate(90deg)}.tree-item-icon[data-v-ebe5ff36]{text-align:center;width:16px}.gap-2>*+*[data-v-ebe5ff36]{margin-left:.5rem}@media (max-width:768px){.gap-2[data-v-ebe5ff36]{align-items:stretch;flex-direction:column}.gap-2>*+*[data-v-ebe5ff36]{margin-left:0;margin-top:.5rem}}.trial-balance-table[data-v-ebe5ff36]{background:#fff;border:1px solid #dee2e6;font-size:16px}.table-header[data-v-ebe5ff36],.table-header th[data-v-ebe5ff36]{background:#f8f9fa}.table-header th[data-v-ebe5ff36]{border:1px solid #dee2e6;color:#495057;font-size:16px;font-weight:600;padding:12px 8px}.header-code[data-v-ebe5ff36]{width:10%}.header-account[data-v-ebe5ff36]{width:30%}.header-amount[data-v-ebe5ff36]{font-size:16px;width:12%}.trial-balance-table tbody tr[data-v-ebe5ff36]{border-bottom:1px solid #dee2e6}.trial-balance-table tbody tr[data-v-ebe5ff36]:hover{background:#f8f9fa}.trial-balance-table tbody tr.table-info[data-v-ebe5ff36]{background:#e9ecef;border-left:3px solid #6c757d;font-weight:600}.trial-balance-table tbody tr.table-info[data-v-ebe5ff36]:hover{background:#dee2e6}.trial-balance-table tbody tr.table-warning[data-v-ebe5ff36]{background:#fff3cd;border-left:3px solid #ffc107;font-weight:600}.trial-balance-table tbody tr.table-warning[data-v-ebe5ff36]:hover{background:#ffeaa7}.cell-code[data-v-ebe5ff36]{background:#f8f9fa}.cell-account[data-v-ebe5ff36],.cell-amount[data-v-ebe5ff36]{background:#fff}.cell-amount[data-v-ebe5ff36]{font-weight:600}.account-code-badge[data-v-ebe5ff36]{background:#6c757d;border-radius:4px;color:#fff;display:inline-block;font-size:16px;font-weight:600;padding:4px 8px}.account-name-container[data-v-ebe5ff36]{align-items:center;display:flex;padding:8px 0}.expand-btn[data-v-ebe5ff36]{align-items:center;background:none;border:none;border-radius:2px;color:#6c757d;display:flex;font-size:16px;height:20px;justify-content:center;margin-right:8px;min-width:20px;padding:2px;transition:color .2s ease}.expand-btn[data-v-ebe5ff36]:hover{background:#f8f9fa;color:#495057}.expand-spacer[data-v-ebe5ff36]{margin-right:8px;width:24px}.account-icon[data-v-ebe5ff36]{font-size:16px;margin-right:8px;text-align:center;width:16px}.account-icon.fa-folder[data-v-ebe5ff36]{color:#6c757d}.account-icon.fa-folder-open[data-v-ebe5ff36]{color:#495057}.account-icon.fa-file[data-v-ebe5ff36]{color:#adb5bd}.account-name[data-v-ebe5ff36]{color:#2c3e50;font-size:16px;font-weight:600}.total-row-name[data-v-ebe5ff36]{color:#d63384;font-style:italic;font-weight:700}.amount-value[data-v-ebe5ff36]{background:none;color:#495057;display:inline-block;font-size:16px;font-weight:600;min-width:80px;padding:0;text-align:right}.credit-amount[data-v-ebe5ff36],.debit-amount[data-v-ebe5ff36]{background:none;border:none;color:#495057}.closing-amount[data-v-ebe5ff36]{background:none;font-size:16px;font-weight:800}.amount-empty[data-v-ebe5ff36]{color:#adb5bd;font-size:16px;font-style:italic}.table-footer[data-v-ebe5ff36]{background:#f8f9fa;color:#495057}.grand-total-row[data-v-ebe5ff36]{background:#e9ecef;border-top:2px solid #6c757d}.grand-total-label[data-v-ebe5ff36]{font-weight:700;padding:12px 8px}.grand-total-amount[data-v-ebe5ff36],.grand-total-label[data-v-ebe5ff36]{background:none;color:#495057;font-size:16px}.grand-total-amount[data-v-ebe5ff36]{border:none;font-weight:600;margin:0;padding:0}.grand-total-amount.credit-amount[data-v-ebe5ff36],.grand-total-amount.debit-amount[data-v-ebe5ff36]{background:none;border:none}@media print{.no-print[data-v-ebe5ff36]{display:none!important}.card[data-v-ebe5ff36]{border:none!important;box-shadow:none!important}.table[data-v-ebe5ff36]{font-size:16px}.table-responsive[data-v-ebe5ff36]{overflow:visible}}@media (max-width:1300px){.info-box[data-v-ebe5ff36]{padding:0}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=ebe5ff36&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=ebe5ff36&scoped=true
  ...
  methods: {
    ...
    loadAnalyticalAccounts: function loadAnalyticalAccounts() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var response, _error$response7, _t7;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 3:
              _context8.p = 3;
              _t7 = _context8.v;
              console.error('Error loading analytical accounts:', _t7);
              _this8.$toast.error('', ((_error$response7 = _t7.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || _this8.$t("Failed to load analytical accounts"));
              _this8.analyticalAccounts = [];
            case 4:
              _context8.p = 4;
    ...
    searchAnalyticalAccounts: function searchAnalyticalAccounts(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var response, _error$response8, _t8;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            ...
            case 3:
              _context9.p = 3;
              _t8 = _context9.v;
              console.error('Error searching analytical accounts:', _t8);
              _this9.$toast.error('', ((_error$response8 = _t8.response) === null || _error$response8 === void 0 || (_error$response8 = _error$response8.data) === null || _error$response8 === void 0 ? void 0 : _error$response8.message) || _this9.$t("Failed to search analytical accounts"));
              _this9.analyticalAccounts = [];
            case 4:
              _context9.p = 4;
              if (loading) {
          ...
          while (1) switch (_context10.p = _context10.n) {
            case 0:
              ...
              requestData = {
                ...
                cost_center_id: _this11.filters.costCenterId,
                analytical_account_id: _this11.filters.analyticalAccountId,
      ...
      accounts.forEach(function (account) {
        ...
        if (accountWithLevel.expanded && account.children && account.children.length > 0) {
          ...
          if (children.length > 0) {
            ...
            var childrenTotals = _this12.calculateChildrenTotals(account.children);
            var totalRow = {
    ...
    applyAccountFilters: function applyAccountFilters(accounts) {
      ...
      var shouldShowAccount = function shouldShowAccount(account) {
        switch (_this13.filters.accountDisplayFilter) {
          case 'transactions_only':
            // Show only accounts with transactions
            return _this13.accountHasTransactions(account);
          case 'hide_zero_balance':
            // Hide accounts with zero closing balance
            return !_this13.accountHasZeroBalance(account);
          case 'hide_zero_opening':
            // Hide accounts with zero opening balance
            return !_this13.accountHasZeroOpeningBalance(account);
          default:
            return true;
        }
      };
    ...
    filterAccountHierarchy: function filterAccountHierarchy(accounts, filterFn) {
      ...
      accounts.forEach(function (account) {
        ...
        if (account.children && account.children.length > 0) {
          var filteredChildren = _this14.filterAccountHierarchy(account.children, filterFn);
...
var update = injectStylesIntoStyleTag_default()(trial_balancevue_type_style_index_0_id_ebe5ff36_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_trial_balancevue_type_style_index_0_id_ebe5ff36_prod_scoped_true_lang_css = (trial_balancevue_type_style_index_0_id_ebe5ff36_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=style&index=0&id=ebe5ff36&prod&scoped=true&lang=css
