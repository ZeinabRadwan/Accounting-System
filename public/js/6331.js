"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6331],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-primary[data-v-d1f01f14]{background:#2ab930!important;color:#fff!important;padding:10px 20px!important}.btn-primary[data-v-d1f01f14],.table-custom[data-v-d1f01f14]{border:none!important}.vat-report-table[data-v-d1f01f14]{border-collapse:separate;border-spacing:0}.vat-report-table thead th[data-v-d1f01f14]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.vat-report-table thead tr[data-v-d1f01f14]{border:none!important}.vat-report-table thead th[data-v-d1f01f14]:first-child{border-top-left-radius:10px}.vat-report-table thead th[data-v-d1f01f14]:last-child{border-top-right-radius:10px}[dir=rtl] .vat-report-table thead th[data-v-d1f01f14]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .vat-report-table thead th[data-v-d1f01f14]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-d1f01f14]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-d1f01f14],.export-pdf-btn[data-v-d1f01f14],.preview-btn[data-v-d1f01f14]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-d1f01f14],.export-pdf-btn[data-v-d1f01f14],.preview-btn[data-v-d1f01f14],.print-btn[data-v-d1f01f14]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-d1f01f14]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-d1f01f14]{gap:10px}.card[data-v-d1f01f14]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-d1f01f14]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.vat-report-table .badge.bg-success[data-v-d1f01f14]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.vat-report-table .badge.bg-info[data-v-d1f01f14]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.vat-report-table .badge.bg-secondary[data-v-d1f01f14]{background:#f5f5f5!important;color:#616161!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-d1f01f14]{background:#fff!important}.text-success[data-v-d1f01f14]{color:#28a745!important}.text-danger[data-v-d1f01f14]{color:#dc3545!important}@media print{.btn[data-v-d1f01f14],.card-tools[data-v-d1f01f14]{display:none!important}}@media (max-width:1300px){.info-box[data-v-d1f01f14]{padding:0}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/vat-report.vue?vue&type=template&id=d1f01f14&scoped=true
...
var update = injectStylesIntoStyleTag_default()(vat_reportvue_type_style_index_0_id_d1f01f14_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_vat_reportvue_type_style_index_0_id_d1f01f14_prod_scoped_true_lang_css = (vat_reportvue_type_style_index_0_id_d1f01f14_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/vat-report.vue?vue&type=style&index=0&id=d1f01f14&prod&scoped=true&lang=css
