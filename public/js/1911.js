"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1911],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/create.vue?vue&type=template&id=0f9e3897&scoped=true
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/create.vue?vue&type=style&index=1&id=0f9e3897&prod&scoped=true&lang=css
var createvue_type_style_index_1_id_0f9e3897_prod_scoped_true_lang_css = __webpack_require__(38494);
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_1_id_0f9e3897_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const employees_createvue_type_style_index_1_id_0f9e3897_prod_scoped_true_lang_css = (createvue_type_style_index_1_id_0f9e3897_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/employees/create.vue?vue&type=style&index=1&id=0f9e3897&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card[data-v-0f9e3897]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-0f9e3897]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-0f9e3897]{padding:1.25rem}.card-footer[data-v-0f9e3897]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-0f9e3897]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-0f9e3897]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-0f9e3897]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-0f9e3897]{color:#dc3545;font-weight:700}.btn-primary[data-v-0f9e3897]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-0f9e3897]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-0f9e3897]{background:#6c757d!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-0f9e3897]:hover{background:#5a6268!important;box-shadow:0 4px 8px hsla(208,7%,46%,.3);transform:translateY(-1px)}.is-invalid[data-v-0f9e3897]{border-color:#dc3545!important}textarea.form-control[data-v-0f9e3897]{min-height:100px;resize:vertical}.v-select[data-v-0f9e3897]{background:#f1f5fb!important}.v-select .vs__dropdown-toggle[data-v-0f9e3897]{background:#f1f5fb!important;border:1px solid #e5e7eb!important;border-radius:10px!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-0f9e3897]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-0f9e3897]{border-color:#dc3545!important}.custom-file-input[data-v-0f9e3897],.custom-file-label[data-v-0f9e3897]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px}.custom-file-label[data-v-0f9e3897]{color:#6b7280;font-size:14px}.custom-file-input:focus~.custom-file-label[data-v-0f9e3897]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.bg-light[data-v-0f9e3897]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px}.vue-tel-input[data-v-0f9e3897]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;padding:3px}.vue-tel-input[data-v-0f9e3897]:focus-within{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.vue-tel-input.is-invalid[data-v-0f9e3897]{border-color:#dc3545!important}.form-check-input[data-v-0f9e3897]{margin-top:.3rem}.form-check-label[data-v-0f9e3897]{color:#374151;font-weight:500;margin-left:.5rem}.row[data-v-0f9e3897]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-0f9e3897]{flex-direction:column;gap:10px}.card-footer .btn[data-v-0f9e3897]{margin-right:0!important;width:100%}.card-footer div[data-v-0f9e3897]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
