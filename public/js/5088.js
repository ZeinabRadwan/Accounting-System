"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5088],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-a540faea]{gap:10px}.card[data-v-a540faea]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-a540faea]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-a540faea]{padding:1.25rem}.card-footer[data-v-a540faea]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-a540faea]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-a540faea]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-a540faea]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-a540faea]{color:#dc3545;font-weight:700}.btn-primary[data-v-a540faea]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-a540faea]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-a540faea]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-a540faea]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-a540faea]{border-color:#dc3545!important}textarea.form-control[data-v-a540faea]{min-height:100px;resize:vertical}.v-select[data-v-a540faea]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-a540faea]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-a540faea]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-a540faea]{border-color:#dc3545!important}.row[data-v-a540faea]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-a540faea]{flex-direction:column;gap:10px}.card-footer .btn[data-v-a540faea]{margin-right:0!important;width:100%}.card-footer div[data-v-a540faea]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/increments/create.vue?vue&type=template&id=a540faea&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/increments/create.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./resources/js/pages/employees/increments/create.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_a540faea_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const increments_createvue_type_style_index_0_id_a540faea_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_a540faea_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/employees/increments/create.vue?vue&type=style&index=0&id=a540faea&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/employees/increments/create.vue
