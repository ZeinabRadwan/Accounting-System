"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5756],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/accounting-periods.vue?vue&type=template&id=9d4200a6
var render = function render() {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('Name')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Fiscal Year')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Start Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('End Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Status')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Actions')))])])]), _vm._v(" "), _c('tbody', _vm._l(_vm.filteredPeriods, function (period) {
    return _c('tr', {
      key: period.id
    }, [_c('td', [_vm._v(_vm._s(period.full_name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(period.fiscal_year ? period.fiscal_year.name : '-'))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.formatDate(period.start_date)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.formatDate(period.end_date)))]), _vm._v(" "), _c('td', [_c('span', {
...
;// ./resources/js/pages/setup/accounting-periods.vue?vue&type=template&id=9d4200a6
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _this3.fiscalYears = response.data.data;
              console.log('Fiscal years loaded:', _this3.fiscalYears);
              _context2.n = 3;
              break;
            case 2:
              _context2.p = 2;
              _t2 = _context2.v;
              console.error('Error fetching fiscal years:', _t2);
              toast.fire({
                type: 'error',
                title: _this3.$t('Error loading fiscal years')
              });
            case 3:
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              ...
              _context3.n = 1;
              return _this4.form.put("/api/accounting-periods/".concat(_this4.form.id));
            case 1:
              _context3.n = 3;
              break;
            case 2:
              _context3.n = 3;
              return _this4.form.post('/api/accounting-periods');
            case 3:
              toast.fire({
                type: 'success',
                title: _this4.$t('Accounting period saved successfully')
              });
              $('#periodModal').modal('hide');
              _this4.getAccountingPeriods();
              _context3.n = 5;
              break;
            case 4:
              _context3.p = 4;
              _t3 = _context3.v;
              console.error('Error saving accounting period:', _t3);
            case 5:
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 1:
              toast.fire({
                type: 'success',
                title: _this5.$t('Current accounting period set successfully')
              });
              _this5.getAccountingPeriods();
              _context4.n = 3;
              break;
            case 2:
              _context4.p = 2;
              _t4 = _context4.v;
              console.error('Error setting current period:', _t4);
            case 3:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              if (!confirm(_this6.$t('Are you sure you want to close this accounting period?'))) {
                _context5.n = 4;
                break;
              }
              _context5.p = 1;
            ...
            case 2:
              toast.fire({
                type: 'success',
                title: _this6.$t('Accounting period closed successfully')
              });
              _this6.getAccountingPeriods();
              _context5.n = 4;
              break;
            case 3:
              _context5.p = 3;
              _t5 = _context5.v;
              console.error('Error closing period:', _t5);
            case 4:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              if (!confirm(_this7.$t('Are you sure you want to reopen this accounting period?'))) {
                _context6.n = 4;
                break;
              }
              _context6.p = 1;
            ...
            case 2:
              toast.fire({
                type: 'success',
                title: _this7.$t('Accounting period reopened successfully')
              });
            ...
            case 3:
              _context6.p = 3;
              _t6 = _context6.v;
              console.error('Error reopening period:', _t6);
            case 4:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              if (!confirm(_this8.$t('Are you sure you want to delete this accounting period?'))) {
                _context7.n = 4;
                break;
              }
              _context7.p = 1;
            ...
            case 2:
              toast.fire({
                type: 'success',
                title: _this8.$t('Accounting period deleted successfully')
              });
            ...
            case 3:
              _context7.p = 3;
              _t7 = _context7.v;
              console.error('Error deleting period:', _t7);
              toast.fire({
                type: 'error',
                title: _this8.$t('Cannot delete closed accounting period')
              });
            case 4:
