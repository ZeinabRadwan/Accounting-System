"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2612],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-f8db2d34]{gap:10px}.header-buttons[data-v-f8db2d34]{margin-bottom:15px}.footer-buttons[data-v-f8db2d34]{display:flex;gap:10px}.footer-buttons .btn[data-v-f8db2d34]{margin-right:10px}.footer-buttons .btn[data-v-f8db2d34]:last-child{margin-right:0}.card[data-v-f8db2d34]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-f8db2d34]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-f8db2d34]{background:#fff!important}.btn-primary[data-v-f8db2d34]{background:#2ab930!important}.btn-primary[data-v-f8db2d34],.btn-secondary[data-v-f8db2d34]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-f8db2d34]{background:#33a0d9!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/accounts/edit.vue?vue&type=template&id=f8db2d34&scoped=true
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios_default().get(window.location.origin + '/api/accounts/' + _this2.$route.params.slug);
            case 2:
              _yield$axios$get = _context2.sent;
              data = _yield$axios$get.data;
              _this2.form.accountLabel = data.data.accountLabel;
              _this2.form.bankName = data.data.bankName;
              _this2.form.branchName = data.data.branchName;
              _this2.form.accountNumber = data.data.accountNumber;
              ...
              if (data.data.chartOfAccount && data.data.chartOfAccount.id) {
                _this2.form.chartOfAccountId = data.data.chartOfAccount.id;
              } else {
                _this2.form.chartOfAccountId = null;
              }
            case 13:
            case "end":
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this3.form.patch(window.location.origin + '/api/accounts/' + _this3.$route.params.slug).then(function () {
                // Clear temporary data after successful save
                _this3.clearTemporaryData();
                toast.fire({
                  type: 'success',
                  title: _this3.$t('Account updated successfully')
                });
                _this3.$router.push({
                  name: 'accounts.index'
                });
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_f8db2d34_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const accounts_editvue_type_style_index_0_id_f8db2d34_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_f8db2d34_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/accounts/edit.vue?vue&type=style&index=0&id=f8db2d34&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/accounts/edit.vue?vue&type=style&index=1&id=f8db2d34&prod&scoped=true&lang=css
var editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css = __webpack_require__(16274);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/accounts/edit.vue?vue&type=style&index=1&id=f8db2d34&prod&scoped=true&lang=css

            

var editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css_options = {};

editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css_options.insert = "head";
editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css_options.singleton = false;

var editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css/* default */.A, editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css_options);



/* harmony default export */ const accounts_editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css = (editvue_type_style_index_1_id_f8db2d34_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/accounts/edit.vue?vue&type=style&index=1&id=f8db2d34&prod&scoped=true&lang=css
