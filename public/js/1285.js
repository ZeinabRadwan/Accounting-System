"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1285],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/profile.vue?vue&type=template&id=52bcfa6a&scoped=true
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Update your profile')))])]), _vm._v(" "), _c('div', {
    ...
    staticClass: "mr-3"
  }, [_vm.profileImagePreview ? _c('img', {
    ...
    attrs: {
      "src": _vm.profileImagePreview,
      "alt": "Profile Preview"
    }
  }) : _c('div', {
    staticClass: "rounded-circle bg-light d-flex align-items-center justify-content-center",
    staticStyle: {
      "width": "80px",
      "height": "80px"
    }
  }, [_c('i', {
    staticClass: "fas fa-user fa-2x text-muted"
  })])]), _vm._v(" "), _c('div', [_c('input', {
    ref: "profileImageInput",
    staticClass: "form-control-file",
    "class": {
      'is-invalid': _vm.form.errors.has('profile_image')
    },
    attrs: {
      "type": "file",
      "accept": "image/*",
  ...
  }, [_vm._v("\n                                " + _vm._s(_vm.$t('Select an image (JPEG, PNG, JPG, GIF) - Max 2MB')) + "\n                            ")]), _vm._v(" "), _c('has-error', {
    attrs: {
      "form": _vm.form,
      "field": "profile_image"
    }
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/profile.vue?vue&type=script&lang=js
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              ...
              _this.profileImagePreview = data.data.photo_url;
            case 2:
              return _context.a(2);
          }
        }, _callee);
    ...
    handleImageChange: function handleImageChange(event) {
      ...
      if (file) {
        ...
        reader.onload = function (e) {
          _this2.profileImagePreview = e.target.result;
        };
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              formData.append('currentPassword', _this3.form.currentPassword);
              formData.append('newPassword', _this3.form.newPassword);
              formData.append('confirmPassword', _this3.form.confirmPassword);
              if (_this3.form.profile_image) {
                formData.append('profile_image', _this3.form.profile_image);
              }
              _context2.p = 2;
              _context2.n = 3;
              return axios_default().post(window.location.origin + '/api/update-profile', formData, {
                headers: {
            ...
            case 3:
              toast.fire({
                type: 'success',
                title: _this3.$t('Profile updated successfully')
              });
            ...
            case 4:
              ...
              _this3.form.reset();
              _this3.form.profile_image = null;
              _context2.n = 6;
              break;
            case 5:
              _context2.p = 5;
              _t = _context2.v;
              if (_t.response && _t.response.data.errors) {
                _this3.form.errors.record(_t.response.data.errors);
              }
              toast.fire({
                type: 'error',
...
;// ./resources/js/pages/settings/profile.vue?vue&type=script&lang=js
 /* harmony default export */ const settings_profilevue_type_script_lang_js = (profilevue_type_script_lang_js); 
...
var component = (0,componentNormalizer/* default */.A)(
  settings_profilevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
