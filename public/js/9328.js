"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9328],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=0071d1e0&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    generateItemTotalPrice: function generateItemTotalPrice(index) {
      ...
      var isTransportTaxable = this.isSupplierTaxable; // transport taxable only when supplier is taxable
      var vatBase = this.roundToTwoDecimals(netTotal + (isTransportTaxable ? proportionalTransport : 0));
    ...
    updateNetTotal: function updateNetTotal() {
      ...
      var transportTotal = Number(this.form.transportTaxableCost || this.form.transportCost || 0);
          ...
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              toast.fire({
                ...
                text: _this0.$t("Please select an account")
              });
              return _context7.abrupt("return");
            case 7:
              if (!(!_this0.form.totalPaid || Number(_this0.form.totalPaid) <= 0)) {
                _context7.next = 11;
                break;
              }
              event.preventDefault();
              toast.fire({
                type: "error",
                title: _this0.$t("Validation Error"),
                text: _this0.$t("Please enter the total amount paid")
              });
              return _context7.abrupt("return");
            case 11:
              _context7.next = 13;
              return _this0.savePurchase();
            case 13:
              _context7.prev = 13;
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 2:
              ...
              if (!_this1.form.supplier) {
                validationErrors.push(_this1.$t("Please select a supplier"));
              }

              // Check products
              if (!_this1.form.selectedProducts || _this1.form.selectedProducts.length === 0) {
                validationErrors.push(_this1.$t("Please add at least one product"));
              }

              // Check account (only required if adding payment)
              if (_this1.form.addPayment == 1 && !_this1.form.account) {
                validationErrors.push(_this1.$t("Please select an account"));
              }

              // Check total paid (only required if adding payment)
              if (_this1.form.addPayment == 1 && (!_this1.form.totalPaid || Number(_this1.form.totalPaid) <= 0)) {
                validationErrors.push(_this1.$t("Please enter the total amount paid"));
              }

              // Check product details
              if (_this1.form.selectedProducts && _this1.form.selectedProducts.length > 0) {
                _this1.form.selectedProducts.forEach(function (product, index) {
                  if (!product.qty || Number(product.qty) <= 0) {
                    validationErrors.push("".concat(_this1.$t("Product"), " ").concat(index + 1, ": ").concat(_this1.$t("Invalid quantity")));
                  }
                  if (!product.unitPrice || Number(product.unitPrice) <= 0) {
                    validationErrors.push("".concat(_this1.$t("Product"), " ").concat(index + 1, ": ").concat(_this1.$t("Invalid unit price")));
                  }
                });
              }
              ...
              toast.fire({
                type: "error",
                title: "".concat(_this1.$t("Validation Error"), ":\n\n").concat(errorList),
                timer: 8000,
            ...
            case 12:
              ...
              _this1.form.errors.clear();

              // Submit the form

              // Prepare the form data
              if (!(_this1.form.attachments && _this1.form.attachments.length > 0)) {
                _context8.next = 52;
                break;
              }
              // Create FormData for file uploads
              formDataObj = _this1.form.data();
              ...
              appendIfDefined('addPayment', _this1.form.addPayment == 1 ? 1 : 0);
              ...
              if (!_this1.isSaudiArabia && formDataObj.orderTax) {
              ...
              _this1.form.attachments.forEach(function (file) {
              ...
              _context8.next = 45;
              return _this1.$axios.post("/api/purchases", formData, {
                headers: {
            ...
            case 45:
              ...
              toast.fire({
                type: "success",
                title: _this1.$t("Purchase added successfully")
              });
              ...
              if (response.data.data.journal_entries_created) {
                setTimeout(function () {
                  toast.fire({
                    type: "success",
                    title: _this1.$t("Journal Entry Created Successfully"),
                    timer: 4000,
                    timerProgressBar: true
                  });
                }, 500);
            ...
            case 52:
              ...
              formData.addPayment = _this1.form.addPayment == 1;

              // Only include payment-related fields if payment is being added
              if (_this1.form.addPayment == 1) {
                formData.account = _this1.form.account;
                formData.totalPaid = _this1.form.totalPaid;
                formData.availableBalance = _this1.form.availableBalance;
              } else {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              if (!(!_this10.form.supplier || _this10.isAutoAssigningSupplier)) {
                _context9.next = 2;
                break;
              }
            ...
            case 2:
              ...
              _context9.prev = 3;
              _context9.next = 6;
              return _this10.$http.post("/api/suppliers/".concat(_this10.form.supplier.slug, "/auto-assign-chart-of-account"));
            case 6:
              response = _context9.sent;
              if (response.data.success) {
                console.log('Auto-assign response:', response.data);
                console.log('Current supplier before update:', _this10.form.supplier);

                // Update the supplier data with new chart of account
                _this10.form.supplier.chart_of_account_id = response.data.chart_of_account_id;
                console.log('Supplier after updating chart_of_account_id:', _this10.form.supplier);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0() {
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              if (!(!product || _this11.isAutoAssigningProduct === product.id)) {
                _context0.next = 2;
                break;
              }
            ...
            case 2:
              ...
              _context0.prev = 3;
              _context0.next = 6;
              return _this11.$http.post("/api/products/".concat(product.slug, "/auto-assign-chart-of-account"));
            case 6:
            ...
            case 14:
              _context0.prev = 14;
              _this11.isAutoAssigningProduct = false;
        ...
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            case 0:
              ...
              _this12.form.errors.clear('supplier');

              // If a supplier is selected, ensure we have the latest data including Chart of Account
              if (!(_this12.form.supplier && _this12.form.supplier.id)) {
                _context1.next = 9;
                break;
              }
              // Find the supplier in the suppliers list to get the most up-to-date data
              updatedSupplier = _this12.suppliers.find(function (s) {
                return s.id === _this12.form.supplier.id;
              });
              if (updatedSupplier) {
                // Update the form supplier with all the latest data
                _this12.form.supplier = _objectSpread({}, updatedSupplier);
              }
            ...
            case 6:
              ...
              if (_this12.form.selectedProducts && _this12.form.selectedProducts.length > 0) {
                _this12.form.selectedProducts.forEach(function (selectedProduct, index) {
                  var freshProduct = _this12.products.find(function (p) {
                    return p.id === selectedProduct.id;
                  });
                  if (freshProduct) {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 3:
              ...
              if (data.data) {
                _this13.costCenters = data.data;
              } else if (Array.isArray(data)) {
                _this13.costCenters = data;
              } else {
                _this13.costCenters = [];
              }
              _context10.next = 12;
          ...
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 3:
              ...
              if (response.data && response.data.data) {
                _this14.paymentMethods = response.data.data;
              }
              _context11.next = 11;
              break;
            case 7:
    ...
    resetForm: function resetForm() {
      ...
      sweetalert2_all_default().fire({
        ...
        if (result.value) {
          ...
          _this17.form.addPayment = "0"; // Default to "No"
          _this17.form.chequeNo = "";
          _this17.form.receiptNo = "";
          ...
          while (1) switch (_context14.prev = _context14.next) {
            ...
            case 39:
              ...
              toast.fire({
                ...
                text: ((_error$response = _context14.t2.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this18.$t("Please try again")
              });
            case 44:
            case "end":
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_0071d1e0_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_0071d1e0_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_0071d1e0_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=0071d1e0&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-0071d1e0]{margin-bottom:15px}.footer-buttons[data-v-0071d1e0]{display:flex;gap:10px}.footer-buttons .btn[data-v-0071d1e0]{margin-right:10px}.footer-buttons .btn[data-v-0071d1e0]:last-child{margin-right:0}.create-btn[data-v-0071d1e0]{padding:11px}.chart-account-success[data-v-0071d1e0],.chart-account-warning[data-v-0071d1e0]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-0071d1e0]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-0071d1e0]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-0071d1e0],.warning-content[data-v-0071d1e0]{align-items:center;display:flex;gap:16px}.success-icon[data-v-0071d1e0],.warning-icon[data-v-0071d1e0]{flex-shrink:0;font-size:24px}.warning-icon[data-v-0071d1e0]{color:#856404}.success-icon[data-v-0071d1e0]{color:#155724}.success-text[data-v-0071d1e0],.warning-text[data-v-0071d1e0]{flex-grow:1}.success-title[data-v-0071d1e0],.warning-title[data-v-0071d1e0]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-0071d1e0]{color:#856404}.success-title[data-v-0071d1e0]{color:#155724}.success-description[data-v-0071d1e0],.warning-description[data-v-0071d1e0]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-0071d1e0]{color:#856404}.success-description[data-v-0071d1e0]{color:#155724}.warning-action[data-v-0071d1e0]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-0071d1e0]{padding:0}.card[data-v-0071d1e0]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-0071d1e0]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-0071d1e0]{padding:1.25rem}.card-footer[data-v-0071d1e0]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-0071d1e0]{border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-0071d1e0]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-0071d1e0]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-0071d1e0]{color:#dc3545;font-weight:700}.btn-primary[data-v-0071d1e0]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-0071d1e0]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-0071d1e0]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-0071d1e0]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-0071d1e0]{border-color:#dc3545!important}textarea.form-control[data-v-0071d1e0]{min-height:100px;resize:vertical}.v-select[data-v-0071d1e0],.v-select .vs__dropdown-toggle[data-v-0071d1e0]{background:#fff!important;border:1px solid #e5e7eb}.v-select .vs__dropdown-toggle[data-v-0071d1e0]{padding:10px 16px}.v-select .vs__search[data-v-0071d1e0]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-0071d1e0]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-0071d1e0]{color:#374151}.v-select .vs__dropdown-menu[data-v-0071d1e0]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-0071d1e0]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-0071d1e0]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-0071d1e0]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-0071d1e0]:hover{background-color:#f8f9fa}.toggle-button[data-v-0071d1e0]{margin-right:10px}.product-status[data-v-0071d1e0],.supplier-status[data-v-0071d1e0]{font-size:13px}.product-warning[data-v-0071d1e0],.supplier-warning[data-v-0071d1e0]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-0071d1e0]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-0071d1e0]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-0071d1e0]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-0071d1e0]{margin-bottom:1rem}.form-text[data-v-0071d1e0]{color:#6b7280;font-size:.875rem}.text-muted[data-v-0071d1e0]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-0071d1e0]{flex-direction:column;gap:10px}.card-footer .btn[data-v-0071d1e0]{margin-right:0!important;width:100%}.card-footer div[data-v-0071d1e0]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-0071d1e0]{font-size:12px}.table-custom tbody td[data-v-0071d1e0],.table-custom thead th[data-v-0071d1e0]{padding:8px 4px}}.btn-group.c-w-100[data-v-0071d1e0]{gap:10px}.quantity-field[data-v-0071d1e0]{border-radius:0!important;margin:0!important;min-height:50px!important}.table-custom[data-v-0071d1e0]{border:none!important}.invoices-create-table[data-v-0071d1e0]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-0071d1e0]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-0071d1e0]{border:none!important}.invoices-create-table thead th[data-v-0071d1e0]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-0071d1e0]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-0071d1e0]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-0071d1e0]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-create-table .badge.badge-danger[data-v-0071d1e0]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-0071d1e0]{background:#fff!important}.summary-footer-wrapper[data-v-0071d1e0]{margin-top:10px}.summary-footer-row[data-v-0071d1e0]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-0071d1e0]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-0071d1e0]{color:#495057}.summary-label[data-v-0071d1e0],.summary-value[data-v-0071d1e0]{font-size:14px;padding:12px 16px}.summary-value[data-v-0071d1e0]{color:#212529;text-align:left}.grand-total-row[data-v-0071d1e0]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-0071d1e0]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-0071d1e0]{text-align:left}[dir=rtl] .summary-value[data-v-0071d1e0]{text-align:right}@media (max-width:768px){.summary-label[data-v-0071d1e0],.summary-value[data-v-0071d1e0]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-0071d1e0]{font-size:14px}}.product-option[data-v-0071d1e0]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-0071d1e0]:last-child{border-bottom:none}.product-option-header[data-v-0071d1e0]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-0071d1e0]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-0071d1e0]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-0071d1e0]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-0071d1e0]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-0071d1e0]{color:#33a0d9;font-size:11px}.badge-sm[data-v-0071d1e0]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-0071d1e0]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-0071d1e0]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-0071d1e0]{background-color:#e3f2fd}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
