"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4148],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=19aab82a&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    })], 2), _vm._v(" "), !item.productTax || !item.productTax.id ? _c('i', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Product needs VAT rate assigned'),
        expression: "$t('Product needs VAT rate assigned')"
      }],
      staticClass: "fas fa-exclamation-triangle text-warning ml-1",
      staticStyle: {
        "font-size": "14px"
      }
    }) : _vm._e()]), _vm._v(" "), _vm.form.errors.has("selectedProducts.".concat(index, ".selectedVatRate")) ? _c('div', {
      staticClass: "invalid-feedback d-block"
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=19aab82a&scoped=true
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              ...
              productsWithoutVatRate = _this0.form.selectedProducts.filter(function (product) {
                return !product.productTax || !product.productTax.id;
              });
              if (productsWithoutVatRate.length > 0) {
                ...
                validationErrors.push({
                  type: "warning",
                  title: _this0.$t("Product VAT Rate Required"),
                  message: _this0.$t("The following products must have a VAT rate assigned: ") + _productNames,
                  field: "products",
                  timer: 8000,
                  timerProgressBar: true
                });
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_19aab82a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_19aab82a_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_19aab82a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=19aab82a&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductCreateModal.vue?vue&type=template&id=77923dd0&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('VModal', {
...
;// ./resources/js/components/ProductCreateModal.vue?vue&type=style&index=0&id=77923dd0&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-19aab82a]{margin-bottom:15px}.footer-buttons[data-v-19aab82a]{display:flex;gap:10px}.footer-buttons .btn[data-v-19aab82a]{margin-right:10px}.footer-buttons .btn[data-v-19aab82a]:last-child{margin-right:0}.create-btn[data-v-19aab82a]{padding:11px}.chart-account-success[data-v-19aab82a],.chart-account-warning[data-v-19aab82a]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-19aab82a]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-19aab82a]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-19aab82a],.warning-content[data-v-19aab82a]{align-items:center;display:flex;gap:16px}.success-icon[data-v-19aab82a],.warning-icon[data-v-19aab82a]{flex-shrink:0;font-size:24px}.warning-icon[data-v-19aab82a]{color:#856404}.success-icon[data-v-19aab82a]{color:#155724}.success-text[data-v-19aab82a],.warning-text[data-v-19aab82a]{flex-grow:1}.success-title[data-v-19aab82a],.warning-title[data-v-19aab82a]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-19aab82a]{color:#856404}.success-title[data-v-19aab82a]{color:#155724}.success-description[data-v-19aab82a],.warning-description[data-v-19aab82a]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-19aab82a]{color:#856404}.success-description[data-v-19aab82a]{color:#155724}.warning-action[data-v-19aab82a]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-19aab82a]{padding:0}.btn-primary[data-v-19aab82a]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-19aab82a]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-19aab82a],.warning-content[data-v-19aab82a]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-19aab82a],.warning-action[data-v-19aab82a]{width:100%}}.client-status[data-v-19aab82a]{font-size:13px}.client-success[data-v-19aab82a],.client-warning[data-v-19aab82a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-19aab82a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-19aab82a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-19aab82a]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-19aab82a]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-19aab82a]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-19aab82a]{font-size:13px}.product-success[data-v-19aab82a],.product-warning[data-v-19aab82a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-19aab82a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-19aab82a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-19aab82a]{font-size:13px}.account-success[data-v-19aab82a],.account-warning[data-v-19aab82a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-19aab82a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-19aab82a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-19aab82a]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-19aab82a]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-19aab82a]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-19aab82a]{cursor:pointer;margin-bottom:0}.text-warning[data-v-19aab82a]{color:#856404!important}.text-warning small[data-v-19aab82a]{font-size:12px;font-weight:500}.text-warning i[data-v-19aab82a]{margin-right:4px}.table-custom[data-v-19aab82a]{border:none!important}.invoices-create-table[data-v-19aab82a]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-19aab82a]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-19aab82a]{border:none!important}.invoices-create-table thead th[data-v-19aab82a]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-19aab82a]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-19aab82a]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-19aab82a]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-19aab82a]{gap:10px}.card[data-v-19aab82a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-19aab82a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-19aab82a]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-19aab82a]{background:#fff!important}.quantity-field[data-v-19aab82a]{border-radius:0!important;margin:0!important;min-height:50px!important}.btn-primary[data-v-19aab82a]{background:#2ab930!important}.btn-secondary[data-v-19aab82a]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-19aab82a]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-19aab82a]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-19aab82a]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-19aab82a]{flex-grow:1}.stock-warning-title[data-v-19aab82a]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-19aab82a]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-19aab82a]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-19aab82a]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-19aab82a]:last-child{margin-bottom:0}.product-name[data-v-19aab82a]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-19aab82a]{color:#856404;opacity:.8}.stock-details strong[data-v-19aab82a]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-19aab82a]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-19aab82a]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-19aab82a]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-19aab82a]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-19aab82a]{align-self:center}.stock-warning-list[data-v-19aab82a]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-19aab82a]{text-align:right}}.clickable-badge[data-v-19aab82a]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-19aab82a]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-19aab82a]:active{transform:scale(.95)}.insufficient-stock-input[data-v-19aab82a]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-19aab82a]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductEditModal.vue?vue&type=template&id=93ce5d4a&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
...
;// ./resources/js/components/ProductEditModal.vue?vue&type=style&index=0&id=93ce5d4a&prod&scoped=true&lang=css
