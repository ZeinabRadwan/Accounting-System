"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6308],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/settings/features.vue?vue&type=template&id=74123b36&scoped=true
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/settings/features.vue?vue&type=script&lang=js
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              if (!_this0.isDemoMode) {
                _context9.n = 1;
                break;
              }
              return _context9.a(2, toast.fire({
                type: 'warning',
                title: _this0.$t('You are not allowed to do this in demo version.')
              }));
            case 1:
              _this0.formType = 'edit';
              _this0.formUpdateId = id;
              _context9.n = 2;
              return axios_default().get(window.location.origin + '/api/setting-images/' + id);
            case 2:
              _yield$axios$get2 = _context9.v;
              data = _yield$axios$get2.data;
              _this0.dataForm.fill(data.data);
              _this0.url = data.data.image;
              _this0.showModal = true;
            case 3:
          ...
          while (1) switch (_context0.n) {
            ...
            case 1:
              Swal.fire({
                ...
                confirmButtonText: _this1.$t('Delete')
                ...
                if (result.value) {
                  _this1.$store.dispatch('operations/deleteData', {
                    ...
                    if (response === true) {
                      Swal.fire(_this1.$t('Deleted!'), _this1.$t('Deleted successfully.'), 'success');
                      _this1.getTableData();
                    } else {
                      Swal.fire(_this1.$t('Failed!'), _this1.$t('There was something wrong.'), 'warning');
                    }
                  });
                }
              });
...
;// ./resources/js/pages/central/settings/features.vue?vue&type=script&lang=js
