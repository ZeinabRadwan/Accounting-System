...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".error-container[data-v-6d243948]{align-items:center;background-color:#fff;display:flex;height:100%;justify-content:center;left:0;padding:2rem;position:fixed;text-align:center;top:0;width:100%;z-index:9999}.error-container .alert[data-v-6d243948]{margin:0 auto;max-width:400px}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/auth/cross-domain-login.vue?vue&type=template&id=6d243948&scoped=true
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _this.loadingText = _this.$t('Authenticating');
            _this.subText = _this.$t('Please wait while we verify your credentials');
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 2:
              ...
              // Update loading text
              _this2.loadingText = _this2.$t('Setting up your session');
              _this2.subText = _this2.$t('Almost there! Preparing your dashboard');
            ...
            case 3:
              ...
              _this2.loadingText = _this2.$t('Loading your dashboard');
              _this2.subText = _this2.$t('Finalizing your login process');
...
var update = injectStylesIntoStyleTag_default()(cross_domain_loginvue_type_style_index_0_id_6d243948_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const auth_cross_domain_loginvue_type_style_index_0_id_6d243948_prod_scoped_true_lang_css = (cross_domain_loginvue_type_style_index_0_id_6d243948_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/auth/cross-domain-login.vue?vue&type=style&index=0&id=6d243948&prod&scoped=true&lang=css
