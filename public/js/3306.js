"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3306],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".export-excel-btn[data-v-a3811c70],.export-pdf-btn[data-v-a3811c70]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-a3811c70],.export-pdf-btn[data-v-a3811c70],.print-btn[data-v-a3811c70]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-a3811c70]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group[data-v-a3811c70]{gap:10px}", ""]);
// Exports
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ inventory_history)
});

;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history.vue?vue&type=template&id=a3811c70&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    staticClass: "mb-3 no-print"
  }, [_c('label', {
    staticClass: "mr-2"
  }, [_vm._v(_vm._s(_vm.$t('Filter by Operation Type')) + ":")]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      "change": function change($event) {
        ...
        _vm.selectedOperationType = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Purchase')))]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "Invoice Return"
    }
  }, [_vm._v(_vm._s(_vm.$t('Invoice Return')))]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "Invoice"
    }
  ...
  }, [_vm._v(_vm._s(_vm.$t('Purchase Return')))])])]) : _vm._e(), _vm._v(" "), _vm.allData ? _c('div', {
  ...
  }, [_c('CompanyInfo')], 1), _vm._v(" "), _vm.product && _vm.product.category && _vm.product.subCategory && _vm.product.itemUnit ? _c('div', {
    staticClass: "col-sm-8 invoice-col float-right text-md-right"
  }, [_c('p', [_vm._v("\n            " + _vm._s(_vm.$t('Date')) + ": " + _vm._s(_vm._f("moment")(_vm.date, 'Do MMM, YYYY')) + "\n          ")]), _vm._v(" "), _c('h5', [_vm._v(_vm._s(_vm.$t('Product Details')))]), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t('Code')) + ":")]), _vm._v("\n          " + _vm._s(_vm._f("withPrefix")(_vm.product.code, _vm.productPrefix))), _c('br'), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t('Name')) + ":")]), _vm._v(" " + _vm._s(_vm.product.name)), _c('br'), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t('Category')) + ":")]), _vm._v("\n          " + _vm._s(_vm.product.category.name)), _c('br'), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t('Sub Category')) + ":")]), _vm._v("\n          " + _vm._s(_vm.product.subCategory.name)), _c('br'), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t('Stock')) + ":")]), _vm._v("\n          " + _vm._s(_vm.product.availableQty) + " " + _vm._s(_vm.product.itemUnit ? _vm.product.itemUnit.code : '-') + " "), _c('br')]) : _vm._e()]), _vm._v(" "), _c('hr'), _vm._v(" "), _c('div', {
  ...
  }, [_c('i', [_vm._v(_vm._s(_vm.$t('Stock In')))])]), _vm._v(" "), _c('div', {
    staticClass: "table-responsive table-custom"
  }, [_c('table', {
    staticClass: "table table-sm"
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('#')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Stock In')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Price')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Type')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Code')))]), _vm._v(" "), _c('th', [_vm._v("\n                    " + _vm._s(_vm.$t('Supplier')) + "/" + _vm._s(_vm.$t('Client')) + "\n                  ")])])]), _vm._v(" "), _c('tbody', [_vm._l(_vm.filteredStockIns, function (data, i) {
    return _c('tr', {
      key: i
    ...
    }, [_vm._v(_vm._s(data.type))])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.code))]), _vm._v(" "), _c('td', [data.type === 'Purchase' ? _c('span', [_vm._v(_vm._s(data.supplier))]) : data.type === 'Invoice Return' ? _c('span', [_vm._v(_vm._s(data.client))]) : _vm._e()])]);
  }), _vm._v(" "), _c('tr', [_c('td', {
    attrs: {
      "colspan": "2",
      "align": "right"
    }
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t('Total Quantity')))])]), _vm._v(" "), _vm.filteredStockIns ? _c('td', {
    attrs: {
      "colspan": "5"
    }
  }, [_c('strong', [_vm._v(_vm._s(_vm.stockInQty(_vm.filteredStockIns)))])]) : _vm._e()])], 2)])])]), _vm._v(" "), _c('div', {
    staticClass: "col-lg-6"
  }, [_c('h4', {
    attrs: {
      "align": "center"
    }
  }, [_c('i', [_vm._v(_vm._s(_vm.$t('Stock Out')))])]), _vm._v(" "), _c('div', {
    staticClass: "table-responsive table-custom"
  }, [_c('table', {
    staticClass: "table table-sm"
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('#')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Stock Out')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Price')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Type')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Code')))]), _vm._v(" "), _c('th', [_vm._v("\n                    " + _vm._s(_vm.$t('Client')) + "/" + _vm._s(_vm.$t('Supplier')) + "\n                  ")])])]), _vm._v(" "), _c('tbody', [_vm._l(_vm.filteredStockOuts, function (data, i) {
    return _c('tr', {
      key: i
    }, [_c('td', [_vm._v(_vm._s(i + 1))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("moment")(data.date, 'Do MMM, YYYY')))]), _vm._v(" "), _c('td', [_vm._v("-" + _vm._s(data.quantity))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.price) + " "), _c('span', {
      staticClass: "saudi-riyal"
      ...
      staticClass: "badge bg-success"
    }, [_vm._v(_vm._s(data.type))])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.code))]), _vm._v(" "), _c('td', [data.type === 'Invoice' ? _c('span', [_vm._v(_vm._s(data.client))]) : data.type === 'Purchase Return' ? _c('span', [_vm._v(_vm._s(data.supplier))]) : _vm._e()])]);
  }), _vm._v(" "), _c('tr', [_c('td', {
    attrs: {
      "colspan": "2",
      "align": "right"
    }
  }, [_c('b', [_c('i', [_vm._v(_vm._s(_vm.$t('Total Quantity')) + ": ")])])]), _vm._v(" "), _vm.filteredStockOuts ? _c('td', {
    attrs: {
      "colspan": "5"
    }
  }, [_c('b', [_c('i', [_vm._v("- " + _vm._s(_vm.stockOutQty(_vm.filteredStockOuts)) + " ")])])]) : _vm._e()])], 2)])])])], 1)])])], 1);
};
var staticRenderFns = [];
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history.vue?vue&type=script&lang=js
...
/* harmony default export */ const historyvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)('operations', ['appInfo'])), {}, {
    exportUrl: function exportUrl() {
      // Create a dynamic export URL with product slug and locale
      var locale = this.$i18n.locale;
      return "/inventory-history/".concat(this.$route.params.slug, "/export/excel?locale=").concat(locale);
    },
    pdfExportUrl: function pdfExportUrl() {
      // Use PDF export URL with product slug and locale
      var locale = this.$i18n.locale;
      return "/inventory-history/".concat(this.$route.params.slug, "/pdf?locale=").concat(locale);
    },
    filteredStockIns: function filteredStockIns() {
      var _this = this;
      ...
      return this.allData.stockIns.filter(function (item) {
        return item.type === _this.selectedOperationType;
      });
    },
    filteredStockOuts: function filteredStockOuts() {
      var _this2 = this;
      ...
      return this.allData.stockOuts.filter(function (item) {
        return item.type === _this2.selectedOperationType;
      });
    }
  }),
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              _this3.loading = true;
              _context.n = 1;
              return axios_default().get(window.location.origin + '/api/inventory-history/' + _this3.$route.params.slug);
            case 1:
...
;// ./resources/js/pages/inventory/history.vue?vue&type=script&lang=js
 /* harmony default export */ const inventory_historyvue_type_script_lang_js = (historyvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/inventory/history.vue?vue&type=style&index=0&id=a3811c70&prod&scoped=true&lang=css
var historyvue_type_style_index_0_id_a3811c70_prod_scoped_true_lang_css = __webpack_require__(35411);
...
var update = injectStylesIntoStyleTag_default()(historyvue_type_style_index_0_id_a3811c70_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const inventory_historyvue_type_style_index_0_id_a3811c70_prod_scoped_true_lang_css = (historyvue_type_style_index_0_id_a3811c70_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/inventory/history.vue?vue&type=style&index=0&id=a3811c70&prod&scoped=true&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  inventory_historyvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ const inventory_history = (component.exports);
