"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2683],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/domains/index.vue?vue&type=template&id=4f4bb5ac
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    attrs: {
      "columns": _vm.domainColumns,
      "rows": _vm.domainsWithIndex,
      "loading": _vm.loading,
      "table-id": "printMe",
      "wrapper-class": "mt-3",
      "show-actions": true
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var row = _ref.row;
        return [row.tenant ? _c('router-link', {
          attrs: {
            "to": {
              name: 'tenants.show',
              params: {
...
/* harmony default export */ const domainsvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)('operations', ['items', 'loading', 'pagination', 'appInfo', 'tenant'])), {}, {
    domainColumns: function domainColumns() {
      return [{
        key: "index",
        label: this.$t("#"),
        sortable: false
    ...
    domainsWithIndex: function domainsWithIndex() {
      var _this = this;
          ...
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              Swal.fire({
                ...
                text: _this7.$t('Are you sure you want to delete this domain?'),
                type: 'warning',
                ...
                if (result.value) {
                  _this7.$store.dispatch('operations/deleteData', {
                    ...
                    if (response === true) {
                      ...
                      _this7.$toast.warning(_this7.$t('Failed!'), _this7.$t('Delete failed'));
                    }
                  });
                }
              });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return _this8.$axios.post('/api/domains/' + id).then(function () {
                toast.fire({
                  type: 'success',
                  title: _this8.$t('Successfully made primary')
                });
                _this8.getData();
              })["catch"](function () {
                toast.fire({
...
var update = injectStylesIntoStyleTag_default()(domainsvue_type_style_index_0_id_4f4bb5ac_prod_lang_css/* default */.A, options);



/* harmony default export */ const central_domainsvue_type_style_index_0_id_4f4bb5ac_prod_lang_css = (domainsvue_type_style_index_0_id_4f4bb5ac_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/domains/index.vue?vue&type=style&index=0&id=4f4bb5ac&prod&lang=css
