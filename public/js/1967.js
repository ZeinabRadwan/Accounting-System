"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1967],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-683802b6]{margin-bottom:15px}.footer-buttons[data-v-683802b6]{display:flex;gap:10px}.footer-buttons .btn[data-v-683802b6]{margin-right:10px}.footer-buttons .btn[data-v-683802b6]:last-child{margin-right:0}.btn-group.c-w-100[data-v-683802b6]{gap:10px}.card[data-v-683802b6]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-683802b6]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-683802b6]{background:#fff!important}.btn-primary[data-v-683802b6]{background:#2ab930!important}.btn-secondary[data-v-683802b6]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/edit.vue?vue&type=template&id=683802b6&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    })])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.sellingPrice) + " "), _c('span', {
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t('Subtotal')))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.form.returnSubtotal)))])]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm.form.totalReturn) + " "), _c('span', {
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])])])]) : _vm._e()], 2)])])]) : _vm._e(), _vm._v(" "), _vm.form.invoice ? _c('div', {
    staticClass: "row"
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_683802b6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_editvue_type_style_index_0_id_683802b6_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_683802b6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/edit.vue?vue&type=style&index=0&id=683802b6&prod&scoped=true&lang=css
