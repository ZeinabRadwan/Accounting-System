"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3441],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".account-status[data-v-4459a188],.client-status[data-v-4459a188],.product-status[data-v-4459a188]{font-size:.875rem}.account-status .account-warning[data-v-4459a188],.account-status .client-warning[data-v-4459a188],.account-status .product-warning[data-v-4459a188],.client-status .account-warning[data-v-4459a188],.client-status .client-warning[data-v-4459a188],.client-status .product-warning[data-v-4459a188],.product-status .account-warning[data-v-4459a188],.product-status .client-warning[data-v-4459a188],.product-status .product-warning[data-v-4459a188]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-4459a188],.account-status .client-success[data-v-4459a188],.account-status .product-success[data-v-4459a188],.client-status .account-success[data-v-4459a188],.client-status .client-success[data-v-4459a188],.client-status .product-success[data-v-4459a188],.product-status .account-success[data-v-4459a188],.product-status .client-success[data-v-4459a188],.product-status .product-success[data-v-4459a188]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.btn-warning[data-v-4459a188]{background-color:#ffc107!important;border-color:#ffc107!important;color:#212529!important}.btn-warning[data-v-4459a188]:hover{background-color:#e0a800!important;border-color:#d39e00!important}.btn-primary[data-v-4459a188]{background:#2ab930!important}.btn-primary[data-v-4459a188]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.clickable-badge[data-v-4459a188]{cursor:pointer;transition:all .2s ease}.clickable-badge[data-v-4459a188]:hover{box-shadow:0 2px 4px rgba(0,0,0,.2);transform:scale(1.1)}.quotations-create-table[data-v-4459a188]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-4459a188]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-4459a188]{border:none!important}.quotations-create-table thead th[data-v-4459a188]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-4459a188]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-4459a188]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-4459a188]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.insufficient-stock-input[data-v-4459a188]{background-color:#fff5f5!important;border-color:#dc3545!important}.custom-qty-input[data-v-4459a188]{display:flex;flex-wrap:nowrap;width:100%}.custom-qty-input .button-minus[data-v-4459a188],.custom-qty-input .button-plus[data-v-4459a188]{align-items:center;background:#fff;border:1px solid #ced4da;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;width:30px}.custom-qty-input .button-minus[data-v-4459a188]{border-radius:.25rem 0 0 .25rem;border-right:none}.custom-qty-input .button-plus[data-v-4459a188]{border-left:none;border-radius:0 .25rem .25rem 0}.custom-qty-input .quantity-field[data-v-4459a188]{border-left:none;border-radius:0;border-right:none;flex:1;text-align:center}.custom-qty-input .quantity-field[data-v-4459a188]:focus{border-color:#80bdff;box-shadow:none}.saudi-riyal[data-v-4459a188]{color:#28a745;font-weight:700}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=4459a188&scoped=true
...
;// ./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=4459a188&scoped=true
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=4459a188&prod&lang=scss&scoped=true
var invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true = __webpack_require__(33602);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=4459a188&prod&lang=scss&scoped=true

            

var invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true_options = {};

invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true_options.insert = "head";
invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true_options.singleton = false;

var invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true_update = injectStylesIntoStyleTag_default()(invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true/* default */.A, invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true_options);



/* harmony default export */ const quotations_invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true = (invoicevue_type_style_index_0_id_4459a188_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=4459a188&prod&lang=scss&scoped=true
