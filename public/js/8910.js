...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/auth/find-domain.vue?vue&type=template&id=519926b7
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _context.p = 0;
              _context.n = 1;
              return _this.form.post('/api/find-domain');
            case 1:
              data = _context.v;
              if (data && data.data.success) {
                // Show success message
                _this.$toast.success('Login successful! Redirecting...');
            ...
            case 3:
              ...
              if (_t.response && _t.response.data && _t.response.data.message) {
                ...
                _this.$toast.error('Login failed. Please check your credentials.');
              }
            case 4:
              return _context.a(2);
          }
