"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3758],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductEditModal.vue?vue&type=template&id=3a8f9510&scoped=true
...
var update = injectStylesIntoStyleTag_default()(ProductEditModalvue_type_style_index_0_id_3a8f9510_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_ProductEditModalvue_type_style_index_0_id_3a8f9510_prod_scoped_true_lang_css = (ProductEditModalvue_type_style_index_0_id_3a8f9510_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/ProductEditModal.vue?vue&type=style&index=0&id=3a8f9510&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductCreateModal.vue?vue&type=template&id=1415a512&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/components/ProductCreateModal.vue?vue&type=style&index=0&id=1415a512&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=a659399a&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
    ...
    return _c('tr', {
      ...
      staticClass: "invalid-feedback d-block"
    }, [_vm._v("\n                          " + _vm._s(_vm.form.errors.get("selectedProducts.".concat(index, ".unitPrice"))) + "\n                        ")]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(item.totalBeforeDiscount)))]), _vm._v(" "), _c('td', [_c('div', {
      staticClass: "input-group"
    }, [_c('select', {
      directives: [{
        name: "model",
      ...
      staticClass: "d-block"
    }, [_vm._v(_vm._s(_vm.form.errors.get("selectedProducts.".concat(index, ".discountType"))))]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(item.totalAfterDiscount)))]), _vm._v(" "), _c('td', [_c('select', {
      directives: [{
        name: "model",
        rawName: "v-model",
    ...
    }, [_vm._v("\n                          " + _vm._s(_vm._f("withCurrency")(item.productTax)) + "\n                        ")])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(item.totalPrice)))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_c('button', {
  ...
  }, [_c('strong', [_vm._v(" " + _vm._s(_vm.$t("Total")) + " : " + _vm._s(_vm.toWord()) + " ")])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalUnitPrice())))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalDiscount())))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalAfterDiscount())))])]), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getProductTotalTax())))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getSubTotal())))])]), _vm._v(" "), _c('td')])], 2)])])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "row"
    ...
    staticClass: "text-muted"
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("Due Amount")) + ": "), _c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.dueAmount)))])])]) : _vm._e()], 1), _vm._v(" "), _c('div', {
    staticClass: "form-group col-md-3"
  }, [_c('label', {
    attrs: {
      "for": "chequeNo"
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=a659399a&scoped=true
...
var ProductEditModal = __webpack_require__(10882);
  ...
  methods: {
    ...
    getClients: function getClients() {
      var _arguments = arguments,
        _this3 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var selectedClient, defaultClientSlug, _error$response, _error$response2, _error$response3, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
            ...
            case 2:
              ...
              if (_this3.items && _this3.items.length > 0) {
                defaultClientSlug = _this3.appInfo.defaultClientSlug;
                _this3.form.client = _this3.items.find(function (item) {
                  return item.slug === defaultClientSlug;
                });
              }
              if (selectedClient == 'latest') {
                _this3.form.client = _this3.items[0];
              }
              _context.n = 4;
              break;
            case 3:
              _context.p = 3;
              _t = _context.v;
              console.error('Error getting clients:', _t);
              ...
              if (((_error$response = _t.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 401) {
                toast.fire({
                  type: "error",
                  title: _this3.$t("Authentication Error"),
                  text: _this3.$t("You are not authorized to view clients. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response2 = _t.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this3.$t("Permission Error"),
                  text: _this3.$t("You don't have permission to view clients."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response3 = _t.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) >= 500) {
                toast.fire({
                  type: "error",
                  title: _this3.$t("Server Error"),
                  text: _this3.$t("Unable to load clients. Please try again later."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (_t.message) {
                toast.fire({
                  type: "error",
                  title: _this3.$t("Client Loading Error"),
                  text: _t.message,
                  timer: 5000,
                  timerProgressBar: true
                });
    ...
    getProducts: function getProducts() {
      var _this4 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var _yield$axios$get, data, _error$response4, _error$response5, _error$response6, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              _context2.p = 0;
            ...
            case 2:
              _context2.p = 2;
              _t2 = _context2.v;
              console.error('Error getting products:', _t2);
              ...
              if (((_error$response4 = _t2.response) === null || _error$response4 === void 0 ? void 0 : _error$response4.status) === 401) {
                toast.fire({
                  ...
                  text: _this4.$t("You are not authorized to view products. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response5 = _t2.response) === null || _error$response5 === void 0 ? void 0 : _error$response5.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this4.$t("Permission Error"),
                  text: _this4.$t("You don't have permission to view products."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response6 = _t2.response) === null || _error$response6 === void 0 ? void 0 : _error$response6.status) >= 500) {
                toast.fire({
                  type: "error",
                  title: _this4.$t("Server Error"),
                  text: _this4.$t("Unable to load products. Please try again later."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (_t2.message) {
                toast.fire({
                  type: "error",
                  title: _this4.$t("Product Loading Error"),
                  text: _t2.message,
                  timer: 5000,
                  timerProgressBar: true
                });
    ...
    getAccounts: function getAccounts() {
      var _this5 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _yield$axios$get2, data, defaultAccountSlug, _error$response7, _error$response8, _error$response9, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              _context3.p = 0;
            ...
            case 1:
              ...
              if (_this5.accounts && _this5.accounts.length > 0) {
                ...
                _this5.form.account = _this5.accounts.find(function (item) {
            ...
            case 2:
              _context3.p = 2;
              _t3 = _context3.v;
              console.error('Error getting accounts:', _t3);
              ...
              if (((_error$response7 = _t3.response) === null || _error$response7 === void 0 ? void 0 : _error$response7.status) === 401) {
                toast.fire({
                  ...
                  text: _this5.$t("You are not authorized to view accounts. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response8 = _t3.response) === null || _error$response8 === void 0 ? void 0 : _error$response8.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this5.$t("Permission Error"),
                  text: _this5.$t("You don't have permission to view accounts."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response9 = _t3.response) === null || _error$response9 === void 0 ? void 0 : _error$response9.status) >= 500) {
                toast.fire({
                  type: "error",
                  title: _this5.$t("Server Error"),
                  text: _this5.$t("Unable to load accounts. Please try again later."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (_t3.message) {
                toast.fire({
                  type: "error",
                  title: _this5.$t("Account Loading Error"),
                  text: _t3.message,
                  timer: 5000,
                  timerProgressBar: true
                });
    ...
    getTaxes: function getTaxes() {
      var _this6 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var _yield$axios$get3, data, defaultVatRateSlug, _error$response0, _error$response1, _error$response10, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              _context4.p = 0;
            ...
            case 1:
              ...
              if (_this6.taxes && _this6.taxes.length > 0) {
                ...
                _this6.form.orderTax = _this6.taxes.find(function (tax) {
                  return tax.slug === defaultVatRateSlug;
                }) || _this6.taxes[0]; // Fallback to first available tax if default not found
                ...
                if (_this6.form.selectedProducts && _this6.form.selectedProducts.length > 0) {
                  _this6.form.selectedProducts.forEach(function (item, index) {
                    if (!item.selectedVatRate) {
                      // First try to use the product's default VAT rate, then fall back to invoice default
                      if (item.productTax) {
                        item.selectedVatRate = _this6.findMatchingVatRate(item.productTax);
                      }

                      // If no match found or no productTax, fall back to invoice default
                      if (!item.selectedVatRate) {
                        item.selectedVatRate = _this6.form.orderTax;
                      }
                      _this6.generateItemTotalPrice(index);
                    }
                  });
                }
              }
            ...
            case 2:
              _context4.p = 2;
              _t4 = _context4.v;
              console.error('Error getting taxes:', _t4);
              ...
              if (((_error$response0 = _t4.response) === null || _error$response0 === void 0 ? void 0 : _error$response0.status) === 401) {
                toast.fire({
                  ...
                  text: _this6.$t("You are not authorized to view tax rates. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response1 = _t4.response) === null || _error$response1 === void 0 ? void 0 : _error$response1.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this6.$t("Permission Error"),
                  text: _this6.$t("You don't have permission to view tax rates."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response10 = _t4.response) === null || _error$response10 === void 0 ? void 0 : _error$response10.status) >= 500) {
                toast.fire({
                  type: "error",
                  title: _this6.$t("Server Error"),
                  text: _this6.$t("Unable to load tax rates. Please try again later."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (_t4.message) {
                toast.fire({
                  type: "error",
                  title: _this6.$t("Tax Loading Error"),
                  text: _t4.message,
                  timer: 5000,
                  timerProgressBar: true
                });
    ...
    ensureDiscountProperties: function ensureDiscountProperties() {
      ...
      this.form.selectedProducts.forEach(function (item) {
        ...
        if (typeof item.selectedVatRate === 'undefined') {
          ...
          // If no match found or no productTax, fall back to invoice default
          if (!item.selectedVatRate) {
            if (_this7.form.orderTax) {
              item.selectedVatRate = _this7.form.orderTax;
            } else if (_this7.taxes && _this7.taxes.length > 0) {
              item.selectedVatRate = _this7.taxes[0];
            }
          }
        }
      });
    ...
    onFileChange: function onFileChange(e) {
      ...
      if (file.size < 2111775 && (file.type === "image/jpeg" || file.type === "image/png" || file.type === "image/gif")) {
        reader.onloadend = function () {
          _this8.formClient.image = reader.result;
        };
        reader.readAsDataURL(file);
        this.url = URL.createObjectURL(file);
      } else {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              ...
              validationErrors = [];
              if (!_this9.form.client || !_this9.form.client.chart_of_account_id) {
                validationErrors.push({
                  type: "warning",
                  title: _this9.$t("Chart of Account Required"),
                  message: _this9.$t("Client must have a Chart of Account assigned before creating an invoice."),
                  field: "client"
                });
              }
              if (!_this9.form.selectedProducts || _this9.form.selectedProducts.length === 0) {
                validationErrors.push({
                  type: "warning",
                  title: _this9.$t("No Products Selected"),
                  message: _this9.$t("Please select at least one product to create an invoice."),
                  field: "selectedProducts"
                });
              }
              ...
              if (productsWithoutSalesAccount.length > 0) {
                ...
                validationErrors.push({
                  type: "warning",
                  title: _this9.$t("Product Chart of Account Required"),
                  message: _this9.$t("The following products must have Sales Accounts assigned: ") + productNames,
                  field: "products",
                  timer: 8000,
                  timerProgressBar: true
                });
              ...
              paymentValidation = _this9.validatePaymentFields();
              ...
              if (!_this9.validateCalculations()) {
                validationErrors.push({
                  type: "error",
                  title: _this9.$t("Calculation Error"),
                  message: _this9.$t("There was an error in the calculations. Please refresh the page and try again."),
                  field: "calculations"
                });
              }
              ...
              _this9.showMultipleValidationErrors(validationErrors);
              return _context5.a(2);
            case 1:
              _this9.loading = true;
              _context5.n = 2;
              return _this9.form.post(window.location.origin + "/api/invoices");
            case 2:
              _yield$_this9$form$po = _context5.v;
              data = _yield$_this9$form$po.data;
              _this9.loading = false;
              if (data.success) {
                toast.fire({
                  type: "success",
                  title: _this9.$t("Success"),
                  text: _this9.$t("Invoice created successfully")
                });
            ...
            case 3:
              ...
              _t5 = _context5.v;
              _this9.loading = false;
              console.error('Invoice creation error:', _t5);

              // Handle validation errors specifically
              if (!(((_error$response11 = _t5.response) === null || _error$response11 === void 0 ? void 0 : _error$response11.status) === 422 && (_error$response12 = _t5.response) !== null && _error$response12 !== void 0 && (_error$response12 = _error$response12.data) !== null && _error$response12 !== void 0 && _error$response12.errors)) {
                _context5.n = 4;
                break;
              }
              _validationErrors = _t5.response.data.errors; // Show validation errors in toast
              Object.keys(_validationErrors).forEach(function (field) {
                ...
                if (Array.isArray(fieldErrors) && fieldErrors.length > 0) {
                  ...
                  toast.fire({
                    type: "error",
                    title: _this9.$t("Validation Error"),
                    text: "".concat(_this9.getFieldLabel(field), ": ").concat(fieldErrors[0]),
                    timer: 5000,
                    timerProgressBar: true
                  });
                }
              ...
              _this9.form.errors.set(_validationErrors);
              _context5.n = 7;
              break;
            case 4:
              if (!(((_error$response13 = _t5.response) === null || _error$response13 === void 0 ? void 0 : _error$response13.status) === 400)) {
                _context5.n = 6;
                break;
              }
              // Handle bad request errors (business logic errors)
              errorMessage = _t5.response.data.message || _t5.response.data.error || _this9.$t("Bad Request Error");
              _validationErrors2 = _t5.response.data.validation_errors;
              errorCount = _t5.response.data.error_count; // If we have multiple validation errors from the backend, show them all
              if (!(_validationErrors2 && Array.isArray(_validationErrors2) && _validationErrors2.length > 0)) {
                _context5.n = 5;
                break;
              }
              _this9.showBackendValidationErrors(_validationErrors2, errorMessage);
              return _context5.a(2);
            case 5:
              // Try to handle as business logic error first
              if (!_this9.handleBusinessLogicError(_t5.response.data)) {
                // If not handled by business logic handler, show generic bad request error
                toast.fire({
                  type: "error",
                  title: _this9.$t("Business Logic Error"),
                  text: errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              ...
              break;
            case 6:
              if (((_error$response14 = _t5.response) === null || _error$response14 === void 0 ? void 0 : _error$response14.status) === 401) {
                // Handle unauthorized errors
                toast.fire({
                  type: "error",
                  title: _this9.$t("Authentication Error"),
                  text: _this9.$t("You are not authorized to perform this action. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response15 = _t5.response) === null || _error$response15 === void 0 ? void 0 : _error$response15.status) === 403) {
                // Handle forbidden errors
                toast.fire({
                  type: "error",
                  title: _this9.$t("Permission Error"),
                  text: _this9.$t("You don't have permission to perform this action."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response16 = _t5.response) === null || _error$response16 === void 0 ? void 0 : _error$response16.status) === 404) {
                // Handle not found errors
                toast.fire({
                  type: "error",
                  title: _this9.$t("Resource Not Found"),
                  text: _this9.$t("The requested resource was not found. Please check your data and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response17 = _t5.response) === null || _error$response17 === void 0 ? void 0 : _error$response17.status) === 409) {
                // Handle conflict errors
                _errorMessage = _t5.response.data.message || _this9.$t("Data Conflict Error");
                toast.fire({
                  type: "error",
                  title: _this9.$t("Data Conflict"),
                  text: _errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (((_error$response18 = _t5.response) === null || _error$response18 === void 0 ? void 0 : _error$response18.status) === 422) {
                // Handle other unprocessable entity errors
                _errorMessage2 = _t5.response.data.message || _this9.$t("Data Processing Error");
                toast.fire({
                  type: "error",
                  title: _this9.$t("Data Error"),
                  text: _errorMessage2,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (((_error$response19 = _t5.response) === null || _error$response19 === void 0 ? void 0 : _error$response19.status) >= 500) {
                // Handle server errors
                _errorMessage3 = _t5.response.data.message || _this9.$t("Server Error");
                toast.fire({
                  type: "error",
                  title: _this9.$t("Server Error"),
                  text: "".concat(_errorMessage3, " (").concat(_this9.$t("Please try again later or contact support"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else if ((_error$response20 = _t5.response) !== null && _error$response20 !== void 0 && (_error$response20 = _error$response20.data) !== null && _error$response20 !== void 0 && _error$response20.message) {
                // Handle other API error messages
                toast.fire({
                  type: "error",
                  title: _this9.$t("API Error"),
                ...
                toast.fire({
                  type: "error",
                  title: _this9.$t("JavaScript Error"),
                  text: _t5.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_t5.code === 'NETWORK_ERROR' || _t5.code === 'ECONNABORTED') {
                // Handle network errors
                toast.fire({
                  type: "error",
                  title: _this9.$t("Network Error"),
                  text: _this9.$t("Unable to connect to the server. Please check your internet connection and try again."),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else {
                ...
                ErrorHandler.handleApiError(_t5, {
    ...
    formatFormValues: function formatFormValues() {
      ...
      this.form.selectedProducts.forEach(function (item) {
        item.unitPrice = _this0.roundToTwoDecimals(Number(item.unitPrice));
        item.qty = Number(item.qty);
        item.productTax = _this0.roundToTwoDecimals(Number(item.productTax));
        item.totalTax = _this0.roundToTwoDecimals(Number(item.totalTax));
        item.totalPrice = _this0.roundToTwoDecimals(Number(item.totalPrice));
        item.unitCost = _this0.roundToTwoDecimals(Number(item.unitCost));
        item.discount = _this0.roundToTwoDecimals(Number(item.discount || 0));
        item.discountAmount = _this0.roundToTwoDecimals(Number(item.discountAmount || 0));
      });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              _context6.n = 1;
              return _this1.formClient.post(window.location.origin + "/api/clients").then(function () {
                toast.fire({
                  type: "success",
                  title: _this1.$t("Client added successfully")
                });
                _this1.showClientCreateModal = false;
                _this1.getClients();
                _this1.formClient.reset();
                _this1.url = null;
              })["catch"](function (error) {
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      var _this10 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var currentClientSlug, response, newAccountId, idx, _error$response21, _error$response22, _error$response23, _error$response24, _error$response25, _error$response26, errorMessage, _errorMessage4, _t6;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              if (!(!_this10.form.client || _this10.isAutoAssigningClient)) {
                _context7.n = 1;
                break;
              }
              return _context7.a(2);
            case 1:
              ...
              currentClientSlug = _this10.form.client.slug;
              _context7.n = 3;
              return _this10.$http.post("/api/clients/".concat(_this10.form.client.slug, "/auto-assign-chart-of-account"));
            case 3:
              ...
              if (response.data.success) {
                ...
                if (newAccountId) {
                  ...
                  idx = _this10.items.findIndex(function (i) {
                    return i.slug === currentClientSlug;
                  });
                  if (idx !== -1) {
                    _this10.$set(_this10.items[idx], 'chart_of_account_id', newAccountId);
                  }
                }
            ...
            case 4:
              ...
              if (((_error$response21 = _t6.response) === null || _error$response21 === void 0 ? void 0 : _error$response21.status) === 400) {
                errorMessage = _t6.response.data.message || _this10.$t("Bad request error");
                toast.fire({
                  type: "error",
                  title: _this10.$t("Assignment Failed"),
                  text: errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (((_error$response22 = _t6.response) === null || _error$response22 === void 0 ? void 0 : _error$response22.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response23 = _t6.response) === null || _error$response23 === void 0 ? void 0 : _error$response23.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this10.$t("Permission Error"),
                  text: _this10.$t("You don't have permission to assign Chart of Accounts."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response24 = _t6.response) === null || _error$response24 === void 0 ? void 0 : _error$response24.status) === 404) {
                toast.fire({
                  type: "error",
                  title: _this10.$t("Client Not Found"),
                  text: _this10.$t("The client was not found. Please refresh the page and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response25 = _t6.response) === null || _error$response25 === void 0 ? void 0 : _error$response25.status) >= 500) {
                _errorMessage4 = _t6.response.data.message || _this10.$t("Server error");
                toast.fire({
                  type: "error",
                  title: _this10.$t("Server Error"),
                  text: "".concat(_errorMessage4, " (").concat(_this10.$t("Please try again later"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else if ((_error$response26 = _t6.response) !== null && _error$response26 !== void 0 && (_error$response26 = _error$response26.data) !== null && _error$response26 !== void 0 && _error$response26.message) {
                toast.fire({
                  type: "error",
                  title: _this10.$t("Assignment Failed"),
                ...
                toast.fire({
                  type: "error",
                  title: _this10.$t("Failed to assign Chart of Account"),
                  text: _this10.$t("Please try again or assign manually"),
                  timer: 5000,
                  timerProgressBar: true
                });
              }
    ...
    clearProductErrors: function clearProductErrors(index) {
      ...
      fields.forEach(function (field) {
        ...
        if (_this12.form.errors.has(errorKey)) {
          _this12.form.errors.clear(errorKey);
        }
      });
    },
    ...
    setupGlobalErrorHandling: function setupGlobalErrorHandling() {
      ...
      this.unhandledRejectionHandler = function (event) {
        ...
        _this13.handleGlobalError(event.reason, 'Promise rejection');
      };

      // Handle unhandled errors
      this.unhandledErrorHandler = function (event) {
        console.error('Unhandled error:', event.error);
        _this13.handleGlobalError(event.error, 'JavaScript error');
      };
    ...
    autoAssignProductChartOfAccount: function autoAssignProductChartOfAccount(product) {
      var _arguments2 = arguments,
        _this14 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var type, response, exists, _error$response27, _error$response28, _error$response29, _error$response30, _error$response31, _error$response32, errorMessage, _errorMessage5, _t7;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              type = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : 'sales';
              if (!(!product || _this14.isAutoAssigningProduct === product.id)) {
                _context8.n = 1;
                break;
              }
              return _context8.a(2);
            case 1:
              _this14.isAutoAssigningProduct = product.id;
              _context8.p = 2;
              _context8.n = 3;
              return _this14.$http.post("/api/products/".concat(product.slug, "/").concat(type, "/auto-assign-chart-of-account"));
            case 3:
              response = _context8.v;
              if (response.data.success) {
                ...
                exists = _this14.form.selectedProducts && _this14.form.selectedProducts.some(function (p) {
                  return p.id === product.id;
                });
                if (!exists) {
                  _this14.storeProduct(product);
                }
            ...
            case 4:
              _context8.p = 4;
              _t7 = _context8.v;
              console.error('Error auto-assigning chart of account for product:', _t7);

              // Handle different types of errors
              if (((_error$response27 = _t7.response) === null || _error$response27 === void 0 ? void 0 : _error$response27.status) === 400) {
                errorMessage = _t7.response.data.message || _this14.$t("Bad request error");
                toast.fire({
                  type: "error",
                  title: _this14.$t("Assignment Failed"),
                  text: errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (((_error$response28 = _t7.response) === null || _error$response28 === void 0 ? void 0 : _error$response28.status) === 401) {
                toast.fire({
                  type: "error",
                  title: _this14.$t("Authentication Error"),
                  text: _this14.$t("You are not authorized to perform this action. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response29 = _t7.response) === null || _error$response29 === void 0 ? void 0 : _error$response29.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this14.$t("Permission Error"),
                  text: _this14.$t("You don't have permission to assign Chart of Accounts."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response30 = _t7.response) === null || _error$response30 === void 0 ? void 0 : _error$response30.status) === 404) {
                toast.fire({
                  type: "error",
                  title: _this14.$t("Product Not Found"),
                  text: _this14.$t("The product was not found. Please refresh the page and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response31 = _t7.response) === null || _error$response31 === void 0 ? void 0 : _error$response31.status) >= 500) {
                _errorMessage5 = _t7.response.data.message || _this14.$t("Server error");
                toast.fire({
                  type: "error",
                  title: _this14.$t("Server Error"),
                  text: "".concat(_errorMessage5, " (").concat(_this14.$t("Please try again later"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else if ((_error$response32 = _t7.response) !== null && _error$response32 !== void 0 && (_error$response32 = _error$response32.data) !== null && _error$response32 !== void 0 && _error$response32.message) {
                toast.fire({
                  type: "error",
                  title: _this14.$t("Please try again or assign manually"),
                ...
                toast.fire({
                  type: "error",
                  title: _this14.$t("Failed to assign Chart of Account"),
                  text: _this14.$t("Please try again or assign manually"),
                  timer: 5000,
                  timerProgressBar: true
                });
              }
            case 5:
              _context8.p = 5;
              _this14.isAutoAssigningProduct = null;
      ...
      if (this.form.selectedProducts && this.form.selectedProducts.length > 0) {
        this.form.selectedProducts.forEach(function (item, index) {
          if (!item.selectedVatRate) {
            ...
            } else if (_this15.form.orderTax) {
              item.selectedVatRate = _this15.form.orderTax;
            } else if (_this15.taxes && _this15.taxes.length > 0) {
              item.selectedVatRate = _this15.taxes[0];
            }
            _this15.generateItemTotalPrice(index);
          }
        });
      }
    },
    ...
    recalculateAllVatAmounts: function recalculateAllVatAmounts() {
      ...
      if (this.form.selectedProducts && this.form.selectedProducts.length > 0) {
        this.form.selectedProducts.forEach(function (item, index) {
          _this16.generateItemTotalPrice(index);
        });
        this.calculateSum();
      }
    },
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              ...
              _context9.p = 1;
              if (!(_this17.form.addPayment == 1)) {
                _context9.n = 2;
                break;
              }
              paymentValidation = _this17.validatePaymentFields();
              if (paymentValidation.isValid) {
                _context9.n = 2;
                break;
              }
              event.preventDefault();
              _this17.showPaymentValidationErrors();
              return _context9.a(2);
            case 2:
              _context9.n = 3;
              return _this17.saveInvoice();
            case 3:
              _context9.p = 3;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_a659399a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_a659399a_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_a659399a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=a659399a&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-card[data-v-3a8f9510]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-bottom:1.25rem;margin-top:20px;transition:all .2s ease}.form-card[data-v-3a8f9510]:hover{box-shadow:0 .1rem .5rem 0 rgba(58,59,69,.15)}.form-card .card-header[data-v-3a8f9510]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:12px 16px}.form-card .card-header .section-title[data-v-3a8f9510]{border:none;color:#fff;font-size:14px;font-weight:600;margin:0;padding:0}.form-card .card-header .section-title[data-v-3a8f9510]:after{display:none}.form-card .card-header .section-title i[data-v-3a8f9510]{color:hsla(0,0%,100%,.8)}.form-card .card-body[data-v-3a8f9510]{padding:16px}.section-title[data-v-3a8f9510]{border-bottom:1px solid #e9ecef;color:#495057;font-weight:600;margin-bottom:15px;padding-bottom:8px}.form-group[data-v-3a8f9510]{margin-bottom:1rem}.form-group label[data-v-3a8f9510]{color:#495057;font-size:.95rem;font-weight:500;margin-bottom:.5rem}.required[data-v-3a8f9510]{color:#dc3545;font-weight:700}.row[data-v-3a8f9510]{margin-bottom:1rem}.row[data-v-3a8f9510]:last-child{margin-bottom:0}.form-text[data-v-3a8f9510]{color:#6c757d;font-size:.8rem;margin-top:3px}.image-preview[data-v-3a8f9510]{text-align:center}.image-preview img[data-v-3a8f9510]{border:1px solid #dee2e6;border-radius:4px;box-shadow:0 1px 3px rgba(0,0,0,.1)}.custom-file-label[data-v-3a8f9510]{background-color:#f8f9fa;border:1px dashed #dee2e6;cursor:pointer;font-size:.85rem;transition:all .2s ease}.custom-file-label[data-v-3a8f9510]:hover{background-color:#e3f2fd;border-color:#007bff}.custom-file-label i[data-v-3a8f9510]{color:#6c757d}@media (max-width:768px){.section-title[data-v-3a8f9510]{font-size:.95rem;margin-bottom:12px}.form-card .card-body[data-v-3a8f9510]{padding:.75rem}}.input-group-prepend .input-group-text[data-v-3a8f9510]{background-color:#f8f9fa;border-color:#ced4da;color:#495057;font-size:.85rem}.v-select[data-v-3a8f9510]{margin-bottom:0}.is-invalid[data-v-3a8f9510]{border-color:#dc3545!important}.invalid-feedback[data-v-3a8f9510]{color:#dc3545;display:block;font-size:75%;margin-top:.2rem;width:100%}.item-type-selector[data-v-3a8f9510]{display:flex;gap:.75rem;margin-top:.5rem}.item-type-option[data-v-3a8f9510]{cursor:pointer;flex:1;position:relative;transition:all .2s ease}.item-type-option input[type=radio][data-v-3a8f9510]{opacity:0;pointer-events:none;position:absolute}.option-content[data-v-3a8f9510]{align-items:center;background:#fff;border:2px solid #e3e6f0;border-radius:8px;display:flex;flex-direction:column;justify-content:center;min-height:70px;padding:1rem .75rem;text-align:center;transition:all .2s ease}.item-type-option:hover .option-content[data-v-3a8f9510]{border-color:#33a0d9;box-shadow:0 2px 6px rgba(51,160,217,.15);transform:translateY(-1px)}.item-type-option.active .option-content[data-v-3a8f9510]{background:#33a0d9;border-color:#33a0d9;box-shadow:0 3px 10px rgba(51,160,217,.25);color:#fff;transform:translateY(-1px)}.option-content i[data-v-3a8f9510]{color:#6c757d;font-size:1.4rem;margin-bottom:.5rem;transition:all .2s ease}.item-type-option.active .option-content i[data-v-3a8f9510]{color:hsla(0,0%,100%,.9)}.option-content span[data-v-3a8f9510]{color:#495057;font-size:.9rem;font-weight:600;transition:all .2s ease}.item-type-option.active .option-content span[data-v-3a8f9510]{color:#fff}@media (max-width:768px){.item-type-selector[data-v-3a8f9510]{flex-direction:column;gap:.5rem}.option-content[data-v-3a8f9510]{min-height:60px;padding:.75rem .5rem}.option-content i[data-v-3a8f9510]{font-size:1.25rem;margin-bottom:.4rem}.option-content span[data-v-3a8f9510]{font-size:.85rem}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-a659399a]{margin-bottom:15px}.footer-buttons[data-v-a659399a]{display:flex;gap:10px}.footer-buttons .btn[data-v-a659399a]{margin-right:10px}.footer-buttons .btn[data-v-a659399a]:last-child{margin-right:0}.create-btn[data-v-a659399a]{padding:11px}.chart-account-success[data-v-a659399a],.chart-account-warning[data-v-a659399a]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-a659399a]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-a659399a]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-a659399a],.warning-content[data-v-a659399a]{align-items:center;display:flex;gap:16px}.success-icon[data-v-a659399a],.warning-icon[data-v-a659399a]{flex-shrink:0;font-size:24px}.warning-icon[data-v-a659399a]{color:#856404}.success-icon[data-v-a659399a]{color:#155724}.success-text[data-v-a659399a],.warning-text[data-v-a659399a]{flex-grow:1}.success-title[data-v-a659399a],.warning-title[data-v-a659399a]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-a659399a]{color:#856404}.success-title[data-v-a659399a]{color:#155724}.success-description[data-v-a659399a],.warning-description[data-v-a659399a]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-a659399a]{color:#856404}.success-description[data-v-a659399a]{color:#155724}.warning-action[data-v-a659399a]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-a659399a]{padding:0}.btn-primary[data-v-a659399a]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-a659399a]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-a659399a],.warning-content[data-v-a659399a]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-a659399a],.warning-action[data-v-a659399a]{width:100%}}.client-status[data-v-a659399a]{font-size:13px}.client-success[data-v-a659399a],.client-warning[data-v-a659399a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-a659399a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-a659399a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-a659399a]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-a659399a]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-a659399a]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-a659399a]{font-size:13px}.product-success[data-v-a659399a],.product-warning[data-v-a659399a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-a659399a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-a659399a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-a659399a]{font-size:13px}.account-success[data-v-a659399a],.account-warning[data-v-a659399a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-a659399a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-a659399a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-a659399a]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-a659399a]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-a659399a]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-a659399a]{cursor:pointer;margin-bottom:0}.text-warning[data-v-a659399a]{color:#856404!important}.text-warning small[data-v-a659399a]{font-size:12px;font-weight:500}.text-warning i[data-v-a659399a]{margin-right:4px}.table-custom[data-v-a659399a]{border:none!important}.invoices-create-table[data-v-a659399a]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-a659399a]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-a659399a]{border:none!important}.invoices-create-table thead th[data-v-a659399a]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-a659399a]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-a659399a]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-a659399a]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-a659399a]{gap:10px}.card[data-v-a659399a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-a659399a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-a659399a]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-a659399a]{background:#fff!important}.btn-primary[data-v-a659399a]{background:#2ab930!important}.btn-secondary[data-v-a659399a]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ClientCreateModal.vue?vue&type=template&id=529b18f8&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('VModal', {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 5:
              ...
              errorMessage = ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this.$t("Opps...something went wrong");
              toast.fire({
                type: "error",
                title: errorMessage
              });
...
;// ./resources/js/components/ClientCreateModal.vue?vue&type=style&index=0&id=529b18f8&prod&scoped=true&lang=css
