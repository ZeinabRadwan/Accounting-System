...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/edit.vue?vue&type=template&id=e68f171c&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
  ...
  })], 1) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.form.selectedProducts && _vm.form.selectedProducts.length > 0 ? _c('ItemsTable', {
    attrs: {
      ...
      "show-current-qty-column": !!_vm.form.purchaseReturnData,
      "show-return-price-column": !!_vm.form.purchaseReturnData,
      "totals-colspan": 5,
      "custom-total-value": _vm.form.purchaseReturnData ? _vm.form.purchaseReturn : null,
    ...
    staticClass: "d-block"
  }, [_vm._v(_vm._s(_vm.form.errors.get('discount_value')))]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _vm.isSupplierTaxable ? _c('div', {
    staticClass: "form-group col-md-6",
    "class": _vm.form.purchaseReturnData ? 'col-lg-3' : 'col-lg-4'
  }, [_c('label', {
    attrs: {
  ...
  methods: {
    ...
    getPurchase: function getPurchase() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var _yield$axios$get, data, totalDiscount;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              ...
              _this2.form.transportTaxableCost = data.data.transport_taxable || '';
              ...
              if (data.data.transport_taxable && data.data.transport && data.data.transport > data.data.transport_taxable) {
                _this2.form.transportVatAmount = Number((data.data.transport - data.data.transport_taxable).toFixed(2));
              } else {
                _this2.form.transportVatAmount = 0;
              }
              ...
              if (data.data.discount_type && data.data.discount_value !== undefined) {
                _this2.form.discount_type = data.data.discount_type || 'percentage';
                _this2.form.discount_value = Number(data.data.discount_value) || 0;
                ...
                totalDiscount = Number(data.data.totalDiscount) || 0;
                _this2.form.discount = totalDiscount;
                if (totalDiscount > 0) {
                  // Default to fixed amount if we can't determine
                  _this2.form.discount_type = 'fixed';
                  _this2.form.discount_value = totalDiscount;
                } else {
                  _this2.form.discount_type = 'percentage';
                  _this2.form.discount_value = 0;
                }
              }
              // Initialize transport taxability - handle both new and old format
              _this2.form.transportIsTaxable = data.data.transportIsTaxable !== undefined ? Boolean(data.data.transportIsTaxable) : data.data.transport_taxable !== undefined ? Boolean(data.data.transport_taxable) : true; // Default to true for backward compatibility
              ...
              if (data.data.payment_method_id) {
                _this2.form.payment_method_id = data.data.payment_method_id;
              } else if (data.data.paymentMethod && data.data.paymentMethod.id) {
                _this2.form.payment_method_id = data.data.paymentMethod.id;
              }
                ...
                _this2.$nextTick(function () {
                  ...
                  if (_this2.form.selectedProducts && _this2.form.selectedProducts.length > 0) {
                    _this2.form.selectedProducts.forEach(function (item, index) {
                      _this2.generateItemTotalPrice(index, true);
                    });
                  }
                  // Then trigger full calculation cycle
                  _this2.calculateSum();
                  _this2.updateTax();
                  _this2.updateNetTotal();
                });
              });
            case 2:
              return _context.a(2);
    ...
    getProducts: function getProducts() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var currentProductIds, _yield$axios$get3, data;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              _this6.loadingPaymentMethods = true;
              _context5.p = 1;
              _context5.n = 2;
            ...
            case 2:
              ...
              if (response.data) {
                if (Array.isArray(response.data)) {
                  _this6.paymentMethods = response.data;
                } else if (response.data.data && Array.isArray(response.data.data)) {
                  _this6.paymentMethods = response.data.data;
                } else {
                  _this6.paymentMethods = [];
                }
              } else {
                _this6.paymentMethods = [];
              }
            ...
            case 3:
              _context5.p = 3;
              _t = _context5.v;
              console.error('Error loading payment methods:', _t);
              _this6.paymentMethods = [];
              toast.fire({
                type: 'error',
                title: _this6.$t('Error'),
                text: _this6.$t('Failed to load payment methods')
              });
            case 4:
              _context5.p = 4;
              _this6.loadingPaymentMethods = false;
    ...
    assignProducts: function assignProducts(purchaseProducts) {
      ...
      var _loop = function _loop() {
        ...
        var unitPrice = Number(purchaseProduct.purchasePrice) || 0;
        var qty = Number(purchaseProduct.quantity) || 0;

        // Find matching VAT rate from taxes list
        var selectedVatRate = null;
        if (_this1.taxes && _this1.taxes.length > 0) {
          if (purchaseProduct.taxRate) {
            selectedVatRate = _this1.taxes.find(function (tax) {
              return tax.rate === purchaseProduct.taxRate;
            }) || null;
          }
          if (!selectedVatRate) {
            selectedVatRate = _this1.taxes[0]; // Default to first tax rate
          }
        }
        var productItem = {
        ...
        _this1.form.selectedProducts.unshift(productItem);
      };
      ...
      this.$nextTick(function () {
        _this1.$nextTick(function () {
          ...
          _this1.form.selectedProducts.forEach(function (item, index) {
            _this1.generateItemTotalPrice(index, true);
          });
          // Trigger full calculation cycle
          _this1.calculateSum();
          _this1.updateTax();
          _this1.updateNetTotal();
        });
      });
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              ...
              _context6.n = 1;
              return _this10.getSuppliers();
            case 1:
              // If we have a selected supplier, update it with the new data
              if (_this10.form.supplier && _this10.suppliers && _this10.suppliers.length > 0) {
                updatedSupplier = _this10.suppliers.find(function (s) {
                  return s.id === _this10.form.supplier.id;
                });
                if (updatedSupplier) {
                  _this10.form.supplier = updatedSupplier;
                }
              }
              _context6.n = 4;
              break;
            ...
            case 3:
              ...
              if (_this10.form.selectedProducts && _this10.form.selectedProducts.length > 0) {
                _this10.form.selectedProducts.forEach(function (selectedProduct) {
                  var updatedProduct = _this10.products.find(function (p) {
                    return p.id === selectedProduct.id;
                  });
                  if (updatedProduct) {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 1:
              ...
              _context7.p = 2;
              _context7.n = 3;
              return axios_default().post("/api/suppliers/".concat(_this11.form.supplier.slug, "/auto-assign-chart-of-account"));
            case 3:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              _context9.n = 1;
              return _this14.form.patch(window.location.origin + '/api/purchases/' + _this14.$route.params.slug).then(function (_ref2) {
                var data = _ref2.data;
                toast.fire({
                  type: 'success',
                  title: _this14.$t('Purchase updated successfully')
                });
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_e68f171c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_editvue_type_style_index_0_id_e68f171c_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_e68f171c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/edit.vue?vue&type=style&index=0&id=e68f171c&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-e68f171c]{gap:10px}.card[data-v-e68f171c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-e68f171c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-e68f171c]{background:#fff!important}.btn-primary[data-v-e68f171c]{background:#2ab930!important}.btn-secondary[data-v-e68f171c]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-e68f171c]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.create-btn[data-v-e68f171c]{padding:11px}.supplier-status[data-v-e68f171c]{font-size:13px}.supplier-success[data-v-e68f171c],.supplier-warning[data-v-e68f171c]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.supplier-warning[data-v-e68f171c]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.supplier-success[data-v-e68f171c]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.product-status[data-v-e68f171c]{font-size:13px}.product-success[data-v-e68f171c],.product-warning[data-v-e68f171c]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-e68f171c]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-e68f171c]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-e68f171c]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-e68f171c]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-e68f171c]:disabled{cursor:not-allowed;opacity:.6}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
