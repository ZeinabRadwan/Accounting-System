...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-ca7f4cc8]{margin-bottom:15px}.footer-buttons[data-v-ca7f4cc8]{display:flex;gap:10px}.footer-buttons .btn[data-v-ca7f4cc8]{margin-right:10px}.footer-buttons .btn[data-v-ca7f4cc8]:last-child{margin-right:0}.btn-group.c-w-100[data-v-ca7f4cc8]{gap:10px}.card[data-v-ca7f4cc8]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-ca7f4cc8]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-ca7f4cc8]{background:#fff!important}.btn-primary[data-v-ca7f4cc8]{background:#2ab930!important}.btn-secondary[data-v-ca7f4cc8]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-ca7f4cc8]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/edit.vue?vue&type=template&id=ca7f4cc8&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_ca7f4cc8_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_editvue_type_style_index_0_id_ca7f4cc8_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_ca7f4cc8_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/purchases/returns/edit.vue?vue&type=style&index=0&id=ca7f4cc8&prod&scoped=true&lang=css
