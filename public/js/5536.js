"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5536],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/group-account-statement.vue?vue&type=template&id=33453f86&scoped=true
...
;// ./resources/js/pages/reports/group-account-statement.vue?vue&type=template&id=33453f86&scoped=true
...
var update = injectStylesIntoStyleTag_default()(group_account_statementvue_type_style_index_0_id_33453f86_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_group_account_statementvue_type_style_index_0_id_33453f86_prod_scoped_true_lang_css = (group_account_statementvue_type_style_index_0_id_33453f86_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/group-account-statement.vue?vue&type=style&index=0&id=33453f86&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-33453f86]{border:none!important}.group-account-statement-table[data-v-33453f86]{border-collapse:separate;border-spacing:0}.group-account-statement-table thead th[data-v-33453f86]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.group-account-statement-table thead tr[data-v-33453f86]{border:none!important}.group-account-statement-table thead th[data-v-33453f86]:first-child{border-top-left-radius:10px}.group-account-statement-table thead th[data-v-33453f86]:last-child{border-top-right-radius:10px}[dir=rtl] .group-account-statement-table thead th[data-v-33453f86]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .group-account-statement-table thead th[data-v-33453f86]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-33453f86]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-33453f86],.export-pdf-btn[data-v-33453f86],.preview-btn[data-v-33453f86]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-33453f86],.export-pdf-btn[data-v-33453f86],.preview-btn[data-v-33453f86],.print-btn[data-v-33453f86]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-33453f86]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-33453f86]{gap:10px}.card[data-v-33453f86]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-33453f86]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-33453f86]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.info-box[data-v-33453f86]{background:#fff;border:1px solid #dee2e6;margin-bottom:1rem;padding:1rem}.info-box[data-v-33453f86],.info-box-icon[data-v-33453f86]{align-items:center;border-radius:.375rem;display:flex}.info-box-icon[data-v-33453f86]{height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-33453f86]{flex:1}.info-box-text[data-v-33453f86]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-33453f86]{color:#495057;display:block;font-size:1.25rem;font-weight:600}.btn-primary[data-v-33453f86]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
