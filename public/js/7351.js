"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7351],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/edit.vue?vue&type=template&id=d55cefca&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    return _c('tr', {
      ...
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]), _vm._v(" "), _vm.form.purchaseReturnData ? _c('td', [_vm._v("\n                        " + _vm._s(item.totalReturn) + " "), _c('span', {
      staticClass: "saudi-riyal"
...
;// ./resources/js/pages/purchases/edit.vue?vue&type=template&id=d55cefca&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_d55cefca_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_editvue_type_style_index_0_id_d55cefca_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_d55cefca_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/edit.vue?vue&type=style&index=0&id=d55cefca&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-d55cefca]{gap:10px}.card[data-v-d55cefca]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-d55cefca]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-d55cefca]{background:#fff!important}.btn-primary[data-v-d55cefca]{background:#2ab930!important}.btn-secondary[data-v-d55cefca]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-d55cefca]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.create-btn[data-v-d55cefca]{padding:11px}.supplier-status[data-v-d55cefca]{font-size:13px}.supplier-success[data-v-d55cefca],.supplier-warning[data-v-d55cefca]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.supplier-warning[data-v-d55cefca]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.supplier-success[data-v-d55cefca]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.product-status[data-v-d55cefca]{font-size:13px}.product-success[data-v-d55cefca],.product-warning[data-v-d55cefca]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-d55cefca]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-d55cefca]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-d55cefca]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-d55cefca]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-d55cefca]:disabled{cursor:not-allowed;opacity:.6}", ""]);
// Exports
