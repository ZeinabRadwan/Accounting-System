...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/index.vue?vue&type=template&id=48712e58&scoped=true
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/index.vue?vue&type=script&lang=js
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              _context9.n = 1;
              return _this0.form.post(window.location.origin + "/api/purchase-pay").then(function () {
                toast.fire({
                  type: "success",
                  title: _this0.$t("Supplier payment added successfully")
                });
                _this0.$router.push({
                  name: "purchases.show",
                  params: {
                    slug: _this0.form.selectedPurchase.slug
                  }
                });
              })["catch"](function () {
                toast.fire({
          ...
          while (1) switch (_context0.n) {
            case 0:
              sweetalert2_all_default().fire({
                ...
                text: _this1.$t("You will not be able to return to this! This will delete the purchase permanently."),
                type: "warning",
                ...
                if (result.value) {
                  _this1.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      _this1.$toast.warning(_this1.$t("Failed!"), _this1.$t(response.message));
                    }
                  });
                }
              });
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            case 0:
              ...
              sweetalert2_all_default().fire({
                title: _this10.$t("Send Purchase to ZATCA"),
                text: _this10.$t("Do you want to send this purchase to ZATCA?"),
                type: "question",
                showCancelButton: true,
                    ...
                    while (1) switch (_context1.p = _context1.n) {
                      case 0:
                        ...
                        sweetalert2_all_default().fire({
                          ...
                          text: _this10.$t("Please wait while we send the purchase to ZATCA"),
                          allowOutsideClick: false,
                          showConfirmButton: true,
                          confirmButtonText: _this10.$t("Please wait..."),
                          confirmButtonColor: "#28a745",
                      ...
                      case 2:
                        ...
                        if (response.data.success) {
                          _this10.$toast.success(_this10.$t("Sent Successfully!"), _this10.$t("Purchase has been sent to ZATCA and journal entries have been created."));
                          // Refresh the purchase data to update the status
                          _this10.getData();
                        } else {
                          _this10.$toast.error(_this10.$t("Failed!"), response.data.message || _this10.$t("Failed to send purchase to ZATCA"));
                        }
                        _context1.n = 4;
                        break;
                      case 3:
                        _context1.p = 3;
                        _t = _context1.v;
                        console.error('Error sending purchase to ZATCA:', _t);
                        // Close the loading dialog
                        sweetalert2_all_default().close();
                        _this10.$toast.error(_this10.$t("Error!"), ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this10.$t("An error occurred while sending the purchase to ZATCA"));
                      case 4:
...
;// ./resources/js/pages/purchases/index.vue?vue&type=script&lang=js
...
;// ./resources/js/pages/purchases/index.vue?vue&type=style&index=0&id=48712e58&prod&scoped=true&lang=css
...
;// ./resources/js/pages/purchases/index.vue?vue&type=style&index=1&id=48712e58&prod&lang=css
