...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/client-receivable-report.vue?vue&type=template&id=2e39e6c7
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._v("\n                            " + _vm._s(_vm.$t("Client Receivable Report")) + "\n                        ")])]), _vm._v(" "), _c('div', {
    ...
    }, [_vm._v("\n                                            " + _vm._s(data.name) + "\n                                        ")]) : _c('span', [_vm._v(_vm._s(data.name))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.phoneNumber))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.email))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.companyName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.clientDue)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.nonInvoiceCurrentDue)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(data.clientDue + data.nonInvoiceCurrentDue)))]), _vm._v(" "), _c('td', [data.status === 1 ? _c('span', {
