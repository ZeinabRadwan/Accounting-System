...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-2c6e8014]{margin-bottom:15px}.btn-group.c-w-100[data-v-2c6e8014]{gap:10px}.card[data-v-2c6e8014]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-2c6e8014]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-2c6e8014]{padding:1.25rem}.card-footer[data-v-2c6e8014]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-2c6e8014]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-2c6e8014]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-2c6e8014]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-2c6e8014]{color:#dc3545;font-weight:700}.btn-primary[data-v-2c6e8014]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-2c6e8014]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-2c6e8014]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-2c6e8014]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.footer-buttons[data-v-2c6e8014]{display:flex;gap:10px}.footer-buttons .btn[data-v-2c6e8014]{margin-right:10px}.footer-buttons .btn[data-v-2c6e8014]:last-child{margin-right:0}.is-invalid[data-v-2c6e8014]{border-color:#dc3545!important}textarea.form-control[data-v-2c6e8014]{min-height:100px;resize:vertical}.v-select[data-v-2c6e8014]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-2c6e8014]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-2c6e8014]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-2c6e8014]{border-color:#dc3545!important}.row[data-v-2c6e8014]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-2c6e8014]{flex-direction:column;gap:10px}.card-footer .btn[data-v-2c6e8014]{margin-right:0!important;width:100%}.card-footer div[data-v-2c6e8014]{display:flex;flex-direction:column;gap:10px;width:100%}}.client-status[data-v-2c6e8014]{font-size:13px}.client-success[data-v-2c6e8014],.client-warning[data-v-2c6e8014]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-2c6e8014]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-2c6e8014]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/clients/non-invoice/create.vue?vue&type=template&id=2c6e8014&scoped=true
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!(!_this2.form.client || !_this2.form.client.slug || _this2.isAutoAssigningClient)) {
                _context.next = 2;
                break;
              }
            ...
            case 2:
              ...
              currentClientSlug = _this2.form.client.slug;
              _context.next = 7;
            ...
            case 7:
              ...
              if (response.data.success) {
                ...
                if (newAccountId) {
                  _this2.form.client.chart_of_account_id = newAccountId;
            ...
            case 11:
              ...
              if (((_error$response = _context.t0.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 400) {
                toast.fire({
                  ...
                  text: ((_error$response2 = _context.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this2.$t('Please check the client data and try again')
                });
                ...
                toast.fire({
                  type: 'error',
                  title: _this2.$t('Failed to assign Chart of Account'),
                  text: ((_error$response5 = _context.t0.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || _context.t0.message || _this2.$t('An error occurred. Please try again.')
                });
              }
            case 15:
              _context.prev = 15;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 8:
              ...
              console.error('Error loading payment methods:', _context4.t0);
              _this5.paymentMethods = [];
              toast.fire({
                type: 'error',
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return _this6.form.post(window.location.origin + '/api/payments/non-invoice').then(function () {
                toast.fire({
                  type: 'success',
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_2c6e8014_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const non_invoice_createvue_type_style_index_0_id_2c6e8014_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_2c6e8014_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payments/clients/non-invoice/create.vue?vue&type=style&index=0&id=2c6e8014&prod&scoped=true&lang=css
