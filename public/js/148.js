"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[148],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-05affb7c]{border:none!important;overflow:visible!important}.accounting-periods-table[data-v-05affb7c]{border-collapse:separate;border-spacing:0}.accounting-periods-table thead th[data-v-05affb7c]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.accounting-periods-table thead tr[data-v-05affb7c]{border:none!important}.accounting-periods-table thead th[data-v-05affb7c]:first-child{border-top-left-radius:10px}.accounting-periods-table thead th[data-v-05affb7c]:last-child{border-top-right-radius:10px}[dir=rtl] .accounting-periods-table thead th[data-v-05affb7c]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .accounting-periods-table thead th[data-v-05affb7c]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.action-dropdown[data-v-05affb7c]{display:inline-block;position:relative}.action-icon-btn[data-v-05affb7c]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-05affb7c]{animation:slideInDown-05affb7c .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-05affb7c]{left:45px!important;right:auto!important}@keyframes slideInDown-05affb7c{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-05affb7c]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-05affb7c]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-05affb7c]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-05affb7c]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-05affb7c]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-05affb7c]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-05affb7c]:last-child{border-bottom:none}.action-menu li a[data-v-05affb7c]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-05affb7c]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-05affb7c]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-05affb7c]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-05affb7c]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-05affb7c]{gap:10px}.card[data-v-05affb7c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.accounting-periods-table .badge.bg-success[data-v-05affb7c]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.accounting-periods-table .badge.bg-danger[data-v-05affb7c]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.accounting-periods-table .badge.bg-secondary[data-v-05affb7c]{background:#f8f9fa!important;color:#6c757d!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.btn-primary[data-v-05affb7c]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/accounting-periods.vue?vue&type=template&id=05affb7c&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/setup/accounting-periods.vue?vue&type=template&id=05affb7c&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/accounting-periods.vue?vue&type=script&lang=js
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              if (!confirm(_this10.$t('Are you sure you want to close this accounting period?'))) {
                _context8.next = 14;
                break;
              }
              _context8.prev = 1;
            ...
            case 4:
              ...
              toast.fire({
                type: 'success',
                title: response.data.message || _this10.$t('Accounting period closed successfully')
              });

              // Refresh the accounting periods list to get updated is_closed flags
              _context8.next = 8;
              return _this10.getAccountingPeriods();
            case 8:
              _context8.next = 14;
              break;
            case 10:
              ...
              if (_context8.t0.response && _context8.t0.response.data && _context8.t0.response.data.message) {
                ...
                toast.fire({
                  type: 'error',
                  title: _this10.$t('Error closing accounting period')
                });
              }
            case 14:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              if (!confirm(_this11.$t('Are you sure you want to reopen this accounting period?'))) {
                _context9.next = 14;
                break;
              }
              _context9.prev = 1;
            ...
            case 4:
              ...
              toast.fire({
                type: 'success',
                title: response.data.message || _this11.$t('Accounting period reopened successfully')
              });

              // Refresh the accounting periods list to get updated is_closed flags
              _context9.next = 8;
              return _this11.getAccountingPeriods();
            case 8:
              _context9.next = 14;
              break;
            case 10:
              ...
              if (_context9.t0.response && _context9.t0.response.data && _context9.t0.response.data.message) {
                ...
                toast.fire({
                  type: 'error',
                  title: _this11.$t('Error reopening accounting period')
                });
              }
            case 14:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              if (!confirm(_this12.$t('Are you sure you want to delete this accounting period?'))) {
                _context10.next = 12;
                break;
              }
              _context10.prev = 1;
            ...
            case 4:
              toast.fire({
                type: 'success',
                title: _this12.$t('Accounting period deleted successfully')
              });
              _this12.getAccountingPeriods();
              _context10.next = 12;
              break;
            case 8:
              _context10.prev = 8;
              _context10.t0 = _context10["catch"](1);
              console.error('Error deleting period:', _context10.t0);
              if (_context10.t0.response && _context10.t0.response.data && _context10.t0.response.data.message) {
                toast.fire({
                  type: 'error',
                  title: _context10.t0.response.data.message
                });
              } else {
                toast.fire({
                  type: 'error',
                  title: _this12.$t('Cannot delete closed accounting period')
                });
              }
            case 12:
            case "end":
...
;// CONCATENATED MODULE: ./resources/js/pages/setup/accounting-periods.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(accounting_periodsvue_type_style_index_0_id_05affb7c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const setup_accounting_periodsvue_type_style_index_0_id_05affb7c_prod_scoped_true_lang_css = (accounting_periodsvue_type_style_index_0_id_05affb7c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/setup/accounting-periods.vue?vue&type=style&index=0&id=05affb7c&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/setup/accounting-periods.vue
