"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4365],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".forgot-password-link[data-v-0609a6b1]{color:#0775af!important;text-decoration:none;transition:color .2s ease}.forgot-password-link[data-v-0609a6b1]:hover{color:#06608a!important;text-decoration:underline}@media (max-width:768px){.forgot-password-link[data-v-0609a6b1]{display:inline-block;font-size:14px;padding:4px 0}}@media (max-width:480px){.forgot-password-link[data-v-0609a6b1]{font-size:13px}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/auth/login.vue?vue&type=template&id=0609a6b1&scoped=true
...
var update = injectStylesIntoStyleTag_default()(loginvue_type_style_index_0_id_0609a6b1_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const auth_loginvue_type_style_index_0_id_0609a6b1_prod_scoped_true_lang_css = (loginvue_type_style_index_0_id_0609a6b1_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/auth/login.vue?vue&type=style&index=0&id=0609a6b1&prod&scoped=true&lang=css
