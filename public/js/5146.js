(self["webpackChunk"] = self["webpackChunk"] || []).push([[5146],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=template&id=59ccf09a&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    return _c('tr', {
    ...
    }, [_vm.activeTab === 'active' ? [data.email_verified_at ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('View'),
      ...
      on: {
        "click": function click($event) {
          return _vm.archiveData(data.id);
        }
      }
    }, [_c('i', {
      staticClass: "fas fa-archive"
    })])] : _vm._e(), _vm._v(" "), _vm.activeTab === 'archived' ? [data.email_verified_at ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('View'),
      ...
      on: {
        "click": function click($event) {
          return _vm.restoreData(data.id);
        }
      }
    }, [_c('i', {
      ...
      on: {
        "click": function click($event) {
          return _vm.permanentDeleteData(data.id);
        }
      }
    }, [_c('i', {
...
/* harmony default export */ const tenantsvue_type_script_lang_js = ({
  ...
  methods: {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              ...
              endpoint = _this6.activeTab === 'archived' ? '/api/tenants/search?archived=1' : '/api/tenants/search';
              _context6.n = 1;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            case 0:
              _this0.activeTab = tab;
              _this0.query = "";
              _this0.dateRange.startDate = "";
              _this0.dateRange.endDate = "";
              _this0.pagination.current_page = 1;
              _context0.n = 1;
              return _this0.getData();
            case 1:
    ...
    archiveData: function archiveData(id) {
      var _this1 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.n) {
            case 0:
              sweetalert2_all_default().fire({
                title: _this1.$t("Archive Tenant"),
                text: _this1.$t("Are you sure you want to archive this tenant? The tenant will be moved to archived section and can be restored later."),
                type: "warning",
                showCancelButton: true,
                confirmButtonText: _this1.$t("Yes, archive it!"),
                ...
                if (result.value) {
                  _this1.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      _this1.$toast.success(_this1.$t("Archived"), _this1.$t("Tenant archived successfully"));
                      _this1.getData();
                    } else {
                      _this1.$toast.warning(_this1.$t("Failed"), _this1.$t("Archive failed"));
                    }
                  })["catch"](function (error) {
                    _this1.$toast.warning(_this1.$t("Failed"), _this1.$t("Archive failed"));
                  });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            case 0:
              sweetalert2_all_default().fire({
                title: _this10.$t("Restore Tenant"),
                text: _this10.$t("Are you sure you want to restore this tenant? The tenant will be moved back to active tenants."),
                type: "question",
                showCancelButton: true,
                confirmButtonText: _this10.$t("Yes, restore it!"),
                cancelButtonText: _this10.$t("Cancel")
              }).then(function (result) {
                if (result.value) {
                  axios_default().post("/api/tenants/".concat(id, "/restore")).then(function (response) {
                    if (response.data.success === true) {
                      _this10.$toast.success(_this10.$t("Restored"), _this10.$t("Tenant restored successfully"));
                      _this10.getData();
                    } else {
                      _this10.$toast.warning(_this10.$t("Failed"), _this10.$t("Restore failed"));
                    }
                  })["catch"](function (error) {
                    _this10.$toast.warning(_this10.$t("Failed"), _this10.$t("Restore failed"));
                  });
    ...
    permanentDeleteData: function permanentDeleteData(id) {
      var _this11 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            case 0:
              sweetalert2_all_default().fire({
                title: _this11.$t("Permanent Delete"),
                text: _this11.$t("WARNING: This action will permanently delete the tenant and all its data including the database. This action cannot be undone!"),
                type: "error",
                showCancelButton: true,
                confirmButtonText: _this11.$t("Yes, delete permanently!"),
                cancelButtonText: _this11.$t("Cancel"),
                confirmButtonColor: "#d33",
                input: "text",
                inputPlaceholder: _this11.$t("Type 'DELETE' to confirm"),
                inputValidator: function inputValidator(value) {
                  if (value !== "DELETE") {
                    return _this11.$t("You must type 'DELETE' to confirm");
                  }
                }
              }).then(function (result) {
                if (result.value) {
                  axios_default()["delete"]("/api/tenants/".concat(id, "/permanent")).then(function (response) {
                    if (response.data.success === true) {
                      _this11.$toast.success(_this11.$t("Permanently Deleted"), _this11.$t("Tenant and all data permanently deleted"));
                      _this11.getData();
                    } else {
                      _this11.$toast.warning(_this11.$t("Failed"), _this11.$t("Permanent delete failed"));
                    }
                  })["catch"](function (error) {
                    _this11.$toast.warning(_this11.$t("Failed"), _this11.$t("Permanent delete failed"));
                  });
          ...
          while (1) switch (_context12.n) {
            case 0:
              axios_default().post(window.location.origin + "/api/tenants/" + id + "/ban").then(function (response) {
                if (response.data.success === true) {
                  _this12.$toast.success(_this12.$t(response.data.message), _this12.$t(response.data.message + "_success"));
                  _this12.getData();
                } else {
                  _this12.$toast.warning(_this12.$t("Failed"), _this12.$t("Ban failed"));
                }
              });
            case 1:
...
var update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_0_id_59ccf09a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const central_tenantsvue_type_style_index_0_id_59ccf09a_prod_scoped_true_lang_css = (tenantsvue_type_style_index_0_id_59ccf09a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=59ccf09a&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=59ccf09a&prod&lang=css
var tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css = __webpack_require__(6120);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=59ccf09a&prod&lang=css

            

var tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css_options = {};

tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css_options.insert = "head";
tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css_options.singleton = false;

var tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css_update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css/* default */.A, tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css_options);



/* harmony default export */ const central_tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css = (tenantsvue_type_style_index_1_id_59ccf09a_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=59ccf09a&prod&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom .table td[data-v-59ccf09a]{vertical-align:middle}.profile-area[data-v-59ccf09a]{align-items:center;display:flex}.profile-area img[data-v-59ccf09a]{border-radius:100%;height:50px;width:50px}.profile-area a[data-v-59ccf09a]{display:block}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
