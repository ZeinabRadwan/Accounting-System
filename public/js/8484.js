          ...
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 4:
              ...
              if (_t5.response && _t5.response.data && _t5.response.data.errors) {
                _this8.form.errors.set(_t5.response.data.errors);
              }

              // Show error message
              toast.fire({
                icon: 'error',
                title: ((_error$response = _t5.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this8.$t('Please check your input and try again.'),
                showConfirmButton: false,
                timer: 3000
              });
            case 5:
