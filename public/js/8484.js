...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/chart-of-accounts/edit.vue?vue&type=template&id=0b127498&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    attrs: {
      ...
      "type": "text",
      "name": "code",
      "placeholder": _vm.$t('Enter account code'),
  ...
  })]), _vm._v(" "), _vm.form.code_generation === 'automatic' && _vm.originalCode && _vm.form.code !== _vm.originalCode ? _c('div', {
    ...
    attrs: {
      ...
      "label": "name",
      "name": "parent_id",
      "placeholder": _vm.parentAccounts.length === 0 ? _vm.$t('No compatible parent accounts available') : _vm.$t('Select parent account (optional)')
    },
    model: {
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 12:
              ...
              console.error('Error generating code:', _context2.t0);
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 7:
              ...
              console.error('Error loading account types:', _context3.t0);
            case 10:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              console.log('Parent Accounts loaded:', _this5.parentAccounts);
              _context4.next = 12;
              break;
            case 9:
              _context4.prev = 9;
              _context4.t0 = _context4["catch"](0);
              console.error('Error loading parent accounts:', _context4.t0);
            case 12:
            case "end":
    ...
    getAccount: function getAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var response, account, type, parent;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return _this7.$axios.get("/api/chart-of-accounts/".concat(_this7.$route.params.slug));
            case 3:
              ...
              // Set form data
              _this7.form.name = account.name || '';
              _this7.form.code = account.code || '';
              _this7.originalCode = account.code || ''; // Store original code
              _this7.form.order = account.order || '';

              // Handle is_active status - ensure it's a boolean/number
              if (account.is_active !== null && account.is_active !== undefined) {
                _this7.form.is_active = account.is_active ? 1 : 0;
              } else {
                _this7.form.is_active = 1; // Default to active if null/undefined
              }
              console.log('Form is_active set to:', _this7.form.is_active); // Debug log

              // Set type_id (find the type object from accountTypes array)
              if (account.type_id) {
                type = _this7.accountTypes.find(function (t) {
                  return t.id === account.type_id;
                });
                _this7.form.type_id = type || null;
              }

              // Set parent_id (find the parent object from parentAccounts array)
              if (account.parent_id) {
                parent = _this7.parentAccounts.find(function (p) {
                  return p.id === account.parent_id;
                });
                _this7.form.parent_id = parent || null;
              }
              console.log('Form data after population:', _this7.form.data()); // Debug log
              _context5.next = 20;
              break;
            case 17:
              _context5.prev = 17;
              _context5.t0 = _context5["catch"](0);
              console.error('Error loading account:', _context5.t0);
            case 20:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              formData = _objectSpread(_objectSpread({}, _this8.form.data()), {}, {
                type_id: _this8.form.type_id ? _this8.form.type_id.id : null,
                parent_id: _this8.form.parent_id ? _this8.form.parent_id.id : null
              });
              console.log('Sending update data:', formData);
              _context6.next = 5;
              return _this8.$axios.put("/api/chart-of-accounts/".concat(_this8.$route.params.slug), formData);
            case 5:
              ...
              toast.fire({
                icon: 'success',
                title: _this8.$t('Chart of account updated successfully'),
            ...
            case 15:
              ...
              console.error('Error updating:', _context6.t0);
              ...
              if (_context6.t0.response && _context6.t0.response.data && _context6.t0.response.data.errors) {
                _this8.form.errors.set(_context6.t0.response.data.errors);
              }

              // Show error message
              toast.fire({
                icon: 'error',
                title: ((_error$response = _context6.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this8.$t('Please check your input and try again.'),
                showConfirmButton: false,
                timer: 3000
              });
            case 20:
    ...
    loadTemporaryData: function loadTemporaryData() {
      var tempData = localStorage.getItem('chartOfAccountEditTempData');
      if (tempData) {
        try {
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/chart-of-accounts/edit.vue?vue&type=style&index=0&id=0b127498&prod&scoped=true&lang=css
var editvue_type_style_index_0_id_0b127498_prod_scoped_true_lang_css = __webpack_require__(55400);
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_0b127498_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const chart_of_accounts_editvue_type_style_index_0_id_0b127498_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_0b127498_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/chart-of-accounts/edit.vue?vue&type=style&index=0&id=0b127498&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-0b127498]{margin-bottom:15px}.footer-buttons[data-v-0b127498]{display:flex;gap:10px}.footer-buttons .btn[data-v-0b127498]{margin-right:10px}.footer-buttons .btn[data-v-0b127498]:last-child{margin-right:0}.code-generation-toggle[data-v-0b127498]{margin-bottom:.5rem!important}.code-generation-toggle .btn-group[data-v-0b127498]{background:#f1f5f9;border:none;border-radius:8px;box-shadow:inset 0 1px 3px rgba(0,0,0,.1);display:inline-flex;padding:3px;width:125%}.code-generation-toggle .btn[data-v-0b127498]{background:transparent!important;border-radius:5px;box-shadow:none!important;flex:1;font-size:12px;font-weight:500;line-height:1.3;padding:6px 12px;transition:all .2s ease}.code-generation-toggle .btn[data-v-0b127498],.code-generation-toggle .btn-outline-primary[data-v-0b127498]{border:none!important;color:#64748b}.code-generation-toggle .btn-outline-primary[data-v-0b127498]:hover{background-color:hsla(0,0%,100%,.5)!important;box-shadow:none!important;color:#475569;transform:none}.code-generation-toggle .btn.btn-primary[data-v-0b127498]{background:#fff!important;border:none!important;box-shadow:0 1px 3px rgba(0,0,0,.12)!important;color:#2ab930!important;transform:none!important}.code-generation-toggle .btn.btn-primary[data-v-0b127498]:hover{background:#fff!important;box-shadow:0 2px 4px rgba(0,0,0,.15)!important;color:#229a26!important;transform:none!important}.code-input-container[data-v-0b127498]{position:relative}.code-generate-btn[data-v-0b127498]{position:absolute;right:.5rem;top:50%;transform:translateY(-50%);z-index:10}.code-generate-btn .btn[data-v-0b127498]{font-size:.8rem;padding:.25rem .75rem}.code-preview[data-v-0b127498]{background:#e3f2fd;border:1px solid #bbdefb;border-radius:4px;font-size:.875rem;padding:.5rem}.code-preview strong[data-v-0b127498]{color:#1976d2;font-family:Monaco,Menlo,Ubuntu Mono,monospace}.code-warning[data-v-0b127498]{background:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;font-size:.875rem;padding:.5rem}.code-warning strong[data-v-0b127498]{color:#856404;font-family:Monaco,Menlo,Ubuntu Mono,monospace}.form-control[readonly][data-v-0b127498]{background-color:#f8f9fa!important;border-color:#e9ecef;cursor:not-allowed}@media (max-width:768px){.code-generate-btn[data-v-0b127498]{margin-top:.5rem;position:static;transform:none;width:100%}.code-generate-btn .btn[data-v-0b127498]{width:100%}.code-generation-toggle .btn[data-v-0b127498]{font-size:.8rem;padding:.4rem .8rem}}.btn-outline-primary[data-v-0b127498]:hover{background-color:#007bff;border-color:#007bff;color:#fff}.btn-outline-secondary[data-v-0b127498]:hover{background-color:#6c757d;border-color:#6c757d;color:#fff}.btn[data-v-0b127498]:disabled{cursor:not-allowed;opacity:.6}.btn-group.c-w-100[data-v-0b127498]{gap:10px}.card[data-v-0b127498]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-0b127498]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-0b127498]{background:#fff!important}.btn-primary[data-v-0b127498]{background:#2ab930!important}.btn-primary[data-v-0b127498],.btn-secondary[data-v-0b127498]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-0b127498]{background:#33a0d9!important}", ""]);
// Exports
