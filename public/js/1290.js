"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1290,5448],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-3431eec2]{border:none!important}.account-statement-table[data-v-3431eec2]{border-collapse:separate;border-spacing:0}.account-statement-table thead th[data-v-3431eec2]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.account-statement-table thead tr[data-v-3431eec2]{border:none!important}.account-statement-table thead th[data-v-3431eec2]:first-child{border-top-left-radius:10px}.account-statement-table thead th[data-v-3431eec2]:last-child{border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-3431eec2]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-3431eec2]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-3431eec2]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.export-excel-btn[data-v-3431eec2],.export-pdf-btn[data-v-3431eec2],.preview-btn[data-v-3431eec2]{background:#f6fef4!important;border:none;border-radius:10px;color:#2ab930!important}.print-btn[data-v-3431eec2]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important}.btn-group.c-w-100[data-v-3431eec2]{gap:10px}.card[data-v-3431eec2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-3431eec2]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-3431eec2]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.table-responsive[data-v-3431eec2]{border:1px solid #dee2e6;border-radius:.375rem;overflow-y:auto}.table-sm td[data-v-3431eec2],.table-sm th[data-v-3431eec2]{font-size:.875rem;padding:.5rem .75rem}.table th[data-v-3431eec2]{border-bottom:2px solid #dee2e6;color:#495057;font-weight:600}.table tbody tr[data-v-3431eec2]:hover,.table th[data-v-3431eec2]{background-color:#f8f9fa}.table tbody tr.table-info[data-v-3431eec2]{background-color:#e3f2fd;font-weight:600}.table tbody tr.table-info[data-v-3431eec2]:hover{background-color:#bbdefb}.info-box[data-v-3431eec2]{background:#f8f9fa;border-radius:.375rem;margin-bottom:1rem;padding:1rem}.info-box[data-v-3431eec2],.info-box-icon[data-v-3431eec2]{align-items:center;display:flex}.info-box-icon[data-v-3431eec2]{border-radius:50%;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-3431eec2]{flex:1}.info-box-text[data-v-3431eec2]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-3431eec2]{color:#495057;display:block;font-size:1.5rem;font-weight:700}.badge[data-v-3431eec2]{font-size:.75rem;padding:.25rem .5rem}.font-weight-bold[data-v-3431eec2]{color:#212529}.text-muted[data-v-3431eec2]{color:#6c757d!important}.btn-link[data-v-3431eec2]{background:none;border:none;color:#007bff;padding:0;text-decoration:none}.btn-link[data-v-3431eec2]:hover{color:#0056b3;text-decoration:none}.btn-link[data-v-3431eec2]:focus{box-shadow:none;outline:none}.tree-toggle-icon[data-v-3431eec2]{transition:transform .2s ease}.tree-toggle-icon.expanded[data-v-3431eec2]{transform:rotate(90deg)}.tree-item-icon[data-v-3431eec2]{text-align:center;width:16px}.gap-2>*+*[data-v-3431eec2]{margin-left:.5rem}@media (max-width:768px){.gap-2[data-v-3431eec2]{align-items:stretch;flex-direction:column}.gap-2>*+*[data-v-3431eec2]{margin-left:0;margin-top:.5rem}}.trial-balance-table[data-v-3431eec2]{background:#fff;border:1px solid #dee2e6;font-size:16px}.table-header[data-v-3431eec2],.table-header th[data-v-3431eec2]{background:#f8f9fa}.table-header th[data-v-3431eec2]{border:1px solid #dee2e6;color:#495057;font-size:16px;font-weight:600;padding:12px 8px}.header-code[data-v-3431eec2]{width:10%}.header-account[data-v-3431eec2]{width:30%}.header-amount[data-v-3431eec2]{font-size:16px;width:12%}.trial-balance-table tbody tr[data-v-3431eec2]{border-bottom:1px solid #dee2e6}.trial-balance-table tbody tr[data-v-3431eec2]:hover{background:#f8f9fa}.trial-balance-table tbody tr.table-info[data-v-3431eec2]{background:#e9ecef;border-left:3px solid #6c757d;font-weight:600}.trial-balance-table tbody tr.table-info[data-v-3431eec2]:hover{background:#dee2e6}.trial-balance-table tbody tr.table-warning[data-v-3431eec2]{background:#fff3cd;border-left:3px solid #ffc107;font-weight:600}.trial-balance-table tbody tr.table-warning[data-v-3431eec2]:hover{background:#ffeaa7}.cell-code[data-v-3431eec2]{background:#f8f9fa}.cell-account[data-v-3431eec2],.cell-amount[data-v-3431eec2]{background:#fff}.cell-amount[data-v-3431eec2]{font-weight:600}.account-code-badge[data-v-3431eec2]{background:#6c757d;border-radius:4px;color:#fff;display:inline-block;font-size:16px;font-weight:600;padding:4px 8px}.account-name-container[data-v-3431eec2]{align-items:center;display:flex;padding:8px 0}.expand-btn[data-v-3431eec2]{align-items:center;background:none;border:none;border-radius:2px;color:#6c757d;display:flex;font-size:16px;height:20px;justify-content:center;margin-right:8px;min-width:20px;padding:2px;transition:color .2s ease}.expand-btn[data-v-3431eec2]:hover{background:#f8f9fa;color:#495057}.expand-spacer[data-v-3431eec2]{margin-right:8px;width:24px}.account-icon[data-v-3431eec2]{font-size:16px;margin-right:8px;text-align:center;width:16px}.account-icon.fa-folder[data-v-3431eec2]{color:#6c757d}.account-icon.fa-folder-open[data-v-3431eec2]{color:#495057}.account-icon.fa-file[data-v-3431eec2]{color:#adb5bd}.account-name[data-v-3431eec2]{color:#2c3e50;font-size:16px;font-weight:600}.total-row-name[data-v-3431eec2]{color:#d63384;font-style:italic;font-weight:700}.amount-value[data-v-3431eec2]{background:none;color:#495057;display:inline-block;font-size:16px;font-weight:600;min-width:80px;padding:0;text-align:right}.credit-amount[data-v-3431eec2],.debit-amount[data-v-3431eec2]{background:none;border:none;color:#495057}.closing-amount[data-v-3431eec2]{background:none;font-size:16px;font-weight:800}.amount-empty[data-v-3431eec2]{color:#adb5bd;font-size:16px;font-style:italic}.table-footer[data-v-3431eec2]{background:#f8f9fa;color:#495057}.grand-total-row[data-v-3431eec2]{background:#e9ecef;border-top:2px solid #6c757d}.grand-total-label[data-v-3431eec2]{font-weight:700;padding:12px 8px}.grand-total-amount[data-v-3431eec2],.grand-total-label[data-v-3431eec2]{background:none;color:#495057;font-size:16px}.grand-total-amount[data-v-3431eec2]{border:none;font-weight:600;margin:0;padding:0}.grand-total-amount.credit-amount[data-v-3431eec2],.grand-total-amount.debit-amount[data-v-3431eec2]{background:none;border:none}@media print{.no-print[data-v-3431eec2]{display:none!important}.card[data-v-3431eec2]{border:none!important;box-shadow:none!important}.table[data-v-3431eec2]{font-size:16px}.table-responsive[data-v-3431eec2]{overflow:visible}}@media (max-width:1300px){.info-box[data-v-3431eec2]{padding:0}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=3431eec2&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=template&id=3431eec2&scoped=true
  ...
  methods: {
    ...
    loadCostCenters: function loadCostCenters() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var _yield$axios$get3, data, centers, _error$response3, _t3;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              ...
              _context4.p = 1;
              _context4.n = 2;
              return axios_default().get("/api/cost-centers/get-all", {
                params: {
                  limit: 100
                }
              });
            case 2:
              ...
              _this4.costCenters = centers.map(function (center) {
                return _objectSpread(_objectSpread({}, center), {}, {
                  display_name: center.code ? "[".concat(center.code, "] ").concat(center.name) : center.name
                });
              });
              _context4.n = 4;
              break;
    ...
    searchCostCenters: function searchCostCenters(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var _yield$axios$get6, data, centers, _error$response6, _t6;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 2:
              ...
              centers = data.data || data;
              _this7.costCenters = centers.map(function (center) {
                return _objectSpread(_objectSpread({}, center), {}, {
                  display_name: center.code ? "[".concat(center.code, "] ").concat(center.name) : center.name
                });
              });
          ...
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 3:
              ...
              if (response.data && response.data.success === true) {
                ...
                console.log('✅ All accounts loaded:', _this8.allAccounts.length);
    ...
    addAllAccountIds: function addAllAccountIds(accounts) {
      ...
      accounts.forEach(function (account) {
        if (account.children && account.children.length > 0) {
          if (!_this11.expandedNodes.includes(account.id)) {
            _this11.expandedNodes.push(account.id);
          }
          _this11.addAllAccountIds(account.children);
        }
      });
    },
...
var update = injectStylesIntoStyleTag_default()(trial_balancevue_type_style_index_0_id_3431eec2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_trial_balancevue_type_style_index_0_id_3431eec2_prod_scoped_true_lang_css = (trial_balancevue_type_style_index_0_id_3431eec2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/trial-balance.vue?vue&type=style&index=0&id=3431eec2&prod&scoped=true&lang=css
