...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/advanced.vue?vue&type=template&id=9d1a0db6&scoped=true
...
var update = injectStylesIntoStyleTag_default()(advancedvue_type_style_index_0_id_9d1a0db6_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const setup_advancedvue_type_style_index_0_id_9d1a0db6_prod_lang_scss_scoped_true = (advancedvue_type_style_index_0_id_9d1a0db6_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/central/setup/advanced.vue?vue&type=style&index=0&id=9d1a0db6&prod&lang=scss&scoped=true
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".inner-card[data-v-9d1a0db6]{box-shadow:0 0 1px rgba(0,0,0,.125),0 1px 3px rgba(0,0,0,.2)}.inner-card .card-header[data-v-9d1a0db6]{background-color:rgba(0,0,0,.03)}", ""]);
// Exports
