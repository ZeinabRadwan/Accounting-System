"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8154],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/pages/index.vue?vue&type=template&id=6517e9ea
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    attrs: {
      "columns": _vm.pageColumns,
      "rows": _vm.pagesWithIndex,
      "loading": _vm.loading,
      "table-id": "printMe",
      "wrapper-class": "mt-3",
      "show-actions": true
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var row = _ref.row;
        return [row.type === 0 ? _c('span', [_vm._v("\n                " + _vm._s(_vm.$t('Information')) + "\n              ")]) : _vm._e(), _vm._v(" "), row.type === 1 ? _c('span', [_vm._v("\n                " + _vm._s(_vm.$t('Need Help')) + "\n              ")]) : _vm._e()];
      }
    }, {
      key: "cell-status",
...
/* harmony default export */ const pagesvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)('operations', ['items', 'loading', 'pagination'])), {}, {
    pageColumns: function pageColumns() {
      return [{
        key: "index",
        label: this.$t("#"),
        sortable: false
    ...
    pagesWithIndex: function pagesWithIndex() {
      var _this = this;
...
var update = injectStylesIntoStyleTag_default()(pagesvue_type_style_index_0_id_6517e9ea_prod_lang_css/* default */.A, options);



/* harmony default export */ const central_pagesvue_type_style_index_0_id_6517e9ea_prod_lang_css = (pagesvue_type_style_index_0_id_6517e9ea_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/pages/index.vue?vue&type=style&index=0&id=6517e9ea&prod&lang=css
