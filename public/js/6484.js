...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-a872b372]{border:none!important;overflow:visible!important}.invoice-returns-table[data-v-a872b372]{border-collapse:separate;border-spacing:0}.invoice-returns-table thead th[data-v-a872b372]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoice-returns-table thead tr[data-v-a872b372]{border:none!important}.invoice-returns-table thead th[data-v-a872b372]:first-child{border-top-left-radius:10px}.invoice-returns-table thead th[data-v-a872b372]:last-child{border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-a872b372]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-a872b372]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-a872b372]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-a872b372],.export-pdf-btn[data-v-a872b372]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-a872b372],.export-pdf-btn[data-v-a872b372],.print-btn[data-v-a872b372]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-a872b372]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-a872b372]{display:inline-block;position:relative}.action-icon-btn[data-v-a872b372]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-a872b372]{animation:slideInDown-a872b372 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-a872b372]{left:45px!important;right:auto!important}@keyframes slideInDown-a872b372{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-a872b372]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-a872b372]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-a872b372]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-a872b372]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-a872b372]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-a872b372]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-a872b372]:last-child{border-bottom:none}.action-menu li a[data-v-a872b372]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-a872b372]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-a872b372]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-a872b372]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-a872b372]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-a872b372]{gap:10px}.btn-group.c-w-100>.btn[data-v-a872b372]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-a872b372]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-a872b372]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-a872b372]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-a872b372]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoice-returns-table .badge.bg-success[data-v-a872b372]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.invoice-returns-table .badge.bg-danger[data-v-a872b372]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-a872b372]{background:#f1f5fb!important}.btn-primary[data-v-a872b372]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/index.vue?vue&type=template&id=a872b372&scoped=true
                    ...
                    while (1) switch (_context8.prev = _context8.next) {
                      ...
                      case 5:
                        ...
                        if (response.data.success) {
                          sweetalert2_all_default().fire(_this9.$t("Sent Successfully!"), _this9.$t("Credit note has been sent to ZATCA and journal entries have been created."), "success");
                          // Refresh the table to update the status
                          _this9.getData();
                        } else {
                          sweetalert2_all_default().fire(_this9.$t("Failed!"), response.data.message || _this9.$t("Failed to send credit note to ZATCA"), "error");
                        }
                        _context8.next = 13;
                        break;
                      case 9:
                        ...
                        sweetalert2_all_default().fire(_this9.$t("Error!"), ((_error$response = _context8.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this9.$t("An error occurred while sending the credit note"), "error");
                      case 13:
                      case "end":
                ...
                if (result.value) {
                  _this10.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      sweetalert2_all_default().fire(_this10.$t("Failed!"), _this10.$t("There was something wrong."), "warning");
                    }
                  });
                }
              });
...
var update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_0_id_a872b372_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const sales_returnsvue_type_style_index_0_id_a872b372_prod_scoped_true_lang_css = (returnsvue_type_style_index_0_id_a872b372_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/index.vue?vue&type=style&index=0&id=a872b372&prod&scoped=true&lang=css
