"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1951],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/domain-requests/index.vue?vue&type=template&id=41cff7aa
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var row = _ref.row;
        return [_vm._v("\n              " + _vm._s(row.tenant && row.tenant.name) + "\n            ")];
      }
    }, {
      key: "cell-tenantEmail",
      fn: function fn(_ref2) {
        var row = _ref2.row;
        return [_vm._v("\n              " + _vm._s(row.tenant && row.tenant.email) + "\n            ")];
      }
    }, {
      key: "cell-status",
          ...
          while (1) switch (_context6.n) {
            case 0:
              Swal.fire({
                ...
                if (result.value) {
                  _this7.$axios.patch("/api/domain-requests/" + slug, {
                    status: status
                  }).then(function () {
                    Swal.fire(_this7.$t("Updated successfully!"), _this7.$t("Updated successfully."), "success");
                    _this7.getData();
                  })["catch"](function () {
          ...
          while (1) switch (_context7.n) {
            case 0:
              Swal.fire({
                ...
                text: _this8.$t("Do you really want to delete this Domain Request?"),
                type: "warning",
                showCancelButton: true,
                ...
                if (result.value) {
                  _this8.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      Swal.fire(_this8.$t("Failed!"), _this8.$t("Delete failed"), "warning");
                    }
                  });
                }
              });
...
var update = injectStylesIntoStyleTag_default()(domain_requestsvue_type_style_index_0_id_41cff7aa_prod_lang_css/* default */.A, options);



/* harmony default export */ const central_domain_requestsvue_type_style_index_0_id_41cff7aa_prod_lang_css = (domain_requestsvue_type_style_index_0_id_41cff7aa_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/domain-requests/index.vue?vue&type=style&index=0&id=41cff7aa&prod&lang=css
