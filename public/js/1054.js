  ...
  methods: {
    ...
    determineAccountType: function determineAccountType(chartOfAccount) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this2$$store$getters, parentId, branchId, bankSettingResponse, settings, bankSetting, cashSettingResponse, _settings, cashSetting;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", 'bank');
            case 2:
              _context2.prev = 2;
            ...
            case 7:
              bankSettingResponse = _context2.sent;
            ...
            case 15:
              cashSettingResponse = _context2.sent;
              ...
              return _context2.abrupt("return", 'cash');
            case 21:
              _context2.next = 26;
              break;
            case 23:
              ...
              console.error('Error determining account type:', _context2.t0);
            case 26:
              return _context2.abrupt("return", 'bank');
            case 27:
            case "end":
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 17:
              _this3.accountType = _context3.sent;
              _context3.next = 20;
            ...
            case 28:
              ...
              console.error('Error loading account:', _context3.t0);
              toast.fire({
                type: 'error',
    ...
    createNewChartOfAccount: function createNewChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var accountType, response, newAccount, _response$data, _error$response, errorMessage;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 12:
              ...
              console.error('Error creating chart of account:', _context4.t0);
              errorMessage = ((_error$response = _context4.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this4.$t('Failed to create chart of account');
              toast.fire({
                type: 'error',
                title: errorMessage
              });
