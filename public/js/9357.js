"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[9357],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-50145247]{gap:10px}.header-buttons[data-v-50145247]{margin-bottom:15px}.footer-buttons[data-v-50145247]{display:flex;gap:10px}.footer-buttons .btn[data-v-50145247]{margin-right:10px}.footer-buttons .btn[data-v-50145247]:last-child{margin-right:0}.card[data-v-50145247]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-body[data-v-50145247]{padding:1.25rem}.card-footer[data-v-50145247]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-50145247]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-50145247]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-50145247]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-50145247]{color:#dc3545;font-weight:700}.btn-primary[data-v-50145247]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-50145247]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-50145247]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-50145247]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-50145247]{border-color:#dc3545!important}textarea.form-control[data-v-50145247]{min-height:100px;resize:vertical}.v-select[data-v-50145247],.v-select .vs__dropdown-toggle[data-v-50145247]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-50145247]{padding:10px 16px}.v-select .vs__search[data-v-50145247]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-50145247]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-50145247]{color:#374151}.v-select .vs__dropdown-menu[data-v-50145247]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.custom-file-input[data-v-50145247],.custom-file-label[data-v-50145247]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px}.custom-file-label[data-v-50145247]{color:#374151}.custom-file-input:focus~.custom-file-label[data-v-50145247]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.bg-light[data-v-50145247]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px}.img-fluid[data-v-50145247]{border-radius:8px;height:auto;max-width:100%}.form-check-input[data-v-50145247]{background:#fff!important;border:1px solid #e5e7eb;border-radius:4px}.form-check-input[data-v-50145247]:checked{background-color:#2ab930!important;border-color:#2ab930!important}.form-check-label[data-v-50145247],.input-group-text[data-v-50145247]{color:#374151;font-weight:500}.input-group-text[data-v-50145247]{background:#fff!important;border:1px solid #e5e7eb}.btn-outline-custom[data-v-50145247]{border-color:#1b3c71;border-radius:10px;color:#1b3c71;font-weight:500;padding:8px 16px;transition:background-color .3s,color .3s,border-color .3s}.btn-custom-active[data-v-50145247],.btn-outline-custom[data-v-50145247]:hover{background-color:#1b3c71;border-color:#1b3c71;color:#fff}.row[data-v-50145247]{margin-bottom:1rem}.form-text[data-v-50145247]{color:#6b7280;font-size:.875rem}.text-muted[data-v-50145247]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-50145247]{flex-direction:column;gap:10px}.card-footer .btn[data-v-50145247]{margin-right:0!important;width:100%}.card-footer div[data-v-50145247]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/create.vue?vue&type=template&id=50145247&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/products/create.vue?vue&type=template&id=50145247&scoped=true
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 7:
              ...
              console.error('Error loading chart of accounts:', _context6.t0);
            case 10:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 16:
              ...
              console.error('Error loading account routing settings:', _context7.t0);
          ...
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 3:
              ...
              console.log("Validation state:", {
                isSalesAccountAutomatic: _this10.isSalesAccountAutomatic,
                salesAccountId: _this10.form.salesAccountId,
                isPurchaseAccountAutomatic: _this10.isPurchaseAccountAutomatic,
                purchaseAccountId: _this10.form.purchaseAccountId
              });

              // Validate sales account if not automatic
              if (!(!_this10.isSalesAccountAutomatic && !_this10.form.salesAccountId)) {
                _context8.next = 7;
                break;
              }
              toast.fire({
              ...
              return _context8.abrupt("return");
            case 7:
              if (!(!_this10.isPurchaseAccountAutomatic && !_this10.form.purchaseAccountId)) {
                _context8.next = 10;
                break;
              }
              toast.fire({
            ...
            case 10:
              ...
              console.log("Form data being sent:", _this10.form.data());
              _context8.next = 13;
              return _this10.form.post(window.location.origin + "/api/products").then(function () {
                // Clear temporary data after successful save
                _this10.clearTemporaryData();
                toast.fire({
                  type: "success",
                  title: _this10.$t("Product added successfully")
                });

                // Store auto-assigned account IDs before reset
                var autoAssignedSalesAccountId = _this10.isSalesAccountAutomatic ? _this10.form.salesAccountId : null;
                var autoAssignedPurchaseAccountId = _this10.isPurchaseAccountAutomatic ? _this10.form.purchaseAccountId : null;
                _this10.form.reset();
                _this10.form.itemType = "product"; // Reset to default

                // Restore auto-assigned account IDs after reset
                if (autoAssignedSalesAccountId) {
                  _this10.form.salesAccountId = autoAssignedSalesAccountId;
                }
                if (autoAssignedPurchaseAccountId) {
                  _this10.form.purchaseAccountId = autoAssignedPurchaseAccountId;
                }
                _this10.$router.push({
                  name: 'products.index'
                });
                ...
                var errorMessage = ((_error$response = error.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this10.$t("Opps...something went wrong");
                toast.fire({
                  type: "error",
                  title: errorMessage
                });
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_50145247_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const products_createvue_type_style_index_0_id_50145247_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_50145247_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/products/create.vue?vue&type=style&index=0&id=50145247&prod&scoped=true&lang=css
