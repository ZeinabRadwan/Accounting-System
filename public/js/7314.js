"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7314],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-e56a9df2]{gap:10px}.header-buttons[data-v-e56a9df2]{margin-bottom:15px}.footer-buttons[data-v-e56a9df2]{display:flex;gap:10px}.footer-buttons .btn[data-v-e56a9df2]{margin-right:10px}.footer-buttons .btn[data-v-e56a9df2]:last-child{margin-right:0}.card[data-v-e56a9df2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-e56a9df2]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-e56a9df2]{background:#fff!important}.btn-primary[data-v-e56a9df2]{background:#2ab930!important}.btn-primary[data-v-e56a9df2],.btn-secondary[data-v-e56a9df2]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-e56a9df2]{background:#33a0d9!important}.btn-secondary[data-v-e56a9df2]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.btn-outline-custom[data-v-e56a9df2]{border-color:#1b3c71;border-radius:10px;color:#1b3c71;font-weight:500;padding:8px 16px;transition:background-color .3s,color .3s,border-color .3s}.btn-custom-active[data-v-e56a9df2],.btn-outline-custom[data-v-e56a9df2]:hover{background-color:#1b3c71;border-color:#1b3c71;color:#fff}h1[data-v-e56a9df2],h2[data-v-e56a9df2]{font-weight:400}ul[data-v-e56a9df2]{list-style-type:none;padding:0}li[data-v-e56a9df2]{display:inline-block;margin:0 10px}a[data-v-e56a9df2]{color:#42b983}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/edit.vue?vue&type=template&id=e56a9df2&scoped=true
...
;// ./resources/js/pages/products/edit.vue?vue&type=template&id=e56a9df2&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_e56a9df2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const products_editvue_type_style_index_0_id_e56a9df2_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_e56a9df2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/products/edit.vue?vue&type=style&index=0&id=e56a9df2&prod&scoped=true&lang=css
