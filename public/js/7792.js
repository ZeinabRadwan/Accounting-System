"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7792],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-pills .nav-item[data-v-1a2f60fd]{background:#ddd;border-radius:.25rem;margin:2px}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/show.vue?vue&type=template&id=1a2f60fd&scoped=true
var render = function render() {
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t("Total Price")))])]), _vm._v(" "), _c('td', {
    staticClass: "text-center"
  }, [_c('strong', [_vm._v(_vm._s(_vm.totalPrice) + " "), _c('span', {
    staticClass: "saudi-riyal"
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_1a2f60fd_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_showvue_type_style_index_0_id_1a2f60fd_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_1a2f60fd_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/quotations/show.vue?vue&type=style&index=0&id=1a2f60fd&prod&scoped=true&lang=css
