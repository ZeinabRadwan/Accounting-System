"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3300],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=5dc3a14a&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    on: {
      "submit": function submit($event) {
        ...
        return _vm.savePurchase.apply(null, arguments);
      },
    ...
    staticClass: "ml-2"
  }, [_vm._v(_vm._s(_vm.$t('Supplier Chart of Account ready')))])])]) : _vm._e(), _vm._v(" "), _c('has-error', {
    attrs: {
      "form": _vm.form,
      "field": "supplier"
    }
    ...
    return _c('tr', {
      ...
      on: {
        "click": function click($event) {
          return _vm.generateItemTotal(item.originalPrice || item.unitPrice, 'price', i - 1, 'decrement');
        }
      }
    }), _vm._v(" "), _c('input', {
      staticClass: "quantity-field border-0 incrementor",
      ...
      domProps: {
        "value": item.originalPrice || item.unitPrice
      },
      on: {
        "change": function change($event) {
      ...
      on: {
        "click": function click($event) {
          return _vm.generateItemTotal(item.originalPrice || item.unitPrice, 'price', i - 1, 'increment');
        }
      }
    })]), _vm._v(" "), _vm.form.errors.has("selectedProducts.".concat(i - 1, ".unitPrice")) ? _c('div', {
      staticClass: "invalid-feedback d-block"
    }, [_vm._v("\n                          " + _vm._s(_vm.form.errors.get("selectedProducts.".concat(i - 1, ".unitPrice"))) + "\n                        ")]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")((item.originalPrice || item.unitPrice) * item.qty)))]), _vm._v(" "), _c('td', [_c('div', {
      ...
      staticClass: "d-block"
    }, [_vm._v(_vm._s(_vm.form.errors.get("selectedProducts.".concat(i - 1, ".discountType"))))]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalAfterDiscount(item))))]), _vm._v(" "), _c('td', [_c('select', {
      directives: [{
        name: "model",
        rawName: "v-model",
    ...
    }, [_vm._v("\n                          " + _vm._s(_vm._f("withCurrency")(item.productTax)) + "\n                        ")])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalWithVAT(item))))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_c('button', {
  ...
  }, [_c('strong', [_vm._v(" " + _vm._s(_vm.$t("Total")) + " : " + _vm._s(_vm.toWord()) + " ")])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.totalUnitPrice)))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalDiscountSum())))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getSubTotalAfterDiscount())))])]), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalVATSum())))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.getTotalWithVATSum())))])]), _vm._v(" "), _c('td')])], 2)])])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
...
;// ./resources/js/pages/purchases/create.vue?vue&type=template&id=5dc3a14a&scoped=true
...
var SupplierCreateModal = __webpack_require__(78874);
  ...
  methods: {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              currentSupplierId = _this.form.supplier ? _this.form.supplier.id : null;
              _context.n = 1;
            ...
            case 1:
              ...
              if (currentSupplierId && _this.items && _this.items.length > 0) {
                currentSupplier = _this.items.find(function (s) {
                  return s.id === currentSupplierId;
                });
                if (currentSupplier) {
                  _this.form.supplier = currentSupplier;
                } else {
                  // Fallback to first supplier if current one not found
                  _this.form.supplier = _this.items[0];
                }
              } else {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              currentProductIds = _this2.form.selectedProducts ? _this2.form.selectedProducts.map(function (p) {
                return p.id;
              }) : [];
              _context2.n = 1;
            ...
            case 1:
              ...
              if (currentProductIds.length > 0 && _this2.form.selectedProducts) {
                _this2.form.selectedProducts.forEach(function (selectedProduct) {
                  var freshProduct = _this2.products.find(function (p) {
    ...
    getAccounts: function getAccounts() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var _yield$axios$get3, data, defaultAccountSlug;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            ...
            case 1:
              ...
              _this4.accounts = data.data;
              // assign default account
              if (_this4.accounts && _this4.accounts.length > 0) {
                defaultAccountSlug = _this4.appInfo.defaultAccountSlug;
                _this4.form.account = _this4.accounts.find(function (account) {
    ...
    storeProduct: function storeProduct(product) {
      ...
      if (index === -1) {
        ...
        this.form.selectedProducts.unshift({
          ...
          // Store original price to preserve it
          discount: 0,
          discountType: "fixed",
          discountAmount: 0,
    ...
    toWord: function toWord() {
      ...
      var words = toWords.convert(this.totalUnitPrice);
      return words + ' Only';
    },
    ...
    savePurchase: function savePurchase() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var validationErrors, errorList, formData, response, errorMessages, _errorList, ErrorHandler, _t;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            ...
            case 1:
              ...
              if (_this6.form.addPayment == 1 && !_this6.form.account) {
                validationErrors.push(_this6.$t("Please select an account"));
              }

              // Check total paid (only required if adding payment)
              if (_this6.form.addPayment == 1 && (!_this6.form.totalPaid || Number(_this6.form.totalPaid) <= 0)) {
                validationErrors.push(_this6.$t("Please enter the total amount paid"));
              }
            ...
            case 2:
              ...
              formData = _this6.form.data(); // Convert addPayment to boolean for backend validation
              formData.addPayment = _this6.form.addPayment == 1;

              // Only include payment-related fields if payment is being added
              if (_this6.form.addPayment == 1) {
                formData.account = _this6.form.account;
                formData.totalPaid = _this6.form.totalPaid;
              } else {
              ...
              _context5.n = 3;
              return _this6.$axios.post("/api/purchases", formData);
            case 3:
              response = _context5.v;
              toast.fire({
                type: "success",
                title: _this6.$t("Purchase added successfully")
              });
            ...
            case 4:
              _context5.p = 4;
              _t = _context5.v;
              if (_t.response && _t.response.data && _t.response.data.errors) {
                // Validation errors from backend - show all errors in one notification
                errorMessages = Object.values(_t.response.data.errors).flat();
              ...
              } else if (_t.response && _t.response.data && _t.response.data.message) {
                ...
                ErrorHandler.handleApiError(_t, {
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_5dc3a14a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_5dc3a14a_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_5dc3a14a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=5dc3a14a&prod&scoped=true&lang=css
...
;// ./node_modules/vue-tel-input/dist/vue-tel-input.css?vue&type=style&index=0&prod&lang=css&external
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-card[data-v-edf6b078]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:20px}.form-card .card-header[data-v-edf6b078]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:22px 16px}.form-card .section-title[data-v-edf6b078]{color:#fff;font-size:14px;font-weight:600;margin:0}.form-card .card-body[data-v-edf6b078]{padding:16px}.form-control[data-v-edf6b078]{background:#fff!important}input[readonly][data-v-edf6b078]{background-color:#f8f9fa!important;border-color:#ced4da;color:#6c757d;cursor:not-allowed}.form-control[data-v-edf6b078]:focus,select.form-control[data-v-edf6b078]:focus,textarea.form-control[data-v-edf6b078]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.radio-group[data-v-edf6b078]{align-items:center;display:flex;gap:16px}.radio-group .radio-inline[data-v-edf6b078]{align-items:center;display:inline-flex;gap:6px;margin:0}.v-select .vs__dropdown-toggle[data-v-edf6b078]{border-color:#ced4da;border-radius:6px}.v-select .vs__dropdown-toggle.vs__open[data-v-edf6b078],.v-select .vs__dropdown-toggle[data-v-edf6b078]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-menu[data-v-edf6b078],.v-select .vs__search[data-v-edf6b078],.v-select .vs__selected[data-v-edf6b078]{font-size:.95rem}.custom-file-input:focus~.custom-file-label[data-v-edf6b078]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.custom-file-label[data-v-edf6b078]{border-radius:6px}.file-upload-area[data-v-edf6b078]{background:#f8fdfe;border:2px dashed #33a0d9;border-radius:12px;padding:20px;position:relative;text-align:center}.file-upload-area .file-input[data-v-edf6b078]{cursor:pointer;height:100%;inset:0;opacity:0;position:absolute;width:100%}.file-upload-area .file-upload-content[data-v-edf6b078]{color:#33a0d9}.selected-files .selected-file-item[data-v-edf6b078]{align-items:center;background:#f5faff;border:1px solid #e3f3f7;border-radius:6px;display:inline-flex;margin-bottom:8px;margin-right:8px;padding:6px 10px}.d-flex.align-items-center span.ml-3[data-v-edf6b078]{font-weight:500}.required[data-v-edf6b078]{color:#dc3545}[dir=rtl] .form-card .card-header[data-v-edf6b078]{border-radius:20px 20px 0 0}.custom-file-label[data-v-edf6b078],[dir=rtl] .custom-file-label[data-v-edf6b078]{text-align:left!important}.btn-primary[data-v-edf6b078]{background:#33a0d9!important;border-color:#33a0d9!important}.btn-primary[data-v-edf6b078]:hover{filter:brightness(.95)}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".create-button[data-v-383ade83]{cursor:pointer;text-decoration:none}.vue-tel-input[data-v-383ade83]{padding:3px}.ti__dropdown-list[data-v-383ade83]{z-index:2}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=template&id=edf6b078&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
/* harmony default export */ const SupplierFormvue_type_script_lang_js = ({
  ...
  methods: {
          ...
          while (1) switch (_context2.n) {
            case 0:
              ...
              if (_this5.$toast) {
                _this5.$toast.fire({
                  type: 'error',
                  title: _this5.$t('Please fix the highlighted errors and try again')
                });
              }
              return _context2.a(2);
            case 1:
            ...
            case 1:
              ...
              if (response.data && response.data.success) {
                ...
                if (_this7.routingSetting) {
                  ...
                  _this7.routingSetting = {
                    routing_type: 'per_each',
                    routing_type_display: 'Specify Per Each',
                    main_account_id: null
                  };
                  console.log('Using default routing setting:', _this7.routingSetting);
                }
              } else {
                ...
                console.log('Using default routing setting due to API failure:', _this7.routingSetting);
              }
              _context4.n = 3;
              break;
            case 2:
              ...
              console.log('Using default routing setting due to error:', _this7.routingSetting);
            case 3:
              return _context4.a(2);
          }
        }, _callee4, null, [[0, 2]]);
    ...
    loadChartOfAccounts: function loadChartOfAccounts() {
      var _this8 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var response, fallbackResponse, _response, altResponse, _t4, _t5, _t6;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              _context5.p = 0;
            ...
            case 1:
              ...
              _context5.p = 2;
              _context5.n = 3;
              return _this8.$http.get("/api/account-routing-settings/".concat(_this8.routingSetting.setting_key, "/accounts"));
            case 3:
              response = _context5.v;
              ...
              _this8.chartOfAccounts = response.data.accounts || [];
            ...
            case 6:
              _context5.p = 6;
              _t4 = _context5.v;
              console.log('Routing accounts failed, falling back to all accounts:', _t4);
              // Fallback to all accounts
              _context5.n = 7;
              return _this8.$http.get('/api/suppliers/chart-of-accounts');
            case 7:
            ...
            case 13:
              altResponse = _context5.v;
              _this8.chartOfAccounts = altResponse.data.data || altResponse.data || [];
              console.log('Loaded accounts from dropdown endpoint:', _this8.chartOfAccounts.length);
              _context5.n = 15;
              break;
            case 14:
              _context5.p = 14;
              _t5 = _context5.v;
              console.error('Alternative endpoint also failed:', _t5);
              ...
              _this8.chartOfAccountsError = 'No chart of accounts available. Please check your configuration.';
            case 15:
              _context5.n = 17;
              break;
            case 16:
              ...
              _this8.chartOfAccountsError = _t6.message || 'Failed to load chart of accounts';
              _this8.chartOfAccounts = [];
            case 17:
              _context5.p = 17;
              _this8.loadingChartOfAccounts = false;
        ...
        }, _callee5, null, [[12, 14], [2, 6], [0, 16, 17, 18]]);
      }))();
    },
    ...
    searchChartOfAccounts: function searchChartOfAccounts(search, loading) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var filtered, response, apiData, _filtered, _t7;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              _context6.p = 0;
              // Filter locally first for better performance
              filtered = _this9.chartOfAccounts.filter(function (account) {
              ...
              return _context6.a(2, filtered.slice(0, 50));
            case 1:
              // Otherwise, search from API
              console.log('Searching from API...');
              _context6.n = 2;
              return _this9.$http.get('/api/chart-of-accounts/search', {
                params: {
                  term: search
                }
              });
            case 2:
              ...
              return _context6.a(2, apiData.slice(0, 50));
            case 3:
            ...
            case 5:
              _context6.p = 5;
              _t7 = _context6.v;
              console.error('Search error:', _t7);
              // Return local filtered results on error
              _filtered = _this9.chartOfAccounts.filter(function (account) {
                return account.name.toLowerCase().includes(search.toLowerCase()) || account.code.toLowerCase().includes(search.toLowerCase());
              });
              return _context6.a(2, _filtered.slice(0, 50));
            case 6:
              _context6.p = 6;
              loading(false);
    ...
    createNewAccount: function createNewAccount() {
      var _this0 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var assetTypeResponse, typeId, assetType, parentId, codeResponse, accountCode, response, _newAccount$type, newAccount, errorMessage, _t8;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
            ...
            case 8:
              _context7.p = 8;
              _t8 = _context7.v;
              console.error('Error creating chart of account:', _t8);
              errorMessage = "Failed to create new chart of account.";
              if (_t8.response && _t8.response.data) {
                if (_t8.response.data.message) {
                  errorMessage = _t8.response.data.message;
                } else if (_t8.response.data.error) {
                  errorMessage = _t8.response.data.error;
                }
              } else if (_t8.message) {
                errorMessage = _t8.message;
              }
    ...
    autoAssignSupplierChartOfAccount: function autoAssignSupplierChartOfAccount() {
      var _this1 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var supplierSlug, response, _t9;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              if (!(!_this1.form || _this1.isAutoAssigningSupplier)) {
                _context8.n = 1;
                break;
              }
              return _context8.a(2);
            case 1:
              _this1.isAutoAssigningSupplier = true;
              _context8.p = 2;
              // Get the current supplier slug from the form or route
              supplierSlug = _this1.form.slug || _this1.$route && _this1.$route.params && _this1.$route.params.slug;
            ...
            case 3:
              _context8.n = 4;
              return _this1.$http.post("/api/suppliers/".concat(supplierSlug, "/auto-assign-chart-of-account"));
            case 4:
              ...
              if (response.data.success) {
                ...
                _this1.form.chartOfAccountId = response.data.chart_of_account_id;
                ...
                _this1.$toast.fire({
                  type: "success",
                  title: _this1.$t("Chart of Account assigned successfully")
                });
              } else {
                _this1.$toast.fire({
                  type: "error",
                  title: _this1.$t("Failed to assign Chart of Account"),
                  text: response.data.message || _this1.$t("Please try again or assign manually")
                });
              }
              _context8.n = 6;
              break;
            case 5:
              ...
              _this1.$toast.fire({
                type: "error",
                title: _this1.$t("An error occurred while assigning Chart of Account")
              });
            case 6:
              _context8.p = 6;
              _this1.isAutoAssigningSupplier = false;
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=edf6b078&prod&scoped=true&lang=css
var SupplierFormvue_type_style_index_0_id_edf6b078_prod_scoped_true_lang_css = __webpack_require__(32776);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=edf6b078&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(SupplierFormvue_type_style_index_0_id_edf6b078_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_SupplierFormvue_type_style_index_0_id_edf6b078_prod_scoped_true_lang_css = (SupplierFormvue_type_style_index_0_id_edf6b078_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=edf6b078&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierCreateModal.vue?vue&type=template&id=383ade83&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('VModal', {
...
var SupplierForm = __webpack_require__(74813);
...
/* harmony default export */ const SupplierCreateModalvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    createSupplier: function createSupplier() {
      var _this = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var formData, submitData, response, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _context.p = 0;
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierCreateModal.vue?vue&type=style&index=1&id=383ade83&prod&scoped=true&lang=css
var SupplierCreateModalvue_type_style_index_1_id_383ade83_prod_scoped_true_lang_css = __webpack_require__(45821);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierCreateModal.vue?vue&type=style&index=1&id=383ade83&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(SupplierCreateModalvue_type_style_index_1_id_383ade83_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_SupplierCreateModalvue_type_style_index_1_id_383ade83_prod_scoped_true_lang_css = (SupplierCreateModalvue_type_style_index_1_id_383ade83_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/SupplierCreateModal.vue?vue&type=style&index=1&id=383ade83&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-5dc3a14a]{margin-bottom:15px}.footer-buttons[data-v-5dc3a14a]{display:flex;gap:10px}.footer-buttons .btn[data-v-5dc3a14a]{margin-right:10px}.footer-buttons .btn[data-v-5dc3a14a]:last-child{margin-right:0}.chart-account-success[data-v-5dc3a14a],.chart-account-warning[data-v-5dc3a14a]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-5dc3a14a]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-5dc3a14a]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-5dc3a14a],.warning-content[data-v-5dc3a14a]{align-items:center;display:flex;gap:16px}.success-icon[data-v-5dc3a14a],.warning-icon[data-v-5dc3a14a]{flex-shrink:0;font-size:24px}.warning-icon[data-v-5dc3a14a]{color:#856404}.success-icon[data-v-5dc3a14a]{color:#155724}.success-text[data-v-5dc3a14a],.warning-text[data-v-5dc3a14a]{flex-grow:1}.success-title[data-v-5dc3a14a],.warning-title[data-v-5dc3a14a]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-5dc3a14a]{color:#856404}.success-title[data-v-5dc3a14a]{color:#155724}.success-description[data-v-5dc3a14a],.warning-description[data-v-5dc3a14a]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-5dc3a14a]{color:#856404}.success-description[data-v-5dc3a14a]{color:#155724}.warning-action[data-v-5dc3a14a]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-5dc3a14a]{padding:0}.btn-group.c-w-100[data-v-5dc3a14a]{gap:10px}.card[data-v-5dc3a14a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-5dc3a14a]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-5dc3a14a]{padding:1.25rem}.card-footer[data-v-5dc3a14a]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-5dc3a14a]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-5dc3a14a]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-5dc3a14a]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-5dc3a14a]{color:#dc3545;font-weight:700}.btn-primary[data-v-5dc3a14a]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-5dc3a14a]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-5dc3a14a]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-5dc3a14a]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-5dc3a14a]{border-color:#dc3545!important}textarea.form-control[data-v-5dc3a14a]{min-height:100px;resize:vertical}.v-select[data-v-5dc3a14a],.v-select .vs__dropdown-toggle[data-v-5dc3a14a]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-5dc3a14a]{padding:10px 16px}.v-select .vs__search[data-v-5dc3a14a]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-5dc3a14a]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-5dc3a14a]{color:#374151}.v-select .vs__dropdown-menu[data-v-5dc3a14a]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-5dc3a14a]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-5dc3a14a]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-5dc3a14a]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-5dc3a14a]:hover{background-color:#f8f9fa}.custom-qty-input[data-v-5dc3a14a]{align-items:center;background:#fff;border:1px solid #e5e7eb;border-radius:10px;display:flex;overflow:hidden}.custom-qty-input .button-minus[data-v-5dc3a14a],.custom-qty-input .button-plus[data-v-5dc3a14a]{background:#6c757d;border:none;color:#fff;cursor:pointer;font-weight:700;padding:8px 12px;transition:background-color .3s}.custom-qty-input .button-minus[data-v-5dc3a14a]:hover{background:#dc3545}.custom-qty-input .button-plus[data-v-5dc3a14a]:hover{background:#2ab930}.custom-qty-input .quantity-field[data-v-5dc3a14a]{background:transparent;border:none;font-weight:500;padding:8px 4px;text-align:center;width:60px}.custom-qty-input .quantity-field[data-v-5dc3a14a]:focus{box-shadow:none;outline:none}.toggle-button[data-v-5dc3a14a]{margin-right:10px}.create-btn[data-v-5dc3a14a]{background:#2ab930;border:none;border-radius:10px;color:#fff;cursor:pointer;padding:11px;transition:background-color .3s}.create-btn[data-v-5dc3a14a]:hover{background:#229a26}.product-status[data-v-5dc3a14a],.supplier-status[data-v-5dc3a14a]{font-size:13px}.product-success[data-v-5dc3a14a],.product-warning[data-v-5dc3a14a],.supplier-success[data-v-5dc3a14a],.supplier-warning[data-v-5dc3a14a]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-5dc3a14a],.supplier-warning[data-v-5dc3a14a]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-5dc3a14a],.supplier-success[data-v-5dc3a14a]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-5dc3a14a]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-5dc3a14a]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-5dc3a14a]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-5dc3a14a]{margin-bottom:1rem}.form-text[data-v-5dc3a14a]{color:#6b7280;font-size:.875rem}.text-muted[data-v-5dc3a14a]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-5dc3a14a]{flex-direction:column;gap:10px}.card-footer .btn[data-v-5dc3a14a]{margin-right:0!important;width:100%}.card-footer div[data-v-5dc3a14a]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-5dc3a14a]{font-size:12px}.table-custom tbody td[data-v-5dc3a14a],.table-custom thead th[data-v-5dc3a14a]{padding:8px 4px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
