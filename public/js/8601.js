"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8601],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=025a454e&scoped=true
...
;// ./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=025a454e&scoped=true
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=025a454e&prod&lang=scss&scoped=true
var invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true = __webpack_require__(43910);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=025a454e&prod&lang=scss&scoped=true

            

var invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true_options = {};

invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true_options.insert = "head";
invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true_options.singleton = false;

var invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true_update = injectStylesIntoStyleTag_default()(invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true/* default */.A, invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true_options);



/* harmony default export */ const quotations_invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true = (invoicevue_type_style_index_0_id_025a454e_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=025a454e&prod&lang=scss&scoped=true
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".account-status[data-v-025a454e],.client-status[data-v-025a454e],.product-status[data-v-025a454e]{font-size:.875rem}.account-status .account-warning[data-v-025a454e],.account-status .client-warning[data-v-025a454e],.account-status .product-warning[data-v-025a454e],.client-status .account-warning[data-v-025a454e],.client-status .client-warning[data-v-025a454e],.client-status .product-warning[data-v-025a454e],.product-status .account-warning[data-v-025a454e],.product-status .client-warning[data-v-025a454e],.product-status .product-warning[data-v-025a454e]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-025a454e],.account-status .client-success[data-v-025a454e],.account-status .product-success[data-v-025a454e],.client-status .account-success[data-v-025a454e],.client-status .client-success[data-v-025a454e],.client-status .product-success[data-v-025a454e],.product-status .account-success[data-v-025a454e],.product-status .client-success[data-v-025a454e],.product-status .product-success[data-v-025a454e]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.btn-warning[data-v-025a454e]{background-color:#ffc107!important;border-color:#ffc107!important;color:#212529!important}.btn-warning[data-v-025a454e]:hover{background-color:#e0a800!important;border-color:#d39e00!important}.btn-primary[data-v-025a454e]{background:#2ab930!important}.btn-primary[data-v-025a454e]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.clickable-badge[data-v-025a454e]{cursor:pointer;transition:all .2s ease}.clickable-badge[data-v-025a454e]:hover{box-shadow:0 2px 4px rgba(0,0,0,.2);transform:scale(1.1)}.invoices-create-table[data-v-025a454e]{font-size:.875rem}.invoices-create-table th[data-v-025a454e]{background-color:#f8f9fa;border-bottom:2px solid #dee2e6;font-weight:600;padding:.75rem .5rem}.invoices-create-table td[data-v-025a454e]{padding:.5rem;vertical-align:middle}.insufficient-stock-input[data-v-025a454e]{background-color:#fff5f5!important;border-color:#dc3545!important}.custom-qty-input[data-v-025a454e]{display:flex;flex-wrap:nowrap;width:100%}.custom-qty-input .button-minus[data-v-025a454e],.custom-qty-input .button-plus[data-v-025a454e]{align-items:center;background:#fff;border:1px solid #ced4da;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;width:30px}.custom-qty-input .button-minus[data-v-025a454e]{border-radius:.25rem 0 0 .25rem;border-right:none}.custom-qty-input .button-plus[data-v-025a454e]{border-left:none;border-radius:0 .25rem .25rem 0}.custom-qty-input .quantity-field[data-v-025a454e]{border-left:none;border-radius:0;border-right:none;flex:1;text-align:center}.custom-qty-input .quantity-field[data-v-025a454e]:focus{border-color:#80bdff;box-shadow:none}.saudi-riyal[data-v-025a454e]{color:#28a745;font-weight:700}", ""]);
// Exports
