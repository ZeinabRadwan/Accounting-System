"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7350],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-4b305f40]{border:none!important}.products-table[data-v-4b305f40]{border-collapse:separate;border-spacing:0}.products-table thead th[data-v-4b305f40]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.products-table thead tr[data-v-4b305f40]{border:none!important}.products-table thead th[data-v-4b305f40]:first-child{border-top-left-radius:10px}.products-table thead th[data-v-4b305f40]:last-child{border-top-right-radius:10px}[dir=rtl] .products-table thead th[data-v-4b305f40]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .products-table thead th[data-v-4b305f40]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-4b305f40]{background:#33a0d91a!important;color:#33a0d9!important}.import-btn[data-v-4b305f40],.refresh-btn[data-v-4b305f40]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.import-btn[data-v-4b305f40]{background:#6c757d!important;color:#fff!important}.export-excel-btn[data-v-4b305f40],.export-pdf-btn[data-v-4b305f40]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-4b305f40],.export-pdf-btn[data-v-4b305f40],.print-btn[data-v-4b305f40]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-4b305f40]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-4b305f40]{display:inline-block;position:relative}.action-icon-btn[data-v-4b305f40]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-4b305f40]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-4b305f40]{animation:slideInDown-4b305f40 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-4b305f40]{left:45px!important;right:auto!important}.action-menu-header[data-v-4b305f40]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-4b305f40]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-4b305f40]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-4b305f40]:hover{background-color:#e5e7eb}.action-menu ul[data-v-4b305f40]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-4b305f40]{margin:0}.action-menu li a[data-v-4b305f40]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-4b305f40]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-4b305f40]{flex-shrink:0;height:16px;width:16px}@keyframes slideInDown-4b305f40{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.btn-group.c-w-100[data-v-4b305f40]{gap:10px}.card[data-v-4b305f40]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-4b305f40]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.products-table .badge.bg-success[data-v-4b305f40]{background:#f6fef4!important;color:#2ab930!important}.products-table .badge.bg-danger[data-v-4b305f40],.products-table .badge.bg-success[data-v-4b305f40]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.products-table .badge.bg-danger[data-v-4b305f40]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-4b305f40]{background:#fff!important}.btn-primary[data-v-4b305f40]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.pay-modal[data-v-4b305f40]{max-width:1100px;width:95vw}@media (min-width:576px){.pay-modal[data-v-4b305f40]{width:90vw}}@media (min-width:768px){.pay-modal[data-v-4b305f40]{width:80vw}}@media (min-width:1200px){.pay-modal[data-v-4b305f40]{width:60vw}}.pay-modal .w-100[data-v-4b305f40]{max-height:75vh;overflow-y:auto}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/index.vue?vue&type=template&id=4b305f40&scoped=true
...
var update = injectStylesIntoStyleTag_default()(productsvue_type_style_index_0_id_4b305f40_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_productsvue_type_style_index_0_id_4b305f40_prod_scoped_true_lang_css = (productsvue_type_style_index_0_id_4b305f40_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/products/index.vue?vue&type=style&index=0&id=4b305f40&prod&scoped=true&lang=css
