...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".edit-button[data-v-2eaec3d9]{cursor:pointer;text-decoration:none}.modal-content[data-v-2eaec3d9]{margin:1.75rem auto;max-width:1000px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-1e8730bb]{margin-bottom:15px}.footer-buttons[data-v-1e8730bb]{display:flex;gap:10px}.footer-buttons .btn[data-v-1e8730bb]{margin-right:10px}.footer-buttons .btn[data-v-1e8730bb]:last-child{margin-right:0}.create-btn[data-v-1e8730bb]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-1e8730bb]:hover{background-color:#e9ecef}.edit-btn[data-v-1e8730bb]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-1e8730bb]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-1e8730bb]{border:none!important}.quotations-create-table[data-v-1e8730bb]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-1e8730bb]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-1e8730bb]{border:none!important}.quotations-create-table thead th[data-v-1e8730bb]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-1e8730bb]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-1e8730bb]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-1e8730bb]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-1e8730bb]{gap:10px}.card[data-v-1e8730bb]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-1e8730bb]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-1e8730bb]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-1e8730bb]{background:#fff!important}.btn-primary[data-v-1e8730bb]{background:#2ab930!important}.btn-secondary[data-v-1e8730bb]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-1e8730bb]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-1e8730bb],.button-plus[data-v-1e8730bb]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-1e8730bb]{background-color:#dc3545;color:#fff}.button-plus[data-v-1e8730bb]{background-color:#007bff;color:#fff}.button-minus[data-v-1e8730bb]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-1e8730bb]:hover{background-color:#0056b3;transform:scale(1.05)}.price-field[data-v-1e8730bb]{width:100%}.quantity-field[data-v-1e8730bb]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-1e8730bb]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-1e8730bb]{direction:rtl}[dir=rtl] .create-btn[data-v-1e8730bb]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-1e8730bb]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-1e8730bb]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-1e8730bb]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-1e8730bb]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-1e8730bb]{border-right:1px solid #ced4da}.clickable-badge[data-v-1e8730bb]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-1e8730bb]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-1e8730bb]:active{transform:scale(.95)}.insufficient-stock-input[data-v-1e8730bb]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-1e8730bb]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-1e8730bb]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-1e8730bb]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-1e8730bb]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-1e8730bb]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-1e8730bb]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-1e8730bb]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-1e8730bb]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-1e8730bb]:last-child{border-bottom:none}.debug-display[data-v-1e8730bb]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-1e8730bb]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-1e8730bb]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-1e8730bb]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-1e8730bb]:last-child{border-bottom:none}.debug-panel .table th[data-v-1e8730bb]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-1e8730bb]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-1e8730bb]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-1e8730bb]{padding:15px}.debug-item .row[data-v-1e8730bb]{margin:0}.debug-item .col-md-6[data-v-1e8730bb]{padding:0 5px}.debug-step[data-v-1e8730bb]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-1e8730bb]{font-size:.75em}}.summary-footer-wrapper[data-v-1e8730bb]{margin-top:10px}.summary-card[data-v-1e8730bb]{background:#fff;border:1px solid #e5e7eb;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.05);overflow:hidden}.summary-card-horizontal[data-v-1e8730bb]{padding:12px 15px}.summary-row-horizontal[data-v-1e8730bb]{align-items:center;display:flex;flex-wrap:wrap;gap:8px;justify-content:space-between}.summary-item[data-v-1e8730bb]{align-items:center;display:flex;flex:1;flex-direction:column;min-width:100px;padding:0 12px}.summary-item-label[data-v-1e8730bb]{color:#6b7280;font-size:11px;font-weight:500;letter-spacing:.5px;margin-bottom:4px;text-transform:uppercase}.summary-item-value[data-v-1e8730bb]{color:#111827;font-size:14px;font-weight:600;text-align:center}.summary-item-discount .summary-item-value[data-v-1e8730bb]{color:#dc2626}.summary-item-total[data-v-1e8730bb]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-radius:6px;margin:0 -5px;padding:8px 15px}.summary-item-total .summary-item-label[data-v-1e8730bb]{color:#1e40af;font-size:12px;font-weight:600}.summary-item-total .summary-item-value[data-v-1e8730bb]{color:#33a0d9;font-size:16px;font-weight:700}.summary-divider[data-v-1e8730bb]{background-color:#e5e7eb;flex-shrink:0;height:40px;width:1px}.summary-divider-bold[data-v-1e8730bb]{background-color:#33a0d9;height:50px;width:2px}.summary-total[data-v-1e8730bb]{color:#33a0d9;font-size:16px;font-weight:700}[dir=rtl] .summary-item[data-v-1e8730bb]{direction:rtl}@media (max-width:992px){.summary-row-horizontal[data-v-1e8730bb]{flex-wrap:wrap;justify-content:center}.summary-item[data-v-1e8730bb]{min-width:80px;padding:0 8px}.summary-divider[data-v-1e8730bb]{display:none}}@media (max-width:768px){.summary-card-horizontal[data-v-1e8730bb]{padding:10px 12px}.summary-item[data-v-1e8730bb]{min-width:70px;padding:0 6px}.summary-item-label[data-v-1e8730bb]{font-size:10px}.summary-item-value[data-v-1e8730bb]{font-size:13px}.summary-item-total[data-v-1e8730bb]{margin:8px 0 0;padding:10px;width:100%}.summary-item-total .summary-item-value[data-v-1e8730bb]{font-size:18px}}@media (max-width:576px){.summary-card[data-v-1e8730bb]{border-radius:6px}.summary-item[data-v-1e8730bb]{min-width:60px;padding:0 4px}.summary-item-label[data-v-1e8730bb]{font-size:9px}.summary-item-value[data-v-1e8730bb]{font-size:12px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/edit.vue?vue&type=template&id=1e8730bb&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
    ...
    staticClass: "form-control",
    "class": {
      'is-invalid': _vm.form.errors.has('discount') || _vm.form.discountType == 0 && _vm.form.discount > _vm.form.subTotal
    },
    attrs: {
      "id": "discount",
      "type": "number",
  ...
  })]), _vm._v(" "), _vm.form.discountType == 0 && _vm.form.discount > _vm.form.subTotal && _vm.form.subTotal > 0 ? _c('div', {
    staticClass: "alert alert-warning mt-2 mb-0 py-2",
    attrs: {
      "role": "alert"
    }
  }, [_c('i', {
    staticClass: "fas fa-exclamation-triangle mr-2"
  }), _vm._v(" "), _c('small', [_c('strong', [_vm._v(_vm._s(_vm.$t("Warning")) + ":")]), _vm._v(" \n                      " + _vm._s(_vm.$t("Discount cannot exceed total price. Maximum allowed discount is")) + " " + _vm._s(_vm.formatToTwoDecimals(_vm.form.subTotal)) + " "), _c('span', {
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])])]) : _vm._e(), _vm._v(" "), _vm.form.errors.has('discountType') || _vm.form.errors.has('discount') ? _c('div', {
    staticClass: "invalid-feedback d-block"
...
;// ./resources/js/pages/sales/quotations/edit.vue?vue&type=template&id=1e8730bb&scoped=true
...
var ClientEditModal = __webpack_require__(88874);
...
/* harmony default export */ const editvue_type_script_lang_js = ({
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _this.ensureDiscountProperties();

            // Load all required data in parallel
            _context.next = 4;
            return Promise.all([_this.getClients(), _this.getProducts(), _this.getTaxes(), _this.loadCommunicationConfigStatus()]);
          case 4:
            _context.next = 6;
            return _this.$nextTick();
          case 6:
            _context.next = 8;
            return _this.fetchQuotation();
          case 8:
          case "end":
            return _context.stop();
        }
  ...
  methods: {
    ...
    setCorrectTitle: function setCorrectTitle() {
      var correctTitle = this.$t("Edit Quotation");
    ...
    getClients: function getClients() {
      var _arguments = arguments,
        _this2 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var selectedClient, _yield$axios$get, data, defaultClientSlug, defaultClient;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 15:
              ...
              defaultClient = _this2.clients.find(function (item) {
                return item.slug === defaultClientSlug;
              });
              if (defaultClient) {
                _this2.form.client = defaultClient;
              }
              _context2.next = 24;
              break;
            case 20:
              ...
              console.error('Error loading clients:', _context2.t0);
              _this2.clients = [];
            case 24:
            case "end":
              return _context2.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 10:
              _context5.prev = 10;
              _context5.t0 = _context5["catch"](0);
              console.error('Error loading communication config status:', _context5.t0);
    ...
    storeProduct: function storeProduct(product) {
      ...
      if (index === -1) {
        ...
        var _index = 0; // Since we're adding to the beginning of the array
        this.calculateItemAmounts(_index);
      } else {
    ...
    ensureDiscountProperties: function ensureDiscountProperties() {
      ...
      this.form.selectedProducts.forEach(function (item) {
        ...
        if (typeof item.selectedVatRate === 'undefined') {
          ...
          if (item.taxRate) {
            item.selectedVatRate = _this6.findMatchingVatRate(item.taxRate);
          }

          // If no match found or no taxRate, fall back to quotation default
          if (!item.selectedVatRate) {
            if (_this6.form.orderTax) {
              item.selectedVatRate = _this6.form.orderTax;
            } else if (_this6.taxes && _this6.taxes.length > 0) {
              item.selectedVatRate = _this6.taxes[0];
            }
          }
        }
      });
    ...
    calculateItemAmounts: function calculateItemAmounts(index) {
      ...
      var vatBase = this.roundToTwoDecimals(netTotal);
      ...
      var updatedItem = _objectSpread(_objectSpread({}, item), {}, {
        ...
        totalTax: totalTax,
        totalPrice: totalPrice // Total after VAT
      });
    ...
    allocateInvoiceDiscountProportionally: function allocateInvoiceDiscountProportionally(quotationLevelDiscount) {
      var _this7 = this;
      ...
      this.form.selectedProducts.forEach(function (item, index) {
        ...
        if (quotationSubtotal > 0 && itemSubtotal > 0) {
          ...
          var proportion = itemSubtotal / quotationSubtotal;
          proportionalAmount = _this7.roundToTwoDecimals(quotationLevelDiscount * proportion);
      ...
      var roundingDifference = this.roundToTwoDecimals(quotationLevelDiscount - allocatedTotal);
    ...
    recalculateAllItemsWithProportionalDiscount: function recalculateAllItemsWithProportionalDiscount() {
      ...
      this.form.selectedProducts.forEach(function (item, index) {
        ...
        _this8.calculateItemAmounts(index, true);
      });
    },
    ...
    clearProductErrors: function clearProductErrors(index) {
      ...
      if (this.form.errors && this.form.errors.has("selectedProducts.".concat(index))) {
        this.form.errors.clear("selectedProducts.".concat(index));
      }
    },
    ...
    calculateSum: function calculateSum() {
      ...
      var quotationLevelDiscount = this.invoiceLevelDiscountTotal;
      ...
      var totalDiscount = this.roundToTwoDecimals(this.totalProductDiscount + quotationLevelDiscount);

      // Validate that total discount doesn't exceed subtotal
      var validatedTotalDiscount = totalDiscount > this.subtotal ? this.roundToTwoDecimals(this.subtotal) : totalDiscount;
    ...
    fetchQuotation: function fetchQuotation() {
      var _this9 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var slug, _yield$axios$get4, data, quotationData, client, tax, _error$response;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.prev = 0;
              _this9.loading = true;
              slug = _this9.$route.params.slug;
              if (slug) {
                _context6.next = 7;
                break;
              }
              toast.fire({
                ...
                text: _this9.$t("Quotation slug is missing")
              });
              _this9.$router.push({
                name: "quotations.index"
              });
            ...
            case 7:
              ...
              _context6.next = 10;
              return _this9.getTaxes();
            case 10:
              _context6.next = 12;
              return axios_default().get(window.location.origin + "/api/quotations/" + slug);
            case 12:
              _yield$axios$get4 = _context6.sent;
              data = _yield$axios$get4.data;
              quotationData = data.data; // Populate form fields
              if (quotationData.client) {
                // Normalize client selection
                client = _this9.clients.find(function (c) {
                  return c.id === quotationData.client.id || c.slug === quotationData.client.slug;
                });
                _this9.form.client = client || quotationData.client;
              }
              _this9.form.reference = quotationData.reference || "";
              _this9.form.date = quotationData.date || new Date().toISOString().slice(0, 10);
              _this9.form.note = quotationData.note || "";
              _this9.form.status = quotationData.status !== undefined ? quotationData.status : 1;
              _this9.form.isSendEmail = quotationData.isSendEmail || false;
              _this9.form.isSendSMS = quotationData.isSendSMS || false;
              _this9.form.deliveryPlace = quotationData.deliveryPlace || "";

              // Set order tax
              if (quotationData.quotationTax) {
                tax = _this9.taxes.find(function (t) {
                  return t.id === quotationData.quotationTax.id || t.slug === quotationData.quotationTax.slug;
                });
                _this9.form.orderTax = tax || quotationData.quotationTax;
              }

              // Set discount fields
              if (quotationData.discountType !== undefined) {
                _this9.form.discountType = quotationData.discountType;
              }
              if (quotationData.discount !== undefined) {
                _this9.form.discount = quotationData.discountType == 0 ? quotationData.discount : quotationData.discountPercentage || 0;
                _this9.form.discount_value = quotationData.discountType == 0 ? quotationData.discount : quotationData.discountPercentage || 0;
                _this9.form.discount_type = quotationData.discountType == 1 ? "percentage" : "fixed";
              }

              // Assign products after taxes are loaded
              if (quotationData.products && quotationData.products.length > 0) {
                _this9.form.selectedProducts = _this9.assignProducts(quotationData.products);
              }
            ...
            case 33:
              ...
              _context6.t0 = _context6["catch"](0);
              _this9.loading = false;
              console.error('Failed to load quotation', _context6.t0);
              toast.fire({
                type: "error",
                title: _this9.$t("Error"),
                text: ((_error$response = _context6.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this9.$t("Failed to load quotation data")
              });
              _this9.$router.push({
                name: "quotations.index"
              });
    ...
    assignProducts: function assignProducts(quotationProducts) {
      ...
      var mapped = quotationProducts.map(function (qp) {
        var _ref2, _qp$salePrice, _qp$taxRate, _qp$taxAmount, _qp$unitCostTotal, _ref3, _qp$productID, _qp$product, _ref4, _qp$productSlug, _qp$product2, _ref5, _qp$productName, _qp$product3, _ref6, _qp$productCode, _qp$product4, _qp$product5, _qp$product6, _ref7, _qp$inventoryCount, _qp$product7, _qp$discount, _qp$discountType, _qp$product8, _qp$product9;
        var qty = Number(qp.quantity || qp.qty || 1);
        var unitPrice = Number((_ref2 = (_qp$salePrice = qp.salePrice) !== null && _qp$salePrice !== void 0 ? _qp$salePrice : qp.unitPrice) !== null && _ref2 !== void 0 ? _ref2 : 0);
        ...
        var totalBeforeDiscount = unitPrice * qty;
        var discountAmount = Number(qp.discountAmount || 0);
        var totalAfterDiscount = totalBeforeDiscount - discountAmount;
        var totalPrice = Number((_qp$unitCostTotal = qp.unitCostTotal) !== null && _qp$unitCostTotal !== void 0 ? _qp$unitCostTotal : taxType === 'Exclusive' ? totalAfterDiscount + totalTax : totalAfterDiscount);

        // Find VAT rate
        var selectedVatRate = null;
        if (qp.vat_rate_id && _this0.taxes) {
          selectedVatRate = _this0.taxes.find(function (tax) {
            return tax.id === qp.vat_rate_id;
          });
        }
        if (!selectedVatRate && qp.vatRate) {
          if (qp.vatRate.id && _this0.taxes) {
            selectedVatRate = _this0.taxes.find(function (tax) {
              return tax.id === qp.vatRate.id;
            });
          }
          if (!selectedVatRate && _this0.taxes) {
            selectedVatRate = _this0.findMatchingVatRate(qp.vatRate.rate || taxRate);
          }
        }
        if (!selectedVatRate && _this0.taxes && _this0.taxes.length > 0) {
          selectedVatRate = _this0.form.orderTax || _this0.taxes[0];
        }
        return {
          id: (_ref3 = (_qp$productID = qp.productID) !== null && _qp$productID !== void 0 ? _qp$productID : (_qp$product = qp.product) === null || _qp$product === void 0 ? void 0 : _qp$product.id) !== null && _ref3 !== void 0 ? _ref3 : qp.id,
          slug: (_ref4 = (_qp$productSlug = qp.productSlug) !== null && _qp$productSlug !== void 0 ? _qp$productSlug : (_qp$product2 = qp.product) === null || _qp$product2 === void 0 ? void 0 : _qp$product2.slug) !== null && _ref4 !== void 0 ? _ref4 : qp.slug,
          name: (_ref5 = (_qp$productName = qp.productName) !== null && _qp$productName !== void 0 ? _qp$productName : (_qp$product3 = qp.product) === null || _qp$product3 === void 0 ? void 0 : _qp$product3.name) !== null && _ref5 !== void 0 ? _ref5 : qp.name,
          code: (_ref6 = (_qp$productCode = qp.productCode) !== null && _qp$productCode !== void 0 ? _qp$productCode : (_qp$product4 = qp.product) === null || _qp$product4 === void 0 ? void 0 : _qp$product4.code) !== null && _ref6 !== void 0 ? _ref6 : qp.code,
          taxType: taxType,
          taxRate: taxRate,
          qty: qty,
          avgPurchasePrice: qp.avgPurchasePrice || ((_qp$product5 = qp.product) === null || _qp$product5 === void 0 ? void 0 : _qp$product5.avgPurchasePrice) || 0,
          unitPrice: unitPrice,
          unitCost: unitPrice,
          ...
          itemType: qp.itemType || ((_qp$product6 = qp.product) === null || _qp$product6 === void 0 ? void 0 : _qp$product6.itemType) || 'product',
          inventoryCount: (_ref7 = (_qp$inventoryCount = qp.inventoryCount) !== null && _qp$inventoryCount !== void 0 ? _qp$inventoryCount : (_qp$product7 = qp.product) === null || _qp$product7 === void 0 ? void 0 : _qp$product7.inventoryCount) !== null && _ref7 !== void 0 ? _ref7 : 0,
          ...
          sales_account_id: ((_qp$product8 = qp.product) === null || _qp$product8 === void 0 ? void 0 : _qp$product8.sales_account_id) || null,
          purchase_account_id: ((_qp$product9 = qp.product) === null || _qp$product9 === void 0 ? void 0 : _qp$product9.purchase_account_id) || null
        };
      });
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _this1.syncDiscountFields();
              _this1.loading = true;
              slug = _this1.$route.params.slug;
              _context7.next = 6;
              return _this1.form.patch(window.location.origin + "/api/quotations/" + slug).then(function (_ref8) {
                var data = _ref8.data;
                toast.fire({
                  type: "success",
                  title: _this1.$t("Quotation updated successfully")
                });
                _this1.$router.push({
                ...
                if ((error === null || error === void 0 || (_error$response2 = error.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 422 && (_error$response3 = error.response) !== null && _error$response3 !== void 0 && (_error$response3 = _error$response3.data) !== null && _error$response3 !== void 0 && _error$response3.errors) {
                  ...
                  var message = (error === null || error === void 0 || (_error$response4 = error.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || _this1.$t("Please check your input and try again.");
                  toast.fire({
                    type: "error",
                    title: message
                  });
            ...
            case 8:
              ...
              _context7.t0 = _context7["catch"](0);
              _this1.loading = false;
              console.error('Quotation update error:', _context7.t0);
              toast.fire({
                type: "error",
                title: _this1.$t("Error"),
                text: _context7.t0.message || _this1.$t("Please check your input and try again.")
              });
            case 13:
            case "end":
              return _context7.stop();
    ...
    showAllInsufficientStock: function showAllInsufficientStock() {
      ...
      insufficientProducts.forEach(function (product, index) {
        ...
        message += "   ".concat(_this10.$t("Required"), ": ").concat(product.qty, ", ").concat(_this10.$t("Available"), ": ").concat(product.inventoryCount, ", ").concat(_this10.$t("Shortage"), ": ").concat(shortage, "\n\n");
      });
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_1e8730bb_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_editvue_type_style_index_0_id_1e8730bb_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_1e8730bb_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/edit.vue?vue&type=style&index=0&id=1e8730bb&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ClientEditModal.vue?vue&type=template&id=2eaec3d9&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
var update = injectStylesIntoStyleTag_default()(ClientEditModalvue_type_style_index_0_id_2eaec3d9_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_ClientEditModalvue_type_style_index_0_id_2eaec3d9_prod_scoped_true_lang_css = (ClientEditModalvue_type_style_index_0_id_2eaec3d9_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/ClientEditModal.vue?vue&type=style&index=0&id=2eaec3d9&prod&scoped=true&lang=css
