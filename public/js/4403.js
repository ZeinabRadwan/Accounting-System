"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4403],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-011c2764]{border:none!important}.client-receivable-table[data-v-011c2764]{border-collapse:separate;border-spacing:0}.client-receivable-table thead th[data-v-011c2764]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.client-receivable-table thead tr[data-v-011c2764]{border:none!important}.client-receivable-table thead th[data-v-011c2764]:first-child{border-top-left-radius:10px}.client-receivable-table thead th[data-v-011c2764]:last-child{border-top-right-radius:10px}[dir=rtl] .client-receivable-table thead th[data-v-011c2764]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .client-receivable-table thead th[data-v-011c2764]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.client-receivable-table thead th.select-col[data-v-011c2764]{text-align:center}.client-receivable-table thead th.select-col .select-box[data-v-011c2764]{display:inline-block;margin:0 auto}.refresh-btn[data-v-011c2764]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-011c2764],.export-pdf-btn[data-v-011c2764],.preview-btn[data-v-011c2764]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-011c2764],.export-pdf-btn[data-v-011c2764],.preview-btn[data-v-011c2764],.print-btn[data-v-011c2764]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-011c2764]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-011c2764]{gap:10px}.card[data-v-011c2764]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-011c2764]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.client-receivable-table .badge.bg-success[data-v-011c2764]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-011c2764]{background:#fff!important}@media (max-width:1300px){.info-box[data-v-011c2764]{padding:0}}", ""]);
// Exports
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ client_receivable_report)
});

;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/client-receivable-report.vue?vue&type=template&id=011c2764&scoped=true
var render = function render() {
  ...
  return _c('div', {
  ...
  })])]) : _vm._e()])])]), _vm._v(" "), _c('table-loading', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.loading,
    ...
    staticClass: "table client-receivable-table"
  }, [_c('thead', [_c('th', {
    staticClass: "select-col text-center"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  })]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Client ID")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Name")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Contact Number")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Email")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Company Name")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice Due")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Non Invoice Due")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Total Due")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))])]), _vm._v(" "), _c('tbody', [_vm._l(_vm.items, function (data, i) {
    return _c('tr', {
      directives: [{
        name: "show",
        rawName: "v-show",
      ...
      domProps: {
        "value": data.id,
        "checked": Array.isArray(_vm.selectedIds) ? _vm._i(_vm.selectedIds, data.id) > -1 : _vm.selectedIds
      },
      on: {
    ...
    })]), _vm._v(" "), _c('td', [_vm.pagination && _vm.pagination.current_page > 1 ? _c('span', [_vm._v("\n                      " + _vm._s(_vm.pagination.per_page * (_vm.pagination.current_page - 1) + (i + 1)) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(i + 1))])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withPrefix")(data.clientID, _vm.clientPrefix)))]), _vm._v(" "), _c('td', [_vm.$can('client-view') ? _c('router-link', {
      attrs: {
        "to": {
          name: 'clients.show',
          params: {
    ...
    }, [_vm._v("\n                      " + _vm._s(data.name) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(data.name))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.phoneNumber))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.email))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.companyName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.clientDue) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.nonInvoiceCurrentDue) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]), _vm._v(" "), _c('td', [_vm._v("\n                    " + _vm._s(data.clientDue + data.nonInvoiceCurrentDue)), _c('span', {
      staticClass: "saudi-riyal"
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/client-receivable-report.vue?vue&type=script&lang=js
...
/* harmony default export */ const client_receivable_reportvue_type_script_lang_js = ({
  middleware: ["auth", "check-permissions"],
  metaInfo: function metaInfo() {
    return {
      title: this.$t("Client Receivable Report")
    };
  },
  data: function data() {
    return {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "loading", "pagination", "appInfo"])), {}, {
    exportUrl: function exportUrl() {
      ...
      return "/client-receivable-report/export/excel?term=".concat(this.query);
    },
    printTemplateUrl: function printTemplateUrl() {
      ...
      return "/print/reports/client-receivable-report".concat(queryString ? '?' + queryString : '');
    }
  }),
  watch: {
    // watch search data
  ...
  methods: {
    ...
    downloadPDF: function downloadPDF() {
      ...
      var queryString = params.toString();
      window.location.href = "/print/reports/client-receivable-report/pdf".concat(queryString ? '?' + queryString : '');
    },
    // preview PDF
    previewPDF: function previewPDF() {
      ...
      var queryString = params.toString();
      window.location.href = "/print/reports/client-receivable-report/preview".concat(queryString ? '?' + queryString : '');
    },
    // print table
    ...
    toggleSelectAll: function toggleSelectAll() {
      if (this.selectAll) {
        this.selectedIds = this.items.map(function (row) {
          return row.id;
        });
      } else {
        this.selectedIds = [];
...
;// ./resources/js/pages/reports/client-receivable-report.vue?vue&type=script&lang=js
 /* harmony default export */ const reports_client_receivable_reportvue_type_script_lang_js = (client_receivable_reportvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/client-receivable-report.vue?vue&type=style&index=0&id=011c2764&prod&scoped=true&lang=css
var client_receivable_reportvue_type_style_index_0_id_011c2764_prod_scoped_true_lang_css = __webpack_require__(18243);
...
var update = injectStylesIntoStyleTag_default()(client_receivable_reportvue_type_style_index_0_id_011c2764_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_client_receivable_reportvue_type_style_index_0_id_011c2764_prod_scoped_true_lang_css = (client_receivable_reportvue_type_style_index_0_id_011c2764_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/client-receivable-report.vue?vue&type=style&index=0&id=011c2764&prod&scoped=true&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  reports_client_receivable_reportvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ const client_receivable_report = (component.exports);
