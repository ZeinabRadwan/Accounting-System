...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-pills .nav-item[data-v-2ccff55a]{background:#ddd;border-radius:.25rem;margin:2px}.equal-sign[data-v-2ccff55a]{color:#007bff;font-weight:700;margin-right:5px}.bg-indigo-light[data-v-2ccff55a]{background-color:#e3f2fd!important}.bg-red-light[data-v-2ccff55a]{background-color:#ffebee!important}.bg-green-light[data-v-2ccff55a]{background-color:#e8f5e8!important}.bg-sub-light[data-v-2ccff55a]{background-color:#f8f9fa!important}.purchases-create-table[data-v-2ccff55a]{border-collapse:collapse;width:100%}.purchases-create-table td[data-v-2ccff55a],.purchases-create-table th[data-v-2ccff55a]{border:1px solid #dee2e6;padding:8px;text-align:center;vertical-align:middle}.purchases-create-table th[data-v-2ccff55a]{background-color:#f8f9fa;font-size:.875rem;font-weight:700}.purchases-create-table tbody tr[data-v-2ccff55a]:hover{background-color:#f8f9fa}.purchases-create-table .quantity-field[data-v-2ccff55a]{text-align:center;width:80px}.purchases-create-table .btn[data-v-2ccff55a]{font-size:.75rem;padding:.25rem .5rem}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/show.vue?vue&type=template&id=2ccff55a&scoped=true
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_2ccff55a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_showvue_type_style_index_0_id_2ccff55a_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_2ccff55a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/show.vue?vue&type=style&index=0&id=2ccff55a&prod&scoped=true&lang=css
