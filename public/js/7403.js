"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7403],{
  ...
  methods: {
    ...
    saveClient: function saveClient(formData) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var hasFiles, requestData, config, fd, appendIfDefined, phoneNumberValue, phoneNumberToSend, _iterator, _step, pair, url, response, _t3, _t4;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            ...
            case 9:
              _context3.p = 9;
              _t4 = _context3.v;
              console.error("Error saving client:", _t4);
              if (window.toast && typeof window.toast.fire === 'function') {
                window.toast.fire({
                  type: "error",
...
var editvue_type_style_index_0_id_c01df8dc_prod_scoped_true_lang_css = __webpack_require__(88850);
