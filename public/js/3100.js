"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3100],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/edit.vue?vue&type=template&id=544e9a40&scoped=true
...
;// ./resources/js/pages/purchases/edit.vue?vue&type=template&id=544e9a40&scoped=true
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              _context.n = 1;
              return axios_default().get(window.location.origin + '/api/purchases/' + _this.$route.params.slug);
            case 1:
              _yield$axios$get = _context.v;
              data = _yield$axios$get.data;
              _this.form.purchaseNo = _this.$options.filters.withPrefix(data.data.purchaseNo, _this.purchasePrefix);
              _this.form.supplier = data.data.supplier;
              _this.form.poReference = data.data.poReference;
              _this.form.transportCost = data.data.transport;
              _this.form.totalTax = data.data.tax;
              _this.form.orderTax = data.data.taxType || null;
              _this.form.discount = data.data.totalDiscount;
              _this.form.paymentTerms = data.data.paymentTerms;
              _this.form.poDate = data.data.poDate;
              _this.form.purchaseDate = data.data.purchaseDate;
              _this.form.purchaseReturnData = data.data.purchaseReturn;
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            ...
            case 1:
              ...
              if (_this5.form.supplier && _this5.items && _this5.items.length > 0) {
                updatedSupplier = _this5.items.find(function (s) {
                  return s.id === _this5.form.supplier.id;
                });
                if (updatedSupplier) {
                  _this5.form.supplier = updatedSupplier;
                }
              }
              _context5.n = 4;
              break;
            ...
            case 3:
              ...
              if (_this5.form.selectedProducts && _this5.form.selectedProducts.length > 0) {
                _this5.form.selectedProducts.forEach(function (selectedProduct) {
                  var updatedProduct = _this5.products.find(function (p) {
                    return p.id === selectedProduct.id;
                  });
                  if (updatedProduct) {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 1:
              ...
              _context6.p = 2;
              _context6.n = 3;
              return axios_default().post("/api/suppliers/".concat(_this6.form.supplier.slug, "/auto-assign-chart-of-account"));
            case 3:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            case 0:
              _context8.n = 1;
              return _this9.form.patch(window.location.origin + '/api/purchases/' + _this9.$route.params.slug).then(function (_ref) {
                var data = _ref.data;
                toast.fire({
                  type: 'success',
                  title: _this9.$t('Purchase updated successfully')
                });
                _this9.$router.push({
                  name: 'purchases.show',
                  params: {
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_544e9a40_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_editvue_type_style_index_0_id_544e9a40_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_544e9a40_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/edit.vue?vue&type=style&index=0&id=544e9a40&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-544e9a40]{gap:10px}.btn-group.c-w-100>.btn[data-v-544e9a40]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-544e9a40]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-544e9a40]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-544e9a40]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-544e9a40]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-544e9a40]{background:#f1f5fb!important}.btn-primary[data-v-544e9a40]{background:#2ab930!important}.btn-primary[data-v-544e9a40],.btn-secondary[data-v-544e9a40]{border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-544e9a40]{background:#33a0d9!important}.create-btn[data-v-544e9a40]{padding:11px}.supplier-status[data-v-544e9a40]{font-size:13px}.supplier-success[data-v-544e9a40],.supplier-warning[data-v-544e9a40]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.supplier-warning[data-v-544e9a40]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.supplier-success[data-v-544e9a40]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.product-status[data-v-544e9a40]{font-size:13px}.product-success[data-v-544e9a40],.product-warning[data-v-544e9a40]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-544e9a40]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-544e9a40]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-544e9a40]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-544e9a40]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-544e9a40]:disabled{cursor:not-allowed;opacity:.6}", ""]);
// Exports
