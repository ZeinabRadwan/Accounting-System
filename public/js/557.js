...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/clients/invoice/create.vue?vue&type=template&id=2342aab7&scoped=true
  ...
  methods: {
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var _yield$axios$post, data, newAccountId, idx, _error$response, message, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 3:
              ...
              message = (_t === null || _t === void 0 || (_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || (_t === null || _t === void 0 ? void 0 : _t.message);
    ...
    handleQueryParams: function handleQueryParams() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var invoiceSlug, clientSlugOrId, client, invoice, _t2;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 6:
              _context6.p = 6;
              _t2 = _context6.v;
              console.error('Error handling query params:', _t2);
            case 7:
...
;// ./resources/js/pages/payments/clients/invoice/create.vue?vue&type=style&index=0&id=2342aab7&prod&scoped=true&lang=css
