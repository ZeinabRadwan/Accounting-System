...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=049a3122&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
...
;// ./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=049a3122&scoped=true
  ...
  methods: {
    ...
    assignProducts: function assignProducts(quotationProducts) {
      ...
      var _loop = function _loop() {
        ...
        var vatRate = _this0.taxes ? _this0.taxes.find(function (tax) {
        ...
        if (vatRate && quotationProduct.vat_rate_id) {
          ...
          productTax = _this0.roundToTwoDecimals(totalAfterDiscount * vatRate.rate / 100);
          totalTax = _this0.roundToTwoDecimals(productTax);
          totalPrice = _this0.roundToTwoDecimals(totalAfterDiscount + totalTax);
        } else {
          ...
          if (existingTaxAmount > 0 && _totalAfterDiscount > 0) {
            ...
            var calculatedVatRate = _this0.roundToTwoDecimals(existingTaxAmount / _totalAfterDiscount * 100);

            // Find matching VAT rate or create a temporary one
            var matchingVatRate = _this0.taxes ? _this0.taxes.find(function (tax) {
              return Math.abs(tax.rate - calculatedVatRate) < 0.01;
            }) : null;
            if (!matchingVatRate && _this0.taxes && _this0.taxes.length > 0) {
              // Use the closest VAT rate
              matchingVatRate = _this0.taxes.reduce(function (closest, current) {
            ...
            if (matchingVatRate) {
              productTax = _this0.roundToTwoDecimals(_totalAfterDiscount * matchingVatRate.rate / 100);
              totalTax = _this0.roundToTwoDecimals(productTax);
              totalPrice = _this0.roundToTwoDecimals(_totalAfterDiscount + totalTax);
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              ...
              event.preventDefault();
              _this1.showPaymentValidationErrors();
              return _context7.a(2);
            case 2:
              _context7.n = 3;
              return _this1.saveInvoice();
            case 3:
              _context7.p = 3;
    ...
    saveInvoice: function saveInvoice() {
      var _this10 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var validationErrors, productsWithoutSalesAccount, productNames, productsWithoutVatRate, _productNames, paymentValidation, _t2;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              _context8.p = 0;
              ...
              productsWithoutVatRate = _this10.form.selectedProducts.filter(function (product) {
              ...
              if (productsWithoutVatRate.length > 0) {
                ...
                validationErrors.push({
                  type: "warning",
                  title: _this10.$t("Product VAT Rate Required"),
                  message: _this10.$t("The following products must have a VAT rate assigned: ") + _productNames,
                  field: "products",
                  timer: 8000,
                  timerProgressBar: true
                });
            ...
            case 1:
              _context8.n = 2;
              return _this10.form.post(window.location.origin + '/api/invoices').then(function () {
                toast.fire({
                  type: 'success',
                  title: _this10.$t('Invoice created successfully')
                });
                _this10.$router.push({
                  name: 'invoices.index'
                });
            ...
            case 3:
              _context8.p = 3;
              _t2 = _context8.v;
              console.error('Unexpected error:', _t2);
              toast.fire({
                type: 'error',
                title: _this10.$t('Please check your input and try again.')
              });
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      var _this11 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var response, newAccountId, idx, errorMessage, _error$response$data, _t3;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              if (_this11.form.client) {
                _context9.n = 1;
                break;
              }
              return _context9.a(2);
            case 1:
              if (_this11.form.client.slug) {
                _context9.n = 2;
                break;
              }
              toast.fire({
                ...
                text: _this11.$t('Client missing required information. Please refresh and try again.')
              });
              return _context9.a(2);
            case 2:
              ...
              _context9.p = 3;
              _context9.n = 4;
              return axios_default().post(window.location.origin + '/api/clients/' + _this11.form.client.slug + '/auto-assign-chart-of-account');
            case 4:
              ...
              if (response && response.data && response.data.success) {
                ...
                if (newAccountId) {
                  ...
                  idx = _this11.items.findIndex(function (i) {
                    return i.slug === _this11.form.client.slug;
                  });
                  if (idx !== -1) {
                ...
                toast.fire({
                  ...
                  text: response && response.data && response.data.message || _this11.$t('Please try again')
                });
              }
              _context9.n = 6;
              break;
            case 5:
              _context9.p = 5;
              _t3 = _context9.v;
              console.error('Error assigning client chart of account:', _t3);
              errorMessage = _this11.$t('Failed to assign Chart of Account. Please try again.');
              if (_t3 && _t3.response) {
                errorMessage = ((_error$response$data = _t3.response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message) || _t3.message || errorMessage;
              } else if (_t3 && _t3.message) {
    ...
    autoAssignAllProductsChartOfAccount: function autoAssignAllProductsChartOfAccount() {
      var _this12 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var productsWithoutSalesAccount, _iterator, _step, _loop2, errorMessage, _error$response$data2, _t4, _t5;
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 1:
              _this12.isAutoAssigningProduct = true;
              _context1.p = 2;
              ...
              toast.fire({
                type: 'info',
                title: _this12.$t('All products already have sales accounts assigned')
              });
              return _context1.a(2);
            case 3:
                  ...
                  while (1) switch (_context0.n) {
                    ...
                    case 2:
                      ...
                      if (response.data && response.data.success) {
                        ...
                        productIndex = _this12.products.findIndex(function (p) {
                          return p.id === product.id;
                        });
                        if (productIndex !== -1) {
                          _this12.$set(_this12.products[productIndex], 'sales_account_id', response.data.sales_account_id);
                        }
                      }
                    case 3:
                      return _context0.a(2);
            ...
            case 5:
              ...
              return _context1.d(_regeneratorValues(_loop2()), 6);
            case 6:
              if (!_context1.v) {
                _context1.n = 7;
                break;
            ...
            case 11:
              toast.fire({
                type: 'success',
                title: _this12.$t('Chart of Accounts assigned successfully')
              });
              _context1.n = 13;
              break;
            case 12:
              _context1.p = 12;
              _t5 = _context1.v;
              console.error('Error assigning product chart of accounts:', _t5);
              errorMessage = _this12.$t('Failed to assign Chart of Accounts. Please try again.');
              if (_t5 && _t5.response) {
                errorMessage = ((_error$response$data2 = _t5.response.data) === null || _error$response$data2 === void 0 ? void 0 : _error$response$data2.message) || _t5.message || errorMessage;
              } else if (_t5 && _t5.message) {
                errorMessage = _t5.message;
              }
              toast.fire({
                type: 'error',
                title: _this12.$t('Error'),
                text: errorMessage
              });
            case 13:
              _context1.p = 13;
        ...
        }, _callee0, null, [[4, 9, 10, 11], [2, 12, 13, 14]]);
      }))();
    },
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            ...
            case 1:
              ...
              toast.fire({
                type: 'info',
                title: _this13.$t('Feature Not Available'),
                text: _this13.$t('Auto-assign for bank accounts is not yet available. Please assign Chart of Account manually.')
              });
            case 2:
              return _context10.a(2);
          }
    ...
    getQuotationProductVatRates: function getQuotationProductVatRates() {
      ...
      return this.form.selectedProducts.map(function (product, index) {
        var vatRate = _this15.taxes ? _this15.taxes.find(function (tax) {
    ...
    recalculateAllProductsVat: function recalculateAllProductsVat() {
      ...
      this.form.selectedProducts.forEach(function (item, index) {
        ...
        item.totalBeforeDiscount = _this16.roundToTwoDecimals(item.unitPrice * item.qty);
        item.totalAfterDiscount = _this16.roundToTwoDecimals(item.totalBeforeDiscount - (item.discountAmount || 0));

        // Find the VAT rate object based on vat_rate_id
        var selectedVatRate = _this16.taxes ? _this16.taxes.find(function (tax) {
          return tax.id === item.vat_rate_id;
        }) : null;
        ...
        if (selectedVatRate && selectedVatRate.rate) {
          ...
          item.productTax = _this16.roundToTwoDecimals(item.totalAfterDiscount * vatRate / 100);
          item.totalTax = _this16.roundToTwoDecimals(item.productTax);
          item.totalPrice = _this16.roundToTwoDecimals(item.totalAfterDiscount + item.totalTax);
        ...
        // Update the item in the array
        _this16.$set(_this16.form.selectedProducts, index, item);
      });
    ...
    forceUpdateVatRateSelection: function forceUpdateVatRateSelection() {
      ...
      this.form.selectedProducts.forEach(function (item, index) {
        if (item.vat_rate_id) {
          ...
          var matchingVatRate = _this17.taxes.find(function (tax) {
            return tax.id === item.vat_rate_id;
          });
          if (matchingVatRate) {
            // Update the selectedVatRate object
            _this17.$set(_this17.form.selectedProducts[index], 'selectedVatRate', matchingVatRate);

            // Recalculate VAT with the correct rate
            var vatRate = matchingVatRate.rate;
            item.productTax = _this17.roundToTwoDecimals(item.totalAfterDiscount * vatRate / 100);
            item.totalTax = _this17.roundToTwoDecimals(item.productTax);
            item.totalPrice = _this17.roundToTwoDecimals(item.totalAfterDiscount + item.totalTax);

            // Update the item
            _this17.$set(_this17.form.selectedProducts, index, item);
          }
        }
      });
...
;// ./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=049a3122&prod&lang=scss&scoped=true
