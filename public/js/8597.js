"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8597],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/account-statement.vue?vue&type=template&id=185d4ea8&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    staticClass: "form-group"
  }, [_c('label', [_vm._v(_vm._s(_vm.$t('Cost Center')))]), _vm._v(" "), _c('v-select', {
    attrs: {
    ...
    model: {
      value: _vm.filters.costCenter,
      callback: function callback($$v) {
        _vm.$set(_vm.filters, "costCenter", $$v);
      },
      expression: "filters.costCenter"
    }
  })], 1)]), _vm._v(" "), _c('div', {
    staticClass: "col-12"
  }, [_c('div', {
...
;// ./resources/js/pages/reports/account-statement.vue?vue&type=template&id=185d4ea8&scoped=true
...
/* harmony default export */ const account_statementvue_type_script_lang_js = ({
  ...
  data: function data() {
    return _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
      ...
      subChartOfAccounts: [],
      costCenters: []
    }, "loadingCostCenters", false), "currentChunk", 1), "chunkSize", 30), "hasMoreData", true), "loadingMore", false), "retryCount", 0), "maxRetries", 3);
  },
  ...
  methods: {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              ...
              _this3.loadingCostCenters = true;
              _context3.p = 1;
              _context3.n = 2;
            ...
            case 2:
              ...
              if (response.data && Array.isArray(response.data)) {
                _this3.costCenters = response.data;
            ...
            case 3:
              _context3.p = 3;
              _t2 = _context3.v;
              console.error('Error loading cost centers:', _t2);
              _this3.$toast.error('', _this3.$t('Failed to load cost centers'));
              _this3.costCenters = [];
            case 4:
              _context3.p = 4;
              _this3.loadingCostCenters = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              _context4.n = 1;
              return _this4.loadChartOfAccounts(search);
            case 1:
    ...
    searchCostCenters: function searchCostCenters(search) {
      var _this5 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              _context5.n = 1;
              return _this5.loadCostCenters(search);
            case 1:
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              ...
              _this6.filters.subChartOfAccount = null;
              _this6.subChartOfAccounts = [];
              if (!accountId) {
                _context6.n = 1;
                break;
              }
              _context6.n = 1;
              return _this6.loadSubChartOfAccounts(accountId);
            case 1:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              search = _arguments3.length > 1 && _arguments3[1] !== undefined ? _arguments3[1] : '';
              _this7.loadingSubAccounts = true;
              _context7.p = 1;
              _context7.n = 2;
            ...
            case 2:
              ...
              if (response.data.success) {
                _this7.subChartOfAccounts = response.data.data;
              }
              _context7.n = 4;
              break;
            case 3:
              _context7.p = 3;
              _t3 = _context7.v;
              console.error('Error loading sub chart of accounts:', _t3);
              _this7.$toast.error('', _this7.$t('Failed to load sub chart of accounts'));
            case 4:
              _context7.p = 4;
              _this7.loadingSubAccounts = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            case 0:
              if (!(search && _this8.filters.chartOfAccount)) {
                _context8.n = 1;
                break;
              }
              _context8.n = 1;
              return _this8.loadSubChartOfAccounts(_this8.filters.chartOfAccount, search);
            case 1:
    ...
    generateReport: function generateReport() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var _error$response, errorMessage, _t4;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              if (_this9.filters.chartOfAccount) {
                _context9.n = 1;
                break;
              }
              _this9.$toast.error('', _this9.$t('Please select a chart of account'));
              return _context9.a(2);
            case 1:
              if (!(!_this9.filters.fromDate || !_this9.filters.toDate)) {
                _context9.n = 2;
                break;
              }
              _this9.$toast.error('', _this9.$t('Please select date range'));
              return _context9.a(2);
            case 2:
              _this9.loading = true;
              _this9.loadingEntries = true;
              _this9.errors = {};
              _this9.allEntries = []; // Initialize before calling loadNextChunk
              _this9.currentChunk = 1;
              _this9.hasMoreData = true;
              _this9.retryCount = 0;
              _context9.p = 3;
              _context9.n = 4;
              return _this9.loadNextChunk();
            case 4:
              _this9.$toast.success('', _this9.$t('Report generated successfully'));
              _context9.n = 6;
              break;
            case 5:
              _context9.p = 5;
              _t4 = _context9.v;
              console.error('Generate report error:', _t4);
              if (_t4.response && _t4.response.data && _t4.response.data.errors) {
                _this9.errors = _t4.response.data.errors;
              }
              errorMessage = ((_error$response = _t4.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _t4.message || _this9.$t('Failed to generate report');
              _this9.$toast.error('', errorMessage);
            case 6:
              _context9.p = 6;
              _this9.loading = false;
              _this9.loadingEntries = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            case 0:
              if (!(!_this0.hasMoreData || _this0.loadingMore)) {
                _context0.n = 1;
                break;
              }
              return _context0.a(2);
            case 1:
              _this0.loadingMore = true;
              _this0.retryCount = 0;
              _context0.p = 2;
              _context0.n = 3;
              return _this0.loadChunkWithRetry();
            case 3:
              _context0.p = 3;
              _this0.loadingMore = false;
          ...
          while (1) switch (_context10.n) {
            case 0:
              ...
              _loop = /*#__PURE__*/_regenerator().m(function _loop() {
                var params, response, data, pagination, delay, _t5;
                return _regenerator().w(function (_context1) {
                  while (1) switch (_context1.p = _context1.n) {
                    case 0:
                      _context1.p = 0;
                      console.log("Loading chunk ".concat(_this1.currentChunk, ", attempt ").concat(attempt));
                      params = {
                        chart_of_account_id: _this1.filters.chartOfAccount,
                        page: _this1.currentChunk,
                        per_page: _this1.chunkSize
                      };
                      if (_this1.filters.subChartOfAccount) {
                        params.sub_chart_of_account_id = _this1.filters.subChartOfAccount;
                      }
                      if (_this1.filters.costCenter) {
                        params.cost_center_id = _this1.filters.costCenter;
                      }
                      params.from_date = _this1.filters.fromDate;
                      params.to_date = _this1.filters.toDate;
                      _context1.n = 1;
                    ...
                    case 1:
                      ...
                      if (_this1.currentChunk === 1) {
                        _this1.reportData = {
                          chart_of_account: data.chart_of_account,
                          report_account: data.report_account,
                          filters: data.filters
                        };
                        _this1.summary = data.summary;
                      }

                      // Add new entries to the list
                      if (data.entries && data.entries.length > 0) {
                        // Ensure allEntries is always an array
                        if (!Array.isArray(_this1.allEntries)) {
                          _this1.allEntries = [];
                        }
                        _this1.allEntries = [].concat(_toConsumableArray(_this1.allEntries), _toConsumableArray(data.entries));
                      }

                      // Check if there's more data
                      pagination = data.pagination;
                      _this1.hasMoreData = pagination.has_more;
                      if (_this1.hasMoreData) {
                        _this1.currentChunk++;
                        // Automatically load next chunk after a short delay
                        setTimeout(function () {
                          _this1.loadNextChunk();
                        }, 100);
                      }
                      console.log("Chunk ".concat(_this1.currentChunk - 1, " loaded successfully. Total entries: ").concat(_this1.allEntries ? _this1.allEntries.length : 0));
                    ...
                    case 2:
                      ...
                      throw new Error(response.data.message || _this1.$t('Failed to load chunk'));
                    case 3:
                      throw new Error(_this1.$t('Failed to load chunk'));
                    case 4:
                      _context1.n = 6;
                      break;
                    case 5:
                      ...
                      _t5 = _context1.v;
                      lastError = _t5;
                      console.error("Chunk ".concat(_this1.currentChunk, " attempt ").concat(attempt, " failed:"), _t5);
                      if (!(attempt < _this1.maxRetries)) {
                        _context1.n = 6;
                        break;
                      }
            ...
            case 1:
              ...
              return _context10.d(_regeneratorValues(_loop()), 2);
            case 2:
              _ret = _context10.v;
              if (!_ret) {
                _context10.n = 3;
              ...
              return _context10.a(2, _ret.v);
            case 3:
              attempt++;
              _context10.n = 1;
              break;
            case 4:
              throw new Error("Failed to load chunk ".concat(_this1.currentChunk, " after ").concat(_this1.maxRetries, " attempts: ").concat(((_lastError = lastError) === null || _lastError === void 0 ? void 0 : _lastError.message) || 'Unknown error'));
            case 5:
...
var update = injectStylesIntoStyleTag_default()(account_statementvue_type_style_index_0_id_185d4ea8_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_account_statementvue_type_style_index_0_id_185d4ea8_prod_scoped_true_lang_css = (account_statementvue_type_style_index_0_id_185d4ea8_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/account-statement.vue?vue&type=style&index=0&id=185d4ea8&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-185d4ea8]{border:none!important}.account-statement-table[data-v-185d4ea8]{border-collapse:separate;border-spacing:0}.account-statement-table thead th[data-v-185d4ea8]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.account-statement-table thead tr[data-v-185d4ea8]{border:none!important}.account-statement-table thead th[data-v-185d4ea8]:first-child{border-top-left-radius:10px}.account-statement-table thead th[data-v-185d4ea8]:last-child{border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-185d4ea8]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .account-statement-table thead th[data-v-185d4ea8]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-185d4ea8]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-185d4ea8],.export-pdf-btn[data-v-185d4ea8]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-185d4ea8],.export-pdf-btn[data-v-185d4ea8],.print-btn[data-v-185d4ea8]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-185d4ea8]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-185d4ea8]{gap:10px}.card[data-v-185d4ea8]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-185d4ea8]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.overlay[data-v-185d4ea8]{background-color:rgba(0,0,0,.5);height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.info-box[data-v-185d4ea8],.overlay[data-v-185d4ea8]{align-items:center;display:flex}.info-box[data-v-185d4ea8]{background:#fff;border:1px solid #dee2e6;border-radius:.25rem;margin-bottom:1rem;padding:1rem}.info-box-icon[data-v-185d4ea8]{align-items:center;border-radius:50%;display:flex;height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-185d4ea8]{flex:1}.info-box-text[data-v-185d4ea8]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-185d4ea8]{color:#495057;display:block;font-size:1.25rem;font-weight:700}.table th[data-v-185d4ea8]{border-top:1px solid #dee2e6}.pagination[data-v-185d4ea8]{margin-bottom:0}.dataTables_info[data-v-185d4ea8]{color:#6c757d;padding-bottom:.75rem;padding-top:.75rem}.dataTables_paginate[data-v-185d4ea8]{text-align:right}.btn-primary[data-v-185d4ea8]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}@media (max-width:1300px){.info-box[data-v-185d4ea8]{padding:0}}", ""]);
// Exports
