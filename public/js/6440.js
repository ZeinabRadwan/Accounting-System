...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card-icon.bg-brand-primary[data-v-534163d9]{background:linear-gradient(135deg,#33a0d9,#2a8bc7)!important;border:1px solid rgba(51,160,217,.3);border-radius:20px}.card-icon.bg-brand-light-blue[data-v-534163d9]{background:linear-gradient(135deg,#ebf6fc,#d6edf7)!important;border:1px solid rgba(235,246,252,.5);border-radius:20px;color:#1b3c71!important}.card-icon.bg-brand-light-green[data-v-534163d9]{background:linear-gradient(135deg,#f6fef4,#e8f5e8)!important;border:1px solid rgba(246,254,244,.5);border-radius:20px;color:#1b3c71!important}.card-icon.bg-brand-green[data-v-534163d9]{background:linear-gradient(135deg,#2ab930,#239a26)!important;border:1px solid rgba(42,185,48,.3);border-radius:20px}.card-icon.bg-brand-dark-blue[data-v-534163d9]{background:linear-gradient(135deg,#1b3c71,#152a4a)!important;border:1px solid rgba(27,60,113,.3);border-radius:20px}.card-icon.bg-brand-teal[data-v-534163d9]{background:linear-gradient(135deg,#449eae,#3a8a98)!important;border:1px solid rgba(68,158,174,.3);border-radius:20px}.card-icon.bg-brand-dark-teal[data-v-534163d9]{background:linear-gradient(135deg,#377578,#2d5f61)!important;border:1px solid rgba(55,117,120,.3);border-radius:20px}.card-icon.bg-brand-light-blue i[data-v-534163d9],.card-icon.bg-brand-light-green i[data-v-534163d9]{color:#1b3c71!important}.card-icon.bg-brand-dark-blue i[data-v-534163d9],.card-icon.bg-brand-dark-teal i[data-v-534163d9],.card-icon.bg-brand-green i[data-v-534163d9],.card-icon.bg-brand-primary i[data-v-534163d9],.card-icon.bg-brand-teal i[data-v-534163d9]{color:#fff!important}.card[data-v-534163d9]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-534163d9]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-534163d9]{padding:1.25rem}.card-footer[data-v-534163d9]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.card-cta i[data-v-534163d9],.card-cta:hover i[data-v-534163d9]{color:inherit!important}.set-up-page .card.card-large-icons[data-v-534163d9]{min-height:200px}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/index.vue?vue&type=template&id=534163d9&scoped=true
...
;// ./resources/js/pages/setup/index.vue?vue&type=template&id=534163d9&scoped=true
...
var update = injectStylesIntoStyleTag_default()(setupvue_type_style_index_0_id_534163d9_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_setupvue_type_style_index_0_id_534163d9_prod_scoped_true_lang_css = (setupvue_type_style_index_0_id_534163d9_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/setup/index.vue?vue&type=style&index=0&id=534163d9&prod&scoped=true&lang=css
