(self["webpackChunk"] = self["webpackChunk"] || []).push([[9670],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-f73ceefc]{border:none!important;overflow:visible!important}.transfer-balances-table[data-v-f73ceefc]{border-collapse:separate;border-spacing:0}.transfer-balances-table thead th[data-v-f73ceefc]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.transfer-balances-table thead tr[data-v-f73ceefc]{border:none!important}.transfer-balances-table thead th[data-v-f73ceefc]:first-child{border-top-left-radius:10px}.transfer-balances-table thead th[data-v-f73ceefc]:last-child{border-top-right-radius:10px}[dir=rtl] .transfer-balances-table thead th[data-v-f73ceefc]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .transfer-balances-table thead th[data-v-f73ceefc]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-f73ceefc]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-f73ceefc],.export-pdf-btn[data-v-f73ceefc]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-f73ceefc],.export-pdf-btn[data-v-f73ceefc],.print-btn[data-v-f73ceefc]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-f73ceefc]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-f73ceefc]{display:inline-block;position:relative}.action-icon-btn[data-v-f73ceefc]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-f73ceefc]{animation:slideInDown-f73ceefc .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-f73ceefc]{left:45px!important;right:auto!important}@keyframes slideInDown-f73ceefc{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-f73ceefc]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-f73ceefc]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-f73ceefc]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-f73ceefc]:hover{background-color:#e5e7eb}.action-menu ul[data-v-f73ceefc]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-f73ceefc]{margin:0}.action-menu li a[data-v-f73ceefc]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-f73ceefc]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-f73ceefc]{flex-shrink:0;height:16px;width:16px}.btn-group.c-w-100[data-v-f73ceefc]{gap:10px}.card[data-v-f73ceefc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-f73ceefc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.transfer-balances-table .badge.bg-success[data-v-f73ceefc]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.transfer-balances-table .badge.bg-danger[data-v-f73ceefc]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-f73ceefc]{background:#fff!important}.btn-primary[data-v-f73ceefc]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cashbook/transfer-balances/index.vue?vue&type=template&id=f73ceefc&scoped=true
...
var update = injectStylesIntoStyleTag_default()(transfer_balancesvue_type_style_index_0_id_f73ceefc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const cashbook_transfer_balancesvue_type_style_index_0_id_f73ceefc_prod_scoped_true_lang_css = (transfer_balancesvue_type_style_index_0_id_f73ceefc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/cashbook/transfer-balances/index.vue?vue&type=style&index=0&id=f73ceefc&prod&scoped=true&lang=css
