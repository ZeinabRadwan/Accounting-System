...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=b74d79bc&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=b74d79bc&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_b74d79bc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_createvue_type_style_index_0_id_b74d79bc_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_b74d79bc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=style&index=0&id=b74d79bc&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-b74d79bc]{margin-bottom:15px}.footer-buttons[data-v-b74d79bc]{display:flex;gap:10px}.footer-buttons .btn[data-v-b74d79bc]{margin-right:10px}.footer-buttons .btn[data-v-b74d79bc]:last-child{margin-right:0}.create-btn[data-v-b74d79bc]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-b74d79bc]:hover{background-color:#e9ecef}.edit-btn[data-v-b74d79bc]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-b74d79bc]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-b74d79bc]{border:none!important}.quotations-create-table[data-v-b74d79bc]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-b74d79bc]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-b74d79bc]{border:none!important}.quotations-create-table thead th[data-v-b74d79bc]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-b74d79bc]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-b74d79bc]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-b74d79bc]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-b74d79bc]{gap:10px}.card[data-v-b74d79bc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-b74d79bc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-b74d79bc]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-b74d79bc]{background:#fff!important}.btn-primary[data-v-b74d79bc]{background:#2ab930!important}.btn-secondary[data-v-b74d79bc]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-b74d79bc]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-b74d79bc],.button-plus[data-v-b74d79bc]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-b74d79bc]{background-color:#dc3545;color:#fff}.button-plus[data-v-b74d79bc]{background-color:#007bff;color:#fff}.button-minus[data-v-b74d79bc]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-b74d79bc]:hover{background-color:#0056b3;transform:scale(1.05)}.quantity-field[data-v-b74d79bc]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-b74d79bc]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-b74d79bc]{direction:rtl}[dir=rtl] .create-btn[data-v-b74d79bc]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-b74d79bc]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-b74d79bc]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-b74d79bc]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-b74d79bc]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-b74d79bc]{border-right:1px solid #ced4da}.clickable-badge[data-v-b74d79bc]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-b74d79bc]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-b74d79bc]:active{transform:scale(.95)}.insufficient-stock-input[data-v-b74d79bc]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-b74d79bc]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-b74d79bc]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-b74d79bc]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-b74d79bc]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-b74d79bc]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-b74d79bc]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-b74d79bc]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-b74d79bc]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-b74d79bc]:last-child{border-bottom:none}.debug-display[data-v-b74d79bc]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-b74d79bc]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-b74d79bc]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-b74d79bc]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-b74d79bc]:last-child{border-bottom:none}.debug-panel .table th[data-v-b74d79bc]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-b74d79bc]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-b74d79bc]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-b74d79bc]{padding:15px}.debug-item .row[data-v-b74d79bc]{margin:0}.debug-item .col-md-6[data-v-b74d79bc]{padding:0 5px}.debug-step[data-v-b74d79bc]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-b74d79bc]{font-size:.75em}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
