"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6891],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-315c3418]{border:none!important;overflow:visible!important}.analytical-accounts-table[data-v-315c3418]{border-collapse:separate;border-spacing:0}.analytical-accounts-table thead th[data-v-315c3418]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.analytical-accounts-table thead tr[data-v-315c3418]{border:none!important}.analytical-accounts-table thead th[data-v-315c3418]:first-child{border-top-left-radius:10px}.analytical-accounts-table thead th[data-v-315c3418]:last-child{border-top-right-radius:10px}[dir=rtl] .analytical-accounts-table thead th[data-v-315c3418]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .analytical-accounts-table thead th[data-v-315c3418]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.action-dropdown[data-v-315c3418]{display:inline-block;position:relative}.action-icon-btn[data-v-315c3418]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-315c3418]{animation:slideInDown-315c3418 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-315c3418]{left:45px!important;right:auto!important}@keyframes slideInDown-315c3418{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-315c3418]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-315c3418]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-315c3418]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-315c3418]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-315c3418]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-315c3418]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-315c3418]:last-child{border-bottom:none}.action-menu li a[data-v-315c3418]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-315c3418]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-315c3418]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-315c3418]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-315c3418]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-315c3418]{gap:10px}.card[data-v-315c3418]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-315c3418]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.btn-primary[data-v-315c3418]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/analytical-accounts/index.vue?vue&type=template&id=315c3418&scoped=true
...
var update = injectStylesIntoStyleTag_default()(analytical_accountsvue_type_style_index_0_id_315c3418_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const setup_analytical_accountsvue_type_style_index_0_id_315c3418_prod_scoped_true_lang_css = (analytical_accountsvue_type_style_index_0_id_315c3418_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/setup/analytical-accounts/index.vue?vue&type=style&index=0&id=315c3418&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/analytical-accounts/index.vue?vue&type=style&index=1&id=315c3418&prod&lang=css
var analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css = __webpack_require__(44726);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/analytical-accounts/index.vue?vue&type=style&index=1&id=315c3418&prod&lang=css

            

var analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css_options = {};

analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css_options.insert = "head";
analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css_options.singleton = false;

var analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css_update = injectStylesIntoStyleTag_default()(analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css/* default */.A, analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css_options);



/* harmony default export */ const setup_analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css = (analytical_accountsvue_type_style_index_1_id_315c3418_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/setup/analytical-accounts/index.vue?vue&type=style&index=1&id=315c3418&prod&lang=css
