"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2947],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-2a8bd16b]{border:none!important}.returns-create-table[data-v-2a8bd16b]{border-collapse:separate;border-spacing:0}.returns-create-table thead th[data-v-2a8bd16b]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.returns-create-table thead tr[data-v-2a8bd16b]{border:none!important}.returns-create-table thead th[data-v-2a8bd16b]:first-child{border-top-left-radius:10px}.returns-create-table thead th[data-v-2a8bd16b]:last-child{border-top-right-radius:10px}[dir=rtl] .returns-create-table thead th[data-v-2a8bd16b]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .returns-create-table thead th[data-v-2a8bd16b]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-2a8bd16b]{gap:10px}.card[data-v-2a8bd16b]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-2a8bd16b]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.returns-create-table .badge.badge-info[data-v-2a8bd16b]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-2a8bd16b]{background:#fff!important}.btn-primary[data-v-2a8bd16b]{background:#2ab930!important}.btn-info[data-v-2a8bd16b],.btn-secondary[data-v-2a8bd16b]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=template&id=2a8bd16b&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('div', {
    ...
    }, [_vm._v(_vm._s(item.unitCost) + " "), _c('span', {
    ...
    }, [_vm._v("\n                          " + _vm._s(item.discountType === 'percentage' ? item.productDiscount + '%' : item.productDiscount) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])]) : _c('span', {
    ...
    }, [_vm._v("\n                        " + _vm._s(item.returnTotal) + " "), _c('span', {
      staticClass: "saudi-riyal"
    }, [_vm._v("ê")])])]);
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm._f("withCurrency")(_vm.form.invoice.subTotal)))])]), _vm._v(" "), _c('td', {
    staticClass: "text-right"
  }, [_c('strong', [_vm._v(_vm._s(_vm.form.totalReturn) + " "), _c('span', {
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])])])]) : _vm._e()], 2)])])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "row",
    attrs: {
      "id": "input-fields"
    }
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_2a8bd16b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_2a8bd16b_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_2a8bd16b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=0&id=2a8bd16b&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=2a8bd16b&prod&scoped=true&lang=css
var createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css = __webpack_require__(21596);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=2a8bd16b&prod&scoped=true&lang=css

            

var createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css_options = {};

createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css_options.insert = "head";
createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css_options.singleton = false;

var createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css_update = injectStylesIntoStyleTag_default()(createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css/* default */.A, createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css_options);



/* harmony default export */ const returns_createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css = (createvue_type_style_index_1_id_2a8bd16b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/create.vue?vue&type=style&index=1&id=2a8bd16b&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-2a8bd16b]{margin-bottom:15px}.footer-buttons[data-v-2a8bd16b]{display:flex;gap:10px}.footer-buttons .btn[data-v-2a8bd16b]{margin-right:10px}.footer-buttons .btn[data-v-2a8bd16b]:last-child{margin-right:0}.badge[data-v-2a8bd16b]{border-radius:.25rem;display:inline-block;font-size:75%;font-weight:700;line-height:1;padding:.25em .4em;text-align:center;vertical-align:baseline;white-space:nowrap}.badge-info[data-v-2a8bd16b]{background-color:#33a0d9;color:#fff}.text-muted[data-v-2a8bd16b]{color:#6c757d!important}.account-status[data-v-2a8bd16b]{font-size:.875rem;.account-warning[data-v-2a8bd16b]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404}.account-success[data-v-2a8bd16b],.account-warning[data-v-2a8bd16b]{align-items:center;display:flex;padding:.5rem}.account-success[data-v-2a8bd16b]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
