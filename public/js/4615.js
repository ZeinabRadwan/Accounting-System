"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4615,6694],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-97152310]{margin-bottom:15px}.footer-buttons[data-v-97152310]{display:flex;gap:10px}.footer-buttons .btn[data-v-97152310]{margin-right:10px}.footer-buttons .btn[data-v-97152310]:last-child{margin-right:0}.create-btn[data-v-97152310]{padding:11px}.chart-account-success[data-v-97152310],.chart-account-warning[data-v-97152310]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-97152310]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-97152310]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-97152310],.warning-content[data-v-97152310]{align-items:center;display:flex;gap:16px}.success-icon[data-v-97152310],.warning-icon[data-v-97152310]{flex-shrink:0;font-size:24px}.warning-icon[data-v-97152310]{color:#856404}.success-icon[data-v-97152310]{color:#155724}.success-text[data-v-97152310],.warning-text[data-v-97152310]{flex-grow:1}.success-title[data-v-97152310],.warning-title[data-v-97152310]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-97152310]{color:#856404}.success-title[data-v-97152310]{color:#155724}.success-description[data-v-97152310],.warning-description[data-v-97152310]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-97152310]{color:#856404}.success-description[data-v-97152310]{color:#155724}.warning-action[data-v-97152310]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-97152310]{padding:0}.btn-primary[data-v-97152310]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-97152310]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-97152310],.warning-content[data-v-97152310]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-97152310],.warning-action[data-v-97152310]{width:100%}}.client-status[data-v-97152310]{font-size:13px}.client-success[data-v-97152310],.client-warning[data-v-97152310]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-97152310]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-97152310]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-97152310]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.debug-panel[data-v-97152310]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-97152310]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-97152310]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-97152310]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-97152310]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-97152310]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-97152310]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-97152310]:last-child{border-bottom:none}.debug-display[data-v-97152310]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-97152310]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-97152310]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-97152310]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-97152310]:last-child{border-bottom:none}.debug-panel .table th[data-v-97152310]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-97152310]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-97152310]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-97152310]{padding:15px}.debug-item .row[data-v-97152310]{margin:0}.debug-item .col-md-6[data-v-97152310]{padding:0 5px}.debug-step[data-v-97152310]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-97152310]{font-size:.75em}}.btn-outline-warning[data-v-97152310]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-97152310]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-97152310]{font-size:13px}.product-success[data-v-97152310],.product-warning[data-v-97152310]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-97152310]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-97152310]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-97152310]{font-size:13px}.account-success[data-v-97152310],.account-warning[data-v-97152310]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-97152310]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-97152310]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-97152310]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-97152310]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-97152310]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-97152310]{cursor:pointer;margin-bottom:0}.text-warning[data-v-97152310]{color:#856404!important}.text-warning small[data-v-97152310]{font-size:12px;font-weight:500}.text-warning i[data-v-97152310]{margin-right:4px}.table-custom[data-v-97152310]{border:none!important}.invoices-create-table[data-v-97152310]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-97152310]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-97152310]{border:none!important}.invoices-create-table thead th[data-v-97152310]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-97152310]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-97152310]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-97152310]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.summary-footer-wrapper[data-v-97152310]{margin-top:10px}.summary-footer-row[data-v-97152310]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-97152310]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-97152310]{color:#495057;padding:12px 16px}.summary-value[data-v-97152310]{color:#212529;padding:12px 16px;text-align:left}.grand-total-row[data-v-97152310]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-97152310]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-97152310]{text-align:left}[dir=rtl] .summary-value[data-v-97152310]{text-align:right}@media (max-width:768px){.summary-label[data-v-97152310],.summary-value[data-v-97152310]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-97152310]{font-size:14px}}.btn-group.c-w-100[data-v-97152310]{gap:10px}.card[data-v-97152310]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-97152310]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-97152310]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-97152310]{background:#fff!important}.quantity-field[data-v-97152310]{border-radius:0!important;margin:0!important;min-height:50px!important}.btn-primary[data-v-97152310]{background:#2ab930!important}.btn-secondary[data-v-97152310]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-97152310]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-97152310]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-97152310]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-97152310]{flex-grow:1}.stock-warning-title[data-v-97152310]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-97152310]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-97152310]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-97152310]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-97152310]:last-child{margin-bottom:0}.product-name[data-v-97152310]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-97152310]{color:#856404;opacity:.8}.stock-details strong[data-v-97152310]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-97152310]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-97152310]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-97152310]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-97152310]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-97152310]{align-self:center}.stock-warning-list[data-v-97152310]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-97152310]{text-align:right}}.clickable-badge[data-v-97152310]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-97152310]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-97152310]:active{transform:scale(.95)}.insufficient-stock-input[data-v-97152310]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important;margin:0 5px}.insufficient-stock-input[data-v-97152310]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.custom-qty-input input.button-minus[data-v-97152310],.custom-qty-input input.button-plus[data-v-97152310]{margin:0 5px}.product-option[data-v-97152310]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-97152310]:last-child{border-bottom:none}.product-option-header[data-v-97152310]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-97152310]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-97152310]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-97152310]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-97152310]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-97152310]{color:#33a0d9;font-size:11px}.badge-sm[data-v-97152310]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-97152310]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-97152310]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-97152310]{background-color:#e3f2fd}.summary-card[data-v-97152310]{background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.05);overflow:hidden}.summary-header[data-v-97152310]{background:linear-gradient(135deg,#33a0d9,#2a8bc7);border-bottom:2px solid #2a8bc7;padding:16px 20px}.summary-title[data-v-97152310]{align-items:center;color:#fff;display:flex;font-size:16px;font-weight:600;margin:0}.summary-title i[data-v-97152310]{font-size:18px}.summary-body[data-v-97152310]{padding:16px 20px}.summary-row[data-v-97152310]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;justify-content:space-between;padding:12px 0;transition:background-color .2s ease}.summary-row[data-v-97152310]:last-child{border-bottom:none}.summary-row[data-v-97152310]:hover{background-color:#f9fafb;border-radius:4px;margin:0 -20px;padding-left:20px;padding-right:20px}.summary-row-net[data-v-97152310]{font-weight:500}.summary-row-discount[data-v-97152310]{background-color:#fef2f2}.summary-row-discount[data-v-97152310]:hover{background-color:#fee2e2}.summary-row-total[data-v-97152310]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-bottom:none;border-radius:8px;font-size:18px;margin-top:12px;padding:16px 20px}.summary-row-total[data-v-97152310]:hover{background:linear-gradient(135deg,#e0f2fe,#dbeafe);margin:12px -20px 0;padding:16px 20px}.summary-label[data-v-97152310]{align-items:center;color:#374151;display:flex;flex:1;font-size:14px;font-weight:500}.summary-label i[data-v-97152310]{color:#6b7280;font-size:14px;text-align:center;width:20px}.summary-value[data-v-97152310]{color:#111827;font-size:14px;font-weight:600;min-width:120px;text-align:right}.summary-total[data-v-97152310]{color:#33a0d9;font-size:20px;font-weight:700}[dir=rtl] .summary-label i[data-v-97152310]{margin-left:8px;margin-right:0}[dir=rtl] .summary-value[data-v-97152310]{text-align:left}@media (max-width:768px){.summary-header[data-v-97152310]{padding:12px 16px}.summary-title[data-v-97152310]{font-size:14px}.summary-body[data-v-97152310]{padding:12px 16px}.summary-row[data-v-97152310]{flex-wrap:wrap;padding:10px 0}.summary-row[data-v-97152310]:hover{margin:0 -16px;padding-left:16px;padding-right:16px}.summary-label[data-v-97152310]{font-size:13px;margin-bottom:4px;width:100%}.summary-value[data-v-97152310]{font-size:13px;min-width:auto;text-align:left;width:100%}.summary-row-total[data-v-97152310]{font-size:16px;padding:12px 16px}.summary-row-total[data-v-97152310]:hover{margin:12px -16px 0;padding:12px 16px}.summary-total[data-v-97152310]{font-size:18px}[dir=rtl] .summary-value[data-v-97152310]{text-align:right}}@media (max-width:576px){.summary-card[data-v-97152310]{border-radius:8px}.summary-body[data-v-97152310],.summary-header[data-v-97152310],.summary-row-total[data-v-97152310]{padding:10px 12px}.summary-row-total[data-v-97152310]:hover{margin:12px -12px 0;padding:10px 12px}}.transport-taxability-card[data-v-97152310]{background:#fff;border:2px solid #e5e7eb;border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.05);margin-top:1rem;padding:16px;transition:all .3s ease}.transport-taxability-card[data-v-97152310]:hover{border-color:#33a0d9;box-shadow:0 4px 8px rgba(51,160,217,.1)}.transport-taxability-header[data-v-97152310]{align-items:center;border-bottom:1px solid #f3f4f6;display:flex;margin-bottom:12px;padding-bottom:10px}.transport-taxability-header i[data-v-97152310]{font-size:20px;margin-right:8px}.transport-taxability-title[data-v-97152310]{color:#374151;font-size:14px;font-weight:600}.transport-taxability-body[data-v-97152310]{padding-top:8px}.custom-checkbox-wrapper[data-v-97152310]{margin-bottom:12px;position:relative}.custom-checkbox-input[data-v-97152310]{cursor:pointer;height:0;opacity:0;position:absolute;width:0}.custom-checkbox-label[data-v-97152310]{align-items:center;cursor:pointer;display:flex;padding:8px 0;transition:all .2s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.custom-checkbox-label[data-v-97152310]:hover{color:#33a0d9}.checkbox-indicator[data-v-97152310]{background-color:#fff;border:2px solid #d1d5db;border-radius:6px;display:inline-block;flex-shrink:0;height:24px;margin-right:12px;position:relative;transition:all .2s ease;width:24px}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-97152310]{background-color:#33a0d9;border-color:#33a0d9}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-97152310]:after{border:solid #fff;border-width:0 2px 2px 0;content:\"\";height:12px;left:7px;position:absolute;top:3px;transform:rotate(45deg);width:6px}.custom-checkbox-input:focus~.custom-checkbox-label .checkbox-indicator[data-v-97152310]{box-shadow:0 0 0 3px rgba(51,160,217,.1)}.checkbox-text[data-v-97152310]{color:#374151;font-size:14px;font-weight:500;line-height:1.5}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-text[data-v-97152310]{color:#33a0d9;font-weight:600}.transport-taxability-description[data-v-97152310]{align-items:flex-start;border-radius:6px;display:flex;font-size:13px;line-height:1.5;margin-top:8px;padding:10px 12px;transition:all .2s ease}.transport-taxability-description i[data-v-97152310]{flex-shrink:0;margin-top:2px}.description-taxable[data-v-97152310]{background-color:#ecfdf5;border:1px solid #a7f3d0;color:#065f46}.description-taxable i[data-v-97152310]{color:#10b981}.description-non-taxable[data-v-97152310]{background-color:#fef3c7;border:1px solid #fde68a;color:#92400e}.description-non-taxable i[data-v-97152310]{color:#f59e0b}[dir=rtl] .transport-taxability-header i[data-v-97152310]{margin-left:8px;margin-right:0}[dir=rtl] .checkbox-indicator[data-v-97152310]{margin-left:12px;margin-right:0}[dir=rtl] .transport-taxability-description i[data-v-97152310]{margin-left:8px;margin-right:0}@media (max-width:768px){.transport-taxability-card[data-v-97152310]{margin-top:.5rem;padding:12px}.transport-taxability-header[data-v-97152310]{margin-bottom:10px;padding-bottom:8px}.transport-taxability-title[data-v-97152310]{font-size:13px}.checkbox-indicator[data-v-97152310]{height:22px;width:22px}.custom-checkbox-input:checked~.custom-checkbox-label .checkbox-indicator[data-v-97152310]:after{height:10px;left:6px;top:2px;width:5px}.checkbox-text[data-v-97152310]{font-size:13px}.transport-taxability-description[data-v-97152310]{font-size:12px;padding:8px 10px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=97152310&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
  ...
  })], 1)]), _vm._v(" "), _vm.items ? _c('div', [_c('div', {
    staticClass: "row"
  }, [_c('div', {
    ...
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])])])])])])]) : _vm._e(), _vm._v(" "), _vm.hasInsufficientStock ? _c('div', {
    ...
    staticClass: "d-block"
  }, [_vm._v(_vm._s(_vm.form.errors.get("discount")))]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "form-group col-12 col-md-6"
  }, [_c('label', {
    attrs: {
      "for": "total_amount"
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=97152310&scoped=true
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 10:
              ...
              if (((_error$response0 = _context8.t0.response) === null || _error$response0 === void 0 ? void 0 : _error$response0.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response1 = _context8.t0.response) === null || _error$response1 === void 0 ? void 0 : _error$response1.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response10 = _context8.t0.response) === null || _error$response10 === void 0 ? void 0 : _error$response10.status) >= 500) {
                toast.fire({
                  type: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 66:
              ...
              if (!(((_error$response11 = _context9.t1.response) === null || _error$response11 === void 0 ? void 0 : _error$response11.status) === 422 && (_error$response12 = _context9.t1.response) !== null && _error$response12 !== void 0 && (_error$response12 = _error$response12.data) !== null && _error$response12 !== void 0 && _error$response12.errors)) {
                _context9.next = 76;
                break;
              }
              ...
              break;
            case 76:
              if (!(((_error$response13 = _context9.t1.response) === null || _error$response13 === void 0 ? void 0 : _error$response13.status) === 400)) {
                _context9.next = 86;
                break;
              }
            ...
            case 83:
              ...
              break;
            case 86:
              if (((_error$response14 = _context9.t1.response) === null || _error$response14 === void 0 ? void 0 : _error$response14.status) === 401) {
              ...
              } else if (((_error$response15 = _context9.t1.response) === null || _error$response15 === void 0 ? void 0 : _error$response15.status) === 403) {
              ...
              } else if (((_error$response16 = _context9.t1.response) === null || _error$response16 === void 0 ? void 0 : _error$response16.status) === 404) {
              ...
              } else if (((_error$response17 = _context9.t1.response) === null || _error$response17 === void 0 ? void 0 : _error$response17.status) === 409) {
              ...
              } else if (((_error$response18 = _context9.t1.response) === null || _error$response18 === void 0 ? void 0 : _error$response18.status) === 422) {
              ...
              } else if (((_error$response19 = _context9.t1.response) === null || _error$response19 === void 0 ? void 0 : _error$response19.status) >= 500) {
              ...
              } else if ((_error$response20 = _context9.t1.response) !== null && _error$response20 !== void 0 && (_error$response20 = _error$response20.data) !== null && _error$response20 !== void 0 && _error$response20.message) {
        ...
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            ...
            case 11:
              ...
              if (((_error$response21 = _context1.t0.response) === null || _error$response21 === void 0 ? void 0 : _error$response21.status) === 400) {
              ...
              } else if (((_error$response22 = _context1.t0.response) === null || _error$response22 === void 0 ? void 0 : _error$response22.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response23 = _context1.t0.response) === null || _error$response23 === void 0 ? void 0 : _error$response23.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response24 = _context1.t0.response) === null || _error$response24 === void 0 ? void 0 : _error$response24.status) === 404) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response25 = _context1.t0.response) === null || _error$response25 === void 0 ? void 0 : _error$response25.status) >= 500) {
              ...
              } else if ((_error$response26 = _context1.t0.response) !== null && _error$response26 !== void 0 && (_error$response26 = _error$response26.data) !== null && _error$response26 !== void 0 && _error$response26.message) {
                toast.fire({
                  type: "error",
                  title: _this19.$t("Assignment Failed"),
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 11:
              ...
              // Handle different types of errors
              if (((_error$response27 = _context10.t0.response) === null || _error$response27 === void 0 ? void 0 : _error$response27.status) === 400) {
              ...
              } else if (((_error$response28 = _context10.t0.response) === null || _error$response28 === void 0 ? void 0 : _error$response28.status) === 401) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response29 = _context10.t0.response) === null || _error$response29 === void 0 ? void 0 : _error$response29.status) === 403) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response30 = _context10.t0.response) === null || _error$response30 === void 0 ? void 0 : _error$response30.status) === 404) {
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response31 = _context10.t0.response) === null || _error$response31 === void 0 ? void 0 : _error$response31.status) >= 500) {
              ...
              } else if ((_error$response32 = _context10.t0.response) !== null && _error$response32 !== void 0 && (_error$response32 = _error$response32.data) !== null && _error$response32 !== void 0 && _error$response32.message) {
                toast.fire({
                  type: "error",
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_97152310_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_97152310_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_97152310_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=97152310&prod&scoped=true&lang=css
