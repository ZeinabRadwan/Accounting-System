(self["webpackChunk"] = self["webpackChunk"] || []).push([[6641],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/index.vue?vue&type=template&id=82b6c068&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    staticClass: "table purchase-returns-table"
  }, [_c('thead', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Return No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Purchase No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Supplier")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Return Reason")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Cost of Return Products")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Date")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _vm.$can('invoice-return-edit') || _vm.$can('invoice-return-view') || _vm.$can('invoice-return-delete') ? _c('th', {
    ...
    }, [_vm._v("\n                      " + _vm._s(_vm._f("withPrefix")(data.purReturnNo, _vm.purReturnPrefix)) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(_vm._f("withPrefix")(data.purReturnNo, _vm.purReturnPrefix)))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withPrefix")(data.purchaseNo, _vm.purPrefix)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.supplierName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.reason))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(parseFloat(data.totalReturn).toFixed(2)) + " "), _c('span', {
    ...
    })])]), _vm._v(" "), _c('ul', [_vm.$can('invoice-return-view') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'purchaseReturns.show',
          params: {
    ...
    }), _vm._v("\n                              " + _vm._s(_vm.$t('View')) + "\n                            ")])], 1) : _vm._e(), _vm._v(" "), _vm.isSaudiArabia && data.status === 0 ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
        "click": function click($event) {
          ...
          return _vm.sendPurchaseReturn(data);
        }
      }
    }, [_c('i', {
      staticClass: "fas fa-paper-plane"
    }), _vm._v("\n                              " + _vm._s(_vm.$t('Send to ZATCA')) + "\n                            ")])]) : _vm._e(), _vm._v(" "), _vm.$can('invoice-return-edit') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
    ...
    }), _vm._v("\n                              " + _vm._s(_vm.$t('Edit')) + "\n                            ")])], 1) : _vm._e(), _vm._v(" "), _vm.$can('invoice-return-delete') ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/index.vue?vue&type=script&lang=js
...
/* harmony default export */ const returnsvue_type_script_lang_js = ({
  ...
  metaInfo: function metaInfo() {
    return {
      title: this.isSaudiArabia ? this.$t("Debit notes") : this.$t("Purchase Returns")
    };
  },
  components: {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "loading", "pagination", "appInfo"])), {}, {
    ...
    exportUrl: function exportUrl() {
      ...
      return "/purchase-returns/export/excel?start_date=".concat(this.dateRange.startDate, "&end_date=").concat(this.dateRange.endDate, "&term=").concat(this.query);
    }
  }),
  watch: {
    // watch search data
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            case 0:
              sweetalert2_default().fire({
                title: _this0.$t("Send Purchase Return to ZATCA"),
                text: _this0.$t("Do you want to send this purchase return to ZATCA?"),
                type: "question",
                showCancelButton: true,
                confirmButtonText: _this0.$t("Yes"),
                cancelButtonText: _this0.$t("No"),
                confirmButtonColor: "#28a745",
                cancelButtonColor: "#dc3545"
              }).then(/*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(result) {
                  var response, _t;
                  return _regenerator().w(function (_context9) {
                    while (1) switch (_context9.p = _context9.n) {
                      case 0:
                        ...
                        // Show loading
                        sweetalert2_default().fire({
                          title: _this0.$t("Sending..."),
                          text: _this0.$t("Please wait while we send the purchase return to ZATCA"),
                      ...
                      case 2:
                        ...
                        if (response.data.success) {
                          _this0.$toast.success(_this0.$t("Sent Successfully!"), _this0.$t("Purchase return has been sent to ZATCA and journal entries have been created."));
                          // Refresh the table to update the status
                          _this0.getData();
                        } else {
                          _this0.$toast.error(_this0.$t("Failed!"), response.data.message || _this0.$t("Failed to send purchase return to ZATCA"));
                        }
                        _context9.n = 4;
                        break;
                      case 3:
                        _context9.p = 3;
                        _t = _context9.v;
                        console.error('Error sending purchase return to ZATCA:', _t);
                        // Close the loading dialog
                        sweetalert2_default().close();
                        _this0.$toast.error(_this0.$t("Error!"), _this0.$t("An error occurred while sending the purchase return to ZATCA"));
                      case 4:
...
;// ./resources/js/pages/purchases/returns/index.vue?vue&type=script&lang=js
 /* harmony default export */ const purchases_returnsvue_type_script_lang_js = (returnsvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/index.vue?vue&type=style&index=0&id=82b6c068&prod&scoped=true&lang=css
var returnsvue_type_style_index_0_id_82b6c068_prod_scoped_true_lang_css = __webpack_require__(36114);
...
var update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_0_id_82b6c068_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_returnsvue_type_style_index_0_id_82b6c068_prod_scoped_true_lang_css = (returnsvue_type_style_index_0_id_82b6c068_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/index.vue?vue&type=style&index=0&id=82b6c068&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/index.vue?vue&type=style&index=1&id=82b6c068&prod&lang=css
var returnsvue_type_style_index_1_id_82b6c068_prod_lang_css = __webpack_require__(98682);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/index.vue?vue&type=style&index=1&id=82b6c068&prod&lang=css

            

var returnsvue_type_style_index_1_id_82b6c068_prod_lang_css_options = {};

returnsvue_type_style_index_1_id_82b6c068_prod_lang_css_options.insert = "head";
returnsvue_type_style_index_1_id_82b6c068_prod_lang_css_options.singleton = false;

var returnsvue_type_style_index_1_id_82b6c068_prod_lang_css_update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_1_id_82b6c068_prod_lang_css/* default */.A, returnsvue_type_style_index_1_id_82b6c068_prod_lang_css_options);



/* harmony default export */ const purchases_returnsvue_type_style_index_1_id_82b6c068_prod_lang_css = (returnsvue_type_style_index_1_id_82b6c068_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/index.vue?vue&type=style&index=1&id=82b6c068&prod&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  purchases_returnsvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-82b6c068]{border:none!important}.purchase-returns-table[data-v-82b6c068]{border-collapse:separate;border-spacing:0}.purchase-returns-table thead th[data-v-82b6c068]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchase-returns-table thead tr[data-v-82b6c068]{border:none!important}.purchase-returns-table thead th[data-v-82b6c068]:first-child{border-top-left-radius:10px}.purchase-returns-table thead th[data-v-82b6c068]:last-child{border-top-right-radius:10px}[dir=rtl] .purchase-returns-table thead th[data-v-82b6c068]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchase-returns-table thead th[data-v-82b6c068]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-82b6c068]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-82b6c068],.export-pdf-btn[data-v-82b6c068]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-82b6c068],.export-pdf-btn[data-v-82b6c068],.print-btn[data-v-82b6c068]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-82b6c068]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-82b6c068]{display:inline-block;position:relative}.action-icon-btn[data-v-82b6c068]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-82b6c068]{animation:slideInDown-82b6c068 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-82b6c068]{left:45px!important;right:auto!important}@keyframes slideInDown-82b6c068{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-82b6c068]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-82b6c068]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-82b6c068]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-82b6c068]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-82b6c068]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-82b6c068]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-82b6c068]:last-child{border-bottom:none}.action-menu li a[data-v-82b6c068]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-82b6c068]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-82b6c068]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-82b6c068]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-82b6c068]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-82b6c068]{gap:10px}.card[data-v-82b6c068]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-82b6c068]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.purchase-returns-table .badge.bg-success[data-v-82b6c068]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.purchase-returns-table .badge.bg-danger[data-v-82b6c068]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-82b6c068]{background:#fff!important}.btn-primary[data-v-82b6c068]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
