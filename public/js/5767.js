...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom .table td[data-v-ae11e882]{vertical-align:middle}.profile-area[data-v-ae11e882]{align-items:center;display:flex}.profile-area img[data-v-ae11e882]{border-radius:100%;height:50px;width:50px}.profile-area a[data-v-ae11e882]{display:block}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=template&id=ae11e882&scoped=true
  ...
  methods: {
          ...
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              ...
              return sweetalert2_all_default().fire({
                ...
                text: _this9.$t("Are you sure you want to archive this tenant? The tenant will be moved to archived section and can be restored later."),
                icon: "warning",
            ...
            case 2:
              ...
              _context9.p = 3;
              _context9.n = 4;
              return _this9.$store.dispatch("operations/deleteData", {
                path: "/api/tenants/",
                slug: slug
              });
            case 4:
              ...
              if (response === true) {
                _this9.$toast.success(_this9.$t("Archived"), _this9.$t("Tenant archived successfully"));
                _this9.getData();
              } else {
                console.error('Archive failed with response:', response);
                _this9.$toast.warning(_this9.$t("Failed"), _this9.$t("Archive failed"));
              }
              _context9.n = 6;
              break;
            case 5:
              _context9.p = 5;
              _t = _context9.v;
              console.error('Delete request error:', _t);
              _this9.$toast.warning(_this9.$t("Failed"), _this9.$t("Archive failed"));
            case 6:
              _context9.n = 8;
              break;
            case 7:
              _context9.p = 7;
              _t2 = _context9.v;
              console.error('SweetAlert error:', _t2);
              // If SweetAlert fails, still proceed with the action
              _this9.$toast.warning(_this9.$t("Warning"), _this9.$t("Confirmation dialog failed, but action will proceed"));
            case 8:
              return _context9.a(2);
          }
        }, _callee9, null, [[3, 5], [1, 7]]);
      }))();
    },
    // delete data
    ban: function ban(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            case 0:
              _this1.archivedLoading = true;
              _context1.p = 1;
              _context1.n = 2;
              return axios_default().get("/api/tenants/archived?perPage=".concat(_this1.perPage));
            case 2:
              response = _context1.v;
              _this1.archivedItems = response.data.data;
              _this1.archivedPagination = response.data.meta;
              _context1.n = 4;
              break;
            case 3:
              _context1.p = 3;
              _t3 = _context1.v;
              console.error('Error fetching archived tenants:', _t3);
              _this1.$toast.error(_this1.$t("Error!"), _this1.$t("Failed to load archived tenants"));
            case 4:
              _context1.p = 4;
              _this1.archivedLoading = false;
          ...
          while (1) switch (_context10.p = _context10.n) {
            case 0:
              ...
              params = new URLSearchParams({
                term: _this10.archivedQuery,
                perPage: _this10.perPage
              });
              if (_this10.archivedDateRange.startDate && _this10.archivedDateRange.endDate) {
                params.append('startDate', _this10.archivedDateRange.startDate);
                params.append('endDate', _this10.archivedDateRange.endDate);
              }
              _context10.n = 2;
            ...
            case 3:
              _context10.p = 3;
              _t4 = _context10.v;
              console.error('Error searching archived tenants:', _t4);
              _this10.$toast.error(_this10.$t("Error!"), _this10.$t("Failed to search archived tenants"));
            case 4:
              _context10.p = 4;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            case 0:
              _this11.archivedDateRange.startDate = moment_default()(_this11.archivedDateRange.startDate).format("YYYY-MM-DD");
              _this11.archivedDateRange.endDate = moment_default()(_this11.archivedDateRange.endDate).format("YYYY-MM-DD");
              _this11.searchArchivedData();
            case 1:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.n) {
            case 0:
              _this12.archivedQuery = "";
              _context12.n = 1;
              return _this12.searchArchivedData();
            case 1:
    ...
    restoreTenant: function restoreTenant(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        var result, response, _error$response, _t5, _t6;
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.p = _context13.n) {
            case 0:
              ...
              _context13.n = 1;
              return sweetalert2_all_default().fire({
                title: _this13.$t("Are you sure?"),
                text: _this13.$t("Are you sure you want to restore this tenant?"),
                icon: "question",
                showCancelButton: true,
                confirmButtonText: _this13.$t("Confirm"),
                cancelButtonText: _this13.$t("Cancel"),
            ...
            case 3:
              ...
              if (response.data.success) {
                _this13.$toast.success(_this13.$t("Success"), _this13.$t("Tenant restored successfully"));
                _this13.getArchivedData();
                _this13.getData(); // Refresh active tenants too
              } else {
                _this13.$toast.error(_this13.$t("Failed"), _this13.$t("Failed to restore tenant"));
              }
              _context13.n = 5;
              break;
            case 4:
              _context13.p = 4;
              _t5 = _context13.v;
              console.error('Error restoring tenant:', _t5);
              _this13.$toast.error(_this13.$t("Error!"), ((_error$response = _t5.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this13.$t("Failed to restore tenant"));
            case 5:
              _context13.n = 7;
              break;
            case 6:
              _context13.p = 6;
              _t6 = _context13.v;
              console.error('SweetAlert error:', _t6);
              _this13.$toast.warning(_this13.$t("Warning"), _this13.$t("Confirmation dialog failed"));
            case 7:
              return _context13.a(2);
          }
        }, _callee13, null, [[2, 4], [0, 6]]);
      }))();
    },
    ...
    permanentDeleteTenant: function permanentDeleteTenant(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        var result, response, _error$response2, _t7, _t8;
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.p = _context14.n) {
            case 0:
              ...
              _context14.n = 1;
              return sweetalert2_all_default().fire({
                title: _this14.$t("Are you sure?"),
                text: _this14.$t("Are you sure you want to permanently delete this tenant? This action cannot be undone and will delete all data including the database."),
                icon: "error",
                showCancelButton: true,
                confirmButtonText: _this14.$t("Confirm"),
                cancelButtonText: _this14.$t("Cancel"),
            ...
            case 3:
              ...
              if (response.data.success) {
                _this14.$toast.success(_this14.$t("Success"), _this14.$t("Tenant permanently deleted successfully"));
                _this14.getArchivedData();
              } else {
                _this14.$toast.error(_this14.$t("Failed"), _this14.$t("Failed to permanently delete tenant"));
              }
              _context14.n = 5;
              break;
            case 4:
              _context14.p = 4;
              _t7 = _context14.v;
              console.error('Error permanently deleting tenant:', _t7);
              _this14.$toast.error(_this14.$t("Error!"), ((_error$response2 = _t7.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this14.$t("Failed to permanently delete tenant"));
            case 5:
              _context14.n = 7;
              break;
            case 6:
              _context14.p = 6;
              _t8 = _context14.v;
              console.error('SweetAlert error:', _t8);
              _this14.$toast.warning(_this14.$t("Warning"), _this14.$t("Confirmation dialog failed"));
            case 7:
              return _context14.a(2);
          }
        }, _callee14, null, [[2, 4], [0, 6]]);
      }))();
    }
  }
});
...
var update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_0_id_ae11e882_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const central_tenantsvue_type_style_index_0_id_ae11e882_prod_scoped_true_lang_css = (tenantsvue_type_style_index_0_id_ae11e882_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=ae11e882&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=ae11e882&prod&lang=css
var tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css = __webpack_require__(25929);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=ae11e882&prod&lang=css

            

var tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css_options = {};

tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css_options.insert = "head";
tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css_options.singleton = false;

var tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css_update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css/* default */.A, tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css_options);



/* harmony default export */ const central_tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css = (tenantsvue_type_style_index_1_id_ae11e882_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=ae11e882&prod&lang=css
