(self["webpackChunk"] = self["webpackChunk"] || []).push([[3368],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-067dfa52]{border:none!important;overflow:visible!important}.payroll-table[data-v-067dfa52]{border-collapse:separate;border-spacing:0}.payroll-table thead th[data-v-067dfa52]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.payroll-table thead tr[data-v-067dfa52]{border:none!important}.payroll-table thead th[data-v-067dfa52]:first-child{border-top-left-radius:10px}.payroll-table thead th[data-v-067dfa52]:last-child{border-top-right-radius:10px}[dir=rtl] .payroll-table thead th[data-v-067dfa52]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .payroll-table thead th[data-v-067dfa52]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-067dfa52]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-067dfa52],.export-pdf-btn[data-v-067dfa52]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-067dfa52],.export-pdf-btn[data-v-067dfa52],.print-btn[data-v-067dfa52]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-067dfa52]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-067dfa52]{display:inline-block;position:relative}.action-icon-btn[data-v-067dfa52]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;transition:all .2s ease;width:24px}.action-icon-btn[data-v-067dfa52]:hover{background-color:#f8fafc;border-radius:4px}.action-menu[data-v-067dfa52]{animation:slideInDown-067dfa52 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-067dfa52]{left:45px!important;right:auto!important}.action-menu-header[data-v-067dfa52]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-067dfa52]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-067dfa52]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-067dfa52]:hover{background-color:#e5e7eb}.action-menu ul[data-v-067dfa52]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-067dfa52]{margin:0}.action-menu li a[data-v-067dfa52]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-067dfa52]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-067dfa52]{flex-shrink:0;height:16px;width:16px}@keyframes slideInDown-067dfa52{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.btn-group.c-w-100[data-v-067dfa52]{gap:10px}.btn-group.c-w-100>.btn[data-v-067dfa52]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-067dfa52]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-067dfa52]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-067dfa52]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-067dfa52]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.payroll-table .badge.bg-success[data-v-067dfa52]{background:#f6fef4!important;color:#2ab930!important}.payroll-table .badge.bg-danger[data-v-067dfa52],.payroll-table .badge.bg-success[data-v-067dfa52]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.payroll-table .badge.bg-danger[data-v-067dfa52]{background:#fef4f4!important;color:#dc3545!important}.form-control[data-v-067dfa52]{background:#f1f5fb!important}.btn-primary[data-v-067dfa52]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/index.vue?vue&type=template&id=067dfa52&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    staticClass: "table payroll-table"
  }, [_c('thead', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Emp Name")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Emp ID")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Designation")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Salary Month")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Total Paid")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Account")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Salary Date")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _vm.$can('payroll-edit') || _vm.$can('payroll-view') || _vm.$can('payroll-delete') ? _c('th', {
    ...
    }, [_vm._v("\n                      " + _vm._s(data.employee.name) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(data.employee.name))])], 1), _vm._v(" "), _c('td', [data.employee ? _c('span', [_vm._v(_vm._s(_vm._f("withPrefix")(data.employee.empID, _vm.employeePrefix)) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c('td', [data.employee ? _c('span', [_vm._v(_vm._s(data.employee.designation) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.salaryMonth))]), _vm._v(" "), _c('td', [data.transaction ? _c('span', [_vm._v(_vm._s(_vm._f("withCurrency")(data.transaction.amount)))]) : _vm._e()]), _vm._v(" "), _c('td', [data.transaction && data.transaction.cashbook_account ? _c('span', [_vm._v("\n                      " + _vm._s(data.transaction.cashbook_account.account_number) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c('td', [data.salaryDate ? _c('span', [_vm._v(_vm._s(_vm._f("moment")(data.salaryDate, "Do MMM, YYYY")))]) : _vm._e()]), _vm._v(" "), _c('td', [data.status === 1 ? _c('span', {
...
/* harmony default export */ const payrollvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "loading", "pagination", "appInfo"])), {}, {
    exportUrl: function exportUrl() {
      ...
      return "/payroll/export/excel?start_date=".concat(this.dateRange.startDate, "&end_date=").concat(this.dateRange.endDate, "&term=").concat(this.query);
    }
  }),
  watch: {
    // watch search data
...
var update = injectStylesIntoStyleTag_default()(payrollvue_type_style_index_0_id_067dfa52_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_payrollvue_type_style_index_0_id_067dfa52_prod_scoped_true_lang_css = (payrollvue_type_style_index_0_id_067dfa52_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payroll/index.vue?vue&type=style&index=0&id=067dfa52&prod&scoped=true&lang=css
