(self["webpackChunk"] = self["webpackChunk"] || []).push([[9451],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/index.vue?vue&type=template&id=b85c2c96
var render = function render() {
  ...
  return _c('div', {
    ...
    staticClass: "table"
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice Date")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Client")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Net Total")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Total Paid")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Total Due")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _vm.$can('invoice-view') || _vm.$can('invoice-edit') || _vm.$can('invoice-delete') ? _c('th', {
    ...
    }, [_vm.$can('invoice-view') && data.due > 0 ? _c('a', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Add Payment?'),
        expression: "$t('Add Payment?')"
      }],
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.isSaudiArabia && data.status === 0 ? _c('a', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('Send Invoice'),
        expression: "$t('Send Invoice')"
      }],
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.$can('invoice-view') ? _c('router-link', {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.$t('View'),
                ...
                if (result.value) {
                  _this0.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      sweetalert2_all_default().fire(_this0.$t("Failed!"), _this0.$t("Sorry you can't delete this invoice!"), "warning");
                    }
                  });
                }
              });
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            case 0:
              ...
              console.log('isSaudiArabia:', _this1.isSaudiArabia);
              console.log('data.status:', data.status);
              sweetalert2_all_default().fire({
                title: _this1.$t("Send Invoice to ZATCA"),
                text: _this1.$t("Do you want to send this invoice to ZATCA?"),
                type: "question",
                showCancelButton: true,
                    ...
                    while (1) switch (_context1.p = _context1.n) {
                      case 0:
                        ...
                        sweetalert2_all_default().fire({
                          ...
                          text: _this1.$t("Please wait while we send the invoice to ZATCA"),
                      ...
                      case 2:
                        ...
                        if (response.data.success) {
                          sweetalert2_all_default().fire(_this1.$t("Sent Successfully!"), _this1.$t("Invoice has been sent to ZATCA and journal entries have been created."), "success");
                          // Refresh the table to update the status
                          _this1.getData();
                        } else {
                          sweetalert2_all_default().fire(_this1.$t("Failed!"), response.data.message || _this1.$t("Failed to send invoice to ZATCA"), "error");
                        }
                        _context1.n = 4;
                        break;
                      case 3:
                        ...
                        sweetalert2_all_default().fire(_this1.$t("Error!"), _this1.$t("An error occurred while sending the invoice to ZATCA"), "error");
                      case 4:
