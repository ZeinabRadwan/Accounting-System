"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3918],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-82a4b1b6]{margin-bottom:15px}.footer-buttons[data-v-82a4b1b6]{display:flex;gap:10px}.footer-buttons .btn[data-v-82a4b1b6]{margin-right:10px}.footer-buttons .btn[data-v-82a4b1b6]:last-child{margin-right:0}.create-btn[data-v-82a4b1b6]{padding:11px}.chart-account-success[data-v-82a4b1b6],.chart-account-warning[data-v-82a4b1b6]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-82a4b1b6]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-82a4b1b6]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-82a4b1b6],.warning-content[data-v-82a4b1b6]{align-items:center;display:flex;gap:16px}.success-icon[data-v-82a4b1b6],.warning-icon[data-v-82a4b1b6]{flex-shrink:0;font-size:24px}.warning-icon[data-v-82a4b1b6]{color:#856404}.success-icon[data-v-82a4b1b6]{color:#155724}.success-text[data-v-82a4b1b6],.warning-text[data-v-82a4b1b6]{flex-grow:1}.success-title[data-v-82a4b1b6],.warning-title[data-v-82a4b1b6]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-82a4b1b6]{color:#856404}.success-title[data-v-82a4b1b6]{color:#155724}.success-description[data-v-82a4b1b6],.warning-description[data-v-82a4b1b6]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-82a4b1b6]{color:#856404}.success-description[data-v-82a4b1b6]{color:#155724}.warning-action[data-v-82a4b1b6]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-82a4b1b6]{padding:0}.btn-primary[data-v-82a4b1b6]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-82a4b1b6]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-82a4b1b6],.warning-content[data-v-82a4b1b6]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-82a4b1b6],.warning-action[data-v-82a4b1b6]{width:100%}}.client-status[data-v-82a4b1b6]{font-size:13px}.client-success[data-v-82a4b1b6],.client-warning[data-v-82a4b1b6]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-82a4b1b6]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-82a4b1b6]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-82a4b1b6]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.debug-panel[data-v-82a4b1b6]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-82a4b1b6]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-82a4b1b6]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-82a4b1b6]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-82a4b1b6]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-82a4b1b6]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-82a4b1b6]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-82a4b1b6]:last-child{border-bottom:none}.debug-display[data-v-82a4b1b6]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-82a4b1b6]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-82a4b1b6]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-82a4b1b6]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-82a4b1b6]:last-child{border-bottom:none}.debug-panel .table th[data-v-82a4b1b6]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-82a4b1b6]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-82a4b1b6]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-82a4b1b6]{padding:15px}.debug-item .row[data-v-82a4b1b6]{margin:0}.debug-item .col-md-6[data-v-82a4b1b6]{padding:0 5px}.debug-step[data-v-82a4b1b6]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-82a4b1b6]{font-size:.75em}}.btn-outline-warning[data-v-82a4b1b6]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-82a4b1b6]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-82a4b1b6]{font-size:13px}.product-success[data-v-82a4b1b6],.product-warning[data-v-82a4b1b6]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-82a4b1b6]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-82a4b1b6]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-82a4b1b6]{font-size:13px}.account-success[data-v-82a4b1b6],.account-warning[data-v-82a4b1b6]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-82a4b1b6]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-82a4b1b6]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-82a4b1b6]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-82a4b1b6]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-82a4b1b6]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-82a4b1b6]{cursor:pointer;margin-bottom:0}.text-warning[data-v-82a4b1b6]{color:#856404!important}.text-warning small[data-v-82a4b1b6]{font-size:12px;font-weight:500}.text-warning i[data-v-82a4b1b6]{margin-right:4px}.table-custom[data-v-82a4b1b6]{border:none!important}.invoices-create-table[data-v-82a4b1b6]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-82a4b1b6]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-82a4b1b6]{border:none!important}.invoices-create-table thead th[data-v-82a4b1b6]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-82a4b1b6]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-82a4b1b6]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-82a4b1b6]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.summary-footer-wrapper[data-v-82a4b1b6]{margin-top:10px}.summary-footer-row[data-v-82a4b1b6]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-82a4b1b6]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-82a4b1b6]{color:#495057}.summary-label[data-v-82a4b1b6],.summary-value[data-v-82a4b1b6]{font-size:14px;padding:12px 16px}.summary-value[data-v-82a4b1b6]{color:#212529;text-align:left}.grand-total-row[data-v-82a4b1b6]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-82a4b1b6]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-82a4b1b6]{text-align:left}[dir=rtl] .summary-value[data-v-82a4b1b6]{text-align:right}@media (max-width:768px){.summary-label[data-v-82a4b1b6],.summary-value[data-v-82a4b1b6]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-82a4b1b6]{font-size:14px}}.btn-group.c-w-100[data-v-82a4b1b6]{gap:10px}.card[data-v-82a4b1b6]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-82a4b1b6]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-82a4b1b6]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-82a4b1b6]{background:#fff!important}.quantity-field[data-v-82a4b1b6]{border-radius:0!important;margin:0!important;min-height:50px!important}.btn-primary[data-v-82a4b1b6]{background:#2ab930!important}.btn-secondary[data-v-82a4b1b6]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-82a4b1b6]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-82a4b1b6]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-82a4b1b6]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-82a4b1b6]{flex-grow:1}.stock-warning-title[data-v-82a4b1b6]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-82a4b1b6]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-82a4b1b6]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-82a4b1b6]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-82a4b1b6]:last-child{margin-bottom:0}.product-name[data-v-82a4b1b6]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-82a4b1b6]{color:#856404;opacity:.8}.stock-details strong[data-v-82a4b1b6]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-82a4b1b6]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-82a4b1b6]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-82a4b1b6]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-82a4b1b6]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-82a4b1b6]{align-self:center}.stock-warning-list[data-v-82a4b1b6]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-82a4b1b6]{text-align:right}}.clickable-badge[data-v-82a4b1b6]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-82a4b1b6]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-82a4b1b6]:active{transform:scale(.95)}.insufficient-stock-input[data-v-82a4b1b6]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important;margin:0 5px}.insufficient-stock-input[data-v-82a4b1b6]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.custom-qty-input input.button-minus[data-v-82a4b1b6],.custom-qty-input input.button-plus[data-v-82a4b1b6]{margin:0 5px}.product-option[data-v-82a4b1b6]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-82a4b1b6]:last-child{border-bottom:none}.product-option-header[data-v-82a4b1b6]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-82a4b1b6]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-82a4b1b6]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-82a4b1b6]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-82a4b1b6]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-82a4b1b6]{color:#33a0d9;font-size:11px}.badge-sm[data-v-82a4b1b6]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-82a4b1b6]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-82a4b1b6]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-82a4b1b6]{background-color:#e3f2fd}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=82a4b1b6&scoped=true
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=82a4b1b6&scoped=true
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    onFileChange: function onFileChange(e) {
      ...
      if (file.size < 2111775 && (file.type === "image/jpeg" || file.type === "image/png" || file.type === "image/gif")) {
        reader.onloadend = function () {
          _this13.formClient.image = reader.result;
        };
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              ...
              validationErrors = [];
              if (!_this14.form.client || !_this14.form.client.chart_of_account_id) {
                validationErrors.push({
                  type: "warning",
                  title: _this14.$t("Chart of Account Required"),
                  message: _this14.$t("Client must have a Chart of Account assigned before creating an invoice."),
                  field: "client"
                });
              }
              if (!_this14.form.selectedProducts || _this14.form.selectedProducts.length === 0) {
                validationErrors.push({
                  type: "warning",
                  title: _this14.$t("No Products Selected"),
                  message: _this14.$t("Please select at least one product to create an invoice."),
                  field: "selectedProducts"
                });
              }
              ...
              if (productsWithoutSalesAccount.length > 0) {
                ...
                validationErrors.push({
                  type: "warning",
                  title: _this14.$t("Product Chart of Account Required"),
                  message: _this14.$t("The following products must have Sales Accounts assigned: ") + productNames,
                  field: "products",
                  timer: 8000,
                  timerProgressBar: true
                });
              ...
              paymentValidation = _this14.validatePaymentFields();
              ...
              _this14.showMultipleValidationErrors(validationErrors);
              return _context0.abrupt("return");
            case 13:
              _this14.loading = true;

              // If attachments exist, use FormData; otherwise use regular form.post()
              if (!(_this14.form.attachments && _this14.form.attachments.length > 0)) {
                _context0.next = 66;
                break;
              }
              // Create FormData for file uploads
              formDataObj = _this14.form.data();
              ...
              _this14.syncDiscountFields();
              appendIfDefined('discountType', _this14.form.discountType);
              appendIfDefined('discount', _this14.form.discount);
              ...
              _this14.form.attachments.forEach(function (file) {
            ...
            case 54:
              ...
              if (data.success) {
                toast.fire({
                  type: "success",
                  title: _this14.$t("Success"),
                  text: _this14.$t("Invoice created successfully")
                });
                ...
                if (data.data.journal_entries_created) {
                  setTimeout(function () {
                    toast.fire({
                      type: "success",
                      title: _this14.$t("Journal Entries Created"),
                      text: _this14.$t("Journal entries have been automatically created for this invoice"),
                      timer: 4000,
                      timerProgressBar: true
                    });
                  }, 500);
            ...
            case 66:
              _context0.next = 68;
              return _this14.form.post(window.location.origin + "/api/invoices");
            case 68:
              _yield$_this14$form$p = _context0.sent;
              _data3 = _yield$_this14$form$p.data;
              _this14.loading = false;
              if (_data3.success) {
                toast.fire({
                  type: "success",
            ...
            case 74:
              ...
              Object.keys(_validationErrors).forEach(function (field) {
                ...
                if (Array.isArray(fieldErrors) && fieldErrors.length > 0) {
                  ...
                  toast.fire({
                    type: "error",
                    title: _this14.$t("Validation Error"),
                    text: "".concat(_this14.getFieldLabel(field), ": ").concat(fieldErrors[0]),
                    timer: 5000,
                    timerProgressBar: true
                  });
                }
              ...
              _this14.form.errors.set(_validationErrors);
              _context0.next = 95;
              break;
            case 84:
              ...
              errorMessage = _context0.t1.response.data.message || _context0.t1.response.data.error || _this14.$t("Bad Request Error");
              ...
              _this14.showBackendValidationErrors(_validationErrors2, errorMessage);
              return _context0.abrupt("return");
            case 91:
              // Try to handle as business logic error first
              if (!_this14.handleBusinessLogicError(_context0.t1.response.data)) {
                // If not handled by business logic handler, show generic bad request error
                toast.fire({
                  type: "error",
                  title: _this14.$t("Business Logic Error"),
                  text: errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
            ...
            case 94:
              if (((_error$response14 = _context0.t1.response) === null || _error$response14 === void 0 ? void 0 : _error$response14.status) === 401) {
                ...
                toast.fire({
                  ...
                  text: _this14.$t("You don't have permission to perform this action."),
                  timer: 5000,
                  timerProgressBar: true
                });
                ...
                toast.fire({
                  type: "error",
                  title: _this14.$t("Resource Not Found"),
                  text: _this14.$t("The requested resource was not found. Please check your data and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response17 = _context0.t1.response) === null || _error$response17 === void 0 ? void 0 : _error$response17.status) === 409) {
                // Handle conflict errors
                _errorMessage = _context0.t1.response.data.message || _this14.$t("Data Conflict Error");
                toast.fire({
                  type: "error",
                  title: _this14.$t("Data Conflict"),
                  text: _errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
                ...
                _errorMessage2 = _context0.t1.response.data.message || _this14.$t("Please check your input and try again.");
                toast.fire({
                  type: "error",
                  title: _this14.$t("Validation Error"),
                  text: _errorMessage2,
                ...
                _errorMessage3 = _context0.t1.response.data.message || _this14.$t("Server Error");
                toast.fire({
                  type: "error",
                  title: _this14.$t("Server Error"),
                  text: "".concat(_errorMessage3, " (").concat(_this14.$t("Please try again later or contact support"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
                ...
                toast.fire({
                  type: "error",
                  title: _this14.$t("JavaScript Error"),
                ...
                toast.fire({
                  type: "error",
                  title: _this14.$t("Network Error"),
                  text: _this14.$t("Unable to connect to the server. Please check your internet connection and try again."),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else {
    ...
    formatFormValues: function formatFormValues() {
      ...
      this.form.selectedProducts.forEach(function (item) {
        item.unitPrice = _this15.roundToTwoDecimals(Number(item.unitPrice));
        item.qty = Number(item.qty);
        item.productTax = _this15.roundToTwoDecimals(Number(item.productTax));
        item.totalTax = _this15.roundToTwoDecimals(Number(item.totalTax));
        item.totalPrice = _this15.roundToTwoDecimals(Number(item.totalPrice));
        item.unitCost = _this15.roundToTwoDecimals(Number(item.unitCost));
        item.discount = _this15.roundToTwoDecimals(Number(item.discount || 0));
        item.discountAmount = _this15.roundToTwoDecimals(Number(item.discountAmount || 0));
      });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee1() {
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            case 0:
              _context1.next = 2;
              return _this16.formClient.post(window.location.origin + "/api/clients").then(function () {
                toast.fire({
                  type: "success",
                  title: _this16.$t("Client added successfully")
                });
                _this16.showClientCreateModal = false;
                _this16.getClients();
                _this16.formClient.reset();
                _this16.url = null;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              if (!(!_this17.form.client || _this17.isAutoAssigningClient)) {
                _context10.next = 2;
                break;
              }
              return _context10.abrupt("return");
            case 2:
              _this17.isAutoAssigningClient = true;
              _context10.prev = 3;
              // Store the current client slug before making the API call
              currentClientSlug = _this17.form.client.slug;
              _context10.next = 7;
              return _this17.$http.post("/api/clients/".concat(_this17.form.client.slug, "/auto-assign-chart-of-account"));
            case 7:
              ...
              if (response.data.success) {
                ...
                if (newAccountId) {
                  _this17.form.client.chart_of_account_id = newAccountId;
                  // Also update the option in items list to keep state consistent when switching clients
                  idx = _this17.items.findIndex(function (i) {
                    return i.slug === currentClientSlug;
                  });
                  if (idx !== -1) {
                    _this17.$set(_this17.items[idx], 'chart_of_account_id', newAccountId);
                  }
                }
            ...
            case 11:
              ...
              if (((_error$response21 = _context10.t0.response) === null || _error$response21 === void 0 ? void 0 : _error$response21.status) === 400) {
                errorMessage = _context10.t0.response.data.message || _this17.$t("Bad request error");
                toast.fire({
                  type: "error",
                ...
                toast.fire({
                  type: "error",
                  title: _this17.$t("Client Not Found"),
                  text: _this17.$t("The client was not found. Please refresh the page and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response25 = _context10.t0.response) === null || _error$response25 === void 0 ? void 0 : _error$response25.status) >= 500) {
                _errorMessage4 = _context10.t0.response.data.message || _this17.$t("Server error");
                toast.fire({
                  type: "error",
                  title: _this17.$t("Server Error"),
                  text: "".concat(_errorMessage4, " (").concat(_this17.$t("Please try again later"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
            ...
            case 15:
              _context10.prev = 15;
              _this17.isAutoAssigningClient = false;
    ...
    clearProductErrors: function clearProductErrors(index) {
      ...
      fields.forEach(function (field) {
        ...
        if (_this19.form.errors.has(errorKey)) {
          _this19.form.errors.clear(errorKey);
        }
      });
    },
    ...
    setupGlobalErrorHandling: function setupGlobalErrorHandling() {
      ...
      this.unhandledRejectionHandler = function (event) {
        ...
        _this20.handleGlobalError(event.reason, 'Promise rejection');
      };

      // Handle unhandled errors
      this.unhandledErrorHandler = function (event) {
        console.error('Unhandled error:', event.error);
        _this20.handleGlobalError(event.error, 'JavaScript error');
      };
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              if (!(!product || _this21.isAutoAssigningProduct === product.id)) {
                _context11.next = 3;
                break;
              }
              return _context11.abrupt("return");
            case 3:
              _this21.isAutoAssigningProduct = product.id;
              _context11.prev = 4;
              _context11.next = 7;
              return _this21.$http.post("/api/products/".concat(product.slug, "/").concat(type, "/auto-assign-chart-of-account"));
            case 7:
              ...
              if (response.data.success) {
                ...
                exists = _this21.form.selectedProducts && _this21.form.selectedProducts.some(function (p) {
                  return p.id === product.id;
                });
                if (!exists) {
                  _this21.storeProduct(product);
                }
            ...
            case 11:
              ...
              if (((_error$response27 = _context11.t0.response) === null || _error$response27 === void 0 ? void 0 : _error$response27.status) === 400) {
                errorMessage = _context11.t0.response.data.message || _this21.$t("Bad request error");
                toast.fire({
                  type: "error",
                ...
                toast.fire({
                  type: "error",
                  title: _this21.$t("Product Not Found"),
                  text: _this21.$t("The product was not found. Please refresh the page and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response31 = _context11.t0.response) === null || _error$response31 === void 0 ? void 0 : _error$response31.status) >= 500) {
                _errorMessage5 = _context11.t0.response.data.message || _this21.$t("Server error");
                toast.fire({
                  type: "error",
                  title: _this21.$t("Server Error"),
                  text: "".concat(_errorMessage5, " (").concat(_this21.$t("Please try again later"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
                ...
                toast.fire({
                  type: "error",
                  title: _this21.$t("Please try again or assign manually"),
            ...
            case 15:
              _context11.prev = 15;
              _this21.isAutoAssigningProduct = null;
    ...
    showAllInsufficientStock: function showAllInsufficientStock() {
      ...
      insufficientProducts.forEach(function (product, index) {
        ...
        message += "   ".concat(_this22.$t("Required"), ": ").concat(product.qty, ", ").concat(_this22.$t("Available"), ": ").concat(product.inventoryCount, ", ").concat(_this22.$t("Shortage"), ": ").concat(shortage, "\n\n");
      });
      ...
      if (this.form.selectedProducts && this.form.selectedProducts.length > 0) {
        this.form.selectedProducts.forEach(function (item, index) {
          if (!item.selectedVatRate) {
            ...
            } else if (_this23.form.orderTax) {
              item.selectedVatRate = _this23.form.orderTax;
            } else if (_this23.taxes && _this23.taxes.length > 0) {
              item.selectedVatRate = _this23.taxes[0];
            }
    ...
    recalculateAllVatAmounts: function recalculateAllVatAmounts() {
      ...
      if (this.form.selectedProducts && this.form.selectedProducts.length > 0) {
        this.form.selectedProducts.forEach(function (item, index) {
          _this24.generateItemTotalPrice(index);
        });
        this.calculateSum();
      }
    },
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              ...
              _this25.isSubmitting = true;
              _context12.prev = 1;
              if (!(_this25.form.addPayment == 1)) {
                _context12.next = 8;
                break;
              }
              paymentValidation = _this25.validatePaymentFields();
              if (paymentValidation.isValid) {
                _context12.next = 8;
                break;
              }
              event.preventDefault();
              _this25.showPaymentValidationErrors();
              return _context12.abrupt("return");
            case 8:
              _context12.next = 10;
              return _this25.saveInvoice();
            case 10:
              _context12.prev = 10;
              // Reset submitting flag
              _this25.isSubmitting = false;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_82a4b1b6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_82a4b1b6_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_82a4b1b6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=82a4b1b6&prod&scoped=true&lang=css
