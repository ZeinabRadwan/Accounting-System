"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1314],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/create.vue?vue&type=template&id=708d4457&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  methods: {
    ...
    storeProducts: function storeProducts() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var isPreSelected, key, _purchaseItem$product, _productData2, purchaseItem, productData, _productData, response, presetReturnQty, selectedVatRate, _this7$taxes, _this7$taxes2, totalBeforeDiscount, discountAmount, totalAfterDiscount, productTax, totalTax, totalPrice, finalPurchaseAccountId, _t3, _t4, _t5;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_708d4457_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_708d4457_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_708d4457_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/create.vue?vue&type=style&index=0&id=708d4457&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-708d4457]{margin-bottom:15px}.footer-buttons[data-v-708d4457]{display:flex;gap:10px}.footer-buttons .btn[data-v-708d4457]{margin-right:10px}.footer-buttons .btn[data-v-708d4457]:last-child{margin-right:0}.btn-group.c-w-100[data-v-708d4457]{gap:10px}.card[data-v-708d4457]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-708d4457]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-708d4457]{padding:1.25rem}.card-footer[data-v-708d4457]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-708d4457]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-708d4457]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-708d4457]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-708d4457]{color:#dc3545;font-weight:700}.btn-primary[data-v-708d4457]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-708d4457]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-708d4457]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-708d4457]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-708d4457]{border-color:#dc3545!important}textarea.form-control[data-v-708d4457]{min-height:100px;resize:vertical}.v-select[data-v-708d4457]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-708d4457]{background:#fff!important;border:1px solid #e5e7eb;padding:10px 16px}.v-select .vs__search[data-v-708d4457]::-moz-placeholder{color:#6c757d}.v-select .vs__search[data-v-708d4457]::placeholder{color:#6c757d}.v-select .vs__selected[data-v-708d4457]{color:#374151}.v-select .vs__dropdown-menu[data-v-708d4457]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-708d4457]{border:none!important}.purchases-create-table[data-v-708d4457]{border-collapse:separate;border-spacing:0}.purchases-create-table thead th[data-v-708d4457]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchases-create-table thead tr[data-v-708d4457]{border:none!important}.purchases-create-table thead th[data-v-708d4457]:first-child{border-top-left-radius:10px}.purchases-create-table thead th[data-v-708d4457]:last-child{border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-708d4457]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-708d4457]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.purchases-create-table .badge.badge-info[data-v-708d4457]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.custom-qty-input[data-v-708d4457]{align-items:center;background:#fff;border:1px solid #e5e7eb;border-radius:10px;display:flex;overflow:hidden}.custom-qty-input .button-minus[data-v-708d4457],.custom-qty-input .button-plus[data-v-708d4457]{background:#6c757d;border:none;color:#fff;cursor:pointer;font-weight:700;padding:8px 12px;transition:background-color .3s}.custom-qty-input .button-minus[data-v-708d4457]:hover{background:#dc3545}.custom-qty-input .button-plus[data-v-708d4457]:hover{background:#2ab930}.custom-qty-input .quantity-field[data-v-708d4457]{background:transparent;border:none;font-weight:500;padding:8px 4px;text-align:center;width:60px}.custom-qty-input .quantity-field[data-v-708d4457]:focus{box-shadow:none;outline:none}.quantity-field[data-v-708d4457]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-708d4457]{font-size:.875rem}.account-status .account-warning[data-v-708d4457]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-708d4457]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.product-status[data-v-708d4457]{font-size:13px}.product-warning[data-v-708d4457]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-708d4457]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-708d4457]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-708d4457]:disabled{cursor:not-allowed;opacity:.6}.callout[data-v-708d4457]{border-left:4px solid;border-radius:8px;margin-bottom:16px;padding:12px 16px}.callout-danger[data-v-708d4457]{background-color:#f8d7da;border-left-color:#dc3545;color:#721c24}.callout i[data-v-708d4457]{margin-right:8px}.row[data-v-708d4457]{margin-bottom:1rem}.form-text[data-v-708d4457]{color:#6b7280;font-size:.875rem}.text-muted[data-v-708d4457]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-708d4457]{flex-direction:column;gap:10px}.card-footer .btn[data-v-708d4457]{margin-right:0!important;width:100%}.card-footer div[data-v-708d4457]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-708d4457]{font-size:12px}.table-custom tbody td[data-v-708d4457],.table-custom thead th[data-v-708d4457]{padding:8px 4px}}", ""]);
// Exports
