...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-04b3361f]{margin-bottom:15px}.footer-buttons[data-v-04b3361f]{display:flex;gap:10px}.footer-buttons .btn[data-v-04b3361f]{margin-right:10px}.footer-buttons .btn[data-v-04b3361f]:last-child{margin-right:0}.create-btn[data-v-04b3361f]{padding:11px}.chart-account-success[data-v-04b3361f],.chart-account-warning[data-v-04b3361f]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-04b3361f]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-04b3361f]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-04b3361f],.warning-content[data-v-04b3361f]{align-items:center;display:flex;gap:16px}.success-icon[data-v-04b3361f],.warning-icon[data-v-04b3361f]{flex-shrink:0;font-size:24px}.warning-icon[data-v-04b3361f]{color:#856404}.success-icon[data-v-04b3361f]{color:#155724}.success-text[data-v-04b3361f],.warning-text[data-v-04b3361f]{flex-grow:1}.success-title[data-v-04b3361f],.warning-title[data-v-04b3361f]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-04b3361f]{color:#856404}.success-title[data-v-04b3361f]{color:#155724}.success-description[data-v-04b3361f],.warning-description[data-v-04b3361f]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-04b3361f]{color:#856404}.success-description[data-v-04b3361f]{color:#155724}.warning-action[data-v-04b3361f]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-04b3361f]{padding:0}.btn-primary[data-v-04b3361f]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-04b3361f]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-04b3361f],.warning-content[data-v-04b3361f]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-04b3361f],.warning-action[data-v-04b3361f]{width:100%}}.client-status[data-v-04b3361f]{font-size:13px}.client-success[data-v-04b3361f],.client-warning[data-v-04b3361f]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-04b3361f]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-04b3361f]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-04b3361f]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.debug-panel[data-v-04b3361f]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-04b3361f]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-04b3361f]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-04b3361f]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-04b3361f]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-04b3361f]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-04b3361f]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-04b3361f]:last-child{border-bottom:none}.debug-display[data-v-04b3361f]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-04b3361f]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-04b3361f]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-04b3361f]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-04b3361f]:last-child{border-bottom:none}.debug-panel .table th[data-v-04b3361f]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-04b3361f]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-04b3361f]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-04b3361f]{padding:15px}.debug-item .row[data-v-04b3361f]{margin:0}.debug-item .col-md-6[data-v-04b3361f]{padding:0 5px}.debug-step[data-v-04b3361f]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-04b3361f]{font-size:.75em}}.btn-outline-warning[data-v-04b3361f]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-04b3361f]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-04b3361f]{font-size:13px}.product-success[data-v-04b3361f],.product-warning[data-v-04b3361f]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-04b3361f]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-04b3361f]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-04b3361f]{font-size:13px}.account-success[data-v-04b3361f],.account-warning[data-v-04b3361f]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-04b3361f]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-04b3361f]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-04b3361f]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-04b3361f]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-04b3361f]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-04b3361f]{cursor:pointer;margin-bottom:0}.text-warning[data-v-04b3361f]{color:#856404!important}.text-warning small[data-v-04b3361f]{font-size:12px;font-weight:500}.text-warning i[data-v-04b3361f]{margin-right:4px}.table-custom[data-v-04b3361f]{border:none!important}.invoices-create-table[data-v-04b3361f]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-04b3361f]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-04b3361f]{border:none!important}.invoices-create-table thead th[data-v-04b3361f]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-04b3361f]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-04b3361f]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-04b3361f]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.summary-footer-wrapper[data-v-04b3361f]{margin-top:10px}.summary-footer-row[data-v-04b3361f]{background-color:#f8f9fa;border-top:2px solid #dee2e6}.summary-footer-row[data-v-04b3361f]:last-child{border-bottom:2px solid #dee2e6}.summary-label[data-v-04b3361f]{color:#495057}.summary-label[data-v-04b3361f],.summary-value[data-v-04b3361f]{font-size:14px;padding:12px 16px}.summary-value[data-v-04b3361f]{color:#212529;text-align:left}.grand-total-row[data-v-04b3361f]{background-color:#e9ecef;border-top:3px solid #33a0d9}.grand-total-value[data-v-04b3361f]{color:#33a0d9;font-size:16px}[dir=rtl] .summary-label[data-v-04b3361f]{text-align:left}[dir=rtl] .summary-value[data-v-04b3361f]{text-align:right}@media (max-width:768px){.summary-label[data-v-04b3361f],.summary-value[data-v-04b3361f]{font-size:12px;padding:8px 12px}.grand-total-value[data-v-04b3361f]{font-size:14px}}.btn-group.c-w-100[data-v-04b3361f]{gap:10px}.card[data-v-04b3361f]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-04b3361f]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-04b3361f]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-04b3361f]{background:#fff!important}.quantity-field[data-v-04b3361f]{border-radius:0!important;margin:0!important;min-height:50px!important}.btn-primary[data-v-04b3361f]{background:#2ab930!important}.btn-secondary[data-v-04b3361f]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-04b3361f]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-04b3361f]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-04b3361f]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-04b3361f]{flex-grow:1}.stock-warning-title[data-v-04b3361f]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-04b3361f]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-04b3361f]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-04b3361f]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-04b3361f]:last-child{margin-bottom:0}.product-name[data-v-04b3361f]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-04b3361f]{color:#856404;opacity:.8}.stock-details strong[data-v-04b3361f]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-04b3361f]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-04b3361f]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-04b3361f]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-04b3361f]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-04b3361f]{align-self:center}.stock-warning-list[data-v-04b3361f]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-04b3361f]{text-align:right}}.clickable-badge[data-v-04b3361f]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-04b3361f]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-04b3361f]:active{transform:scale(.95)}.insufficient-stock-input[data-v-04b3361f]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important;margin:0 5px}.insufficient-stock-input[data-v-04b3361f]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.custom-qty-input input.button-minus[data-v-04b3361f],.custom-qty-input input.button-plus[data-v-04b3361f]{margin:0 5px}.product-option[data-v-04b3361f]{border-bottom:1px solid #e9ecef;padding:8px 12px}.product-option[data-v-04b3361f]:last-child{border-bottom:none}.product-option-header[data-v-04b3361f]{align-items:center;display:flex;flex-wrap:wrap;gap:6px;margin-bottom:6px}.product-option-header strong[data-v-04b3361f]{color:#333;font-size:14px;font-weight:600}.product-code[data-v-04b3361f]{color:#6c757d;font-size:12px;font-weight:500}.product-option-details[data-v-04b3361f]{color:#6c757d;display:flex;flex-wrap:wrap;font-size:12px;gap:12px;margin-top:4px}.product-detail-item[data-v-04b3361f]{align-items:center;display:inline-flex;gap:4px}.product-detail-item i[data-v-04b3361f]{color:#33a0d9;font-size:11px}.badge-sm[data-v-04b3361f]{font-size:10px;font-weight:500;padding:2px 6px}.badge-warning[data-v-04b3361f]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.v-select .vs__dropdown-option:hover .product-option[data-v-04b3361f]{background-color:#f8f9fa}.v-select .vs__dropdown-option--selected .product-option[data-v-04b3361f]{background-color:#e3f2fd}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=04b3361f&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
    ...
    attrs: {
      ...
      "label": "name",
      "name": "representative",
      "placeholder": _vm.$t('Select a sales representative')
    },
    on: {
    ...
    attrs: {
      ...
      "label": "name",
      "name": "cashier",
      "placeholder": _vm.$t('Select a cashier')
    },
    on: {
    ...
    staticClass: "ml-2"
  }, [_vm._v("\n                          " + _vm._s(_vm.$t('Product')) + " \"" + _vm._s(_vm.form.product.name) + "\" " + _vm._s(_vm.$t('needs Sales Account')) + "\n                        ")]), _vm._v(" "), _c('button', {
    staticClass: "btn btn-sm btn-outline-warning ml-2",
    attrs: {
      "type": "button",
    ...
    staticClass: "fas fa-exclamation-triangle"
  }), _vm._v("\n                        " + _vm._s(_vm.$t('At least one product must be selected')) + "\n                      ")])]) : _vm._e()], 1)])])]) : _vm._e(), _vm._v(" "), _c('ItemsTable', {
    attrs: {
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t("Total Tax")) + " (إجمالي الضريبة):")])]), _vm._v(" "), _c('td', {
    staticClass: "summary-value"
  }, [_vm._v("\n                        " + _vm._s(_vm.formatToTwoDecimals(_vm.totalProductTax)) + " "), _c('span', {
    staticClass: "saudi-riyal"
    ...
    staticClass: "summary-value"
  }, [_vm._v("\n                        " + _vm._s(_vm.formatToTwoDecimals(_vm.totalProductDiscount)) + " "), _c('span', {
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])]), _vm._v(" "), _c('td', {
    attrs: {
      "colspan": "6"
  ...
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t("Grand Total")) + " (المجموع):")])]), _vm._v(" "), _c('td', {
    staticClass: "summary-value grand-total-value"
  }, [_c('strong', [_vm._v(_vm._s(_vm.formatToTwoDecimals(_vm.form.netTotal)) + " "), _c('span', {
    staticClass: "saudi-riyal"
  }, [_vm._v("ê")])])]), _vm._v(" "), _c('td', {
    attrs: {
      "colspan": "6"
    }
  })])])])])]) : _vm._e(), _vm._v(" "), _vm.hasInsufficientStock ? _c('div', {
    ...
    staticClass: "form-group col-md-6"
  }, [_c('label', [_vm._v(_vm._s(_vm.$t("Payment Type")))]), _vm._v(" "), _c('div', {
    staticClass: "d-flex align-items-center"
  }, [_c('toggle-button', {
    staticClass: "mr-2",
    attrs: {
    ...
    staticClass: "ml-2"
  }, [_vm._v(_vm._s(_vm.form.isPaid ? _vm.$t("Paid") : _vm.$t("On Credit")))])], 1)]), _vm._v(" "), _vm.form.isPaid ? _c('div', {
    staticClass: "form-group col-md-6"
  }, [_c('label', {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Select")))]), _vm._v(" "), _vm._l(_vm.paymentMethods, function (method) {
    return _c('option', {
      key: method.id,
      domProps: {
        "value": method.id
...
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=04b3361f&scoped=true
    ...
    'form.discount_type': {
      handler: function handler(newVal) {
        if (newVal) {
          ...
          var newDiscountType = newVal === 'percentage' ? 1 : 0;
    ...
    'form.discount_value': {
      handler: function handler(newVal) {
        if (newVal !== null && newVal !== undefined) {
          ...
          var newDiscount = parseFloat(newVal) || 0;
  ...
  methods: {
    ...
    getClients: function getClients() {
      var _arguments = arguments,
        _this5 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var selectedClient, items, areClients, defaultClientSlug, defaultClient, _error$response, _error$response2, _error$response3;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 3:
              ...
              _this9.representatives = _this9.employees.filter(function (emp) {
                var designation = (emp.designation || '').toLowerCase();
                return designation === 'مندوب' || designation === 'sales representative' || designation === 'representative';
              });

              // Filter cashiers (كاشير in Arabic, Cashier in English)
              _this9.cashiers = _this9.employees.filter(function (emp) {
                var designation = (emp.designation || '').toLowerCase();
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              if (response.data && response.data.data) {
                _this0.paymentMethods = response.data.data;
              }
              _context7.next = 11;
              break;
            case 7:
              _context7.prev = 7;
              _context7.t0 = _context7["catch"](0);
              console.error('Error loading payment methods:', _context7.t0);
              // Fallback to empty array if API fails
              _this0.paymentMethods = [];
            case 11:
            case "end":
              return _context7.stop();
          }
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _context8.prev = 0;
              user = _this1.$store.getters['auth/user'];
            ...
            case 28:
              _this1.branches = branchesData;
              _context8.next = 35;
              break;
            case 31:
              _context8.prev = 31;
              _context8.t1 = _context8["catch"](0);
              console.error('Error getting branches:', _context8.t1);
              _this1.branches = [];
            case 35:
            case "end":
              return _context8.stop();
          }
        }, _callee8, null, [[0, 31], [13, 21]]);
      }))();
    },
      ...
      files.forEach(function (file) {
        ...
        if (file.size < 2 * 1024 * 1024) {
          ...
          toast.fire({
            ...
            text: _this10.$t("Please select a file with size less than 2 MB")
          });
        }
      });
    ...
    getTaxes: function getTaxes() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        var _yield$axios$get8, data, defaultVatRateSlug, _error$response0, _error$response1, _error$response10;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 3:
              ...
              _this11.taxes = data.data;

              // assign default vat rate
              if (_this11.taxes && _this11.taxes.length > 0) {
                defaultVatRateSlug = _this11.appInfo.defaultVatRateSlug;
                _this11.form.orderTax = _this11.taxes.find(function (tax) {
                  return tax.slug === defaultVatRateSlug;
                }) || _this11.taxes[0]; // Fallback to first available tax if default not found

                // Update any existing products with the default VAT rate if they don't have one
                if (_this11.form.selectedProducts && _this11.form.selectedProducts.length > 0) {
                  _this11.form.selectedProducts.forEach(function (item, index) {
                    if (!item.selectedVatRate) {
                      ...
                      _this11.generateItemTotalPrice(index);
                    }
                  });
                }
              }
              _this11.calculateSum();
              _context9.next = 14;
              break;
            case 10:
              _context9.prev = 10;
              _context9.t0 = _context9["catch"](0);
              console.error('Error getting taxes:', _context9.t0);

              // Show error toast for tax loading failures
              if (((_error$response0 = _context9.t0.response) === null || _error$response0 === void 0 ? void 0 : _error$response0.status) === 401) {
                toast.fire({
                  type: "error",
                  title: _this11.$t("Authentication Error"),
                  text: _this11.$t("You are not authorized to view tax rates. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response1 = _context9.t0.response) === null || _error$response1 === void 0 ? void 0 : _error$response1.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this11.$t("Permission Error"),
                  text: _this11.$t("You don't have permission to view tax rates."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response10 = _context9.t0.response) === null || _error$response10 === void 0 ? void 0 : _error$response10.status) >= 500) {
                toast.fire({
                  type: "error",
                  title: _this11.$t("Server Error"),
                  text: _this11.$t("Unable to load tax rates. Please try again later."),
                  timer: 5000,
                  timerProgressBar: true
                });
                ...
                toast.fire({
                  type: "error",
                  title: _this11.$t("Tax Loading Error"),
    ...
    ensureDiscountProperties: function ensureDiscountProperties() {
      ...
      this.form.selectedProducts.forEach(function (item) {
        ...
        if (typeof item.selectedVatRate === 'undefined') {
          // First try to use the product's default VAT rate, then fall back to invoice default
          if (item.productTax) {
            item.selectedVatRate = _this12.findMatchingVatRate(item.productTax);
          }

          // If no match found or no productTax, fall back to invoice default
          if (!item.selectedVatRate) {
            if (_this12.form.orderTax) {
              item.selectedVatRate = _this12.form.orderTax;
            } else if (_this12.taxes && _this12.taxes.length > 0) {
              item.selectedVatRate = _this12.taxes[0];
            }
          }
        }
      });
    ...
    calculateSum: function calculateSum() {
      ...
      var netTotalBeforeInvoiceDiscount = 0;
      if (this.isSaudiArabia) {
        ...
        netTotalBeforeInvoiceDiscount = this.roundToTwoDecimals(this.form.subTotal - globalDiscount + this.form.invoiceTax + Number(this.form.transportCost || 0));
      }
      ...
      var transportCost = Number(this.form.transportCost || 0);
      var grandTotal = this.roundToTwoDecimals(this.subtotal + this.totalProductTax + transportCost);
    ...
    allocateInvoiceDiscountProportionally: function allocateInvoiceDiscountProportionally(invoiceLevelDiscount) {
      ...
      if (!invoiceLevelDiscount || invoiceLevelDiscount <= 0) {
        ...
        this.form.selectedProducts.forEach(function (item, index) {
          if (item.proportionalDiscountAmount) {
            _this13.$set(_this13.form.selectedProducts[index], 'proportionalDiscountAmount', 0);
          }
        });
        return;
      }
      ...
      var totalLineAmounts = 0;
      var lineAmounts = [];
      this.form.selectedProducts.forEach(function (item) {
        var unitPriceNumber = Number(item.unitPrice) || 0;
        var qtyNumber = Number(item.qty) || 0;
        var totalBeforeDiscount = unitPriceNumber * qtyNumber;
        ...
        var lineAmount = totalBeforeDiscount - productDiscount;
      ...
      this.form.selectedProducts.forEach(function (item, index) {
        var lineAmount = lineAmounts[index] || 0;
        var proportionalAmount = 0;
        if (totalLineAmounts > 0 && lineAmount > 0) {
          // Calculate proportional share
          var proportion = lineAmount / totalLineAmounts;
          proportionalAmount = _this13.roundToTwoDecimals(invoiceLevelDiscount * proportion);
          allocatedTotal += proportionalAmount;
        }

        // Store proportional discount amount
        _this13.$set(_this13.form.selectedProducts[index], 'proportionalDiscountAmount', proportionalAmount);
      });
    ...
    allocateTransportCostProportionally: function allocateTransportCostProportionally(transportCost) {
      ...
      if (!transportCost || transportCost <= 0) {
        ...
        this.form.selectedProducts.forEach(function (item, index) {
          if (item.proportionalTransportAmount) {
            _this14.$set(_this14.form.selectedProducts[index], 'proportionalTransportAmount', 0);
          }
        });
        return;
      }
      ...
      this.form.selectedProducts.forEach(function (item) {
        ...
        var netAmount = item.netTotal || item.totalAfterDiscount || 0;
        ...
        if (!netAmount) {
          ...
          var proportionalDiscount = item.proportionalDiscountAmount || 0;
          var totalDiscount = productDiscount + proportionalDiscount;
      ...
      var allocatedTotal = 0;
      this.form.selectedProducts.forEach(function (item, index) {
        var netAmount = netAmounts[index] || 0;
        var proportionalAmount = 0;
        if (totalNetAmounts > 0 && netAmount > 0) {
          // Calculate proportional share based on net amount
          var proportion = netAmount / totalNetAmounts;
          proportionalAmount = _this14.roundToTwoDecimals(transportCost * proportion);
          allocatedTotal += proportionalAmount;
        }

        // Store proportional transport amount (for reporting/display only)
        _this14.$set(_this14.form.selectedProducts[index], 'proportionalTransportAmount', proportionalAmount);
      });
    ...
    recalculateAllItemsWithProportionalDiscount: function recalculateAllItemsWithProportionalDiscount() {
      ...
      this.form.selectedProducts.forEach(function (item, index) {
        ...
        _this15.calculateItemAmounts(index);
      });
    },
    ...
    onFileChange: function onFileChange(e) {
      ...
      if (file.size < 2111775 && (file.type === "image/jpeg" || file.type === "image/png" || file.type === "image/gif")) {
        reader.onloadend = function () {
          _this16.formClient.image = reader.result;
        };
        reader.readAsDataURL(file);
        this.url = URL.createObjectURL(file);
      } else {
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              ...
              validationErrors = [];
              if (!_this17.form.client || !_this17.form.client.chart_of_account_id) {
                validationErrors.push({
                  type: "warning",
                  title: _this17.$t("Chart of Account Required"),
                  message: _this17.$t("Client must have a Chart of Account assigned before creating an invoice."),
                  field: "client"
                });
              }
              if (!_this17.form.selectedProducts || _this17.form.selectedProducts.length === 0) {
                validationErrors.push({
                  type: "warning",
                  title: _this17.$t("No Products Selected"),
                  message: _this17.$t("Please select at least one product to create an invoice."),
                  field: "selectedProducts"
                });
              }

              // Validate that all products have sales accounts assigned
              productsWithoutSalesAccount = _this17.form.selectedProducts.filter(function (product) {
                return !product.sales_account_id;
              });
              if (productsWithoutSalesAccount.length > 0) {
                ...
                validationErrors.push({
                  type: "warning",
                  title: _this17.$t("Product Chart of Account Required"),
                  message: _this17.$t("The following products must have Sales Accounts assigned: ") + productNames,
                  field: "products",
                  timer: 8000,
                  timerProgressBar: true
                });
              ...
              _this17.showMultipleValidationErrors(validationErrors);
              return _context0.abrupt("return");
            case 13:
              _this17.loading = true;

              // If attachments exist, use FormData; otherwise use regular form.post()
              if (!(_this17.form.attachments && _this17.form.attachments.length > 0)) {
                _context0.next = 66;
                break;
              }
              // Create FormData for file uploads
              formDataObj = _this17.form.data();
              ...
              _this17.syncDiscountFields();
              appendIfDefined('discountType', _this17.form.discountType);
              appendIfDefined('discount', _this17.form.discount);
              ...
              _this17.form.attachments.forEach(function (file) {
                if (file instanceof File) {
            ...
            case 54:
              _yield$axios$post = _context0.sent;
              data = _yield$axios$post.data;
              _this17.loading = false;
              if (data.success) {
                toast.fire({
                  type: "success",
                  title: _this17.$t("Success"),
                  text: _this17.$t("Invoice created successfully")
                });
                ...
                if (data.data.journal_entries_created) {
                  setTimeout(function () {
                    toast.fire({
                      type: "success",
                      title: _this17.$t("Journal Entries Created"),
                      text: _this17.$t("Journal entries have been automatically created for this invoice"),
                      timer: 4000,
                      timerProgressBar: true
                    });
                  }, 500);
            ...
            case 60:
              _context0.prev = 60;
              _context0.t0 = _context0["catch"](51);
              _this17.loading = false;
              throw _context0.t0;
            case 64:
              _context0.next = 72;
            ...
            case 66:
              _context0.next = 68;
              return _this17.form.post(window.location.origin + "/api/invoices");
            case 68:
              _yield$_this17$form$p = _context0.sent;
              _data3 = _yield$_this17$form$p.data;
              _this17.loading = false;
              if (_data3.success) {
                toast.fire({
                  type: "success",
            ...
            case 74:
              ...
              _this17.loading = false;
              console.error('Invoice creation error:', _context0.t1);

              // Handle validation errors specifically
              if (!(((_error$response11 = _context0.t1.response) === null || _error$response11 === void 0 ? void 0 : _error$response11.status) === 422 && (_error$response12 = _context0.t1.response) !== null && _error$response12 !== void 0 && (_error$response12 = _error$response12.data) !== null && _error$response12 !== void 0 && _error$response12.errors)) {
                _context0.next = 84;
                break;
              }
              _validationErrors = _context0.t1.response.data.errors; // Show validation errors in toast
              Object.keys(_validationErrors).forEach(function (field) {
                ...
                if (Array.isArray(fieldErrors) && fieldErrors.length > 0) {
                  ...
                  toast.fire({
                    type: "error",
                    title: _this17.$t("Validation Error"),
                    text: "".concat(_this17.getFieldLabel(field), ": ").concat(fieldErrors[0]),
                    timer: 5000,
                    timerProgressBar: true
                  });
                }
              ...
              _this17.form.errors.set(_validationErrors);
              _context0.next = 95;
              break;
            case 84:
              if (!(((_error$response13 = _context0.t1.response) === null || _error$response13 === void 0 ? void 0 : _error$response13.status) === 400)) {
                _context0.next = 94;
                break;
              }
              // Handle bad request errors (business logic errors)
              errorMessage = _context0.t1.response.data.message || _context0.t1.response.data.error || _this17.$t("Bad Request Error");
              _validationErrors2 = _context0.t1.response.data.validation_errors;
              errorCount = _context0.t1.response.data.error_count; // If we have multiple validation errors from the backend, show them all
              if (!(_validationErrors2 && Array.isArray(_validationErrors2) && _validationErrors2.length > 0)) {
                _context0.next = 91;
                break;
              }
              _this17.showBackendValidationErrors(_validationErrors2, errorMessage);
              return _context0.abrupt("return");
            case 91:
              // Try to handle as business logic error first
              if (!_this17.handleBusinessLogicError(_context0.t1.response.data)) {
                // If not handled by business logic handler, show generic bad request error
                toast.fire({
                  type: "error",
                  title: _this17.$t("Business Logic Error"),
                  text: errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              ...
              break;
            case 94:
              if (((_error$response14 = _context0.t1.response) === null || _error$response14 === void 0 ? void 0 : _error$response14.status) === 401) {
              ...
              } else if (((_error$response15 = _context0.t1.response) === null || _error$response15 === void 0 ? void 0 : _error$response15.status) === 403) {
                // Handle forbidden errors
                toast.fire({
                  type: "error",
                  title: _this17.$t("Permission Error"),
                  text: _this17.$t("You don't have permission to perform this action."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response16 = _context0.t1.response) === null || _error$response16 === void 0 ? void 0 : _error$response16.status) === 404) {
                // Handle not found errors
                toast.fire({
                  type: "error",
                  title: _this17.$t("Resource Not Found"),
                  text: _this17.$t("The requested resource was not found. Please check your data and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response17 = _context0.t1.response) === null || _error$response17 === void 0 ? void 0 : _error$response17.status) === 409) {
                // Handle conflict errors
                _errorMessage = _context0.t1.response.data.message || _this17.$t("Data Conflict Error");
                toast.fire({
                  type: "error",
                  title: _this17.$t("Data Conflict"),
                  text: _errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (((_error$response18 = _context0.t1.response) === null || _error$response18 === void 0 ? void 0 : _error$response18.status) === 422) {
                // Handle other unprocessable entity errors
                _errorMessage2 = _context0.t1.response.data.message || _this17.$t("Please check your input and try again.");
                toast.fire({
                  type: "error",
                  title: _this17.$t("Validation Error"),
                  text: _errorMessage2,
              ...
              } else if (((_error$response19 = _context0.t1.response) === null || _error$response19 === void 0 ? void 0 : _error$response19.status) >= 500) {
                // Handle server errors
                _errorMessage3 = _context0.t1.response.data.message || _this17.$t("Server Error");
                toast.fire({
                  type: "error",
                  title: _this17.$t("Server Error"),
                  text: "".concat(_errorMessage3, " (").concat(_this17.$t("Please try again later or contact support"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else if ((_error$response20 = _context0.t1.response) !== null && _error$response20 !== void 0 && (_error$response20 = _error$response20.data) !== null && _error$response20 !== void 0 && _error$response20.message) {
                // Handle other API error messages
                toast.fire({
                  type: "error",
                  title: _this17.$t("API Error"),
                  text: _context0.t1.response.data.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_context0.t1.message) {
                // Handle JavaScript errors
                toast.fire({
                  type: "error",
                  title: _this17.$t("JavaScript Error"),
                  text: _context0.t1.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_context0.t1.code === 'NETWORK_ERROR' || _context0.t1.code === 'ECONNABORTED') {
                // Handle network errors
                toast.fire({
                  type: "error",
                  title: _this17.$t("Network Error"),
                  text: _this17.$t("Unable to connect to the server. Please check your internet connection and try again."),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else {
                ...
                ErrorHandler.handleApiError(_context0.t1, {
            ...
            case 95:
              ...
              console.error('Error object:', _context0.t1);
              console.error('Error response:', _context0.t1.response);
              console.error('Error message:', _context0.t1.message);
              console.error('Error stack:', _context0.t1.stack);
              console.groupEnd();
            case 101:
            case "end":
              return _context0.stop();
          }
        }, _callee0, null, [[0, 74], [51, 60]]);
      }))();
    },
    ...
    formatFormValues: function formatFormValues() {
      ...
      this.form.selectedProducts.forEach(function (item) {
        item.unitPrice = _this18.roundToTwoDecimals(Number(item.unitPrice));
        item.qty = Number(item.qty);
        item.productTax = _this18.roundToTwoDecimals(Number(item.productTax));
        item.totalTax = _this18.roundToTwoDecimals(Number(item.totalTax));
        item.totalPrice = _this18.roundToTwoDecimals(Number(item.totalPrice));
        item.unitCost = _this18.roundToTwoDecimals(Number(item.unitCost));
        item.discount = _this18.roundToTwoDecimals(Number(item.discount || 0));
        item.discountAmount = _this18.roundToTwoDecimals(Number(item.discountAmount || 0));
      });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee1() {
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            case 0:
              _context1.next = 2;
              return _this19.formClient.post(window.location.origin + "/api/clients").then(function () {
                toast.fire({
                  type: "success",
                  title: _this19.$t("Client added successfully")
                });
                _this19.showClientCreateModal = false;
                _this19.getClients();
                _this19.formClient.reset();
                _this19.url = null;
              })["catch"](function (error) {
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        var currentClientSlug, response, newAccountId, idx, _error$response21, _error$response22, _error$response23, _error$response24, _error$response25, _error$response26, errorMessage, _errorMessage4;
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              if (!(!_this20.form.client || _this20.isAutoAssigningClient)) {
                _context10.next = 2;
                break;
              }
              return _context10.abrupt("return");
            case 2:
              _this20.isAutoAssigningClient = true;
              _context10.prev = 3;
              // Store the current client slug before making the API call
              currentClientSlug = _this20.form.client.slug;
              _context10.next = 7;
              return _this20.$http.post("/api/clients/".concat(_this20.form.client.slug, "/auto-assign-chart-of-account"));
            case 7:
              ...
              if (response.data.success) {
                ...
                if (newAccountId) {
                  _this20.form.client.chart_of_account_id = newAccountId;
                  // Also update the option in items list to keep state consistent when switching clients
                  idx = _this20.items.findIndex(function (i) {
                    return i.slug === currentClientSlug;
                  });
                  if (idx !== -1) {
                    _this20.$set(_this20.items[idx], 'chart_of_account_id', newAccountId);
                  }
                }
                ...
                toast.fire({
                  type: "success",
                  title: _this20.$t("Chart of Account assigned successfully")
                });
              } else {
                toast.fire({
                  type: "error",
                  title: _this20.$t("Failed to assign Chart of Account"),
                  text: response.data.message || _this20.$t("Please try again or assign manually")
                });
              }
              _context10.next = 15;
              break;
            case 11:
              ...
              console.error('Error auto-assigning chart of account:', _context10.t0);

              // Handle different types of errors
              if (((_error$response21 = _context10.t0.response) === null || _error$response21 === void 0 ? void 0 : _error$response21.status) === 400) {
                errorMessage = _context10.t0.response.data.message || _this20.$t("Bad request error");
                toast.fire({
                  type: "error",
                  title: _this20.$t("Assignment Failed"),
                  text: errorMessage,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (((_error$response22 = _context10.t0.response) === null || _error$response22 === void 0 ? void 0 : _error$response22.status) === 401) {
                toast.fire({
                  type: "error",
                  title: _this20.$t("Authentication Error"),
                  text: _this20.$t("You are not authorized to perform this action. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response23 = _context10.t0.response) === null || _error$response23 === void 0 ? void 0 : _error$response23.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this20.$t("Permission Error"),
                  text: _this20.$t("You don't have permission to assign Chart of Accounts."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response24 = _context10.t0.response) === null || _error$response24 === void 0 ? void 0 : _error$response24.status) === 404) {
                toast.fire({
                  type: "error",
                  title: _this20.$t("Client Not Found"),
                  text: _this20.$t("The client was not found. Please refresh the page and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response25 = _context10.t0.response) === null || _error$response25 === void 0 ? void 0 : _error$response25.status) >= 500) {
                _errorMessage4 = _context10.t0.response.data.message || _this20.$t("Server error");
                toast.fire({
                  type: "error",
                  title: _this20.$t("Server Error"),
                  text: "".concat(_errorMessage4, " (").concat(_this20.$t("Please try again later"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else if ((_error$response26 = _context10.t0.response) !== null && _error$response26 !== void 0 && (_error$response26 = _error$response26.data) !== null && _error$response26 !== void 0 && _error$response26.message) {
                toast.fire({
                  type: "error",
                  title: _this20.$t("Assignment Failed"),
                ...
                toast.fire({
                  type: "error",
                  title: _this20.$t("Failed to assign Chart of Account"),
                  text: _this20.$t("Please try again or assign manually"),
                  timer: 5000,
                  timerProgressBar: true
                });
              }
            case 15:
              _context10.prev = 15;
              _this20.isAutoAssigningClient = false;
    ...
    clearProductErrors: function clearProductErrors(index) {
      ...
      fields.forEach(function (field) {
        ...
        if (_this22.form.errors.has(errorKey)) {
          _this22.form.errors.clear(errorKey);
        }
      });
    },
    ...
    setupGlobalErrorHandling: function setupGlobalErrorHandling() {
      ...
      this.unhandledRejectionHandler = function (event) {
        ...
        _this23.handleGlobalError(event.reason, 'Promise rejection');
      };

      // Handle unhandled errors
      this.unhandledErrorHandler = function (event) {
        console.error('Unhandled error:', event.error);
        _this23.handleGlobalError(event.error, 'JavaScript error');
      };
    ...
    autoAssignProductChartOfAccount: function autoAssignProductChartOfAccount(product) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
        var type, response, exists, _error$response27, _error$response28, _error$response29, _error$response30, _error$response31, _error$response32, errorMessage, _errorMessage5;
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 3:
              ...
              _context11.prev = 4;
              _context11.next = 7;
              return _this24.$http.post("/api/products/".concat(product.slug, "/").concat(type, "/auto-assign-chart-of-account"));
            case 7:
              response = _context11.sent;
              if (response.data.success) {
                ...
                exists = _this24.form.selectedProducts && _this24.form.selectedProducts.some(function (p) {
                  return p.id === product.id;
                });
                if (!exists) {
                  _this24.storeProduct(product);
                }
                ...
                toast.fire({
                  type: "success",
                  title: _this24.$t("Chart of Account assigned successfully")
                });
              } else {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Failed to assign Chart of Account"),
            ...
            case 11:
              ...
              console.error('Error auto-assigning chart of account for product:', _context11.t0);

              // Handle different types of errors
              if (((_error$response27 = _context11.t0.response) === null || _error$response27 === void 0 ? void 0 : _error$response27.status) === 400) {
                errorMessage = _context11.t0.response.data.message || _this24.$t("Bad request error");
                toast.fire({
                  type: "error",
              ...
              } else if (((_error$response28 = _context11.t0.response) === null || _error$response28 === void 0 ? void 0 : _error$response28.status) === 401) {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Authentication Error"),
                  text: _this24.$t("You are not authorized to perform this action. Please log in again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response29 = _context11.t0.response) === null || _error$response29 === void 0 ? void 0 : _error$response29.status) === 403) {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Permission Error"),
                  text: _this24.$t("You don't have permission to assign Chart of Accounts."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response30 = _context11.t0.response) === null || _error$response30 === void 0 ? void 0 : _error$response30.status) === 404) {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Product Not Found"),
                  text: _this24.$t("The product was not found. Please refresh the page and try again."),
                  timer: 5000,
                  timerProgressBar: true
                });
              } else if (((_error$response31 = _context11.t0.response) === null || _error$response31 === void 0 ? void 0 : _error$response31.status) >= 500) {
                _errorMessage5 = _context11.t0.response.data.message || _this24.$t("Server error");
                toast.fire({
                  type: "error",
                  title: _this24.$t("Server Error"),
                  text: "".concat(_errorMessage5, " (").concat(_this24.$t("Please try again later"), ")"),
                  timer: 8000,
                  timerProgressBar: true
                });
              } else if ((_error$response32 = _context11.t0.response) !== null && _error$response32 !== void 0 && (_error$response32 = _error$response32.data) !== null && _error$response32 !== void 0 && _error$response32.message) {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Please try again or assign manually"),
                  text: _context11.t0.response.data.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else if (_context11.t0.message) {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Please try again or assign manually"),
                  text: _context11.t0.message,
                  timer: 6000,
                  timerProgressBar: true
                });
              } else {
                toast.fire({
                  type: "error",
                  title: _this24.$t("Failed to assign Chart of Account"),
                  text: _this24.$t("Please try again or assign manually"),
                  timer: 5000,
                  timerProgressBar: true
                });
              }
    ...
    showAllInsufficientStock: function showAllInsufficientStock() {
      ...
      insufficientProducts.forEach(function (product, index) {
        ...
        message += "   ".concat(_this25.$t("Required"), ": ").concat(product.qty, ", ").concat(_this25.$t("Available"), ": ").concat(product.inventoryCount, ", ").concat(_this25.$t("Shortage"), ": ").concat(shortage, "\n\n");
      });
      ...
      if (this.form.selectedProducts && this.form.selectedProducts.length > 0) {
        this.form.selectedProducts.forEach(function (item, index) {
          if (!item.selectedVatRate) {
            ...
            } else if (_this26.form.orderTax) {
              item.selectedVatRate = _this26.form.orderTax;
            } else if (_this26.taxes && _this26.taxes.length > 0) {
              item.selectedVatRate = _this26.taxes[0];
            }
    ...
    recalculateAllVatAmounts: function recalculateAllVatAmounts() {
      ...
      if (this.form.selectedProducts && this.form.selectedProducts.length > 0) {
        this.form.selectedProducts.forEach(function (item, index) {
          _this27.generateItemTotalPrice(index);
        });
        this.calculateSum();
      }
    },
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              ...
              _this28.isSubmitting = true;
              _context12.prev = 1;
              if (!(_this28.form.addPayment == 1)) {
                _context12.next = 8;
                break;
              }
              paymentValidation = _this28.validatePaymentFields();
              if (paymentValidation.isValid) {
                _context12.next = 8;
                break;
              }
              event.preventDefault();
              _this28.showPaymentValidationErrors();
              return _context12.abrupt("return");
            case 8:
              _context12.next = 10;
              return _this28.saveInvoice();
            case 10:
              _context12.prev = 10;
              // Reset submitting flag
              _this28.isSubmitting = false;
              return _context12.finish(10);
            case 13:
            case "end":
              return _context12.stop();
          }
        }, _callee12, null, [[1,, 10, 13]]);
      }))();
    },
    // on account change
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_04b3361f_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_04b3361f_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_04b3361f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=04b3361f&prod&scoped=true&lang=css
