"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4482],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-c01df8dc]{gap:10px}.header-buttons[data-v-c01df8dc]{margin-bottom:15px}.footer-buttons[data-v-c01df8dc]{display:flex;gap:10px}.footer-buttons .btn[data-v-c01df8dc]{margin-right:10px}.footer-buttons .btn[data-v-c01df8dc]:last-child{margin-right:0}.card[data-v-c01df8dc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-c01df8dc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-c01df8dc]{background:#fff!important}.btn-primary[data-v-c01df8dc]{background:#2ab930!important}.btn-primary[data-v-c01df8dc],.btn-secondary[data-v-c01df8dc]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-c01df8dc]{background:#33a0d9!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/clients/edit.vue?vue&type=template&id=c01df8dc&scoped=true
  ...
  methods: {
    ...
    saveClient: function saveClient(formData) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var hasFiles, requestData, config, fd, appendIfDefined, phoneNumberValue, phoneNumberToSend, _iterator, _step, pair, url, response;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 7:
              ...
              hasFiles = formData.image && formData.image instanceof File || Array.isArray(formData.attachments) && formData.attachments.some(function (f) {
              ...
              if (hasFiles) {
                ...
                if (phoneNumberValue === undefined || phoneNumberValue === null) {
                  ...
                  if (_this4.$refs.clientForm && _this4.$refs.clientForm.form) {
                    phoneNumberValue = _this4.$refs.clientForm.form.phoneNumber;
                  }
                }
                // Ensure we have a string value (even if empty)
                phoneNumberValue = phoneNumberValue || '';
                console.log('Adding phoneNumber to FormData:', phoneNumberValue);
                console.log('phoneNumber type:', _typeof(phoneNumberValue));
              ...
              url = "/api/clients/".concat(_this4.clientData.slug);
              if (!hasFiles) {
                _context3.next = 24;
                break;
              }
              _context3.next = 21;
              return _this4.$http.post(url, requestData, config);
            case 21:
            ...
            case 24:
              _context3.next = 26;
              return _this4.$http.put(url, requestData, config);
            case 26:
              _context3.t0 = _context3.sent;
            case 27:
            ...
            case 39:
              ...
              console.error("Error saving client:", _context3.t1);
              if (window.toast && typeof window.toast.fire === 'function') {
                window.toast.fire({
                  type: "error",
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_c01df8dc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const clients_editvue_type_style_index_0_id_c01df8dc_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_c01df8dc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/clients/edit.vue?vue&type=style&index=0&id=c01df8dc&prod&scoped=true&lang=css
