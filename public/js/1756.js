  ...
  methods: {
    ...
    loadBranches: function loadBranches() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var user, isSuperAdmin, branchesData, response, _response, fallbackResponse;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 23:
              fallbackResponse = _context.sent;
            ...
            case 28:
              ...
              console.error('Error loading branches:', _context.t1);
              _this.branches = [];
              toast.fire({
                type: 'error',
                title: _this.$t('Error'),
    ...
    getAnalyticalAccount: function getAnalyticalAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _yield$axios$get, data, accountData, statusValue, _error$response;
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              toast.fire({
                ...
                text: ((_error$response = _context2.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this2.$t("Failed to load analytical account.")
              });
              _this2.$router.push({
                name: "analyticalAccounts.index"
              });
