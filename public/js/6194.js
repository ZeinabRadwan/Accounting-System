"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6194],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/collection-by-user-report.vue?vue&type=template&id=75056080&scoped=true
...
var update = injectStylesIntoStyleTag_default()(collection_by_user_reportvue_type_style_index_0_id_75056080_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_collection_by_user_reportvue_type_style_index_0_id_75056080_prod_scoped_true_lang_css = (collection_by_user_reportvue_type_style_index_0_id_75056080_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/collection-by-user-report.vue?vue&type=style&index=0&id=75056080&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".refresh-btn[data-v-75056080]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-75056080],.export-pdf-btn[data-v-75056080],.preview-btn[data-v-75056080]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-75056080],.export-pdf-btn[data-v-75056080],.preview-btn[data-v-75056080],.print-btn[data-v-75056080]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-75056080]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-75056080]{gap:10px}.card[data-v-75056080]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-75056080]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-75056080]{padding:1.25rem}.form-control[data-v-75056080]{background:#fff!important}@media (max-width:1300px){.info-box[data-v-75056080]{padding:0}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
