"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1974],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-ee4e01b6]{gap:10px}.header-buttons[data-v-ee4e01b6]{margin-bottom:15px}.footer-buttons[data-v-ee4e01b6]{display:flex;gap:10px}.footer-buttons .btn[data-v-ee4e01b6]{margin-right:10px}.footer-buttons .btn[data-v-ee4e01b6]:last-child{margin-right:0}.card[data-v-ee4e01b6]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-ee4e01b6]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-ee4e01b6]{padding:1.25rem}.card-footer[data-v-ee4e01b6]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-ee4e01b6]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-ee4e01b6]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-ee4e01b6]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-ee4e01b6]{color:#dc3545;font-weight:700}.btn-primary[data-v-ee4e01b6]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-ee4e01b6]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-ee4e01b6]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-ee4e01b6]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-ee4e01b6]{border-color:#dc3545!important}textarea.form-control[data-v-ee4e01b6]{min-height:100px;resize:vertical}.v-select[data-v-ee4e01b6]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-ee4e01b6]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-ee4e01b6]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-ee4e01b6]{border-color:#dc3545!important}.custom-file-input[data-v-ee4e01b6],.custom-file-label[data-v-ee4e01b6]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.custom-file-label[data-v-ee4e01b6]{color:#6c757d}.custom-file-input:focus~.custom-file-label[data-v-ee4e01b6]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.bg-light[data-v-ee4e01b6]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;margin-top:10px;padding:10px}.img-fluid[data-v-ee4e01b6]{border-radius:8px;height:auto;max-width:100%}.row[data-v-ee4e01b6]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-ee4e01b6]{flex-direction:column;gap:10px}.card-footer .btn[data-v-ee4e01b6]{margin-right:0!important;width:100%}.card-footer div[data-v-ee4e01b6]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/create.vue?vue&type=template&id=ee4e01b6&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payroll/create.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./resources/js/pages/payroll/create.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_ee4e01b6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const payroll_createvue_type_style_index_0_id_ee4e01b6_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_ee4e01b6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/payroll/create.vue?vue&type=style&index=0&id=ee4e01b6&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/payroll/create.vue
