...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/suppliers/purchase/create.vue?vue&type=template&id=3355cec5&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_3355cec5_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchase_createvue_type_style_index_0_id_3355cec5_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_3355cec5_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payments/suppliers/purchase/create.vue?vue&type=style&index=0&id=3355cec5&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-3355cec5]{gap:10px}.header-buttons[data-v-3355cec5]{margin-bottom:15px}.card[data-v-3355cec5]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-3355cec5]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-3355cec5]{padding:1.25rem}.card-footer[data-v-3355cec5]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.footer-buttons[data-v-3355cec5]{display:flex;gap:10px}.footer-buttons .btn[data-v-3355cec5]{margin-right:10px}.footer-buttons .btn[data-v-3355cec5]:last-child{margin-right:0}.form-control[data-v-3355cec5]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-3355cec5]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-3355cec5]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-3355cec5]{color:#dc3545;font-weight:700}.btn-primary[data-v-3355cec5]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-3355cec5]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-3355cec5]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-3355cec5]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.btn-danger[data-v-3355cec5]{background:#dc3545!important;border:none!important;border-radius:8px!important;color:#fff!important;font-weight:500;padding:8px 12px!important}.btn-danger[data-v-3355cec5]:hover{background:#c82333!important;box-shadow:0 4px 8px rgba(220,53,69,.3);transform:translateY(-1px)}.is-invalid[data-v-3355cec5]{border-color:#dc3545!important}textarea.form-control[data-v-3355cec5]{min-height:100px;resize:vertical}.v-select[data-v-3355cec5]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-3355cec5]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-3355cec5]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-3355cec5]{border-color:#dc3545!important}.bg-light[data-v-3355cec5]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;margin-bottom:15px}.bg-light .card-header[data-v-3355cec5]{background-color:#e9ecef!important;border-bottom:1px solid #dee2e6;border-radius:10px 10px 0 0;color:#495057;font-weight:600;padding:12px 16px}.bg-light .card-body[data-v-3355cec5]{padding:16px}.d-flex[data-v-3355cec5]{align-items:center;display:flex!important}.pr-5[data-v-3355cec5]{padding-right:3rem!important}.row[data-v-3355cec5]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-3355cec5]{flex-direction:column;gap:10px}.card-footer .btn[data-v-3355cec5]{margin-right:0!important;width:100%}.card-footer div[data-v-3355cec5]{display:flex;flex-direction:column;gap:10px;width:100%}.pr-5[data-v-3355cec5]{padding-right:1rem!important}}", ""]);
// Exports
