(self["webpackChunk"] = self["webpackChunk"] || []).push([[1146],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/employees/increments/index.vue?vue&type=template&id=3cc56da5&scoped=true
var render = function render() {
  ...
  return _c('div', {
    ...
    }, [_c('ul', [_vm.$can('increment-view') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
          name: 'increments.show',
          params: {
    ...
    }, [_vm._v(_vm._s(_vm.$t('View')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('increment-edit') ? _c('li', [_c('router-link', {
      attrs: {
        "to": {
    ...
    }, [_vm._v(_vm._s(_vm.$t('Edit')))])], 1) : _vm._e(), _vm._v(" "), _vm.$can('increment-delete') ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
...
var update = injectStylesIntoStyleTag_default()(incrementsvue_type_style_index_0_id_3cc56da5_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const employees_incrementsvue_type_style_index_0_id_3cc56da5_prod_scoped_true_lang_css = (incrementsvue_type_style_index_0_id_3cc56da5_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/employees/increments/index.vue?vue&type=style&index=0&id=3cc56da5&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-3cc56da5]{border:none!important}.increments-table[data-v-3cc56da5]{border-collapse:separate;border-spacing:0}.increments-table thead th[data-v-3cc56da5]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.increments-table thead tr[data-v-3cc56da5]{border:none!important}.increments-table thead th[data-v-3cc56da5]:first-child{border-top-left-radius:10px}.increments-table thead th[data-v-3cc56da5]:last-child{border-top-right-radius:10px}[dir=rtl] .increments-table thead th[data-v-3cc56da5]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .increments-table thead th[data-v-3cc56da5]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-3cc56da5]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-3cc56da5],.export-pdf-btn[data-v-3cc56da5]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-3cc56da5],.export-pdf-btn[data-v-3cc56da5],.print-btn[data-v-3cc56da5]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-3cc56da5]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-3cc56da5]{display:inline-block;position:relative}.action-icon-btn[data-v-3cc56da5]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-3cc56da5]{background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 8px 20px 0 #00000014;min-width:180px;position:absolute;right:0;top:48px;z-index:10}.action-menu ul[data-v-3cc56da5]{list-style:none;margin:0;padding:8px 0}.action-menu li a[data-v-3cc56da5]{color:#023033;display:block;padding:10px 16px;text-align:center;text-decoration:none}.action-menu li a[data-v-3cc56da5]:hover{background:#f1f5fb}.btn-group.c-w-100[data-v-3cc56da5]{gap:10px}.btn-group.c-w-100>.btn[data-v-3cc56da5]{border-radius:10px!important}.btn-group.c-w-100>.btn[data-v-3cc56da5]:first-child{border-bottom-right-radius:10px!important;border-top-right-radius:10px!important}.btn-group.c-w-100>.btn[data-v-3cc56da5]:last-child{border-bottom-left-radius:10px!important;border-top-left-radius:10px!important}.card[data-v-3cc56da5]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-3cc56da5]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.increments-table .badge.bg-success[data-v-3cc56da5]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.increments-table .badge.bg-danger[data-v-3cc56da5]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-3cc56da5]{background:#f1f5fb!important}.btn-primary[data-v-3cc56da5]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-3cc56da5]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-3cc56da5]{align-items:center;color:#6c757d;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
