"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7506],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-004d20eb]{gap:10px}.header-buttons[data-v-004d20eb]{margin-bottom:15px}.footer-buttons[data-v-004d20eb]{display:flex;gap:10px}.footer-buttons .btn[data-v-004d20eb]{margin-right:10px}.footer-buttons .btn[data-v-004d20eb]:last-child{margin-right:0}.card[data-v-004d20eb]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-004d20eb]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-004d20eb]{background:#fff!important}.btn-primary[data-v-004d20eb]{background:#2ab930!important}.btn-primary[data-v-004d20eb],.btn-secondary[data-v-004d20eb]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-004d20eb]{background:#33a0d9!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/assets/edit.vue?vue&type=template&id=004d20eb&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_004d20eb_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const assets_editvue_type_style_index_0_id_004d20eb_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_004d20eb_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/assets/edit.vue?vue&type=style&index=0&id=004d20eb&prod&scoped=true&lang=css
