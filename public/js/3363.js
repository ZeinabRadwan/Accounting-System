"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3363],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/domains/index.vue?vue&type=template&id=38092afa
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var row = _ref.row;
        return [row.is_domain ? _c('span', [_vm._v("Domain")]) : _c('span', [_vm._v("Sub Domain")])];
      }
    }, {
      key: "cell-fallback",
      fn: function fn(_ref2) {
        var row = _ref2.row;
        return [row.is_fallback ? _c('span', {
      ...
      fn: function fn(_ref4) {
        ...
        return [row.id ? _c('div', {
        ...
        }, [row.is_fallback && row.is_primary ? _c('span', [_vm._v("\n                  " + _vm._s(_vm.$t('No action available')) + "\n                ")]) : _vm._e(), _vm._v(" "), !row.is_primary ? _c('a', {
          directives: [{
            name: "tooltip",
            rawName: "v-tooltip",
          ...
          on: {
            "click": function click($event) {
              return _vm.makePrimary(row.id);
            }
          }
        }, [_c('i', {
          staticClass: "fas fa-check-circle"
        })]) : _vm._e(), _vm._v(" "), !row.is_fallback && !row.is_primary ? _c('a', {
          directives: [{
            name: "tooltip",
            rawName: "v-tooltip",
            value: _vm.$t('Delete'),
...
;// ./resources/js/pages/domains/index.vue?vue&type=template&id=38092afa
          ...
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              Swal.fire({
                ...
                text: _this5.$t('Are you sure you want to delete this domain?'),
                type: 'warning',
                ...
                if (result.value) {
                  _this5.$store.dispatch('operations/deleteData', {
                    ...
                    if (response === true) {
                      ...
                      Swal.fire(_this5.$t('Failed!'), _this5.$t('Delete failed'), 'warning');
                    }
                  });
                }
              });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return _this6.$axios.post('/api/domains/' + id).then(function () {
                toast.fire({
                  type: 'success',
                  title: _this6.$t('Successfully made primary')
                });
                _this6.getData();
              })["catch"](function () {
                toast.fire({
...
var update = injectStylesIntoStyleTag_default()(domainsvue_type_style_index_0_id_38092afa_prod_lang_css/* default */.A, options);



/* harmony default export */ const pages_domainsvue_type_style_index_0_id_38092afa_prod_lang_css = (domainsvue_type_style_index_0_id_38092afa_prod_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/domains/index.vue?vue&type=style&index=0&id=38092afa&prod&lang=css
