"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2110],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/collection-by-user-report.vue?vue&type=template&id=2b4584fe&scoped=true
...
/* harmony default export */ const collection_by_user_reportvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["appInfo"])), {}, {
    exportUrl: function exportUrl() {
      ...
      return "/collection-by-user-report/export/excel?start_date=".concat(this.form.fromDate, "&end_date=").concat(this.form.toDate, "&term=").concat(this.form.user['id']);
    },
    exportPdfUrl: function exportPdfUrl() {
      return "/collection-by-user-report/pdf?start_date=".concat(this.form.fromDate, "&end_date=").concat(this.form.toDate, "&term=").concat(this.form.user['id']);
    },
    printTemplateUrl: function printTemplateUrl() {
      ...
      return "/print/reports/collection-by-user-report?".concat(params.toString());
    }
  }),
  ...
  methods: {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              _context2.n = 1;
              return _this2.form.post(window.location.origin + "/api/reports/collection-by-user-report").then(function (response) {
    ...
    downloadPDF: function downloadPDF() {
      ...
      window.location.href = "/print/reports/collection-by-user-report/pdf?".concat(params.toString());
    },
    // preview PDF
    previewPDF: function previewPDF() {
      ...
      window.location.href = "/print/reports/collection-by-user-report/preview?".concat(params.toString());
    },
    // print table area
...
var update = injectStylesIntoStyleTag_default()(collection_by_user_reportvue_type_style_index_0_id_2b4584fe_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_collection_by_user_reportvue_type_style_index_0_id_2b4584fe_prod_scoped_true_lang_css = (collection_by_user_reportvue_type_style_index_0_id_2b4584fe_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/collection-by-user-report.vue?vue&type=style&index=0&id=2b4584fe&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".refresh-btn[data-v-2b4584fe]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-2b4584fe],.export-pdf-btn[data-v-2b4584fe],.preview-btn[data-v-2b4584fe]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-2b4584fe],.export-pdf-btn[data-v-2b4584fe],.preview-btn[data-v-2b4584fe],.print-btn[data-v-2b4584fe]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-2b4584fe]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-2b4584fe]{gap:10px}.card[data-v-2b4584fe]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-2b4584fe]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-2b4584fe]{padding:1.25rem}.form-control[data-v-2b4584fe]{background:#fff!important}@media (max-width:1300px){.info-box[data-v-2b4584fe]{padding:0}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
