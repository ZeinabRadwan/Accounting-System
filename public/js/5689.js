"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5689],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/cost-centers/show.vue?vue&type=template&id=7df2a45b
  ...
  methods: {
    getCostCenter: function getCostCenter() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, data, _error$response, errorMessage;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _this.$http.get("/api/cost-centers/".concat(_this.$route.params.slug));
            case 3:
              response = _context.sent;
              data = response.data; // Check if response has error
              if (!(data && data.error)) {
                _context.next = 9;
                break;
              }
              _this.$toast.error(_this.$t('Error'), data.message || _this.$t('Cost center not found'));
              _this.$router.push({
                name: 'cost-centers.index'
              });
            ...
            case 9:
              ...
              if (data && data.data) {
                _this.costCenter = data.data;
              } else if (data && data.id) {
                // Direct resource response
                _this.costCenter = data;
              } else {
                _this.$toast.error(_this.$t('Error'), _this.$t('Cost center not found'));
                _this.$router.push({
                  name: 'cost-centers.index'
                });
              }
            ...
            case 12:
              ...
              console.error('Error loading cost center:', _context.t0);
              errorMessage = ((_error$response = _context.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this.$t('Failed to load cost center');
              _this.$toast.error(_this.$t('Error'), errorMessage);
              _this.$router.push({
                name: 'cost-centers.index'
              });
            case 18:
