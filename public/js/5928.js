...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=template&id=633d0438&scoped=true
            ...
            case 0:
              axios_default().post(window.location.origin + "/api/tenants/" + id + "/ban").then(function (response) {
                if (response.data.success === true) {
                  _this0.$toast.success(_this0.$t(response.data.message), _this0.$t(response.data.message + "_success"));
                  _this0.getData();
                } else {
                  _this0.$toast.warning(_this0.$t("Failed"), _this0.$t("Ban failed"));
                }
              });
            case 1:
...
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=633d0438&prod&scoped=true&lang=css
...
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=633d0438&prod&lang=css
