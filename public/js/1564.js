...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=7e68dfac&scoped=true
...
;// ./resources/js/pages/purchases/create.vue?vue&type=template&id=7e68dfac&scoped=true
...
var SupplierCreateModal = __webpack_require__(44703);
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            ...
            case 4:
              ...
              if (purchaseOrder.supplier && _this10.suppliers && _this10.suppliers.length > 0) {
                supplier = _this10.suppliers.find(function (s) {
                  return s.id === purchaseOrder.supplier.id || s.id === purchaseOrder.supplier_id;
                });
                if (supplier) {
                  _this10.form.supplier = supplier;
                  _this10.onSupplierChange();
                }
              }

              // Set purchase order reference fields
              if (purchaseOrder.po_reference) {
                _this10.form.poReference = purchaseOrder.po_reference;
              }
              if (purchaseOrder.payment_terms) {
                _this10.form.paymentTerms = purchaseOrder.payment_terms;
              }
              if (purchaseOrder.po_date) {
                _this10.form.poDate = purchaseOrder.po_date;
              }
              if (purchaseOrder.purchase_date) {
                _this10.form.purchaseDate = purchaseOrder.purchase_date;
              } else {
                _this10.form.purchaseDate = new Date().toISOString().slice(0, 10);
              }
              if (purchaseOrder.note) {
                _this10.form.note = purchaseOrder.note;
              }
              if (purchaseOrder.transport) {
                _this10.form.transportCost = purchaseOrder.transport;
              }
                ...
                return _regeneratorRuntime().wrap(function _loop$(_context0) {
                  while (1) switch (_context0.prev = _context0.next) {
                    case 0:
                      ...
                      product = _this10.products.find(function (p) {
                        return p.id === poProduct.product_id || poProduct.product && p.id === poProduct.product.id;
                      });
                      if (product) {
                        // Find matching VAT rate
                        selectedVatRate = null;
                        if (poProduct.tax_amount && poProduct.tax_amount > 0 && _this10.taxes && _this10.taxes.length > 0) {
                          ...
                          selectedVatRate = _this10.taxes.find(function (tax) {
                            return Math.abs(tax.rate - calculatedVatRate) < 0.01 || poProduct.product && poProduct.product.productTax && _this10.findMatchingVatRate(poProduct.product.productTax);
                          });
                          if (!selectedVatRate && poProduct.product && poProduct.product.productTax) {
                            selectedVatRate = _this10.findMatchingVatRate(poProduct.product.productTax);
                          }
                        }
                        ...
                        formProduct = {
                          ...
                          discountAmount: poProduct.discount_amount || 0,
                          selectedVatRate: selectedVatRate || (_this10.taxes && _this10.taxes.length > 0 ? _this10.taxes[0] : null),
            ...
            case 32:
              ...
              _this10.form.selectedProducts = selectedProducts;

              // Recalculate totals for all products (calculateProductVat already calls generateItemTotalPrice)
              selectedProducts.forEach(function (product, index) {
                _this10.calculateProductDiscount(index);
                _this10.calculateProductVat(index);
              });
            ...
            case 35:
              ...
              toast.fire({
                type: "success",
                title: _this10.$t("Purchase order data loaded successfully")
              });
              _this10.$store.state.operations.loading = false;
              _context1.next = 44;
              break;
            case 39:
              _context1.prev = 39;
              ...
              toast.fire({
                type: "error",
                title: _this10.$t("Failed to load purchase order data"),
                text: ((_error$response = _context1.t2.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this10.$t("Please try again")
              });
            case 44:
            case "end":
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_7e68dfac_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_7e68dfac_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_7e68dfac_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=7e68dfac&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".create-button[data-v-94badc3c]{cursor:pointer;text-decoration:none}.modal-content[data-v-94badc3c]{margin:1.75rem auto;max-width:1000px}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-7e68dfac]{margin-bottom:15px}.footer-buttons[data-v-7e68dfac]{display:flex;gap:10px}.footer-buttons .btn[data-v-7e68dfac]{margin-right:10px}.footer-buttons .btn[data-v-7e68dfac]:last-child{margin-right:0}.create-btn[data-v-7e68dfac]{padding:11px}.chart-account-success[data-v-7e68dfac],.chart-account-warning[data-v-7e68dfac]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-7e68dfac]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-7e68dfac]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-7e68dfac],.warning-content[data-v-7e68dfac]{align-items:center;display:flex;gap:16px}.success-icon[data-v-7e68dfac],.warning-icon[data-v-7e68dfac]{flex-shrink:0;font-size:24px}.warning-icon[data-v-7e68dfac]{color:#856404}.success-icon[data-v-7e68dfac]{color:#155724}.success-text[data-v-7e68dfac],.warning-text[data-v-7e68dfac]{flex-grow:1}.success-title[data-v-7e68dfac],.warning-title[data-v-7e68dfac]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-7e68dfac]{color:#856404}.success-title[data-v-7e68dfac]{color:#155724}.success-description[data-v-7e68dfac],.warning-description[data-v-7e68dfac]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-7e68dfac]{color:#856404}.success-description[data-v-7e68dfac]{color:#155724}.warning-action[data-v-7e68dfac]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-7e68dfac]{padding:0}.card[data-v-7e68dfac]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-7e68dfac]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-7e68dfac]{padding:1.25rem}.card-footer[data-v-7e68dfac]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-7e68dfac]{border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-7e68dfac]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-7e68dfac]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-7e68dfac]{color:#dc3545;font-weight:700}.btn-primary[data-v-7e68dfac]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-7e68dfac]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-7e68dfac]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-7e68dfac]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-7e68dfac]{border-color:#dc3545!important}textarea.form-control[data-v-7e68dfac]{min-height:100px;resize:vertical}.v-select[data-v-7e68dfac],.v-select .vs__dropdown-toggle[data-v-7e68dfac]{background:#fff!important;border:1px solid #e5e7eb}.v-select .vs__dropdown-toggle[data-v-7e68dfac]{padding:10px 16px}.v-select .vs__search[data-v-7e68dfac]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-7e68dfac]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-7e68dfac]{color:#374151}.v-select .vs__dropdown-menu[data-v-7e68dfac]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-7e68dfac]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-7e68dfac]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-7e68dfac]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-7e68dfac]:hover{background-color:#f8f9fa}.toggle-button[data-v-7e68dfac]{margin-right:10px}.product-status[data-v-7e68dfac],.supplier-status[data-v-7e68dfac]{font-size:13px}.product-warning[data-v-7e68dfac],.supplier-warning[data-v-7e68dfac]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-7e68dfac]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-7e68dfac]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-7e68dfac]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-7e68dfac]{margin-bottom:1rem}.form-text[data-v-7e68dfac]{color:#6b7280;font-size:.875rem}.text-muted[data-v-7e68dfac]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-7e68dfac]{flex-direction:column;gap:10px}.card-footer .btn[data-v-7e68dfac]{margin-right:0!important;width:100%}.card-footer div[data-v-7e68dfac]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-7e68dfac]{font-size:12px}.table-custom tbody td[data-v-7e68dfac],.table-custom thead th[data-v-7e68dfac]{padding:8px 4px}}.btn-group.c-w-100[data-v-7e68dfac]{gap:10px}.quantity-field[data-v-7e68dfac]{border-radius:0!important;margin:0!important;min-height:50px!important}.table-custom[data-v-7e68dfac]{border:none!important}.invoices-create-table[data-v-7e68dfac]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-7e68dfac]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-7e68dfac]{border:none!important}.invoices-create-table thead th[data-v-7e68dfac]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-7e68dfac]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-7e68dfac]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-7e68dfac]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-create-table .badge.badge-danger[data-v-7e68dfac]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-7e68dfac]{background:#fff!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierCreateModal.vue?vue&type=template&id=94badc3c&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
var SupplierForm = __webpack_require__(89619);
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 56:
              ...
              if (status === 422 && serverErrors && _this.$refs.supplierForm && _this.$refs.supplierForm.getFormData) {
                // Map backend validation errors into SupplierForm's vform errors
                form = _this.$refs.supplierForm.getFormData();
                mapped = {};
...
var update = injectStylesIntoStyleTag_default()(SupplierCreateModalvue_type_style_index_0_id_94badc3c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_SupplierCreateModalvue_type_style_index_0_id_94badc3c_prod_scoped_true_lang_css = (SupplierCreateModalvue_type_style_index_0_id_94badc3c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/SupplierCreateModal.vue?vue&type=style&index=0&id=94badc3c&prod&scoped=true&lang=css
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=template&id=2bfaf193&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Street Name")))]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
...
;// ./resources/js/components/SupplierForm.vue?vue&type=template&id=2bfaf193&scoped=true
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              submitData = _objectSpread(_objectSpread({}, _this8.form.data()), {}, {
                // Map legacy fields for backward compatibility
                name: _this8.form.type === 'Individual' ? _this8.form.fullName : _this8.form.businessName,
                companyName: _this8.form.businessName,
                taxStatus: _this8.form.taxStatus || 'non_taxable',
                taxRegistrationNumber: _this8.form.taxRegistrationNumber || _this8.form.taxCard,
                address: _this8.form.streetAddress1,
                // Saudi National Address Fields
                buildingNumber: _this8.form.buildingNumber,
                streetNumber: _this8.form.streetNumber,
                districtNumber: _this8.form.districtNumber,
                unitNumber: _this8.form.unitNumber,
                additionalNumber: _this8.form.additionalNumber,
                // Include representatives data
                representatives: _this8.form.representatives && Array.isArray(_this8.form.representatives) ? _this8.form.representatives : [],
                // Ensure phone field is included
                phone: _this8.form.phone,
                phoneNumber: _this8.form.phoneNumber,
                // Saudi region
                saudi_region: _this8.form.saudi_region
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=2bfaf193&prod&scoped=true&lang=css
var SupplierFormvue_type_style_index_0_id_2bfaf193_prod_scoped_true_lang_css = __webpack_require__(99192);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=2bfaf193&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(SupplierFormvue_type_style_index_0_id_2bfaf193_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_SupplierFormvue_type_style_index_0_id_2bfaf193_prod_scoped_true_lang_css = (SupplierFormvue_type_style_index_0_id_2bfaf193_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/components/SupplierForm.vue?vue&type=style&index=0&id=2bfaf193&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".form-card[data-v-2bfaf193]{background:#fff;border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:20px}.form-card .card-header[data-v-2bfaf193]{background-color:#33a0d9;border-bottom:none;border-radius:20px 20px 0 0;color:#fff;padding:22px 16px}.form-card .section-title[data-v-2bfaf193]{color:#fff;font-size:14px;font-weight:600;margin:0}.form-card .card-body[data-v-2bfaf193]{padding:16px}.form-control[data-v-2bfaf193]{background:#fff!important}input[readonly][data-v-2bfaf193]{background-color:#f8f9fa!important;border-color:#ced4da;color:#6c757d;cursor:not-allowed}.form-control[data-v-2bfaf193]:focus,select.form-control[data-v-2bfaf193]:focus,textarea.form-control[data-v-2bfaf193]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.radio-group[data-v-2bfaf193]{align-items:center;display:flex;gap:16px}.radio-group .radio-inline[data-v-2bfaf193]{align-items:center;display:inline-flex;gap:6px;margin:0}.v-select .vs__dropdown-toggle[data-v-2bfaf193]{border-color:#ced4da;border-radius:6px}.v-select .vs__dropdown-toggle.vs__open[data-v-2bfaf193],.v-select .vs__dropdown-toggle[data-v-2bfaf193]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.v-select .vs__dropdown-menu[data-v-2bfaf193],.v-select .vs__search[data-v-2bfaf193],.v-select .vs__selected[data-v-2bfaf193]{font-size:.95rem}.custom-file-input:focus~.custom-file-label[data-v-2bfaf193]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15)}.custom-file-label[data-v-2bfaf193]{border-radius:6px}.file-upload-area[data-v-2bfaf193]{background:#f8fdfe;border:2px dashed #33a0d9;border-radius:12px;padding:20px;position:relative;text-align:center}.file-upload-area .file-input[data-v-2bfaf193]{cursor:pointer;height:100%;inset:0;opacity:0;position:absolute;width:100%}.file-upload-area .file-upload-content[data-v-2bfaf193]{color:#33a0d9}.selected-files .selected-file-item[data-v-2bfaf193]{align-items:center;background:#f5faff;border:1px solid #e3f3f7;border-radius:6px;display:inline-flex;margin-bottom:8px;margin-right:8px;padding:6px 10px}.d-flex.align-items-center span.ml-3[data-v-2bfaf193]{font-weight:500}.required[data-v-2bfaf193]{color:#dc3545}.tax-status-options[data-v-2bfaf193]{margin-top:.5rem}.tax-status-card-compact[data-v-2bfaf193]{background-color:#fff;border:2px solid #e0e0e0;border-radius:8px;box-shadow:0 1px 4px rgba(0,0,0,.06);cursor:pointer;display:block;padding:.75rem 1rem;position:relative;transition:all .2s ease}.tax-status-card-compact[data-v-2bfaf193]:hover{border-color:#007bff;box-shadow:0 2px 8px rgba(0,123,255,.12);transform:translateY(-1px)}.tax-status-card-compact.active[data-v-2bfaf193]{background:linear-gradient(135deg,#f8f9ff,#fff);border-color:#007bff;box-shadow:0 2px 10px rgba(0,123,255,.15)}.tax-status-card-compact.border-success.active[data-v-2bfaf193]{background:linear-gradient(135deg,#f0fff4,#fff);border-color:#28a745;box-shadow:0 2px 10px rgba(40,167,69,.15)}.tax-status-card-compact.border-primary.active[data-v-2bfaf193]{background:linear-gradient(135deg,#f8f9ff,#fff);border-color:#007bff;box-shadow:0 2px 10px rgba(0,123,255,.15)}.tax-status-header-compact[data-v-2bfaf193]{align-items:center;display:flex;position:relative}.tax-status-radio[data-v-2bfaf193]{opacity:0;pointer-events:none;position:absolute}.tax-status-icon-compact[data-v-2bfaf193]{align-items:center;border-radius:8px;display:flex;flex-shrink:0;font-size:1rem;height:32px;justify-content:center;margin-right:.75rem;transition:all .2s ease;width:32px}.tax-status-icon-compact.taxable-icon[data-v-2bfaf193]{background:linear-gradient(135deg,#007bff,#0056b3);box-shadow:0 2px 6px rgba(0,123,255,.25);color:#fff}.tax-status-icon-compact.non-taxable-icon[data-v-2bfaf193]{background:linear-gradient(135deg,#28a745,#1e7e34);box-shadow:0 2px 6px rgba(40,167,69,.25);color:#fff}.tax-status-card-compact.active .tax-status-icon-compact.taxable-icon[data-v-2bfaf193]{box-shadow:0 3px 10px rgba(0,123,255,.35);transform:scale(1.05)}.tax-status-card-compact.active .tax-status-icon-compact.non-taxable-icon[data-v-2bfaf193]{box-shadow:0 3px 10px rgba(40,167,69,.35);transform:scale(1.05)}.tax-status-title-compact[data-v-2bfaf193]{color:#2c3e50;flex:1;font-size:.95rem;font-weight:600}.tax-status-card-compact.active .tax-status-title-compact[data-v-2bfaf193]{color:#007bff}.tax-status-card-compact.border-success.active .tax-status-title-compact[data-v-2bfaf193]{color:#28a745}[dir=rtl] .tax-status-icon-compact[data-v-2bfaf193]{margin-left:.75rem;margin-right:0}[dir=rtl] .form-card .card-header[data-v-2bfaf193]{border-radius:20px 20px 0 0}.custom-file-label[data-v-2bfaf193],[dir=rtl] .custom-file-label[data-v-2bfaf193]{text-align:left!important}.btn-primary[data-v-2bfaf193]{background:#33a0d9!important;border-color:#33a0d9!important}.btn-primary[data-v-2bfaf193]:hover{filter:brightness(.95)}.equal-height>[class*=\" col-\"][data-v-2bfaf193],.equal-height>[class^=col-][data-v-2bfaf193]{display:flex}.equal-height .form-card[data-v-2bfaf193]{display:flex;flex-direction:column;width:100%}.equal-height .form-card .card-body[data-v-2bfaf193]{flex:1 1 auto}.country-select[data-v-2bfaf193]{width:100%}.country-select .vs__dropdown-toggle[data-v-2bfaf193]{border:1px solid #ced4da;border-radius:6px;max-width:100%;min-height:2.5rem;overflow:hidden;padding:.5rem 1rem}.country-select .vs__search[data-v-2bfaf193]{font-size:.95rem;margin:0;padding:0}.country-select .vs__selected[data-v-2bfaf193]{align-items:center;display:flex;gap:.5rem;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.country-option[data-v-2bfaf193],.country-selected[data-v-2bfaf193]{align-items:center;display:flex;gap:.5rem;min-width:0}.country-flag[data-v-2bfaf193]{flex-shrink:0;font-size:1.25rem;line-height:1}.country-name[data-v-2bfaf193]{flex:1;font-size:.95rem;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.country-select.is-invalid .vs__dropdown-toggle[data-v-2bfaf193]{border-color:#dc3545}.country-select .vs__dropdown-menu[data-v-2bfaf193]{border-radius:6px;box-shadow:0 .5rem 1rem rgba(0,0,0,.15);margin-top:.5rem}.country-select .vs__dropdown-option[data-v-2bfaf193]{padding:.75rem 1rem}.country-select .vs__dropdown-option--highlight[data-v-2bfaf193]{background-color:#33a0d9;color:#fff}.saudi-location-select[data-v-2bfaf193]{width:100%}.saudi-location-select .vs__dropdown-toggle[data-v-2bfaf193]{background-color:#fff;border:1px solid #ced4da;border-radius:6px;min-height:2.5rem;padding:.375rem .75rem}.saudi-location-select .vs__dropdown-toggle.vs__open[data-v-2bfaf193],.saudi-location-select .vs__dropdown-toggle[data-v-2bfaf193]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(23,162,184,.15);outline:none}.saudi-location-select.is-invalid .vs__dropdown-toggle[data-v-2bfaf193]{border-color:#dc3545}.saudi-location-select .vs__search[data-v-2bfaf193]{font-size:.95rem;margin:0;padding:0}.saudi-location-select .vs__dropdown-menu[data-v-2bfaf193]{border-radius:6px;box-shadow:0 .5rem 1rem rgba(0,0,0,.15);margin-top:.5rem}.saudi-location-select .vs__dropdown-option[data-v-2bfaf193]{padding:.75rem 1rem}.saudi-location-select .vs__dropdown-option--highlight[data-v-2bfaf193]{background-color:#33a0d9;color:#fff}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
