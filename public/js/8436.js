"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8436],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ sales_by_user_report)
});

;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/sales-by-user-report.vue?vue&type=template&id=74faa9b2&scoped=true
var render = function render() {
  ...
  }, [_c('thead', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Sales By")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Client")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Net Total")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice Date")))])]), _vm._v(" "), _c('tbody', _vm._l(_vm.items, function (data, i) {
    return _c('tr', {
      key: i
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/sales-by-user-report.vue?vue&type=script&lang=js
...
/* harmony default export */ const sales_by_user_reportvue_type_script_lang_js = ({
  middleware: ["auth", "check-permissions"],
  metaInfo: function metaInfo() {
    return {
      title: this.$t("Sales By User Report")
    };
  },
  data: function data() {
    return {
      breadcrumbsCurrent: "Sales By User Report",
      breadcrumbs: [{
        name: "Dashboard",
        url: "home"
      }, {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["appInfo"])), {}, {
    ...
    printTemplateUrl: function printTemplateUrl() {
      ...
      return "/print/reports/sales-by-user-report?".concat(params.toString());
    }
  }),
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 3;
              _context2.next = 6;
              return _this2.form.post(window.location.origin + "/api/reports/sales-by-user-report");
            case 6:
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this3.update({
                from: _this3.form.fromDate,
                to: _this3.form.toDate
              });
            case 2:
              ok = _context3.sent;
              if (ok) {
    ...
    downloadPDF: function downloadPDF() {
      ...
      window.location.href = "/print/reports/sales-by-user-report/pdf?".concat(params.toString());
    },
    // preview PDF
    previewPDF: function previewPDF() {
      ...
      window.location.href = "/print/reports/sales-by-user-report/preview?".concat(params.toString());
    },
    // print table area
...
;// ./resources/js/pages/reports/sales-by-user-report.vue?vue&type=script&lang=js
 /* harmony default export */ const reports_sales_by_user_reportvue_type_script_lang_js = (sales_by_user_reportvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/sales-by-user-report.vue?vue&type=style&index=0&id=74faa9b2&prod&scoped=true&lang=css
var sales_by_user_reportvue_type_style_index_0_id_74faa9b2_prod_scoped_true_lang_css = __webpack_require__(99727);
...
var update = injectStylesIntoStyleTag_default()(sales_by_user_reportvue_type_style_index_0_id_74faa9b2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_sales_by_user_reportvue_type_style_index_0_id_74faa9b2_prod_scoped_true_lang_css = (sales_by_user_reportvue_type_style_index_0_id_74faa9b2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/sales-by-user-report.vue?vue&type=style&index=0&id=74faa9b2&prod&scoped=true&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  reports_sales_by_user_reportvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ const sales_by_user_report = (component.exports);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".refresh-btn[data-v-74faa9b2]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-74faa9b2],.export-pdf-btn[data-v-74faa9b2],.preview-btn[data-v-74faa9b2]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-74faa9b2],.export-pdf-btn[data-v-74faa9b2],.preview-btn[data-v-74faa9b2],.print-btn[data-v-74faa9b2]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-74faa9b2]{background:#33a0d91a!important;color:#33a0d9!important}.btn-group.c-w-100[data-v-74faa9b2]{gap:10px}.card[data-v-74faa9b2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-74faa9b2]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-74faa9b2]{padding:1.25rem}.form-control[data-v-74faa9b2]{background:#fff!important}@media (max-width:1300px){.info-box[data-v-74faa9b2]{padding:0}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
