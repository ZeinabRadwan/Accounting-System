"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3526],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=7cba30c6&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }, [_vm.isRTL || _vm.$i18n.locale === 'ar' || typeof _vm.document !== 'undefined' && _vm.document.documentElement.getAttribute('dir') === 'rtl' ? [_vm._v("\n                  " + _vm._s(_vm.$t("Back")) + " "), _c('i', {
          ...
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              if (!_this7.form.supplier) {
                validationErrors.push(_this7.$t("Please select a supplier"));
              }

              // Check products
              if (!_this7.form.selectedProducts || _this7.form.selectedProducts.length === 0) {
                validationErrors.push(_this7.$t("Please add at least one product"));
              }

              // Check account (only required if adding payment)
              if (_this7.form.addPayment == 1 && !_this7.form.account) {
                validationErrors.push(_this7.$t("Please select an account"));
              }

              // Check total paid (only required if adding payment)
              if (_this7.form.addPayment == 1 && (!_this7.form.totalPaid || Number(_this7.form.totalPaid) <= 0)) {
                validationErrors.push(_this7.$t("Please enter the total amount paid"));
              }

              // Check product details
              if (_this7.form.selectedProducts && _this7.form.selectedProducts.length > 0) {
                _this7.form.selectedProducts.forEach(function (product, index) {
                  if (!product.qty || Number(product.qty) <= 0) {
                    validationErrors.push("".concat(_this7.$t("Product"), " ").concat(index + 1, ": ").concat(_this7.$t("Invalid quantity")));
                  }
                  if (!product.unitPrice || Number(product.unitPrice) <= 0) {
                    validationErrors.push("".concat(_this7.$t("Product"), " ").concat(index + 1, ": ").concat(_this7.$t("Invalid unit price")));
                  }
                });
              }
              ...
              toast.fire({
                type: "error",
                title: "".concat(_this7.$t("Validation Error"), ":\n\n").concat(errorList),
                timer: 8000,
            ...
            case 12:
              ...
              if (!(_this7.form.attachments && _this7.form.attachments.length > 0)) {
                _context7.next = 53;
                break;
              }
              // Create FormData for file uploads
              formDataObj = _this7.form.data();
              ...
              appendIfDefined('addPayment', _this7.form.addPayment == 1 ? 1 : 0);
              ...
              if (!_this7.isSaudiArabia && formDataObj.orderTax) {
              ...
              _this7.form.attachments.forEach(function (file) {
            ...
            case 53:
              ...
              formData = _this7.form.data();

              // Convert addPayment to boolean for backend validation
              formData.addPayment = _this7.form.addPayment == 1;

              // Only include payment-related fields if payment is being added
              if (_this7.form.addPayment == 1) {
                formData.account = _this7.form.account;
                formData.totalPaid = _this7.form.totalPaid;
              } else {
          ...
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 6:
              ...
              if (_response4.data.success) {
                ...
                _this8.form.supplier.chart_of_account_id = _response4.data.chart_of_account_id;
                console.log('Supplier after updating chart_of_account_id:', _this8.form.supplier);
                ...
                toast.fire({
                  ...
                  text: _response4.data.message || _this8.$t("Please try again or assign manually")
                });
              }
              _context8.next = 14;
              break;
            ...
            case 6:
              ...
              if (_response5.data.success) {
                ...
                toast.fire({
                  ...
                  text: _response5.data.message || _this9.$t("Please try again or assign manually")
                });
              }
              _context9.next = 14;
              break;
    ...
    onSupplierChange: function onSupplierChange() {
      ...
      if (this.form.supplier && this.form.supplier.id) {
        ...
        var updatedSupplier = this.suppliers.find(function (s) {
          return s.id === _this0.form.supplier.id;
        });
        if (updatedSupplier) {
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            ...
            case 3:
              ...
              if (data.data) {
                _this1.costCenters = data.data;
              } else if (Array.isArray(data)) {
                _this1.costCenters = data;
              } else {
                _this1.costCenters = [];
              }
              _context0.next = 12;
            ...
            case 8:
              ...
              console.error('Error getting cost centers:', _context0.t0);
              _this1.costCenters = [];
            case 12:
            case "end":
              return _context0.stop();
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee1() {
        ...
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            ...
            case 6:
              _yield$axios$get6 = _context1.sent;
            ...
            case 14:
              _yield$axios$get7 = _context1.sent;
            ...
            case 19:
              ...
              return axios_default().get('/api/branches');
            case 23:
              _yield$axios$get8 = _context1.sent;
              _data2 = _yield$axios$get8.data;
              if (_data2.data) {
                branchesData = _data2.data;
              }
            case 26:
              _this10.branches = branchesData;
              _context1.next = 33;
              break;
            case 29:
              _context1.prev = 29;
              _context1.t1 = _context1["catch"](0);
              console.error('Error getting branches:', _context1.t1);
              _this10.branches = [];
            case 33:
            case "end":
              return _context1.stop();
          }
        }, _callee1, null, [[0, 29], [11, 19]]);
      }))();
    },
    ...
    onAttachmentChange: function onAttachmentChange(event) {
      ...
      var validFiles = files.filter(function (file) {
        ...
        if (file.size > 10 * 1024 * 1024) {
          toast.fire({
            type: "error",
            title: _this11.$t("File too large"),
            text: "".concat(file.name, " ").concat(_this11.$t("exceeds 10MB limit"))
          });
          return false;
        }
        return true;
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 4:
              ...
              if (purchaseOrder.supplier && _this12.suppliers && _this12.suppliers.length > 0) {
                supplier = _this12.suppliers.find(function (s) {
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_7cba30c6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_7cba30c6_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_7cba30c6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=7cba30c6&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-7cba30c6]{margin-bottom:15px}.footer-buttons[data-v-7cba30c6]{display:flex;gap:10px}.footer-buttons .btn[data-v-7cba30c6]{margin-right:10px}.footer-buttons .btn[data-v-7cba30c6]:last-child{margin-right:0}.create-btn[data-v-7cba30c6]{padding:11px}.chart-account-success[data-v-7cba30c6],.chart-account-warning[data-v-7cba30c6]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-7cba30c6]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-7cba30c6]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-7cba30c6],.warning-content[data-v-7cba30c6]{align-items:center;display:flex;gap:16px}.success-icon[data-v-7cba30c6],.warning-icon[data-v-7cba30c6]{flex-shrink:0;font-size:24px}.warning-icon[data-v-7cba30c6]{color:#856404}.success-icon[data-v-7cba30c6]{color:#155724}.success-text[data-v-7cba30c6],.warning-text[data-v-7cba30c6]{flex-grow:1}.success-title[data-v-7cba30c6],.warning-title[data-v-7cba30c6]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-7cba30c6]{color:#856404}.success-title[data-v-7cba30c6]{color:#155724}.success-description[data-v-7cba30c6],.warning-description[data-v-7cba30c6]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-7cba30c6]{color:#856404}.success-description[data-v-7cba30c6]{color:#155724}.warning-action[data-v-7cba30c6]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-7cba30c6]{padding:0}.card[data-v-7cba30c6]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-7cba30c6]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-7cba30c6]{padding:1.25rem}.card-footer[data-v-7cba30c6]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-7cba30c6]{border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-7cba30c6]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-7cba30c6]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-7cba30c6]{color:#dc3545;font-weight:700}.btn-primary[data-v-7cba30c6]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-7cba30c6]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-7cba30c6]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-7cba30c6]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-7cba30c6]{border-color:#dc3545!important}textarea.form-control[data-v-7cba30c6]{min-height:100px;resize:vertical}.v-select[data-v-7cba30c6],.v-select .vs__dropdown-toggle[data-v-7cba30c6]{background:#fff!important;border:1px solid #e5e7eb}.v-select .vs__dropdown-toggle[data-v-7cba30c6]{padding:10px 16px}.v-select .vs__search[data-v-7cba30c6]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-7cba30c6]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-7cba30c6]{color:#374151}.v-select .vs__dropdown-menu[data-v-7cba30c6]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-7cba30c6]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-7cba30c6]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-7cba30c6]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-7cba30c6]:hover{background-color:#f8f9fa}.toggle-button[data-v-7cba30c6]{margin-right:10px}.product-status[data-v-7cba30c6],.supplier-status[data-v-7cba30c6]{font-size:13px}.product-warning[data-v-7cba30c6],.supplier-warning[data-v-7cba30c6]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-7cba30c6]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-7cba30c6]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-7cba30c6]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-7cba30c6]{margin-bottom:1rem}.form-text[data-v-7cba30c6]{color:#6b7280;font-size:.875rem}.text-muted[data-v-7cba30c6]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-7cba30c6]{flex-direction:column;gap:10px}.card-footer .btn[data-v-7cba30c6]{margin-right:0!important;width:100%}.card-footer div[data-v-7cba30c6]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-7cba30c6]{font-size:12px}.table-custom tbody td[data-v-7cba30c6],.table-custom thead th[data-v-7cba30c6]{padding:8px 4px}}.btn-group.c-w-100[data-v-7cba30c6]{gap:10px}.quantity-field[data-v-7cba30c6]{border-radius:0!important;margin:0!important;min-height:50px!important}.table-custom[data-v-7cba30c6]{border:none!important}.invoices-create-table[data-v-7cba30c6]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-7cba30c6]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-7cba30c6]{border:none!important}.invoices-create-table thead th[data-v-7cba30c6]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-7cba30c6]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-7cba30c6]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-7cba30c6]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.invoices-create-table .badge.badge-danger[data-v-7cba30c6]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-7cba30c6]{background:#fff!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
