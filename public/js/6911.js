"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6911],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_laravel_mix_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-f70b6af8]{margin-bottom:15px}.footer-buttons[data-v-f70b6af8]{display:flex;gap:10px}.footer-buttons .btn[data-v-f70b6af8]{margin-right:10px}.footer-buttons .btn[data-v-f70b6af8]:last-child{margin-right:0}.btn-group.c-w-100[data-v-f70b6af8]{gap:10px}.card[data-v-f70b6af8]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-f70b6af8]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-f70b6af8]{background:#fff!important}.btn-primary[data-v-f70b6af8]{background:#2ab930!important}.btn-secondary[data-v-f70b6af8]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/edit.vue?vue&type=template&id=f70b6af8&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
          ...
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              if (response.data && response.data.data) {
                _this2.paymentMethods = response.data.data;
              }
              _context2.n = 3;
              break;
            case 2:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _context3.n = 1;
              return axios_default().get(window.location.origin + '/api/invoice-returns/' + _this3.$route.params.slug);
            case 1:
              _yield$axios$get2 = _context3.v;
              data = _yield$axios$get2.data;
              _this3.form.invoiceNo = data.data.invoice.invoiceLabel;
              _this3.form.invoiceReturnNo = _this3.$options.filters.withPrefix(data.data.returnNo, _this3.purchaseReturnPrefix);
              _this3.form.returnReason = data.data.reason;
              _this3.form.availableBalance = data.data.account ? data.data.account.availableBalance : null;
              _this3.form.account = data.data.account;
              _this3.form.chequeNo = data.data.accountPayable ? data.data.accountPayable.cheque_no : '';
              _this3.form.receiptNo = data.data.accountPayable ? data.data.accountPayable.receipt_no : '';
              _this3.form.clientName = data.data.client.name;
              ...
              _this3.form.invoiceTaxRate = data.data.invoice.taxRate;
              _this3.form.invoiceTax = data.data.invoice.tax;
              _this3.form.clientAdvance = data.data.creditAmount;
              _this3.form.clientAdvanceText = data.data.creditAmount;
              _this3.form.invoiceDue = data.data.invoice.due;
              _this3.form.newDueText = data.data.invoice.due;
              _this3.form.invoiceTransport = data.data.invoice.transport;
              _this3.form.discountType = data.data.invoice.discountType;
              _this3.form.discountPercentage = data.data.invoice.discountPercentage;
              _this3.form.invoiceDiscount = data.data.invoice.discount;
              _this3.form.invoicePaid = data.data.invoice.invoicePaid;
              _this3.form.invoiceTotal = data.data.invoice.invoiceTotal;
              _this3.form.selectedProducts = _this3.assignProducts(data.data.invoiceReturnProducts);
            case 2:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              _context4.n = 1;
              return _this4.form.patch(window.location.origin + '/api/invoice-returns/' + _this4.$route.params.slug).then(function () {
                toast.fire({
                  type: 'success',
                  title: _this4.$t('Invoice return updated successfully')
                });
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_f70b6af8_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_editvue_type_style_index_0_id_f70b6af8_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_f70b6af8_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/returns/edit.vue?vue&type=style&index=0&id=f70b6af8&prod&scoped=true&lang=css
