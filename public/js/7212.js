"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7212],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/payment-methods/edit.vue?vue&type=template&id=8db358f6
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios_default().get(window.location.origin + "/api/payment-methods/" + _this2.$route.params.slug);
            case 2:
              _yield$axios$get = _context2.sent;
              data = _yield$axios$get.data;
              _this2.form.name = data.name;
              _this2.form.shortCode = data.code;
              _this2.form.note = data.note;
              _this2.form.status = data.status;
              _this2.form.chartOfAccountId = data.chart_of_account_id || null;
            case 9:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _this3.form.chart_of_account_id = _this3.form.chartOfAccountId || null;
              _context3.next = 3;
              return _this3.form.patch(window.location.origin + "/api/payment-methods/" + _this3.$route.params.slug).then(function () {
                toast.fire({
                  type: "success",
