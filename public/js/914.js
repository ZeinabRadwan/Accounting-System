"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[914],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/clients/edit.vue?vue&type=template&id=9a8ded24&scoped=true
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Edit Client')))]), _vm._v(" "), _c('router-link', {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              console.log("Fetching client with slug:", _this2.$route.params.slug);
              _context2.n = 2;
              return _this2.$http.get("/api/clients/".concat(_this2.$route.params.slug));
            case 2:
            ...
            case 3:
              ...
              console.log("Route params slug:", _this2.$route.params.slug);
              ...
              _this2.clientData = {
                ...
                slug: clientData.slug || _this2.$route.params.slug,
                // Account Details
              ...
              console.log("Client data slug:", clientData.slug);
              console.log("Route params slug:", _this2.$route.params.slug);
              console.log("Final slug used:", clientData.slug || _this2.$route.params.slug);
              console.log("Mapped client data:", _this2.clientData);
              _context2.n = 5;
              break;
            case 4:
              _context2.p = 4;
              ...
              if (window.toast && typeof window.toast.fire === 'function') {
                window.toast.fire({
                  type: "error",
                  title: _this2.$t("Failed to load client data"),
                ...
                alert(_this2.$t("Failed to load client data: ") + (_t2.message || "Unknown error"));
              }
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              ...
              console.log('Is submitting:', _this3.isSubmitting);
              console.log('Loading:', _this3.loading);
              if (!(_this3.isSubmitting || _this3.loading)) {
                _context3.n = 1;
                break;
              }
            ...
            case 1:
              ...
              _context3.n = 3;
              return _this3.$http.put("/api/clients/".concat(_this3.clientData.slug), formData);
            case 3:
              ...
              if (window.toast && typeof window.toast.fire === 'function') {
                window.toast.fire({
                  type: "success",
                  title: _this3.$t("Client updated successfully")
                });
              } else {
                alert(_this3.$t("Client updated successfully"));
              }
              _this3.$router.push({
                name: "clients.index"
              });
            ...
            case 6:
              ...
              if (window.toast && typeof window.toast.fire === 'function') {
                ...
                alert(_this3.$t("Opps...something went wrong"));
              }
            case 7:
              _context3.p = 7;
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/clients/edit.vue?vue&type=style&index=0&id=9a8ded24&prod&scoped=true&lang=css
var editvue_type_style_index_0_id_9a8ded24_prod_scoped_true_lang_css = __webpack_require__(94338);
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_9a8ded24_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const clients_editvue_type_style_index_0_id_9a8ded24_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_9a8ded24_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/clients/edit.vue?vue&type=style&index=0&id=9a8ded24&prod&scoped=true&lang=css
