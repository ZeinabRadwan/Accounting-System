"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7285],{
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/profit-loss.vue?vue&type=template&id=aa9aef60
...
;// CONCATENATED MODULE: ./resources/js/pages/reports/profit-loss.vue?vue&type=template&id=aa9aef60
  ...
  methods: {
    ...
    calculateTotal: function calculateTotal(items) {
      ...
      items.forEach(function (item) {
        _this2.totalQty += item.currentQty;
        _this2.totalProfitOrLoss += item.profitOrLoss;
        _this2.totalPurchased += item.avgPurchasePrice * item.currentQty;
        _this2.totalSold += item.avgSalePrice * item.currentQty;
      });
      return;
    },
    // print
