(self["webpackChunk"] = self["webpackChunk"] || []).push([[6772],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-40639539]{border:none!important}.invoice-returns-table[data-v-40639539]{border-collapse:separate;border-spacing:0}.invoice-returns-table thead th[data-v-40639539]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoice-returns-table thead tr[data-v-40639539]{border:none!important}.invoice-returns-table thead th[data-v-40639539]:first-child{border-top-left-radius:10px}.invoice-returns-table thead th[data-v-40639539]:last-child{border-top-right-radius:10px}.invoice-returns-table tfoot[data-v-40639539]{background-color:#f8fafc;border-top:2px solid #33a0d9}.invoice-returns-table tfoot td[data-v-40639539]{font-weight:600;padding:12px 8px}.invoice-returns-table tfoot tr:last-child td[data-v-40639539]:first-child{border-bottom-left-radius:10px}.invoice-returns-table tfoot tr:last-child td[data-v-40639539]:last-child{border-bottom-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-40639539]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoice-returns-table thead th[data-v-40639539]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-40639539]{background:#33a0d91a!important;border:none;border-radius:10px;color:#33a0d9!important;height:44px;padding:10px 16px;width:56px}.export-excel-btn[data-v-40639539],.export-pdf-btn[data-v-40639539]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-40639539],.export-pdf-btn[data-v-40639539],.print-btn[data-v-40639539]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-40639539]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-40639539]{display:inline-block;position:relative}.action-icon-btn[data-v-40639539]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-40639539]{animation:slideInDown-40639539 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-40639539]{left:45px!important;right:auto!important}@keyframes slideInDown-40639539{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-40639539]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-40639539]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-40639539]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-40639539]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-40639539]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-40639539]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-40639539]:last-child{border-bottom:none}.action-menu li a[data-v-40639539]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-40639539]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-40639539]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-40639539]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-40639539]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-40639539]{gap:10px}.card[data-v-40639539]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-40639539]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoice-returns-table .badge.bg-success[data-v-40639539]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.invoice-returns-table .badge.bg-danger[data-v-40639539]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-40639539]{background:#fff!important}.btn-primary[data-v-40639539]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/index.vue?vue&type=template&id=40639539&scoped=true
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_c('thead', [_c('th', [_vm._v(_vm._s(_vm.$t("#")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Return No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Invoice No")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Client")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Return Reason")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Date")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Subtotal")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Net Total")))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _vm.$can('invoice-return-edit') || _vm.$can('invoice-return-view') || _vm.$can('invoice-return-delete') ? _c('th', {
    ...
    }, [_vm._v("\n                      " + _vm._s(_vm._f("withPrefix")(data.returnNo, _vm.invoiceReturnPrefix)) + "\n                    ")]) : _c('span', [_vm._v(_vm._s(_vm._f("withPrefix")(data.returnNo, _vm.invoiceReturnPrefix)))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("withPrefix")(data.invoiceNo, _vm.invoicePrefix)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.clientName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(data.reason))]), _vm._v(" "), _c('td', [data.returnDate ? _c('span', [_vm._v(_vm._s(_vm._f("moment")(data.returnDate, "Do MMM, YYYY")))]) : _vm._e()]), _vm._v(" "), _c('td', {
      domProps: {
        "innerHTML": _vm._s(_vm.formatCurrency(data.subtotal || 0))
      }
    }), _vm._v(" "), _c('td', {
      domProps: {
        "innerHTML": _vm._s(_vm.formatCurrency(data.netTotal || data.totalReturn || 0))
      }
  ...
  }, [_c('EmptyTable')], 1)])], 2), _vm._v(" "), _vm.items.length > 0 ? _c('tfoot', [_c('tr', [_c('td', {
    ...
    domProps: {
      "innerHTML": _vm._s(_vm.formatCurrency(_vm.totalSubtotal))
    }
  })]), _vm._v(" "), _c('td', {
    staticClass: "text-right",
    staticStyle: {
    ...
    domProps: {
      "innerHTML": _vm._s(_vm.formatCurrency(_vm.totalNetTotal))
    }
  })]), _vm._v(" "), _c('td'), _vm._v(" "), _vm.$can('invoice-return-edit') || _vm.$can('invoice-return-view') || _vm.$can('invoice-return-delete') ? _c('td') : _vm._e()])]) : _vm._e()])])], 1), _vm._v(" "), _c('div', {
...
/* harmony default export */ const returnsvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)("operations", ["items", "loading", "pagination", "appInfo"])), {}, {
    ...
    totalSubtotal: function totalSubtotal() {
      if (!this.items || this.items.length === 0) {
        return 0;
      }
      return this.items.reduce(function (total, item) {
        var amount = parseFloat(item.subtotal) || 0;
        return total + amount;
      }, 0);
    },
    // Calculate total net total for all returns in current page
    totalNetTotal: function totalNetTotal() {
      if (!this.items || this.items.length === 0) {
        return 0;
      }
      return this.items.reduce(function (total, item) {
        var amount = parseFloat(item.netTotal || item.totalReturn) || 0;
        return total + amount;
      }, 0);
    }
  }),
...
var update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_0_id_40639539_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const sales_returnsvue_type_style_index_0_id_40639539_prod_scoped_true_lang_css = (returnsvue_type_style_index_0_id_40639539_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/index.vue?vue&type=style&index=0&id=40639539&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/index.vue?vue&type=style&index=1&id=40639539&prod&lang=css
var returnsvue_type_style_index_1_id_40639539_prod_lang_css = __webpack_require__(74160);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/returns/index.vue?vue&type=style&index=1&id=40639539&prod&lang=css

            

var returnsvue_type_style_index_1_id_40639539_prod_lang_css_options = {};

returnsvue_type_style_index_1_id_40639539_prod_lang_css_options.insert = "head";
returnsvue_type_style_index_1_id_40639539_prod_lang_css_options.singleton = false;

var returnsvue_type_style_index_1_id_40639539_prod_lang_css_update = injectStylesIntoStyleTag_default()(returnsvue_type_style_index_1_id_40639539_prod_lang_css/* default */.A, returnsvue_type_style_index_1_id_40639539_prod_lang_css_options);



/* harmony default export */ const sales_returnsvue_type_style_index_1_id_40639539_prod_lang_css = (returnsvue_type_style_index_1_id_40639539_prod_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/returns/index.vue?vue&type=style&index=1&id=40639539&prod&lang=css
