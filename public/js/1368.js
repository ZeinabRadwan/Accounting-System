"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1368],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-1031f084]{margin-bottom:15px}.footer-buttons[data-v-1031f084]{display:flex;gap:10px}.footer-buttons .btn[data-v-1031f084]{margin-right:10px}.footer-buttons .btn[data-v-1031f084]:last-child{margin-right:0}.create-btn[data-v-1031f084]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-1031f084]:hover{background-color:#e9ecef}.edit-btn[data-v-1031f084]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-1031f084]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-1031f084]{border:none!important}.quotations-create-table[data-v-1031f084]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-1031f084]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-1031f084]{border:none!important}.quotations-create-table thead th[data-v-1031f084]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-1031f084]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-1031f084]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-1031f084]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-1031f084]{gap:10px}.card[data-v-1031f084]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-1031f084]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-1031f084]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-1031f084]{background:#fff!important}.btn-primary[data-v-1031f084]{background:#2ab930!important}.btn-secondary[data-v-1031f084]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-1031f084]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-1031f084],.button-plus[data-v-1031f084]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-1031f084]{background-color:#dc3545;color:#fff}.button-plus[data-v-1031f084]{background-color:#007bff;color:#fff}.button-minus[data-v-1031f084]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-1031f084]:hover{background-color:#0056b3;transform:scale(1.05)}.price-field[data-v-1031f084]{width:100%}.quantity-field[data-v-1031f084]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-1031f084]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-1031f084]{direction:rtl}[dir=rtl] .create-btn[data-v-1031f084]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-1031f084]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-1031f084]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-1031f084]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-1031f084]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-1031f084]{border-right:1px solid #ced4da}.clickable-badge[data-v-1031f084]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-1031f084]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-1031f084]:active{transform:scale(.95)}.insufficient-stock-input[data-v-1031f084]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-1031f084]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-1031f084]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-1031f084]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-1031f084]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-1031f084]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-1031f084]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-1031f084]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-1031f084]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-1031f084]:last-child{border-bottom:none}.debug-display[data-v-1031f084]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-1031f084]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-1031f084]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-1031f084]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-1031f084]:last-child{border-bottom:none}.debug-panel .table th[data-v-1031f084]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-1031f084]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-1031f084]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-1031f084]{padding:15px}.debug-item .row[data-v-1031f084]{margin:0}.debug-item .col-md-6[data-v-1031f084]{padding:0 5px}.debug-step[data-v-1031f084]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-1031f084]{font-size:.75em}}.summary-footer-wrapper[data-v-1031f084]{margin-top:10px}.summary-card[data-v-1031f084]{background:#fff;border:1px solid #e5e7eb;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.05);overflow:hidden}.summary-card-horizontal[data-v-1031f084]{padding:12px 15px}.summary-row-horizontal[data-v-1031f084]{align-items:center;display:flex;flex-wrap:wrap;gap:8px;justify-content:space-between}.summary-item[data-v-1031f084]{align-items:center;display:flex;flex:1;flex-direction:column;min-width:100px;padding:0 12px}.summary-item-label[data-v-1031f084]{color:#6b7280;font-size:11px;font-weight:500;letter-spacing:.5px;margin-bottom:4px;text-transform:uppercase}.summary-item-value[data-v-1031f084]{color:#111827;font-size:14px;font-weight:600;text-align:center}.summary-item-discount .summary-item-value[data-v-1031f084]{color:#dc2626}.summary-item-total[data-v-1031f084]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-radius:6px;margin:0 -5px;padding:8px 15px}.summary-item-total .summary-item-label[data-v-1031f084]{color:#1e40af;font-size:12px;font-weight:600}.summary-item-total .summary-item-value[data-v-1031f084]{color:#33a0d9;font-size:16px;font-weight:700}.summary-divider[data-v-1031f084]{background-color:#e5e7eb;flex-shrink:0;height:40px;width:1px}.summary-divider-bold[data-v-1031f084]{background-color:#33a0d9;height:50px;width:2px}.summary-total[data-v-1031f084]{color:#33a0d9;font-size:16px;font-weight:700}[dir=rtl] .summary-item[data-v-1031f084]{direction:rtl}@media (max-width:992px){.summary-row-horizontal[data-v-1031f084]{flex-wrap:wrap;justify-content:center}.summary-item[data-v-1031f084]{min-width:80px;padding:0 8px}.summary-divider[data-v-1031f084]{display:none}}@media (max-width:768px){.summary-card-horizontal[data-v-1031f084]{padding:10px 12px}.summary-item[data-v-1031f084]{min-width:70px;padding:0 6px}.summary-item-label[data-v-1031f084]{font-size:10px}.summary-item-value[data-v-1031f084]{font-size:13px}.summary-item-total[data-v-1031f084]{margin:8px 0 0;padding:10px;width:100%}.summary-item-total .summary-item-value[data-v-1031f084]{font-size:18px}}@media (max-width:576px){.summary-card[data-v-1031f084]{border-radius:6px}.summary-item[data-v-1031f084]{min-width:60px;padding:0 4px}.summary-item-label[data-v-1031f084]{font-size:9px}.summary-item-value[data-v-1031f084]{font-size:12px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=1031f084&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=1031f084&scoped=true
...
var createvue_type_style_index_0_id_1031f084_prod_scoped_true_lang_css = __webpack_require__(12154);
;// ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/create.vue?vue&type=style&index=0&id=1031f084&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_1031f084_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_createvue_type_style_index_0_id_1031f084_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_1031f084_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=style&index=0&id=1031f084&prod&scoped=true&lang=css
