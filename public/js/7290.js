  ...
  methods: {
    ...
    saveExpense: function saveExpense() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var formData, _iterator, _step, _step$value, key, value, response, _error$response, _error$response2, _error$response3, errors, errorMessages, _error$response4, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 6:
              _context4.p = 6;
              _t4 = _context4.v;
              console.error('Error details:', (_error$response = _t4.response) === null || _error$response === void 0 ? void 0 : _error$response.data);

              // Handle validation errors (422)
              if (((_error$response2 = _t4.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 422 && (_error$response3 = _t4.response) !== null && _error$response3 !== void 0 && (_error$response3 = _error$response3.data) !== null && _error$response3 !== void 0 && _error$response3.errors) {
                errors = _t4.response.data.errors; // Set form errors to display under fields
                ...
                sweetalert2_all_default().fire({
                  icon: 'error',
                  title: _this5.$t('Error'),
                  text: ((_error$response4 = _t4.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || _this5.$t('Please check your input and try again.')
                });
              }
            case 7:
              return _context4.a(2);
