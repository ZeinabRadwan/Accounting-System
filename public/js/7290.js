"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7290],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/create.vue?vue&type=template&id=563279e2&scoped=true
  ...
  methods: {
    ...
    onFileChange: function onFileChange(e) {
      ...
      if (!validTypes.includes(file.type)) {
        this.$toast.error(this.$t('Error!'), this.$t('Please select a valid image file (jpeg, png, jpg, gif)'));
        e.target.value = ''; // Clear the input
        this.url = null;
        this.imageFile = null;
        this.form.image = '';
    ...
    saveExpense: function saveExpense() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var formData, _iterator, _step, _step$value, key, value, response, _error$response, _error$response2, _error$response3, errors, errorMessages, _error$response4;
          ...
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              sweetalert2_all_default().fire({
                ...
                text: _this5.$t('Please select a payment account')
              });
            ...
            case 3:
              ...
              sweetalert2_all_default().fire({
                icon: 'error',
                title: _this5.$t('Error'),
                text: _this5.$t('Please select an expense account')
              });
              return _context4.abrupt("return");
            case 6:
              ...
              sweetalert2_all_default().fire({
                icon: 'error',
                title: _this5.$t('Error'),
                text: _this5.$t('Please select a sub category')
              });
              return _context4.abrupt("return");
            case 9:
              ...
              if (_this5.imageFile && _this5.imageFile instanceof File) {
                formData.append('image', _this5.imageFile);
              }
            ...
            case 30:
              ...
              if (response.data.success) {
                ...
                sweetalert2_all_default().fire({
                  ...
                  text: _this5.$t('Expense added successfully'),
                  timer: 2000,
            ...
            case 34:
              ...
              console.error('Error details:', (_error$response = _context4.t0.response) === null || _error$response === void 0 ? void 0 : _error$response.data);

              // Handle validation errors (422)
              if (((_error$response2 = _context4.t0.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 422 && (_error$response3 = _context4.t0.response) !== null && _error$response3 !== void 0 && (_error$response3 = _error$response3.data) !== null && _error$response3 !== void 0 && _error$response3.errors) {
                errors = _context4.t0.response.data.errors; // Set form errors to display under fields
                ...
                sweetalert2_all_default().fire({
                  ...
                  confirmButtonText: _this5.$t('OK')
                });

                // Scroll to first error field
                _this5.$nextTick(function () {
                  setTimeout(function () {
                    var firstError = _this5.$el.querySelector('.is-invalid');
                    if (firstError) {
                ...
                sweetalert2_all_default().fire({
                  icon: 'error',
                  title: _this5.$t('Error'),
                  text: ((_error$response4 = _context4.t0.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || _this5.$t('Please check your input and try again.')
                });
              }
            case 38:
            case "end":
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_563279e2_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const expenses_createvue_type_style_index_0_id_563279e2_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_563279e2_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/create.vue?vue&type=style&index=0&id=563279e2&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-563279e2]{gap:10px}.header-buttons[data-v-563279e2]{margin-bottom:15px}.footer-buttons[data-v-563279e2]{display:flex;gap:10px}.footer-buttons .btn[data-v-563279e2]{margin-right:10px}.footer-buttons .btn[data-v-563279e2]:last-child{margin-right:0}.card[data-v-563279e2]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-563279e2]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-563279e2]{padding:1.25rem}.card-footer[data-v-563279e2]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.btn-primary[data-v-563279e2]{background:#2ab930!important}.btn-primary[data-v-563279e2],.btn-secondary[data-v-563279e2]{border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-563279e2]{background:#33a0d9!important}.btn-secondary[data-v-563279e2]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}", ""]);
// Exports
