      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0() {
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            ...
            case 61:
              _context0.prev = 61;
              _context0.t0 = _context0["catch"](52);
              _this18.loading = false;
              throw _context0.t0;
            case 65:
              _context0.next = 73;
            ...
            case 69:
              _yield$_this18$form$p = _context0.sent;
            ...
            case 85:
              ...
              errorMessage = _context0.t1.response.data.message || _context0.t1.response.data.error || _this18.$t("Bad Request Error");
            ...
            case 92:
              ...
              if (!_this18.handleBusinessLogicError(_context0.t1.response.data)) {
            ...
            case 95:
              if (((_error$response14 = _context0.t1.response) === null || _error$response14 === void 0 ? void 0 : _error$response14.status) === 401) {
                ...
                _errorMessage = _context0.t1.response.data.message || _this18.$t("Data Conflict Error");
                toast.fire({
                  type: "error",
                ...
                _errorMessage2 = _context0.t1.response.data.message || _this18.$t("Please check your input and try again.");
                toast.fire({
                  type: "error",
                  title: _this18.$t("Validation Error"),
                  text: _errorMessage2,
                ...
                _errorMessage3 = _context0.t1.response.data.message || _this18.$t("Server Error");
                toast.fire({
                  type: "error",
          ...
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 11:
              ...
              if (((_error$response21 = _context10.t0.response) === null || _error$response21 === void 0 ? void 0 : _error$response21.status) === 400) {
                errorMessage = _context10.t0.response.data.message || _this21.$t("Bad request error");
                toast.fire({
                  type: "error",
                ...
                _errorMessage4 = _context10.t0.response.data.message || _this21.$t("Server error");
                toast.fire({
                  type: "error",
          ...
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 11:
              ...
              if (((_error$response27 = _context11.t0.response) === null || _error$response27 === void 0 ? void 0 : _error$response27.status) === 400) {
                errorMessage = _context11.t0.response.data.message || _this25.$t("Bad request error");
                toast.fire({
                  type: "error",
                ...
                _errorMessage5 = _context11.t0.response.data.message || _this25.$t("Server error");
                toast.fire({
                  type: "error",
