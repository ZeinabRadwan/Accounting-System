...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/index.vue?vue&type=template&id=3dafb718
                ...
                if (result.value) {
                  _this0.$store.dispatch("operations/deleteData", {
                    ...
                    if (response === true) {
                      ...
                      Swal.fire(_this0.$t("Failed!"), _this0.$t(response.message), "warning");
                    }
                  });
                }
              });
