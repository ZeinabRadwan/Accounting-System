"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8028],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".overlay[data-v-72b0f092]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.info-box[data-v-72b0f092]{background:#fff;border:1px solid #dee2e6;margin-bottom:1rem;padding:1rem}.info-box[data-v-72b0f092],.info-box-icon[data-v-72b0f092]{align-items:center;border-radius:.375rem;display:flex}.info-box-icon[data-v-72b0f092]{height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-72b0f092]{flex:1}.info-box-text[data-v-72b0f092]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-72b0f092]{color:#495057;display:block;font-size:1.25rem;font-weight:600}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/invoice-summary.vue?vue&type=template&id=72b0f092&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    staticClass: "text-right"
  }, [_vm._v(_vm._s(_vm.$t('Tax')))])])]), _vm._v(" "), _c('tbody', [_vm.reportData.client_summary.length === 0 ? _c('tr', [_c('td', {
    ...
    return _c('tr', {
      ...
      staticClass: "text-right"
    }, [_vm._v(_vm._s(_vm.numberFormat(client.total_amount)))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_vm._v(_vm._s(_vm.numberFormat(client.paid_amount)))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_vm._v(_vm._s(_vm.numberFormat(client.due_amount)))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_vm._v(_vm._s(_vm.numberFormat(client.discount_amount)))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_vm._v(_vm._s(_vm.numberFormat(client.tax_amount)))])]);
  })], 2)])])])]), _vm._v(" "), _c('div', {
    staticClass: "row mb-4"
  }, [_c('div', {
    staticClass: "col-12"
    ...
    return _c('tr', {
      ...
      staticClass: "text-right"
    }, [_vm._v(_vm._s(_vm.numberFormat(returnData.invoice.sub_total)))]), _vm._v(" "), _c('td', {
...
;// ./resources/js/pages/reports/invoice-summary.vue?vue&type=template&id=72b0f092&scoped=true
...
var update = injectStylesIntoStyleTag_default()(invoice_summaryvue_type_style_index_0_id_72b0f092_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_invoice_summaryvue_type_style_index_0_id_72b0f092_prod_scoped_true_lang_css = (invoice_summaryvue_type_style_index_0_id_72b0f092_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/reports/invoice-summary.vue?vue&type=style&index=0&id=72b0f092&prod&scoped=true&lang=css
