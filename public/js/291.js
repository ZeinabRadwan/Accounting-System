...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-52206d18]{border:none!important;overflow:visible!important}.clients-table[data-v-52206d18]{border-collapse:separate;border-spacing:0}.clients-table thead th[data-v-52206d18]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.clients-table thead tr[data-v-52206d18]{border:none!important}.clients-table thead th[data-v-52206d18]:first-child{border-top-left-radius:10px}.clients-table thead th[data-v-52206d18]:last-child{border-top-right-radius:10px}[dir=rtl] .clients-table thead th[data-v-52206d18]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .clients-table thead th[data-v-52206d18]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.refresh-btn[data-v-52206d18]{background:#33a0d91a!important;color:#33a0d9!important}.import-btn[data-v-52206d18],.refresh-btn[data-v-52206d18]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.import-btn[data-v-52206d18]{background:#6c757d1a!important;color:#6c757d!important}.export-excel-btn[data-v-52206d18],.export-pdf-btn[data-v-52206d18]{background:#f6fef4!important;color:#2ab930!important}.export-excel-btn[data-v-52206d18],.export-pdf-btn[data-v-52206d18],.print-btn[data-v-52206d18]{border:none;border-radius:10px;height:44px;padding:10px 16px;width:56px}.print-btn[data-v-52206d18]{background:#33a0d91a!important;color:#33a0d9!important}.action-dropdown[data-v-52206d18]{display:inline-block;position:relative}.action-icon-btn[data-v-52206d18]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-52206d18]{animation:slideInDown-52206d18 .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-52206d18]{left:45px!important;right:auto!important}@keyframes slideInDown-52206d18{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-52206d18]{align-items:center;background:#fafbfc;border-bottom:1px solid #f1f5f9;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:16px 20px 12px}.action-menu-title[data-v-52206d18]{color:#374151;font-size:14px;font-weight:600;margin:0}.action-menu-close[data-v-52206d18]{align-items:center;background:none;border:none;border-radius:4px;cursor:pointer;display:flex;justify-content:center;padding:4px;transition:background-color .2s ease}.action-menu-close[data-v-52206d18]:hover{background-color:#e5e7eb}.action-menu ul[data-v-52206d18]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-52206d18]{margin:0}.action-menu li a[data-v-52206d18]{align-items:center;border-left:3px solid transparent;color:#374151;display:flex;font-size:14px;font-weight:500;gap:12px;padding:12px 20px;text-decoration:none;transition:all .2s ease}.action-menu li a[data-v-52206d18]:hover{background:#f8fafc;border-left-color:#3b82f6;color:#1f2937;transform:translateX(2px)}.action-menu li a svg[data-v-52206d18]{flex-shrink:0;height:16px;width:16px}.btn-group.c-w-100[data-v-52206d18]{gap:10px}.card[data-v-52206d18]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.card-footer[data-v-52206d18]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.clients-table .badge.bg-success[data-v-52206d18]{background:#f6fef4!important;color:#2ab930!important}.clients-table .badge.bg-danger[data-v-52206d18],.clients-table .badge.bg-success[data-v-52206d18]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.clients-table .badge.bg-danger[data-v-52206d18]{background:#fef4f4!important;color:#dc3545!important}.clients-table .badge.bg-info[data-v-52206d18]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-52206d18]{background:#fff!important}.btn-primary[data-v-52206d18]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}.preview-sm[data-v-52206d18]{height:40px;-o-object-fit:cover;object-fit:cover;width:40px}.no-preview-sm[data-v-52206d18]{align-items:center;display:flex;font-size:10px;height:40px;justify-content:center;width:40px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/clients/index.vue?vue&type=template&id=52206d18&scoped=true
...
var update = injectStylesIntoStyleTag_default()(clientsvue_type_style_index_0_id_52206d18_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const pages_clientsvue_type_style_index_0_id_52206d18_prod_scoped_true_lang_css = (clientsvue_type_style_index_0_id_52206d18_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/clients/index.vue?vue&type=style&index=0&id=52206d18&prod&scoped=true&lang=css
