(self["webpackChunk"] = self["webpackChunk"] || []).push([[4885],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/expenses/categories/create.vue?vue&type=template&id=6717094c&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_6717094c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const categories_createvue_type_style_index_0_id_6717094c_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_6717094c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/expenses/categories/create.vue?vue&type=style&index=0&id=6717094c&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-6717094c]{gap:10px}.card[data-v-6717094c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-6717094c]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-6717094c]{padding:1.25rem}.card-footer[data-v-6717094c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-6717094c]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-6717094c]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-6717094c]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-6717094c]{color:#dc3545;font-weight:700}.btn-primary[data-v-6717094c]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-6717094c]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-6717094c]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-6717094c]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-6717094c]{border-color:#dc3545!important}#editor[data-v-6717094c]{border:1px solid #e5e7eb;min-height:200px}#editor[data-v-6717094c],#editor .ql-editor[data-v-6717094c]{background:#fff!important;border-radius:10px}#editor .ql-editor[data-v-6717094c]{font-size:14px;padding:12px 16px}#editor .ql-toolbar[data-v-6717094c]{background:#f8f9fa!important;border:1px solid #e5e7eb;border-bottom:none;border-radius:10px 10px 0 0}#editor .ql-container[data-v-6717094c]{border:1px solid #e5e7eb;border-radius:0 0 10px 10px;border-top:none}#editor[data-v-6717094c]:focus-within{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.row[data-v-6717094c]{margin-bottom:1rem}@media (max-width:768px){.card-footer[data-v-6717094c]{flex-direction:column;gap:10px}.card-footer .btn[data-v-6717094c]{margin-right:0!important;width:100%}.card-footer div[data-v-6717094c]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
