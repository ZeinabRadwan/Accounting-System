  ...
  methods: {
    ...
    autoAssignClientChartOfAccount: function autoAssignClientChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var currentClientSlug, response, newAccountId, idx, _error$response, _error$response3, _error$response4, _error$response2, _error$response5, _t4;
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            ...
            case 4:
              ...
              if (((_error$response = _t4.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 400) {
                toast.fire({
                  type: 'error',
                  title: _this1.$t('Invalid Request'),
                  text: ((_error$response2 = _t4.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this1.$t('Please check the client data and try again')
                });
              } else if (((_error$response3 = _t4.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 403 || ((_error$response4 = _t4.response) === null || _error$response4 === void 0 ? void 0 : _error$response4.status) === 401) {
                toast.fire({
                  type: 'error',
                ...
                toast.fire({
                  type: 'error',
                  title: _this1.$t('Failed to assign Chart of Account'),
                  text: ((_error$response5 = _t4.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || _t4.message || _this1.$t('An error occurred. Please try again.')
                });
              }
            case 5:
              _context0.p = 5;
    ...
    autoAssignSupplierChartOfAccount: function autoAssignSupplierChartOfAccount() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        var currentSupplierSlug, response, newAccountId, idx, _error$response6, _error$response8, _error$response9, _error$response7, _error$response0, _t5;
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 4:
              ...
              if (((_error$response6 = _t5.response) === null || _error$response6 === void 0 ? void 0 : _error$response6.status) === 400) {
                toast.fire({
                  type: 'error',
                  title: _this10.$t('Invalid Request'),
                  text: ((_error$response7 = _t5.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || _this10.$t('Please check the supplier data and try again')
                });
              } else if (((_error$response8 = _t5.response) === null || _error$response8 === void 0 ? void 0 : _error$response8.status) === 403 || ((_error$response9 = _t5.response) === null || _error$response9 === void 0 ? void 0 : _error$response9.status) === 401) {
                toast.fire({
                  type: 'error',
                ...
                toast.fire({
                  type: 'error',
                  title: _this10.$t('Failed to assign Chart of Account'),
                  text: ((_error$response0 = _t5.response) === null || _error$response0 === void 0 || (_error$response0 = _error$response0.data) === null || _error$response0 === void 0 ? void 0 : _error$response0.message) || _t5.message || _this10.$t('An error occurred. Please try again.')
                });
              }
            case 5:
              _context1.p = 5;
