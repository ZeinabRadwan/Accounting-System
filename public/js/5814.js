...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".client-status[data-v-10f7f39b],.supplier-status[data-v-10f7f39b]{font-size:13px}.client-success[data-v-10f7f39b],.client-warning[data-v-10f7f39b],.supplier-warning[data-v-10f7f39b]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-10f7f39b],.supplier-warning[data-v-10f7f39b]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-10f7f39b]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.create-btn[data-v-10f7f39b]{align-items:center;background-color:#33a0d9;border:1px solid #33a0d9;border-left:none;border-radius:0 10px 10px 0;color:#fff;cursor:pointer;display:flex;justify-content:center;padding:10px 16px;transition:all .3s ease}.create-btn[data-v-10f7f39b]:hover{background-color:#2a8bc4;border-color:#2a8bc4}.create-btn i[data-v-10f7f39b]{font-size:18px}.account-select[data-v-10f7f39b],[dir=rtl] .create-btn[data-v-10f7f39b]{border-radius:10px 0 0 10px}[dir=rtl] .create-btn[data-v-10f7f39b]{border-left:1px solid #33a0d9;border-right:none}[dir=rtl] .account-select[data-v-10f7f39b]{border-radius:0 10px 10px 0}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/vouchers/send/create.vue?vue&type=template&id=10f7f39b&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    ...
    staticClass: "form-text text-muted"
  }, [_vm._v("\n                  " + _vm._s(_vm.$t("Automatically set based on payment method")) + "\n                ")])]) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.form && _vm.form.entityType === 'supplier' && _vm.purchases ? _c('div', {
    staticClass: "row"
  }, [_c('div', {
    staticClass: "form-group col-md-12"
  }, [_c('label', {
    ...
    handleQueryParams: function handleQueryParams() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              query = _this2.$route.query; // If purchase and supplier are provided, auto-fill the form
              if (!(query.purchase && query.supplier)) {
                _context.next = 12;
                break;
              }
              // Set entity type to supplier
              _this2.form.entityType = 'supplier';

              // Get suppliers first
              _context.next = 5;
              return _this2.getSuppliers();
            case 5:
              // Find and set the supplier
              supplier = _this2.suppliers.find(function (s) {
              ...
              _this2.form.supplier = supplier;
              // Set payment method to purchase (for backward compatibility)
              _this2.form.paymentMethod = 'purchase';

              // Get purchases for this supplier
              _context.next = 11;
              return _this2.getPurchases();
            case 11:
              // Find and set the purchase
              if (_this2.purchases && _this2.purchases.length > 0) {
                purchase = _this2.purchases.find(function (p) {
                  return p.slug === query.purchase;
                });
                if (purchase) {
                  _this2.form.purchase = purchase;
                }
              }
            case 12:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 2:
              ...
              account = _this9.accounts.find(function (acc) {
              ...
              if (!account && newAccount) {
                ...
                _this9.accounts.push(account);
              }
              if (account) {
                // Use $nextTick to ensure Vue updates the form
                _this9.$nextTick(function () {
                  _this9.form.account = account;
                  _this9.updateBalance();
                });
              }
            case 6:
            case "end":
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              _this0.loadingPaymentMethods = true;
              _context9.prev = 1;
              _context9.next = 4;
            ...
            case 4:
              ...
              if (response.data) {
                if (Array.isArray(response.data)) {
                  _this0.paymentMethods = response.data;
            ...
            case 8:
              ...
              console.error('Error loading payment methods:', _context9.t0);
              _this0.paymentMethods = [];
              toast.fire({
                type: 'error',
                title: _this0.$t('Error'),
                text: _this0.$t('Failed to load payment methods')
              });
            case 13:
              _context9.prev = 13;
              _this0.loadingPaymentMethods = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0() {
        ...
        return _regeneratorRuntime().wrap(function _callee0$(_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              if (!(!_this1.form.client || !_this1.form.client.slug || _this1.isAutoAssigningClient)) {
                _context0.next = 2;
                break;
              }
            ...
            case 2:
              ...
              _context0.prev = 3;
              currentClientSlug = _this1.form.client.slug;
              _context0.next = 7;
              return axios_default().post("/api/clients/".concat(_this1.form.client.slug, "/auto-assign-chart-of-account"));
            case 7:
              ...
              if (response.data.success) {
                ...
                if (newAccountId) {
                  ...
                  idx = (_this1.clients || []).findIndex(function (i) {
                    return i.slug === currentClientSlug;
                  });
                  if (idx !== -1) {
                    _this1.$set(_this1.clients[idx], 'chart_of_account_id', newAccountId);
                  }
                }
            ...
            case 11:
              ...
              if (((_error$response = _context0.t0.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 400) {
                toast.fire({
                  type: 'error',
                  title: _this1.$t('Invalid Request'),
                  text: ((_error$response2 = _context0.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this1.$t('Please check the client data and try again')
                });
              } else if (((_error$response3 = _context0.t0.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 403 || ((_error$response4 = _context0.t0.response) === null || _error$response4 === void 0 ? void 0 : _error$response4.status) === 401) {
                toast.fire({
                  type: 'error',
                  title: _this1.$t('Permission Denied'),
                  text: _this1.$t("You don't have permission to assign Chart of Accounts.")
                });
              } else {
                toast.fire({
                  type: 'error',
                  title: _this1.$t('Failed to assign Chart of Account'),
                  text: ((_error$response5 = _context0.t0.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || _context0.t0.message || _this1.$t('An error occurred. Please try again.')
                });
              }
            case 15:
              _context0.prev = 15;
        ...
        return _regeneratorRuntime().wrap(function _callee1$(_context1) {
          while (1) switch (_context1.prev = _context1.next) {
            ...
            case 11:
              ...
              if (((_error$response6 = _context1.t0.response) === null || _error$response6 === void 0 ? void 0 : _error$response6.status) === 400) {
                toast.fire({
                  type: 'error',
                  title: _this10.$t('Invalid Request'),
                  text: ((_error$response7 = _context1.t0.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || _this10.$t('Please check the supplier data and try again')
                });
              } else if (((_error$response8 = _context1.t0.response) === null || _error$response8 === void 0 ? void 0 : _error$response8.status) === 403 || ((_error$response9 = _context1.t0.response) === null || _error$response9 === void 0 ? void 0 : _error$response9.status) === 401) {
                toast.fire({
                  type: 'error',
                ...
                toast.fire({
                  type: 'error',
                  title: _this10.$t('Failed to assign Chart of Account'),
                  text: ((_error$response0 = _context1.t0.response) === null || _error$response0 === void 0 || (_error$response0 = _error$response0.data) === null || _error$response0 === void 0 ? void 0 : _error$response0.message) || _context1.t0.message || _this10.$t('An error occurred. Please try again.')
                });
              }
            case 15:
              _context1.prev = 15;
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_10f7f39b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const send_createvue_type_style_index_0_id_10f7f39b_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_10f7f39b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/vouchers/send/create.vue?vue&type=style&index=0&id=10f7f39b&prod&scoped=true&lang=css
