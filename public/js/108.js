...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=template&id=3ef05f4b&scoped=true
  ...
  methods: {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 3:
              _context1.p = 3;
              _t2 = _context1.v;
              console.error('Error fetching archived tenants:', _t2);
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            ...
            case 3:
              _context10.p = 3;
              _t3 = _context10.v;
              console.error('Error searching archived tenants:', _t3);
    ...
    restoreTenant: function restoreTenant(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        var confirmed, response, _error$response, _t4;
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.p = _context13.n) {
            case 0:
              confirmed = confirm(_this13.$t("Are you sure you want to restore this tenant?"));
              if (!confirmed) {
                _context13.n = 4;
                break;
              }
            ...
            case 3:
              _context13.p = 3;
              _t4 = _context13.v;
              console.error('Error restoring tenant:', _t4);
              _this13.$toast.error(_this13.$t("Error!"), ((_error$response = _t4.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this13.$t("Failed to restore tenant"));
            case 4:
    ...
    permanentDeleteTenant: function permanentDeleteTenant(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        var confirmed, response, _error$response2, _t5;
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.p = _context14.n) {
            case 0:
              confirmed = confirm(_this14.$t("Are you sure you want to permanently delete this tenant? This action cannot be undone and will delete all data including the database."));
              if (!confirmed) {
                _context14.n = 4;
                break;
              }
            ...
            case 3:
              _context14.p = 3;
              _t5 = _context14.v;
              console.error('Error permanently deleting tenant:', _t5);
              _this14.$toast.error(_this14.$t("Error!"), ((_error$response2 = _t5.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this14.$t("Failed to permanently delete tenant"));
            case 4:
...
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=3ef05f4b&prod&scoped=true&lang=css
...
;// ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=3ef05f4b&prod&lang=css
