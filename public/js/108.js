...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom .table td[data-v-3ef05f4b]{vertical-align:middle}.profile-area[data-v-3ef05f4b]{align-items:center;display:flex}.profile-area img[data-v-3ef05f4b]{border-radius:100%;height:50px;width:50px}.profile-area a[data-v-3ef05f4b]{display:block}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=template&id=3ef05f4b&scoped=true
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              confirmed = confirm(_this9.$t("Are you sure you want to archive this tenant? The tenant will be moved to archived section and can be restored later."));
              if (!confirmed) {
                _context9.next = 16;
                break;
              }
            ...
            case 12:
              ...
              console.error('Delete request error:', _context9.t0);
              _this9.$toast.warning(_this9.$t("Failed"), _this9.$t("Archive failed"));
            case 16:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.prev = 1;
              _context11.next = 4;
              return axios_default().get("/api/tenants/archived?perPage=".concat(_this11.perPage));
            case 4:
            ...
            case 9:
              ...
              console.error('Error fetching archived tenants:', _context11.t0);
              _this11.$toast.error(_this11.$t("Error!"), _this11.$t("Failed to load archived tenants"));
            case 13:
              _context11.prev = 13;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              _this12.archivedLoading = true;
              _context12.prev = 1;
              params = new URLSearchParams({
                term: _this12.archivedQuery,
                perPage: _this12.perPage
              });
              if (_this12.archivedDateRange.startDate && _this12.archivedDateRange.endDate) {
                params.append('startDate', _this12.archivedDateRange.startDate);
                params.append('endDate', _this12.archivedDateRange.endDate);
              }
              _context12.next = 6;
              return axios_default().get("/api/tenants/archived?".concat(params));
            case 6:
              response = _context12.sent;
              _this12.archivedItems = response.data.data;
              _this12.archivedPagination = response.data.meta;
              _context12.next = 15;
              break;
            case 11:
              _context12.prev = 11;
              _context12.t0 = _context12["catch"](1);
              console.error('Error searching archived tenants:', _context12.t0);
              _this12.$toast.error(_this12.$t("Error!"), _this12.$t("Failed to search archived tenants"));
            case 15:
              _context12.prev = 15;
              _this12.archivedLoading = false;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              _this13.archivedDateRange.startDate = moment_default()(_this13.archivedDateRange.startDate).format("YYYY-MM-DD");
              _this13.archivedDateRange.endDate = moment_default()(_this13.archivedDateRange.endDate).format("YYYY-MM-DD");
              _this13.searchArchivedData();
            case 3:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              _this14.archivedQuery = "";
              _context14.next = 3;
              return _this14.searchArchivedData();
            case 3:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
        ...
        return _regeneratorRuntime().wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            case 0:
              confirmed = confirm(_this15.$t("Are you sure you want to restore this tenant?"));
              if (!confirmed) {
                _context15.next = 13;
                break;
              }
            ...
            case 5:
              ...
              if (response.data.success) {
                _this15.$toast.success(_this15.$t("Success"), _this15.$t("Tenant restored successfully"));
                _this15.getArchivedData();
                _this15.getData(); // Refresh active tenants too
              } else {
                _this15.$toast.error(_this15.$t("Failed"), _this15.$t("Failed to restore tenant"));
              }
              _context15.next = 13;
              break;
            case 9:
              ...
              console.error('Error restoring tenant:', _context15.t0);
              _this15.$toast.error(_this15.$t("Error!"), ((_error$response = _context15.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _this15.$t("Failed to restore tenant"));
            case 13:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
        ...
        return _regeneratorRuntime().wrap(function _callee16$(_context16) {
          while (1) switch (_context16.prev = _context16.next) {
            case 0:
              confirmed = confirm(_this16.$t("Are you sure you want to permanently delete this tenant? This action cannot be undone and will delete all data including the database."));
              if (!confirmed) {
                _context16.next = 13;
                break;
              }
            ...
            case 5:
              ...
              if (response.data.success) {
                _this16.$toast.success(_this16.$t("Success"), _this16.$t("Tenant permanently deleted successfully"));
                _this16.getArchivedData();
              } else {
                _this16.$toast.error(_this16.$t("Failed"), _this16.$t("Failed to permanently delete tenant"));
              }
              _context16.next = 13;
              break;
            case 9:
              ...
              console.error('Error permanently deleting tenant:', _context16.t0);
              _this16.$toast.error(_this16.$t("Error!"), ((_error$response2 = _context16.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _this16.$t("Failed to permanently delete tenant"));
            case 13:
            case "end":
...
var update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_0_id_3ef05f4b_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const central_tenantsvue_type_style_index_0_id_3ef05f4b_prod_scoped_true_lang_css = (tenantsvue_type_style_index_0_id_3ef05f4b_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=0&id=3ef05f4b&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=3ef05f4b&prod&lang=css
var tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css = __webpack_require__(28529);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=3ef05f4b&prod&lang=css

            

var tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css_options = {};

tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css_options.insert = "head";
tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css_options.singleton = false;

var tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css_update = injectStylesIntoStyleTag_default()(tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css/* default */.A, tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css_options);



/* harmony default export */ const central_tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css = (tenantsvue_type_style_index_1_id_3ef05f4b_prod_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/central/tenants/index.vue?vue&type=style&index=1&id=3ef05f4b&prod&lang=css
