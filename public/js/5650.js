...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/products/create.vue?vue&type=template&id=3638b82f&scoped=true
...
;// ./resources/js/pages/products/create.vue?vue&type=template&id=3638b82f&scoped=true
...
var createvue_type_style_index_0_id_3638b82f_prod_scoped_true_lang_css = __webpack_require__(72885);
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_3638b82f_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const products_createvue_type_style_index_0_id_3638b82f_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_3638b82f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/products/create.vue?vue&type=style&index=0&id=3638b82f&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-3638b82f]{gap:10px}.header-buttons[data-v-3638b82f]{margin-bottom:15px}.footer-buttons[data-v-3638b82f]{display:flex;gap:10px}.footer-buttons .btn[data-v-3638b82f]{margin-right:10px}.footer-buttons .btn[data-v-3638b82f]:last-child{margin-right:0}.card[data-v-3638b82f]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-body[data-v-3638b82f]{padding:1.25rem}.card-footer[data-v-3638b82f]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-3638b82f]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-3638b82f]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-3638b82f]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-3638b82f]{color:#dc3545;font-weight:700}.btn-primary[data-v-3638b82f]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-3638b82f]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-3638b82f]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-3638b82f]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-3638b82f]{border-color:#dc3545!important}textarea.form-control[data-v-3638b82f]{min-height:100px;resize:vertical}.v-select[data-v-3638b82f],.v-select .vs__dropdown-toggle[data-v-3638b82f]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-3638b82f]{padding:10px 16px}.v-select .vs__search[data-v-3638b82f]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-3638b82f]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-3638b82f]{color:#374151}.v-select .vs__dropdown-menu[data-v-3638b82f]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.custom-file-input[data-v-3638b82f],.custom-file-label[data-v-3638b82f]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px 16px}.custom-file-label[data-v-3638b82f]{color:#374151}.custom-file-input:focus~.custom-file-label[data-v-3638b82f]{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.bg-light[data-v-3638b82f]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;padding:10px}.img-fluid[data-v-3638b82f]{border-radius:8px;height:auto;max-width:100%}.form-check-input[data-v-3638b82f]{background:#fff!important;border:1px solid #e5e7eb;border-radius:4px}.form-check-input[data-v-3638b82f]:checked{background-color:#2ab930!important;border-color:#2ab930!important}.form-check-label[data-v-3638b82f],.input-group-text[data-v-3638b82f]{color:#374151;font-weight:500}.input-group-text[data-v-3638b82f]{background:#fff!important;border:1px solid #e5e7eb}.btn-outline-custom[data-v-3638b82f]{border-color:#1b3c71;border-radius:10px;color:#1b3c71;font-weight:500;padding:8px 16px;transition:background-color .3s,color .3s,border-color .3s}.btn-custom-active[data-v-3638b82f],.btn-outline-custom[data-v-3638b82f]:hover{background-color:#1b3c71;border-color:#1b3c71;color:#fff}.row[data-v-3638b82f]{margin-bottom:1rem}.form-text[data-v-3638b82f]{color:#6b7280;font-size:.875rem}.text-muted[data-v-3638b82f]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-3638b82f]{flex-direction:column;gap:10px}.card-footer .btn[data-v-3638b82f]{margin-right:0!important;width:100%}.card-footer div[data-v-3638b82f]{display:flex;flex-direction:column;gap:10px;width:100%}}", ""]);
// Exports
