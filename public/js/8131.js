"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8131],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".overlay[data-v-505ef27c]{align-items:center;background-color:rgba(0,0,0,.5);display:flex;height:100%;justify-content:center;left:0;position:fixed;top:0;width:100%;z-index:9999}.info-box[data-v-505ef27c]{background:#fff;border:1px solid #dee2e6;margin-bottom:1rem;padding:1rem}.info-box[data-v-505ef27c],.info-box-icon[data-v-505ef27c]{align-items:center;border-radius:.375rem;display:flex}.info-box-icon[data-v-505ef27c]{height:60px;justify-content:center;margin-right:1rem;width:60px}.info-box-content[data-v-505ef27c]{flex:1}.info-box-text[data-v-505ef27c]{color:#6c757d;display:block;font-size:.875rem;margin-bottom:.25rem}.info-box-number[data-v-505ef27c]{color:#495057;display:block;font-size:1.25rem;font-weight:600}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/reports/invoice-summary.vue?vue&type=template&id=505ef27c&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('Client Name')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Phone')))]), _vm._v(" "), _c('th', {
    ...
    staticClass: "table table-bordered table-striped"
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v(_vm._s(_vm.$t('Invoice #')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Client')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Invoice Date')))]), _vm._v(" "), _c('th', {
    staticClass: "text-right"
...
;// CONCATENATED MODULE: ./resources/js/pages/reports/invoice-summary.vue?vue&type=template&id=505ef27c&scoped=true
...
var update = injectStylesIntoStyleTag_default()(invoice_summaryvue_type_style_index_0_id_505ef27c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const reports_invoice_summaryvue_type_style_index_0_id_505ef27c_prod_scoped_true_lang_css = (invoice_summaryvue_type_style_index_0_id_505ef27c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/reports/invoice-summary.vue?vue&type=style&index=0&id=505ef27c&prod&scoped=true&lang=css
