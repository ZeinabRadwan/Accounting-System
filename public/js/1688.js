...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-e755d722]{margin-bottom:15px}.footer-buttons[data-v-e755d722]{display:flex;gap:10px}.footer-buttons .btn[data-v-e755d722]{margin-right:10px}.footer-buttons .btn[data-v-e755d722]:last-child{margin-right:0}.btn-group.c-w-100[data-v-e755d722]{gap:10px}.card[data-v-e755d722]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-e755d722]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-e755d722]{background:#fff!important}.btn-primary[data-v-e755d722]{background:#2ab930!important}.btn-secondary[data-v-e755d722]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-e755d722]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.table-custom[data-v-e755d722]{border:none!important}.purchases-create-table[data-v-e755d722]{border-collapse:separate;border-spacing:0}.purchases-create-table thead th[data-v-e755d722]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchases-create-table thead tr[data-v-e755d722]{border:none!important}.purchases-create-table thead th[data-v-e755d722]:first-child{border-top-left-radius:10px}.purchases-create-table thead th[data-v-e755d722]:last-child{border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-e755d722]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-e755d722]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.purchases-create-table .badge.badge-info[data-v-e755d722]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.quantity-field[data-v-e755d722]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-e755d722]{font-size:.875rem}.account-status .account-warning[data-v-e755d722]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-e755d722]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.product-status[data-v-e755d722]{font-size:13px}.product-warning[data-v-e755d722]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-e755d722]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-e755d722]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-e755d722]:disabled{cursor:not-allowed;opacity:.6}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/edit.vue?vue&type=template&id=e755d722&scoped=true
...
;// ./resources/js/pages/purchases/returns/edit.vue?vue&type=template&id=e755d722&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_e755d722_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_editvue_type_style_index_0_id_e755d722_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_e755d722_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/edit.vue?vue&type=style&index=0&id=e755d722&prod&scoped=true&lang=css
