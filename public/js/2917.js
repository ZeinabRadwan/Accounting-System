"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2917],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/create.vue?vue&type=template&id=24f9d2fa&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
;// ./resources/js/pages/purchases/create.vue?vue&type=template&id=24f9d2fa&scoped=true
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_24f9d2fa_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const purchases_createvue_type_style_index_0_id_24f9d2fa_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_24f9d2fa_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/create.vue?vue&type=style&index=0&id=24f9d2fa&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card[data-v-24f9d2fa]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-24f9d2fa]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-24f9d2fa]{padding:1.25rem}.card-footer[data-v-24f9d2fa]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-24f9d2fa]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px;font-size:14px;padding:10px 16px}.form-control[data-v-24f9d2fa]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-24f9d2fa]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-24f9d2fa]{color:#dc3545;font-weight:700}.btn-primary[data-v-24f9d2fa]{background:#2ab930!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-24f9d2fa]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-24f9d2fa]{background:#6c757d!important;border:none!important;border-radius:10px!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-24f9d2fa]:hover{background:#5a6268!important;box-shadow:0 4px 8px hsla(208,7%,46%,.3);transform:translateY(-1px)}.is-invalid[data-v-24f9d2fa]{border-color:#dc3545!important}textarea.form-control[data-v-24f9d2fa]{min-height:100px;resize:vertical}.v-select[data-v-24f9d2fa],.v-select .vs__dropdown-toggle[data-v-24f9d2fa]{background:#f1f5fb!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-24f9d2fa]{padding:10px 16px}.v-select .vs__search[data-v-24f9d2fa]::-moz-placeholder{color:#6b7280}.v-select .vs__search[data-v-24f9d2fa]::placeholder{color:#6b7280}.v-select .vs__selected[data-v-24f9d2fa]{color:#374151}.v-select .vs__dropdown-menu[data-v-24f9d2fa]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-24f9d2fa]{border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-custom thead th[data-v-24f9d2fa]{background-color:#f8f9fa;border-bottom:2px solid #e5e7eb;color:#374151;font-weight:600;padding:12px 8px;text-align:center}.table-custom tbody td[data-v-24f9d2fa]{border-bottom:1px solid #e5e7eb;padding:12px 8px;vertical-align:middle}.table-custom tbody tr[data-v-24f9d2fa]:hover{background-color:#f8f9fa}.custom-qty-input[data-v-24f9d2fa]{align-items:center;background:#f1f5fb;border:1px solid #e5e7eb;border-radius:10px;display:flex;overflow:hidden}.custom-qty-input .button-minus[data-v-24f9d2fa],.custom-qty-input .button-plus[data-v-24f9d2fa]{background:#6c757d;border:none;color:#fff;cursor:pointer;font-weight:700;padding:8px 12px;transition:background-color .3s}.custom-qty-input .button-minus[data-v-24f9d2fa]:hover{background:#dc3545}.custom-qty-input .button-plus[data-v-24f9d2fa]:hover{background:#2ab930}.custom-qty-input .quantity-field[data-v-24f9d2fa]{background:transparent;border:none;font-weight:500;padding:8px 4px;text-align:center;width:60px}.custom-qty-input .quantity-field[data-v-24f9d2fa]:focus{box-shadow:none;outline:none}.toggle-button[data-v-24f9d2fa]{margin-right:10px}.create-btn[data-v-24f9d2fa]{background:#2ab930;border:none;border-radius:10px;color:#fff;cursor:pointer;padding:11px;transition:background-color .3s}.create-btn[data-v-24f9d2fa]:hover{background:#229a26}.product-status[data-v-24f9d2fa],.supplier-status[data-v-24f9d2fa]{font-size:13px}.product-success[data-v-24f9d2fa],.product-warning[data-v-24f9d2fa],.supplier-success[data-v-24f9d2fa],.supplier-warning[data-v-24f9d2fa]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-24f9d2fa],.supplier-warning[data-v-24f9d2fa]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-24f9d2fa],.supplier-success[data-v-24f9d2fa]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-24f9d2fa]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-24f9d2fa]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-24f9d2fa]:disabled{cursor:not-allowed;opacity:.6}.row[data-v-24f9d2fa]{margin-bottom:1rem}.form-text[data-v-24f9d2fa]{color:#6b7280;font-size:.875rem}.text-muted[data-v-24f9d2fa]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-24f9d2fa]{flex-direction:column;gap:10px}.card-footer .btn[data-v-24f9d2fa]{margin-right:0!important;width:100%}.card-footer div[data-v-24f9d2fa]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-24f9d2fa]{font-size:12px}.table-custom tbody td[data-v-24f9d2fa],.table-custom thead th[data-v-24f9d2fa]{padding:8px 4px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
