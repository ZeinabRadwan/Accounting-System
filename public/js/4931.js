...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/fiscal-years.vue?vue&type=template&id=3f0ab72a&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    attrs: {
      "columns": _vm.fiscalYearColumns,
      "rows": _vm.fiscalYears,
      "table-id": "printMe",
      "wrapper-class": "mt-3",
      "show-actions": true
    },
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref3) {
        var row = _ref3.row;
        return [_c('span', {
          "class": row.is_active ? 'badge bg-success' : 'badge bg-danger'
        ...
        return [_c('div', {
          ...
          on: {
            "click": function click($event) {
              ...
              return _vm.editFiscalYear(row);
            }
          }
        }, [_c('i', {
          staticClass: "fas fa-edit"
        }), _vm._v("\n                                                " + _vm._s(_vm.$t('Edit')) + "\n                                            ")])]), _vm._v(" "), row.id !== _vm.currentFiscalYearId ? _c('li', [_c('a', {
          attrs: {
            "href": "#"
          },
          on: {
            "click": function click($event) {
              $event.preventDefault();
              return _vm.setCurrentFiscalYear(row);
            }
          }
        }, [_c('i', {
          staticClass: "fas fa-check"
        }), _vm._v("\n                                                " + _vm._s(_vm.$t('Set as Current')) + "\n                                            ")])]) : _vm._e(), _vm._v(" "), row.accounting_periods_count === 0 ? _c('li', [_c('a', {
          attrs: {
            "href": "#"
          },
          on: {
            "click": function click($event) {
              $event.preventDefault();
              return _vm.deleteFiscalYear(row);
            }
          }
        }, [_c('i', {
...
;// ./resources/js/pages/setup/fiscal-years.vue?vue&type=template&id=3f0ab72a&scoped=true
...
/* harmony default export */ const fiscal_yearsvue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)({
    ...
    fiscalYearColumns: function fiscalYearColumns() {
      return [{
        key: 'id',
        label: this.$t('ID')
      }, {
        ...
        key: 'accounting_periods_count',
        label: this.$t('Accounting Periods')
      }];
    }
  }),
...
var fiscal_yearsvue_type_style_index_0_id_3f0ab72a_prod_scoped_true_lang_css = __webpack_require__(84552);
...
var update = injectStylesIntoStyleTag_default()(fiscal_yearsvue_type_style_index_0_id_3f0ab72a_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const setup_fiscal_yearsvue_type_style_index_0_id_3f0ab72a_prod_scoped_true_lang_css = (fiscal_yearsvue_type_style_index_0_id_3f0ab72a_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/setup/fiscal-years.vue?vue&type=style&index=0&id=3f0ab72a&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-3f0ab72a]{border:none!important;overflow:visible!important}.action-dropdown[data-v-3f0ab72a]{display:inline-block;position:relative}.action-icon-btn[data-v-3f0ab72a]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-3f0ab72a]{animation:slideInDown-3f0ab72a .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-3f0ab72a]{left:45px!important;right:auto!important}@keyframes slideInDown-3f0ab72a{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-3f0ab72a]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-3f0ab72a]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-3f0ab72a]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-3f0ab72a]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-3f0ab72a]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-3f0ab72a]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-3f0ab72a]:last-child{border-bottom:none}.action-menu li a[data-v-3f0ab72a]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-3f0ab72a]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-3f0ab72a]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-3f0ab72a]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-3f0ab72a]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-3f0ab72a]{gap:10px}.card[data-v-3f0ab72a]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.general-table .badge.bg-success[data-v-3f0ab72a]{background:#f6fef4!important;color:#2ab930!important}.general-table .badge.bg-danger[data-v-3f0ab72a],.general-table .badge.bg-success[data-v-3f0ab72a]{font-size:12px!important;font-weight:500!important;padding:10px 16px}.general-table .badge.bg-danger[data-v-3f0ab72a]{background:#fef4f4!important;color:#dc3545!important}.btn-primary[data-v-3f0ab72a]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
