"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8068],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/edit.vue?vue&type=template&id=90a98bfc&scoped=true
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              _context6.n = 1;
              return _this7.form.patch(window.location.origin + '/api/purchase-returns/' + _this7.$route.params.slug).then(function (_ref2) {
                var data = _ref2.data;
                toast.fire({
                  type: 'success',
...
var editvue_type_style_index_0_id_90a98bfc_prod_scoped_true_lang_css = __webpack_require__(91099);
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_90a98bfc_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_editvue_type_style_index_0_id_90a98bfc_prod_scoped_true_lang_css = (editvue_type_style_index_0_id_90a98bfc_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/purchases/returns/edit.vue?vue&type=style&index=0&id=90a98bfc&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-90a98bfc]{margin-bottom:15px}.footer-buttons[data-v-90a98bfc]{display:flex;gap:10px}.footer-buttons .btn[data-v-90a98bfc]{margin-right:10px}.footer-buttons .btn[data-v-90a98bfc]:last-child{margin-right:0}.btn-group.c-w-100[data-v-90a98bfc]{gap:10px}.card[data-v-90a98bfc]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-90a98bfc]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-90a98bfc]{background:#fff!important}.btn-primary[data-v-90a98bfc]{background:#2ab930!important}.btn-secondary[data-v-90a98bfc]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.btn-secondary[data-v-90a98bfc]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.table-custom[data-v-90a98bfc]{border:none!important}.purchases-create-table[data-v-90a98bfc]{border-collapse:separate;border-spacing:0}.purchases-create-table thead th[data-v-90a98bfc]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchases-create-table thead tr[data-v-90a98bfc]{border:none!important}.purchases-create-table thead th[data-v-90a98bfc]:first-child{border-top-left-radius:10px}.purchases-create-table thead th[data-v-90a98bfc]:last-child{border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-90a98bfc]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-90a98bfc]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.purchases-create-table .badge.badge-info[data-v-90a98bfc]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.quantity-field[data-v-90a98bfc]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-90a98bfc]{font-size:.875rem}.account-status .account-warning[data-v-90a98bfc]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-90a98bfc]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.product-status[data-v-90a98bfc]{font-size:13px}.product-warning[data-v-90a98bfc]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-90a98bfc]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-90a98bfc]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-90a98bfc]:disabled{cursor:not-allowed;opacity:.6}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
