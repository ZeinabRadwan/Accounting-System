"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8996],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".table-custom[data-v-330a202f]{border:none!important;overflow:visible!important}.accounting-periods-table[data-v-330a202f]{border-collapse:separate;border-spacing:0}.accounting-periods-table thead th[data-v-330a202f]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.accounting-periods-table thead tr[data-v-330a202f]{border:none!important}.accounting-periods-table thead th[data-v-330a202f]:first-child{border-top-left-radius:10px}.accounting-periods-table thead th[data-v-330a202f]:last-child{border-top-right-radius:10px}[dir=rtl] .accounting-periods-table thead th[data-v-330a202f]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .accounting-periods-table thead th[data-v-330a202f]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.action-dropdown[data-v-330a202f]{display:inline-block;position:relative}.action-icon-btn[data-v-330a202f]{align-items:center;background-color:#fff;border:none;cursor:pointer;display:inline-flex;height:24px;justify-content:center;padding:0;width:24px}.action-menu[data-v-330a202f]{animation:slideInDown-330a202f .3s ease-out;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 20px 0 #00000014;max-height:80vh;min-width:200px;overflow:hidden;position:fixed;z-index:9999}[dir=rtl] .action-menu[data-v-330a202f]{left:45px!important;right:auto!important}@keyframes slideInDown-330a202f{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}.action-menu-header[data-v-330a202f]{align-items:center;background:#f8fafc;border-bottom:1px solid #f1f5fb;border-radius:12px 12px 0 0;display:flex;justify-content:space-between;padding:12px 16px}.action-menu-title[data-v-330a202f]{color:#023033;font-size:14px;font-weight:600}.action-menu-close[data-v-330a202f]{background:none;border:none;border-radius:4px;color:#6b7280;cursor:pointer;padding:4px;transition:all .2s ease}.action-menu-close[data-v-330a202f]:hover{background:#e5e7eb;color:#374151}.action-menu ul[data-v-330a202f]{list-style:none;margin:0;padding:8px 0}.action-menu li[data-v-330a202f]{border-bottom:1px solid #f1f5fb}.action-menu li[data-v-330a202f]:last-child{border-bottom:none}.action-menu li a[data-v-330a202f]{align-items:center;color:#023033;display:flex;font-size:14px;font-weight:500;gap:10px;padding:12px 16px;position:relative;text-decoration:none;transition:all .2s ease}.action-menu li a i[data-v-330a202f]{align-items:center;display:flex;font-size:12px;height:16px;justify-content:center;width:16px}.action-menu li a[data-v-330a202f]:hover{background:#f8fafc;color:#2ab930;transform:translateX(2px)}.action-menu li a[data-v-330a202f]:before{background:#2ab930;bottom:0;content:\"\";left:0;position:absolute;top:0;transform:scaleY(0);transition:transform .2s ease;width:3px}.action-menu li a[data-v-330a202f]:hover:before{transform:scaleY(1)}.btn-group.c-w-100[data-v-330a202f]{gap:10px}.card[data-v-330a202f]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px;overflow:visible}.accounting-periods-table .badge.bg-success[data-v-330a202f]{background:#f6fef4!important;color:#2ab930!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.accounting-periods-table .badge.bg-danger[data-v-330a202f]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.accounting-periods-table .badge.bg-secondary[data-v-330a202f]{background:#f8f9fa!important;color:#6c757d!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.btn-primary[data-v-330a202f]{background:#2ab930!important;border:none!important;color:#fff!important;padding:10px 20px!important}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/setup/accounting-periods.vue?vue&type=template&id=330a202f&scoped=true
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Accounting Periods')))])]), _vm._v(" "), _c('div', {
    ...
    staticClass: "table accounting-periods-table"
  }, [_c('thead', [_c('th', [_vm._v(_vm._s(_vm.$t('ID')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Name')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Fiscal Year')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Start Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('End Date')))]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.$t('Status')))]), _vm._v(" "), _c('th', {
    staticClass: "text-right no-print"
  }, [_vm._v(_vm._s(_vm.$t('Actions')))])]), _vm._v(" "), _c('tbody', _vm._l(_vm.filteredPeriods, function (period) {
    return _c('tr', {
      key: period.id
      ...
      "class": {
        open: _vm.openActionIndex === period.id
      }
    }, [_c('button', {
      staticClass: "action-icon-btn",
      attrs: {
        "type": "button",
        "data-action-index": period.id
      },
      on: {
        "click": function click($event) {
          $event.stopPropagation();
          return _vm.toggleAction(period.id);
        }
      }
    }, [_c('svg', {
      attrs: {
    ...
    })])]), _vm._v(" "), _vm.openActionIndex === period.id ? _c('div', {
    ...
    }), _vm._v("\n                                                            " + _vm._s(_vm.$t('Edit')) + "\n                                                        ")])]), _vm._v(" "), !period.is_closed && period.id !== _vm.currentPeriodId ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
    ...
    }), _vm._v("\n                                                            " + _vm._s(_vm.$t('Set as Current')) + "\n                                                        ")])]) : _vm._e(), _vm._v(" "), !period.is_closed ? _c('li', [_c('a', {
      attrs: {
        "href": "#"
      },
      on: {
...
;// ./resources/js/pages/setup/accounting-periods.vue?vue&type=template&id=330a202f&scoped=true
...
var update = injectStylesIntoStyleTag_default()(accounting_periodsvue_type_style_index_0_id_330a202f_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const setup_accounting_periodsvue_type_style_index_0_id_330a202f_prod_scoped_true_lang_css = (accounting_periodsvue_type_style_index_0_id_330a202f_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/setup/accounting-periods.vue?vue&type=style&index=0&id=330a202f&prod&scoped=true&lang=css
