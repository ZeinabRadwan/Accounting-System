"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1594],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/journal-entries/show.vue?vue&type=template&id=24de6aa6&scoped=true
  ...
  return _c('div', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref2) {
        var row = _ref2.row;
        return [row._raw.cost_center ? _c('span', [_c('strong', [_vm._v(_vm._s(row._raw.cost_center.code))]), _c('br'), _vm._v(" "), _c('small', [_vm._v(_vm._s(row._raw.cost_center.name))])]) : _c('span', {
...
var update = injectStylesIntoStyleTag_default()(showvue_type_style_index_0_id_24de6aa6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const journal_entries_showvue_type_style_index_0_id_24de6aa6_prod_scoped_true_lang_css = (showvue_type_style_index_0_id_24de6aa6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/journal-entries/show.vue?vue&type=style&index=0&id=24de6aa6&prod&scoped=true&lang=css
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".page-header[data-v-24de6aa6]{margin-bottom:20px}.form-control-plaintext[data-v-24de6aa6]{background:transparent;border:none;margin:0;padding:0}.table th[data-v-24de6aa6]{background-color:#f8f9fa;font-weight:600}.badge[data-v-24de6aa6]{font-size:.875em}.table-active[data-v-24de6aa6]{background-color:#e9ecef!important}", ""]);
// Exports
