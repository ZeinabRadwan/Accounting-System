"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7688],{
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".account-status[data-v-17d0c723],.client-status[data-v-17d0c723],.product-status[data-v-17d0c723]{font-size:.875rem}.account-status .account-warning[data-v-17d0c723],.account-status .client-warning[data-v-17d0c723],.account-status .product-warning[data-v-17d0c723],.client-status .account-warning[data-v-17d0c723],.client-status .client-warning[data-v-17d0c723],.client-status .product-warning[data-v-17d0c723],.product-status .account-warning[data-v-17d0c723],.product-status .client-warning[data-v-17d0c723],.product-status .product-warning[data-v-17d0c723]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-17d0c723],.account-status .client-success[data-v-17d0c723],.account-status .product-success[data-v-17d0c723],.client-status .account-success[data-v-17d0c723],.client-status .client-success[data-v-17d0c723],.client-status .product-success[data-v-17d0c723],.product-status .account-success[data-v-17d0c723],.product-status .client-success[data-v-17d0c723],.product-status .product-success[data-v-17d0c723]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.btn-warning[data-v-17d0c723]{background-color:#ffc107!important;border-color:#ffc107!important;color:#212529!important}.btn-warning[data-v-17d0c723]:hover{background-color:#e0a800!important;border-color:#d39e00!important}.btn-primary[data-v-17d0c723]{background:#2ab930!important}.btn-primary[data-v-17d0c723]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.clickable-badge[data-v-17d0c723]{cursor:pointer;transition:all .2s ease}.clickable-badge[data-v-17d0c723]:hover{box-shadow:0 2px 4px rgba(0,0,0,.2);transform:scale(1.1)}.quotations-create-table[data-v-17d0c723]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-17d0c723]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-17d0c723]{border:none!important}.quotations-create-table thead th[data-v-17d0c723]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-17d0c723]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-17d0c723]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-17d0c723]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.insufficient-stock-input[data-v-17d0c723]{background-color:#fff5f5!important;border-color:#dc3545!important}.custom-qty-input[data-v-17d0c723]{display:flex;flex-wrap:nowrap;width:100%}.custom-qty-input .button-minus[data-v-17d0c723],.custom-qty-input .button-plus[data-v-17d0c723]{align-items:center;background:#fff;border:1px solid #ced4da;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;width:30px}.custom-qty-input .button-minus[data-v-17d0c723]{border-radius:.25rem 0 0 .25rem;border-right:none}.custom-qty-input .button-plus[data-v-17d0c723]{border-left:none;border-radius:0 .25rem .25rem 0}.custom-qty-input .quantity-field[data-v-17d0c723]{border-left:none;border-radius:0;border-right:none;flex:1;text-align:center}.custom-qty-input .quantity-field[data-v-17d0c723]:focus{border-color:#80bdff;box-shadow:none}.saudi-riyal[data-v-17d0c723]{color:#28a745;font-weight:700}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=17d0c723&scoped=true
var render = function render() {
  ...
  }), _vm._v(" " + _vm._s(_vm.$t("Please choose a bank account")))])]) : _vm._e()], 1), _vm._v(" "), _c('div', {
    staticClass: "form-group col-md-6"
  }, [_c('label', {
    attrs: {
      "for": "paidAmount"
...
;// CONCATENATED MODULE: ./resources/js/pages/sales/quotations/invoice.vue?vue&type=template&id=17d0c723&scoped=true
...
/* harmony default export */ const invoicevue_type_script_lang_js = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_esm/* mapGetters */.L8)('operations', ['items', 'appInfo'])), {}, {
    ...
    allProductsHaveVatRates: function allProductsHaveVatRates() {
      ...
      return this.form.selectedProducts.every(function (product) {
        return product.selectedVatRate && product.selectedVatRate.id;
      });
    },
  ...
  methods: {
        ...
        return invoicevue_type_script_lang_js_regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              productsWithoutVatRate = _this6.form.selectedProducts.filter(function (product) {
                return !product.selectedVatRate || !product.selectedVatRate.id;
              });
              if (productsWithoutVatRate.length > 0) {
                ...
                validationErrors.push({
                  type: "warning",
                  title: _this6.$t("Product VAT Rate Required"),
                  message: _this6.$t("The following products must have a VAT rate assigned: ") + _productNames,
                  field: "products",
                  timer: 8000,
                  timerProgressBar: true
                });
          ...
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              toast.fire({
                ...
                text: _this7.$t('Client missing required information. Please refresh and try again.')
              });
              return _context7.abrupt("return");
            case 5:
              ...
              _context7.prev = 6;
              _context7.next = 9;
              return axios_default().post(window.location.origin + '/api/clients/' + _this7.form.client.slug + '/auto-assign-chart-of-account');
            case 9:
              ...
              if (response && response.data && response.data.success) {
                ...
                if (newAccountId) {
                  ...
                  idx = _this7.items.findIndex(function (i) {
                    return i.slug === _this7.form.client.slug;
                  });
                  if (idx !== -1) {
                    _this7.$set(_this7.items[idx], 'chart_of_account_id', newAccountId);
                  }
                }
                toast.fire({
                  type: 'success',
                ...
                toast.fire({
                  ...
                  text: response && response.data && response.data.message || _this7.$t('Please try again')
                });
              }
              _context7.next = 19;
              break;
            case 13:
              ...
              errorMessage = _this7.$t('Failed to assign Chart of Account. Please try again.');
    ...
    autoAssignAllProductsChartOfAccount: function autoAssignAllProductsChartOfAccount() {
      ...
      return invoicevue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/invoicevue_type_script_lang_js_regeneratorRuntime().mark(function _callee8() {
        var productsWithoutSalesAccount, _iterator, _step, _loop, errorMessage, _error$response$data2;
        return invoicevue_type_script_lang_js_regeneratorRuntime().wrap(function _callee8$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 2:
              _this8.isAutoAssigningProduct = true;
              _context9.prev = 3;
              productsWithoutSalesAccount = _this8.form.selectedProducts.filter(function (product) {
                return !product.sales_account_id;
              });
              if (!(productsWithoutSalesAccount.length === 0)) {
                _context9.next = 8;
              ...
              toast.fire({
                type: 'info',
                title: _this8.$t('All products already have sales accounts assigned')
              });
              return _context9.abrupt("return");
            case 8:
              _iterator = _createForOfIteratorHelper(productsWithoutSalesAccount);
              _context9.prev = 9;
              _loop = /*#__PURE__*/invoicevue_type_script_lang_js_regeneratorRuntime().mark(function _loop() {
                var product, response, productIndex;
                return invoicevue_type_script_lang_js_regeneratorRuntime().wrap(function _loop$(_context8) {
                  while (1) switch (_context8.prev = _context8.next) {
                    ...
                    case 6:
                      ...
                      if (response.data && response.data.success) {
                        ...
                        productIndex = _this8.products.findIndex(function (p) {
                          return p.id === product.id;
                        });
                        if (productIndex !== -1) {
                          _this8.$set(_this8.products[productIndex], 'sales_account_id', response.data.sales_account_id);
                        }
                      }
                    case 8:
                    case "end":
            ...
            case 26:
              toast.fire({
                type: 'success',
                title: _this8.$t('Chart of Accounts assigned successfully')
              });
              _context9.next = 35;
              break;
            case 29:
              ...
              errorMessage = _this8.$t('Failed to assign Chart of Accounts. Please try again.');
        ...
        return invoicevue_type_script_lang_js_regeneratorRuntime().wrap(function _callee9$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 2:
              ...
              toast.fire({
                type: 'info',
                title: _this9.$t('Feature Not Available'),
                text: _this9.$t('Auto-assign for bank accounts is not yet available. Please assign Chart of Account manually.')
              });
            case 3:
            case "end":
    ...
    calculateProductVat: function calculateProductVat(index) {
      ...
      if (item) {
        ...
        if (updatedItem.selectedVatRate) {
          ...
          var vatRate = updatedItem.selectedVatRate.rate || 0;
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=17d0c723&prod&lang=scss&scoped=true
var invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true = __webpack_require__(17367);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-14.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-14.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-14.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=17d0c723&prod&lang=scss&scoped=true

            

var invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true_options = {};

invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true_options.insert = "head";
invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true_options.singleton = false;

var invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true_update = injectStylesIntoStyleTag_default()(invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true/* default */.A, invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true_options);



/* harmony default export */ const quotations_invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true = (invoicevue_type_style_index_0_id_17d0c723_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/quotations/invoice.vue?vue&type=style&index=0&id=17d0c723&prod&lang=scss&scoped=true
