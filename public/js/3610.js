"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3610],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=19c52dac&scoped=true
...
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=template&id=19c52dac&scoped=true
...
var update = injectStylesIntoStyleTag_default()(editvue_type_style_index_0_id_19c52dac_prod_lang_scss_scoped_true/* default */.A, options);



/* harmony default export */ const invoices_editvue_type_style_index_0_id_19c52dac_prod_lang_scss_scoped_true = (editvue_type_style_index_0_id_19c52dac_prod_lang_scss_scoped_true/* default */.A.locals || {});
;// ./resources/js/pages/sales/invoices/edit.vue?vue&type=style&index=0&id=19c52dac&prod&lang=scss&scoped=true
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-19c52dac]{margin-bottom:15px}.footer-buttons[data-v-19c52dac]{display:flex;gap:10px}.footer-buttons .btn[data-v-19c52dac]{margin-right:10px}.footer-buttons .btn[data-v-19c52dac]:last-child{margin-right:0}.account-status .account-warning[data-v-19c52dac],.account-status .client-warning[data-v-19c52dac],.account-status .product-warning[data-v-19c52dac],.client-status .account-warning[data-v-19c52dac],.client-status .client-warning[data-v-19c52dac],.client-status .product-warning[data-v-19c52dac],.product-status .account-warning[data-v-19c52dac],.product-status .client-warning[data-v-19c52dac],.product-status .product-warning[data-v-19c52dac]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:4px;color:#856404;font-size:.875rem;padding:8px 12px}.account-status .account-success[data-v-19c52dac],.account-status .client-success[data-v-19c52dac],.account-status .product-success[data-v-19c52dac],.client-status .account-success[data-v-19c52dac],.client-status .client-success[data-v-19c52dac],.client-status .product-success[data-v-19c52dac],.product-status .account-success[data-v-19c52dac],.product-status .client-success[data-v-19c52dac],.product-status .product-success[data-v-19c52dac]{background-color:#d4edda;border:1px solid #c3e6cb;border-radius:4px;color:#155724;font-size:.875rem;padding:8px 12px}.create-btn[data-v-19c52dac]{background-color:#007bff;border-left:none;border-color:#007bff;color:#fff;cursor:pointer}.create-btn[data-v-19c52dac]:hover{background-color:#0056b3;border-color:#0056b3}.radio-group-horizontal[data-v-19c52dac]{display:flex;gap:20px}.radio-group-horizontal .form-check[data-v-19c52dac]{align-items:center;display:flex;gap:8px}.custom-qty-input .button-minus[data-v-19c52dac],.custom-qty-input .button-plus[data-v-19c52dac]{border:none;border-radius:0;height:30px;width:30px}.custom-qty-input .quantity-field[data-v-19c52dac]{border-left:none;border-right:none;text-align:center;width:60px}.table-custom td[data-v-19c52dac],.table-custom th[data-v-19c52dac]{vertical-align:middle}.invalid-feedback[data-v-19c52dac]{display:block;margin-top:5px}.btn-primary[data-v-19c52dac]{background:#2ab930!important}.btn-primary[data-v-19c52dac]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}", ""]);
// Exports
