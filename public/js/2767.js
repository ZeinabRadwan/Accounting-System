"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2767],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=72b39c33&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
  ...
  }), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.$t("Error")) + ":")]), _vm._v("\n                    " + _vm._s(_vm.$t("Discount amount cannot exceed the quotation total amount")) + "\n                  ")]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "form-group col-12 col-md-6"
  }, [_c('label', {
    attrs: {
      "for": "total_amount"
    ...
    attrs: {
      ...
      "disabled": _vm.isDiscountExceedingTotal,
      "type": "success"
    }
  }, [_c('i', {
    staticClass: "fas fa-save"
...
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=template&id=72b39c33&scoped=true
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  watch: {
    ...
    clients: {
      handler: function handler(newClients, oldClients) {
        var _clients$,
          _oldClients$,
          _this = this;
        var clients = newClients || [];
        console.log("[Quotation] Clients watcher: ".concat(clients.length, " clients available"));

        // Skip if clients haven't actually changed (prevent infinite loop)
        if (oldClients && clients.length === oldClients.length && clients.length > 0 && oldClients.length > 0 && ((_clients$ = clients[0]) === null || _clients$ === void 0 ? void 0 : _clients$.id) === ((_oldClients$ = oldClients[0]) === null || _oldClients$ === void 0 ? void 0 : _oldClients$.id)) {
          return;
        }
        if (clients.length > 0 && !this.form.client) {
          ...
          setTimeout(function () {
            _this.selectDefaultClient();
          }, 100);
        } else if (clients.length === 0) {
          console.warn('[Quotation] Clients watcher: No clients available');
        } else if (this.form.client) {
          console.log("[Quotation] Clients watcher: Client already selected: ".concat(this.form.client.name || this.form.client.slug));
        }
      },
      immediate: false
    }
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              walkingCustomerExists = _this2.clients.some(function (item) {
                return item.slug === 'walking-customer';
              });
              if (!walkingCustomerExists && _this2.clients.length > 0) {
                console.warn('[Quotation] ⚠️ Walking Customer not found in clients list!');
                console.warn('[Quotation] Available client slugs:', _this2.clients.map(function (c) {
                  return c.slug;
                }).join(', '));
            ...
            case 30:
              ...
              defaultClient = clients.find(function (item) {
                return item.slug === defaultClientSlug;
              });
              if (defaultClient) {
                _this2.form.client = defaultClient;
                console.log("[Quotation] \u2705 Selected default client: ".concat(defaultClient.name, " (").concat(defaultClient.slug, ")"));
              } else {
                // Fallback to Walking Customer if default client not found
                console.warn("[Quotation] Default client (".concat(defaultClientSlug, ") not found, trying Walking Customer..."));
                walkingCustomer = clients.find(function (item) {
                  return item.slug === 'walking-customer';
                });
                if (walkingCustomer) {
                  _this2.form.client = walkingCustomer;
                  console.log("[Quotation] \u2705 Selected Walking Customer as fallback: ".concat(walkingCustomer.name));
                } else {
                  ...
                  if (clients.length > 0) {
                    _this2.form.client = clients[0];
                    console.log("[Quotation] Selected first available client: ".concat(clients[0].name));
                  } else {
            ...
            case 39:
              ...
              if (((_error$response3 = _context.t0.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 401) {
                toast.fire({
                  ...
                  text: _this2.$t("You are not authorized to view clients. Please log in again."),
                  timer: 5000,
                ...
                toast.fire({
                  ...
                  text: _this2.$t("You don't have permission to view clients."),
                  timer: 5000,
                  timerProgressBar: true
                });
                ...
                toast.fire({
                  ...
                  text: _this2.$t("Unable to load clients. Please try again later."),
                  timer: 5000,
                  timerProgressBar: true
                });
            ...
            case 45:
              ...
              _this2.$nextTick(function () {
                ...
                if (!_this2.form.client && clients.length > 0) {
    ...
    selectDefaultClient: function selectDefaultClient() {
      ...
      if (this.form.client && (this.form.client.id || this.form.client.slug)) {
        console.log("[Quotation] selectDefaultClient: Client already selected: ".concat(this.form.client.name || this.form.client.slug));
        return;
      }
      ...
      console.log("[Quotation] selectDefaultClient: Looking for client with slug: ".concat(defaultClientSlug));
      console.log("[Quotation] selectDefaultClient: Available slugs: ".concat(clients.map(function (c) {
        return c.slug;
      }).join(', ')));
      var defaultClient = clients.find(function (item) {
        return item.slug === defaultClientSlug;
      });
      if (defaultClient) {
        this.form.client = defaultClient;
        console.log("[Quotation] selectDefaultClient: \u2705 Selected default client: ".concat(defaultClient.name, " (").concat(defaultClient.slug, ")"));
        return;
      }

      // Fallback to Walking Customer if default client not found
      console.warn("[Quotation] selectDefaultClient: Default client (".concat(defaultClientSlug, ") not found, trying Walking Customer..."));
      var walkingCustomer = clients.find(function (item) {
        return item.slug === 'walking-customer';
      });
      if (walkingCustomer) {
        this.form.client = walkingCustomer;
        console.log("[Quotation] selectDefaultClient: \u2705 Selected Walking Customer: ".concat(walkingCustomer.name));
        return;
      }
      ...
      if (clients.length > 0) {
        ...
        console.log("[Quotation] selectDefaultClient: Selected first client: ".concat(clients[0].name, " (").concat(clients[0].slug, ")"));
      } else {
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              toast.fire({
                ...
                text: _this9.$t("Discount amount cannot exceed the quotation total amount"),
                timer: 5000,
                timerProgressBar: true
              });
            ...
            case 4:
              ...
              return _this9.form.post(window.location.origin + "/api/quotations").then(function (_ref2) {
                ...
                toast.fire({
                  type: "success",
                  title: _this9.$t("Quotation added successfully")
                });
                ...
                if ((error === null || error === void 0 || (_error$response6 = error.response) === null || _error$response6 === void 0 ? void 0 : _error$response6.status) === 422 && (_error$response7 = error.response) !== null && _error$response7 !== void 0 && (_error$response7 = _error$response7.data) !== null && _error$response7 !== void 0 && _error$response7.errors) {
                  ...
                  var message = (error === null || error === void 0 || (_error$response8 = error.response) === null || _error$response8 === void 0 || (_error$response8 = _error$response8.data) === null || _error$response8 === void 0 ? void 0 : _error$response8.message) || _this9.$t("Please check your input and try again.");
                  toast.fire({
                    type: "error",
                    title: message
                  });
    ...
    showAllInsufficientStock: function showAllInsufficientStock() {
      ...
      insufficientProducts.forEach(function (product, index) {
        ...
        message += "   ".concat(_this0.$t("Required"), ": ").concat(product.qty, ", ").concat(_this0.$t("Available"), ": ").concat(product.inventoryCount, ", ").concat(_this0.$t("Shortage"), ": ").concat(shortage, "\n\n");
      });
    ...
    normalizeClientSelection: function normalizeClientSelection() {
      try {
        ...
        if (current.id) {
          ...
          if (matched) {
            console.log("[Quotation] normalizeClientSelection: Found client by ID: ".concat(matched.name));
          }
        }
        if (!matched && current.slug) {
          ...
          if (matched) {
            console.log("[Quotation] normalizeClientSelection: Found client by slug: ".concat(matched.name));
          }
        }
        if (matched) {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      var clients = _this1.clients || [];
      if (!_this1.form.client && clients.length > 0) {
        _this1.selectDefaultClient();
      } else if (clients.length === 0) {
        // If clients are not loaded yet, try again after a short delay
        setTimeout(function () {
          var retryClients = _this1.clients || [];
          if (!_this1.form.client && retryClients.length > 0) {
            _this1.selectDefaultClient();
          }
        }, 500);
      }
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_72b39c33_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const quotations_createvue_type_style_index_0_id_72b39c33_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_72b39c33_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/sales/quotations/create.vue?vue&type=style&index=0&id=72b39c33&prod&scoped=true&lang=css
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-72b39c33]{margin-bottom:15px}.footer-buttons[data-v-72b39c33]{display:flex;gap:10px}.footer-buttons .btn[data-v-72b39c33]{margin-right:10px}.footer-buttons .btn[data-v-72b39c33]:last-child{margin-right:0}.create-btn[data-v-72b39c33]{cursor:pointer;padding:11px;transition:background-color .2s ease}.create-btn[data-v-72b39c33]:hover{background-color:#e9ecef}.edit-btn[data-v-72b39c33]{background-color:#17a2b8!important;border-color:#17a2b8!important;color:#fff!important}.edit-btn[data-v-72b39c33]:hover{background-color:#138496!important;border-color:#117a8b!important}.table-custom[data-v-72b39c33]{border:none!important}.quotations-create-table[data-v-72b39c33]{border-collapse:separate;border-spacing:0}.quotations-create-table thead th[data-v-72b39c33]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.quotations-create-table thead tr[data-v-72b39c33]{border:none!important}.quotations-create-table thead th[data-v-72b39c33]:first-child{border-top-left-radius:10px}.quotations-create-table thead th[data-v-72b39c33]:last-child{border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-72b39c33]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .quotations-create-table thead th[data-v-72b39c33]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-72b39c33]{gap:10px}.card[data-v-72b39c33]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-72b39c33]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.quotations-create-table .badge.badge-danger[data-v-72b39c33]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-72b39c33]{background:#fff!important}.btn-primary[data-v-72b39c33]{background:#2ab930!important}.btn-secondary[data-v-72b39c33]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.custom-qty-input[data-v-72b39c33]{align-items:center;display:flex;margin:0 auto;width:-moz-fit-content;width:fit-content}.button-minus[data-v-72b39c33],.button-plus[data-v-72b39c33]{align-items:center;border:none;border-radius:50%;cursor:pointer;display:flex;font-size:14px;font-weight:700;height:30px;justify-content:center;transition:all .2s ease;width:30px}.button-minus[data-v-72b39c33]{background-color:#dc3545;color:#fff}.button-plus[data-v-72b39c33]{background-color:#007bff;color:#fff}.button-minus[data-v-72b39c33]:hover{background-color:#c82333;transform:scale(1.05)}.button-plus[data-v-72b39c33]:hover{background-color:#0056b3;transform:scale(1.05)}.price-field[data-v-72b39c33]{width:100%}.quantity-field[data-v-72b39c33]{border:1px solid #ced4da;border-radius:5px;margin:0 5px;padding:5px;text-align:center;width:60px}.quantity-field[data-v-72b39c33]:focus{border-color:#007bff;box-shadow:0 0 0 .2rem rgba(0,123,255,.25);outline:none}[dir=rtl] .d-flex[data-v-72b39c33]{direction:rtl}[dir=rtl] .create-btn[data-v-72b39c33]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .create-btn[data-v-72b39c33]{border-radius:0 .25rem .25rem 0}[dir=rtl] .rtl-select .vs__dropdown-toggle[data-v-72b39c33]{border-radius:.25rem 0 0 .25rem}[dir=ltr] .rtl-select .vs__dropdown-toggle[data-v-72b39c33]{border-radius:.25rem}[dir=rtl] .flex-grow-1.rtl-select[data-v-72b39c33]{border-right:none}[dir=ltr] .flex-grow-1.rtl-select[data-v-72b39c33]{border-right:1px solid #ced4da}.clickable-badge[data-v-72b39c33]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-72b39c33]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-72b39c33]:active{transform:scale(.95)}.insufficient-stock-input[data-v-72b39c33]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important}.insufficient-stock-input[data-v-72b39c33]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.debug-panel[data-v-72b39c33]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-72b39c33]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-72b39c33]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-72b39c33]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-72b39c33]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-72b39c33]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-72b39c33]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-72b39c33]:last-child{border-bottom:none}.debug-display[data-v-72b39c33]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-72b39c33]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-72b39c33]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-72b39c33]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-72b39c33]:last-child{border-bottom:none}.debug-panel .table th[data-v-72b39c33]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-72b39c33]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-72b39c33]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-72b39c33]{padding:15px}.debug-item .row[data-v-72b39c33]{margin:0}.debug-item .col-md-6[data-v-72b39c33]{padding:0 5px}.debug-step[data-v-72b39c33]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-72b39c33]{font-size:.75em}}.summary-footer-wrapper[data-v-72b39c33]{margin-top:10px}.summary-card[data-v-72b39c33]{background:#fff;border:1px solid #e5e7eb;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.05);overflow:hidden}.summary-card-horizontal[data-v-72b39c33]{padding:12px 15px}.summary-row-horizontal[data-v-72b39c33]{align-items:center;display:flex;flex-wrap:wrap;gap:8px;justify-content:space-between}.summary-item[data-v-72b39c33]{align-items:center;display:flex;flex:1;flex-direction:column;min-width:100px;padding:0 12px}.summary-item-label[data-v-72b39c33]{color:#6b7280;font-size:11px;font-weight:500;letter-spacing:.5px;margin-bottom:4px;text-transform:uppercase}.summary-item-value[data-v-72b39c33]{color:#111827;font-size:14px;font-weight:600;text-align:center}.summary-item-discount .summary-item-value[data-v-72b39c33]{color:#dc2626}.summary-item-total[data-v-72b39c33]{background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-radius:6px;margin:0 -5px;padding:8px 15px}.summary-item-total .summary-item-label[data-v-72b39c33]{color:#1e40af;font-size:12px;font-weight:600}.summary-item-total .summary-item-value[data-v-72b39c33]{color:#33a0d9;font-size:16px;font-weight:700}.summary-divider[data-v-72b39c33]{background-color:#e5e7eb;flex-shrink:0;height:40px;width:1px}.summary-divider-bold[data-v-72b39c33]{background-color:#33a0d9;height:50px;width:2px}.summary-total[data-v-72b39c33]{color:#33a0d9;font-size:16px;font-weight:700}[dir=rtl] .summary-item[data-v-72b39c33]{direction:rtl}@media (max-width:992px){.summary-row-horizontal[data-v-72b39c33]{flex-wrap:wrap;justify-content:center}.summary-item[data-v-72b39c33]{min-width:80px;padding:0 8px}.summary-divider[data-v-72b39c33]{display:none}}@media (max-width:768px){.summary-card-horizontal[data-v-72b39c33]{padding:10px 12px}.summary-item[data-v-72b39c33]{min-width:70px;padding:0 6px}.summary-item-label[data-v-72b39c33]{font-size:10px}.summary-item-value[data-v-72b39c33]{font-size:13px}.summary-item-total[data-v-72b39c33]{margin:8px 0 0;padding:10px;width:100%}.summary-item-total .summary-item-value[data-v-72b39c33]{font-size:18px}}@media (max-width:576px){.summary-card[data-v-72b39c33]{border-radius:6px}.summary-item[data-v-72b39c33]{min-width:60px;padding:0 4px}.summary-item-label[data-v-72b39c33]{font-size:9px}.summary-item-value[data-v-72b39c33]{font-size:12px}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
