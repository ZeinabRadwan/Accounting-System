...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/auth/find-domain.vue?vue&type=template&id=7953ee4b
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LoginStepsModal', {
    attrs: {
      "show": _vm.showLoginModal,
      "current-step": _vm.currentStep
    }
  }), _vm._v(" "), !_vm.showLoginModal ? _c('div', {
    ...
    attrs: {
      "type": "button",
      "disabled": _vm.showLoginModal || _vm.form.busy
    },
    on: {
      "click": _vm.handleSubmit
    }
  }, [_c('strong', [_vm._v(_vm._s(_vm.$t('login')))]), _vm._v(" "), _vm.showLoginModal || _vm.form.busy ? _c('i', {
  ...
  methods: {
    ...
    findDomain: function findDomain() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var domainResponse, firstError, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              if (!_this.showLoginModal) {
                _context.n = 1;
                break;
              }
