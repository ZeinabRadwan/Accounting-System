...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".btn-group.c-w-100[data-v-3a0db603]{gap:10px}.header-buttons[data-v-3a0db603]{margin-bottom:15px}.footer-buttons[data-v-3a0db603]{display:flex;gap:10px}.footer-buttons .btn[data-v-3a0db603]{margin-right:10px}.footer-buttons .btn[data-v-3a0db603]:last-child{margin-right:0}.card[data-v-3a0db603]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-3a0db603]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-3a0db603]{padding:1.25rem}.card-footer[data-v-3a0db603]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-3a0db603]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-3a0db603]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-3a0db603]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-3a0db603]{color:#dc3545;font-weight:700}.btn-primary[data-v-3a0db603]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-3a0db603]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-3a0db603]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-3a0db603]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.btn-danger[data-v-3a0db603]{background:#dc3545!important;border:none!important;border-radius:8px!important;color:#fff!important;font-weight:500;padding:8px 12px!important}.btn-danger[data-v-3a0db603]:hover{background:#c82333!important;box-shadow:0 4px 8px rgba(220,53,69,.3);transform:translateY(-1px)}.is-invalid[data-v-3a0db603]{border-color:#dc3545!important}textarea.form-control[data-v-3a0db603]{min-height:100px;resize:vertical}.v-select[data-v-3a0db603]{background:#fff!important}.v-select .vs__dropdown-toggle[data-v-3a0db603]{background:#fff!important;border:1px solid #e5e7eb!important;padding:10px 16px!important}.v-select .vs__dropdown-toggle[data-v-3a0db603]:focus{border-color:#33a0d9!important;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)!important}.v-select.is-invalid .vs__dropdown-toggle[data-v-3a0db603]{border-color:#dc3545!important}.bg-light[data-v-3a0db603]{background-color:#f8f9fa!important;border:1px solid #e5e7eb;border-radius:10px;margin-bottom:15px}.bg-light .card-header[data-v-3a0db603]{background-color:#e9ecef!important;border-bottom:1px solid #dee2e6;border-radius:10px 10px 0 0;color:#495057;font-weight:600;padding:12px 16px}.bg-light .card-body[data-v-3a0db603]{padding:16px}.callout[data-v-3a0db603]{border-radius:10px;margin-bottom:16px;padding:12px 16px}.callout-danger[data-v-3a0db603]{background-color:#f8d7da;border:1px solid #f5c6cb;color:#721c24}.callout i[data-v-3a0db603]{margin-right:8px}.d-flex[data-v-3a0db603]{align-items:center;display:flex!important}.pr-5[data-v-3a0db603]{padding-right:3rem!important}.row[data-v-3a0db603]{margin-bottom:1rem}.text-muted[data-v-3a0db603]{color:#6c757d!important}.text-muted[data-v-3a0db603],small[data-v-3a0db603]{font-size:12px}@media (max-width:768px){.card-footer[data-v-3a0db603]{flex-direction:column;gap:10px}.card-footer .btn[data-v-3a0db603]{margin-right:0!important;width:100%}.card-footer div[data-v-3a0db603]{display:flex;flex-direction:column;gap:10px;width:100%}.pr-5[data-v-3a0db603]{padding-right:1rem!important}}", ""]);
// Exports
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/payments/clients/invoice/create.vue?vue&type=template&id=3a0db603&scoped=true
  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              if (!(!_this2.form.client || !_this2.form.client.slug)) {
                _context.n = 1;
                break;
              }
              return _context.a(2);
            case 1:
              _context.p = 1;
              _this2.isAutoAssigningClient = true;
              _context.n = 2;
              return axios_default().post("/api/clients/".concat(_this2.form.client.slug, "/auto-assign-chart-of-account"));
            case 2:
              ...
              if (newAccountId) {
                ...
                _this2.$set(_this2.form.client, 'chart_of_account_id', newAccountId);

                // Also update the item in the clients list (items from vuex)
                idx = (_this2.items || []).findIndex(function (c) {
                  return c.slug === _this2.form.client.slug;
                });
                if (idx !== -1) {
                  _this2.$set(_this2.items, idx, _objectSpread(_objectSpread({}, _this2.items[idx]), {}, {
            ...
            case 4:
              _context.p = 4;
              _this2.isAutoAssigningClient = false;
              return _context.f(4);
            case 5:
              return _context.a(2);
          }
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _this4.form.selectedInvoices = [];
              if (!_this4.form.client) {
                _context3.n = 2;
                break;
              }
              _this4.form.clientBalance = _this4.form.client.clientTotalAdvance;
              _context3.n = 1;
            ...
            case 1:
              ...
              _this4.invoices = data.invoices;
              _this4.form.client = data.client;
            case 2:
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              _context6.n = 1;
              return _this7.form.post(window.location.origin + "/api/payments/invoice").then(function () {
                // Clear temporary data after successful save
                _this7.clearTemporaryData();
                toast.fire({
                  type: "success",
                  title: _this7.$t("Invoice payment added successfully")
                });
                _this7.$router.push({
                  name: "invoicePayments.index"
                });
                ...
                if ((error === null || error === void 0 || (_error$response2 = error.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 422 && error !== null && error !== void 0 && (_error$response3 = error.response) !== null && _error$response3 !== void 0 && (_error$response3 = _error$response3.data) !== null && _error$response3 !== void 0 && _error$response3.errors) {
                  ...
                  _this7.form.errors.set(errorsMap);
                ...
                toast.fire({
                  ...
                  text: backendMessage || _this7.$t('Please check your input and try again.')
                });
              });
            case 1:
    ...
    handleQueryParams: function handleQueryParams() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var invoiceSlug, clientSlugOrId, client, invoice, _t3;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              invoiceSlug = _this8.$route.query.invoice;
              clientSlugOrId = _this8.$route.query.client;
              ...
              _context7.p = 1;
              _context7.n = 2;
              return _this8.getClients();
            case 2:
              // Find the client
              client = _this8.items.find(function (c) {
              ...
              // Set the client
              _this8.form.client = client;

              // Load invoices for this client
              _context7.n = 3;
              return _this8.getInvoices();
            case 3:
              _context7.n = 4;
              return _this8.$nextTick();
            case 4:
              // Find and select the invoice
              if (_this8.invoices && _this8.invoices.length > 0) {
                invoice = _this8.invoices.find(function (inv) {
                  return inv.slug === invoiceSlug;
                });
                if (invoice) {
                  _this8.form.invoice = invoice;
                  _this8.storeInvoice(invoice);
                }
              }
            case 5:
              _context7.n = 7;
            ...
            case 6:
              _context7.p = 6;
              _t3 = _context7.v;
              console.error('Error handling query params:', _t3);
            case 7:
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_3a0db603_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoice_createvue_type_style_index_0_id_3a0db603_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_3a0db603_prod_scoped_true_lang_css/* default */.A.locals || {});
;// ./resources/js/pages/payments/clients/invoice/create.vue?vue&type=style&index=0&id=3a0db603&prod&scoped=true&lang=css
