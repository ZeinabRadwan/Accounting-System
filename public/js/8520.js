"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8520],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/currency/edit.vue?vue&type=template&id=bd5b9b52
var render = function render() {
  ...
  return _c('div', [_c('breadcrumbs', {
    ...
    on: {
      "submit": function submit($event) {
        ...
        return _vm.updateCurrency.apply(null, arguments);
      },
    ...
    attrs: {
      ...
      "type": "text",
      "name": "rate",
      "placeholder": _vm.$t('Exchange rate for your currency (USD comparison)')
    },
    domProps: {
      "value": _vm.form.rate
    },
    ...
    attrs: {
      ...
      "type": "text",
      "name": "symbol",
      "placeholder": _vm.$t('Enter a symbol')
    },
    domProps: {
      "value": _vm.form.symbol
    },
  ...
  }, [_vm._v(_vm._s(_vm.$t("Currency Position")))]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v("\n                                    " + _vm._s(_vm.$t("Left align")) + "\n                                ")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "right"
    }
  }, [_vm._v("\n                                    " + _vm._s(_vm.$t("Right align")) + "\n                                ")])]), _vm._v(" "), _c('has-error', {
    attrs: {
      "form": _vm.form,
      "field": "position"
    }
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/setup/currency/edit.vue?vue&type=script&lang=js
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              _context.n = 1;
              return axios_default().get(window.location.origin + "/api/currencies/" + _this.$route.params.slug);
            case 1:
              _yield$axios$get = _context.v;
              data = _yield$axios$get.data;
              _this.form.name = data.data.name;
              _this.form.code = data.data.code;
              _this.form.rate = data.data.rate;
              _this.form.symbol = data.data.symbol;
              _this.form.position = data.data.position;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return _this2.form.patch(window.location.origin + "/api/currencies/" + _this2.$route.params.slug).then(function () {
                toast.fire({
                  type: "success",
                  title: _this2.$t("Currency updated successfully")
                });
                _this2.$router.push({
...
;// ./resources/js/pages/central/setup/currency/edit.vue?vue&type=script&lang=js
 /* harmony default export */ const currency_editvue_type_script_lang_js = (editvue_type_script_lang_js); 
...
var component = (0,componentNormalizer/* default */.A)(
  currency_editvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
