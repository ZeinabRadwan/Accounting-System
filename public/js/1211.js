"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1211],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-be06455e]{margin-bottom:15px}.footer-buttons[data-v-be06455e]{display:flex;gap:10px}.footer-buttons .btn[data-v-be06455e]{margin-right:10px}.footer-buttons .btn[data-v-be06455e]:last-child{margin-right:0}.btn-group.c-w-100[data-v-be06455e]{gap:10px}.card[data-v-be06455e]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-header[data-v-be06455e]{background-color:#fff;border-bottom:1px solid #ced4da;border-radius:20px 20px 0 0;padding:1.25rem 1.25rem 0}.card-body[data-v-be06455e]{padding:1.25rem}.card-footer[data-v-be06455e]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.form-control[data-v-be06455e]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-be06455e]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.form-group label[data-v-be06455e]{color:#374151;display:block;font-weight:500;margin-bottom:8px}.required[data-v-be06455e]{color:#dc3545;font-weight:700}.btn-primary[data-v-be06455e]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-primary[data-v-be06455e]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-be06455e]{background:#33a0d9!important;border:none!important;color:#fff!important;font-weight:500;margin-right:10px;padding:10px 20px!important}.btn-secondary[data-v-be06455e]:hover{background:#2a8bc4!important;box-shadow:0 4px 8px rgba(51,160,217,.3);transform:translateY(-1px)}.is-invalid[data-v-be06455e]{border-color:#dc3545!important}textarea.form-control[data-v-be06455e]{min-height:100px;resize:vertical}.v-select[data-v-be06455e]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-be06455e]{background:#fff!important;border:1px solid #e5e7eb;padding:10px 16px}.v-select .vs__search[data-v-be06455e]::-moz-placeholder{color:#6c757d}.v-select .vs__search[data-v-be06455e]::placeholder{color:#6c757d}.v-select .vs__selected[data-v-be06455e]{color:#374151}.v-select .vs__dropdown-menu[data-v-be06455e]{border-radius:10px;box-shadow:0 4px 6px -1px rgba(0,0,0,.1)}.table-custom[data-v-be06455e]{border:none!important}.purchases-create-table[data-v-be06455e]{border-collapse:separate;border-spacing:0}.purchases-create-table thead th[data-v-be06455e]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.purchases-create-table thead tr[data-v-be06455e]{border:none!important}.purchases-create-table thead th[data-v-be06455e]:first-child{border-top-left-radius:10px}.purchases-create-table thead th[data-v-be06455e]:last-child{border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-be06455e]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .purchases-create-table thead th[data-v-be06455e]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.purchases-create-table .badge.badge-info[data-v-be06455e]{background:#e3f2fd!important;color:#1976d2!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.custom-qty-input[data-v-be06455e]{align-items:center;background:#fff;border:1px solid #e5e7eb;border-radius:10px;display:flex;overflow:hidden}.custom-qty-input .button-minus[data-v-be06455e],.custom-qty-input .button-plus[data-v-be06455e]{background:#6c757d;border:none;color:#fff;cursor:pointer;font-weight:700;padding:8px 12px;transition:background-color .3s}.custom-qty-input .button-minus[data-v-be06455e]:hover{background:#dc3545}.custom-qty-input .button-plus[data-v-be06455e]:hover{background:#2ab930}.custom-qty-input .quantity-field[data-v-be06455e]{background:transparent;border:none;font-weight:500;padding:8px 4px;text-align:center;width:60px}.custom-qty-input .quantity-field[data-v-be06455e]:focus{box-shadow:none;outline:none}.quantity-field[data-v-be06455e]{border-radius:0!important;margin:0!important;min-height:50px!important}.account-status[data-v-be06455e]{font-size:.875rem}.account-status .account-warning[data-v-be06455e]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:.25rem;color:#856404;display:flex;padding:.5rem}.account-status .account-success[data-v-be06455e]{align-items:center;background-color:#d4edda;border:1px solid #c3e6cb;border-radius:.25rem;color:#155724;display:flex;padding:.5rem}.product-status[data-v-be06455e]{font-size:13px}.product-warning[data-v-be06455e]{align-items:center;background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;color:#856404;display:flex;font-weight:500;padding:8px 12px}.btn-outline-warning[data-v-be06455e]{border-color:#ffc107;border-radius:6px;color:#856404;font-size:12px;padding:4px 8px}.btn-outline-warning[data-v-be06455e]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-be06455e]:disabled{cursor:not-allowed;opacity:.6}.callout[data-v-be06455e]{border-left:4px solid;border-radius:8px;margin-bottom:16px;padding:12px 16px}.callout-danger[data-v-be06455e]{background-color:#f8d7da;border-left-color:#dc3545;color:#721c24}.callout i[data-v-be06455e]{margin-right:8px}.row[data-v-be06455e]{margin-bottom:1rem}.form-text[data-v-be06455e]{color:#6b7280;font-size:.875rem}.text-muted[data-v-be06455e]{color:#6b7280!important}@media (max-width:768px){.card-footer[data-v-be06455e]{flex-direction:column;gap:10px}.card-footer .btn[data-v-be06455e]{margin-right:0!important;width:100%}.card-footer div[data-v-be06455e]{display:flex;flex-direction:column;gap:10px;width:100%}.table-custom[data-v-be06455e]{font-size:12px}.table-custom tbody td[data-v-be06455e],.table-custom thead th[data-v-be06455e]{padding:8px 4px}}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/create.vue?vue&type=template&id=be06455e&scoped=true
...
;// CONCATENATED MODULE: ./resources/js/pages/purchases/returns/create.vue?vue&type=template&id=be06455e&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/purchases/returns/create.vue?vue&type=script&lang=js
  ...
  methods: {
    ...
    storeProducts: function storeProducts() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var isPreSelected, key, _purchaseItem$product, _productData2, purchaseItem, productData, _productData, response, availableQty, presetReturnQty, maxQty, selectedVatRate, _this6$taxes, _this6$taxes2, totalBeforeDiscount, discountAmount, totalAfterDiscount, productTax, totalTax, totalPrice, finalPurchaseAccountId;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.t0 = _regeneratorRuntime().keys(_this6.form.purchase.purchaseProducts);
            case 12:
            ...
            case 27:
              ...
              presetReturnQty = availableQty; // Default to remaining quantity (like sales returns)
              maxQty = availableQty; // Try to find matching VAT rate, fallback to 15% VAT rate, then first available
              selectedVatRate = _this6.findMatchingVatRate(purchaseItem.productTax);
              if (!selectedVatRate) {
                // Try to find 15% VAT rate as default
                selectedVatRate = (_this6$taxes = _this6.taxes) === null || _this6$taxes === void 0 ? void 0 : _this6$taxes.find(function (tax) {
                  return Math.abs(tax.rate - 15) < 0.01;
                });
                // If 15% not found, use first available
                if (!selectedVatRate) {
                  selectedVatRate = (_this6$taxes2 = _this6.taxes) === null || _this6$taxes2 === void 0 ? void 0 : _this6$taxes2[0];
                }
              }
              ...
              _this6.form.selectedProducts.unshift({
                ...
                // Default to remaining quantity (like sales returns)
                totalReturnQty: availableQty,
                // Total quantity that can be returned
                maxQty: maxQty,
    ...
    updateItem: function updateItem(value, index) {
      ...
      if (selectedProduct && value >= 0 && value <= selectedProduct.maxQty) {
        ...
        if (selectedProduct.returnQty > 0) {
          ...
          var originalDiscount = parseFloat(selectedProduct.discountAmount) || 0;
          var originalTax = parseFloat(selectedProduct.totalTax) || 0;
    ...
    updateItemReactively: function updateItemReactively(item) {
      ...
      if (item.returnQty > 0) {
        ...
        // Calculate proportional discount and tax
        var originalDiscount = parseFloat(item.discountAmount) || 0;
        var originalTax = parseFloat(item.totalTax) || 0;
        var proportionalDiscount = Number((originalDiscount / totalQty * returnQty).toFixed(2));
        var proportionalTax = Number((originalTax / totalQty * returnQty).toFixed(2));
    ...
    calculateSum: function calculateSum() {
      ...
      for (var i = 0; i < length; i++) {
        ...
        var productTotal = remainingQty * p.purchasePrice;
            ...
            case 0:
              ...
              return _this9.form.post(window.location.origin + '/api/purchase-returns').then(function (_ref) {
                ...
                if (errorMessage) {
                  ...
                  var translatedMessage = _this9.$t(errorMessage);
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              supplierSlug = _this10.$route.query.supplier;
              purchaseSlug = _this10.$route.query.purchase;
              purchaseData = null;
              if (!purchaseSlug) {
                _context9.next = 96;
                break;
            ...
            case 14:
              ...
              if (!(_this10.items && _this10.items.length > 0)) {
                _context9.next = 85;
                break;
              }
              selectedSupplier = _this10.items.find(function (supplier) {
              ...
              fallbackSupplier = _this10.items.find(function (supplier) {
              ...
              _this10.form.supplier = fallbackSupplier;

              // Trigger purchase loading for this supplier
              _context9.next = 23;
              return _this10.assignPurchases();
            case 23:
              _context9.next = 25;
            ...
            case 27:
              if (!(_this10.supplierPurchases && _this10.supplierPurchases.length > 0)) {
                _context9.next = 52;
                break;
              }
              selectedPurchase = _this10.supplierPurchases.find(function (purchase) {
              ...
              _this10.form.purchase = selectedPurchase;
              // Trigger product loading for this purchase
              _context9.next = 33;
              return _this10.storeProducts();
            case 33:
            ...
            case 36:
              ...
              if (purchaseData && purchaseData.id) {
                fallbackPurchase = _this10.supplierPurchases.find(function (purchase) {
              ...
              _this10.form.purchase = fallbackPurchase;
              _context9.next = 44;
              return _this10.storeProducts();
            case 44:
              return _context9.abrupt("return");
            case 47:
              ...
              _this10.form.purchase = purchaseData;
              _context9.next = 51;
              return _this10.storeProducts();
            case 51:
              return _context9.abrupt("return");
            case 52:
              ...
              _this10.form.supplier = selectedSupplier;
            ...
            case 60:
              ...
              _selectedPurchase = _this10.supplierPurchases.find(function (purchase) {
                return purchase.slug === purchaseSlug;
              });
              ...
              _this10.form.purchase = _selectedPurchase;
              // Trigger product loading for this purchase
              _context9.next = 66;
              return _this10.storeProducts();
            case 66:
            ...
            case 69:
              ...
              if (purchaseData && purchaseData.id) {
                _fallbackPurchase = _this10.supplierPurchases.find(function (purchase) {
                  return purchase.id === purchaseData.id;
                });
              }
              ...
              _this10.form.purchase = _fallbackPurchase;
              _context9.next = 77;
              return _this10.storeProducts();
            case 77:
              return _context9.abrupt("return");
            ...
            case 93:
              ...
              console.error('Error fetching purchase details:', _context9.t0);
            case 96:
            case "end":
...
;// CONCATENATED MODULE: ./resources/js/pages/purchases/returns/create.vue?vue&type=script&lang=js
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_be06455e_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const returns_createvue_type_style_index_0_id_be06455e_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_be06455e_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/purchases/returns/create.vue?vue&type=style&index=0&id=be06455e&prod&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(14486);
;// CONCATENATED MODULE: ./resources/js/pages/purchases/returns/create.vue
