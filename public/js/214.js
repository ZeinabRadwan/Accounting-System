"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[214],{
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/central/settings/explorers.vue?vue&type=template&id=8cf02408&scoped=true
              ...
              Swal.fire({
                ...
                if (result.value) {
                  _this0.$store.dispatch('operations/deleteData', {
                    ...
                    if (response === true) {
                      Swal.fire(_this0.$t('Deleted!'), _this0.$t('Deleted successfully.'), 'success');
                      _this0.getTableData();
                    } else {
                      Swal.fire(_this0.$t('Failed!'), _this0.$t('There was something wrong.'), 'warning');
                    }
                  });
                }
              });
