"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2183],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-tabs[data-v-6905dcc6]{border-bottom:2px solid #dee2e6;margin-bottom:1.5rem}.nav-tabs .nav-item[data-v-6905dcc6]{margin-bottom:-2px}.nav-tabs .nav-link[data-v-6905dcc6]{background-color:transparent;border:1px solid transparent;border-top-left-radius:.25rem;border-top-right-radius:.25rem;color:#495057;cursor:pointer;font-weight:500;padding:.75rem 1.5rem;transition:all .2s ease}.nav-tabs .nav-link[data-v-6905dcc6]:hover{border-color:#e9ecef #e9ecef #dee2e6;color:#33a0d9}.nav-tabs .nav-link.active[data-v-6905dcc6]{background-color:#fff;border-color:#dee2e6 #dee2e6 transparent;color:#33a0d9;font-weight:600}.nav-tabs .nav-link i[data-v-6905dcc6]{margin-right:.5rem}.tab-content[data-v-6905dcc6]{min-height:200px}.tab-pane[data-v-6905dcc6]{padding:0}.form-group[data-v-6905dcc6]{margin-bottom:1rem}.form-group label[data-v-6905dcc6]{color:#495057;font-size:.95rem;font-weight:500;margin-bottom:.5rem}.required[data-v-6905dcc6]{color:#dc3545;font-weight:700}.form-control[data-v-6905dcc6]{background:#fff!important;border:1px solid #e5e7eb;font-size:14px;padding:10px 16px}.form-control[data-v-6905dcc6]:focus{border-color:#33a0d9;box-shadow:0 0 0 .2rem rgba(51,160,217,.25)}.is-invalid[data-v-6905dcc6]{border-color:#dc3545!important}textarea.form-control[data-v-6905dcc6]{min-height:100px;resize:vertical}.v-select[data-v-6905dcc6]{background:#fff!important;border:1px solid #e5e7eb;border-radius:10px}.v-select .vs__dropdown-toggle[data-v-6905dcc6]{background:#fff!important;border:1px solid #e5e7eb;padding:10px 16px}.btn-success[data-v-6905dcc6]{background:#2ab930!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-success[data-v-6905dcc6]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-secondary[data-v-6905dcc6]{background:#6c757d!important;border:none!important;color:#fff!important;font-weight:500;padding:10px 20px!important}.btn-secondary[data-v-6905dcc6]:hover{background:#5a6268!important;box-shadow:0 4px 8px hsla(208,7%,46%,.3);transform:translateY(-1px)}.create-button[data-v-6905dcc6]{cursor:pointer;text-decoration:none}.row[data-v-6905dcc6]{margin-bottom:1rem}.row[data-v-6905dcc6]:last-child{margin-bottom:0}@media (max-width:768px){.nav-tabs .nav-link[data-v-6905dcc6]{font-size:.9rem;padding:.5rem 1rem}.tab-content[data-v-6905dcc6]{padding:.5rem}}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-buttons[data-v-1b7bc25c]{margin-bottom:15px}.footer-buttons[data-v-1b7bc25c]{display:flex;gap:10px}.footer-buttons .btn[data-v-1b7bc25c]{margin-right:10px}.footer-buttons .btn[data-v-1b7bc25c]:last-child{margin-right:0}.create-btn[data-v-1b7bc25c]{padding:11px}.chart-account-success[data-v-1b7bc25c],.chart-account-warning[data-v-1b7bc25c]{border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.chart-account-warning[data-v-1b7bc25c]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107}.chart-account-success[data-v-1b7bc25c]{background:linear-gradient(135deg,#d4edda,#c3e6cb);border:1px solid #28a745}.success-content[data-v-1b7bc25c],.warning-content[data-v-1b7bc25c]{align-items:center;display:flex;gap:16px}.success-icon[data-v-1b7bc25c],.warning-icon[data-v-1b7bc25c]{flex-shrink:0;font-size:24px}.warning-icon[data-v-1b7bc25c]{color:#856404}.success-icon[data-v-1b7bc25c]{color:#155724}.success-text[data-v-1b7bc25c],.warning-text[data-v-1b7bc25c]{flex-grow:1}.success-title[data-v-1b7bc25c],.warning-title[data-v-1b7bc25c]{font-size:14px;font-weight:600;margin:0 0 4px}.warning-title[data-v-1b7bc25c]{color:#856404}.success-title[data-v-1b7bc25c]{color:#155724}.success-description[data-v-1b7bc25c],.warning-description[data-v-1b7bc25c]{font-size:13px;margin:0;opacity:.8}.warning-description[data-v-1b7bc25c]{color:#856404}.success-description[data-v-1b7bc25c]{color:#155724}.warning-action[data-v-1b7bc25c]{flex-shrink:0}.button-plus.icon-shape.icon-sm.btn-primary[data-v-1b7bc25c]{padding:0}.btn-primary[data-v-1b7bc25c]:hover{background:#229a26!important;box-shadow:0 4px 8px rgba(42,185,48,.3);transform:translateY(-1px)}.btn-primary[data-v-1b7bc25c]:disabled{box-shadow:none;cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.success-content[data-v-1b7bc25c],.warning-content[data-v-1b7bc25c]{flex-direction:column;gap:12px;text-align:center}.btn-primary[data-v-1b7bc25c],.warning-action[data-v-1b7bc25c]{width:100%}}.client-status[data-v-1b7bc25c]{font-size:13px}.client-success[data-v-1b7bc25c],.client-warning[data-v-1b7bc25c]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.client-warning[data-v-1b7bc25c]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.client-success[data-v-1b7bc25c]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.btn-outline-warning[data-v-1b7bc25c]{border-color:#ffc107;color:#856404;font-size:12px;padding:4px 8px}.debug-panel[data-v-1b7bc25c]{border:2px solid #ffc107;border-radius:10px;box-shadow:0 4px 8px rgba(255,193,7,.2);display:none}.debug-panel .card-header[data-v-1b7bc25c]{background:linear-gradient(45deg,#ffc107,#ffeb3b)!important;border-bottom:2px solid #ffc107;border-radius:8px 8px 0 0!important}.debug-item[data-v-1b7bc25c]{background-color:#f8f9fa;border-left:4px solid #007bff!important;transition:all .3s ease}.debug-item[data-v-1b7bc25c]:hover{background-color:#e9ecef;box-shadow:0 2px 4px rgba(0,0,0,.1);transform:translateY(-2px)}.debug-step[data-v-1b7bc25c]{background-color:#fff;border:1px solid #dee2e6;border-radius:4px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:4px 8px}.debug-summary[data-v-1b7bc25c]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-summary ul li[data-v-1b7bc25c]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-summary ul li[data-v-1b7bc25c]:last-child{border-bottom:none}.debug-display[data-v-1b7bc25c]{background:linear-gradient(135deg,#e3f2fd,#f3e5f5)!important;border:1px solid #bbdefb;font-family:Courier New,monospace}.debug-steps .step[data-v-1b7bc25c]{background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;font-family:Courier New,monospace;font-size:.9em;margin-bottom:8px;padding:8px 12px}.debug-state[data-v-1b7bc25c]{background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:8px;padding:15px}.debug-state div[data-v-1b7bc25c]{border-bottom:1px solid #e9ecef;padding:4px 0}.debug-state div[data-v-1b7bc25c]:last-child{border-bottom:none}.debug-panel .table th[data-v-1b7bc25c]{background-color:#f8f9fa;font-size:.85em;font-weight:600}.debug-panel .table td[data-v-1b7bc25c]{font-size:.85em;vertical-align:middle}.debug-panel .table tbody tr[data-v-1b7bc25c]:hover{background-color:#f8f9fa}@media (max-width:768px){.debug-panel .card-body[data-v-1b7bc25c]{padding:15px}.debug-item .row[data-v-1b7bc25c]{margin:0}.debug-item .col-md-6[data-v-1b7bc25c]{padding:0 5px}.debug-step[data-v-1b7bc25c]{font-size:.8em;padding:3px 6px}.debug-panel .table[data-v-1b7bc25c]{font-size:.75em}}.btn-outline-warning[data-v-1b7bc25c]:hover{background-color:#ffc107;border-color:#ffc107;color:#212529}.btn-outline-warning[data-v-1b7bc25c]:disabled{cursor:not-allowed;opacity:.6}.product-status[data-v-1b7bc25c]{font-size:13px}.product-success[data-v-1b7bc25c],.product-warning[data-v-1b7bc25c]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.product-warning[data-v-1b7bc25c]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.product-success[data-v-1b7bc25c]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.account-status[data-v-1b7bc25c]{font-size:13px}.account-success[data-v-1b7bc25c],.account-warning[data-v-1b7bc25c]{align-items:center;border-radius:6px;display:flex;font-weight:500;padding:8px 12px}.account-warning[data-v-1b7bc25c]{background-color:#fff3cd;border:1px solid #ffeaa7;color:#856404}.account-success[data-v-1b7bc25c]{background-color:#d4edda;border:1px solid #c3e6cb;color:#155724}.radio-group-horizontal[data-v-1b7bc25c]{align-items:center;display:flex;flex-direction:row;gap:20px}.radio-group-horizontal .form-check[data-v-1b7bc25c]{align-items:center;display:flex;margin-bottom:0}.radio-group-horizontal .form-check-input[data-v-1b7bc25c]{margin-right:8px}.radio-group-horizontal .form-check-label[data-v-1b7bc25c]{cursor:pointer;margin-bottom:0}.text-warning[data-v-1b7bc25c]{color:#856404!important}.text-warning small[data-v-1b7bc25c]{font-size:12px;font-weight:500}.text-warning i[data-v-1b7bc25c]{margin-right:4px}.table-custom[data-v-1b7bc25c]{border:none!important}.invoices-create-table[data-v-1b7bc25c]{border-collapse:separate;border-spacing:0}.invoices-create-table thead th[data-v-1b7bc25c]{background-color:#33a0d9;border:none!important;border-color:inherit!important;color:#fff;font-weight:400;padding:8px}.invoices-create-table thead tr[data-v-1b7bc25c]{border:none!important}.invoices-create-table thead th[data-v-1b7bc25c]:first-child{border-top-left-radius:10px}.invoices-create-table thead th[data-v-1b7bc25c]:last-child{border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-1b7bc25c]:first-child{border-top-left-radius:0;border-top-right-radius:10px}[dir=rtl] .invoices-create-table thead th[data-v-1b7bc25c]:last-child{border-top-left-radius:10px;border-top-right-radius:0}.btn-group.c-w-100[data-v-1b7bc25c]{gap:10px}.card[data-v-1b7bc25c]{border:1px solid #ced4da;border-radius:20px;box-shadow:0 8px 20px 0 #00000014;margin-top:30px}.card-footer[data-v-1b7bc25c]{background-color:#fff;border-radius:0 0 20px 20px;border-top:1px solid #ced4da;padding:0 1.25rem .625rem}.invoices-create-table .badge.badge-danger[data-v-1b7bc25c]{background:#fef4f4!important;color:#dc3545!important;font-size:12px!important;font-weight:500!important;padding:10px 16px}.form-control[data-v-1b7bc25c]{background:#fff!important}.quantity-field[data-v-1b7bc25c]{border-radius:0!important;margin:0!important;min-height:50px!important}.btn-primary[data-v-1b7bc25c]{background:#2ab930!important}.btn-secondary[data-v-1b7bc25c]{background:#33a0d9!important;border:none!important;color:#fff!important;padding:10px 20px!important}.stock-warning-alert[data-v-1b7bc25c]{background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1px solid #ffc107;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:16px}.stock-warning-content[data-v-1b7bc25c]{align-items:flex-start;display:flex;gap:16px}.stock-warning-icon[data-v-1b7bc25c]{color:#856404;flex-shrink:0;font-size:24px;margin-top:2px}.stock-warning-text[data-v-1b7bc25c]{flex-grow:1}.stock-warning-title[data-v-1b7bc25c]{color:#856404;font-size:16px;font-weight:600;margin:0 0 8px}.stock-warning-description[data-v-1b7bc25c]{color:#856404;font-size:14px;margin:0 0 12px;opacity:.9}.stock-warning-list[data-v-1b7bc25c]{list-style:none;margin:0;padding-left:20px}.stock-warning-item[data-v-1b7bc25c]{background-color:hsla(0,0%,100%,.5);border-left:3px solid #ffc107;border-radius:6px;color:#856404;font-size:14px;margin-bottom:8px;padding:8px 12px}.stock-warning-item[data-v-1b7bc25c]:last-child{margin-bottom:0}.product-name[data-v-1b7bc25c]{color:#856404;font-weight:600;margin-right:8px}.stock-details[data-v-1b7bc25c]{color:#856404;opacity:.8}.stock-details strong[data-v-1b7bc25c]{color:#856404;font-weight:600}[dir=rtl] .stock-warning-list[data-v-1b7bc25c]{padding-left:0;padding-right:20px}[dir=rtl] .stock-warning-item[data-v-1b7bc25c]{border-left:none;border-right:3px solid #ffc107}[dir=rtl] .product-name[data-v-1b7bc25c]{margin-left:8px;margin-right:0}@media (max-width:768px){.stock-warning-content[data-v-1b7bc25c]{flex-direction:column;gap:12px;text-align:center}.stock-warning-icon[data-v-1b7bc25c]{align-self:center}.stock-warning-list[data-v-1b7bc25c]{padding-left:0;text-align:left}[dir=rtl] .stock-warning-list[data-v-1b7bc25c]{text-align:right}}.clickable-badge[data-v-1b7bc25c]{cursor:pointer;transition:all .3s ease;-webkit-user-select:none;-moz-user-select:none;user-select:none}.clickable-badge[data-v-1b7bc25c]:hover{background-color:#c82333!important;box-shadow:0 2px 4px rgba(220,53,69,.3);transform:scale(1.05)}.clickable-badge[data-v-1b7bc25c]:active{transform:scale(.95)}.insufficient-stock-input[data-v-1b7bc25c]{background-color:#fff5f5!important;border:2px solid #dc3545!important;color:#dc3545!important;margin:0 5px}.insufficient-stock-input[data-v-1b7bc25c]:focus{border-color:#dc3545!important;box-shadow:0 0 0 .2rem rgba(220,53,69,.25)!important}.custom-qty-input input.button-minus[data-v-1b7bc25c],.custom-qty-input input.button-plus[data-v-1b7bc25c]{margin:0 5px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var CategorySubcategoryCreateModalvue_type_template_id_6905dcc6_scoped_true_staticRenderFns = [];
...
/* harmony default export */ const CategorySubcategoryCreateModalvue_type_script_lang_js = ({
  ...
  data: function data() {
    return {
      ...
      categories: [],
      // Local state for categories - prevents overriding shared Vuex store
...
var injectStylesIntoStyleTag = __webpack_require__(85072);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CategorySubcategoryCreateModal.vue?vue&type=style&index=0&id=6905dcc6&prod&scoped=true&lang=css
var CategorySubcategoryCreateModalvue_type_style_index_0_id_6905dcc6_prod_scoped_true_lang_css = __webpack_require__(79183);
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/CategorySubcategoryCreateModal.vue?vue&type=style&index=0&id=6905dcc6&prod&scoped=true&lang=css
...
var update = injectStylesIntoStyleTag_default()(CategorySubcategoryCreateModalvue_type_style_index_0_id_6905dcc6_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const components_CategorySubcategoryCreateModalvue_type_style_index_0_id_6905dcc6_prod_scoped_true_lang_css = (CategorySubcategoryCreateModalvue_type_style_index_0_id_6905dcc6_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/components/CategorySubcategoryCreateModal.vue?vue&type=style&index=0&id=6905dcc6&prod&scoped=true&lang=css
...
var component = (0,componentNormalizer/* default */.A)(
  ...
  CategorySubcategoryCreateModalvue_type_template_id_6905dcc6_scoped_true_render,
  CategorySubcategoryCreateModalvue_type_template_id_6905dcc6_scoped_true_staticRenderFns,
  false,
  null,
  "6905dcc6",
  null
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=1b7bc25c&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('div', {
...
;// CONCATENATED MODULE: ./resources/js/pages/sales/invoices/create.vue?vue&type=template&id=1b7bc25c&scoped=true
...
var ProductCreateModal = __webpack_require__(70074);
...
/* harmony default export */ const createvue_type_script_lang_js = ({
  ...
  data: function data() {
    return {
      ...
      taxes: [],
      clients: [],
      // Local state for clients - prevents being overridden by other API calls
      prefix: "",
...
var update = injectStylesIntoStyleTag_default()(createvue_type_style_index_0_id_1b7bc25c_prod_scoped_true_lang_css/* default */.A, options);



/* harmony default export */ const invoices_createvue_type_style_index_0_id_1b7bc25c_prod_scoped_true_lang_css = (createvue_type_style_index_0_id_1b7bc25c_prod_scoped_true_lang_css/* default */.A.locals || {});
;// CONCATENATED MODULE: ./resources/js/pages/sales/invoices/create.vue?vue&type=style&index=0&id=1b7bc25c&prod&scoped=true&lang=css
