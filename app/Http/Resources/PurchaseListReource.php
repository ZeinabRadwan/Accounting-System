...
class PurchaseListReource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'supplierPhone' => $this->supplier ? $this->supplier->phone_number : null,
            ...
            'accountReceivable' => $this->purchaseReturn && isset($this->purchaseReturn->returnTransaction) ? $this->purchaseReturn->returnTransaction->amount : null,
            'note' => $this->note,
