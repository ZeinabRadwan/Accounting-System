        ...
        return [
            ...
            'fiscal_year' => $this->whenLoaded('fiscalYear', function () {
                return [
                    ...
                    'start_date' => $this->fiscalYear->start_date ? $this->fiscalYear->start_date->format('Y-m-d') : null,
                    'end_date' => $this->fiscalYear->end_date ? $this->fiscalYear->end_date->format('Y-m-d') : null,
