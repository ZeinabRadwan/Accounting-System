...
class PurchasePaymentController extends Controller
{
    ...
    {
        $query = PurchasePayment::with('purchase.supplier', 'purchase.purchaseTax', 'purchase.purchaseReturn', 'purchasePaymentTransaction.cashbookAccount', 'user');
            ...
            foreach ($request->selectedPurchases as $key => $selectedPurchase) {
               ...
               $purchasePayment = PurchasePayment::create([
                ...
                activity()
                    ...
                    ->log('Supplier Purchase Payment Created');
                }
    ...
    public function update(Request $request, $slug)
    {
        ...
        try {
            ...
            activity()
                ...
                ->useLog('Supplier Purchase Payment Updated')
                ->log('Supplier Purchase Payment Updated');
    ...
    public function destroy($slug)
    {
        try {
            ...
            activity()
                ...
                ->useLog('Supplier Purchase Payment Deleted')
                ->log('Supplier Purchase Payment Deleted');
