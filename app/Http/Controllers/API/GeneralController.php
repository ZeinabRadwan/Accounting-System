...
class GeneralController extends Controller
{
    ...
    public function getGeneralSettings()
    {
        ...
        $settings = [
            ...
            'logo' => getLogoWithFallbackGlobal($query, 'logo', 'white_logo.png'),
            'blackLogo' => getLogoWithFallbackGlobal($query, 'logo_black', 'black_logo.png'),
            'smallLogo' => getLogoWithFallbackGlobal($query, 'small_logo', 'small_logo.png'),
            'favicon' => getLogoWithFallbackGlobal($query, 'favicon', 'favicon.png'),
