...
class PurchaseOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'selectedProducts.*.productTax' => 'nullable|numeric|min:0',
            'selectedProducts.*.totalTax' => 'nullable|numeric|min:0',
            'selectedProducts.*.selectedVatRate' => 'nullable',
        ...
        try {
            ...
            foreach ($request->selectedProducts as $product) {
                PurchaseOrderProduct::create([
                    ...
                    'tax_amount' => isset($product['productTax']) ? $product['productTax'] : (isset($product['tax_amount']) ? $product['tax_amount'] : 0),
