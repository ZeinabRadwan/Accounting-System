...
class SeedBulkDataForTenant extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'tenant:seed-bulk-data 
     ...
     * @var string
     */
    protected $description = 'Generate bulk data (invoices, purchases, journal entries) for a specific tenant without running other seeders';
