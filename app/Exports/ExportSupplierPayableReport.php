    ...
    public function collection()
    {
        ...
        $supplierPayableReports = SupplierResource::collection($query->latest()->get())->map(function ($supplierPayableReport) {
            ...
            return [
                ...
                $currencySymbol . strval($supplierPayableReport->nonPurchaseCurrentDue() ?: '0'),
                $currencySymbol . strval($supplierPayableReport->purchaseTotalDue() + $supplierPayableReport->nonPurchaseCurrentDue() ?: '0'),
            ];
        });
