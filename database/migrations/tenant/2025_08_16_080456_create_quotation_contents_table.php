...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('quotation_contents', function (Blueprint $table) {
            $table->id();
            
            // Relationship to quotations table
            ...
            $table->unsignedInteger('sort_order')->default(0)->comment('Order of items in the quotation');
    ...
    {
        Schema::dropIfExists('quotation_contents');
    }
};
