...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->foreign('sales_account_id')->references('id')->on('chart_of_accounts')->onDelete('set null')->onUpdate('cascade');
            $table->foreign('purchase_account_id')->references('id')->on('chart_of_accounts')->onDelete('set null')->onUpdate('cascade');
        });
    }
