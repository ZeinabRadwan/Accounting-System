...
class SidebarMenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $createMenu([
            ...
            'icon' => 'pie-chart',
            'name' => 'dashboard',
            'permissions' => json_encode(['view_default', 'view_academy', 'view_ecmommerce', 'view_hospital', 'view_hrm']),
            'order' => 1,
        ], [
            ['name' => 'custom.default', 'url' => '/admin/dashboard', 'permissions' => json_encode(['view_default'])],
            ['name' => 'custom.academy', 'url' => '/dashboard/academy', 'permissions' => json_encode(['view_academy'])],
            ['name' => 'custom.e_commerce', 'url' => '/dashboard/ecommerce', 'permissions' => json_encode(['view_ecmommerce'])],
            ['name' => 'custom.hospital', 'url' => '/dashboard/hospital', 'permissions' => json_encode(['view_hospital'])],
            ['name' => 'custom.hrm', 'url' => '/dashboard/hrm', 'permissions' => json_encode(['view_hrm'])],
