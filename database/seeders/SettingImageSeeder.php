    ...
    public function run()
    {
        ...
        $settingImages = [
            ...
            [
                ...
                'title' => 'Multilingual',
                'description' => 'Multilingual feature allows you to use websoft SaaS in your local language.',
                'status' => true,
            ],
            [
                'type' => 'why_us_cards',
                ...
                'title' => 'SPA',
                'description' => 'websoft SaaS is a Single Page Application that doesn\'t need a page refresh which makes it faster.',
                'status' => true,
            ],
            [
                'type' => 'why_us_cards',
                ...
                'title' => 'Custom Domain',
                'description' => 'websoft SaaS can be used on any custom domain that helps can help you to establish brand identity.',
                'status' => true,
            ],
            // features
            [
