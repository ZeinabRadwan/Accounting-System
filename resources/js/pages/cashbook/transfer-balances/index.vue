                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('account-transfer-balance-view')">
                              <router-link :to="{ name: 'transferBalances.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('account-transfer-balance-edit')">
                              <router-link :to="{ name: 'transferBalances.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
