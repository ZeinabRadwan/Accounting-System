          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/cashbook/transfer-balances/pdf" v-tooltip="$t('Export to PDF')" class="btn btn-secondary">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('account-transfer-balance-edit') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('account-transfer-balance-view')" v-tooltip="$t('View')" :to="{
                          name: 'transferBalances.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('account-transfer-balance-edit')" v-tooltip="$t('Edit')" :to="{
                          name: 'transferBalances.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('account-transfer-balance-delete')" v-tooltip="$t('Delete')" href="#"
