                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('chart-of-account-view')">
                              <router-link :to="{ name: 'chart-of-accounts.show', params: { slug: data.code } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('chart-of-account-edit')">
                              <router-link :to="{ name: 'chart-of-accounts.edit', params: { slug: data.code } }">{{ $t('Edit') }}</router-link>
                            </li>
                            <li v-if="$can('chart-of-account-delete')">
                              <a href="#" @click.prevent="deleteData(data.code)">{{ $t('Delete') }}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
