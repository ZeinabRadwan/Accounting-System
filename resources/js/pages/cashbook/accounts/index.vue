                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('account-view')">
                              <router-link :to="{ name: 'accounts.show', params: { slug: data.slug } }">{{ $t('Transactions') }}</router-link>
                            </li>
                            <li v-if="$can('account-edit')">
                              <router-link :to="{ name: 'accounts.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
