<template>
  <div class="mb-50">
      ...
      <div class="col-lg-12">
        <div class="card custom-card w-100">
          ...
          <div class="card-body position-relative">
            ...
            <div class="row">
              ...
              <div class="col-xl-6 col-6 float-right text-right">
                <div class="btn-group c-w-100">
                  ...
                  <a href="#" @click="uploadCsvModalShow()" v-tooltip="$t('Import')" class="btn btn-dark import-btn">
            ...
            <GeneralTable table-id="printMe" wrapper-class="mt-3" :columns="clientColumns" :rows="itemsWithIndex"
              :loading="loading" :show-actions="$can('client-edit') || $can('client-view') || $can('client-delete')">
              ...
              <template #cell-clientID="{ row }">
                {{ row.clientID | withPrefix(clientPrefix) }}
              </template>
              ...
              <template #actions="{ row, index }">
                <div class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li v-if="$can('client-view')">
                        <router-link :to="{ name: 'clients.show', params: { slug: row.slug } }">
                      ...
                      <li v-if="$can('client-edit')">
                        <router-link :to="{ name: 'clients.edit', params: { slug: row.slug } }">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                            fill="none">
                      ...
                      <li v-if="appInfo.defaultClientSlug != row.slug && $can('client-delete')">
    ...
    <!-- Client Edit Modal -->
    <ClientEditModal v-if="selectedClientForEdit" :client="selectedClientForEdit" @reloadClients="reload"
...
export default {
  ...
  computed: {
    ...
    exportUrl() {
      ...
      let url = `/clients/export/excel?start_date=${this.dateRange.startDate}&end_date=${this.dateRange.endDate}&term=${this.query}&locale=${locale}`;
    ...
    clientColumns() {
      return [
        ...
        { key: "clientID", label: this.$t("Client ID") },
  ...
  methods: {
    ...
    async exportToPDF() {
      try {
        ...
        const opt = {
          margin: [10, 10, 10, 10],
          filename: `clients-${moment().format("YYYY-MM-DD")}.pdf`,
...
[dir="rtl"] .clients-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .clients-table thead th:last-child {
...
.clients-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
