                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('client-view')">
                              <router-link :to="{ name: 'clients.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('client-edit')">
                              <router-link :to="{ name: 'clients.edit', params: { slug: data.slug } }">{{ $t('Edit Page') }}</router-link>
                            </li>
                            <li v-if="$can('client-edit')">
