    ...
    <div>
        ...
        <div class="card">
            <div class="card-header setings-header">
                <h3 class="card-title">{{ $t('Software Overview') }}</h3>
            </div>
            <form
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="software_overview_section_tagline">
                            {{
                                $t('Software Overview Section Tagline')
                            }}
                        ...
                        <input
                            ...
                            :placeholder="
                                $t(
                                    'Enter software overview section tagline'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group">
                        <label for="software_overview_section_title">
                            {{ $t('Software Overview Section Title') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            ...
                            :placeholder="
                                $t(
                                    'Enter software overview section title'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group col-12 d-flex flex-wrap">
                        <div class="pr-5">
                        <toggle-button 
                                v-model="form.is_show_screenshot_section"
                                :sync="true"
                            />
        ...
        <Modal v-if="showModal" @close="closeModal">
            <h5 slot="header">{{ $t('Software Overview') }}</h5>
...
export default {
    ...
    methods: {
        ...
        async getData() {
            ...
            this.user = data.data;
            this.form.software_overview_section_tagline = data.data.software_overview_section_tagline || '';
            this.form.software_overview_section_title = data.data.software_overview_section_title || '';
            this.form.is_show_screenshot_section = this.appInfo.is_show_screenshot_section;
        },
