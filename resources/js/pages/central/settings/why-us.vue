        ...
        <div class="card">
            ...
            >
                <div class="card-header setings-header">
                    <h3 class="card-title">{{ $t('Why Us') }}</h3>
                </div>
                <div class="card-body">
                    <!-- form group start -->
                    <div class="form-group">
                        <label for="why_us_tagline">
                            {{ $t('Why Us Tagline') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="form.why_us_tagline"
                            class="form-control"
                            :class="{
                                'is-invalid': form.errors.has('why_us_tagline'),
                            }"
                            id="why_us_tagline"
                            :placeholder="
                                $t('Enter why us tagline')
                            "
                        />
                        <has-error :form="form" field="why_us_tagline" />
                    </div>
                    <div class="form-group">
                        <label for="why_us_title">
                            {{ $t('Why Us Title') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="form.why_us_title"
                            class="form-control"
                            :class="{
                                'is-invalid': form.errors.has('why_us_title'),
                            }"
                            id="why_us_title"
                            :placeholder="$t('Enter why us title')"
                        />
                        <has-error :form="form" field="why_us_title" />
                    </div>
                    <div class="form-group">
                        <label for="why_us_description">
                            {{ $t('Why Us Description') }}
                            <span class="required">*</span>
                        </label>
                        <textarea
                            v-model="form.why_us_description"
                            class="form-control"
                            :class="{
                                'is-invalid':
                                    form.errors.has('why_us_description'),
                            }"
                            id="why_us_description"
                            :placeholder="
                                $t('Enter why us description')
                            "
                        ></textarea>
                        <has-error :form="form" field="why_us_description" />
                    </div>

                    <div class="form-group col-12 d-flex flex-wrap">
                        <div class="pr-5">
                        <toggle-button 
                                v-model="form.is_show_why_us_section"
                                :sync="true"
                            />
    ...
    methods: {
        ...
        async getData() {
            const { data } = await axios.get(
                window.location.origin + '/api/settings/why-us-settings'
            );
            this.user = data.data;
            this.form.why_us_tagline = data.data.why_us_tagline || '';
            this.form.why_us_title = data.data.why_us_title || '';
            this.form.why_us_description = data.data.why_us_description || '';
            this.form.is_show_why_us_section = this.appInfo.is_show_why_us_section;
        },
        ...
        async update() {
            ...
            await this.form
                .patch(window.location.origin + '/api/settings/why-us-settings')
                .then(() => {
                    toast.fire({
                        type: 'success',
