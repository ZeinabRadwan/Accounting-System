    ...
    <div>
        ...
        <div class="card">
            <div class="card-header setings-header">
                <h3 class="card-title">{{ $t('Features') }}</h3>
            </div>
            <form
            ...
            >
                <div class="card-body">
                    <div class="form-group row">
                        <label for="features_section_tagline">
                            {{ $t('Feature Section Tagline') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="form.features_section_tagline"
                            class="form-control"
                            :class="{
                    ...
                    <div class="form-group row">
                        <label for="features_section_title">
                            {{ $t('Feature Section Title') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="form.features_section_title"
                            class="form-control"
                            :class="{
                                'is-invalid': form.errors.has(
                    ...
                    <div class="form-group row">
                        <label for="features_section_description">
                            {{ $t('Feature Section Description') }}
                        </label>
                        <textarea
                            v-model="form.features_section_description"
                            class="form-control"
                            :class="{
                                'is-invalid': form.errors.has(
                            ...
                            :placeholder="
                                $t(
                                    'Enter feature section description'
                                )
                            "
                        >
                        </textarea>
                    ...
                    <div class="form-group col-12 d-flex flex-wrap">
                        <div class="pr-5">
                        <toggle-button 
                                v-model="form.is_show_features_section"
                                :sync="true"
                            />
    ...
    methods: {
        ...
        async getData() {
            const { data } = await axios.get(
                window.location.origin + '/api/settings/features-settings'
            );
            this.user = data.data;
            this.form.features_section_tagline = data.data.features_section_tagline || '';
            this.form.features_section_title = data.data.features_section_title || '';
            this.form.features_section_description = data.data.features_section_description || '';
            this.form.is_show_features_section = this.appInfo.is_show_features_section;
        },
