<template>
    <div>
            ...
            >
                <div class="card-body">
                    <div class="form-group">
                        <label for="testimonial_section_tagline">
                            {{ $t('Testimonial Section Tagline') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="form.testimonial_section_tagline"
                            class="form-control"
                            :class="{
                            ...
                            :placeholder="
                                $t(
                                    'Enter testimonial section tagline'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group">
                        <label for="testimonial_section_title">
                            {{ $t('Testimonial Section Title') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            v-model="form.testimonial_section_title"
                            class="form-control"
                            :class="{
                                'is-invalid': form.errors.has(
                            ...
                            :placeholder="
                                $t(
                                    'Enter testimonial section title'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group col-12 d-flex flex-wrap">
                        <div class="pr-5">
                        <toggle-button 
                                v-model="form.is_show_testimonial_section"
                                :sync="true"
                            />
        ...
        <Modal v-if="showModal" @close="closeModal">
            <h5 slot="header">{{ $t('Testimonial') }}</h5>
                ...
                >
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input
                            ...
                            class="form-control"
                            :class="{
                                'is-invalid': dataForm.errors.has('name'),
                            }"
                            name="name"
                            :placeholder="$t('name')"
                        />
                        <has-error :form="dataForm" field="name" />
                    </div>
                    <!-- status -->
                    <div class="form-group col-md-6">
                        <label for="status">
    ...
    methods: {
        ...
        async getData() {
            const { data } = await axios.get(
                window.location.origin + '/api/settings/testimonial-settings'
            );
            this.user = data.data;
            this.form.testimonial_section_tagline = data.data.testimonial_section_tagline || '';
            this.form.testimonial_section_title = data.data.testimonial_section_title || '';
            this.form.is_show_testimonial_section = this.appInfo.is_show_testimonial_section;
        },
            ...
            await this.form
                .patch(
                    window.location.origin +
                        '/api/settings/testimonial-settings'
                )
                .then(() => {
                    toast.fire({
                        type: 'success',
