                  ...
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <router-link v-if="$can('purchase-order-view')" :to="{
                        ...
                        {{ data.purchaseNo || data.poNumber || data.purchase_no | withPrefix(prefix) }}
                      </router-link>
                      <span v-else>{{
                        (data.purchaseNo || data.poNumber || data.purchase_no) | withPrefix(prefix)
                      }}</span>
                    ...
                    <td>{{ Number(data.subTotal || data.sub_total || 0).toFixed(2) }} <span class="saudi-riyal">ê</span>
                    </td>
                    <td>{{ formatNumber(getOrderProductDiscount(data)) }} <span class="saudi-riyal">ê</span></td>
                    <td>{{ Number(data.totalTax || data.total_tax || 0).toFixed(2) }} <span class="saudi-riyal">ê</span>
                    </td>
                    <td>{{ Number(data.netTotal || data.net_total || data.calculated_total || 0).toFixed(2) }} <span
                        ...
                        <div class="action-menu" v-if="openActionIndex === i">
                          ...
                          <ul>
                            ...
                            <li v-if="$can('purchase-order-view')">
                              <router-link :to="{ name: 'purchase-order.show', params: { slug: data.slug } }">
                            ...
                            <li v-if="$can('purchase-order-edit')">
                              <router-link :to="{ name: 'purchase-order.edit', params: { slug: data.slug } }">{{
                                $t('Edit')
                              }}</router-link>
                            </li>
