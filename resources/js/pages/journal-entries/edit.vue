      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Edit Journal Entry - {{ journalEntry.formatted_entry_number }}</h4>
          </div>
          <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted">Status cannot be changed after creation</small>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <button
                      ...
                      :disabled="saving || balanceDifference !== 0"
                    >
                      <i v-if="saving" class="fa fa-spinner fa-spin"></i>
                      <i v-else class="fa fa-save"></i>
                      {{ saving ? 'Updating...' : 'Update Journal Entry' }}
                    </button>
                    <router-link :to="`/journal-entries/${journalEntry.id}`" class="btn btn-secondary ml-2">
...
export default {
  ...
  metaInfo() {
    return { title: 'Edit Journal Entry' }
  },
  data() {
    return {
      journalEntry: null,
