      ...
      <div class="col-12 col-xl-9">
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <h3 class="card-title">{{ $t("Brands") }}</h3>
          </div>
          <!-- /.card-header -->
            ...
            <div class="row">
              ...
              <div class="col-xl-8 col-8 float-right text-right">
                <div class="btn-group c-w-100">
                  <a href="/setup/brands/pdf" v-tooltip="$t('Export Table')" class="btn export-pdf-btn">
              ...
              <template #actions="{ row, index }">
                <div class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li>
                        <router-link :to="{ name: 'brands.show', params: { slug: row.slug } }">
                          <i class="fas fa-eye"></i>
                          {{ $t('View') }}
                        </router-link>
                      </li>
                      <li>
                        <router-link :to="{ name: 'brands.edit', params: { slug: row.slug } }">
  ...
  computed: {
    ...
    brandColumns() {
      return [
        ...
        { key: "name", label: this.$t("Brand Name") },
...
.brands-table thead th:first-child {
  border-top-left-radius: 10px;
}

.brands-table thead th:last-child {
  border-top-right-radius: 10px;
}

/* RTL styles for Arabic language */
[dir="rtl"] .brands-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .brands-table thead th:last-child {
