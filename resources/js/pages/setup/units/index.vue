      ...
      <div class="col-12 col-xl-9">
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <h3 class="card-title">{{ $t("Units") }}</h3>
          </div>
          <!-- /.card-header -->
            ...
            <div class="row">
              ...
              <div class="col-xl-8 col-8 float-right text-right">
                <div class="btn-group c-w-100">
                  <a href="/setup/units/pdf" v-tooltip="$t('Export Table')" class="btn export-pdf-btn">
                    ...
                    <td class="text-right no-print">
                      <div class="action-dropdown" :class="{ open: openActionIndex === i }">
                        ...
                        <div class="action-menu" v-if="openActionIndex === i">
                          ...
                          <ul>
                            <li>
                              <router-link :to="{ name: 'units.edit', params: { slug: data.slug } }">
...
[dir="rtl"] .units-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .units-table thead th:last-child {
