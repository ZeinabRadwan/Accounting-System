      ...
      <div class="col-12 col-xl-9">
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <h3 class="card-title">{{ $t("Tax Rates") }}</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body position-relative">
            ...
            <div class="row">
              ...
              <div class="col-xl-8 col-8 float-right text-right">
                <div class="btn-group c-w-100">
                  <a href="/setup/vat-rates/pdf" v-tooltip="$t('Export Table')" class="btn export-pdf-btn">
            ...
            >
              ...
              <template #cell-chartOfAccounts="{ row }">
                <div v-if="row.salesVatAccount || row.purchaseVatAccount" class="small">
                  <div v-if="row.salesVatAccount" class="text-success">
                    <i class="fas fa-arrow-up"></i> {{ row.salesVatAccount.name }}
                  </div>
                  <div v-if="row.purchaseVatAccount" class="text-info">
                    <i class="fas fa-arrow-down"></i> {{ row.purchaseVatAccount.name }}
                  </div>
                </div>
              ...
              <template #actions="{ row, index }">
                <div class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li>
                        <router-link :to="{ name: 'vatRates.edit', params: { slug: row.slug } }">
                          <i class="fas fa-edit"></i>
                          {{ $t('Edit') }}
                        </router-link>
                      </li>
                      <li v-if="appInfo.defaultVatRateSlug !== row.slug">
  ...
  computed: {
    ...
    vatRateColumns() {
      return [
        ...
        { key: "chartOfAccounts", label: this.$t("Chart of Accounts") },
...
.vat-rates-table thead tr {
  border: none !important;
}

.vat-rates-table thead th:first-child {
  border-top-left-radius: 10px;
}

.vat-rates-table thead th:last-child {
  border-top-right-radius: 10px;
}

/* RTL styles for Arabic language */
[dir="rtl"] .vat-rates-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .vat-rates-table thead th:last-child {
