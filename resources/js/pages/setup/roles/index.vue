      ...
      <div class="col-12 col-xl-9">
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            <h3 class="card-title">{{ $t("Roles & Permissions") }}</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body position-relative">
            <div class="row">
              ...
              <div class="col-xl-8 col-8 float-right text-right">
                <div class="btn-group c-w-100">
                  <a href="/setup/roles/pdf" v-tooltip="$t('Export Table')" class="btn export-pdf-btn">
            ...
            >
              ...
              <template #actions="{ row, index }">
                ...
                " class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li v-if="row && row.slug">
                        <router-link :to="{ name: 'roles.edit', params: { slug: row.slug } }">
...
[dir="rtl"] .roles-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .roles-table thead th:last-child {
