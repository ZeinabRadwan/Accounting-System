                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('employee-view')">
                              <router-link :to="{ name: 'employees.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('employee-edit')">
                              <router-link :to="{ name: 'employees.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
