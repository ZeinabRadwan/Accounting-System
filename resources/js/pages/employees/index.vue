          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/employees/pdf" v-tooltip="$t('Export to PDF')" class="btn btn-secondary">
                  ...
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('employee-view') ||
                      ...
                      <div v-if="data.slug" class="btn-group">
                        <router-link v-if="$can('employee-view')" v-tooltip="$t('View')" :to="{
                          name: 'employees.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('employee-edit')" v-tooltip="$t('Edit')" :to="{
                          name: 'employees.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('employee-delete')" v-tooltip="$t('Delete')" href="#"
