                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('increment-view')">
                              <router-link :to="{ name: 'increments.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('increment-edit')">
                              <router-link :to="{ name: 'increments.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
