            ...
            <div class="table-responsive table-custom mt-3" id="printMe">
              <table class="table departments-table">
                <thead>
                    ...
                    <th>{{ $t("Note") }}</th>
                    <th>{{ $t("Status") }}</th>
                    <th v-if="$can('department-edit') || $can('department-delete')
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('department-edit') || $can('department-delete')
                        " class="text-right no-print">
                        ...
                        <div class="action-menu" v-if="openActionIndex === i">
                          ...
                          <ul>
                            <li v-if="$can('department-edit')">
                              <router-link :to="{ name: 'departments.edit', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
