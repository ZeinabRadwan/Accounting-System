          ...
          <div class="card-body position-relative">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                  ...
                  <router-link v-if="$can('department-create')" :to="{ name: 'departments.create' }" class="btn btn-primary">
                  {{ $t("Create") }}
              ...
              <template #actions="{ row, index }">
                <div class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li v-if="$can('department-edit')">
                        <router-link :to="{ name: 'departments.edit', params: { slug: row.slug } }">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
...
export default {
  ...
  computed: {
    ...
    exportUrl() {
      ...
      return `/departments/export/excel?term=${this.query}&locale=${locale}`;
    },
    showActions() {
      return this.$can('department-edit') || this.$can('department-delete');
    },
    departmentColumns() {
      return [
  ...
  methods: {
    ...
    async exportToPDF() {
      try {
        ...
        const opt = {
          margin: [10, 10, 10, 10],
          filename: `employee-departments-${(new Date()).toISOString().slice(0,10)}.pdf`,
    ...
    async deleteData(slug) {
      Swal.fire({
        ...
        text: this.$t("You will not be able to return to this! This will delete the department permanently."),
        type: "warning",
...
[dir="rtl"] .departments-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .departments-table thead th:last-child {
...
.departments-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
...
.departments-table .badge.bg-danger {
