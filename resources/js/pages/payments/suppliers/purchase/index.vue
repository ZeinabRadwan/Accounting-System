          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a v-if="$can('purchase-payment-list') ||
                  $can('purchase-payment-edit') ||
                  $can('purchase-payment-view') ||
                  $can('purchase-payment-delete')
                  " href="/payments/suppliers/purchase/pdf" v-tooltip="$t('Export to PDF')"
                ...
                <router-link v-if="$can('purchase-payment-create')" :to="{ name: 'purchasePayments.create' }"
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('purchase-payment-edit') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('purchase-payment-view')" v-tooltip="$t('View')" :to="{
                          name: 'purchasePayments.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('purchase-payment-edit')" v-tooltip="$t('Edit')" :to="{
                          name: 'purchasePayments.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('purchase-payment-delete')" v-tooltip="$t('Delete')" href="#"
