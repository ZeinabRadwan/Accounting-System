            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a v-if="$can('non-purchase-payment-show') ||
                  ...
                  " href="/payments/suppliers/non-purchase/pdf" v-tooltip="$t('Export to PDF')"
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('non-purchase-payment-show') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('non-purchase-payment-edit')" v-tooltip="$t('Edit')" :to="{
                          name: 'nonPurchasePayments.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('non-purchase-payment-delete')" v-tooltip="$t('Delete')" href="#"
