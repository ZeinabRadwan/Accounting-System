          ...
          <div class="card-body position-relative">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                  ...
                  <router-link v-if="$can('loan-authority-create')" :to="{ name: 'authorities.create' }" class="btn btn-primary">
                  {{ $t("Create") }}
            ...
            <div class="table-responsive table-custom mt-3" id="printMe">
              <table class="table loan-authorities-table">
                <thead>
                    <th>{{ $t("#") }}</th>
                    <th>{{ $t("Name") }}</th>
                    <th>{{ $t("Email") }}</th>
                        ...
                        <div class="action-menu" v-if="openActionIndex === i">
                          ...
                          <ul>
                            <li v-if="$can('loan-authority-view')">
                              <router-link :to="{ name: 'authorities.show', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <li v-if="$can('loan-authority-edit')">
                              <router-link :to="{ name: 'authorities.edit', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
