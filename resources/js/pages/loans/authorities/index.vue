                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('loan-authority-view')">
                              <router-link :to="{ name: 'authorities.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('loan-authority-edit')">
                              <router-link :to="{ name: 'authorities.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
