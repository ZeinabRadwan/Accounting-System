        ...
        <div class="d-flex justify-content-between" v-if="allData">
          <div class="btn-group">
            <ul class="nav nav-pills">
              <li class="nav-item">
                <a class="nav-link active" href="#details" data-toggle="tab" @click="getLoanAuthority">
          ...
          <div class="btn-group">
            ...
            <router-link :to="{ name: 'authorities.index' }" class="btn btn-info float-right">
              <template
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="minus-sign">-</span>{{ allData.ccLoanTaken }} <span class="saudi-riyal">ê</span>
                        </td>
                      </tr>
