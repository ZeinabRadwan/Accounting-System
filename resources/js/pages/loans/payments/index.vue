        ...
        <div class="card custom-card w-100">
          ...
          <div class="card-body position-relative">
            ...
            <div class="table-responsive table-custom mt-3" id="printMe">
              <table class="table loan-payments-table">
                <thead>
                  <th>{{ $t("#") }}</th>
                  <th>{{ $t("Payment Ref.") }}</th>
                  <th>{{ $t("Loan Ref.") }}</th>
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <span v-if="data.account">{{ data.account.accountNumber }}
                      </span>
                    </td>
                    <td>{{ data.date }}</td>
                    <td>
                        ...
                        <div class="action-menu" v-if="openActionIndex === i">
                          ...
                          <ul>
                            <li v-if="$can('loan-payment-view')">
                              <router-link :to="{ name: 'loanPayments.show', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <li v-if="$can('loan-payment-edit')">
                              <router-link :to="{ name: 'loanPayments.edit', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
