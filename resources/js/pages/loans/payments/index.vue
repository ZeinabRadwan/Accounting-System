                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('loan-payment-view')">
                              <router-link :to="{ name: 'loanPayments.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('loan-payment-edit')">
                              <router-link :to="{ name: 'loanPayments.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
