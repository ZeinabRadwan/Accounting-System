        ...
        <div class="card custom-card w-100">
          ...
          <div class="card-body position-relative">
            <div class="row">
              ...
              <div class="col-xl-8 col-8 float-right text-right">
                <div class="btn-group c-w-100">
                  ...
                  <a href="expense-sub-categories/pdf" v-tooltip="$t('Export to PDF')" class="btn export-pdf-btn"
                    title="Export to PDF">
            ...
            <GeneralTable
              ...
              :rows="expenseSubCategoriesWithIndex"
              :loading="loading"
              table-id="printMe"
              wrapper-class="mt-3"
              ...
              <template #actions="{ row, index }">
                <div class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li v-if="$can('expense-sub-category-edit')">
                        <router-link :to="{ name: 'expenseSubCats.edit', params: { slug: row.slug } }">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                            fill="none">
                      ...
                      <li v-if="$can('expense-sub-category-delete')">
...
export default {
  ...
  computed: {
    ...
    exportUrl() {
      ...
      return `/expense-sub-categories/export/excel?term=${this.query}&locale=${locale}`;
    },
    showActions() {
...
.expense-sub-categories-table {
  border-collapse: separate;
  border-spacing: 0;
}

.expense-sub-categories-table thead th {
...
.expense-sub-categories-table thead tr {
  border: none !important;
}

.expense-sub-categories-table thead th:first-child {
  border-top-left-radius: 10px;
}

.expense-sub-categories-table thead th:last-child {
  border-top-right-radius: 10px;
}

/* RTL styles for Arabic language */
[dir="rtl"] .expense-sub-categories-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .expense-sub-categories-table thead th:last-child {
...
.expense-sub-categories-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
...
.expense-sub-categories-table .badge.bg-danger {
