<template>
  <div class="mb-50">
    <div class="row">
      <div class="col-lg-12" v-if="$can('expense-category-list') ||
        ...
        <div class="card custom-card w-100">
          ...
          <div class="card-body position-relative">
            <div class="row">
              ...
              <div class="col-xl-8 col-8 float-right text-right">
                <div class="btn-group c-w-100">
                  ...
                  <a href="expense-categories/pdf" v-tooltip="$t('Export to PDF')" class="btn export-pdf-btn"
                    title="Export to PDF">
            ...
            <GeneralTable
              ...
              :rows="expenseCategoriesWithIndex"
              :loading="loading"
              table-id="printMe"
              wrapper-class="mt-3"
            ...
            >
              <template #cell-code="{ row }">
                {{ row.code | withPrefix(codePrefix) }}
              </template>
              <template #cell-note="{ row }">
                <span v-html="row.note"></span>
              </template>
              ...
              <template #actions="{ row, index }">
                <div class="action-dropdown" :class="{ open: openActionIndex === index }">
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li v-if="$can('expense-category-edit')">
                        <router-link :to="{ name: 'expenseCats.edit', params: { slug: row.slug } }">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                            fill="none">
                      ...
                      <li v-if="$can('expense-category-delete')">
...
export default {
  ...
  computed: {
    ...
    exportUrl() {
      ...
      return `/expense-categories/export/excel?term=${this.query}&locale=${locale}`;
    },
    showActions() {
...
.expense-categories-table thead tr {
  border: none !important;
}

.expense-categories-table thead th:first-child {
  border-top-left-radius: 10px;
}

.expense-categories-table thead th:last-child {
  border-top-right-radius: 10px;
}

/* RTL styles for Arabic language */
[dir="rtl"] .expense-categories-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .expense-categories-table thead th:last-child {
...
.expense-categories-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
...
.expense-categories-table .badge.bg-danger {
