                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('inventory-history')">
                              <router-link :to="{ name: 'inventory.history', params: { slug: data.slug } }">{{ $t('Inventory History') }}</router-link>
                            </li>
                          </ul>
                        </div>
                      </div>
...
[dir="rtl"] .inventory-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .inventory-table thead th:last-child {
...
.inventory-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
...
.inventory-table .badge.bg-danger {
...
/* Alert badge styling */
.inventory-table .badge.badge-danger {
  background: #FEF4F4 !important;
  color: #DC3545 !important;
  font-size: 12px !important;
  font-weight: 500 !important;
