          ...
          <div class="card-body position-relative">
            <div class="row d-flex justify-content-between">
              ...
              <div class="col-12 col-md-6 col-xl-3 mb-2">
                <select v-model="filterType" class="form-control" id="summeryType" name="summeryType">
              ...
              <div class="col-12 col-xl-5 text-right">
                <div class="btn-group c-w-100">
                  ...
                  <a href="#" @click.prevent="exportExcel" v-tooltip="$t('Export to Excel')"
                    class="btn export-excel-btn" title="Export to Excel">
                  ...
                  <a href="#" @click.prevent="exportPdf" v-tooltip="$t('Export to PDF')" class="btn export-pdf-btn"
                    title="Export to PDF">
              ...
              <table class="table inventory-count-table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <router-link target="_blank" :to="{ name: 'adjustments.create', query: { product_id: data.id } }"
                        class="btn btn-sm btn-primary" v-tooltip="$t('Create Adjustment')">
