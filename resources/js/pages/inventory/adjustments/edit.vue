    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100 header-buttons">
                ...
                <button type="submit" class="btn btn-success" :form="'adjustmentEditForm'" :title="$t('Save')">
                  <i class="fas fa-save" />
                </button>
              </div>
            </div>
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form id="adjustmentEditForm" role="form" @submit.prevent="updateAdjustment" @keydown="form.onKeydown($event)">
            <div class="card-body">
              <div class="row">
...
export default {
  ...
  methods: {
    ...
    // load temporary data
    loadTemporaryData() {
      const tempData = localStorage.getItem('inventoryAdjustmentEditTempData')
      if (tempData) {
        try {
