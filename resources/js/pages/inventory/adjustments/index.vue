                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('adjustment-view')">
                              <router-link :to="{ name: 'adjustments.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('adjustment-edit')">
                              <router-link :to="{ name: 'adjustments.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
