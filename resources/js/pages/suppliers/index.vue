                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('supplier-view')">
                              <router-link :to="{ name: 'suppliers.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('supplier-edit')">
                              <router-link :to="{ name: 'suppliers.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
                            <li v-if="$can('supplier-edit')">
                              <a href="#" @click.prevent="openEditModal(data)">{{ $t('Quick Edit') }}</a>
                            </li>
