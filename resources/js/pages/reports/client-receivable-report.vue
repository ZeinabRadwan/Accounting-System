        ...
        <div class="card custom-card w-100">
          ...
          <div class="card-body position-relative">
            ...
            <div class="table-responsive table-custom mt-3" id="printMe">
              <table class="table client-receivable-table">
                <thead>
...
.client-receivable-table thead th {
...
.client-receivable-table thead tr {
  border: none !important;
}

.client-receivable-table thead th:first-child {
  border-top-left-radius: 10px;
}

.client-receivable-table thead th:last-child {
  border-top-right-radius: 10px;
}

/* RTL styles for Arabic language */
[dir="rtl"] .client-receivable-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .client-receivable-table thead th:last-child {
  border-top-right-radius: 0;
  border-top-left-radius: 10px;
}

/* Center header checkbox in select column */
.client-receivable-table thead th.select-col {
  text-align: center;
}

.client-receivable-table thead th.select-col .select-box {
...
.client-receivable-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
