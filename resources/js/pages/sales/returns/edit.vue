    ...
    <div class="row">
      <div class="col-lg-12 col-xl-12">
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100 header-buttons">
                ...
                <button type="submit" class="btn btn-success" :form="'invoiceReturnEditForm'" title="Save">
                  <i class="fas fa-save" />
                </button>
              </div>
            </div>
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form id="invoiceReturnEditForm" role="form" @submit.prevent="updateInvoiceReturn" @keydown="form.onKeydown($event)">
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="invoiceNo">{{ $t('Invoice No') }}</label>
                  ...
                  <table class="table table-hover table-sm text-center">
                    ...
                    <tbody>
                      <tr v-for="(item, i) in form.selectedProducts" :key="i">
                        ...
                        <td style="min-width: 100px;">{{ Number(item.sellingPrice).toFixed(2) | withCurrency }}</td>
