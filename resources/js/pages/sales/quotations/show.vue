      ...
      <div class="w-100 text-right float-right">
        <div class="d-flex justify-content-between" v-if="allData">
          ...
          <div class="btn-group">
            ...
            <router-link v-if="$can('quotation-to-invoice')" :to="{
...
export default {
  ...
  methods: {
    ...
    downloadPDF() {
      ...
      const pdfUrl = `/print/quotation/${this.$route.params.slug}/pdf?${params.toString()}`;
    ...
    previewPDF() {
      ...
      const pdfUrl = `/print/quotation/${this.$route.params.slug}/preview?${params.toString()}`;
      window.location.href = pdfUrl;
    },
    // notify
    async notify() {
