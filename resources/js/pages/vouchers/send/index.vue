      ...
      <div class="col-lg-12">
        <div class="card custom-card w-100">
          ...
          <div class="card-body position-relative">
            ...
            <GeneralTable
              :columns="sendVoucherColumns"
              :rows="sendVouchersWithIndex"
              :loading="loading"
              table-id="printMe"
              wrapper-class="mt-3"
                  ...
                  <div class="action-menu" v-if="openActionIndex === index">
                    ...
                    <ul>
                      <li v-if="$can('payment-voucher-view')">
                        <router-link :to="{ name: 'sendVouchers.show', params: { slug: row.slug } }">
                          <i class="fas fa-eye"></i>
                          {{ $t('View') }}
                        </router-link>
                      </li>
                      <li v-if="$can('payment-voucher-edit')">
                        <router-link :to="{ name: 'sendVouchers.edit', params: { slug: row.slug } }">{{ $t('Edit') }}</router-link>
                      </li>
