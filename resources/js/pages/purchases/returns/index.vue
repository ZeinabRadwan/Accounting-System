                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('invoice-return-view')">
                              <router-link :to="{ name: 'purchaseReturns.show', params: { slug: data.slug } }">{{ $t('View') }}</router-link>
                            </li>
                            <li v-if="$can('invoice-return-edit')">
                              <router-link :to="{ name: 'purchaseReturns.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
