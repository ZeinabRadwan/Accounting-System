        ...
        <div class="d-flex justify-content-between" v-if="allData">
          <div class="btn-group">
            <ul class="nav nav-pills">
              <li class="nav-item">
                <a class="nav-link active" href="#details" data-toggle="tab" @click="getAsset">
          ...
          <div class="btn-group">
            ...
            <router-link :to="{ name: 'assets.index' }" class="btn btn-info float-right">
              <template
        ...
        <div class="row">
          ...
          <div class="invoice p-3 mb-3 w-100" id="content-to-pdf">
            ...
            <div class="row invoice-info">
              ...
              <!-- /.col -->
              <div v-if="allData.type" class="col-sm-8 invoice-col float-right text-md-right">
