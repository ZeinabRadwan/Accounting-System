          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/product-sub-categories/pdf" v-tooltip="$t('Export to PDF')" class="btn btn-secondary">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('product-sub-category-edit') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('product-sub-category-edit')" v-tooltip="$t('Edit')" :to="{
                          name: 'productSubCats.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('product-sub-category-delete')" v-tooltip="$t('Delete')" href="#"
