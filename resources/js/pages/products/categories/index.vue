            ...
            <div class="row d-fex" style="justify-content: flex-end">
              ...
              <div class="col-xl-6 col-3 float-right text-right">
                <div class="btn-group c-w-100">
                  ...
                  <router-link v-if="$can('product-category-create')" :to="{ name: 'productCats.create' }" class="btn btn-primary">
                    {{ $t("Create") }}
                        ...
                        <div class="action-menu" v-if="openActionIndex === i" @click.stop>
                          <ul>
                            <li v-if="$can('product-category-edit')">
                              <router-link :to="{ name: 'productCats.edit', params: { slug: data.slug } }">{{ $t('Edit') }}</router-link>
                            </li>
...
[dir="rtl"] .categories-table thead th:first-child {
  border-top-left-radius: 0;
  border-top-right-radius: 10px;
}

[dir="rtl"] .categories-table thead th:last-child {
...
.categories-table .badge.bg-success {
  background: #F6FEF4 !important;
  color: #2AB930 !important;
...
.categories-table .badge.bg-danger {
