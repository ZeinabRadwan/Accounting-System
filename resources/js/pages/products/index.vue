              ...
              <table class="table products-table">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td class="text-capitalize">{{ data.itemType }}</td>
                    <td>
                        ...
                        <div class="action-menu" v-if="openActionIndex === i">
                          ...
                          <ul>
                            <li v-if="$can('product-view')">
                              <router-link :to="{ name: 'products.show', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <li v-if="$can('product-edit')">
                              <router-link :to="{ name: 'products.edit', params: { slug: data.slug } }">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
