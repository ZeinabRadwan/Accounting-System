...
return [
    ...
    'final' => [
        ...
        'success' => 'A superadmin account has been created. Please use the following credentials to access the account. We higly recemmned you to change the email and password with valid email and strong password.',
        'email' => 'Email',
        'password' => 'Password',
        'env' => 'Final .env File:',
