...
return [
    ...
    */
    ...
    'between' => [
        ...
        'file' => 'Pole :attribute musi być między :min a :max kilobajtów.',
        'string' => 'Pole :attribute musi być między :min a :max znaków.',
    ...
    */
    ...
    'attributes' => [
        ...
        'itemCode' => 'kod przedmiotu',
        'itemModel' => 'model',
        'subCategory' => 'kategoria',
        'brand' => 'marka',
        'itemUnit' => 'jednostka',
        'productTax' => 'stawka podatkowa',
        'regularPrice' => 'cena',
        'discount' => 'zniżka',
        'sellingPrice' => 'cena końcowa',
        'openingStockCount' => 'stan początkowy',
        'openingStockUnitPrice' => 'cena jednostkowa stanu',
        'servicePurchasePrice' => 'cena zakupu usługi',
        'salesAccountId' => 'konto sprzedaży',
        'purchaseAccountId' => 'konto zakupów',
        'note' => 'notatki',
        'status' => 'status',
        'image' => 'obraz',
