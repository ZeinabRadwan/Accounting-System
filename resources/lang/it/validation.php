...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'brand' => 'marca',
        'itemUnit' => 'unità',
        'productTax' => 'aliquota fiscale',
        'regularPrice' => 'prezzo',
        'discount' => 'sconto',
        'sellingPrice' => 'prezzo finale',
        'openingStockCount' => 'stock iniziale',
        'openingStockUnitPrice' => 'prezzo unitario stock',
        'servicePurchasePrice' => 'prezzo di acquisto servizio',
        'salesAccountId' => 'conto vendite',
        'purchaseAccountId' => 'conto acquisti',
        'note' => 'note',
        'status' => 'stato',
        'image' => 'immagine',
