...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'regularPrice' => 'цена',
        'discount' => 'скидка',
        'sellingPrice' => 'итоговая цена',
        'openingStockCount' => 'начальный запас',
        'openingStockUnitPrice' => 'цена единицы запаса',
        'servicePurchasePrice' => 'цена покупки услуги',
        'salesAccountId' => 'счет продаж',
        'purchaseAccountId' => 'счет покупок',
        'note' => 'заметки',
        'status' => 'статус',
        'image' => 'изображение',
        'itemType' => 'тип товара',
