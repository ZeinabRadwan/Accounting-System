...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            'confirmed' => ' تأكيد كلمة المرور غير متطابقة مع كلمة المرور.',
        ],
        'domain' => [
            'required' => 'حقل النطاق مطلوب.',
            'not_found' => 'لم يتم العثور على مستأجر لهذا النطاق.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'date' => 'التاريخ',
        'chartOfAccountId' => 'دليل الحسابات',
        ...
        'mobileBill' => 'فاتورة الجوال',
        'foodBill' => 'فاتورة الطعام',
        'bonus' => 'علاوة',
        'commission' => 'عمولة',
        'festivalBonus' => 'علاوة المناسبات',
        'travelAllowance' => 'بدل السفر',
        'others' => 'أخرى',
        'advance' => 'سلفة',
