...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'brand' => 'marca',
        'itemUnit' => 'unidade',
        'productTax' => 'taxa de imposto',
        'regularPrice' => 'preço',
        'discount' => 'desconto',
        'sellingPrice' => 'preço final',
        'openingStockCount' => 'estoque inicial',
        'openingStockUnitPrice' => 'preço unitário do estoque',
        'servicePurchasePrice' => 'preço de compra do serviço',
        'salesAccountId' => 'conta de vendas',
        'purchaseAccountId' => 'conta de compras',
        'note' => 'notas',
        'status' => 'status',
        'image' => 'imagem',
