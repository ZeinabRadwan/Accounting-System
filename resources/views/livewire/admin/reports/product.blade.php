<div>
    <x-ui.page-header title="{{ __('Product Report') }}" subtitle="{{ __('Sales and movement by SKU') }}">
        ...
        <x-ui.table-body>
            @forelse ($data as $row)
                <tr class="hover:bg-slate-50/80">
                    ...
                    <x-ui.td>{{ number_format($row->qty_base_sold ?? 0, 2) }}</x-ui.td>
