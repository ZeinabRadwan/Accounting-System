            ...
            <div class="auth-inner row m-0">
                ...
                <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                        ...
                        <form class="auth-login-form mt-2" method="POST" action="{{ route('multi-tenant.login') }}">
                            @csrf
                            <div class="mb-1">
                                <label class="form-label" for="email">Email</label>
                                <input class="form-control" id="email" type="text" name="email" placeholder="john@example.com" aria-describedby="email" tabindex="1" autofocus value="{{ old('email') }}" />
                            </div>
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                <div class="form-check">
                                    <input class="form-check-input" id="remember-me" type="checkbox" name="remember_me" tabindex="3" />
                        ...
                        <p class="text-center mt-2">
                            ...
                            <a href="{{ route('multi-tenant.register') }}">
