...
@section('content-area')
    ...
    <h3>@lang('print.Purchase Summary')</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm">
                        <tr>
                            <td><strong>@lang('print.Total Suppliers')</strong></td>
                            <td>{{ $reportData['summary']['total_suppliers'] ?? 0 }}</td>
                        </tr>
                        <tr>
                            <td><strong>@lang('print.Total Purchases')</strong></td>
    ...
    @if(isset($reportData['suppliers']) && count($reportData['suppliers']) > 0)
        <div class="table-responsive">
            <table class="table-listing table table-bordered table-striped table-sm">
                <thead class="thead-light">
                    <tr>
                        <th>@lang('print.Row Number')</th>
                        <th>@lang('print.Supplier Name')</th>
                        <th>@lang('print.Total Purchases')</th>
                ...
                <tbody>
                    @foreach ($reportData['suppliers'] as $index => $supplier)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $supplier['supplier_name'] ?? 'Unknown Supplier' }}</td>
