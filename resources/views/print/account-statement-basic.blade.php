...
<body>
    ...
    <div class="account-info arabic-text">
        <strong>@lang('print.Account'):</strong> {{ $accountStatementData['chart_of_account']['code'] }} - {{ $accountStatementData['chart_of_account']['name'] }}
        ...
        <br><strong>@lang('print.Sub Account'):</strong> {{ $accountStatementData['report_account']['code'] }} - {{ $accountStatementData['report_account']['name'] }}
        @endif
        <br><strong>@lang('print.Period'):</strong> {{ $accountStatementData['filters']['from_date'] ?? '' }} - {{ $accountStatementData['filters']['to_date'] ?? '' }}
    </div>
    ...
    <div class="summary-section">
        <div class="summary-box">
            ...
            <div class="summary-value arabic-text">{{ number_format($accountStatementData['summary']['opening_balance'] ?? 0, 2) }} 
        ...
        <div class="summary-box">
            ...
            <div class="summary-value arabic-text">{{ number_format($accountStatementData['summary']['period_debits'] ?? 0, 2) }}</div>
        </div>
        <div class="summary-box">
            <div class="summary-label arabic-text">@lang('print.Period Credits')</div>
            <div class="summary-value arabic-text">{{ number_format($accountStatementData['summary']['period_credits'] ?? 0, 2) }}</div>
        </div>
        <div class="summary-box closing">
            <div class="summary-label arabic-text">@lang('print.Closing Balance')</div>
            <div class="summary-value arabic-text">{{ number_format($accountStatementData['summary']['closing_balance'] ?? 0, 2) }} 
        ...
        <tbody>
            @if(isset($accountStatementData['entries']) && count($accountStatementData['entries']) > 0)
                ...
                <tr>
                    ...
                    <td class="text-center {{ ($entry['balance_type'] ?? '') === 'Debit' ? 'positive' : 'negative' }}">
