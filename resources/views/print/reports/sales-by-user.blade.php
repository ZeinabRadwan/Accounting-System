...
<head>
    ...
    <title>Sales By User Report</title>
    ...
    <div id="document-container" style="max-width: 100%; margin: 0 auto;">
        <div style="position: relative;">
            ...
            <div class="text-center mb-4" style="margin-bottom: 30px;">
                <h2 style="margin: 0 0 10px 0; color: {{ $colors['primary'] ?? '#1f2937' }}; font-size: {{ ($typography['headingSize'] ?? 24) }}px; font-weight: bold;">@lang('print.Sales By User Report')</h2>
                @if(isset($salesByUserReportData['filters']['from_date']) && isset($salesByUserReportData['filters']['to_date']))
                    <h4 style="margin: 5px 0; color: {{ $colors['secondary'] ?? '#6b7280' }}; font-size: {{ ($typography['baseFontSize'] ?? 14) + 2 }}px;">@lang('print.Period'): {{ $salesByUserReportData['filters']['from_date'] }} - {{ $salesByUserReportData['filters']['to_date'] }}</h4>
                @endif
                @if(isset($salesByUserReportData['filters']['user']))
                    <h5 style="margin: 5px 0; color: {{ $colors['secondary'] ?? '#6b7280' }}; font-size: {{ ($typography['baseFontSize'] ?? 14) + 1 }}px;">@lang('print.User'): {{ $salesByUserReportData['filters']['user'] }}</h5>
                @endif
            </div>
            ...
            @else
                <div class="text-center mt-5" style="margin-top: 50px; text-align: center;">
                    <h4 style="color: {{ $colors['secondary'] ?? '#6b7280' }};">@lang('print.No sales data found for the selected period.')</h4>
                </div>
            @endif
        </div>
    </div>
