                ...
                <div style="display: flex; {{ $isRTL ? 'flex-direction: row-reverse;' : '' }} flex-wrap: wrap; gap: 20px;">
                    @foreach($groupStatementData['chart_of_accounts'] as $account)
                        <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; border-left: 4px solid {{ $colors['primary'] ?? '#2563eb' }}; flex: 1; min-width: 200px;">
                            <strong style="color: {{ $colors['primary'] ?? '#2563eb' }};" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('print.Account'):</strong> 
                            <span class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">{{ $account['code'] ?? '' }} - {{ $account['name'] ?? '' }}</span><br>
                            <strong style="color: {{ $colors['secondary'] ?? '#6b7280' }};" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('Account Type'):</strong> 
                ...
                <div style="display: flex; {{ $isRTL ? 'flex-direction: row-reverse;' : '' }} flex-wrap: wrap; gap: 20px;">
                    @if(isset($groupStatementData['filters']['from_date']) && isset($groupStatementData['filters']['to_date']))
                        <div style="background: #f8f9fa; padding: 15px; border-radius: 8px;">
                            ...
                            <span class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">{{ $groupStatementData['filters']['from_date'] }} - {{ $groupStatementData['filters']['to_date'] }}</span>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="display: flex; {{ $isRTL ? 'flex-direction: row-reverse;' : '' }} flex-wrap: wrap; gap: 20px;">
                    <div style="background: #dcfce7; padding: 20px; border-radius: 8px; text-align: center; flex: 1; min-width: 150px;">
                        <h4 style="margin: 0; color: #166534;" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('print.Opening Balance')</h4>
                        ...
                        <small style="color: #166534;" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">
                    ...
                    <div style="background: #dbeafe; padding: 20px; border-radius: 8px; text-align: center; flex: 1; min-width: 150px;">
                        <h4 style="margin: 0; color: #1e40af;" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('print.Period Debits')</h4>
                    ...
                    <div style="background: #fef3c7; padding: 20px; border-radius: 8px; text-align: center; flex: 1; min-width: 150px;">
                        <h4 style="margin: 0; color: #92400e;" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('print.Period Credits')</h4>
                    ...
                    <div style="background: #fee2e2; padding: 20px; border-radius: 8px; text-align: center; flex: 1; min-width: 150px;">
                        <h4 style="margin: 0; color: #991b1b;" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('print.Closing Balance')</h4>
                        ...
                        <small style="color: #991b1b;" class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">
