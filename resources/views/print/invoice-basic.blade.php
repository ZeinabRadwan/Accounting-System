...
<body>
    ...
    <div class="document-container">
        ...
        <div class="document-header">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                ...
                <div style="text-align: right;">
                    ...
                    <p style="margin: 0;">@lang('print.Date'):
                        {{ \Carbon\Carbon::parse($invoice->invoice_date)->format('M d, Y') }}</p>
                    @if ($invoice->dueDate)
                        <p style="margin: 0;">@lang('print.Due Date'):
                            {{ \Carbon\Carbon::parse($invoice->dueDate)->format('M d, Y') }}</p>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div style="margin-bottom: 30px;">
            ...
            <p style="margin: 0; font-weight: 600;" class="arabic-text">{{ $invoice->client->name ?? __('print.N/A') }}
            </p>
            <p style="margin: 0;">{{ $invoice->client->address ?? __('print.N/A') }}</p>
            <p style="margin: 0;">{{ $invoice->client->email ?? __('print.N/A') }} •
                {{ $invoice->client->phone ?? __('print.N/A') }}</p>
        </div>
