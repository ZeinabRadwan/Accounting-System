...
<head>
    ...
    <style>
        ...
        .summary-box.suppliers {
            background: #dcfce7;
            color: #166534;
        }

        .summary-box.purchases {
            background: #dbeafe;
            color: #1e40af;
        }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">@lang('print.This report was generated on')
                {{ date('d-M-Y H:i:s') }}</p>
        </div>
        ...
        @if (isset($purchaseSummaryData['suppliers']) && count($purchaseSummaryData['suppliers']) > 0)
                    ...
                    @foreach ($purchaseSummaryData['suppliers'] as $index => $supplier)
                        <tr>
                            ...
                            <td class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">
                                {{ $supplier['supplier_name'] ?? 'Unknown Supplier' }}</td>
            ...
            <div style="text-align: center; color: #6b7280; margin-top: 15px;"
                class="{{ app()->getLocale() === 'ar' ? 'arabic-text' : '' }}">
