...
<body>
    ...
    <div class="sheet">
        ...
        <p class="muted">{{ __('Statement of Account') }} ({{ __('Kashf Hesab') }})</p>
        <div class="meta">
            <div>
        ...
        <div class="cards">
            <div class="card"><div class="lbl">{{ __('Outstanding') }}</div><div class="val">EGP {{ number_format($statement['current_due'], 2) }}</div></div>
